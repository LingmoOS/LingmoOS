/*
    ...
    Parts of this class have been take from the KAboutLingmo class, which was
...
class LingmoAboutDialog : public QDialog
{
    Q_OBJECT
...
public:
     ...
     */
    explicit LingmoAboutDialog(QWidget *parent = nullptr);

private:
    class Private;
    Private *const d;
    Q_DISABLE_COPY(LingmoAboutDialog)
};
