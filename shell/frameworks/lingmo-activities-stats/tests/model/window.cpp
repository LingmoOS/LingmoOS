    ...
    , activities(new KActivities::Consumer())
{
    ...
    presets = {
        {QStringLiteral("kicker-favorites"),
         LinkedResources
             | Agent{QStringLiteral("org.kde.lingmo.favorites.applications"),
                     QStringLiteral("org.kde.lingmo.favorites.documents"),
                     QStringLiteral("org.kde.lingmo.favorites.contacts")}
