...
#include "lingmoactivitiesstats_export.h"
 ...
 */
enum LINGMOACTIVITIESSTATS_EXPORT Order {
 ...
 */
enum LINGMOACTIVITIESSTATS_EXPORT Select {
 ...
 */
struct LINGMOACTIVITIESSTATS_EXPORT Limit {
    Limit(int value);
    int value;
};
 ...
 */
struct LINGMOACTIVITIESSTATS_EXPORT Offset {
    Offset(int value);
    int value;
};
 ...
 */
struct LINGMOACTIVITIESSTATS_EXPORT Type {
    /**
 ...
 * accessed it
 */
struct LINGMOACTIVITIESSTATS_EXPORT Agent {
    /**
 ...
 * were accessed
 */
struct LINGMOACTIVITIESSTATS_EXPORT Activity {
    /**
 ...
 * Url filtering.
 */
struct LINGMOACTIVITIESSTATS_EXPORT Url {
    /**
 ...
 * @since 6.0
 */
struct LINGMOACTIVITIESSTATS_EXPORT Title {
    /**
 ...
 */
struct LINGMOACTIVITIESSTATS_EXPORT Date {
    Date(QDate value);
