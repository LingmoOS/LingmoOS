...
![Discover window](https://cdn.kde.org/screenshots/lingmo-discover/lingmo-discover.png)
...
* Find and install add-ons for Lingmo.
...
Like other projects in the KDE ecosystem, contributions are welcome from all. This repository is managed in [KDE Invent](https://invent.kde.org/lingmo/discover), our GitLab instance.
...
If you get stuck or need help with anything at all, head over to the [KDE New Contributors room](https://go.kde.org/matrix/#/#kde-welcome:kde.org) on Matrix. For questions about Discover, please ask in the [Lingmo Discover room](https://go.kde.org/matrix/#/#lingmo-discover:kde.org). See [Matrix](https://community.kde.org/Matrix) for more details.
