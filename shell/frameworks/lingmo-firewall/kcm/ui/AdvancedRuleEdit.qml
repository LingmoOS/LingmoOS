...
LingmoUI.FormLayout {
    ...
    QQC2.ComboBox {
        id: policy
        LingmoUI.FormData.label: i18n("Policy:")
    ...
    RowLayout {
        LingmoUI.FormData.label: i18n("Direction:")
        QQC2.RadioButton {
            id: incoming
            text: i18n("Incoming")
    ...
    RowLayout {
        LingmoUI.FormData.label: i18n("IP Version:")
    ...
    RowLayout {
        LingmoUI.FormData.label: i18n("Source:")
    ...
    RowLayout {
        LingmoUI.FormData.label: i18n("Destination:")
    ...
    QQC2.ComboBox {
        ...
        LingmoUI.FormData.label: i18n("Protocol:")
        Layout.preferredWidth: root.maxComboboxWidth
    ...
    QQC2.ComboBox {
        ...
        LingmoUI.FormData.label: i18n("Interface:")
        Layout.preferredWidth: root.maxComboboxWidth
    ...
    QQC2.ComboBox {
        ...
        LingmoUI.FormData.label: i18n("Logging:")
        Layout.preferredWidth: root.maxComboboxWidth
        model: ruleChoices
        textRole: "text"
