...
ViewBase {
    ...
    columns: [
        {column: ConnectionsModel.ProtocolColumn, width: LingmoUI.Units.gridUnit * 4},
        {column: ConnectionsModel.LocalAddressColumn, width: LingmoUI.Units.gridUnit * 10},
        {column: ConnectionsModel.ForeignAddressColumn, width: LingmoUI.Units.gridUnit * 10},
        {column: ConnectionsModel.StatusColumn, width: LingmoUI.Units.gridUnit * 5},
        {column: ConnectionsModel.PidColumn, width: LingmoUI.Units.gridUnit * 3},
        {column: ConnectionsModel.ProgramColumn, width: LingmoUI.Units.gridUnit * 7}
    ]
    ...
    NetstatClient {
        id: netStatClient
        property bool active: base.LingmoUI.ColumnView.inViewport
