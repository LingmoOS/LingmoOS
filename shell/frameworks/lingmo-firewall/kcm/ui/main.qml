...
KCMUtils.ScrollViewKCM {
    ...
    LingmoUI.OverlaySheet {
        ...
        ColumnLayout {
            ...
            RuleEdit {
                ...
                implicitWidth: 30 * LingmoUI.Units.gridUnit
                ...
                function accept() {
                    ...
                    if (!job) {
                        ruleEditMessage.text = i18n("Please restart lingmo firewall, the backend disconnected.");
    ...
    header: ColumnLayout {
        ...
        LingmoUI.FormLayout {
            RowLayout {
                ...
                LingmoUI.FormData.label: i18n("Firewall type:")
            ...
            Repeater {
                ...
                RowLayout {
                    LingmoUI.FormData.label: modelData.label
                    ...
                    QQC2.ComboBox {
                        ...
                        onActivated: {
                            ...
                            if (!job) {
                                firewallInlineErrorMessage.text = i18n("Please restart lingmo firewall, the backend disconnected.");
                                firewallInlineErrorMessage.visible = true;
                                return;
                           }
    ...
    view: TableView {
        ...
        columnWidthProvider: (column) => {
            ...
            const columnWidths = [];
            columnWidths[RuleListModel.ActionColumn] =  LingmoUI.Units.gridUnit * 8
            columnWidths[RuleListModel.FromColumn] =  LingmoUI.Units.gridUnit * 10
            columnWidths[RuleListModel.ToColumn] =  LingmoUI.Units.gridUnit * 10
            columnWidths[RuleListModel.Ipv6Column] = LingmoUI.Units.gridUnit * 4
            columnWidths[RuleListModel.LoggingColumn] = LingmoUI.Units.gridUnit * 5
            columnWidths[RuleListModel.EditColumn] = LingmoUI.Units.gridUnit * 6
        ...
        LingmoUI.PlaceholderMessage {
            ...
            width: tableView.width - (LingmoUI.Units.largeSpacing * 12)
            visible: tableView.rows === 0
