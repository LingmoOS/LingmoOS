...
ViewBase {
    ...
    columns: [
        {column: LogListModel.ProtocolColumn, width: LingmoUI.Units.gridUnit * 3},
        {column: LogListModel.SourceAddressColumn, width: LingmoUI.Units.gridUnit * 10},
        {column: LogListModel.SourcePortColumn, width: LingmoUI.Units.gridUnit * 3},
        {column: LogListModel.DestinationAddressColumn, width: LingmoUI.Units.gridUnit * 10},
        {column: LogListModel.DestinationPortColumn, width: LingmoUI.Units.gridUnit * 3},
        {column: LogListModel.InterfaceColumn, width: LingmoUI.Units.gridUnit * 3}
    ]
