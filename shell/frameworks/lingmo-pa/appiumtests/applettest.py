...
WIDGET_ID: Final = "org.kde.lingmo.volume"
...
class AppletTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        options.set_capability("environ", {
            "QT_FATAL_WARNINGS": "1",
            "QT_LOGGING_RULES": "org.kde.pulseaudio=false;org.kde.lingmo.pulseaudio.warning=false;qt.accessibility.atspi.warning=false;kf.lingmo.core.warning=false;kf.windowsystem.warning=false;kf.lingmoui.platform.warning=false",
        })
