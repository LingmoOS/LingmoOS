        ...
        ColumnLayout {
                ...
                RowLayout {
                    ...
                    PC3.RadioButton {
                        ...
                        Layout.maximumWidth: item.availableWidth - Layout.leftMargin - Layout.rightMargin
                            - (contextMenuButton.visible ? contextMenuButton.implicitWidth + LingmoUI.Units.smallSpacing * 2 : 0)
                        ...
                        spacing: LingmoUI.Units.smallSpacing + Math.round((muteButton.width - defaultButton.indicator.width) / 2)
            ...
            RowLayout {
                ...
                PC3.Label {
                    ...
                    // and lingmo-workspace:OSDItem.qml
                    color: {
