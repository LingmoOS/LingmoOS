        ...
        delegate: ItemDelegate {
            ...
            contentItem: RowLayout {
                ...
                Label {
                    ...
                    color: item.highlighted ? LingmoUI.Theme.highlightedTextColor : LingmoUI.Theme.TextColor
                }

                Label {
                    text: view._evalTrigger, item._deviceStatus.text
                    color: item.highlighted ? LingmoUI.Theme.highlightedTextColor : item._deviceStatus.color
                }
            }
