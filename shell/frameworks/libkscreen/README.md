...
libkscreen is the screen management library for KDE Lingmo Workspaces. Its primary consumer is the KDE screen management application KScreen.

libkscreen is part of [Lingmo releases][lingmo-releases].
...
[lingmo-releases]: https://community.kde.org/Schedules/Lingmo_5
