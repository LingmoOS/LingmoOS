...
int main(int argc, char **argv)
{
    ...
    aboutData.addAuthor(QStringLiteral("Jan Grulich"), i18n("Port to Qt 5 / Lingmo 5"), QStringLiteral("jgrulich@redhat.com"));
    aboutData.addAuthor(QStringLiteral("Mike Noe"), i18n("Port to Qt 6 / Lingmo 6"), QStringLiteral("noeerover@gmail.com"));
