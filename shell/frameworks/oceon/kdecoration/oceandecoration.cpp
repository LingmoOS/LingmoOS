...
#include "oceandecoration.h"

#include "oceansettingsprovider.h"

#include "oceanbutton.h"

#include "oceanboxshadowrenderer.h"
...
K_PLUGIN_FACTORY_WITH_JSON(OceanDecoFactory, "ocean.json", registerPlugin<Ocean::Decoration>(); registerPlugin<Ocean::Button>();)
...
{
    switch (size) {
    case Ocean::InternalSettings::ShadowNone:
        return s_shadowParams[0];
    case Ocean::InternalSettings::ShadowSmall:
        return s_shadowParams[1];
    case Ocean::InternalSettings::ShadowMedium:
        return s_shadowParams[2];
    case Ocean::InternalSettings::ShadowLarge:
        return s_shadowParams[3];
    case Ocean::InternalSettings::ShadowVeryLarge:
...
{
    switch (intensity) {
    case Ocean::InternalSettings::OutlineOff:
        return 0;
    case Ocean::InternalSettings::OutlineLow:
        return Ocean::Metrics::Bias_Default / 2;
    case Ocean::InternalSettings::OutlineMedium:
        return Ocean::Metrics::Bias_Default;
    case Ocean::InternalSettings::OutlineHigh:
        return Ocean::Metrics::Bias_Default * 2;
    case Ocean::InternalSettings::OutlineMaximum:
        return Ocean::Metrics::Bias_Default * 3;
    default:
...
#endif
{
    ...
    // Linear to have the same easing as Ocean animations
