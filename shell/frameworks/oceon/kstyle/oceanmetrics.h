...
struct Metrics {
    ...
    // Keep this value in sync with LingmoUI  PlatformTheme::frameContrast()
    // https://invent.kde.org/frameworks/lingmoui/-/blob/master/src/platform/platformtheme.cpp?ref_type=heads#L701
