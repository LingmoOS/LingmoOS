...
SessionManagementScreen {
    ...
    LingmoComponents3.TextField {
        ...
        placeholderText: i18nd("lingmo-desktop-sddm-theme", "Username")
    ...
    RowLayout {
        ...
        LingmoExtras.PasswordField {
            ...
            placeholderText: i18nd("lingmo-desktop-sddm-theme", "Password")
            focus: !showUsernamePrompt || lastUserName

            // Disable reveal password action because SDDM does not have the ocean icon set loaded
            rightActions: []
        ...
        LingmoComponents3.Button {
            id: loginButton
            Accessible.name: i18nd("lingmo-desktop-sddm-theme", "Log In")
