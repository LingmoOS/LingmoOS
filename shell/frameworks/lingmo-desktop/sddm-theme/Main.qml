...
Item {
    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            height: root.height + LingmoUI.Units.gridUnit * 3
            ...
            Timer {
                ...
                //it's been this way for all Lingmo 5.x without a huge problem
                running: true
                repeat: false
                interval: 200
            ...
            initialItem: Login {
                ...
                notificationMessage: {
                    ...
                    if (capsLockState.locked) {
                        parts.push(i18nd("lingmo-desktop-sddm-theme", "Caps Lock is on"));
                    }
                ...
                actionItems: [
                    ActionButton {
                        ...
                        text: i18ndc("lingmo-desktop-sddm-theme", "Suspend to RAM", "Sleep")
                        onClicked: sddm.suspend()
                        enabled: sddm.canSuspend
                    },
                    ActionButton {
                        icon.name: "system-reboot"
                        text: i18nd("lingmo-desktop-sddm-theme", "Restart")
                        onClicked: sddm.reboot()
                        enabled: sddm.canReboot
                    },
                    ActionButton {
                        icon.name: "system-shutdown"
                        text: i18nd("lingmo-desktop-sddm-theme", "Shut Down")
                        onClicked: sddm.powerOff()
                        enabled: sddm.canPowerOff
                    },
                    ActionButton {
                        icon.name: "system-user-prompt"
                        text: i18ndc("lingmo-desktop-sddm-theme", "For switching to a username and password prompt", "Other…")
        ...
        Component {
            ...
            Login {
                ...
                loginScreenUiVisible: loginScreenRoot.uiVisible
                fontSize: LingmoUI.Theme.defaultFont.pointSize + 2
                ...
                userListModel: ListModel {
                    ...
                    Component.onCompleted: {
                        ...
                        setProperty(0, "name", i18nd("lingmo-desktop-sddm-theme", "Type in Username and Password"));
                ...
                actionItems: [
                    ...
                    ActionButton {
                        ...
                        text: i18nd("lingmo-desktop-sddm-theme", "List Users")
        ...
        Image {
            ...
            height: Math.round(LingmoUI.Units.gridUnit * 3.5)
            Behavior on opacity {
                // OpacityAnimator when starting from 0 is buggy (it shows one frame with opacity 1)"
                NumberAnimation {
                    duration: LingmoUI.Units.longDuration
        ...
        RowLayout {
            ...
            LingmoComponents3.ToolButton {
                ...
                text: i18ndc("lingmo-desktop-sddm-theme", "Button to show/hide virtual keyboard", "Virtual Keyboard")
    ...
    Connections {
        ...
        function onLoginFailed() {
            notificationMessage = i18nd("lingmo-desktop-sddm-theme", "Login Failed")
            footer.enabled = true
