...
int main(int argc, char **argv)
{
    ...
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("org.kde.lingmo.emojier"));

    KAboutData about(QStringLiteral("lingmo.emojier"),
                     i18n("Emoji Selector"),
    ...
    engine.loadFromModule("org.kde.lingmo.emoji.app", "Emojier");
