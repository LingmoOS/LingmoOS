/*
    Lingmo analog-clock drawing code:
...
void Dtime::currentZone()
{
    ...
    const char *domain = "lingmo_applet_org.kde.lingmo.digitalclock.mo";
    ...
    : QWidget(parent)
{
    ...
    m_imageSet->setBasePath("lingmo/desktoptheme");
    auto lingmoConfig = KSharedConfig::openConfig(QStringLiteral("lingmorc"));
    m_imageSet->setImageSetName(lingmoConfig->group("Theme").readEntry("name", "default"));
