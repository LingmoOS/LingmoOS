...
#include "workspaceoptions_lingmosettings.h"
...
{
    qmlRegisterAnonymousType<WorkspaceOptionsGlobalsSettings>("org.kde.lingmo.workspaceoptions.kcm", 0);
    qmlRegisterAnonymousType<WorkspaceOptionsLingmoSettings>("org.kde.lingmo.workspaceoptions.kcm", 0);
    qmlRegisterAnonymousType<WorkspaceOptionsKwinSettings>("org.kde.lingmo.workspaceoptions.kcm", 0);
...
WorkspaceOptionsLingmoSettings *KCMWorkspaceOptions::lingmoSettings() const
{
    return m_data->workspaceOptionsLingmoSettings();
}
