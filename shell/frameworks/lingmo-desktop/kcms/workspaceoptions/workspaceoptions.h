...
class WorkspaceOptionsLingmoSettings;
...
class KCMWorkspaceOptions : public KQuickManagedConfigModule
{
    ...
    Q_PROPERTY(WorkspaceOptionsLingmoSettings *lingmoSettings READ lingmoSettings CONSTANT)
...
public:
    ...
    WorkspaceOptionsLingmoSettings *lingmoSettings() const;
