...
KCM.ScrollViewKCM {
    ...
    implicitWidth: LingmoUI.Units.gridUnit * 42
    ...
    header: ColumnLayout {
        ...
        ColumnLayout {
            ...
            QQC2.Label {
                ...
                Layout.fillWidth: true
                Layout.maximumWidth: LingmoUI.Units.gridUnit * 24
            ...
            LingmoUI.FormLayout {
                ...
                QQC2.CheckBox {
                    ...
                    LingmoUI.FormData.label: i18nc("@title:group", "File indexing:")
                ...
                QQC2.RadioButton {
                    LingmoUI.FormData.label: i18nc("@title:group", "Data to index:")
                ...
                Item {
                    implicitHeight: LingmoUI.Units.smallSpacing
                }
