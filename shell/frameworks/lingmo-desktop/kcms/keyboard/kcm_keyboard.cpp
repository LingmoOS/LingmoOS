...
{
    qmlRegisterAnonymousType<WorkspaceOptions>("org.kde.lingmo.keyboard.kcm", 0);
    qmlRegisterAnonymousType<KeyboardMiscSettings>("org.kde.lingmo.keyboard.kcm", 0);
    qmlRegisterAnonymousType<KeyboardSettings>("org.kde.lingmo.keyboard.kcm", 0);
...
{
    static bool isLingmoIM = (qgetenv("QT_IM_MODULE") == "lingmoim");
    return isLingmoIM;
}
