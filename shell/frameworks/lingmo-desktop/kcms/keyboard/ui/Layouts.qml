...
import org.kde.lingmouiaddons.tableview as TableView
...
ColumnLayout {
    ...
    RowLayout {
        ...
        LingmoUI.FormLayout {
            LingmoUI.Separator {
                LingmoUI.FormData.label: i18nc("@title:group", "Shortcuts for Switching Layout")
                LingmoUI.FormData.isSection: true
            }

            RowLayout {
                spacing: LingmoUI.Units.smallSpacing
                LingmoUI.FormData.label: i18nc("@option:textbox", "Main shortcuts:")
                Layout.fillWidth: true
            ...
            RowLayout {
                spacing: LingmoUI.Units.smallSpacing
                LingmoUI.FormData.label: i18nc("@option:textbox", "3rd level shortcuts:")
                Layout.fillWidth: true
            ...
            KQuickControls.KeySequenceItem {
                ...
                LingmoUI.FormData.label: i18nc("@option:textbox", "Alternative shortcut:")
            ...
            KQuickControls.KeySequenceItem {
                id: lastUsedShortcut
                LingmoUI.FormData.label: i18nc("@option:textbox", "Last used shortcuts:")
                modifierlessAllowed: false
                modifierOnlyAllowed: true
        ...
        LingmoUI.FormLayout {
            ...
            LingmoUI.Separator {
                LingmoUI.FormData.label: i18nc("@title:group", "Switching Policy")
                LingmoUI.FormData.isSection: true
            }
