...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        Item {
            LingmoUI.FormData.label: i18nc("Internet related application’s category’s name", "Internet")
            LingmoUI.FormData.isSection: true
        }
        RowLayout {
            LingmoUI.FormData.label: i18n("Web browser:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Email client:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nc("Default phone app", "Phone Numbers:")
        ...
        Item {
            LingmoUI.FormData.label: i18nc("Multimedia related application’s category’s name", "Multimedia")
            LingmoUI.FormData.isSection: true
        }

        RowLayout {
            LingmoUI.FormData.label: i18n("Image viewer:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Music player:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Video player:")
        ...
        Item {
            LingmoUI.FormData.label: i18nc("Documents related application’s category’s name", "Documents")
            LingmoUI.FormData.isSection: true
        }

        RowLayout {
            LingmoUI.FormData.label: i18n("Text editor:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("PDF viewer:")
        ...
        Item {
            LingmoUI.FormData.label: i18nc("Utilities related application’s category’s name", "Utilities")
            LingmoUI.FormData.isSection: true
        }

        RowLayout {
            LingmoUI.FormData.label: i18n("File manager:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Terminal emulator:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Archive manager:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nc("Map related application’s category’s name", "Map:")
