...
#include <LingmoActivities/Stats/ResultSet>
#include <LingmoActivities/Stats/Terms>
...
static QHash<QString, QString> s_programs = {{"lingmoshell", "lingmoshell"}, {"lingmo-discover", "lingmodiscover"}};
...
{
    qmlRegisterAnonymousType<LandingPageGlobalsSettings>("org.kde.lingmo.landingpage.kcm", 0);
    qmlRegisterAnonymousType<MostUsedModel>("org.kde.lingmo.landingpage.kcm", 0);
    qmlRegisterAnonymousType<LookAndFeelGroup>("org.kde.lingmo.landingpage.kcm", 0);
...
void KCMLandingPage::save()
{
    ...
    if (m_lnfDirty) {
        QProcess::startDetached(QStringLiteral("lingmo-apply-lookandfeel"), QStringList({QStringLiteral("-a"), globalsSettings()->lookAndFeelPackage()}));
    }
}
