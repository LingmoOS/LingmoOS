...
{
    qmlRegisterAnonymousType<MouseSettings>("org.kde.lingmo.access.kcm", 0);
    qmlRegisterAnonymousType<BellSettings>("org.kde.lingmo.access.kcm", 0);
    qmlRegisterAnonymousType<KeyboardSettings>("org.kde.lingmo.access.kcm", 0);
    qmlRegisterAnonymousType<KeyboardFiltersSettings>("org.kde.lingmo.access.kcm", 0);
    qmlRegisterAnonymousType<ActivationGesturesSettings>("org.kde.lingmo.access.kcm", 0);
    qmlRegisterAnonymousType<ScreenReaderSettings>("org.kde.lingmo.access.kcm", 0);
    qmlRegisterAnonymousType<ShakeCursorSettings>("org.kde.lingmo.access.kcm", 0);
