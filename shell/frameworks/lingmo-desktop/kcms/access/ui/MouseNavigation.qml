...
LingmoUI.FormLayout {
    QQC2.CheckBox {
        ...
        LingmoUI.FormData.label:  i18n("Use number pad to move cursor:")
        text: i18n("Enable")
    ...
    QQC2.SpinBox {
        LingmoUI.FormData.label: i18n("Acceleration delay:")
    ...
    QQC2.SpinBox {
        LingmoUI.FormData.label: i18n("Repeat interval:")
    ...
    QQC2.SpinBox {
        LingmoUI.FormData.label: i18n("Acceleration time:")
    ...
    QQC2.SpinBox {
        LingmoUI.FormData.label:  i18n("Maximum speed:")
    ...
    QQC2.SpinBox {
        LingmoUI.FormData.label: i18n("Pointer acceleration:")
