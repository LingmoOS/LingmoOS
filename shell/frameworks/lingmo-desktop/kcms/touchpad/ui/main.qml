...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        // Device
        QQC2.ComboBox {
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Device:")
            id: deviceSelector
        ...
        QQC2.CheckBox {
            id: deviceEnabled
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "General:")
        ...
        // Acceleration
        RowLayout {
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Pointer speed:")
            id: accelSpeed
            Layout.fillWidth: true
            ...
            QQC2.SpinBox {
                ...
                Layout.minimumWidth: LingmoUI.Units.gridUnit * 4
        ...
        ColumnLayout {
            id: accelProfile
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Pointer acceleration:")
            LingmoUI.FormData.buddyFor: accelProfileFlat
            spacing: LingmoUI.Units.smallSpacing
        ...
        GridLayout {
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Scrolling speed:")
            LingmoUI.FormData.buddyFor: scrollFactor
            Layout.fillWidth: true
        ...
        ColumnLayout {
            id: scrollMethod
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Scrolling:")
            LingmoUI.FormData.buddyFor: scrollMethodTwoFingers
        ...
        QQC2.CheckBox {
            id: tapToClick
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Tapping:")
        ...
        ColumnLayout {
            id: multiTap
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Two-finger tap:")
            LingmoUI.FormData.buddyFor: multiTapRightClick
        ...
        ColumnLayout {
            id: rightClickMethod
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Right-click:")
            LingmoUI.FormData.buddyFor: rightClickMethodAreas
        ...
        ColumnLayout {
            ...
            LingmoUI.FormData.label: i18nd("kcm_touchpad", "Middle-click: ")
            LingmoUI.FormData.buddyFor: middleSoftwareEmulation
