...
KCMUtils.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        QQC2.ComboBox {
            id: deviceSelector
            LingmoUI.FormData.label: i18nd("kcmmouse", "Device:")
        ...
        QQC2.CheckBox {
            id: deviceEnabled
            LingmoUI.FormData.label: i18nd("kcmmouse", "General:")
        ...
        QQC2.CheckBox {
            id: leftHanded
            LingmoUI.FormData.label: deviceEnabled.visible ? null : deviceEnabled.LingmoUI.FormData.label
        ...
        RowLayout {
            ...
            LingmoUI.FormData.label: i18nd("kcmmouse", "Pointer speed:")
            Layout.fillWidth: true
        ...
        ColumnLayout {
            id: accelProfile
            spacing: LingmoUI.Units.smallSpacing
            LingmoUI.FormData.label: i18nd("kcmmouse", "Pointer acceleration:")
        ...
        QQC2.CheckBox {
            id: naturalScroll
            LingmoUI.FormData.label: i18nd("kcmmouse", "Scrolling:")
