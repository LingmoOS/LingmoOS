...
QQC2.ApplicationWindow {
    ...
    component Target: QQC2.ToolButton {
        readonly property real positionX: test.LingmoUI.ScenePosition.x
        readonly property real positionY: test.LingmoUI.ScenePosition.y

        icon.name: "crosshairs"
        focusPolicy: Qt.NoFocus

        down: {
            const isX = root.currentPenToolX >= LingmoUI.ScenePosition.x && root.currentPenToolX <= LingmoUI.ScenePosition.x + width;
            const isY = root.currentPenToolY >= LingmoUI.ScenePosition.y && root.currentPenToolY <= LingmoUI.ScenePosition.y + height;
            return isX && isY;
        }
    ...
    component TargetPath: Shape {
        ...
        ShapePath {
            strokeWidth: 1
            strokeColor: Qt.lighter(LingmoUI.Theme.backgroundColor, 1.5)
    ...
    Target {
        ...
        anchors {
            left: parent.left
            leftMargin: LingmoUI.Units.gridUnit * 4
            top: parent.top
            topMargin: LingmoUI.Units.gridUnit * 4
        }
    }
    ...
    Target {
        ...
        anchors {
            right: parent.right
            rightMargin: LingmoUI.Units.gridUnit * 4
            top: parent.top
            topMargin: LingmoUI.Units.gridUnit * 4
        }
    }
    ...
    Target {
        ...
        anchors {
            ...
            bottomMargin: LingmoUI.Units.gridUnit * 4
        }
    }
