...
import org.kde.lingmo.tablet.kcm
...
SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        QQC2.ComboBox {
            id: combo
            LingmoUI.FormData.label: i18ndc("kcm_tablet", "@label:listbox The device we are configuring", "Device:")
        ...
        QQC2.ComboBox {
            id: outputsCombo
            LingmoUI.FormData.label: i18nd("kcm_tablet", "Map to screen:")
            model: OutputsModel {
                id: outputsModel
            }
        ...
        QQC2.ComboBox {
            LingmoUI.FormData.label: i18nd("kcm_tablet", "Orientation:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nd("kcm_tablet", "Left-handed mode:")
            LingmoUI.FormData.buddyFor: leftHandedCheckbox
            spacing: 0
        ...
        QQC2.ComboBox {
            ...
            LingmoUI.FormData.label: i18nd("kcm_tablet", "Mapped Area:")
        ...
        Item {
            ...
            Rectangle {
                id: tabletItem
                color: LingmoUI.Theme.activeBackgroundColor
                opacity: 0.8
        ...
        Repeater {
            ...
            delegate: KeySequenceItem {
                id: seq
                LingmoUI.FormData.label: (pressed ? "<b>" : "") + modelData.text + (pressed ? "</b>" : "")
        ...
        QQC2.ComboBox {
            LingmoUI.FormData.label: i18ndc("kcm_tablet", "@label:listbox The pad we are configuring", "Pad:")
            model: kcm.padsModel
        ...
        Repeater {
            ...
            delegate: KeySequenceItem {
                id: seq
                LingmoUI.FormData.label: (pressed ? "<b>" : "") + i18nd("kcm_tablet", "Pad button %1:", modelData + 1) + (pressed ? "</b>" : "")
                property bool pressed: false
