    ...
    , m_padsModel(new DevicesModel("tabletPad", this))
{
    ...
    qmlRegisterType<OutputsModel>("org.kde.lingmo.tablet.kcm", 1, 0, "OutputsModel");
    qmlRegisterType<OrientationsModel>("org.kde.lingmo.tablet.kcm", 1, 0, "OrientationsModel");
    qmlRegisterType<OutputsFittingModel>("org.kde.lingmo.tablet.kcm", 1, 1, "OutputsFittingModel");
    qmlRegisterType<TabletEvents>("org.kde.lingmo.tablet.kcm", 1, 1, "TabletEvents");
    qmlRegisterAnonymousType<InputDevice>("org.kde.lingmo.tablet.kcm", 1);
    qmlRegisterType<CalibrationTool>("org.kde.lingmo.tablet.kcm", 1, 1, "CalibrationTool");
