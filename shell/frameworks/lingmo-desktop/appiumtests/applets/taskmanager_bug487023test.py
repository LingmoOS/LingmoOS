...
WIDGET_ID: Final = "org.kde.lingmo.taskmanager"
...
class Bug487023Test(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        options.set_capability("app", f"lingmowindowed -p org.kde.lingmo.desktop {WIDGET_ID}")
    ...
    def test_1_bug487023_group_dialog(self) -> None:
        ...
        subprocess.check_call(["lingmowindowed", "--config"])
        ...
        options.set_capability("environ", {
            "LC_ALL": "en_US.UTF-8",
            "QT_FATAL_WARNINGS": "1",
            "QT_LOGGING_RULES": "qt.accessibility.atspi.warning=false;kf.lingmo.core.warning=false;kf.windowsystem.warning=false;kf.lingmoui.platform.warning=false;org.kde.lingmo.notificationmanager.warning=false;org.kde.lingmo.taskmanager.warning=false",
        })
        options.set_capability("app", f"lingmowindowed -p org.kde.lingmo.desktop {WIDGET_ID}")
        options.set_capability("timeouts", {'implicit': 10000})
