...
CMAKE_BINARY_DIR: Final = os.environ.get("CMAKE_BINARY_DIR", os.path.join(pathlib.Path.home(), "kde/build/lingmo-desktop/bin"))
...
def start_lingmoshell() -> tuple:
    """
    Launches plashashell and returns the subprocess instances
    """
    kactivitymanagerd = start_kactivitymanagerd()
    kded = start_kded()
    lingmoshell = subprocess.Popen(["lingmoshell", "-p", "org.kde.lingmo.desktop", "--no-respawn"], stdout=sys.stderr, stderr=sys.stderr)

    return (kactivitymanagerd, kded, lingmoshell)
...
class DesktopTest(unittest.TestCase):
    ...
    lingmoshell: subprocess.Popen | None = None
    ...
    def setUpClass(cls) -> None:
        ...
        """
        cls.kactivitymanagerd, cls.kded, cls.lingmoshell = start_lingmoshell()
    ...
    def tearDown(self) -> None:
        ...
        if not self._outcome.result.wasSuccessful():
            self.driver.get_screenshot_as_file(f"failed_test_shot_lingmoshell_#{self.id()}.png")
    ...
    def tearDownClass(cls) -> None:
        ...
        """
        if cls.lingmoshell is not None:
            subprocess.check_output(["kquitapp6", "lingmoshell"], stderr=sys.stderr)
            assert cls.lingmoshell.wait(30) == 0, cls.lingmoshell.returncode
    ...
    def test_1_containment_config_dialog_2_add_new_wallpaper(self) -> None:
        ...
        @see https://invent.kde.org/lingmo/lingmo-integration/-/merge_requests/117
        """
    ...
    def test_3_open_panel_edit_mode(self) -> None:
        ...
        Consolidates https://invent.kde.org/frameworks/lingmo-framework/-/commit/3bb099a427cacd44fef7668225d8094f952dd5b2
        """
        # Alt+D, E
    ...
    def test_5_bug477185_meta_number_shortcut(self) -> None:
        ...
        message: Gio.DBusMessage = Gio.DBusMessage.new_method_call("org.kde.lingmoshell", "/LingmoShell", "org.kde.LingmoShell", "evaluateScript")
        message.set_body(GLib.Variant("(s)", [f"panels().forEach(containment => containment.widgets('org.kde.lingmo.icontasks').forEach(widget => {{widget.currentConfigGroup = ['General'];widget.writeConfig('launchers', 'file://{desktopfile_path}');}}))"]))
        ...
        message = Gio.DBusMessage.new_method_call("org.kde.kglobalaccel", "/component/lingmoshell", "org.kde.kglobalaccel.Component", "invokeShortcut")
    ...
    def test_6_sentry_3516_load_layout(self) -> None:
        ...
        message: Gio.DBusMessage = Gio.DBusMessage.new_method_call("org.kde.lingmoshell", "/LingmoShell", "org.kde.LingmoShell", "loadLookAndFeelDefaultLayout")
        message.set_body(GLib.Variant("(s)", ["Ocean Dark"]))
    ...
    def test_7_bug_query_accent_color_binding_loop(self) -> None:
        ...
        2. LingmoUI.ImageColors.update()
        3. LingmoUI.ImageColors emits paletteChanged()
        ...
        for i in range(2):
            ...
            message: Gio.DBusMessage = Gio.DBusMessage.new_method_call("org.kde.lingmoshell", "/LingmoShell", "org.kde.LingmoShell", "color")
            reply, _ = session_bus.send_message_with_reply_sync(message, Gio.DBusSendMessageFlags.NONE, 1000)
