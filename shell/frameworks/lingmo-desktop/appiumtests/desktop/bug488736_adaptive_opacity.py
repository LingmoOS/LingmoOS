...
from desktoptest import start_lingmoshell
...
class Bug488736Test(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        assert cls.lingmoshell is not None
    ...
    def test_1_defloat_panel_and_set_color_background(self) -> None:
        ...
        message = Gio.DBusMessage.new_method_call(LINGMOSHELL_SERVICE_NAME, "/LingmoShell", "org.kde.LingmoShell", "setWallpaper")
