...
class Bug476968Test(unittest.TestCase):
    """
    lingmoshell crashes when clicking configure button in System Tray settings window for applets without an overridden configure action
    """
    ...
    def setUpClass(cls) -> None:
        ...
        options.set_capability("app", "lingmoshell -p org.kde.lingmo.desktop --no-respawn")
    ...
    def test_bug476968(self) -> None:
        ...
        wait.until(EC.presence_of_element_located((AppiumBy.NAME, "Show hidden icons"))).click()  # lingmo-workspace/applets/systemtray/package/contents/ui/ExpanderArrow.qml
