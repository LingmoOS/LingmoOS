...
class Bug472909Test(unittest.TestCase):
    ...
    def test_bug472909(self) -> None:
        ...
        message = Gio.DBusMessage.new_method_call("org.kde.kglobalaccel", "/component/lingmoshell", "org.kde.kglobalaccel.Component", "allShortcutInfos")
