...
/**
    ...
    @see https://invent.kde.org/lingmo/lingmo-workspace/-/merge_requests/2232
    @since 6.0
*/

const containments = desktops().concat(panels());

containments.forEach(containment => containment.widgets("org.kde.lingmo.digitalclock").forEach(widget => {
