...
/**
    ...
    @see https://invent.kde.org/lingmo/kdelingmo-addons/-/merge_requests/238
    @since 5.27
*/
desktops().forEach(containment => containment.widgets("org.kde.lingmo.mediaframe").forEach(widget => {
