...
Item {
    ...
    Connections {
        ...
        function onFailed(kind) {
            ...
            const msg = i18nd("lingmo_shell_org.kde.lingmo.desktop", "Unlocking failed");
    ...
    MouseArea {
        ...
        StackView {
            ...
            height: lockScreenRoot.height + LingmoUI.Units.gridUnit * 3
            ...
            initialItem: MainBlock {
                ...
                notificationMessage: {
                    ...
                    if (capsLockState.locked) {
                        parts.push(i18nd("lingmo_shell_org.kde.lingmo.desktop", "Caps Lock is on"));
                    }
                    if (root.notification) {
                ...
                actionItems: [
                    ActionButton {
                        text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Sleep")
                        icon.name: "system-suspend"
                        onClicked: root.suspendToRam()
                        visible: root.suspendToRamSupported
                    },
                    ActionButton {
                        text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Hibernate")
                        icon.name: "system-suspend-hibernate"
                        onClicked: root.suspendToDisk()
                        visible: root.suspendToDiskSupported
                    },
                    ActionButton {
                        text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Switch User")
                ...
                Loader {
                    Layout.topMargin: LingmoUI.Units.smallSpacing // some distance to the password field
        ...
        RowLayout {
            ...
            LingmoComponents3.ToolButton {
                ...
                text: i18ndc("lingmo_shell_org.kde.lingmo.desktop", "Button to show/hide virtual keyboard", "Virtual Keyboard")
            ...
            LingmoComponents3.ToolButton {
                ...
                focusPolicy: Qt.TabFocus
                Accessible.description: i18ndc("lingmo_shell_org.kde.lingmo.desktop", "Button to change keyboard layout", "Switch layout")
