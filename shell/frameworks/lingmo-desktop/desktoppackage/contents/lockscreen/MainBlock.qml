...
SessionManagementScreen {
    ...
    onHeightChanged: visibleBoundary = mapFromItem(loginButton, 0, 0).y + loginButton.height + LingmoUI.Units.smallSpacing
    /*
    ...
    RowLayout {
        ...
        LingmoExtras.PasswordField {
            ...
            placeholderText: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Password")
            focus: true
        ...
        LingmoComponents3.Button {
            id: loginButton
            Accessible.name: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Unlock")
    ...
    component FailableLabel : LingmoComponents3.Label {
        id: _failableLabel
    ...
    FailableLabel {
        ...
        label: i18nd("lingmo_shell_org.kde.lingmo.desktop", "(or scan your fingerprint on the reader)")
    }
    FailableLabel {
        kind: ScreenLocker.Authenticator.Smartcard
        label: i18nd("lingmo_shell_org.kde.lingmo.desktop", "(or scan your smartcard)")
    }
}
