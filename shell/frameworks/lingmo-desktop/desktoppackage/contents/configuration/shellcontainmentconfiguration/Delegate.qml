...
QQC2.Control {
    ...
    width: Math.min(LingmoUI.Units.gridUnit * 25, Math.floor(viewPort.width / Math.min(repeater.count, Math.floor(viewPort.width / (LingmoUI.Units.gridUnit * 12)))))

    contentItem: ColumnLayout {
        id: contentsLayout
        width: Math.min(parent.width, LingmoUI.Units.gridUnit * 15)
                    ...
                    QQC2.Button {
                        ...
                        anchors {
                            ...
                            topMargin: model.edge == "floating"
                                ? model.panelCountAtTop * moveButton.height + LingmoUI.Units.largeSpacing
                                : 0
                            rightMargin: model.edge == "floating"
                                ? (moveButton.LayoutMirroring.enabled ? model.panelCountAtLeft : model.panelCountAtRight) * moveButton.height + LingmoUI.Units.largeSpacing
                                : 0
                        }
                        onClicked: {
                            contextMenu.open()
                        ...
                        QQC2.Menu {
                            ...
                            Repeater {
                                ...
                                QQC2.MenuItem {
                                    text: edge == "floating"
                                        ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "Swap with Desktop on Screen %1", model.screenName)
                                        : i18nd("lingmo_shell_org.kde.lingmo.desktop", "Move to Screen %1", model.screenName)
                            ...
                            QQC2.MenuItem {
                                ...
                                text: contRect.state === "floating"
                                    ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "Remove Desktop")
                                    : i18nd("lingmo_shell_org.kde.lingmo.desktop", "Remove Panel")
        ...
        QQC2.Label {
            ...
            text: model.isPrimary
                ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "%1 (primary)", model.screenName)
                : model.screenName
