...
Rectangle {
    ...
    Layout.minimumWidth: LingmoUI.Units.gridUnit * 30
    Layout.minimumHeight: LingmoUI.Units.gridUnit * 21
    ...
    ConfigModel {
        ...
        ConfigCategory {
            name: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Keyboard Shortcuts")
    ...
    QQC2.ScrollView {
        ...
        width: LingmoUI.Units.gridUnit * 7
        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                model: ConfigModel {
                    ConfigCategory{
                        name: i18nd("lingmo_shell_org.kde.lingmo.desktop", "About")
                        icon: "help-about"
    ...
    LingmoUI.ApplicationItem {
        ...
        pageStack.globalToolBar.style: LingmoUI.ApplicationHeaderStyle.Breadcrumb
        wideScreen: true
        pageStack.globalToolBar.separatorVisible: bottomSeparator.visible
        pageStack.globalToolBar.colorSet: LingmoUI.Theme.Window
        ...
        LingmoUI.PromptDialog {
            id: messageDialog
            property var item
            title: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Apply Settings")
            subtitle: i18nd("lingmo_shell_org.kde.lingmo.desktop", "The settings of the current module have changed. Do you want to apply the changes or discard them?")
            standardButtons: LingmoUI.Dialog.Apply | LingmoUI.Dialog.Discard | LingmoUI.Dialog.Cancel
            onApplied: {
                applyAction.trigger()
                discarded();
            }
        ...
        footer: QQC2.Pane {
            ...
            contentItem: RowLayout {
                ...
                QQC2.Button {
                    icon.name: "dialog-ok"
                    text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "OK")
                ...
                QQC2.Button {
                    ...
                    text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Apply")
                ...
                QQC2.Button {
                    ...
                    text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Cancel")
