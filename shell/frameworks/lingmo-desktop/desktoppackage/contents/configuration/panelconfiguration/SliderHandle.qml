...
KSvg.SvgItem {
    ...
    MouseArea {
        ...
        anchors {
            fill: parent
            leftMargin: (dialogRoot.vertical) ? 0 : -LingmoUI.Units.gridUnit
            rightMargin: (dialogRoot.vertical) ? 0 : -LingmoUI.Units.gridUnit
            topMargin: (dialogRoot.vertical) ? -LingmoUI.Units.gridUnit : 0
            bottomMargin: (dialogRoot.vertical) ? -LingmoUI.Units.gridUnit : 0
        }
