...
KSvg.FrameSvgItem {
    ...
    property string maximumText: (dialogRoot.vertical ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "Drag to change maximum height.") : i18nd("lingmo_shell_org.kde.lingmo.desktop", "Drag to change maximum width.")) + "\n" + i18nd("lingmo_shell_org.kde.lingmo.desktop", "Double click to reset.")
    property string minimumText: (dialogRoot.vertical ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "Drag to change minimum height.") : i18nd("lingmo_shell_org.kde.lingmo.desktop", "Drag to change minimum width.")) + "\n" + i18nd("lingmo_shell_org.kde.lingmo.desktop", "Double click to reset.")
    ...
    SliderHandle {
        ...
        description: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Drag to change position on this screen edge.\nDouble click to reset.")
    ...
    SliderHandle {
        ...
        minimumPosition: offsetHandle.position + LingmoUI.Units.gridUnit * 3
        maximumPosition: {
            var rootSize = dialogRoot.vertical ? root.height : root.width
            var size = dialogRoot.vertical ? height : width
    ...
    SliderHandle {
        ...
        graphicElementName: "maxslider"
        onValueChanged: panel.minimumLength = value
        maximumPosition: offsetHandle.position - LingmoUI.Units.gridUnit * 3
        minimumPosition: {
            var size = dialogRoot.vertical ? height : width
