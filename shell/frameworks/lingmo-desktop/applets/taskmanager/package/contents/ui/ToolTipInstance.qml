...
ColumnLayout {
    ...
    RowLayout {
        id: header
        // match spacing of DefaultToolTip.qml in lingmo-framework
        spacing: isWin ? LingmoUI.Units.smallSpacing : LingmoUI.Units.gridUnit
        ...
        // match margins of DefaultToolTip.qml in lingmo-framework
        Layout.margins: isWin ? 0 : LingmoUI.Units.gridUnit / 2
    ...
    Item {
        ...
        // There's no LingmoComponents3 version
            ...
            Component {
                ...
                LingmoUI.Icon {
                    ...
                    SequentialAnimation {
                        ...
                        PauseAnimation {
                            duration: LingmoUI.Units.humanMoment
                        }
        ...
        Loader {
            ...
            asynchronous: true
            //In a loader since we might not have PipeWire available yet (WITH_PIPEWIRE could be undefined in lingmo-workspace/libtaskmanager/declarative/taskmanagerplugin.cpp)
    ...
    Loader {
        ...
        sourceComponent: RowLayout {
            LingmoComponents3.ToolButton { // Mute button
            ...
            LingmoComponents3.Label { // percent label
