...
import org.kde.lingmo.workspace.trianglemousefilter 1.0
...
PlasmoidItem {
    ...
    property bool iconsOnly: Plasmoid.pluginName === "org.kde.lingmo.icontasks"
    ...
    Layout.minimumWidth: {
        if (shouldShrinkToZero) {
            return LingmoUI.Units.gridUnit; // For edit mode
        }
...
//BEGIN TODO: this is not precise enough: launchers are smaller than full tasks
    Layout.preferredWidth: {
        ...
        if (tasks.vertical) {
            return LingmoUI.Units.gridUnit * 10;
        }
    ...
    Layout.preferredHeight: {
        ...
        return LingmoUI.Units.gridUnit * 2;
    }
//END TODO
    ...
    property Component taskInitComponent: Component {
        Timer {
            ...
            interval: LingmoUI.Units.longDuration
            running: true
    ...
    Item {
        ...
        Binding {
            ...
            value: (tasksModel.anyTaskDemandsAttention && Plasmoid.configuration.unhideOnAttention
                ? LingmoCore.Types.NeedsAttentionStatus : LingmoCore.Types.PassiveStatus)
    ...
    function addLauncher(url) {
        if (Plasmoid.immutability !== LingmoCore.Types.SystemImmutable) {
    ...
    // This is called by lingmoshell in response to a Meta+number shortcut.
