...
import org.kde.lingmo.private.trash as TrashPrivate
...
PlasmoidItem {
    ...
    fullRepresentation: MouseArea {
        ...
        DragDrop.DropArea {
            ...
            onDrop: {
                ...
                if (trashableUrls.length > 0) {
                    ...
                    event.accept(Qt.IgnoreAction) // prevent Lingmo from spawning an applet
                }
            }
        }
        ...
        LingmoExtras.ShadowedLabel {
            ...
            width: Math.round(text.implicitWidth + LingmoUI.Units.smallSpacing) // make sure label is not blurry
            text: Plasmoid.title + "\n" + root.toolTipSubText
