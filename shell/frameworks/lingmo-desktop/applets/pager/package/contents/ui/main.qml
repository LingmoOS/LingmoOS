...
import org.kde.lingmo.private.pager 2.0
...
PlasmoidItem {
    ...
    Plasmoid.status: pagerModel.shouldShowPager ? LingmoCore.Types.ActiveStatus : LingmoCore.Types.HiddenStatus
    ...
    readonly property color windowActiveOnActiveDesktopColor: colorWithAlpha(LingmoUI.Theme.textColor, 0.6)
    readonly property color windowInactiveOnActiveDesktopColor: colorWithAlpha(LingmoUI.Theme.textColor, 0.35)
    readonly property color windowActiveColor: colorWithAlpha(LingmoUI.Theme.textColor, 0.5)
    readonly property color windowActiveBorderColor: LingmoUI.Theme.textColor
    readonly property color windowInactiveColor: colorWithAlpha(LingmoUI.Theme.textColor, 0.17)
    readonly property color windowInactiveBorderColor: colorWithAlpha(LingmoUI.Theme.textColor, 0.5)
    ...
    Component {
        ...
        LingmoComponents3.Label {
            ...
            font.pixelSize: Math.min(height, LingmoUI.Theme.defaultFont.pixelSize)
    ...
    Component {
        ...
        LingmoUI.Icon {
            ...
            height: Math.min(LingmoUI.Units.iconSizes.small,
                             parent.height,
                             Math.max(parent.height - (LingmoUI.Units.smallSpacing * 2),
                                      LingmoUI.Units.smallSpacing * 2))
            width: Math.min(LingmoUI.Units.iconSizes.small,
                            parent.width,
                            Math.max(parent.width - (LingmoUI.Units.smallSpacing * 2),
                                     LingmoUI.Units.smallSpacing * 2))
        ...
        Repeater {
            ...
            LingmoCore.ToolTipArea {
                ...
                component PagerFrame : KSvg.FrameSvgItem {
                    ...
                    Behavior on opacity { OpacityAnimator { duration: LingmoUI.Units.longDuration; easing.type: Easing.OutCubic } }
                }
                ...
                Item {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            Behavior on width  { NumberAnimation { duration: LingmoUI.Units.longDuration; easing.type: Easing.OutCubic } }
                            Behavior on height { NumberAnimation { duration: LingmoUI.Units.longDuration; easing.type: Easing.OutCubic } }
                            Behavior on color        { ColorAnimation  { duration: LingmoUI.Units.longDuration; easing.type: Easing.OutCubic } }
                            Behavior on border.color { ColorAnimation  { duration: LingmoUI.Units.longDuration; easing.type: Easing.OutCubic } }
