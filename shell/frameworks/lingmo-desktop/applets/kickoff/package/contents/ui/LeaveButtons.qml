...
RowLayout {
    ...
    RowLayout {
        ...
        Repeater {
            ...
            delegate: PC3.ToolButton {
                ...
                Layout.rightMargin: model.favoriteId === "switch-user" && root.__layout.allActionsArePrimary ? LingmoUI.Units.gridUnit : undefined
    ...
    // Just like LingmoUI.ActionToolBar, it takes two actual instances of a
    ...
    component OverflowMenuButton : PC3.ToolButton {
        ...
        down: contextMenu.status === LingmoExtras.Menu.Open || pressed
        PC3.ToolTip.text: text
    ...
    LingmoExtras.Menu {
        ...
        placement: {
            ...
            case LingmoCore.Types.TopEdge:
                return LingmoExtras.Menu.BottomPosedRightAlignedPopup;
            case LingmoCore.Types.BottomEdge:
            default:
                return LingmoExtras.Menu.TopPosedRightAlignedPopup;
            }
        }
    }
}
