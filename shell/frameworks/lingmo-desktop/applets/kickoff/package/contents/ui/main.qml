...
PlasmoidItem {
    ...
    readonly property Kicker.RootModel rootModel: Kicker.RootModel {
        ...
        Component.onCompleted: {
            favoritesModel.initForClient("org.kde.lingmo.kickoff.favorites.instance-" + Plasmoid.id)
    ...
    readonly property KSvg.FrameSvgItem backgroundMetrics: KSvg.FrameSvgItem {
        ...
        visible: false
        imagePath: Plasmoid.formFactor === LingmoCore.Types.Planar ? "widgets/background" : "dialogs/background"
    }
    ...
    compactRepresentation: MouseArea {
        ...
        readonly property bool shouldHaveIcon: Plasmoid.formFactor === LingmoCore.Types.Vertical || Plasmoid.icon !== ""
        readonly property bool shouldHaveLabel: Plasmoid.formFactor !== LingmoCore.Types.Vertical && Plasmoid.configuration.menuLabel !== ""

        readonly property int iconSize: LingmoUI.Units.iconSizes.large
        ...
        readonly property var sizing: {
            ...
            if (kickoff.inPanel) {
                ...
                return {
                    preferredWidth: impWidth,
                    preferredHeight: LingmoUI.Units.iconSizes.small,
                };
            }
        }
        ...
        RowLayout {
            ...
            LingmoUI.Icon {
                ...
                Layout.maximumHeight: LingmoUI.Units.iconSizes.huge
                Layout.maximumWidth: LingmoUI.Units.iconSizes.huge
            ...
            PC3.Label {
                ...
                font.pixelSize: compactRoot.tooSmall ? LingmoUI.Theme.defaultFont.pixelSize : LingmoUI.Units.iconSizes.roundedIconSize(LingmoUI.Units.gridUnit * 2)
    ...
    Plasmoid.contextualActions: [
        LingmoCore.Action {
            ...
            icon.name: "kmenuedit"
            visible: Plasmoid.immutability !== LingmoCore.Types.SystemImmutable
