...
FocusScope {
    ...
    property var horizontalScrollBarPolicy: LingmoComponents.ScrollBar.AlwaysOff
    property var verticalScrollBarPolicy: LingmoComponents.ScrollBar.AsNeeded
    ...
    DropArea {
        ...
        LingmoComponents.ScrollView {
            ...
            LingmoComponents.ScrollBar.horizontal.policy: itemGrid.horizontalScrollBarPolicy
            ...
            GridView {
                ...
                property int iconSize: LingmoUI.Units.iconSizes.huge
