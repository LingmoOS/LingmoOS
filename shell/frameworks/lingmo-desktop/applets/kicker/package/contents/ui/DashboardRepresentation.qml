...
Kicker.DashboardWindow {
    ...
    property bool smallScreen: ((Math.floor(width / LingmoUI.Units.iconSizes.huge) <= 22) || (Math.floor(height / LingmoUI.Units.iconSizes.huge) <= 14))

    property int iconSize: smallScreen ? LingmoUI.Units.iconSizes.large : LingmoUI.Units.iconSizes.huge
    property int cellSize: iconSize + (2 * LingmoUI.Units.iconSizes.sizeForLabels)
        + (2 * LingmoUI.Units.smallSpacing)
    ...
    mainItem: MouseArea {
        ...
        Row {
            ...
            anchors {
                top: parent.top
                topMargin: LingmoUI.Units.gridUnit * (smallScreen ? 8 : 10)
                bottom: parent.bottom
                bottomMargin: (LingmoUI.Units.gridUnit * 2)
                horizontalCenter: parent.horizontalCenter
            }
            ...
            Item {
                ...
                width: (columns * root.cellSize) + LingmoUI.Units.gridUnit
                ...
                LingmoUI.Heading {
                    ...
                    Behavior on opacity { SmoothedAnimation { duration: LingmoUI.Units.longDuration; velocity: 0.01 } }
                }
                ...
                ItemGridView {
                    ...
                    property int rows: (Math.floor((parent.height - favoritesColumnLabel.height
                        - favoritesColumnLabelUnderline.height - LingmoUI.Units.gridUnit) / root.cellSize)
            ...
            Item {
                ...
                Item {
                    ...
                    property int headerHeight: mainColumnLabel.height + mainColumnLabelUnderline.height + LingmoUI.Units.gridUnit
            ...
            Item {
                ...
                anchors {
                    top: parent.top
                    topMargin: mainColumnLabelUnderline.y + mainColumnLabelUnderline.height + LingmoUI.Units.gridUnit
                    bottom: parent.bottom
                }
                ...
                LingmoComponents.ScrollView {
                    ...
                    x: root.visible ? 0 : LingmoUI.Units.gridUnit

                    Behavior on x { SmoothedAnimation { duration: LingmoUI.Units.longDuration; velocity: 0.01 } }
                    ...
                    LingmoComponents.ScrollBar.vertical.policy: (opacity === 1.0) ? LingmoComponents.ScrollBar.AsNeeded : LingmoComponents.ScrollBar.AlwaysOff
                    ...
                    ListView {
                        ...
                        onCountChanged: {
                            ...
                            filterListScrollArea.width = width + hItemMargins + (LingmoUI.Units.gridUnit * 2);
                        }
