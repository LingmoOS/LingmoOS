...
PlasmoidItem {
    ...
    // this is a bit of a hack to prevent Lingmo from spawning a dialog on its own when we're Dash
    ...
    Kicker.RootModel {
        ...
        Component.onCompleted: {
            favoritesModel.initForClient("org.kde.lingmo.kicker.favorites.instance-" + Plasmoid.id)
    ...
    Kicker.DragHelper {
        ...
        dragIconSize: LingmoUI.Units.iconSizes.medium
    }
    ...
    Component.onCompleted: {
        ...
        updateSvgMetrics();
        LingmoCore.Theme.themeChanged.connect(updateSvgMetrics);
