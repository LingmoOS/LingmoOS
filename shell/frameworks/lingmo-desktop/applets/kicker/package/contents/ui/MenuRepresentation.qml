...
FocusScope {
    ...
    Layout.minimumHeight: Math.max(((rootModel.count - rootModel.separatorCount) * rootList.itemHeight)
        ...
        + searchField.height + (2 * LingmoUI.Units.smallSpacing), sideBar.margins.top + sideBar.margins.bottom
        + favoriteApps.contentHeight + favoriteSystemActions.contentHeight + sidebarSeparator.height
        + (4 * LingmoUI.Units.smallSpacing))
    ...
    Row {
        ...
        LayoutMirroring.enabled: ((Plasmoid.location === LingmoCore.Types.RightEdge)
            || (Qt.application.layoutDirection === Qt.RightToLeft && Plasmoid.location !== LingmoCore.Types.LeftEdge))
        ...
        KSvg.FrameSvgItem {
            ...
            width: (globalFavorites && systemFavorites
                ...
                ? LingmoUI.Units.iconSizes.medium + margins.left + margins.right : 0)
            height: parent.height
            ...
            SideBarSection {
                ...
                height: (sideBar.height - sideBar.margins.top - sideBar.margins.bottom
                    - favoriteSystemActions.height - sidebarSeparator.height - (4 * LingmoUI.Units.smallSpacing))
                ...
                Binding {
                    ...
                    property: "iconSize"
                    value: LingmoUI.Units.iconSizes.medium
            ...
            KSvg.SvgItem {
                ...
                anchors.bottomMargin: (2 * LingmoUI.Units.smallSpacing)
                ...
                states: State {
                    ...
                    PropertyChanges {
                        target: sidebarSeparator
                        anchors.topMargin: (2 * LingmoUI.Units.smallSpacing)
    ...
    LingmoExtras.SearchField {
        ...
        anchors.leftMargin: sideBar.width + (sideBar.width ? mainRow.spacing : LingmoUI.Units.smallSpacing)

        readonly property real defaultWidth: LingmoUI.Units.gridUnit * 14
        ...
        states: [
            State {
                ...
                PropertyChanges {
                    target: searchField
                    anchors.leftMargin: sideBar.width + mainRow.spacing + LingmoUI.Units.smallSpacing
                    anchors.rightMargin: undefined
                }
            },
            State {
                name: "right"
                when: (Plasmoid.location === LingmoCore.Types.RightEdge && Qt.application.layoutDirection === Qt.LeftToRight)
                    || (Plasmoid.location === LingmoCore.Types.LeftEdge && Qt.application.layoutDirection === Qt.RightToLeft)
                ...
                PropertyChanges {
                    ...
                    anchors.rightMargin: sideBar.width + mainRow.spacing + LingmoUI.Units.smallSpacing
                }
            }
        ]
