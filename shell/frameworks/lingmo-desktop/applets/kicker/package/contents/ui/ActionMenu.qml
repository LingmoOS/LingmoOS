...
QtObject {
    ...
    readonly property bool opened: __menu ? (__menu.status !== LingmoExtras.Menu.Closed) : false

    property LingmoExtras.Menu __menu
    ...
    function __fillMenu(menu: LingmoExtras.Menu, actionItems: var): void {
    ...
    readonly property list<QtObject> __data: [
        ...
        Component {
            ...
            LingmoExtras.MenuItem {
                ...
                readonly property LingmoExtras.Menu submenu: LingmoExtras.Menu {
