...
MouseArea {
    ...
    onPositionChanged: mouse => {
        if (pressed) {
            ...
            var padding = LingmoUI.Units.gridUnit * 5;
            ...
            if (Plasmoid.formFactor === LingmoCore.Types.Vertical && currentApplet) {
    ...
    Timer {
        id: hideTimer
        interval: LingmoUI.Units.longDuration * 5
    ...
    LingmoCore.PopupLingmoWindow {
        ...
        margin: configurationArea.Window.window?.lengthMode === 2 ? LingmoUI.Units.gridUnit * 2 : 0
        ...
        mainItem: MouseArea {
            ...
            ColumnLayout {
                ...
                LingmoComponents3.ToolButton {
                    ...
                    // a top panel
                    visible: tooltip.location !== LingmoCore.Types.TopEdge
                ...
                LingmoComponents3.SpinBox {
                    id: panelSpacerWidth
                    editable: true
                    Layout.fillWidth: true
                    focus: !LingmoUI.InputMethod.willShowOnActive
                    visible: configurationArea.currentApplet?.applet.plasmoid.pluginName === "org.kde.lingmo.panelspacer"
