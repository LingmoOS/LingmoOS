...
function addApplet(applet, x, y) {
    ...
    appletItem.visible = Qt.binding(function() {
        return applet.status !== LingmoCore.Types.HiddenStatus || (!root.plasmoid.immutable && root.plasmoid.userConfiguring);
    });
    ...
    // since Lingmo 1. However, "add launcher to X" is a generic-enough concept and
    ...
    if (applet.pluginName === "org.kde.lingmo.icon" && x === 0 && y === 0 &&
