...
//BEGIN properties
    ...
    property bool isHorizontal: Plasmoid.formFactor !== LingmoCore.Types.Vertical
...
//END connections
    ...
    DragDrop.DropArea {
        ...
        readonly property real spacingAtMinSize: Math.floor(Math.max(1, (isHorizontal ? root.height : root.width) - LingmoUI.Units.iconSizes.smallMedium)/2)
...
//BEGIN components
        Component {
            ...
            Loader {
                ...
                visible: applet.plasmoid?.status !== LingmoCore.Types.HiddenStatus || (!Plasmoid.immutable && Plasmoid.userConfiguring);
...
//BEGIN UI elements
        ...
        Item {
            ...
            width: isHorizontal ? LingmoUI.Units.iconSizes.sizeForLabels * 5 : currentLayout.width
            height: isHorizontal ? currentLayout.height : LingmoUI.Units.iconSizes.sizeForLabels * 5
        }
    ...
    MouseArea {
        ...
        Accessible.description: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Open Panel configuration ui")
    ...
    PC3.ToolButton {
        ...
        text: isHorizontal ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "Add Widgets…") : undefined
