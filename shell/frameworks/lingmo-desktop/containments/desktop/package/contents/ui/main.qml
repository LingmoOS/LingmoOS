...
ContainmentItem {
    ...
    function switchSize() {
        ...
        if (isPopup && Plasmoid.formFactor === LingmoCore.Types.Vertical) {
            return LingmoUI.Units.gridUnit * 8;
        }
    ...
    property bool isFolder: (Plasmoid.pluginName === "org.kde.lingmo.folder")
    property bool isContainment: Plasmoid.isContainment
    property bool isPopup: (Plasmoid.location !== LingmoCore.Types.Floating)
    ...
    function preferredWidth(forMinimumSize: bool): real {
        if (isContainment || !folderViewLayer.ready) {
            ...
            return (forMinimumSize ? folderViewLayer.view.cellHeight * 4 : LingmoUI.Units.gridUnit * 16);
        }

        return (folderViewLayer.view.cellWidth * (forMinimumSize ? 1 : 3)) + (LingmoUI.Units.gridUnit * 2);
    }
    ...
    function preferredHeight(forMinimumSize: bool): real {
        ...
        if (isContainment || !folderViewLayer.ready) {
            ...
            height = (folderViewLayer.view.cellHeight * (forMinimumSize ? 1 : 15)) + LingmoUI.Units.smallSpacing;
        } else {
            height = (folderViewLayer.view.cellHeight * (forMinimumSize ? 1 : 2)) + LingmoUI.Units.gridUnit;
        }
    ...
    fullRepresentation: FolderViewDropArea {
        ...
        ContainmentLayoutManager.AppletsLayout {
            ...
            minimumItemWidth: LingmoUI.Units.gridUnit * 3
            minimumItemHeight: minimumItemWidth

            cellWidth: LingmoUI.Units.iconSizes.small
