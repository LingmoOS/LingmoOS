...
ColumnLayout {
    ...
    LingmoUI.FormLayout {
        ComboBox {
            id: filterMode
            LingmoUI.FormData.label: i18n("Files:")
            model: [i18n("Show all"), i18n("Show matching"), i18n("Hide matching")]
        }

        TextField {
            id: filterPattern
            LingmoUI.FormData.label: i18n("File name pattern:")
        ...
        LingmoUI.SearchField {
            id: mimeFilter
            LingmoUI.FormData.label: i18n("File types:")
            enabled: (filterMode.currentIndex > 0)
        }

        CheckBox {
            id: showHiddenFiles
            LingmoUI.FormData.label: i18n("Show hidden files:")
        }
    }
    ...
    ColumnLayout {
        ...
        ScrollView {
            ...
            contentItem: ListView {
                ...
                property real columnSize: LingmoUI.Units.gridUnit * 15
        ...
        RowLayout {
            ...
            Button {
                ...
                ToolTip.visible: (LingmoUI.Settings.isMobile ? pressed : hovered) && ToolTip.text.length > 0
