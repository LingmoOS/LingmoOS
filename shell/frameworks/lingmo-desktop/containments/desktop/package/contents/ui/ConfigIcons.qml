...
Item {
    ...
    LingmoUI.FormLayout {
        ...
        RowLayout {
            ...
            LingmoUI.FormData.label: i18n("Panel button:")
            ...
            Button {
                id: iconButton
                Layout.minimumWidth: LingmoUI.Units.iconSizes.large + LingmoUI.Units.smallSpacing * 2
                ...
                onClicked: {
                    checked = Qt.binding(() =>
                        iconMenu.status === LingmoExtras.Menu.Open);
        ...
        ComboBox {
            ...
            LingmoUI.FormData.label: i18n("Arrangement:")
        ...
        ComboBox {
            ...
            LingmoUI.FormData.label: i18n("Sorting:")
        ...
        ComboBox {
            ...
            LingmoUI.FormData.label: i18nc("whether to use icon or list view", "View mode:")
        ...
        Slider {
            ...
            LingmoUI.FormData.label: i18n("Icon size:")
        ...
        ComboBox {
            ...
            LingmoUI.FormData.label: i18n("Label width:")
        ...
        SpinBox {
            ...
            LingmoUI.FormData.label: i18n("Text lines:")
        ...
        CheckBox {
            ...
            LingmoUI.FormData.label: i18n("When hovering over icons:")
        ...
        CheckBox {
            ...
            LingmoUI.FormData.label: i18n("Rename:")
        ...
        CheckBox {
            ...
            LingmoUI.FormData.label: i18n("Previews:")
