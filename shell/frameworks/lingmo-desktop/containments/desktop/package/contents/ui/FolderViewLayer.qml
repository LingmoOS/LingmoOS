...
FocusScope {
    ...
    property int labelHeight: LingmoUI.Units.iconSizes.sizeForLabels
        + (root.isPopup ? (LingmoUI.Units.smallSpacing * 2) : 0)
        ...
        Item {
            ...
            Component {
                ...
                LingmoComponents.ToolButton {
                    ...
                    width: root.isPopup ? Math.round(LingmoUI.Units.gridUnit * 1.25) : 0
                    height: width
                    checkable: true
