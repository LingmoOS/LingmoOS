        ...
        Item {
            ...
            LingmoCore.ToolTipArea {
                ...
                active: (Plasmoid.configuration.toolTips || label.truncated)
                        ...
                        && !model.blank
                interactive: false
                location: root.useListViewMode ? (Plasmoid.location === LingmoCore.Types.LeftEdge ? LingmoCore.Types.LeftEdge : LingmoCore.Types.RightEdge) : Plasmoid.location
            ...
            Loader {
                ...
                x: root.useListViewMode ? 0 : LingmoUI.Units.smallSpacing
                y: root.useListViewMode ? 0 : LingmoUI.Units.smallSpacing
                ...
                width: {
                    if (root.useListViewMode) {
                        if (main.GridView.view.overflowing) {
                            return parent.width - LingmoUI.Units.smallSpacing;
                        } else {
                            return parent.width;
                        }
                    }

                    return parent.width - (LingmoUI.Units.smallSpacing * 2);
                }

                height: root.useListViewMode
                                ? parent.height
                                // the smallSpacings are for padding
                                : icon.height + (LingmoUI.Units.gridUnit * label.lineCount) + (LingmoUI.Units.smallSpacing * 3)
                ...
                LingmoUI.Icon {
                    ...
                    width: root.useListViewMode ? main.GridView.view.iconSize : (parent.width - 2 * LingmoUI.Units.smallSpacing)
