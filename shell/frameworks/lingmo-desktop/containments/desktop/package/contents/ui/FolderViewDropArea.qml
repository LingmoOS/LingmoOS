...
DragDrop.DropArea {
    ...
    function handleDragMove(folderView, pos) {
        // Trigger autoscroll.
        folderView.scrollLeft = (pos.x < (LingmoUI.Units.gridUnit * 3));
        folderView.scrollRight = (pos.x > width - (LingmoUI.Units.gridUnit * 3));
        folderView.scrollUp = (pos.y < (LingmoUI.Units.gridUnit * 3));
        folderView.scrollDown = (pos.y > height - (LingmoUI.Units.gridUnit * 3));
