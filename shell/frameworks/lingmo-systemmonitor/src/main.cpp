...
int main(int argc, char **argv)
{
    ...
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("lingmo-systemmonitor"));

    KAboutData aboutData{/* componentName */ QStringLiteral("lingmo-systemmonitor"),
                         ...
                         /* copyrightStatement */ i18n("© 2020 Lingmo Development Team"),
                         /* otherText */ QString{},
                         /* homePageAddress */ QString{}};
    aboutData.setDesktopFileName(QStringLiteral("org.kde.lingmo-systemmonitor"));
    ...
    aboutData.setBugAddress("https://bugs.kde.org/enter_bug.cgi?product=lingmo-systemmonitor");
