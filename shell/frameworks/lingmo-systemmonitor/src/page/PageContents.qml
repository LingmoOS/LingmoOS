            ...
            sourceFalse: GridLayout {
                ...
                Repeater {
                    ...
                    ConditionalLoader {
                        ...
                        Layout.minimumHeight: item.Layout.minimumHeight + (model.data.noMargins ? 0 : LingmoUI.Units.largeSpacing * 2)
                        ...
                        component ColumnContents: RowLayout {
                            ...
                            anchors.fill: parent
                            anchors.margins: model.data.noMargins ? 0 : LingmoUI.Units.largeSpacing
                            ...
                            Repeater {
                                ...
                                ConditionalLoader {
                                    ...
                                    sourceTrue: LingmoUI.Separator { Layout.preferredWidth: 1 }
                        ...
                        sourceTrue: LingmoUI.AbstractCard {
                            anchors.fill: parent
    ...
    Component {
        ...
        Control {
            ...
            TapHandler {
                ...
                enabled: WidgetExporter.lingmoshellAvailable
                onTapped: eventPoint => {
