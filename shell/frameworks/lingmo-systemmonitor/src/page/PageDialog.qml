...
LingmoUI.Dialog {
    ...
    // No top padding since the content item is a LingmoUI.FormLayout which
    ...
    LingmoUI.FormLayout {
        ...
        Button {
            LingmoUI.FormData.label: i18nc("@label:textbox", "Icon:")
            icon.name: dialog.iconName
            onClicked: iconDialog.open()
        }
        ComboBox {
            LingmoUI.FormData.label: i18nc("@label:listbox", "Page Margins:")
        ...
        ComboBox {
            id: actionsCombobox
            LingmoUI.FormData.label: i18nc("@label:listbox", "Use Actions From:")
            visible: count > 1
            textRole: "display"
            valueRole: "id"
        ...
        ComboBox {
            LingmoUI.FormData.label: i18nc("@label:listbox", "Load this page:")
    ...
    KIconThemes.IconDialog {
        id: iconDialog
        iconSize: LingmoUI.Units.iconSizes.smallMedium
