        ...
        delegate: Item {
            ...
            ItemDelegate {
                ...
                background: Rectangle {
                    color: listItemContainer.filesWriteable == Page.PagesModel.AllWriteable && listItemContainer.shouldRemoveFiles ? LingmoUI.Theme.negativeBackgroundColor : LingmoUI.Theme.backgroundColor
                }
            }
        }
    }
