...
ToolButton {
    ...
    DragHandler {
        ...
        xAxis.minimum: root.target.parent.LingmoUI.ScenePosition.x
        xAxis.maximum: root.target.parent.LingmoUI.ScenePosition.x + root.target.parent.width - root.target.width

        yAxis.enabled: root.axis == Qt.YAxis
        yAxis.minimum: root.target.parent.LingmoUI.ScenePosition.y
        yAxis.maximum: root.target.parent.LingmoUI.ScenePosition.y + root.target.parent.height - root.target.height
