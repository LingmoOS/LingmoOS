...
FocusScope {
    ...
    property real minimumColumnWidth: LingmoUI.Units.gridUnit * 4
    ...
    ScrollView {
        ...
        background: Rectangle { color: LingmoUI.Theme.backgroundColor; LingmoUI.Theme.colorSet: LingmoUI.Theme.View }
