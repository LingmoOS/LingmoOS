...
Faces.SensorFace {
    ...
    contentItem: Item {
        ...
        Loader {
            ...
            property real minimumWidth: LingmoUI.Units.gridUnit * 8
            ...
            transitions: Transition {
                SequentialAnimation {
                    NumberAnimation { properties: "x"; duration: LingmoUI.Units.shortDuration }
    ...
    Table.KillDialog {
        ...
        delegate: LingmoUI.Padding {
            horizontalPadding: LingmoUI.Units.largeSpacing
