lingmo-systemmonitor
====================

An application for monitoring system resources.

lingmo-systemmonitor provides an interface for monitoring system sensors,
process information and other system resources. It is built on top of the faces
system also used to provide widgets for lingmo-dekstop and makes use of the
