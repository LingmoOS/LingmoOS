...
void TestTextInputV1Interface::testEnableDisable()
{
    ...
    m_clientTextInputV1->set_surrounding_text("KDE Lingmo Desktop", 0, 3);
    ...
    QCOMPARE(m_serverTextInputV1->surroundingText(), QString("KDE Lingmo Desktop"));
...
void TestTextInputV1Interface::testEvents()
{
    ...
    m_serverTextInputV1->commitString("Lingmo");
