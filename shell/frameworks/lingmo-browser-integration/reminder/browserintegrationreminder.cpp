...
#include <LingmoActivities/ResourceInstance>
#include <KConfig>
...
static const QString s_dbusServiceName = QStringLiteral("org.kde.lingmo.browser_integration");
...
BrowserIntegrationReminder::BrowserIntegrationReminder(QObject *parent, const QList<QVariant> &)
    : KDEDModule(parent)
{
    m_debug = qEnvironmentVariableIsSet("LINGMO_BROWSE_REMIND_FORCE");
    auto config = KSharedConfig::openConfig()->group(QStringLiteral("LingmoBrowserIntegration"));
    ...
    QUrl firefox(QStringLiteral("https://addons.mozilla.org/en-US/firefox/addon/lingmo-integration/"));
    ...
    QUrl chrome(QStringLiteral("https://chrome.google.com/webstore/detail/lingmo-integration/cimiefiiaegbelhefglklhhakcgmhkai"));
    ...
    QUrl edge(QStringLiteral("https://microsoftedge.microsoft.com/addons/detail/lingmo-integration/dnnckbejblnejeabhcmhklcaljjpdjeh"));
...
void BrowserIntegrationReminder::onBrowserStarted(const QString &browser)
{
    ...
    m_sni->setTitle(i18n("Get Lingmo Browser Integration"));
    m_sni->setIconByName(QStringLiteral("lingmo-browser-integration"));
    ...
    connect(m_sni, &KStatusNotifierItem::activateRequested, this, [this, browser]() {
        ...
        KActivities::ResourceInstance::notifyAccessed(QUrl(QStringLiteral("applications:") + browser),
                                                      QStringLiteral("org.kde.lingmo.browserintegrationreminder"));
