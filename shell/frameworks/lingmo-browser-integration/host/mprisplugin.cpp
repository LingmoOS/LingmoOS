...
static const QString s_serviceName = QStringLiteral("org.mpris.MediaPlayer2.lingmo-browser-integration");
...
QVariantMap MPrisPlugin::metadata() const
{
    ...
    metadata.insert(QStringLiteral("mpris:trackid"), QVariant::fromValue(QDBusObjectPath(QStringLiteral("/org/kde/lingmo/browser_integration/1337"))));
