...
Loader {
    ...
    visible: LingmoUI.Settings.tabletMode && target.selectByMouse && target.activeFocus && (isSelectionEnd ? target.selectionStart !== target.selectionEnd : true) && Qt.platform.os !== 'android'
    active: visible
    sourceComponent: LingmoUI.ShadowedRectangle {
        id: handle
