...
T.ScrollBar {
    ...
    padding: control.interactive ? LingmoUI.Units.mediumSpacing : Impl.Units.verySmallSpacing
    ...
    policy: LingmoUI.Settings.isMobile || !control.interactive ? T.ScrollBar.AsNeeded : T.ScrollBar.AlwaysOn
    ...
    background: Rectangle {
        ...
        LingmoUI.Separator {
            ...
            weight: LingmoUI.Separator.Weight.Light
            anchors {
                left: parent.left
