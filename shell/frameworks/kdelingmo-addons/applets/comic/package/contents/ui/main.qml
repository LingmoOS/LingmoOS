...
PlasmoidItem {
    ...
    readonly property int implicitWidth: LingmoUI.Units.gridUnit * 40
    readonly property int implicitHeight: LingmoUI.Units.gridUnit * 15
    ...
    readonly property int minimumWidth: LingmoUI.Units.gridUnit * 8
    readonly property int minimumHeight: LingmoUI.Units.gridUnit * 8
