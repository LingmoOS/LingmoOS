...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        Layouts.ColumnLayout {
            id: providerColumn
            LingmoUI.FormData.label: i18nc("@title:group", "Comics:")
            LingmoUI.FormData.buddyFor: children[1] // 0 is the Repeater
        ...
        Layouts.RowLayout {
                LingmoUI.FormData.label: i18nc("@label:spinbox", "Check for new plugins every:")
        ...
        Layouts.RowLayout {
                LingmoUI.FormData.label: i18nc("@label:spinbox", "Check for new comics every:")
