...
KCM.SimpleKCM {
    readonly property bool vertical: plasmoid.formFactor == LingmoCore.Types.Vertical || (plasmoid.formFactor == LingmoCore.Types.Planar && plasmoid.height > plasmoid.width)
    ...
    LingmoUI.FormLayout {
        QQC2.SpinBox {
            ...
            LingmoUI.FormData.label: vertical ? i18nc("@label:spinbox", "Maximum columns:") : i18nc("@label:spinbox", "Maximum rows:")
        ...
        QQC2.CheckBox {
            ...
            LingmoUI.FormData.label: i18nc("@title:group", "Appearance:")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nc("@title:group", "Title:")
            Layout.fillWidth: true

            visible: plasmoid.formFactor == LingmoCore.Types.Planar
