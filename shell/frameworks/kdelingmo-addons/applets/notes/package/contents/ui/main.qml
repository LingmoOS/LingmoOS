...
import org.kde.lingmo.private.notes 0.1
...
PlasmoidItem {
    ...
    readonly property LingmoComponents3.TextArea mainTextArea: fullRepresentationItem.mainTextArea
    ...
    fullRepresentation: KSvg.SvgItem {
        ...
        Layout.preferredHeight: LingmoUI.Units.gridUnit * 25
        ...
        Connections {
            ...
            function onExpandedChanged(expanded) {
                ...
                if (expanded && (Plasmoid.formFactor === LingmoCore.Types.Vertical || Plasmoid.formFactor === LingmoCore.Types.Horizontal)) {
                ...
                LingmoComponents3.TextArea {
                    ...
                    onActiveFocusChanged: {
                        ...
                        if (activeFocus && window && (window.flags & Qt.WindowDoesNotAcceptFocus)) {
                            Plasmoid.status = LingmoCore.Types.AcceptingInputStatus
                        } else {
