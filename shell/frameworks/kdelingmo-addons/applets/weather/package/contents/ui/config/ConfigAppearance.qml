...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        Item {
            ...
            LingmoUI.FormData.label: i18nc("@title:group", "Compact Mode")
        ...
        QQC2.RadioButton {
            id: radioTempInBadge
            LingmoUI.FormData.label: i18nc("@label", "Show temperature:")
        ...
        QQC2.CheckBox {
            ...
            LingmoUI.FormData.label: i18nc("@label", "Show in tooltip:")
