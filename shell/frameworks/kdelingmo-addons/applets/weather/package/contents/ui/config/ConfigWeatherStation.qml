    ...
    header: ColumnLayout {
        ...
        LingmoUI.FormLayout {
            ...
            QQC2.SpinBox {
                ...
                LingmoUI.FormData.label: i18nc("@label:spinbox", "Update every:")
            ...
            QQC2.Label {
                LingmoUI.FormData.label: hasSource ? i18nc("@label", "Provider:") : ""
            ...
            Item {
                ...
                implicitWidth: Math.min(LingmoUI.Units.gridUnit * 15, weatherStationConfigPage.width - LingmoUI.Units.gridUnit)
            }
        }
