...
GridLayout {
    ...
    readonly property int minimumIconSize: LingmoUI.Units.iconSizes.small
    ...
    Item {
        ...
        Text {
            ...
            font {
                ...
                pixelSize: iconAndTextRoot.vertical ? LingmoUI.Units.gridUnit * 2 : 1024 // random "big enough" size - this is used as a max pixelSize by the fontSizeMode
            }
            ...
            height: {
                ...
                return Math.min (parent.height * textHeightScaleFactor, 3 * LingmoUI.Theme.defaultFont.pixelSize);
            }
            visible: false
