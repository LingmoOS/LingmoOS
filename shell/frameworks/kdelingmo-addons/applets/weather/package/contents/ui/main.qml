...
PlasmoidItem {
    ...
    Binding {
        ...
        value: (Plasmoid.containmentType & LingmoCore.Types.CustomEmbeddedContainment)
                | (Plasmoid.containmentDisplayHints & LingmoCore.Types.ContainmentForcesSquarePlasmoids)
    }
