...
WeatherValidator::WeatherValidator(Lingmo5Support::DataEngine *weatherDataengine, const QString &ionName, QObject *parent)
    : QObject(parent)
...
void WeatherValidator::dataUpdated(const QString &source, const Lingmo5Support::DataEngine::Data &data)
{
...
void LocationListModel::searchLocations(const QString &searchString, const QStringList &services)
{
    ...
    Lingmo5Support::DataEngine *dataengine = dataEngine(QStringLiteral("weather"));
