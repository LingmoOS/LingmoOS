...
class WeatherValidator : public QObject
{
    Q_OBJECT
public:
    WeatherValidator(Lingmo5Support::DataEngine *weatherDataengine, const QString &ionName, QObject *parent = nullptr);
...
private:
    Lingmo5Support::DataEngine *m_weatherDataEngine;
    QString m_ionName;
};
...
class LocationListModel : public QAbstractListModel, public Lingmo5Support::DataEngineConsumer
{
    Q_OBJECT
