...
LingmoComponents3.ToolButton {
    ...
    Rectangle {
        ...
        width: LingmoUI.Units.iconSizes.roundedIconSize(pickerIcon.width) * 0.75
        height: LingmoUI.Units.iconSizes.roundedIconSize(pickerIcon.height) * 0.75
        radius: width / 2
        ...
        border {
            ...
            width: {
                const contrast = luminance(LingmoUI.Theme.viewBackgroundColor) / luminance(colorCircle.color) + 0.05;
