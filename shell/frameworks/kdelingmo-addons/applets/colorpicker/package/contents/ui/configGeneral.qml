...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        QQC2.ComboBox {
            ...
            LingmoUI.FormData.label: i18nc("@label:listbox", "Default color format:")
            model: Logic.formats
        ...
        QQC2.RadioButton {
            LingmoUI.FormData.label: i18nc("@label", "When pressing the keyboard shortcut:")
        ...
        QQC2.SpinBox {
            ...
            LingmoUI.FormData.label: i18nc("@label", "Preview count:")
            from: 0
