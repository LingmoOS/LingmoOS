...
PlasmoidItem {
    ...
    Component {
        ...
        Window { // QTBUG-119055
            id: window
            width: LingmoUI.Units.gridUnit * 19
            height: LingmoUI.Units.gridUnit * 23
            maximumWidth: width
    ...
    Component.onCompleted: {
        ...
        Logic.copyToClipboardText = i18ndc("lingmo_applet_org.kde.lingmo.colorpicker", "@title:menu", "Copy to Clipboard"); // i18n is not supported in js library
    }
    ...
    fullRepresentation: GridView {
        ...
        Layout.minimumWidth: columns * LingmoUI.Units.gridUnit * 6
        ...
        delegate: MouseArea {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    height: colorLabel.contentHeight + 2 * LingmoUI.Units.smallSpacing
            ...
            Loader {
                active: parent.containsMouse || LingmoUI.Settings.tabletMode || LingmoUI.Settings.hasTransientTouchInput
