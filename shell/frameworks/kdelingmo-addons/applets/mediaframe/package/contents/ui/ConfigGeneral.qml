    ...
    */
    ...
    LingmoUI.FormLayout {
        ...
        RowLayout {
            ...
            LingmoUI.FormData.label: i18n("Change picture every:")
        ...
        ComboBox {
            id: comboBox
            LingmoUI.FormData.label: i18nc("@label:listbox", "Image fill mode:")
    ...
    //         Layout.minimumWidth: LingmoUI.Units.gridUnit * 10
        ...
        CheckBox {
            ...
            LingmoUI.FormData.label: i18nc("@label:checkbox", "General:")
