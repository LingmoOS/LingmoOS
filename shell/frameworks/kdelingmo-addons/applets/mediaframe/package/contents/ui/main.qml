...
import org.kde.lingmo.private.mediaframe 2.0
...
PlasmoidItem {
    ...
    height: LingmoUI.Units.gridUnit * 13
    ...
    SequentialAnimation {
        ...
        ParallelAnimation {
            OpacityAnimator { target: frontImage; from: 1; to: 0; duration: LingmoUI.Units.veryLongDuration }
            OpacityAnimator { target: bufferImage; from: 0; to: 1; duration: LingmoUI.Units.veryLongDuration }
        }
        ScriptAction {
            script: {
    ...
    // TODO Makes lingmoshell suck CPU until the universe or the computer collapse in on itself
    /*
    Rectangle {
        id: progress
