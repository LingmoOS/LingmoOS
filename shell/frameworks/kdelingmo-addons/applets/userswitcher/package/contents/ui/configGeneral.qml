...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        QtControls.RadioButton {
            ...
            LingmoUI.FormData.label: i18nc("@title:label", "Username style:")
        ...
        QtControls.RadioButton {
            ...
            LingmoUI.FormData.label: i18nc("@title:label", "Show:")
        ...
        QtControls.CheckBox {
            ...
            LingmoUI.FormData.label: i18nc("@title:label", "Advanced:")
