...
PlasmoidItem {
    ...
    switchWidth: LingmoUI.Units.gridUnit * 7
    switchHeight: Math.round(LingmoUI.Units.gridUnit * 10.5)
    ...
    P5Support.DataSource {
        ...
        engine: "org.kde.lingmo.clipboard"
        ...
        contentItem: ColumnLayout {
            ...
            KSvg.FrameSvgItem {
                ...
                TextEdit {
                    ...
                    text: "0";
                    font.pointSize: LingmoUI.Theme.defaultFont.pointSize * 2;
