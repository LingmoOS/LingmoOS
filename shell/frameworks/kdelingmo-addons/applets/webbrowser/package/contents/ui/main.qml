...
PlasmoidItem {
    ...
    switchWidth: LingmoUI.Units.gridUnit * 16
    switchHeight: LingmoUI.Units.gridUnit * 23
    ...
    fullRepresentation: ColumnLayout {
        ...
        Item {
            ...
            Layout.preferredWidth: LingmoUI.Units.gridUnit * 36
            Layout.preferredHeight: LingmoUI.Units.gridUnit * 18
