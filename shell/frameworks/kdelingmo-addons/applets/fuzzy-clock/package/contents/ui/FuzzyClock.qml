...
Item {
    ...
    Layout.minimumWidth: vertical ? 0 : sizehelper.paintedWidth + (LingmoUI.Units.smallSpacing * 2)
    Layout.maximumWidth: vertical ? Infinity : Layout.minimumWidth
    Layout.preferredWidth: vertical ? undefined : Layout.minimumWidth

    Layout.minimumHeight: vertical ? sizehelper.paintedHeight + (LingmoUI.Units.smallSpacing * 2) : 0
    Layout.maximumHeight: vertical ? Layout.minimumHeight : Infinity
    Layout.preferredHeight: vertical ? Layout.minimumHeight : LingmoUI.Units.iconSizes.sizeForLabels * 2
    ...
    LingmoComponents3.Label  {
        ...
        minimumPixelSize: LingmoUI.Units.iconSizes.sizeForLabels
    ...
    Text {
        ...
        font.pixelSize: vertical ? LingmoUI.Units.gridUnit * 2 : 1024 // random "big enough" size - this is used as a max pixelSize by the fontSizeMode
        minimumPixelSize: Math.round(LingmoUI.Units.gridUnit / 2)
        horizontalAlignment: Text.AlignHCenter
        verticalAlignment: Text.AlignVCenter
        text: timeLabel.text
