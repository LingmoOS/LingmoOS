...
void FlickrProvider::loadConfig()
{
    ...
    m_configLocalPath = QStandardPaths::writableLocation(QStandardPaths::GenericCacheLocation) + QStringLiteral("/lingmo_engine_potd/") + configFileName;
