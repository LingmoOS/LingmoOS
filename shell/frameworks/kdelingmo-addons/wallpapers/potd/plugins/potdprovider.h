 ...
 */
class LINGMO_POTD_EXPORT PotdProvider : public QObject
{
    Q_OBJECT
...
public:
    ...
    /**
     * @return the name of this provider (equiv to X-KDE-LingmoPoTDProvider-Identifier)
     */
    QString name() const;
