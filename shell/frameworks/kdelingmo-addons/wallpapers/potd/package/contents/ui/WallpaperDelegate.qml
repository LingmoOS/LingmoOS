...
FocusScope {
    ...
    QQC2.ToolTip {
        ...
        visible: hoverHandler.enabled && !contextMenu.opened
                 && (hoverHandler.hovered
                     ...
                     || (LingmoUI.Settings.isMobile && openUrlTapHandler.pressed))
    }
    ...
    LingmoUI.ShadowedRectangle {
        ...
        color: thumbnailArea.activeFocus ? LingmoUI.Theme.highlightColor : LingmoUI.Theme.backgroundColor
        ...
        Rectangle {
            ...
            color: !delegate.thumbnailAvailable || delegate.thumbnailLoading ? LingmoUI.Theme.backgroundColor : delegate.backgroundColor

            activeFocusOnTab: true
            Accessible.name: delegate.thumbnailAvailable ? i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis", "Today's picture")
                           : delegate.thumbnailLoading ? i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis", "Loading")
                                                       : i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis", "Unavailable")
            Accessible.description: delegate.thumbnailAvailable ? i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis for an image %1 title %2 author", "%1 Author: %2. Right-click on the image to see more actions.", delegate.title, delegate.author)
                                  : delegate.thumbnailLoading ? i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis", "The wallpaper is being fetched from the Internet.")
                                                              : i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis", "Failed to fetch the wallpaper from the Internet.")
                    ...
                    delegate: QQC2.Button {
                        ...
                        QQC2.ToolTip {
                            visible: modelData.tooltip.length > 0
                                     && ((LingmoUI.Settings.isMobile ? parent.pressed : parent.hovered)
