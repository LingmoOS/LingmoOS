...
WallpaperItem {
    ...
    contextualActions: [
        LingmoCore.Action {
            text: i18nd("lingmo_wallpaper_org.kde.potd", "Open Wallpaper Image")
    ...
    QQC2.StackView {
        ...
        Rectangle {
            ...
            Behavior on color {
                ColorAnimation { duration: LingmoUI.Units.longDuration }
            }
        }
        ...
        replaceEnter: Transition {
            OpacityAnimator {
                ...
                duration: Math.round(LingmoUI.Units.veryLongDuration * 5)
            }
        }
