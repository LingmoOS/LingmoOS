...
import org.kde.lingmo.wallpapers.potd 1.0
...
LingmoUI.FormLayout {
    ...
    Row {
        LingmoUI.FormData.label: i18ndc("lingmo_wallpaper_org.kde.potd", "@label:listbox", "Provider:")
        ...
        LingmoUI.ContextualHelpButton {
            ...
            toolTipText: i18ndc("lingmo_wallpaper_org.kde.potd", "@info:tooltip", "This wallpaper provider does not filter out images that may be sensitive or objectionable. Use caution if these images will be displayed in public.")
        }
    }
    ...
    QQC2.CheckBox {
        ...
        text: i18ndc("lingmo_wallpaper_org.kde.potd", "@option:check", "Update when using metered network connection")
    ...
    QQC2.ComboBox {
        id: resizeComboBox
        LingmoUI.FormData.label: i18ndc("lingmo_wallpaper_org.kde.potd", "@label:listbox", "Positioning:")
        model: [
                    {
                        'label': i18ndc("lingmo_wallpaper_org.kde.potd", "@item:inlistbox", "Scaled and Cropped"),
                        'fillMode': Image.PreserveAspectCrop
                    },
                    {
                        'label': i18ndc("lingmo_wallpaper_org.kde.potd", "@item:inlistbox", "Scaled"),
                        'fillMode': Image.Stretch
                    },
                    {
                        'label': i18ndc("lingmo_wallpaper_org.kde.potd", "@item:inlistbox", "Scaled, Keep Proportions"),
                        'fillMode': Image.PreserveAspectFit
                    },
                    {
                        'label': i18ndc("lingmo_wallpaper_org.kde.potd", "@item:inlistbox", "Centered"),
                        'fillMode': Image.Pad
                    },
                    {
                        'label': i18ndc("lingmo_wallpaper_org.kde.potd", "@item:inlistbox", "Tiled"),
                        'fillMode': Image.Tile
                    }
                ]
    ...
    KQC2.ColorButton {
        id: colorButton
        LingmoUI.FormData.label: i18ndc("lingmo_wallpaper_org.kde.potd", "@label:chooser", "Background color:")
        dialogTitle: i18ndc("lingmo_wallpaper_org.kde.potd", "@title:window", "Select Background Color")
    }
    ...
    WallpaperPreview {
        id: wallpaperPreview
        LingmoUI.FormData.label: i18ndc("lingmo_wallpaper_org.kde.potd", "@label", "Today's picture:")
    ...
    LingmoUI.SelectableLabel {
        id: titleLabel
        LingmoUI.FormData.label: i18ndc("lingmo_wallpaper_org.kde.potd", "@label", "Title:")
        Layout.fillWidth: true
        Layout.maximumWidth: wallpaperPreview.implicitWidth * 1.5
        visible: wallpaperPreview.visible && backend.title.length > 0
        font.bold: true
        text: backend.title
        Accessible.name: titleLabel.LingmoUI.FormData.label
    }
    ...
    LingmoUI.SelectableLabel {
        id: authorLabel
        LingmoUI.FormData.label: i18ndc("lingmo_wallpaper_org.kde.potd", "@label", "Author:")
        Layout.fillWidth: true
        Layout.maximumWidth: wallpaperPreview.implicitWidth * 1.5
        visible: wallpaperPreview.visible && backend.author.length > 0
        text: backend.author
        Accessible.name: authorLabel.LingmoUI.FormData.label
    }
    ...
    LingmoUI.InlineMessage {
        ...
        actions: [
            LingmoUI.Action {
                ...
                text: i18ndc("lingmo_wallpaper_org.kde.potd", "@action:button", "Open Containing Folder")
                visible: backend.saveStatus === Global.Successful
                onTriggered: Qt.openUrlExternally(backend.savedFolder)

                Accessible.description: i18ndc("lingmo_wallpaper_org.kde.potd", "@info:whatsthis for a button", "Open the destination folder where the wallpaper image was saved.")
            }
        ]
        ...
        Connections {
            ...
            function onSaveStatusChanged() {
                ...
                case Global.Successful:
                    ...
                    saveMessage.type = LingmoUI.MessageType.Positive;
                    break;
                case Global.Failed:
                    saveMessage.text = backend.saveStatusMessage;
                    saveMessage.type = LingmoUI.MessageType.Error;
                    break;
                default:
                    return;
                }
