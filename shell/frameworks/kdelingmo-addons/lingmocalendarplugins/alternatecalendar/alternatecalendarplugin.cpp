...
{
    auto config = KSharedConfig::openConfig("lingmo_calendar_alternatecalendar"_L1, KConfig::NoGlobals);
...
{
    if (configGroup.config()->name() != "lingmo_calendar_alternatecalendar"_L1) {
        return;
    }
    init();
