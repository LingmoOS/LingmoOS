    ...
    **/
    ...
    LingmoCore.Dialog {
        ...
        mainItem: Item {
            ...
            property int optimalWidth: textMetrics.width + LingmoUI.Units.iconSizes.small + 2 * LingmoUI.Units.smallSpacing + hoverItem.margins.right + hoverItem.margins.left
            ...
            ListView {
                ...
                property int rowHeight: Math.max(LingmoUI.Units.iconSizes.small, textMetrics.height + hoverItem.margins.top + hoverItem.margins.bottom)
                ...
                delegate: RowLayout {
                    ...
                    spacing: 2 * LingmoUI.Units.smallSpacing
