...
KWin.TabBoxSwitcher {
    ...
    Window {
        ...
        PathView {
            ...
            highlightMoveDuration: LingmoUI.Units.veryLongDuration * (2 / Math.sqrt(visibleCount + 1))
            ...
            delegate: Item {
                ...
                LingmoUI.ShadowedRectangle {
                    ...
                    color: "transparent"
                    shadow.size: LingmoUI.Units.gridUnit
                    shadow.color: "black"
                    opacity: 0.5
                }
            ...
            highlight: KSvg.FrameSvgItem {
                ...
                width: target ? Math.round(target.width/2 + 3 * LingmoUI.Units.smallSpacing) * 2 : 0
                height: target ? Math.round(target.height/2 + 3 * LingmoUI.Units.smallSpacing) * 2 : 0
        ...
        RowLayout {
            ...
            PC3.Label {
                font.bold: true
                font.pointSize: Math.round(LingmoUI.Theme.defaultFont.pointSize * 1.6)
