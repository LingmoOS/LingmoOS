...
Item {
    ...
    property real faceSize: LingmoUI.Units.gridUnit * 7
    ...
    Item {
        ...
        width: wrapper.isCurrent ? wrapper.faceSize : wrapper.faceSize - LingmoUI.Units.gridUnit
        height: width
    ...
    ShaderEffect {
        ...
        readonly property color colorBorder: LingmoUI.Theme.textColor

        fragmentShader: "qrc:/qt/qml/org/kde/ocean/components/shaders/UserDelegate.frag.qsb"
    }
    ...
    LingmoComponents3.Label {
        ...
        styleColor: wrapper.softwareRendering ? LingmoUI.Theme.backgroundColor : "transparent" //no outline, doesn't matter
