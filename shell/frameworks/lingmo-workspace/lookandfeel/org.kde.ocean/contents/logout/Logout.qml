...
Item {
    ...
    Rectangle {
        ...
        color: root.isLightColor(LingmoUI.Theme.backgroundColor) ? LingmoUI.Theme.backgroundColor : "black"
        opacity: 0.5
    }
    MouseArea {
        anchors.fill: parent
    ...
    UserDelegate {
        ...
        height: LingmoUI.Units.gridUnit * 9
        anchors {
    ...
    ColumnLayout {
        ...
        anchors {
            ...
            topMargin: LingmoUI.Units.gridUnit * 2
            horizontalCenter: parent.horizontalCenter
        }
        spacing: LingmoUI.Units.largeSpacing

        height: Math.max(implicitHeight, LingmoUI.Units.gridUnit * 10)
        width: Math.max(implicitWidth, LingmoUI.Units.gridUnit * 16)
        ...
        LingmoComponents.Label {
            ...
            text: {
                switch (sdtype) {
                    case ShutdownType.ShutdownTypeReboot:
                        return softwareUpdatePending ? i18ndp("lingmo_lookandfeel_org.kde.lookandfeel", "Installing software updates and restarting in 1 second", "Installing software updates and restarting in %1 seconds", root.remainingTime)
                        : i18ndp("lingmo_lookandfeel_org.kde.lookandfeel", "Restarting in 1 second", "Restarting in %1 seconds", root.remainingTime);
                    case ShutdownType.ShutdownTypeNone:
                        return i18ndp("lingmo_lookandfeel_org.kde.lookandfeel", "Logging out in 1 second", "Logging out in %1 seconds", root.remainingTime);
                    case ShutdownType.ShutdownTypeHalt:
                    default:
                        return i18ndp("lingmo_lookandfeel_org.kde.lookandfeel", "Shutting down in 1 second", "Shutting down in %1 seconds", root.remainingTime);
                }
            }
        ...
        LingmoComponents.Label {
            font.pointSize: LingmoUI.Theme.defaultFont.pointSize + 1
            Layout.maximumWidth: Math.max(LingmoUI.Units.gridUnit * 16, logoutButtonsRow.implicitWidth)
            Layout.alignment: Qt.AlignHCenter
            Layout.fillWidth: true
            horizontalAlignment: Text.AlignHCenter
            wrapMode: Text.WordWrap
            font.italic: true
            text: i18ndp("lingmo_lookandfeel_org.kde.lookandfeel",
        ...
        LingmoComponents.Label {
            ...
            wrapMode: Text.WordWrap
            font.italic: true
            text: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "When restarted, the computer will enter the firmware setup screen.")
            textFormat: Text.PlainText
        ...
        RowLayout {
            ...
            Layout.topMargin: LingmoUI.Units.gridUnit * 2 - column.spacing
            Layout.alignment: Qt.AlignHCenter
            LogoutButton {
                id: suspendButton
                icon.name: "system-suspend"
                text: root.showAllOptions ? i18ndc("lingmo_lookandfeel_org.kde.lookandfeel", "Suspend to RAM", "Sleep")
                                          : i18ndc("lingmo_lookandfeel_org.kde.lookandfeel", "Suspend to RAM", "Sleep Now")
            ...
            LogoutButton {
                ...
                text: root.showAllOptions ? i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Hibernate")
                                          : i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Hibernate Now")
            ...
            LogoutButton {
                id: rebootButton
                icon.name: softwareUpdatePending ? "update-none" : "system-reboot"
                text: {
                    if (softwareUpdatePending) {
                        return root.showAllOptions ? i18ndc("lingmo_lookandfeel_org.kde.lookandfeel", "@action:button Keep short", "Install Updates & Restart")
                                                   : i18ndc("lingmo_lookandfeel_org.kde.lookandfeel", "@action:button Keep short", "Install Updates & Restart Now")
                    } else {
                        return root.showAllOptions ? i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Restart")
                                                   : i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Restart Now")
                    }
                }
            ...
            LogoutButton {
                ...
                text: root.showAllOptions ? i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Restart")
                                          : i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Restart Now")
                onClicked: {
            ...
            LogoutButton {
                ...
                text: root.showAllOptions ? i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Shut Down")
                                          : i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Shut Down Now")
            ...
            LogoutButton {
                ...
                text: root.showAllOptions ? i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Log Out")
                                          : i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Log Out Now")
            ...
            LogoutButton {
                ...
                text: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Cancel")
                onClicked: root.cancelRequested()
