...
QColor MediaProxy::getAccentColorFromMetaData(const KPackage::Package &package)
{
    ...
    const auto jsonIt = metaData.constFind(QLatin1String("X-KDE-LingmoImageWallpaper-AccentColor"));
    ...
    default:
        qCWarning(IMAGEWALLPAPER, "Invalid value from \"X-KDE-LingmoImageWallpaper-AccentColor\"");
        break;
    }
