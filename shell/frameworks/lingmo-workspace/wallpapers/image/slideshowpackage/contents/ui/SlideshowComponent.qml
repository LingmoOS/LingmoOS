...
import org.kde.lingmo.wallpapers.image 2.0 as LingmoWallpaper
...
ColumnLayout {
    ...
    LingmoUI.FormLayout {
        ...
        RowLayout {
            id: slideshowModeRow
            LingmoUI.FormData.label: i18nd("lingmo_wallpaper_org.kde.image", "Order:")
            ...
            QQC2.ComboBox {
                ...
                model: [
                    {
                        'label': i18nd("lingmo_wallpaper_org.kde.image", "Random"),
                        'slideshowMode':  LingmoWallpaper.SortingMode.Random
                    },
                    {
                        'label': i18nd("lingmo_wallpaper_org.kde.image", "A to Z"),
                        'slideshowMode':  LingmoWallpaper.SortingMode.Alphabetical
                    },
                    {
                        'label': i18nd("lingmo_wallpaper_org.kde.image", "Z to A"),
                        'slideshowMode':  LingmoWallpaper.SortingMode.AlphabeticalReversed
                    },
                    {
                        'label': i18nd("lingmo_wallpaper_org.kde.image", "Date modified (newest first)"),
                        'slideshowMode':  LingmoWallpaper.SortingMode.ModifiedReversed
                    },
                    {
                        'label': i18nd("lingmo_wallpaper_org.kde.image", "Date modified (oldest first)"),
                        'slideshowMode':  LingmoWallpaper.SortingMode.Modified
                    }
                ]
                textRole: "label"
                onActivated: {
            ...
            QQC2.CheckBox {
                ...
                text: i18nd("lingmo_wallpaper_org.kde.image", "Group by folders")
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nd("lingmo_wallpaper_org.kde.image", "Change every:")
            QQC2.SpinBox {
                id: hoursInterval
                ...
                textFromValue: function(value, locale) {
                    return i18ndp("lingmo_wallpaper_org.kde.image","%1 hour", "%1 hours", value)
                }
            ...
            QQC2.SpinBox {
                ...
                textFromValue: function(value, locale) {
                    return i18ndp("lingmo_wallpaper_org.kde.image","%1 minute", "%1 minutes", value)
                }
                valueFromText: function(text, locale) {
                    return parseInt(text);
                }
            ...
            QQC2.SpinBox {
                ...
                textFromValue: function(value, locale) {
                    return i18ndp("lingmo_wallpaper_org.kde.image","%1 second", "%1 seconds", value)
                }
                valueFromText: function(text, locale) {
                    return parseInt(text);
                }
            ...
            QQC2.ScrollView {
                ...
                ListView {
                    ...
                    header: LingmoUI.InlineViewHeader {
                        ...
                        text: i18nd("lingmo_wallpaper_org.kde.image", "Folders")
                        actions: [
                            LingmoUI.Action {
                                icon.name: "list-add-symbolic"
                                text: i18ndc("lingmo_wallpaper_org.kde.image", "@action button the thing being added is a folder", "Add…")
                                Accessible.name: i18ndc("lingmo_wallpaper_org.kde.image", "@action:button", "Add Folder…")
                    ...
                    delegate: LingmoUI.SubtitleDelegate {
                        ...
                        contentItem: RowLayout {
                            ...
                            QQC2.ToolButton {
                                ...
                                text: i18nd("lingmo_wallpaper_org.kde.image", "Remove Folder")
                            ...
                            QQC2.ToolButton {
                                ...
                                text: i18nd("lingmo_wallpaper_org.kde.image", "Open Folder…")
                                display: QQC2.Button.IconOnly
                    ...
                    LingmoUI.PlaceholderMessage {
                        ...
                        text: i18nd("lingmo_wallpaper_org.kde.image", "There are no wallpaper locations configured")
                    }
                }
            }
        }
