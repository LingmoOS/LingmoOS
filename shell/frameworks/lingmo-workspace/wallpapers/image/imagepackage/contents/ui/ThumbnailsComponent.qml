...
Item {
    ...
    ColumnLayout {
        ...
        LingmoUI.InlineViewHeader {
            Layout.fillWidth: true
            text: i18nd("lingmo_wallpaper_org.kde.image", "Images")
            actions: [
                LingmoUI.Action {
                    icon.name: "list-add-symbolic"
                    text: i18ndc("lingmo_wallpaper_org.kde.image", "@action:button the thing being added is an image file", "Add…")
                    Accessible.name: i18ndc("lingmo_wallpaper_org.kde.image", "@action:button", "Add Wallpaper Image…")
                    visible: configDialog.currentWallpaper == "org.kde.image"
                    onTriggered: root.openChooserDialog();
                },
                NewStuff.Action {
                    configFile: LingmoUI.Settings.isMobile ? "wallpaper-mobile.knsrc" : "wallpaper.knsrc"
                    text: i18ndc("lingmo_wallpaper_org.kde.image", "@action:button the new things being gotten are wallpapers", "Get New…")
                    Accessible.name: i18ndc("lingmo_wallpaper_org.kde.image", "@action:button", "Get New Wallpaper Images…")
        ...
        Rectangle {
            ...
            KCM.GridView {
                ...
                view.implicitCellWidth: screenSize.width / 10 + LingmoUI.Units.smallSpacing * 2
                view.implicitCellHeight: screenSize.height / 10 + LingmoUI.Units.smallSpacing * 2 + LingmoUI.Units.gridUnit * 3
