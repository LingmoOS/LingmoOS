...
KCM.GridDelegate {
    ...
    actions: [
        LingmoUI.Action {
            ...
            tooltip: i18nd("lingmo_wallpaper_org.kde.image", "Open Containing Folder")
            onTriggered: imageModel.openContainingFolder(index)
        },
        LingmoUI.Action {
            icon.name: "edit-undo"
            visible: model.pendingDeletion
            tooltip: i18nd("lingmo_wallpaper_org.kde.image", "Restore wallpaper")
            onTriggered: model.pendingDeletion = false
        },
        LingmoUI.Action {
            icon.name: "edit-delete"
            tooltip: i18nd("lingmo_wallpaper_org.kde.image", "Remove Wallpaper")
