...
import org.kde.lingmo.wallpapers.image as LingmoWallpaper
...
ColumnLayout {
    ...
    LingmoWallpaper.ImageBackend {
        id: imageWallpaper
        renderingMode: (configDialog.currentWallpaper === "org.kde.image") ? LingmoWallpaper.ImageBackend.SingleImage : LingmoWallpaper.ImageBackend.SlideShow
        targetSize: {
    ...
    LingmoUI.FormLayout {
        ...
        Layout.bottomMargin: configDialog.currentWallpaper === "org.kde.image" ? LingmoUI.Units.largeSpacing : 0
        ...
        QtControls2.ComboBox {
            id: resizeComboBox
            LingmoUI.FormData.label: i18nd("lingmo_wallpaper_org.kde.image", "Positioning:")
            model: [
                        {
                            'label': i18nd("lingmo_wallpaper_org.kde.image", "Scaled and Cropped"),
                            'fillMode': Image.PreserveAspectCrop
                        },
                        {
                            'label': i18nd("lingmo_wallpaper_org.kde.image", "Scaled"),
                            'fillMode': Image.Stretch
                        },
                        {
                            'label': i18nd("lingmo_wallpaper_org.kde.image", "Scaled, Keep Proportions"),
                            'fillMode': Image.PreserveAspectFit
                        },
                        {
                            'label': i18nd("lingmo_wallpaper_org.kde.image", "Centered"),
                            'fillMode': Image.Pad
                        },
                        {
                            'label': i18nd("lingmo_wallpaper_org.kde.image", "Tiled"),
                            'fillMode': Image.Tile
                        }
            ]
        ...
        QtControls2.RadioButton {
            ...
            LingmoUI.FormData.label: i18nd("lingmo_wallpaper_org.kde.image", "Background:")
            text: i18nd("lingmo_wallpaper_org.kde.image", "Blur")
        ...
        RowLayout {
            ...
            QtControls2.RadioButton {
                id: colorRadioButton
                text: i18nd("lingmo_wallpaper_org.kde.image", "Solid color")
                checked: !cfg_Blur
                QtControls2.ButtonGroup.group: backgroundGroup
            ...
            KQuickControls.ColorButton {
                id: colorButton
                color: cfg_Color
                dialogTitle: i18nd("lingmo_wallpaper_org.kde.image", "Select Background Color")
