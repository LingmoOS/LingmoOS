...
import org.kde.lingmo.wallpapers.image as Wallpaper
...
WallpaperItem {
    ...
    contextualActions: [
        LingmoCore.Action {
            text: i18nd("lingmo_wallpaper_org.kde.image", "Open Wallpaper Image")
            icon.name: "document-open"
            visible: root.pluginName === "org.kde.slideshow"
            onTriggered: imageView.mediaProxy.openModelImage();
        },
        LingmoCore.Action {
            text: i18nd("lingmo_wallpaper_org.kde.image", "Next Wallpaper Image")
    ...
    Component.onCompleted: {
        // In case lingmoshell crashes when the config dialog is opened
