...
int main(int argc, char **argv)
{
    ...
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("lingmowindowed"));
    ...
    QCommandLineOption shellPluginOption(QStringList() << QStringLiteral("p") << QStringLiteral("shell-plugin"),
                                         ...
                                         QStringLiteral("org.kde.lingmo.desktop"));
    ...
    LingmoWindowedCorona *corona = new LingmoWindowedCorona(parser.value(shellPluginOption));
    ...
    app.connect(&service, &KDBusService::activateRequested, corona, &LingmoWindowedCorona::activateRequested);
