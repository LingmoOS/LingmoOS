...
View::View(LingmoQuick::SharedQmlEngine *engine, QWindow *)
    : LingmoQuick::LingmoWindow()
    , m_engine(engine)
    , m_floating(false)
{
    KCrash::initialize();
    ...
    connect(m_engine, &LingmoQuick::SharedQmlEngine::finished, this, &View::objectIncubated);
