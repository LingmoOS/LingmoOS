    ...
    RowLayout {
        ...
        LingmoComponents3.ToolButton {
            ...
            onClicked: {
                ...
                KCMLauncher.open("lingmo/kcms/desktop/kcm_krunnersettings")
            }
        ...
        LingmoExtras.SearchField {
            ...
            Layout.minimumWidth: LingmoUI.Units.gridUnit * 25
            ...
            LingmoUI.Icon {
                anchors {
                    right: parent.right
                    rightMargin: 6 // from LingmoStyle TextFieldStyle
                    verticalCenter: parent.verticalCenter
                }
                // match clear button
                width: Math.max(parent.height * 0.8, LingmoUI.Units.iconSizes.small)
                height: width
                source: "expand"
