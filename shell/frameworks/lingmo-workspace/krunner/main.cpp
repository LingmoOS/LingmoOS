...
int main(int argc, char **argv)
{
    ...
    // this is needed to fake window position so Lingmo Dialog sets correct borders
    ...
    LingmoQuick::SharedQmlEngine sharedEngine;
    // It is important this to be done before the view is created, as it creates internally a framesvgitem for the background
    // that needs to use the current lingmo theme
    sharedEngine.engine()->setProperty("_lingmouiTheme", u"LingmoUILingmoStyle"_s);
