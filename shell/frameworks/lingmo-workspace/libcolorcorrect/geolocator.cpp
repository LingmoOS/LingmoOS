...
void Geolocator::dataUpdated(const QString &source, const Lingmo5Support::DataEngine::Data &data)
{
    Q_UNUSED(source);
    ...
    auto readGeoDouble = [](const Lingmo5Support::DataEngine::Data &data, const QString &key) -> double {
        const Lingmo5Support::DataEngine::Data::ConstIterator it = data.find(key);
