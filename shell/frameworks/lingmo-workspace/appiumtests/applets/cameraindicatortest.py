...
WIDGET_ID: Final = "org.kde.lingmo.cameraindicator"
...
class CameraIndicatorTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        options.set_capability("environ", {
            "LC_ALL": "en_US.UTF-8",
            "QT_FATAL_WARNINGS": "1",
            "QT_LOGGING_RULES": "qt.accessibility.atspi.warning=false;kf.lingmo.core.warning=false;kf.windowsystem.warning=false;kf.lingmoui.platform.warning=false;kpipewire_logging.warning=false",
        })
