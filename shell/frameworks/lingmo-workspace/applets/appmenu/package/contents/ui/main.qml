...
import org.kde.lingmo.private.appmenu 1.0 as AppMenuPrivate
...
PlasmoidItem {
    ...
    compactRepresentation: LingmoComponents3.ToolButton {
    ...
    fullRepresentation: GridLayout {
        ...
        Plasmoid.status: {
            if (appMenuModel.menuAvailable && Plasmoid.currentIndex > -1 && buttonRepeater.count > 0) {
                ...
                return buttonRepeater.count > 0 || Plasmoid.configuration.compactView ? LingmoCore.Types.ActiveStatus : LingmoCore.Types.HiddenStatus;
            }
        }
        ...
        Repeater {
            ...
            MenuDelegate {
                ...
                LingmoUI.MnemonicData.active: altState.pressed
