...
class AppMenuModel : public QAbstractListModel
{
    ...
    Q_PROPERTY(Lingmo::Types::ItemStatus containmentStatus MEMBER m_containmentStatus NOTIFY containmentStatusChanged)
...
private:
    ...
    Lingmo::Types::ItemStatus m_containmentStatus = Lingmo::Types::PassiveStatus;
