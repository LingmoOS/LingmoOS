...
KCMUtils.ScrollViewKCM {
    ...
    view: ListView {
        ...
        property real visibilityColumnWidth: LingmoUI.Units.gridUnit
        property real keySequenceColumnWidth: LingmoUI.Units.gridUnit
        readonly property int iconSize: LingmoUI.Units.iconSizes.smallMedium
        ...
        header: RowLayout {
            ...
            Item {
                implicitWidth: itemsList.iconSize + 2 * LingmoUI.Units.smallSpacing
            }
            LingmoUI.Heading {
            ...
            QQC2.Button { // Configure button column
                ...
                enabled: false
                opacity: 0
                Layout.rightMargin: 2 * LingmoUI.Units.smallSpacing
            }
        }
