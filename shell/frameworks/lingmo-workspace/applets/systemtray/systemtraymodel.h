...
protected:
    Lingmo::Types::ItemStatus calculateEffectiveStatus(bool canRender, Lingmo::Types::ItemStatus status, QString itemId) const;
...
public Q_SLOTS:
    void addApplet(Lingmo::Applet *applet);
    void removeApplet(Lingmo::Applet *applet);
 ...
 * @note This model is exported to QML for lingmo-mobile
 */
...
public:
    ...
    struct Item {
        QString source;
        Lingmo5Support::Service *service = nullptr;
    };
