...
bool SortedSystemTrayModel::lessThanSystemTray(const QModelIndex &left, const QModelIndex &right) const
{
    ...
    if (itemIdRight.toString() == QLatin1String("org.kde.lingmo.notifications")) {
        // return false when at least right is "org.kde.lingmo.notifications"
        return false;
    } else if (itemIdLeft.toString() == QLatin1String("org.kde.lingmo.notifications")) {
        // return true when only left is "org.kde.lingmo.notifications"
        return true;
    }
