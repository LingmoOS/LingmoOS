...
LingmoExtras.Representation {
    ...
    Layout.maximumWidth: LingmoUI.Units.gridUnit * 40
    Layout.maximumHeight: LingmoUI.Units.gridUnit * 40

    collapseMarginsHint: true

    readonly property alias playerSelector: playerSelector
    readonly property int controlSize: LingmoUI.Units.iconSizes.medium
        ...
        Item { // Album Art + Details
            ...
            ColumnLayout { // Details Column
                ...
                anchors {
                    ...
                    leftMargin: LingmoUI.Units.gridUnit / 2
                    right: parent.right
                }
                ...
                LingmoUI.Heading { // Song Title
                    id: songTitle
                    level: 1

                    color: (softwareRendering || !albumArt.hasImage) ? LingmoUI.Theme.textColor : "white"
                    ...
                    Layout.maximumHeight: LingmoUI.Units.gridUnit * 5
                }
                LingmoUI.Heading { // Song Artist
                    id: songArtist
                    visible: root.artist
                    level: 2
                    ...
                    text: root.artist
                    Layout.fillWidth: true
                    Layout.maximumHeight: LingmoUI.Units.gridUnit * 2
                }
                LingmoUI.Heading { // Song Album
                    color: (softwareRendering || !albumArt.hasImage) ? LingmoUI.Theme.textColor : "white"
    ...
    footer: LingmoExtras.PlasmoidHeading {
        id: footerItem
        position: LingmoComponents3.ToolBar.Footer
        ColumnLayout { // Main Column Layout
            ...
            RowLayout { // Seek Bar
                ...
                Layout.fillWidth: true
                Layout.maximumWidth: Math.min(LingmoUI.Units.gridUnit * 45, Math.round(expandedRepresentation.width * (7 / 10)))
                ...
                LingmoComponents3.Label { // Time Elapsed
                ...
                LingmoComponents3.Slider { // Slider
                    id: seekSlider
                    Layout.fillWidth: true
                    z: 999
                    value: 0
                    ...
                    onPressedChanged: {
                        ...
                        if (pressed) {
                            ...
                            seekToolTip.delay = Qt.binding(() => LingmoUI.Units.toolTipDelay);
                    ...
                    LingmoComponents3.ToolTip {
                        ...
                        closePolicy: LingmoComponents3.Popup.NoAutoClose
                        timeout: -1
                        text: {
                ...
                RowLayout {
                    ...
                    LingmoComponents3.ProgressBar { // Time Remaining
            ...
            RowLayout { // Player Controls
                ...
                property int controlsSize: LingmoUI.Units.gridUnit * 3
                ...
                LingmoComponents3.ToolButton {
                    id: shuffleButton
                    Layout.rightMargin: LayoutMirroring.enabled ? 0 : LingmoUI.Units.gridUnit - playerControls.spacing
                    Layout.leftMargin: LayoutMirroring.enabled ? LingmoUI.Units.gridUnit - playerControls.spacing : 0
                ...
                LingmoComponents3.ToolButton { // Previous
                    id: previousButton
                    icon.width: expandedRepresentation.controlSize
                    icon.height: expandedRepresentation.controlSize
                    Layout.alignment: Qt.AlignVCenter
                ...
                LingmoComponents3.ToolButton { // Pause/Play
                    id: playPauseButton
                    icon.width: expandedRepresentation.controlSize
                    icon.height: expandedRepresentation.controlSize
                ...
                LingmoComponents3.ToolButton { // Next
                    id: nextButton
                    icon.width: expandedRepresentation.controlSize
                    icon.height: expandedRepresentation.controlSize
                    Layout.alignment: Qt.AlignVCenter
                ...
                LingmoComponents3.ToolButton {
                    id: repeatButton
                    Layout.leftMargin: LayoutMirroring.enabled ? 0 : LingmoUI.Units.gridUnit - playerControls.spacing
                    Layout.rightMargin: LayoutMirroring.enabled ? LingmoUI.Units.gridUnit - playerControls.spacing : 0
    ...
    header: LingmoExtras.PlasmoidHeading {
        id: headerItem
        position: LingmoComponents3.ToolBar.Header
        ...
        LingmoComponents3.TabBar {
            ...
            position: LingmoComponents3.TabBar.Header

            Repeater {
                id: playerList
                model: mpris2Model
                delegate: LingmoComponents3.TabButton {
                    ...
                    LingmoComponents3.ToolTip.text: text
                    LingmoComponents3.ToolTip.delay: LingmoUI.Units.toolTipDelay
                    LingmoComponents3.ToolTip.visible: hovered || (activeFocus && (focusReason === Qt.TabFocusReason || focusReason === Qt.BacktabFocusReason))
                }
            }
        }
    }
