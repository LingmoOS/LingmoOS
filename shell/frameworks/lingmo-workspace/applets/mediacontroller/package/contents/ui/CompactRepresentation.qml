...
MouseArea {
    ...
    readonly property bool inPanel: [LingmoCore.Types.TopEdge, LingmoCore.Types.RightEdge, LingmoCore.Types.BottomEdge, LingmoCore.Types.LeftEdge].includes(Plasmoid.location)
        ...
        sourceComponent: GridLayout {
            ...
            ColumnLayout {
                ...
                visible: (compactRepresentation.layoutForm !== CompactRepresentation.LayoutType.VerticalPanel
                    ...
                    && compactRepresentation.parent.width >= LingmoUI.Units.gridUnit * 5)
                ...
                PC3.Label {
                    ...
                    Layout.maximumWidth: compactRepresentation.layoutForm === CompactRepresentation.LayoutType.HorizontalPanel ? LingmoUI.Units.gridUnit * 10 : -1
