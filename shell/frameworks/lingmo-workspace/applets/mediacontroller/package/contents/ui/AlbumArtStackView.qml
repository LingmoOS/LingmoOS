...
Item {
    ...
    function loadAlbumArt() {
        ...
        function replaceWhenLoaded() {
            ...
            if (pendingImage.status === Image.Ready) {
                ...
                exitTransitionOpacityAnimator.duration = oldImageRatio === newImageRatio ? 0 : LingmoUI.Units.longDuration;
            } else {
    ...
    StackView {
        ...
        Component {
            ...
            LingmoUI.Icon { // Fallback
                id: fallbackIcon

                anchors.margins: LingmoUI.Units.gridUnit * 2
                opacity: 0
