...
PlasmoidItem {
    ...
    Plasmoid.status: (filterModel.deviceCount > 0 || isMessageHighlightAnimatorRunning) ? LingmoCore.Types.ActiveStatus : LingmoCore.Types.PassiveStatus
