...
void SystemMonitor::init()
{
    ...
    auto qmlObject = new LingmoQuick::SharedQmlEngine();
    ...
    config().writeEntry("CurrentPreset", "org.kde.lingmo.systemmonitor");
...
{
    auto job = new KIO::ApplicationLauncherJob(KService::serviceByDesktopName(u"org.kde.lingmo-systemmonitor"_s));
