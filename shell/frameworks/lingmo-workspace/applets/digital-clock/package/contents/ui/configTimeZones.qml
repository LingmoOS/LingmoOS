...
KCMUtils.ScrollViewKCM {
    ...
    view: ListView {
        ...
        delegate: LingmoUI.RadioSubtitleDelegate {
            id: timeZoneListItem
        ...
        LingmoUI.PlaceholderMessage {
            ...
            anchors {
                ...
                left: parent.left
                right: parent.right
                leftMargin: LingmoUI.Units.largeSpacing * 6
                rightMargin: LingmoUI.Units.largeSpacing * 6
            }
    ...
    LingmoUI.OverlaySheet {
        ...
        ListView {
            ...
            activeFocusOnTab: true // keyboard navigation
            clip: true
            implicitWidth: Math.max(timeZonesPage.width/2, LingmoUI.Units.gridUnit * 25)
