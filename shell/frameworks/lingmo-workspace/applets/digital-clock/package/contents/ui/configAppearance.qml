...
KCMUtils.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Information:")
        ...
        QQC2.ComboBox {
            ...
            LingmoUI.FormData.label: i18n("Show seconds:")
            model: [
        ...
        ColumnLayout {
            LingmoUI.FormData.label: i18n("Show time zone:")
            LingmoUI.FormData.buddyFor: showLocalTimeZoneWhenDifferent
            spacing: LingmoUI.Units.smallSpacing
        ...
        QQC2.ComboBox {
            ...
            LingmoUI.FormData.label: i18n("Display time zone as:")
        ...
        RowLayout {
            ...
            LingmoUI.FormData.label: i18n("Time display:")
            spacing: LingmoUI.Units.smallSpacing
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Date format:")
            enabled: showDate.checked
            spacing: LingmoUI.Units.smallSpacing
        ...
        QQC2.RadioButton {
            ...
            LingmoUI.FormData.label: i18nc("@label:group", "Text display:")
        ...
        RowLayout {
            ...
            QQC2.RadioButton {
                ...
                onClicked: {
                    if (cfg_fontFamily === "") {
                        fontDialog.fontChosen = LingmoUI.Theme.defaultFont
                    }
                }
            }
