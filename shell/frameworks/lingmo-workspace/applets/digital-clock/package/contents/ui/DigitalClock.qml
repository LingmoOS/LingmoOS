...
MouseArea {
    ...
    readonly property bool oneLineMode: {
        if (Plasmoid.configuration.dateDisplayFormat === 1) {
            ...
            // Adaptive
            return Plasmoid.formFactor === LingmoCore.Types.Horizontal &&
                height <= 2 * LingmoUI.Theme.smallFont.pixelSize &&
    ...
    states: [
        State {
            ...
            when: Plasmoid.formFactor === LingmoCore.Types.Horizontal && !main.oneLineMode
            ...
            PropertyChanges {
                ...
                width: Math.max(timeLabel.width + (Plasmoid.configuration.showDate ? timeZoneLabel.paintedWidth : 0),
                                timeZoneLabel.paintedWidth, dateLabel.paintedWidth) + LingmoUI.Units.largeSpacing
            }
        ...
        State {
            ...
            when: Plasmoid.formFactor !== LingmoCore.Types.Vertical && main.oneLineMode
        ...
        State {
            name: "verticalPanel"
            when: Plasmoid.formFactor === LingmoCore.Types.Vertical
            ...
            PropertyChanges {
                ...
                height: LingmoUI.Units.gridUnit * 10
                ...
                font.pixelSize: Math.min(0.7 * timeLabel.height, LingmoUI.Theme.defaultFont.pixelSize * 1.4)
                elide: Text.ElideRight
        ...
        State {
            name: "other"
            when: Plasmoid.formFactor !== LingmoCore.Types.Vertical && Plasmoid.formFactor !== LingmoCore.Types.Horizontal
            ...
            PropertyChanges {
                ...
                height: 0.7 * timeLabel.height
                font.pixelSize: 1024
                width: Math.max(timeLabel.contentWidth, LingmoUI.Units.gridUnit * 3)
                verticalAlignment: Text.AlignVCenter
    ...
    */
    ...
    LingmoComponents.Label {
        ...
        font.family: (Plasmoid.configuration.autoFontAndSize || Plasmoid.configuration.fontFamily.length === 0) ? LingmoUI.Theme.defaultFont.family : Plasmoid.configuration.fontFamily
        font.weight: Plasmoid.configuration.autoFontAndSize ? LingmoUI.Theme.defaultFont.weight : Plasmoid.configuration.fontWeight
        font.italic: Plasmoid.configuration.autoFontAndSize ? LingmoUI.Theme.defaultFont.italic : Plasmoid.configuration.italicText
        font.pixelSize: Plasmoid.configuration.autoFontAndSize ? 3 * LingmoUI.Theme.defaultFont.pixelSize : pointToPixel(Plasmoid.configuration.fontSize)
        font.pointSize: -1
        fontSizeMode: Text.VerticalFit
    ...
    function setupLabels() {
        ...
        if (showTimezone) {
            ...
            if ((Plasmoid.configuration.showDate || oneLineMode) && Plasmoid.formFactor === LingmoCore.Types.Horizontal) {
