...
import org.kde.lingmo.workspace.calendar 2.0
...
PlasmoidItem {
    ...
    Layout.minimumHeight: LingmoUI.Units.iconSizes.large
    ...
    compactRepresentation: MouseArea {
        ...
        LingmoUI.Icon {
            ...
            LingmoComponents3.Label {
                ...
                visible: parent.width > LingmoUI.Units.gridUnit * 3
            }
    ...
    fullRepresentation: Item {
        ...
        readonly property int _minimumHeight: LingmoUI.Units.gridUnit * 14
