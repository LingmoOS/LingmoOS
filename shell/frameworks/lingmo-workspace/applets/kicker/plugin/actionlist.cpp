...
#include <LingmoActivities/Stats/Cleaning>
...
static QList<KServiceAction> additionalActions(const KService::Ptr &service)
{
    ...
    const static auto locations =
        QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("lingmo/kickeractions"), QStandardPaths::LocateDirectory);
