...
PlasmoidItem {
    ...
    height: LingmoUI.Units.gridUnit * 15
    ...
    compactRepresentation: MouseArea {
        ...
        Layout.minimumWidth: Plasmoid.formFactor !== LingmoCore.Types.Vertical ? representation.height : LingmoUI.Units.gridUnit
        Layout.minimumHeight: Plasmoid.formFactor === LingmoCore.Types.Vertical ? representation.width : LingmoUI.Units.gridUnit
    ...
    fullRepresentation: LingmoCalendar.MonthView {
        Layout.minimumWidth: LingmoUI.Units.gridUnit * 22
        Layout.maximumWidth: LingmoUI.Units.gridUnit * 80
        Layout.minimumHeight: LingmoUI.Units.gridUnit * 22
