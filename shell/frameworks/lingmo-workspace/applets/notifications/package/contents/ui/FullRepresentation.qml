...
LingmoExtras.Representation {
    ...
    Layout.fillHeight: Plasmoid.formFactor === LingmoCore.Types.Vertical
    ...
    header: LingmoExtras.PlasmoidHeading {
        ColumnLayout {
            ...
            LingmoExtras.DescriptiveLabel {
                Layout.leftMargin: dndCheck.mirrored ? 0 : dndCheck.indicator.width + 2 * dndCheck.spacing + LingmoUI.Units.iconSizes.smallMedium
                Layout.rightMargin: dndCheck.mirrored ? dndCheck.indicator.width + 2 * dndCheck.spacing + LingmoUI.Units.iconSizes.smallMedium : 0
                Layout.fillWidth: true
    ...
    LingmoComponents3.ScrollView {
        ...
        contentItem: ListView {
            ...
            // Not using LingmoExtras.Highlight as this is only for indicating keyboard focus
            ...
            delegate: DraggableDelegate {
                ...
                SequentialAnimation {
                    ...
                    ParallelAnimation {
                        NumberAnimation { target: delegate; property: "opacity"; to: 0; duration: LingmoUI.Units.longDuration }
                        NumberAnimation {
                            target: transl
                            property: "x"
                            to: list.width - (scrollView.LingmoComponents3.ScrollBar.vertical.visible ? LingmoUI.Units.largeSpacing * 2 : 0)
                            duration: LingmoUI.Units.longDuration
                        }
                    }
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Item {
                                    ...
                                    // Not using the Lingmo theme's vertical line SVG because we want something thicker
                                    // than a hairline, and thickening a thin line SVG does not necessarily look good
                                    // with all Lingmo themes.
                                    Rectangle {
