...
PlasmoidItem {
    ...
    readonly property int effectiveStatus: historyModel.activeJobsCount > 0
                     ...
                     || Globals.inhibited ? LingmoCore.Types.ActiveStatus
                                          : LingmoCore.Types.PassiveStatus
    onEffectiveStatusChanged: {
        if (effectiveStatus === LingmoCore.Types.PassiveStatus) {
    ...
    switchWidth: LingmoUI.Units.gridUnit * 14
    ...
    switchHeight: Plasmoid.formFactor === LingmoCore.Types.Vertical ? 1 : LingmoUI.Units.gridUnit * 10
