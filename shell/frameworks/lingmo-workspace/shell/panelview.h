...
class PanelView : public LingmoQuick::ContainmentView

{
     ...
     * @since 5.9
     */
    Q_PROPERTY(Lingmo::Types::BackgroundHints backgroundHints WRITE setBackgroundHints READ backgroundHints NOTIFY backgroundHintsChanged)
...
public:
    ...
    static KConfigGroup panelConfig(ShellCorona *corona, Lingmo::Containment *containment, QScreen *screen);
    static KConfigGroup panelConfigDefaults(ShellCorona *corona, Lingmo::Containment *containment, QScreen *screen);
...
protected Q_SLOTS:
     ...
     */
    void showConfigurationInterface(Lingmo::Applet *applet) override;
...
private Q_SLOTS:
    ...
    void refreshStatus(Lingmo::Types::ItemStatus);
...
private:
    ...
    QPointer<LingmoQuick::ConfigView> m_appletConfigView;
    QPointer<LingmoQuick::PopupLingmoWindow> m_panelConfigView;
    ...
    Lingmo::Types::BackgroundHints m_backgroundHints;
