...
{
public:
    WaylandAutoHideScreenEdgeV1(Lingmo::Types::Location location, ::kde_auto_hide_screen_edge_v1 *edge)
    ...
    const Lingmo::Types::Location location;
};
    ...
    : AutoHideScreenEdge(view)
{
    ...
    if (!m_manager->isActive()) {
        qCWarning(LINGMOSHELL) << m_manager->extensionInterface()->name << "is unsupported by the compositor. Panel autohide won't work correctly";
        return;
    }
