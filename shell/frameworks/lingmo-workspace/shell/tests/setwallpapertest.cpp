...
#define SERVICE_NAME "org.kde.lingmoshell"
...
void SetWallPaperTest::setWallpaper(const QString &wallpaperPath)
{
    ...
    // find our remote
    auto iface = new QDBusInterface(QStringLiteral(SERVICE_NAME), u"/LingmoShell"_s, u"org.kde.LingmoShell"_s, QDBusConnection::sessionBus(), this);
    if (!iface->isValid()) {
