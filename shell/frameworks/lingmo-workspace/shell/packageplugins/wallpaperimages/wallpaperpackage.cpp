...
/**
 * By specifying "X-KDE-LingmoImageWallpaper-AccentColor" in metadata,
...
K_PLUGIN_CLASS_WITH_JSON(WallpaperPackage, "lingmo-packagestructure-wallpaperimages.json")
