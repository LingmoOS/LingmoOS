...
class DesktopView : public LingmoQuick::ContainmentView
{
    Q_OBJECT
     ...
     *
     * @note When usedInAccentColor becomes @c true, \LingmoUI.ImageColors
...
public:
    explicit DesktopView(Lingmo::Corona *corona, QScreen *targetScreen = nullptr);
