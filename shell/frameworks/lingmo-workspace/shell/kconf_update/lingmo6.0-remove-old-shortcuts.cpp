...
/**
 * In lingmo5, every single contextual action was registered as a global shortcut, with
 * Often confusing and duplicated names. Now this capability has been dropped in Lingmo6
...
int main(int argc, char **argv)
{
    ...
    KConfigGroup lingmoGroup(configPtr, QStringLiteral("lingmoshell"));
    ...
    QStringList filteredActionNames = lingmoGroup.keyList();
    ...
    for (const QString &actionName : filteredActionNames) {
        ...
        action.setProperty("componentName", QStringLiteral("lingmoshell"));
        action.setProperty("componentDisplayName", QStringLiteral("Lingmo"));
