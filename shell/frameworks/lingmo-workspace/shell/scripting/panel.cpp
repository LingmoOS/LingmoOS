...
{
Panel::Panel(Lingmo::Containment *containment, ScriptEngine *engine)
...
void Panel::setLocation(const QString &locationString)
{
    ...
    Lingmo::Types::Location loc = Lingmo::Types::Floating;
    Lingmo::Types::FormFactor ff = Lingmo::Types::Planar;
    if (lower == u"desktop") {
        loc = Lingmo::Types::Desktop;
    } else if (lower == u"fullscreen") {
        loc = Lingmo::Types::FullScreen;
    } else if (lower == u"top") {
        loc = Lingmo::Types::TopEdge;
        ff = Lingmo::Types::Horizontal;
    } else if (lower == u"bottom") {
        loc = Lingmo::Types::BottomEdge;
        ff = Lingmo::Types::Horizontal;
    } else if (lower == u"left") {
        loc = Lingmo::Types::LeftEdge;
        ff = Lingmo::Types::Vertical;
    } else if (lower == u"right") {
        loc = Lingmo::Types::RightEdge;
        ff = Lingmo::Types::Vertical;
    }
     ...
     *
     * @see isHorizontal in lingmo-desktop/containments/panel/contents/ui/main.qml
     */
