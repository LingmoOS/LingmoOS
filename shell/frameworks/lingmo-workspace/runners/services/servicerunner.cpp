...
ServiceRunner::ServiceRunner(QObject *parent, const KPluginMetaData &metaData)
    ...
    , m_kactivitiesQuery(Terms::LinkedResources | Terms::Agent{QStringLiteral("org.kde.lingmo.favorites.applications")} | Terms::Type::any()
...
K_PLUGIN_CLASS_WITH_JSON(ServiceRunner, "lingmo-runner-services.json")
