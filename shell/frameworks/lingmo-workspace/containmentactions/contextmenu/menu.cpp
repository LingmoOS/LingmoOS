...
ContextMenu::ContextMenu(QObject *parent, const QVariantList &args)
    : Lingmo::ContainmentActions(parent, args)
...
void ContextMenu::restore(const KConfigGroup &config)
{
    ...
    if (c->containmentType() == Lingmo::Containment::Panel || c->containmentType() == Lingmo::Containment::CustomPanel) {
    ...
    if (!m_runCommandAction) {
        m_runCommandAction = new QAction(i18nc("lingmo_containmentactions_contextmenu", "Show KRunner"), this);
        ...
        m_lockScreenAction = new QAction(i18nc("lingmo_containmentactions_contextmenu", "Lock Screen"), this);
        ...
        m_logoutAction = new QAction(i18nc("lingmo_containmentactions_contextmenu", "Show Logout Screen"), this);
        ...
        m_configureDisplaysAction = new QAction(i18nc("lingmo_containmentactions_contextmenu", "Display Configuration"), this);
        ...
        if (name == QLatin1String("_wallpaper")) {
            ...
            if (name != QLatin1String("remove") || cont->isUserConfiguring()
                || (cont->containmentType() != Lingmo::Containment::Panel && cont->containmentType() != Lingmo::Containment::CustomPanel
                    && cont->corona()->immutability() != Lingmo::Types::Mutable)) {
                actions << a;
            }
        }
    }
...
QAction *ContextMenu::action(const QString &name)
{
    ...
    if (name == QLatin1String("_sep1")) {
        ...
        if (c->corona() && c->corona()->immutability() == Lingmo::Types::Mutable) {
...
QWidget *ContextMenu::createConfigurationInterface(QWidget *parent)
{
    ...
    widget->setWindowTitle(i18nc("lingmo_containmentactions_contextmenu", "Configure Contextual Menu Plugin"));
    ...
    for (const QString &name : std::as_const(m_actionOrder)) {
        ...
        if (name == QLatin1String("_context")) {
            ...
            // FIXME better text
            item->setText(i18nc("lingmo_containmentactions_contextmenu", "[Other Actions]"));
        } else if (name == QLatin1String("_wallpaper")) {
            item = new QCheckBox(widget);
            item->setText(i18nc("lingmo_containmentactions_contextmenu", "Wallpaper Actions"));
            ...
            item = new QCheckBox(widget);
            item->setText(i18nc("lingmo_containmentactions_contextmenu", "[Separator]"));
        } else {
