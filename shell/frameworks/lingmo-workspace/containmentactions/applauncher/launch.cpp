...
QWidget *AppLauncher::createConfigurationInterface(QWidget *parent)
{
    ...
    m_ui.setupUi(widget);
    widget->setWindowTitle(i18nc("lingmo_containmentactions_applauncher", "Configure Application Launcher Plugin"));
...
K_PLUGIN_CLASS_WITH_JSON(AppLauncher, "lingmo-containmentactions-applauncher.json")
