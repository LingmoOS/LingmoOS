...
{
    if (qApp->applicationName() == QLatin1String("lingmo-netbook")) {
...
Lingmo5Support::Service *ActivityEngine::serviceForSource(const QString &source)
{
...
K_PLUGIN_CLASS_WITH_JSON(ActivityEngine, "lingmo-dataengine-activities.json")
