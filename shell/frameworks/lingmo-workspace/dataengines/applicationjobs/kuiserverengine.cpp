...
Lingmo5Support::Service *KuiserverEngine::serviceForSource(const QString &source)
{
...
K_PLUGIN_CLASS_WITH_JSON(KuiserverEngine, "lingmo-dataengine-applicationjobs.json")
