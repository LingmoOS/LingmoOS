...
bool PowermanagementEngine::updateSourceEvent(const QString &source)
{
    ...
    return Lingmo5Support::DataEngine::updateSourceEvent(source);
}

Lingmo5Support::Service *PowermanagementEngine::serviceForSource(const QString &source)
{
...
K_PLUGIN_CLASS_WITH_JSON(PowermanagementEngine, "lingmo-dataengine-powermanagement.json")
