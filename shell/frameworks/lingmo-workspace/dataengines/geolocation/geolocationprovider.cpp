    ...
    , m_updating(false)
{
    ...
    qRegisterMetaType<Lingmo5Support::DataEngine::Data>("Lingmo5Support::DataEngine::Data");
    connect(&m_updateTimer, &QTimer::timeout, this, &GeolocationProvider::updated);
}

void GeolocationProvider::init(Lingmo5Support::DataEngine::Data *data, EntryAccuracy *accuracies)
{
    m_sharedData = data;
...
{
    Lingmo5Support::DataEngine::Data::const_iterator it = m_data.constBegin();
    bool changed = false;
...
void GeolocationProvider::setData(const Lingmo5Support::DataEngine::Data &data)
{
    m_updating = false;
    m_data = data;
