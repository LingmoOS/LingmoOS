...
void Geolocation::init()
{
    ...
    const QList<KPluginMetaData> offers = KPluginMetaData::findPlugins("lingmo5support/geolocationprovider", {}, KPluginMetaData::AllowEmptyMetaData);
...
K_PLUGIN_CLASS_WITH_JSON(Geolocation, "lingmo-dataengine-geolocation.json")
