...
public:
    ...
    void init(Lingmo5Support::DataEngine::Data *data, EntryAccuracy *accuracies);
...
protected Q_SLOTS:
    void setData(const Lingmo5Support::DataEngine::Data &data);
    void setData(const QString &key, const QVariant &value);

private:
    Lingmo5Support::DataEngine::Data *m_sharedData;
