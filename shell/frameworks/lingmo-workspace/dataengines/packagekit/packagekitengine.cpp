...
Lingmo5Support::Service *PackagekitEngine::serviceForSource(const QString &source)
{
    if (m_pk_available) {
...
K_PLUGIN_CLASS_WITH_JSON(PackagekitEngine, "lingmo-dataengine-packagekit.json")
