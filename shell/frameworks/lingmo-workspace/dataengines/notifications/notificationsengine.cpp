...
Lingmo5Support::Service *NotificationsEngine::serviceForSource(const QString &source)
{
...
K_PLUGIN_CLASS_WITH_JSON(NotificationsEngine, "lingmo-dataengine-notifications.json")
