    ...
    , m_notifier(nullptr)
{
    ...
    connect(this, &Lingmo5Support::DataEngine::sourceRemoved, this, &SolidDeviceEngine::sourceWasRemoved);
}
...
Lingmo5Support::Service *SolidDeviceEngine::serviceForSource(const QString &source)
{
...
K_PLUGIN_CLASS_WITH_JSON(SolidDeviceEngine, "lingmo-dataengine-soliddevice.json")
