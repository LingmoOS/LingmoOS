    ...
    : Lingmo5Support::DataEngine(parent)
{
    ...
    connect(this, &Lingmo5Support::DataEngine::sourceRemoved, this, &WeatherEngine::removeIonSource);
...
void WeatherEngine::updateIonList()
{
    ...
    const auto infos = Lingmo5Support::PluginLoader::listDataEngineMetaData(QStringLiteral("weatherengine"));
 ...
 */
void WeatherEngine::dataUpdated(const QString &source, const Lingmo5Support::DataEngine::Data &data)
{
...
{
    Q_UNUSED(ion);
    Lingmo5Support::DataContainer *container = containerForSource(source);
    if (container) {
...
K_PLUGIN_CLASS_WITH_JSON(WeatherEngine, "lingmo-dataengine-weather.json")
