...
bool EnvCanadaIon::readXMLData(const QString &source, QXmlStreamReader &xml)
{
    ...
    Lingmo5Support::DataEngine *timeEngine = dataEngine(QStringLiteral("time"));
    if (timeEngine) {
...
void EnvCanadaIon::dataUpdated(const QString &sourceName, const Lingmo5Support::DataEngine::Data &data)
{
