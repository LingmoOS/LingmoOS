...
{
    const QString stationsFileName = u"lingmo/weather/noaa_station_list.xml"_s;
...
void NOAAIon::getSolarData(const QString &source)
{
    ...
    Lingmo5Support::DataEngine *timeEngine = dataEngine(u"time"_s);
    if (timeEngine) {
...
void NOAAIon::dataUpdated(const QString &sourceName, const Lingmo5Support::DataEngine::Data &data)
{
