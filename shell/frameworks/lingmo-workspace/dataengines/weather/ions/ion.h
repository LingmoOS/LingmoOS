 ...
 * data from.
 *
 * Basically an ion is a Lingmo5Support::DataEngine, which is queried by the WeatherEngine instead of some applet.
 *
 *
 ...
 */
class ION_EXPORT IonInterface : public Lingmo5Support::DataEngine
{
    Q_OBJECT
...
public:
     ...
     */
    explicit IonInterface(QObject *parent);
    /**
...
public Q_SLOTS:
    ...
    /**
     * Reimplemented from Lingmo5Support::DataEngine
