...
/**
 * This class is connected with solid, filter devices and provide signal with source for applet in Lingmo
 */
class HotplugEngine : public Lingmo5Support::DataEngine
{
    Q_OBJECT
