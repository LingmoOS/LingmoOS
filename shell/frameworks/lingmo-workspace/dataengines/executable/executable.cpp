...
ExecutableContainer::ExecutableContainer(const QString &command, QObject *parent)
    : Lingmo5Support::DataContainer(parent)
    , m_process(nullptr)
{
    setObjectName(command);
    connect(this, &Lingmo5Support::DataContainer::updateRequested, this, &ExecutableContainer::exec);
    exec();
}
...
K_PLUGIN_CLASS_WITH_JSON(ExecutableEngine, "lingmo-dataengine-executable.json")
