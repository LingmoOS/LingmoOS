...
void sanity_check(int argc, char *argv[])
{
    ...
    if (!msg.isEmpty()) {
        ...
        KMessageBox::error(nullptr, qmsg, i18n("Lingmo Workspace installation problem!"));
        exit(255);
    }
}
...
int main(int argc, char *argv[])
{
    ...
    parser.setApplicationDescription(i18n("The reliable Lingmo session manager that talks the standard X11R6 \nsession management protocol (XSMP)."));
    ...
    // we don't need session restoring in Lingmo Mobile
