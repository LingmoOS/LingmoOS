...
SplashWindow::SplashWindow(bool testing, bool window, const QString &theme, QScreen *screen)
    : LingmoQuick::QuickViewSharedEngine()
    , m_stage(0)
    , m_testing(testing)
    , m_window(window)
    , m_theme(theme)
{
    ...
    setResizeMode(LingmoQuick::QuickViewSharedEngine::SizeRootObjectToView);
...
{
    LingmoQuick::QuickViewSharedEngine::keyPressEvent(event);
...
{
    LingmoQuick::QuickViewSharedEngine::mousePressEvent(event);
...
void SplashWindow::setGeometry(const QRect &rect)
{
    ...
    LingmoQuick::QuickViewSharedEngine::setGeometry(rect);
