...
Lingmo::Containment *AppletsLayout::containment() const
{
    return m_containment;
}

void AppletsLayout::setContainment(Lingmo::Containment *containment)
{
    ...
    connect(m_containment, &Lingmo::Containment::appletAdded, this, &AppletsLayout::appletAdded);
    connect(m_containment, &Lingmo::Containment::appletRemoved, this, &AppletsLayout::appletRemoved);

    Q_EMIT containmentChanged();
}

LingmoQuick::AppletQuickItem *AppletsLayout::containmentItem() const
{
    return m_containmentItem;
}

void AppletsLayout::setContainmentItem(LingmoQuick::AppletQuickItem *containmentItem)
{
...
void AppletsLayout::componentComplete()
{
    ...
    if (m_containment && m_containment->corona()) {
        ...
        connect(m_containment->corona(), &Lingmo::Corona::startupCompleted, this, [this]() {
            save();
        });
        ...
        // constant
        connect(m_containment->corona(), &Lingmo::Corona::screenGeometryChanged, this, [this](int id) {
        ...
        connect(m_containment, &Lingmo::Containment::screenChanged, this, [this]() {
            m_geometryBeforeResolutionChange = QRectF(x(), y(), width(), height());
            m_layoutChangeTimer->start();
        });
    }
...
void AppletsLayout::appletAdded(Lingmo::Applet *applet)
{
    LingmoQuick::AppletQuickItem *appletItem = LingmoQuick::AppletQuickItem::itemForApplet(applet);
...
void AppletsLayout::appletRemoved(Lingmo::Applet *applet)
{
    LingmoQuick::AppletQuickItem *appletItem = LingmoQuick::AppletQuickItem::itemForApplet(applet);
...
AppletContainer *AppletsLayout::createContainerForApplet(LingmoQuick::AppletQuickItem *appletItem)
{
    AppletContainer *container = m_containerForApplet.value(appletItem);
