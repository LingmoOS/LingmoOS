...
class AppletContainer : public ItemContainer
{
    ...
    Q_PROPERTY(LingmoQuick::AppletQuickItem *applet READ applet NOTIFY appletChanged)
...
public:
    ...
    LingmoQuick::AppletQuickItem *applet(); // TODO: appletItem()?
...
private:
    ...
    QPointer<LingmoQuick::AppletQuickItem> m_appletItem;
