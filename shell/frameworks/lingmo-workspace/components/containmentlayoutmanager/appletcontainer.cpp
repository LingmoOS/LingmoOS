    ...
    : ItemContainer(parent)
{
    connect(this, &AppletContainer::contentItemChanged, this, [this]() {
        ...
        m_appletItem = qobject_cast<LingmoQuick::AppletQuickItem *>(contentItem());
...
LingmoQuick::AppletQuickItem *AppletContainer::applet()
{
    return m_appletItem;
}
...
void AppletContainer::connectBusyIndicator()
{
    if (m_appletItem && !m_busyIndicatorItem) {
        ...
        connect(m_appletItem->applet(), &Lingmo::Applet::busyChanged, this, [this]() {
...
void AppletContainer::connectConfigurationRequired()
{
    if (m_appletItem && !m_configurationRequiredItem) {
        ...
        connect(m_appletItem->applet(), &Lingmo::Applet::configurationRequiredChanged, this, syncConfigRequired);
