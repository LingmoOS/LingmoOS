...
class AppletsLayout : public QQuickItem
{
    ...
    // from the screen size and lingmo starts on an "unexpected" size
    ...
    Q_PROPERTY(Lingmo::Containment *containment READ containment WRITE setContainment NOTIFY containmentChanged)

    Q_PROPERTY(LingmoQuick::AppletQuickItem *containmentItem READ containmentItem WRITE setContainmentItem NOTIFY containmentItemChanged)
...
public:
    ...
    void setContainment(Lingmo::Containment *containment);

    LingmoQuick::AppletQuickItem *containmentItem() const;
    void setContainmentItem(LingmoQuick::AppletQuickItem *containment);
...
private:
    AppletContainer *createContainerForApplet(LingmoQuick::AppletQuickItem *appletItem);
    ...
    QPointer<LingmoQuick::AppletQuickItem> m_containmentItem;
    ...
    QHash<LingmoQuick::AppletQuickItem *, AppletContainer *> m_containerForApplet;
