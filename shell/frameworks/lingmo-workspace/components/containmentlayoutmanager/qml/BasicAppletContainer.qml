...
ContainmentLayoutManager.AppletContainer {
    ...
    LingmoUI.Theme.colorSet: (applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.ShadowBackground)
        && !(applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.StandardBackground)
        && !(applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.TranslucentBackground)
            ? LingmoUI.Theme.Complementary
            : LingmoUI.Theme.Window
    ...
    background: KSvg.FrameSvgItem {
        ...
        imagePath: {
            ...
            if (appletContainer.applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.TranslucentBackground) {
                return "widgets/translucentbackground";
            } else if (appletContainer.applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.StandardBackground) {
        ...
        function bindBlurEnabled() {
            ...
            blurEnabled = Qt.binding(() =>
                ...
                && (appletContainer.applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.StandardBackground)
        ...
        DropShadow {
            ...
            source: appletContainer.applet && appletContainer.applet.plasmoid.effectiveBackgroundHints & LingmoCore.Types.ShadowBackground
    ...
    Component {
        ...
        OpacityMask {
            ...
            readonly property rect appletContainerScreenRect: {
                ...
                const position = appletContainer.LingmoUI.ScenePosition;
                return clipRect(
            ...
            maskSource: Item {
                ...
                KSvg.FrameSvgItem {
                    ...
                    x: appletContainer.LingmoUI.ScenePosition.x - mask.appletContainerScreenRect.x
                    y: appletContainer.LingmoUI.ScenePosition.y - mask.appletContainerScreenRect.y
    ...
    busyIndicatorComponent: LingmoComponents.BusyIndicator {
        anchors.centerIn: parent
        visible: applet.plasmoid.busy
        running: visible
    }
    configurationRequiredComponent: LingmoComponents.Button {
        anchors.centerIn: parent
        text: i18nd("lingmoshellprivateplugin", "Configure…")
        icon.name: "configure"
