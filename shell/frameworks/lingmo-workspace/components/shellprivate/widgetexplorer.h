...
class WidgetExplorer : public QObject, public QQmlParserStatus
{
    ...
    /**
     * Actions for adding widgets, like download lingmo widgets, download google gadgets, install from local file
     */
...
protected Q_SLOTS:
    void immutabilityChanged(Lingmo::Types::ImmutabilityType);

private:
    Q_PRIVATE_SLOT(d, void appletAdded(Lingmo::Applet *))
    Q_PRIVATE_SLOT(d, void appletRemoved(Lingmo::Applet *))
