...
class LingmoAppletItemModel;

/**
 * Implementation of the KCategorizedItemsViewModels::AbstractItem
 */
class LingmoAppletItem : public KCategorizedItemsViewModels::AbstractItem
{
public:
    explicit LingmoAppletItem(const KPluginMetaData &info);
...
class LingmoAppletItemModel : public QStandardItemModel
{
    Q_OBJECT
...
public:
    ...
    explicit LingmoAppletItemModel(QObject *parent = nullptr);
