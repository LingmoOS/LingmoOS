...
Item {
     ...
     */
    property LingmoCalendar.EventPluginsManager eventPluginsManager
    ...
    LingmoComponents.SwipeView {
        ...
        // Warning: this binding depends on an implementation detail of LingmoComponents.SwipeView
        ...
        InfiniteList {
            ...
            delegate: DaysCalendar {
                ...
                dateMatchingPrecision: LingmoCalendar.Calendar.MatchYearMonthAndDay
        ...
        InfiniteList {
            ...
            delegate: DaysCalendar {
                dateMatchingPrecision: LingmoCalendar.Calendar.MatchYearAndMonth
                columns: 3
                rows: 4
        ...
        InfiniteList {
            ...
            delegate: DaysCalendar {
                ...
                dateMatchingPrecision: LingmoCalendar.Calendar.MatchYear
                columns: 3
                rows: 4
