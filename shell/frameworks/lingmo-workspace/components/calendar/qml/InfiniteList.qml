...
ListView {
    ...
    readonly property LingmoCalendar.Calendar previousCalendar: previousAlternativeBackend.item
    readonly property LingmoCalendar.Calendar nextCalendar: nextAlternativeBackend.item
    ...
    required property LingmoCalendar.Calendar backend
    ...
    Loader {
        ...
        sourceComponent: LingmoCalendar.Calendar {
