...
KCM.SimpleKCM {
    ...
    LingmoUI.FormLayout {
        ...
        RowLayout {
            LingmoUI.FormData.label: i18n("Anti-Aliasing:")
            QtControls.CheckBox {
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nc("Used as a noun, and precedes a combobox full of options", "Sub-pixel rendering:")
            QtControls.ComboBox {
                id: subPixelCombo
                Layout.preferredWidth: formLayout.maxImplicitWidth
        ...
        RowLayout {
            LingmoUI.FormData.label: i18nc("Used as a noun, and precedes a combobox full of options", "Hinting:")
            QtControls.ComboBox {
                id: hintingCombo
                Layout.preferredWidth: formLayout.maxImplicitWidth
