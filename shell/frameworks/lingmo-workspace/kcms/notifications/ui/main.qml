...
KCM.SimpleKCM {
    ...
    implicitWidth: LingmoUI.Units.gridUnit * 36

    readonly property string ourServerVendor: "KDE"
    readonly property string ourServerName: "Lingmo"
    ...
    function openSystemNotificationSettings() {
        const idx = kcm.sourcesModel.persistentIndexForNotifyRcName(kcm.lingmoWorkspaceNotifyRcName);
    ...
    actions: [
        LingmoUI.Action {
            text: i18nc("@action:button Lingmo-specific notifications", "System Notifications")
    ...
    Connections {
        ...
        function onFirstLoadDone() {
            if (kcm.initialDesktopEntry || kcm.initialNotifyRcName) {
                if (kcm.initialNotifyRcName === kcm.lingmoWorkspaceNotifyRcName) {
            ...
            text: {
                if (currentOwnerInfo.vendor && currentOwnerInfo.name) {
                    return i18nc("Vendor and product name",
                                 "Notifications are currently provided by '%1 %2' instead of Lingmo.",
                                 currentOwnerInfo.vendor, currentOwnerInfo.name);
                }

                return i18n("Notifications are currently not provided by Lingmo.");
            }
    ...
    LingmoUI.FormLayout {
        ...
        Item {
            LingmoUI.FormData.label: i18nc("@title:group", "Do Not Disturb mode")
            LingmoUI.FormData.isSection: true
        }

        QtControls.CheckBox {
            LingmoUI.FormData.label: i18nc("Automatically enable Do Not Disturb mode when screens are mirrored", "Enable automatically:")
        ...
        KQuickControls.KeySequenceItem {
            LingmoUI.FormData.label: i18nc("Keyboard shortcut to turn Do Not Disturb mode on and off", "Manually toggle with shortcut:")
            enabled: root.notificationsAvailable
        ...
        Item {
            LingmoUI.FormData.label: i18nc("@title:group", "Visibility conditions")
            LingmoUI.FormData.isSection: true
        }

        QtControls.CheckBox {
            LingmoUI.FormData.label: i18n("Critical notifications:")
        ...
        QtControls.CheckBox {
            LingmoUI.FormData.label: i18n("Normal notifications:")
        ...
        QtControls.CheckBox {
            LingmoUI.FormData.label: i18n("Low priority notifications:")
        ...
        Item {
            LingmoUI.FormData.label: i18nc("@title:group As in: 'notification popups'", "Popups")
            LingmoUI.FormData.isSection: true
        }

        QtControls.RadioButton {
            id: positionCloseToWidget
            LingmoUI.FormData.label: i18nc("@label", "Location:")
        ...
        QtControls.SpinBox {
            id: timeoutSpinner
            LingmoUI.FormData.label: i18nc("Part of a sentence like, 'Hide popup after n seconds'", "Hide after:")
        ...
        Item {
            LingmoUI.FormData.label: i18nc("@title:group", "Additional feedback")
            LingmoUI.FormData.isSection: true
        }
        ...
        QtControls.CheckBox {
            ...
            LingmoUI.FormData.label: i18n("Application progress:")
        ...
        QtControls.CheckBox {
            LingmoUI.FormData.label: i18n("Notification badges:")
