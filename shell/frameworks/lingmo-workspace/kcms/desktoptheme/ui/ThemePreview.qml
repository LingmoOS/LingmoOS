...
Item {
    ...
    Item {
        ...
        KSvg.FrameSvgItem {
            ...
            // Ideally Lingmo::FrameSvg exposes the transparent margins one day.
            readonly property int generalMargin: 2 * LingmoUI.Units.largeSpacing
            anchors {
                fill: parent
    ...
    Component.onCompleted: {
        kcm.applyLingmoTheme(root, themeName);
    }
}
