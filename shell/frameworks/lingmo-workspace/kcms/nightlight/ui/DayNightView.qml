...
ColumnLayout {
    ...
    Rectangle {
        ...
        color: root.enabled ? grad.nightColor : LingmoUI.Theme.backgroundColor
        ...
        Repeater {
            ...
            LingmoUI.Icon {
                ...
                color: root.enabled ? 'black'  : LingmoUI.Theme.textColor
            }
        }
    ...
    function isThemeDark(): bool {
        const bg = LingmoUI.Theme.backgroundColor;
