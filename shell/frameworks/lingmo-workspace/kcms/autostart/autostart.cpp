    ...
    , m_model(new AutostartModel(this))
{
    ...
    qmlRegisterUncreatableType<AutostartModel>("org.kde.lingmo.kcm.autostart", 1, 0, "AutostartModel", QStringLiteral("Only for enums"));
    qmlRegisterUncreatableType<Unit>("org.kde.lingmo.kcm.autostart", 1, 0, "Unit", QStringLiteral("Unit object is not creatable"));
}
