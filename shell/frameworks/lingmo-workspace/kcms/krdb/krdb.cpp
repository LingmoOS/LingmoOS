...
static void applyQtSettings(KSharedConfigPtr kglobalcfg, QSettings &settings)
{
    ...
    // NOTE keep this in sync with kfontsettingsdata in lingmo-integration (cf. also Bug 378262)
...
void runRdb(unsigned int flags)
{
    ...
    QString theme = mousecfg.readEntry("cursorTheme", QStringLiteral("ocean_cursors"));
