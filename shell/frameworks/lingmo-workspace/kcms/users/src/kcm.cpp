...
{
    constexpr const char *uri = "org.kde.lingmo.kcm.users";
    ...
    const auto dirs = QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("lingmo/avatars"), QStandardPaths::LocateDirectory);
