    ...
    ColumnLayout {
        ...
        LingmoUI.FormLayout {
            ...
            QQC2.RadioButton {
                ...
                LingmoUI.FormData.label: i18nc("@label", "Cursor feedback:")
            ...
            QQC2.CheckBox {
                ...
                LingmoUI.FormData.label: i18nc("@label", "Task Manager feedback:")
            ...
            QQC2.SpinBox {
                ...
                LingmoUI.FormData.label: i18nc("@label", "Stop animations after:")
