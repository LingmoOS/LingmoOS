    ...
    , m_selectedLanguageModel(new SelectedLanguageModel(this))
{
     ...
     *
     * see https://invent.kde.org/lingmo/lingmo-workspace/-/merge_requests/2478
     * and https://mail.kde.org/pipermail/kde-i18n-doc/2023-January/001340.html
     * for more info on the matter
     */
    auto availableLanguages = KLocalizedString::availableDomainTranslations("lingmoshell");
...
void SelectedLanguageModel::addLanguage(const QString &lang)
{
    ...
    // fix LingmoUI.SwipeListItem doesn't connect to Actions' visible property.
