...
KCM.ScrollViewKCM {
    id: root
    implicitHeight: LingmoUI.Units.gridUnit * 40
    ...
    header: ColumnLayout {
        ...
        LingmoUI.InlineMessage {
            ...
            type: LingmoUI.MessageType.Positive
            position: LingmoUI.InlineMessage.Position.Header
            ...
            view: ListView {
                ...
                delegate: LingmoUI.SubtitleDelegate {
                    ...
                    contentItem: RowLayout {
                        ...
                        QQC2.Label {
                            color: !titleSubtitle.selected ? LingmoUI.Theme.disabledTextColor: titleSubtitle.color
            ...
            view: ListView {
                ...
                delegate: LingmoUI.SubtitleDelegate {
                    ...
                    contentItem: RowLayout {
                        ...
                        QQC2.Label {
                            color: !icontTitle.selected ? LingmoUI.Theme.disabledTextColor: icontTitle.color
