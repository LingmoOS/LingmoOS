...
int main(int argc, char **argv)
{
    ...
    // About data
    KAboutData aboutData(u"lingmo-apply-lookandfeel"_s,
    ...
    aboutData.setDesktopFileName(u"org.kde.lingmo-apply-lookandfeel"_s);
    ...
    QCommandLineOption _apply =
        QCommandLineOption(QStringList() << QStringLiteral("a") << _a,
                           ...
                           i18n("packagename"));
    QCommandLineOption _resetLayout = QCommandLineOption(QStringList() << _r, i18n("Reset the Lingmo Desktop layout"));
    ...
    if (parser.isSet(_list)) {
        const QList<KPluginMetaData> pkgs = KPackage::PackageLoader::self()->listPackages(u"Lingmo/LookAndFeel"_s);
        ...
        KPackage::Package p = KPackage::PackageLoader::self()->loadPackage(u"Lingmo/LookAndFeel"_s);
