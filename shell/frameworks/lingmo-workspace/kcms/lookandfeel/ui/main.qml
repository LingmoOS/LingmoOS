...
KCM.GridViewKCM {
    ...
    function showConfirmation() { //Show the LingmoUI Sheet
    ...
    function resetCheckboxes() { //This call is used whenever you switch pages (More/Less Options) or trigger the LingmoUI Sheet
