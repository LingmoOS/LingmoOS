...
bool KCMLookandFeel::removeRow(int row, bool removeDependencies)
{
    ...
    KPackage::Package package = KPackage::PackageLoader::self()->loadPackage(QStringLiteral("Lingmo/LookAndFeel"));
...
QList<KPackage::Package> KCMLookandFeel::availablePackages(const QStringList &components)
{
    ...
    const QList<KPluginMetaData> packagesMetaData = KPackage::PackageLoader::self()->listPackages(QStringLiteral("Lingmo/LookAndFeel"));

    for (const KPluginMetaData &metadata : packagesMetaData) {
        KPackage::Package pkg = KPackage::PackageLoader::self()->loadPackage(QStringLiteral("Lingmo/LookAndFeel"), metadata.pluginId());
...
void KCMLookandFeel::load()
{
    ...
    m_package = KPackage::PackageLoader::self()->loadPackage(QStringLiteral("Lingmo/LookAndFeel"), lookAndFeelSettings()->lookAndFeelPackage());
}
...
void KCMLookandFeel::cursorsChanged(const QString &themeName)
{
    ...
    KMessageBox::information(this,
                             i18n("You have to restart the Lingmo session for these changes to take effect."),
