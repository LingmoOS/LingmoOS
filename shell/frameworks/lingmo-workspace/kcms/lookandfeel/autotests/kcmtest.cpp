...
void KcmTest::initTestCase()
{
    ...
    const QString packageRoot = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + u"/lingmo/look-and-feel/";
    auto installJob = KPackage::PackageJob::install(QStringLiteral("Lingmo/LookAndFeel"), packagePath, packageRoot);
...
void KcmTest::testLingmoTheme()
{
    m_KCMLookandFeel->lookAndFeel()->setLingmoTheme(QStringLiteral("customTestValue"));

    KConfig config(QStringLiteral("lingmorc"));
    KConfigGroup cg(&config, u"Theme"_s);
    QCOMPARE(cg.readEntry("name", QString()), QString());

    KConfig configDefault(QStandardPaths::writableLocation(QStandardPaths::GenericConfigLocation) + u"/kdedefaults/lingmorc", KConfig::SimpleConfig);
...
void KcmTest::testKCMSave()
{
    ...
    KConfig lingmoConfig(QStringLiteral("lingmorc"));
    KConfig lingmoConfigDefault(QStandardPaths::writableLocation(QStandardPaths::GenericConfigLocation) + u"/kdedefaults/lingmorc", KConfig::SimpleConfig);
    cg = KConfigGroup(&lingmoConfig, u"Theme"_s);
    cgd = KConfigGroup(&lingmoConfigDefault, u"Theme"_s);
    QCOMPARE(cg.readEntry("name", QString()), QString());
    QCOMPARE(cgd.readEntry("name", QString()), QStringLiteral("customTestValue"));
