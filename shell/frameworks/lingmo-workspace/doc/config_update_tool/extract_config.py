...
# Output is then presented in mediawiki format for copying and pasting to https://userbase.kde.org/KDE_System_Administration/LingmoDesktopScripting#Configuration_Keys
...
root = xdg_data_dir + "/lingmo/plasmoids"
