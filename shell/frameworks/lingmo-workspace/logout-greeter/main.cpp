...
int main(int argc, char *argv[])
{
    ...
    // TODO Lingmo 6, just have the greeter QML import and use the SessionManagement object directly
    ...
    const auto pkg = KPackage::PackageLoader::self()->loadPackage(QStringLiteral("Lingmo/LookAndFeel"), packageName);
