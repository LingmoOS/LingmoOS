...
static const QString s_ourServiceName = QStringLiteral("org.kde.lingmo.gmenu_dbusmenu_proxy");
...
void MenuProxy::writeGtk2Settings()
{
    ...
    if (!rcFile.exists()) {
        ...
        // as the gtkocean kconf_update script only does so if it does not exist
        return;
    }
