 ...
 */
class LingmoAutostart : public QObject
{
    Q_OBJECT
...
public:
     ...
     */
    explicit LingmoAutostart(const QString &entryName = QString(), QObject *parent = nullptr);
    ~LingmoAutostart();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(LingmoAutostart::Conditions)
