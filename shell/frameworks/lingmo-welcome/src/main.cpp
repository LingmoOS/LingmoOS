...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setApplicationName(QStringLiteral("lingmo-welcome"));
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("lingmo-welcome"));

    const QString description = i18nc("@info:usagetip", "Friendly onboarding wizard for Lingmo");
    KAboutData aboutData(
        // The program name used internally.
        QStringLiteral("lingmo-welcome"),
        // A displayable program name string.
        i18nc("@title", "Welcome Center"),
        // The program version string.
        QStringLiteral(LINGMO_WELCOME_VERSION_STRING),
    ...
    aboutData.setProgramLogo(QIcon::fromTheme(QStringLiteral("start-here-kde-lingmo")));
    ...
    parser.addOption(QCommandLineOption(QStringLiteral("post-update"), i18n("Display release notes for the current Lingmo release.")));
    parser.addOption(QCommandLineOption(QStringLiteral("post-update-beta"), i18n("Display release notes for the current Lingmo release, for beta versions.")));
    ...
    auto controller = engine.singletonInstance<Controller *>("org.kde.lingmo.welcome", "Controller");
    ...
    engine.loadFromModule("org.kde.lingmo.welcome", "Main");
