...
ScrollablePage {
    ...
    LingmoUI.Icon {
        ...
        source: "favorite"
        width: LingmoUI.Units.iconSizes.enormous * 3
    ...
    view: Flickable {
        ...
        readonly property int margins: LingmoUI.Units.gridUnit
        ...
        GridLayout {
            ...
            readonly property int minColumnSize: LingmoUI.Units.gridUnit * 8
