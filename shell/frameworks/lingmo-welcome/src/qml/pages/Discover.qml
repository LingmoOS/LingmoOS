...
GenericPage {
    ...
    ColumnLayout {
        ...
        ApplicationIcon {
            ...
            size: LingmoUI.Units.gridUnit * (applicationGrid.twoRowlayout ? 6 : 10)
        }

        GridLayout {
            id: applicationGrid

            readonly property int itemSize: LingmoUI.Units.iconSizes.huge
            ...
            columnSpacing: LingmoUI.Units.largeSpacing * 4
            ...
            Repeater {
                ...
                delegate: ColumnLayout {
                    ...
                    Loader {
                        ...
                        Component {
                            id: iconComponent
                            LingmoUI.Icon { source: model.icon }
                        }
                        Component {
                            id: imageComponent
