...
GenericPage {
    ...
    description: xi18nc("@info:usagetip", "Lingmo is an extremely feature-rich environment, designed to super-charge your productivity! Here is just a smattering of the things it can do for you:")
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            LingmoFeatureButton {
                ...
                Layout.maximumWidth: grid.cellWidth
                Layout.preferredHeight: grid.cellHeight
                title: i18nc("@title:row Name of the 'Activities' Lingmo feature", "Activities")
            ...
            LingmoFeatureButton {
                ...
                Layout.maximumWidth: grid.cellWidth
                Layout.preferredHeight: grid.cellHeight
                title: i18nc("@title:row Short form of the 'Vaults' Lingmo feature", "Vaults")
                subtitle: i18nc("@info Caption for Lingmo Vaults button", "Store sensitive files securely")
                buttonIcon: "lingmovault"
        ...
        LingmoUI.UrlButton {
            text: i18nc("@action:button", "Learn about more Lingmo features")
            url: "https://userbase.kde.org/Lingmo?source=lingmo-welcome"
        }
    }
}
