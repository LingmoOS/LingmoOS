...
LingmoExtras.ExpandableListItem {
    ...
    defaultActionButtonAction: QQC2.Action {
        ...
        text: root.model.isOpened ? i18nd("lingmovault-kde", "Lock Vault") : i18nd("lingmovault-kde", "Unlock and Open")
        onTriggered: source => {
    ...
    contextualActions: [
        QQC2.Action {
            ...
            text: i18nd("lingmovault-kde", "Show in File Manager")
            onTriggered: source => {
                root.vaultsModelActions.openInFileManager(root.model.device);
            }
        },
        QQC2.Action {
            ...
            text: root.model.isOpened ? i18nd("lingmovault-kde", "Forcefully Lock Vault") : i18nd("lingmovault-kde", "Unlock Vault")
            onTriggered: source => {
                if (root.model.isOpened) {
        ...
        QQC2.Action {
            ...
            text: i18nd("lingmovault-kde", "Configure Vault…")
