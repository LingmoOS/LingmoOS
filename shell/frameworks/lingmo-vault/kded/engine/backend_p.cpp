...
{
    return backend == QLatin1String("encfs")    ? LingmoVault::EncFsBackend::instance()
        : backend == QLatin1String("cryfs")     ? LingmoVault::CryFsBackend::instance()
        : backend == QLatin1String("gocryptfs") ? LingmoVault::GocryptfsBackend::instance()
                                                :
