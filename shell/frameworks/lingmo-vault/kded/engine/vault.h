...
#ifndef LINGMOVAULT_KDED_ENGINE_VAULT_H
#define LINGMOVAULT_KDED_ENGINE_VAULT_H
...
class Vault : public QObject
{
    ...
    Q_PROPERTY(LingmoVault::Device device READ device)
    Q_PROPERTY(LingmoVault::MountPoint mountPoint READ mountPoint NOTIFY mountPointChanged)
