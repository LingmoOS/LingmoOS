...
#ifndef LINGMOVAULT_KDED_UI_VAULT_WIZARD_BASE_P_H
#define LINGMOVAULT_KDED_UI_VAULT_WIZARD_BASE_P_H
...
public:
    ...
    void setCurrentModule(DialogDsl::DialogModule *module)
    {
        ...
        auto collectedPayload = firstStepModule == module ? LingmoVault::Vault::Payload{} : firstStepModule->fields();
