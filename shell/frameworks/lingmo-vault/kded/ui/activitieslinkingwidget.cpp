...
#include <LingmoActivities/ActivitiesModel>
...
LingmoVault::Vault::Payload ActivitiesLinkingWidget::fields() const
{
...
void ActivitiesLinkingWidget::init(const LingmoVault::Vault::Payload &payload)
{
