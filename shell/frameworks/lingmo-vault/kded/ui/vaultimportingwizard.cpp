...
public:
    ...
    void finish()
    {
        ...
        const LingmoVault::Device device(collectedPayload[KEY_DEVICE].toString());
        const LingmoVault::MountPoint mountPoint(collectedPayload[KEY_MOUNT_POINT].toString());

        auto vault = new LingmoVault::Vault(device, q);
