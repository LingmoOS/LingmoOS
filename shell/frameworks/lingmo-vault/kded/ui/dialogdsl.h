...
#ifndef LINGMOVAULT_KDED_UI_DIALOG_DSL_H
#define LINGMOVAULT_KDED_UI_DIALOG_DSL_H
...
public:
    ...
    virtual LingmoVault::Vault::Payload fields() const = 0;
    virtual void init(const LingmoVault::Vault::Payload &payload);
