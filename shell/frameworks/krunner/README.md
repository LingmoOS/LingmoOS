...
Framework for Lingmo runners

## Introduction

The Lingmo workspace provides an application called KRunner which, among other
...
These plugins can be used by any application using the Lingmo library. The
KRunner framework is used to write these plugins, as explained in
[this tutorial](https://develop.kde.org/docs/lingmo/krunner/)
