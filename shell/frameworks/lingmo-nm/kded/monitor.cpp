    ...
    , m_bluetoothMonitor(new BluetoothMonitor(this))
{
    ...
    QDBusConnection::sessionBus().registerService(QStringLiteral("org.kde.lingmonetworkmanagement"));
    QDBusConnection::sessionBus().registerObject(QStringLiteral("/org/kde/lingmonetworkmanagement"), this, QDBusConnection::ExportScriptableContents);
}
