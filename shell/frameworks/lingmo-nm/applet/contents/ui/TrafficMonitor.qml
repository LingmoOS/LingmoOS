...
ColumnLayout {
    ...
    Item {
        ...
        QuickChartsControls.AxisLabels {
            ...
            delegate: LingmoComponents3.Label {
        ...
        QuickChartsControls.GridLines {
            ...
            major.count: 3
            major.lineWidth: 1
            // Same calculation as LingmoUI Separator
            major.color: LingmoUI.ColorUtils.linearInterpolation(LingmoUI.Theme.backgroundColor, LingmoUI.Theme.textColor, 0.4)
        }
        QuickCharts.LineChart {
            ...
            anchors {
                ...
                topMargin: Math.round(metricsLabel.implicitHeight / 2) + LingmoUI.Units.smallSpacing
            }
            height: LingmoUI.Units.gridUnit * 8
            interpolate: true
