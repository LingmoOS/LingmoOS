...
{
    if (!pError) {
        qCWarning(LINGMO_NM_VPNC_LOG) << "Error in executing cisco-decrypt";
...
K_PLUGIN_CLASS_WITH_JSON(VpncUiPlugin, "lingmonetworkmanagement_vpncui.json")
