...
#ifndef LINGMO_NM_CREATABLE_CONNECTIONS_MODEL_H
#define LINGMO_NM_CREATABLE_CONNECTIONS_MODEL_H
...
class LINGMONM_INTERNAL_EXPORT CreatableConnectionItem : public QObject
{
    Q_OBJECT
public:
...
class LINGMONM_INTERNAL_EXPORT CreatableConnectionsModel : public QAbstractListModel
{
    Q_OBJECT
    QML_ELEMENT
public:
...
#endif // LINGMO_NM_CREATABLE_CONNECTIONS_MODEL_H
