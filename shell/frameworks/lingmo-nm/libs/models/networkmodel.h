...
#ifndef LINGMO_NM_NETWORK_MODEL_H
#define LINGMO_NM_NETWORK_MODEL_H
...
class LINGMONM_INTERNAL_EXPORT NetworkModel : public QAbstractListModel
{
    Q_OBJECT
    QML_ELEMENT
public:
...
#endif // LINGMO_NM_NETWORK_MODEL_H
