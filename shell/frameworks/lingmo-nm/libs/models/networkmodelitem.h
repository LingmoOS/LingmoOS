...
#ifndef LINGMO_NM_MODEL_NETWORK_MODEL_ITEM_H
#define LINGMO_NM_MODEL_NETWORK_MODEL_ITEM_H
...
class LINGMONM_INTERNAL_EXPORT NetworkModelItem : public QObject
{
    Q_OBJECT
public:
...
#endif // LINGMO_NM_MODEL_NETWORK_MODEL_ITEM_H
