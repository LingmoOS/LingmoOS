...
#ifndef LINGMO_NM_CONNECTION_EDITOR_TAB_WIDGET_H
#define LINGMO_NM_CONNECTION_EDITOR_TAB_WIDGET_H
...
class LINGMONM_EDITOR_EXPORT ConnectionEditorTabWidget : public ConnectionEditorBase
{
    Q_OBJECT
public:
...
#endif // LINGMO_NM_CONNECTION_EDITOR_TAB_WIDGET_H
