...
#ifndef LINGMO_NM_VPN_UI_PLUGIN_H
#define LINGMO_NM_VPN_UI_PLUGIN_H
 ...
 */
class LINGMONM_EDITOR_EXPORT VpnUiPlugin : public QObject
{
    Q_OBJECT
public:
...
#endif // LINGMO_NM_VPN_UI_PLUGIN_H
