...
#ifndef LINGMO_NM_WIRED_CONNECTION_WIDGET_H
#define LINGMO_NM_WIRED_CONNECTION_WIDGET_H
...
class LINGMONM_EDITOR_EXPORT WiredConnectionWidget : public SettingWidget
{
    Q_OBJECT
...
#endif // LINGMO_NM_WIRED_CONNECTION_WIDGET_H
