...
#ifndef LINGMO_NM_WIREGUARD_PEER_WIDGET_H
#define LINGMO_NM_WIREGUARD_PEER_WIDGET_H
...
class LINGMONM_EDITOR_EXPORT WireGuardPeerWidget : public QDialog
{
    Q_OBJECT
...
#endif // LINGMO_NM_WIREGUARD_PEER_WIDGET_H
