...
#ifndef LINGMO_NM_WIREGUARD_TAB_WIDGET_H
#define LINGMO_NM_WIREGUARD_TAB_WIDGET_H
...
class LINGMONM_EDITOR_EXPORT WireGuardTabWidget : public QDialog
{
    Q_OBJECT
...
#endif // LINGMO_NM_WIREGUARD_TAB_WIDGET_H
