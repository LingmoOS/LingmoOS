...
#ifndef LINGMO_NM_WIREGUARD_INTERFACE_WIDGET_H
#define LINGMO_NM_WIREGUARD_INTERFACE_WIDGET_H
...
class LINGMONM_EDITOR_EXPORT WireGuardInterfaceWidget : public SettingWidget
{
    Q_OBJECT
...
#endif // LINGMO_NM_WIREGUARD_INTERFACE_WIDGET_H
