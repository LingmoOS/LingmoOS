...
#ifndef LINGMO_NM_WIRED_SECURITY_H
#define LINGMO_NM_WIRED_SECURITY_H
...
class LINGMONM_EDITOR_EXPORT WiredSecurity : public SettingWidget
{
    Q_OBJECT
public:
...
#endif // LINGMO_NM_WIRED_SECURITY_H
