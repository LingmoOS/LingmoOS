...
#ifndef LINGMO_NM_WIFI_SECURITY_H
#define LINGMO_NM_WIFI_SECURITY_H
...
class LINGMONM_EDITOR_EXPORT WifiSecurity : public SettingWidget
{
    Q_OBJECT
public:
...
#endif // LINGMO_NM_WIFI_SECURITY_H
