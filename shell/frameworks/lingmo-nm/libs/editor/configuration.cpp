...
{
    KSharedConfigPtr config = KSharedConfig::openConfig(QStringLiteral("lingmo-nm"));
...
{
    static KSharedConfigPtr config = KSharedConfig::openConfig(QStringLiteral("lingmo-nm"));
