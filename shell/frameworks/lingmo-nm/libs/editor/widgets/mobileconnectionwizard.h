...
#ifndef LINGMO_NM_MOBILE_CONNECTION_WIZARD_H
#define LINGMO_NM_MOBILE_CONNECTION_WIZARD_H
...
class LINGMONM_EDITOR_EXPORT MobileConnectionWizard : public QWizard
{
    Q_OBJECT
public:
    /*
...
#endif // LINGMO_NM_MOBILE_CONNECTION_WIZARD_H
