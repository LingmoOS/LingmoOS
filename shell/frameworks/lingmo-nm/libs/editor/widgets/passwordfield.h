...
#ifndef LINGMO_NM_PASSWORD_FIELD_H
#define LINGMO_NM_PASSWORD_FIELD_H
...
class LINGMONM_EDITOR_EXPORT PasswordField : public QWidget
{
    Q_OBJECT
...
#endif // LINGMO_NM_PASSWORD_FIELD_H
