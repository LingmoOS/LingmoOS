...
#ifndef LINGMO_NM_BSSIDCOMBOBOX_H
#define LINGMO_NM_BSSIDCOMBOBOX_H
...
class LINGMONM_EDITOR_EXPORT BssidComboBox : public QComboBox
{
    Q_OBJECT
public:
...
#endif // LINGMO_NM_BSSIDCOMBOBOX_H
