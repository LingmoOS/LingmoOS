...
Lingmo applet written in QML for managing network connections
...
----------
**Recommended method**
The best way to develop for KDE is to use [kdesrc-build](https://kdesrc-build.kde.org/), a KDE supported tool chain to manage installation and compilation of KDE applications and dependencies. Please refer to the following guide when developing, building, and testing `lingmo-nm`:
...
BUGS:
-----
Submit bugs and feature requests to KDE bugzilla, product lingmo-nm:

https://bugs.kde.org/describecomponents.cgi?product=lingmo-nm
