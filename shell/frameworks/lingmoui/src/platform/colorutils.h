 ...
 */
class LINGMOUIPLATFORM_EXPORT ColorUtils : public QObject
{
    Q_OBJECT
    QML_ELEMENT
    QML_SINGLETON
public:
     ...
     * LingmoUI.Heading {
     *     text: {
     *         if (LingmoUI.ColorUtils.brightnessForColor("pink") == LingmoUI.ColorUtils.Light) {
     ...
     *
     * Rectangle {
     *     color: LingmoUI.ColorUtils.alphaBlend(Qt.rgba(0, 0, 0, 0.5), Qt.rgba(1, 1, 1, 1))
     * }
     * @endcode
     *
     * @since 5.69
     ...
     *
     * Rectangle {
     *     color: LingmoUI.ColorUtils.linearInterpolation("black", "white", 0.5)
     * }
     * @endcode
     *
     * @since 5.69
