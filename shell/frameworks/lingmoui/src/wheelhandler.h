 ...
 */
class LingmoUIWheelEvent : public QObject
{
    Q_OBJECT
    QML_ELEMENT
    QML_UNCREATABLE("")
...
public:
    LingmoUIWheelEvent(QObject *parent = nullptr);
    ~LingmoUIWheelEvent() override;
...
Q_SIGNALS:
     ...
     */
    void wheel(LingmoUIWheelEvent *wheel);
...
private:
    ...
    LingmoUI::Platform::Settings *m_settings = nullptr;
    ...
    LingmoUIWheelEvent m_lingmouiWheelEvent;
