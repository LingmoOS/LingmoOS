...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
bool LingmoPass::matchesAbbreviation(const QStringRef &word, const QStringRef &typed)
#else
bool LingmoPass::matchesAbbreviation(const QStringView &word, const QStringView &typed)
#endif
{
...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
bool LingmoPass::matchesPath(const QStringRef &path, const QStringRef &typed)
#else
bool LingmoPass::matchesPath(const QStringView &path, const QStringView &typed)
#endif
{
    int consumed = 0;
    int pos = 0;
...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
int LingmoPass::matchPathFilter(const QVector<QStringRef> &toFilter, const QVector<QStringRef> &text)
#else
int LingmoPass::matchPathFilter(const QVector<QStringView> &toFilter, const QVector<QStringView> &text)
#endif
{
