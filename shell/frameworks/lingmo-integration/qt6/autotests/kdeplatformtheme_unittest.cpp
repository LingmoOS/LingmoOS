...
private Q_SLOTS:
    ...
    void testPlatformHints()
    {
        ...
        QStringList styles;
        styles << QStringLiteral("non-existent-widget-style") << QStringLiteral("ocean") << QStringLiteral("oxygen") << QStringLiteral("fusion")
    ...
    void testPlatformHintChanges()
    {
        ...
        QStringList styles;
        styles << QStringLiteral("another-non-existent-widget-style") << QStringLiteral("ocean") << QStringLiteral("oxygen") << QStringLiteral("fusion")
               << QStringLiteral("windows");
        QCOMPARE(m_qpa->themeHint(QPlatformTheme::StyleNames).toStringList(), styles);
