...
{
    LingmoQtQuickSettings::RendererSettings s;
    ...
    case LingmoQtQuickSettings::RendererSettings::software:
        graphicsApi = QSGRendererInterface::Software;
        break;
    case LingmoQtQuickSettings::RendererSettings::opengl:
        graphicsApi = QSGRendererInterface::OpenGL;
        break;
    case LingmoQtQuickSettings::RendererSettings::vulkan:
    ...
    if (!qEnvironmentVariableIsSet("QSG_RENDER_LOOP")) {
        if (s.renderLoop() == LingmoQtQuickSettings::RendererSettings::basic) {
