...
void KHintsSettingsTest::testDefaults()
{
    ...
    QCOMPARE(hints.hint(QPlatformTheme::SystemIconThemeName).toString(), QStringLiteral("ocean"));
    ...
    const QStringList expectedStyles = QStringList{QStringLiteral("ocean"), QStringLiteral("oxygen"), QStringLiteral("fusion"), QStringLiteral("windows")};
