...
//BEGIN properties
    implicitWidth: delegateContents.implicitWidth + 4 * LingmoUI.Units.smallSpacing
    implicitHeight: delegateContents.height + LingmoUI.Units.smallSpacing * 4
...
//BEGIN UI components
    Rectangle {
        ...
        opacity: { // try to match Ocean style hover handling
    ...
    ColumnLayout {
        ...
        QtControls.Label {
            ...
            color: current && categoriesScroll.activeFocus ? LingmoUI.Theme.highlightedTextColor : LingmoUI.Theme.textColor
