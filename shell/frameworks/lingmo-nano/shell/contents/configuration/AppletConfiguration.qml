        ...
        ColumnLayout {
            ...
            QtControls.ScrollView {
                ...
                Window.onActiveFocusItemChanged: {
                    ...
                    var padding = LingmoUI.Units.gridUnit * 2 // some padding to the top/bottom when we scroll
                    ...
                    // into view when it implicitly gains focus (like lingmo-pa config dialog has).
                ...
                Flickable {
                    ...
                    ColumnLayout {
                        ...
                        QtControls.StackView {
                            ...
                            Layout.fillWidth: true
                            Layout.fillHeight: true
                            implicitWidth: Math.max(currentItem ? Math.max(currentItem.Layout.minimumWidth, currentItem.Layout.preferredWidth, currentItem.implicitWidth) : 0, LingmoUI.Units.gridUnit * 15)
                            implicitHeight: Math.max(currentItem ? Math.max(currentItem.Layout.minimumHeight, currentItem.Layout.preferredHeight, currentItem.implicitHeight) : 0, LingmoUI.Units.gridUnit * 15)
