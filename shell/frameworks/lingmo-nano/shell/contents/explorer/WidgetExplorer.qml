...
PC3.Drawer {
    ...
    readonly property int delegateSize: LingmoUI.Units.gridUnit * 8
    ...
    topPadding: horizontal ? LingmoUI.Units.smallSpacing : containmentInterface.availableScreenRect.y
    ...
    implicitWidth: categoriesView.shouldBeVisible ? layout.implicitWidth : view.implicitWidth + LingmoUI.Units.smallSpacing
    implicitHeight: categoriesView.shouldBeVisible ? layout.implicitHeight : view.implicitHeight + LingmoUI.Units.smallSpacing
    ...
    contentItem: Item {
        ...
        GridLayout {
            ...
            PC3.ScrollView {
                ...
                implicitWidth: delegateSize + LingmoUI.Units.gridUnit
                implicitHeight: delegateSize + LingmoUI.Units.gridUnit * 3
