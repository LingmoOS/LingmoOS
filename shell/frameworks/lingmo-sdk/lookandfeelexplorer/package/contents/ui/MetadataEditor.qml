        ...
        ColumnLayout {
            ...
            LingmoUI.FormLayout {
                ...
                QQC2.TextField {
                    id: pluginNameField
                    Layout.fillWidth: true
                    LingmoUI.FormData.label: i18n("Theme Plugin Name:")
                    onTextChanged: {
                ...
                QQC2.TextField {
                    id: "nameField"
                    LingmoUI.FormData.label: i18n("Theme Name:")
                }
                QQC2.TextField {
                    id: "commentField"
                    LingmoUI.FormData.label: i18n("Comment:")
                }
                QQC2.TextField {
                    id: "authorField"
                    LingmoUI.FormData.label: i18n("Author:")
                }
                QQC2.TextField {
                    id: "emailField"
                    LingmoUI.FormData.label:  i18n("Email:")
                }
                QQC2.TextField {
                    id: "versionField"
                    LingmoUI.FormData.label: i18n("Version:")
                }
                QQC2.TextField {
                    id: "websiteField"
                    LingmoUI.FormData.label:  i18n("Website:")
                }
                QQC2.ComboBox {
                    id: licenseField
                    Layout.fillWidth: true
                    LingmoUI.FormData.label: i18n("License:")
                    editable: true
                    editText: "LGPL 2.1+"
