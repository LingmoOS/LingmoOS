...
int main(int argc, char **argv)
{
    ...
    parser.setApplicationDescription(i18n("Lingmo Look And Feel Explorer"));
    ...
    const QString packagePath("org.kde.lingmo.lookandfeelexplorer");

    // usually we have an ApplicationWindow here, so we do not need to create a window by ourselves
    LingmoQuick::SharedQmlEngine obj;
    ...
    qmlRegisterAnonymousType<LnfLogic>("org.kde.lingmo.sdk", 1);
    qmlRegisterAnonymousType<LnfListModel>("org.kde.lingmo.sdk", 1);
