...
int main(int argc, char *argv[])
{
    ...
    auto engine = LingmoQuick::SharedQmlEngine().engine();
    ...
    for (const QString &path : std::as_const(files)) {
        ...
        auto window = new LingmoQuick::QuickViewSharedEngine();
        ...
        QObject::connect(window, &LingmoQuick::QuickViewSharedEngine::statusChanged, window, [window](QQmlComponent::Status status) {
