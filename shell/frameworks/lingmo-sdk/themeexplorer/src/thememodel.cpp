...
QVariant ThemeModel::data(const QModelIndex &index, int role) const
{
    ...
    case IsWritable:
        return QFile::exists(QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + "/lingmo/desktoptheme/" + m_themeName);
    case IconElements:
...
void ThemeModel::editElement(const QString &imagePath)
{
    ...
    if (m_theme->currentThemeHasImage(imagePath)) {
        ...
        finalFile = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + "/lingmo/desktoptheme/" + m_themeName + "/" + imagePath + ".svgz";
...
void ThemeModel::processFinished()
{
    ...
    const QString metadataPath(
        QStandardPaths::locate(QStandardPaths::GenericDataLocation, QLatin1String("lingmo/desktoptheme/") % m_themeName % QLatin1String("/metadata.desktop")));
...
void ThemeModel::editThemeMetaData(const QString &name, const QString &author, const QString &email, const QString &license, const QString &website)
{
    ...
    const QString metadataPath(QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) % QLatin1String("/lingmo/desktoptheme/") % compactName
...
void ThemeModel::createNewTheme(const QString &name, const QString &author, const QString &email, const QString &license, const QString &website)
{
    ...
    QString file = QStandardPaths::locate(QStandardPaths::GenericDataLocation, +"/lingmo/desktoptheme/default/colors");

    QString compactName = name.toLower();
    compactName.replace(' ', QString());
    QString finalFile = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + "/lingmo/desktoptheme/" + compactName + "/colors";
...
{
    return QStandardPaths::locate(QStandardPaths::GenericDataLocation, +"lingmo/desktoptheme/" + m_themeName, QStandardPaths::LocateDirectory);
}
