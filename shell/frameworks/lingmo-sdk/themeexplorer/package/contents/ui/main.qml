...
LingmoUI.AbstractApplicationWindow {
    ...
    height: LingmoUI.Units.gridUnit * 35
    visible: true
    ...
    header: ToolBar {
        RowLayout {
            ...
            ToolButton {
                ...
                onClicked: Qt.openUrlExternally("https://techbase.kde.org/Development/Tutorials/Lingmo5/ThemeDetails");
            }
            TextField {
    ...
    Item {
        ...
        ColumnLayout {
            ...
            Slider {
                id: iconSizeSlider
                Layout.fillWidth: true
                value: LingmoUI.Units.gridUnit * 12
                from: LingmoUI.Units.gridUnit * 5
                to: LingmoUI.Units.gridUnit * 20
            }
        }
    }
}
