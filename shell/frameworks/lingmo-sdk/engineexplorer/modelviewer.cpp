...
ModelViewer::ModelViewer(Lingmo5Support::DataEngine *engine, const QString &source, QWidget *parent)
    : QDialog(parent)
    , m_engine(engine)
    , m_source(source)
{
    ...
    setWindowTitle(i18nc("%1 is a Lingmo dataengine name", "%1 Model Explorer", engineName));
}
