...
void listEngines()
{
    ...
    const auto plugins = Lingmo5Support::PluginLoader::listDataEngineMetaData();
...
int main(int argc, char **argv)
{
    ...
    KLocalizedString::setApplicationDomain("lingmoengineexplorer");

    KAboutData aboutData("lingmoengineexplorer",
                         i18n("Lingmo Engine Explorer"),
                         PROJECT_VERSION,
                         i18n("Explore the data published by Lingmo DataEngines"),
                         KAboutLicense::GPL,
