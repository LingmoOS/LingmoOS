...
LingmoUI.OverlaySheet {
    ...
    implicitWidth: Math.min(parent.width, LingmoUI.Units.gridUnit * 50)
    ...
    GridView {
        ...
        cellWidth: LingmoUI.Units.iconSizes.enormous
        cellHeight: cellWidth + 2 * LingmoUI.Units.gridUnit + LingmoUI.Units.largeSpacing
        implicitWidth: {
        ...
        delegate: ColumnLayout {
            ...
            Item {
                ...
                LingmoUI.Icon {
                    ...
                    color: hasIcon ? "" : LingmoUI.Theme.disabledTextColor
                    isMask: !hasIcon
                }
            }
            QQC2.Label {
