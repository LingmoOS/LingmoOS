...
Item {
    ...
    Column {
        ...
        IconMontage {
            ...
            LingmoUI.Theme.inherit: false
            LingmoUI.Theme.textColor: "#232629"
            LingmoUI.Theme.backgroundColor: "#eff0f1"
            LingmoUI.Theme.highlightColor: "#3daee9"
            LingmoUI.Theme.highlightedTextColor: "#eff0f1"
            LingmoUI.Theme.positiveTextColor: "#27ae60"
            LingmoUI.Theme.neutralTextColor: "#f67400"
            LingmoUI.Theme.negativeTextColor: "#da4453"
        }
        IconMontage {
            id: darkMontage
            ...
            LingmoUI.Theme.inherit: false
            LingmoUI.Theme.textColor: "#eff0f1"
            LingmoUI.Theme.backgroundColor: "#31363b"
            LingmoUI.Theme.highlightColor: "#3daee9"
            LingmoUI.Theme.highlightedTextColor: "#eff0f1"
            LingmoUI.Theme.positiveTextColor: "#27ae60"
            LingmoUI.Theme.neutralTextColor: "#f67400"
