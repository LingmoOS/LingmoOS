...
ColumnLayout {
    ...
    RowLayout {
        ...
        PC3.Label {
            ...
            text: panel.location === LingmoCore.Types.LeftEdge || panel.location === LingmoCore.Types.RightEdge ? i18nd("lingmo_shell_org.kde.lingmo.desktop", "Panel Width:") : i18nd("lingmo_shell_org.kde.lingmo.desktop", "Height:")
            textFormat: Text.PlainText
        }
        PC3.SpinBox {
            id: spinBox
            ...
            to: panel.location === LingmoCore.Types.LeftEdge || panel.location === LingmoCore.Types.RightEdge ? panel.screenToFollow.geometry.width / 2 : panel.screenToFollow.geometry.height / 2
