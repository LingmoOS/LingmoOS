...
Item {
    ...
    property var prettyStrings: {
        "LeftButton": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Left-Button"),
        "RightButton": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Right-Button"),
        "MiddleButton": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Middle-Button"),
        "BackButton": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Back-Button"),
        "ForwardButton": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Forward-Button"),

        "wheel:Vertical": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Vertical-Scroll"),
        "wheel:Horizontal": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Horizontal-Scroll"),

        "ShiftModifier": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Shift"),
        "ControlModifier": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Ctrl"),
        "AltModifier": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Alt"),
        "MetaModifier": i18nd("lingmo_shell_org.kde.lingmo.desktop", "Meta")
    }
    ...
    GridLayout {
        ...
        Repeater {
            ...
            MouseEventInputButton {
                ...
                defaultText: {
                    ...
                    }).join(i18ndc("lingmo_shell_org.kde.lingmo.desktop", "Concatenation sign for shortcuts, e.g. Ctrl+Shift", "+"));
                }
                ...
                QQC2.Button {
                    ...
                    onClicked: {
                        ...
                        aboutComponent.incubateObject(root.Window.window.contentItem, {
                            "metaData": metaData,
                            "title": i18ndc("lingmo_shell_org.kde.lingmo.desktop", "@title", "About"),
                        }, Qt.Asynchronous);
                    }
                }
                QQC2.Button {
        ...
        MouseEventInputButton {
            defaultText: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Add Action");
