...
# keep this function in sync with lingmoshell from lingmo-workspace
...
_arguments \
  '(-c --containment)'{-c=,--containment=}'[override containment package id]::: _lingmo_list_packages containments containment' \
  '(-a --applet)'{-a=,--applet=}'[applet package id]::: _lingmo_list_packages applets applet' \
  ...
  '(-t --theme)'{-t=,--theme=}'[override theme which the shell will use]::: _lingmo_list_packages themes theme Lingmo/Theme' \
