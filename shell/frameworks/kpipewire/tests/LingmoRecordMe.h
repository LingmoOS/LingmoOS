...
class LingmoRecordMe : public QObject
{
    Q_OBJECT
    Q_PROPERTY(QRect region READ region NOTIFY regionChanged)
public:
    LingmoRecordMe(Screencasting::CursorMode cursorMode, const QStringList &sources, bool doSelection, QObject *parent = nullptr);
    ~LingmoRecordMe() override;
...
private:
    ...
    KWayland::Client::LingmoWindowManagement* m_management = nullptr;
