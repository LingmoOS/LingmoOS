...
public:
    ...
    static KLocalizedString systemInfoKey(const QString &key)
    {
        ...
        qFatal("unexpected kinfocenter key %s\n", qUtf8Printable(key));
        Q_UNREACHABLE();
    ...
    void loadEntries()
    {
        ...
        KAuth::Action action(QStringLiteral("org.kde.kinfocenter.dmidecode.kinfocenterrmation"));
...
private:
    ...
    Q_PROPERTY(bool isThisSystemInfo MEMBER m_isThisSystemInfo CONSTANT)
    const bool m_isThisSystemInfo = qGuiApp->desktopFileName() == QLatin1String("org.kde.kinfocenter");
};
