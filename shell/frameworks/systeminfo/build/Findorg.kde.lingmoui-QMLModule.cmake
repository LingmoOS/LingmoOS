...
if (QT_MAJOR_VERSION EQUAL "6")
    ...
    # Get the qmldir file
    _ecm_qmlmodule_uri_to_path(MODULEDIR "org.kde.lingmoui" "2.5")
    ...
    if (NOT MODULE_NOTFOUND AND NOT "2.5" STREQUAL "") # Check if we even need to check the version
        ...
        if (VERSION_FILE)
            ...
            if ("${FILE_CONTENTS}" MATCHES "([0-9]+(\\.[0-9]+)*)")
                if ("${CMAKE_MATCH_1}" VERSION_GREATER_EQUAL "2.5")
                    set(org.kde.lingmoui-QMLModule_FOUND TRUE)
                endif()
                set(org.kde.lingmoui-QMLModule_VERSION "${CMAKE_MATCH_1}")
            endif()
        else()
...
if (NOT CMAKE_CROSSCOMPILING AND NOT MODULE_NOTFOUND AND NOT org.kde.lingmoui-QMLModule_FOUND)
    if (QT_MAJOR_VERSION EQUAL "6")
    ...
    execute_process(COMMAND "${QMLPLUGINDUMP_PROGRAM}" "org.kde.lingmoui" "2.5" ERROR_VARIABLE ERRORS_OUTPUT OUTPUT_VARIABLE DISREGARD_VARIABLE RESULT_VARIABLE ExitCode TIMEOUT 30)
    if(ExitCode EQUAL 0)
        set(org.kde.lingmoui-QMLModule_FOUND TRUE)
    else()
        message(STATUS "qmlplugindump failed for org.kde.lingmoui.")
        set(org.kde.lingmoui-QMLModule_FOUND FALSE)
    endif()
endif()

set(org.kde.lingmoui-QMLModule_FOUND ${org.kde.lingmoui-QMLModule_FOUND} PARENT_SCOPE)
set(org.kde.lingmoui-QMLModule_VERSION ${org.kde.lingmoui-QMLModule_VERSION} PARENT_SCOPE)
find_package_handle_standard_args(org.kde.lingmoui-QMLModule
    VERSION_VAR org.kde.lingmoui-QMLModule_VERSION
    REQUIRED_VARS org.kde.lingmoui-QMLModule_FOUND
    HANDLE_COMPONENTS
)
