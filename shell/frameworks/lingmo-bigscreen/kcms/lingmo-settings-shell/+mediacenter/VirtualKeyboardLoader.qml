...
Loader {
        ...
        height: Math.min(parent.height / 2, Math.max(parent.height/3, LingmoUI.Units.gridUnit * 15))
        states: [
            State {
                name: "visible"
                PropertyChanges {
                    target: inputPanel
                    y: inputPanel.parent.height - inputPanel.height +  LingmoUI.Units.gridUnit
                    opacity: 1
                }
            },
            State {
