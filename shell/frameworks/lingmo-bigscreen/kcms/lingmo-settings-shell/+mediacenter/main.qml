...
LingmoUI.ApplicationWindow {
    ...
    color: Qt.rgba(LingmoUI.Theme.backgroundColor.r, LingmoUI.Theme.backgroundColor.g, LingmoUI.Theme.backgroundColor.b, 0.5)
    ...
    header: ModulesListPage {
        ...
        height: pageStack.depth > 0 ? LingmoUI.Units.gridUnit * 15 : rootItem.height
