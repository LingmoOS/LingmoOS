        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                LingmoUI.Icon {
                    ...
                    Layout.preferredWidth: listView.currentIndex == index && delegate.activeFocus ? LingmoCore.Units.iconSizes.medium : LingmoCore.Units.iconSizes.smallMedium
                    Layout.preferredHeight: listView.currentIndex == index && delegate.activeFocus ? LingmoCore.Units.iconSizes.medium : LingmoCore.Units.iconSizes.smallMedium
