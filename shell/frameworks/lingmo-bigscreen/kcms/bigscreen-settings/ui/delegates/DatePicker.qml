...
Item {
    ...
    property int _margin: LingmoUI.Units.gridUnit
        ...
        Row {
            ...
            Digit {
                ...
                delegate: Text {
                    ...
                    color: dayDigit.focus && dayDigit.currentIndex == index ? LingmoUI.Theme.linkColor : LingmoUI.Theme.textColor
            ...
            Digit {
                ...
                delegate: Text {
                    ...
                    text: months[index]
                    font.pointSize: root.fontSize
                    color: monthDigit.focus && monthDigit.currentIndex == index ? LingmoUI.Theme.linkColor : LingmoUI.Theme.textColor
                    opacity: PathView.itemOpacity
                }
                Text {
                    id: monthPlaceHolder
            ...
            Digit {
                ...
                Text {
                    ...
                    visible: false
                    font.pointSize: root.fontSize
                    color: yearDigit.focus && yearDigit.currentIndex == index ? LingmoUI.Theme.linkColor : LingmoUI.Theme.textColor
                    text: "0000"
                }
            }
        }
