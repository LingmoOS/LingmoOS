...
FocusScope {
    ...
    //TODO:dynamic
    property int columns: Math.max(3, Math.floor(width / (LingmoUI.Units.gridUnit * 8)))
    ...
    ListView {
        ...
        anchors {
            ...
            topMargin: LingmoUI.Units.largeSpacing*2
        ...
        property int cellWidth: (LingmoUI.Units.iconSizes.huge + LingmoUI.Units.largeSpacing*4)
        property int cellHeight: cellWidth + LingmoUI.Units.gridUnit * 3
