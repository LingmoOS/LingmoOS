...
FocusScope {
    ...
    Flickable {
        ...
        readonly property int cellWidth: root.width / columns + (LingmoUI.Units.gridUnit / 1)
        property int cellHeight: root.compactMode ? cellWidth + LingmoUI.Units.gridUnit * 2 : cellWidth * 0.75
