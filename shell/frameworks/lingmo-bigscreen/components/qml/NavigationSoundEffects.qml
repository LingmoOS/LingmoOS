...
QtObject {
    ...
    property SoundEffect clickedSound: SoundEffect {
        source: StandardPaths.locate(StandardPaths.GenericDataLocation, "sounds/lingmo-bigscreen/clicked.wav")
    }

    property SoundEffect movingSound: SoundEffect {
        source: StandardPaths.locate(StandardPaths.GenericDataLocation, "sounds/lingmo-bigscreen/moving.wav")
    }
