## Lingmo-Bigscreen Voice Application Development Guidelines

- [Lingmo-Bigscreen Voice Application Development Guidelines](#lingmo-bigscreen-voice-application-development-guidelines)
  - [Abstract](#abstract)
...
This tutorial requires Mycroft-Core, Mycroft-GUI and Mycroft-Skill-Installer. We are in this tutorial going to create a graphic user interface skill for Mycroft-AI which can be installed as a Voice Applications on the Lingmo Bigscreen Platform.
...
The Pling Store is a publishing platform for open source applications, addons, wallpapers, applets and more. The Mycroft Skill Installer leverages the infrastructure provided by the pling store to make installing voice applications a ocean.
