...
ColumnLayout {
    ...
    property int formAlignment: wallpaperComboBox.LingmoUI.ScenePosition.x - root.LingmoUI.ScenePosition.x + (units.largeSpacing/2)
...
//END functions
    ...
    LingmoUI.InlineMessage {
        ...
        text: i18nd("lingmo_shell_org.kde.lingmo.desktop", "Layout cannot be changed while widgets are locked")
