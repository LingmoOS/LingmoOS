...
AbstractIndicator {
    ...
    onClicked: {
        NanoShell.StartupFeedback.open(
                            ...
                            paIcon.LingmoUI.ScenePosition.x + paIcon.width/2,
                            paIcon.LingmoUI.ScenePosition.y + paIcon.height/2,
                            Math.min(paIcon.width, paIcon.height));
        Plasmoid.executeCommand("lingmo-settings -s -m kcm_mediacenter_audiodevice")
    }
}
