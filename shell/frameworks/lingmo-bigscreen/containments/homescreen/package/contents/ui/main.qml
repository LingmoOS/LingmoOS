...
ContainmentItem {
    ...
    // LingmoCore.ColorScope.colorGroup: LingmoCore.Theme.ComplementaryColorGroup
    ...
    function addApplet(applet, x, y) {
        ...
        //container.width = LingmoUI.Units.iconSizes.medium
    ...
    Component {
        ...
        Item {
            ...
            visible: applet && applet.status !== LingmoCore.Types.HiddenStatus && applet.status !== LingmoCore.Types.PassiveStatus
            Layout.fillHeight: true
            Layout.minimumWidth: Math.max(applet.implicitWidth, applet.Layout.preferredWidth, applet.Layout.minimumWidth) + LingmoUI.Units.gridUnit
    ...
    Item {
        ...
        height: LingmoUI.Units.iconSizes.medium + LingmoUI.Units.smallSpacing * 2
        ...
        LinearGradient {
            property int radius: LingmoUI.Units.gridUnit
