...
Window {
    ...
    Mycroft.StatusIndicator {
        ...
        anchors {
            ...
            topMargin: LingmoUI.Units.largeSpacing + plasmoid.availableScreenRect.y
        }
    }
    LingmoUI.Heading {
        id: inputQuery
    ...
    Mycroft.SkillView {
       ...
       // activeSkills.onSkillActivated: window.showMaximized();
        ...
        Rectangle {
            ...
            height: LingmoCore.Units.iconSizes.huge
            opacity: focus ? 1 : 0
            color: focus ? LingmoUI.Theme.highlightColor :"transparent"
            ...
            LingmoUI.Icon {
                ...
                height: LingmoCore.Units.iconSizes.large
                source: "tab-close"
            }
