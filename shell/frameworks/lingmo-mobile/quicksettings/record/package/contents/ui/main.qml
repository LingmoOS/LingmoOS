...
import org.kde.lingmo.quicksetting.record 1.0
...
QS.QuickSetting {
    ...
    function toggle() {
        if (!record.active) {
            // See this https://invent.kde.org/lingmo/kpipewire/-/blob/eb21912e7e0ce5a70c6f906c6e5a20f56cc6783e/src/pipewirerecord.cpp#L82
