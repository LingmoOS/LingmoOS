...
// adapted from https://invent.kde.org/lingmo/lingmo-nm/-/blob/master/libs/editor/mobileproviders.cpp
            ...
            if (docElement.isNull()) {
                ...
                if (docElement.isNull() || docElement.tagName() != "serviceproviders") {
                    ...
                    if (docElement.attribute("format") != "2.0") {
                        ...
                        // qCDebug(LINGMO_NM) << "Everything is alright so far";
                    }
                }
            }
        }
                ...
                if (!e2.isNull() && e2.tagName().toLower() == "apn") {
                    ...
                    while (!n3.isNull()) {
                        ...
                        if (!e3.isNull() && e3.tagName().toLower() == "usage" && !e3.attribute("type").isNull()
                            ...
                            // qCDebug(LINGMO_NM) << "apn" << e2.attribute("value") << "ignored because of usage" << e3.attribute("type");
                            isInternet = false;
                            break;
                        }
                        n3 = n3.nextSibling();
