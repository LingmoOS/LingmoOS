...
Item {
    ...
    implicitWidth: LingmoUI.Units.gridUnit * 4
    implicitHeight: column.implicitHeight

    readonly property color buttonColor: LingmoUI.Theme.backgroundColor
    ...
    readonly property color buttonBorderColor: Qt.alpha(LingmoUI.Theme.textColor, 0.3)
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                color: LingmoUI.ColorUtils.linearInterpolation(LingmoUI.Theme.backgroundColor, LingmoUI.Theme.textColor, 0.15)
            }
            ...
            MouseArea {
                ...
                TextInput {
                    ...
                    anchors.left: parent.left
                    anchors.right: parent.right
                    font.pointSize: Math.round(LingmoUI.Theme.defaultFont.pointSize * 2.5)
