        ...
        FormCard.FormCard {
            FormCard.FormComboBoxDelegate {
                ...
                model: ListModel {
                    ...
                    function load() {
                        clear();
                        append({ "text": i18n("None"), "type": LingmoNM.Enums.NoneSecurity });
                        append({ "text": i18n("WEP Key"), "type": LingmoNM.Enums.StaticWep });
                        append({ "text": i18n("Dynamic WEP"), "type": LingmoNM.Enums.DynamicWep });
                        append({ "text": i18n("WPA/WPA2 Personal"), "type": LingmoNM.Enums.Wpa2Psk });
                        append({ "text": i18n("WPA/WPA2 Enterprise"), "type": LingmoNM.Enums.Wpa2Eap });
                        append({ "text": i18n("WPA3 Personal"), "type": LingmoNM.Enums.SAE });
                        append({ "text": i18n("WPA3 Enterprise"), "type": LingmoNM.Enums.Wpa3SuiteB192 });
            ...
            FormCard.FormTextFieldDelegate {
                ...
                text: secrets["psk"]
                visible: securityTypesModel.get(securityCombobox.currentIndex).type !== LingmoNM.Enums.NoneSecurity
