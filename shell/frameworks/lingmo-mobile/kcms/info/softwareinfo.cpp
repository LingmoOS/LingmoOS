...
QString SoftwareInfo::lingmoVersion() const
{
    const QStringList &filePaths = QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("wayland-sessions/lingmo.desktop"));
    ...
    // reflect the lingmo session run.
