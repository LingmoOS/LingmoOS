...
Item {
    ...
    onContentItemChanged: {
        ...
        contentItem.anchors.margins = LingmoUI.Units.largeSpacing;
    ...
    MultiEffect {
        ...
        shadowOpacity: 0.3
        shadowColor: Qt.lighter(LingmoUI.Theme.backgroundColor, 0.2)
    }
    ...
    Rectangle {
        ...
        color: Qt.darker(LingmoUI.Theme.backgroundColor, 1.3)
    ...
    Rectangle {
        ...
        color: (root.tapEnabled && mouseArea.pressed) ? Qt.darker(LingmoUI.Theme.backgroundColor, 1.1) : LingmoUI.Theme.backgroundColor
        radius: LingmoUI.Units.cornerRadius
        implicitHeight: contentParent.implicitHeight
    ...
    DragHandler {
        ...
        onActiveChanged: {
            ...
            if (!active) { // release event
                let threshold = LingmoUI.Units.gridUnit * 5; // drag threshold
