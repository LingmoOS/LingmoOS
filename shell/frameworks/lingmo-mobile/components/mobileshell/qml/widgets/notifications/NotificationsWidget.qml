...
Item {
    ...
    function openNotificationSettings() {
        MobileShell.ShellUtil.executeCommand("lingmo-open-settings kcm_notifications");
    }
    ...
    ListView {
        ...
        readonly property int animationDuration: ShellSettings.Settings.animationsEnabled ? LingmoUI.Units.longDuration : 0
        ...
        LingmoExtras.PlaceholderMessage {
            ...
            LingmoComponents3.Label {
                ...
                // LingmoExtras.PlaceholderMessage is internally a ColumnLayout, so we can use Layout.whatever properties here
            ...
            Component {
                ...
                Column {
                    ...
                    Loader {
                        ...
                        sourceComponent: LingmoComponents3.ToolButton {
