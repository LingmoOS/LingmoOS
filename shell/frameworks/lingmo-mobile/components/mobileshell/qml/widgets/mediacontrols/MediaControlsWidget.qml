...
Item {
    ...
    readonly property real padding: LingmoUI.Units.gridUnit
    readonly property real contentHeight: LingmoUI.Units.gridUnit * 2 * heightMultiplier
    ...
    QQC2.SwipeView {
        ...
        Repeater {
            ...
            delegate: Loader {
                id: delegate
                // NOTE: model is PlayerContainer from KMpris in lingmo-workspace
                    ...
                    MobileShell.BaseItem {
                        ...
                        contentItem: ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                ColumnLayout {
                                    Layout.leftMargin: albumArt.visible ? LingmoUI.Units.gridUnit : 0
                                    ...
                                    MobileShell.MarqueeLabel {
                                        ...
                                        textFormat: Text.PlainText
                                        font.pointSize: LingmoUI.Theme.defaultFont.pointSize * 0.9
                                        opacity: 0.9
                                        color: "white"
                                    }
                                }
                                ...
                                QQC2.ToolButton {
                                    ...
                                    Accessible.name: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Previous track")
                                }
                                ...
                                QQC2.ToolButton {
                                    ...
                                    Accessible.name: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Play or Pause media")
                                }
                                ...
                                QQC2.ToolButton {
                                    ...
                                    visible: model.canGoPrevious || model.canGoNext
                                    Accessible.name: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Next track")
                                }
                            }
