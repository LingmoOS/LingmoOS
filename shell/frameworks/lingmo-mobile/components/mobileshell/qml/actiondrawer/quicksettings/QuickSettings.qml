...
Item {
    ...
    readonly property real intendedColumnWidth: LingmoUI.Units.gridUnit * 7
    readonly property real intendedMinimizedColumnWidth: LingmoUI.Units.gridUnit * 4 + LingmoUI.Units.smallSpacing
    readonly property real minimizedRowHeight: LingmoUI.Units.gridUnit * 4 + LingmoUI.Units.smallSpacing
    ...
    RowLayout {
        ...
        Repeater {
            ...
            delegate: MobileShell.BaseItem {
                ...
                horizontalPadding: (width - LingmoUI.Units.gridUnit * 3) / 2
                verticalPadding: (height - LingmoUI.Units.gridUnit * 3) / 2
        ...
        Item {
            ...
            Flickable {
                ...
                ScrollIndicator.vertical: ScrollIndicator {
                    ...
                    contentItem: Item {
                        implicitWidth: LingmoUI.Units.smallSpacing / 4
                        Rectangle {
