...
MobileShell.BaseItem {
     ...
     */
    readonly property real minimizedQuickSettingsHeight: quickSettings.minimizedRowHeight + LingmoUI.Units.gridUnit
    ...
    contentItem: Item {
        ...
        ColumnLayout {
            ...
            MobileShell.StatusBar {
                ...
                Layout.preferredHeight: MobileShell.Constants.topPanelHeight + LingmoUI.Units.gridUnit * 0.8
