...
MobileShell.BaseItem {
    ...
    topPadding: LingmoUI.Units.smallSpacing * 4
    leftPadding: LingmoUI.Units.smallSpacing * 4
    rightPadding: LingmoUI.Units.smallSpacing * 4
    bottomPadding: LingmoUI.Units.smallSpacing * 4
    ...
    contentItem: Item {
        ...
        ColumnLayout {
            ...
            MobileShell.StatusBar {
                ...
                Layout.preferredHeight: LingmoUI.Units.gridUnit * 1.5
                Layout.maximumHeight: LingmoUI.Units.gridUnit * 1.5
            ...
            MobileShell.QuickSettings {
                ...
                Layout.alignment: Qt.AlignTop
                Layout.fillWidth: true
                Layout.maximumHeight: root.fullScreenHeight - root.topPadding - root.bottomPadding - statusBar.height - LingmoUI.Units.smallSpacing
