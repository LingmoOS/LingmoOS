...
QtObject {
    readonly property real topPanelHeight: LingmoUI.Units.gridUnit + LingmoUI.Units.smallSpacing
    readonly property real navigationPanelThickness: ShellSettings.Settings.navigationPanelEnabled ? LingmoUI.Units.gridUnit * 2 : 0
