        ...
        delegate: Item {
            Window {
                ...
                SequentialAnimation {
                    ...
                    ParallelAnimation {
                        id: parallelAnim
                        property real animationDuration: LingmoUI.Units.longDuration + LingmoUI.Units.shortDuration
                ...
                Item {
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            color: LingmoUI.ColorUtils.brightnessForColor(LingmoUI.Theme.backgroundColor) === LingmoUI.ColorUtils.Dark ?
                                    LingmoUI.ColorUtils.tintWithAlpha(colorGenerator.dominant, LingmoUI.Theme.backgroundColor, 0.7) :
