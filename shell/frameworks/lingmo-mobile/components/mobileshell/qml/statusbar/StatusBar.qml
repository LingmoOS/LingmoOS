...
import org.kde.lingmo.private.systemtray as SystemTray
...
Item {
    ...
    property color colorScopeColor: LingmoUI.Theme.backgroundColor

    readonly property real textPixelSize: 11
    readonly property real smallerTextPixelSize: 9
    readonly property real elementSpacing: LingmoUI.Units.smallSpacing * 1.5
    ...
    Controls.Control {
        ...
        rightPadding: LingmoUI.Units.smallSpacing * 3
        leftPadding: LingmoUI.Units.smallSpacing * 3
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                id: mainRow
                readonly property real rowHeight: MobileShell.Constants.topPanelHeight - LingmoUI.Units.smallSpacing * 2
                ...
                RowLayout {
                    id: indicators
                    Layout.leftMargin: LingmoUI.Units.smallSpacing // applets have different spacing needs
