...
Item {
    ...
    Item {
        ...
        NavigationPanelButton {
            ...
            LingmoUI.Theme.colorSet: root.foregroundColorGroup
    ...
    states: [
        State {
            ...
            PropertyChanges {
                target: icons
                buttonLength: Math.min(LingmoUI.Units.gridUnit * 10, icons.height * 0.7 / 3)
            }
            AnchorChanges {
                target: leftButton
                anchors {
            ...
            PropertyChanges {
                target: icons
                buttonLength: Math.min(LingmoUI.Units.gridUnit * 8, icons.width * 0.7 / 3)
            }
            AnchorChanges {
                target: leftButton
                anchors {
