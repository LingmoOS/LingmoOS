...
// adapted from https://invent.kde.org/lingmo/lingmo-pa/-/blob/master/applet/contents/ui/ListItemBase.qml
Controls.ItemDelegate {
    ...
    contentItem: RowLayout {
        ...
        LingmoComponents.RadioButton {
            ...
            Layout.topMargin: Math.round(row.height / 2 - implicitHeight - LingmoUI.Units.smallSpacing / 2) // align with text
