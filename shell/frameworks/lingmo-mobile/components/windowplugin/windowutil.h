...
public:
     ...
     */
    QList<KWayland::Client::LingmoWindow *> windowsFromStorageId(const QString &storageId) const;
...
private Q_SLOTS:
    ...
    void windowCreatedSlot(KWayland::Client::LingmoWindow *window);
...
private:
    ...
    QPointer<KWayland::Client::LingmoWindow> m_activeWindow;
