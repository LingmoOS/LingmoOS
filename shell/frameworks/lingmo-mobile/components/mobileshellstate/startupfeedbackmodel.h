...
private Q_SLOTS:
    void onWindowOpened(KWayland::Client::LingmoWindow *window);
    void onLingmoWindowOpened(KWayland::Client::LingmoWindow *window);
    void onActiveWindowChanged(KWayland::Client::LingmoWindow *activeWindow);
...
private:
    ...
    KWayland::Client::LingmoWindow *m_activeWindow{nullptr};
};
