...
FocusScope {
    ...
    onTasksCountChanged: {
        if (tasksCount === 0 && oldTasksCount !== 0) {
            ...
            taskSwitcherHelpers.animateGoToTaskIndex(tasksCount - 1, LingmoUI.Units.longDuration);
        }
    ...
    Connections {
        ...
        function quickSwitch() {
            ...
            if (shouldSwitch) {
                let appAtNewIndex = taskList.getTaskAt(newIndex).window;
                taskSwitcherHelpers.openApp(newIndex, appAtNewIndex, LingmoUI.Units.longDuration * 4, Easing.OutExpo);
            } else {
    ...
    //     id: statusBar
    //     z: 1
    //     colorGroup: LingmoUI.Theme.ComplementaryColorGroup
    ...
    MobileShell.NavigationPanel {
        ...
        foregroundColorGroup: LingmoUI.Theme.Complementary
        shadow: false
    ...
    Item {
        ...
        RowLayout {
            ...
            anchors.horizontalCenterOffset: {
                let size = LingmoUI.Units.iconSizes.large + LingmoUI.Units.largeSpacing * 2;
            ...
            Repeater {
                ...
                delegate: LingmoUI.Icon {
                    ...
                    Layout.preferredHeight: isCenteredIcon ? LingmoUI.Units.iconSizes.huge : LingmoUI.Units.iconSizes.large
                    Layout.preferredWidth: isCenteredIcon ? LingmoUI.Units.iconSizes.huge : LingmoUI.Units.iconSizes.large
        ...
        RowLayout {
            ...
            LingmoUI.Icon {
                ...
                Behavior on opacity { NumberAnimation { duration: LingmoUI.Units.longDuration * 2; easing.type: Easing.OutExpo } }
                Layout.alignment: Qt.AlignHCenter
