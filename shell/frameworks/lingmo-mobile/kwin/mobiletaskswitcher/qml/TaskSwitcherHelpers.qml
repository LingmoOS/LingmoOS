...
QtObject {
    ...
    readonly property real taskSpacing: LingmoUI.Units.gridUnit

    // height of the task preview header
    readonly property real taskHeaderHeight: LingmoUI.Units.gridUnit * 2 + LingmoUI.Units.smallSpacing * 2
    ...
    function openApp(index, window, duration = LingmoUI.Units.shortDuration, horizontalEasing = Easing.OutBack) {
    ...
    function animateGoToTaskIndex(index, duration = LingmoUI.Units.longDuration * 2, easing = Easing.OutExpo) {
