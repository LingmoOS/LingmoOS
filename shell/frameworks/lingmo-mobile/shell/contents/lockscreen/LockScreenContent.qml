...
Item {
    ...
    ColumnLayout {
        ...
        anchors.topMargin: root.notificationsShown ? LingmoUI.Units.gridUnit * 5 : Math.round(root.fullHeight / 2 - (verticalLayout.implicitHeight / 2))
        anchors.bottomMargin: LingmoUI.Units.gridUnit
        anchors.fill: parent
    ...
    Item {
        ...
        ColumnLayout {
            ...
            anchors {
                ...
                left: parent.left
                leftMargin: LingmoUI.Units.gridUnit * 3
            }
    ...
    ColumnLayout {
        ...
        Clock {
            ...
            Layout.fillWidth: true
            Layout.bottomMargin: root.isVertical ? LingmoUI.Units.gridUnit * 2 : 0
        }
        ...
        MobileShell.MediaControlsWidget {
            ...
            Layout.leftMargin: root.isVertical ? LingmoUI.Units.gridUnit : 0
            Layout.rightMargin: root.isVertical ? LingmoUI.Units.gridUnit : 0
            ...
            layer.effect: MultiEffect {
                ...
                shadowOpacity: 0.5
                shadowColor: Qt.lighter(LingmoUI.Theme.backgroundColor, 0.1)
            }
        }
    }
    ...
    NotificationsComponent {
        ...
        Layout.fillWidth: true
        Layout.maximumWidth: LingmoUI.Units.gridUnit * (25 + 2) // clip margins

        leftMargin: root.isVertical ? 0 : LingmoUI.Units.gridUnit
        rightMargin: root.isVertical ? 0 : LingmoUI.Units.gridUnit
        bottomMargin: root.isVertical ? 0 : LingmoUI.Units.gridUnit
