...
Rectangle {
    ...
    MouseArea {
        ...
        ToolButton {
            ...
            visible: (dotDisplay.width / 2) < ((root.width / 2) - keyboardToggle.width - LingmoUI.Units.smallSpacing)
        ...
        FontMetrics {
            id: pinFontMetrics
            font.family: LingmoUI.Theme.defaultFont.family
            font.pointSize: 12
        }
        ...
        ColumnLayout {
            ...
            ListView {
                ...
                Layout.maximumWidth: root.width - (LingmoUI.Units.largeSpacing * 2)
