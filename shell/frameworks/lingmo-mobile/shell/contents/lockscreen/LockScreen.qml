...
import org.kde.lingmo.private.mobileshell.dpmsplugin as DPMS
...
Item {
    ...
    Item {
        ...
        HeaderComponent {
            ...
            z: 1
            anchors.fill: parent
            statusBarHeight: LingmoUI.Units.gridUnit * 1.25
        ...
        Loader {
            ...
            sourceComponent: FlickContainer {
                ...
                keypadHeight: LingmoUI.Units.gridUnit * 20
                ...
                BottomIconIndicator {
                    ...
                    anchors.bottom: parent.bottom
                    anchors.bottomMargin: LingmoUI.Units.gridUnit + flickable.position * 0.1
