...
import org.kde.lingmo.mobileinitialstart.initialstart
import org.kde.lingmo.mobileinitialstart.prepare 1.0 as Prepare
...
Item {
    ...
    ColumnLayout {
        ...
        anchors.leftMargin: LingmoUI.Units.gridUnit * 4
        anchors.rightMargin: LingmoUI.Units.gridUnit * 4
