...
const QList<QString> WIZARD_MODULE_ORDER = {QStringLiteral("org.kde.lingmo.mobileinitialstart.prepare"),
                                            QStringLiteral("org.kde.lingmo.mobileinitialstart.time"),
                                            QStringLiteral("org.kde.lingmo.mobileinitialstart.wifi"),
                                            QStringLiteral("org.kde.lingmo.mobileinitialstart.cellular"),
                                            QStringLiteral("org.kde.lingmo.mobileinitialstart.finished")};
...
void Wizard::load()
{
    ...
    const auto packages = KPackage::PackageLoader::self()->listPackages(QStringLiteral("KPackage/GenericQML"), QStringLiteral("lingmo/mobileinitialstart"));
