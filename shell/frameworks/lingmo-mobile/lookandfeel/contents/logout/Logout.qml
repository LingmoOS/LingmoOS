    ...
    Item {
        ...
        ColumnLayout {
            ...
            ActionButton {
                ...
                text: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Restart")
                onClicked: {
            ...
            ActionButton {
                ...
                text: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Shut Down")
                onClicked: {
                    closeAnim.closeToBlack = true;
            ...
            ActionButton {
                ...
                text: i18nd("lingmo_lookandfeel_org.kde.lookandfeel", "Log Out")
                onClicked: {
                    closeAnim.closeToBlack = true;
