...
int main(int argc, char *argv[])
{
    ...
    // start wizard
    KLocalizedString::setApplicationDomain("lingmo-mobile-envmanager");
    QCoreApplication::setApplicationName(u"lingmo-mobile-envmanager"_s);
    QCoreApplication::setApplicationVersion(QStringLiteral(LINGMO_MOBILE_VERSION_STRING));
