...
import org.kde.lingmo.workspace.keyboardlayout as Keyboards
...
MobileShell.NavigationPanel {
    ...
    backgroundColor: (Keyboards.KWinVirtualKeyboard.active || opaqueBar) ? LingmoUI.Theme.backgroundColor : "transparent";
    foregroundColorGroup: opaqueBar ? LingmoUI.Theme.Window : LingmoUI.Theme.Complementary
    shadow: !opaqueBar
    ...
    rightAction: MobileShell.NavigationPanelAction {
        ...
        // mobile-close-app (from lingmo-frameworks) seems to have fewer margins than icons from ocean-icons
