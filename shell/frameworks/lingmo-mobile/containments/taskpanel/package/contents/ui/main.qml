...
import org.kde.lingmo.private.mobileshell.windowplugin as WindowPlugin
...
ContainmentItem {
    ...
    Plasmoid.status: LingmoCore.Types.PassiveStatus // ensure that the panel never takes focus away from the running app

    // filled in by the shell (Panel.qml) with the lingmo-workspace PanelView
    ...
    readonly property int intendedWindowLocation: inLandscape ? LingmoCore.Types.RightEdge : LingmoCore.Types.BottomEdge
    ...
    // see https://invent.kde.org/lingmo/lingmo-mobile/-/issues/321
    Timer {
    ...
    Item {
        ...
        // contrasting colour
        LingmoUI.Theme.colorSet: opaqueBar ? LingmoUI.Theme.Window : LingmoUI.Theme.Complementary
