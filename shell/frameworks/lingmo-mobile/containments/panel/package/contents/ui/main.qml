...
ContainmentItem {
    ...
    // enforce thickness
    Binding {
        target: panel // assumed to be lingmo-workspace "PanelView" component
        property: "thickness"
...
//END API implementation
    ...
    MobileShell.StatusBar {
        ...
        LingmoUI.Theme.colorSet: root.showingApp ? LingmoUI.Theme.Header : LingmoUI.Theme.Complementary
