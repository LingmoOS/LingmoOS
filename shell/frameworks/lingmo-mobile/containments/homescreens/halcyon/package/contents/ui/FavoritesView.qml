...
Item {
    ...
    readonly property real twoColumnThreshold: LingmoUI.Units.gridUnit * 16
    ...
    readonly property real delegateHeight: Math.round(LingmoUI.Units.gridUnit * 3)
    ...
    FavoritesGrid {
        ...
        property real translateX: openFolderProgress * -LingmoUI.Units.gridUnit
    ...
    FolderGrid {
        ...
        property real translateX: (1 - openProgress) * LingmoUI.Units.gridUnit
    ...
    DragHandler {
        ...
        onTranslationChanged: {
            let moveAmount = Math.max(0, translation.x) / (LingmoUI.Units.gridUnit * 5);
