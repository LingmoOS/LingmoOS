...
MouseArea {
    ...
    function launchApp() {
        ...
        if (application.running) {
            ...
            delegate.launch(delegate.x + (LingmoUI.Units.smallSpacing * 2), delegate.y + (LingmoUI.Units.smallSpacing * 2), icon.source, application.name, application.storageId);
        }
    }
    ...
    ColumnLayout {
        ...
        LingmoComponents.Label {
            ...
            Layout.leftMargin: -parent.anchors.leftMargin + LingmoUI.Units.smallSpacing
            Layout.rightMargin: -parent.anchors.rightMargin + LingmoUI.Units.smallSpacing
