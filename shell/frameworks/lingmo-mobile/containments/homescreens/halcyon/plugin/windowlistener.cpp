    ...
    : QObject{parent}
{
    ...
    connect(registry, &KWayland::Client::Registry::lingmoWindowManagementAnnounced, this, [this, registry](quint32 name, quint32 version) {
        ...
        connect(m_windowManagement, &KWayland::Client::LingmoWindowManagement::windowCreated, this, &WindowListener::windowCreated);
    });
...
QList<KWayland::Client::LingmoWindow *> WindowListener::windowsFromStorageId(QString &storageId) const
{
...
void WindowListener::windowCreated(KWayland::Client::LingmoWindow *window)
{
