...
class HomeScreen : public Lingmo::Containment
{
    Q_OBJECT
...
private Q_SLOTS:
    void onAppletAdded(Lingmo::Applet *applet, const QRectF &geometryHint);
    void onAppletAboutToBeRemoved(Lingmo::Applet *applet);
