    ...
    , m_pageListModel{new PageListModel{this}}
{
    ...
    connect(this, &Lingmo::Containment::appletAdded, this, &HomeScreen::onAppletAdded);
    connect(this, &Lingmo::Containment::appletAboutToBeRemoved, this, &HomeScreen::onAppletAboutToBeRemoved);
}
...
{
    Lingmo::Containment::configChanged();
}

void HomeScreen::onAppletAdded(Lingmo::Applet *applet, const QRectF &geometryHint)
{
    Q_UNUSED(geometryHint)
    widgetsManager()->addWidget(applet);
}

void HomeScreen::onAppletAboutToBeRemoved(Lingmo::Applet *applet)
{
