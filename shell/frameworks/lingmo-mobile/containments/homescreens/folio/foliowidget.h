...
class FolioWidget : public QObject
{
    ...
    Q_PROPERTY(Lingmo::Applet *applet READ applet NOTIFY appletChanged)
    Q_PROPERTY(LingmoQuick::AppletQuickItem *visualApplet READ visualApplet NOTIFY visualAppletChanged)

public:
    FolioWidget(HomeScreen *parent = nullptr, int id = -1, int gridWidth = 0, int gridHeight = 0);
    FolioWidget(HomeScreen *parent, Lingmo::Applet *applet, int gridWidth, int gridHeight);
    ...
    LingmoQuick::AppletQuickItem *visualApplet() const;
...
private:
    void init();
    void setVisualApplet(LingmoQuick::AppletQuickItem *quickApplet);
    ...
    Lingmo::Applet *m_applet{nullptr};
    LingmoQuick::AppletQuickItem *m_quickApplet{nullptr};
};
