...
Folio.DelegateTouchArea {
    ...
    FolderViewTitle {
        ...
        y: Math.round((root.height / 2) - (folderBackground.height / 2) - LingmoUI.Units.gridUnit - height)
    ...
    Rectangle {
        ...
        radius: LingmoUI.Units.gridUnit

        readonly property real margin: LingmoUI.Units.largeSpacing
    ...
    QQC2.PageIndicator {
        ...
        // have to use y instead of anchors to avoid animations
        y: Math.round((root.height / 2) + (folderBackground.height / 2) + LingmoUI.Units.largeSpacing)
