...
MobileShell.GridView {
    ...
    cellWidth: effectiveContentWidth / Math.min(Math.floor(effectiveContentWidth / (folio.FolioSettings.delegateIconSize + LingmoUI.Units.largeSpacing * 3.5)), 8)
    ...
    PC3.ScrollBar.vertical: PC3.ScrollBar {
        ...
        interactive: true
        enabled: true
        implicitWidth: LingmoUI.Units.smallSpacing
