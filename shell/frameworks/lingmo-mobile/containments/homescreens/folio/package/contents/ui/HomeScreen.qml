...
Item {
    ...
    DelegateLabel {
        ...
        Component.onCompleted: {
            folio.HomeScreenState.pageDelegateLabelWidth = LingmoUI.Units.smallSpacing;
        }
    }
    ...
    MobileShell.SwipeArea {
        ...
        Item {
            ...
            Rectangle {
                ...
                anchors.topMargin: folio.HomeScreenState.favouritesBarLocation === Folio.HomeScreenState.Bottom ? 0 : -LingmoUI.Units.gridUnit * 5
                anchors.bottomMargin: -LingmoUI.Units.gridUnit * 5
                anchors.leftMargin: folio.HomeScreenState.favouritesBarLocation === Folio.HomeScreenState.Right ? 0 : -LingmoUI.Units.gridUnit * 5
                anchors.rightMargin: folio.HomeScreenState.favouritesBarLocation === Folio.HomeScreenState.Left ? 0 : -LingmoUI.Units.gridUnit * 5
            }
            ...
            FavouritesBar {
                ...
                height: LingmoUI.Units.gridUnit * 6
            ...
            Item {
                ...
                anchors.leftMargin: root.leftMargin
                anchors.rightMargin: root.rightMargin
                anchors.bottomMargin: favouritesBarAtBottom ? 0 : (root.bottomMargin + LingmoUI.Units.largeSpacing)
        ...
        AppDrawer {
            ...
            property real animationY: (1 - homeScreenState.appDrawerOpenProgress) * (LingmoUI.Units.gridUnit * 2)
            ...
            headerHeight: Math.round(LingmoUI.Units.gridUnit * 4)
        ...
        MobileShell.KRunnerScreen {
            ...
            visible: opacity > 0
            transform: Translate { y: (1 - homeScreenState.searchWidgetOpenProgress) * (-LingmoUI.Units.gridUnit * 2) }
