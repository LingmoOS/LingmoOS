...
Item {
    ...
    QQC2.Popup {
        ...
        readonly property real barWidth: LingmoUI.Units.gridUnit * 3.5
        readonly property real barSpacing: LingmoUI.Units.largeSpacing
        readonly property real minimumBarLength: LingmoUI.Units.gridUnit * 8
        ...
        contentItem: MouseArea {
            ...
            PC3.Button {
                ...
                text: i18n('Options')
                display: (resizeFrame.handleContainer.width > LingmoUI.Units.gridUnit * 7) ? PC3.Button.TextBesideIcon : PC3.Button.IconOnly
