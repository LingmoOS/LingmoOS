...
// on the system without having to load a full Lingmo Mobile shell.
//
// Do not expect changes in this file to change the lingmo UX. Do not install.
//
...
ApplicationWindow {
    ...
    MobileShell.StatusBar {
        ...
        height: LingmoUI.Units.gridUnit * 1.25
