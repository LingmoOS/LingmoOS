...
class ConfigScrollBarAnimationHelper : public AnimationHelper
{
    Q_OBJECT
public:
    explicit ConfigScrollBarAnimationHelper(QObject *parent = nullptr);
    ~ConfigScrollBarAnimationHelper();
