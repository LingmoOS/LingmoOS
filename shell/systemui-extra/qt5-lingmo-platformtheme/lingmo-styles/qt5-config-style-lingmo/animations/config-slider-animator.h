...
class ConfigSliderAnimator : public QParallelAnimationGroup, public AnimatorIface
{
    Q_OBJECT
public:
    explicit ConfigSliderAnimator(QObject *parent = nullptr);
    ~ConfigSliderAnimator();
