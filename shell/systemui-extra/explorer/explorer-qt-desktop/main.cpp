...
void messageOutput(QtMsgType type, const QMessageLogContext &context, const QString &msg)
{
    ...
    QString logFilePath = QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/explorer-qt-desktop.log";
...
int main(int argc, char *argv[])
{
    ...
    PeonyDesktopApplication::explorer_desktop_start_time = QDateTime::currentMSecsSinceEpoch();
...
//    initLingmoUILog4qt("explorer-desktop");
//    qInstallMessageHandler(messageOutput);
...
#endif
    qDebug() << "desktop start time in main:" <<PeonyDesktopApplication::explorer_desktop_start_time;
    ...
    QString id = "explorer-qt-desktop" + qgetenv("DISPLAY");
