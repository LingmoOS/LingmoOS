 ...
 * \details
 * In explorer, the undo/redo stack manager is bind with a directory view.
 * And in explorer-qt, it is similar to explorer. But there are higher level
 * api to manage these 'managers' in explorer-qt.
 ...
 * which are implement as defaut in explorer-qt's operation frameworks.
 * \note
 * FileOperationManager is not a strong binding in explorer-qt's file operation
