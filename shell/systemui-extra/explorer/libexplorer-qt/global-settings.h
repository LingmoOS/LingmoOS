...
//文件管理器版本
#define PEONY_VERSION               "explorerVersion"
...
//其它
#define INIT_FOR_FIRST_TIME         "initForFirstTime"  /* org.lingmo.explorer.settings 首次初始化标志 */
 ...
 * \details
 * this class provide a global settings for explorer-qt.
 * it most be used to save and load preferences of explorer-qt, such as default view,
 * sort type, etc.
 *
 * you can also save another kind of datas using by extensions. such as enable properties.
 * this class instance is shared in both explorer-qt and its plugins.
 */
...
public Q_SLOTS:
     ...
     * keep same. this may be used in out progress, such as explorer-qt-desktop.
     */
...
private:
    ...
    QGSettings*                 m_explorer_gsettings  = nullptr;
    QGSettings*                 m_explorerGSettings  = nullptr; //fixme: 代码冲突遗留，后续仅保留一个explorer gsettings实例
