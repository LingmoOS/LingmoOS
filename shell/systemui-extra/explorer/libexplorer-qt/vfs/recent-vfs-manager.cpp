...
void RecentVFSManager::insert(QString uri, QString mimetype, QString name, QString exec)
{
    ...
    g_autoptr (GFileInfo) tmp_info = g_file_query_info(opened_file, "metadata::explorer-opened-count", G_FILE_QUERY_INFO_NONE, nullptr, nullptr);
    QString openCountString = g_file_info_get_attribute_string(tmp_info, "metadata::explorer-opened-count");
    ...
    g_file_info_set_attribute_string(tmp_info, "metadata::explorer-time-opened", openTimeString.toUtf8().constData());
    g_file_info_set_attribute_string(tmp_info, "metadata::explorer-opened-count", openCountString.toUtf8().constData());
