...
#define PEONY_TYPE_SEARCH_VFS_FILE_ENUMERATOR explorer_search_vfs_file_enumerator_get_type()
G_DECLARE_FINAL_TYPE(PeonySearchVFSFileEnumerator,
                     explorer_search_vfs_file_enumerator,
                     PEONY, SEARCH_VFS_FILE_ENUMERATOR,
                     GFileEnumerator)

PeonySearchVFSFileEnumerator *explorer_search_vfs_file_enumerator_new(void);
