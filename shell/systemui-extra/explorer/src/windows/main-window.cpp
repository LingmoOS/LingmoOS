...
MainWindow::MainWindow(const QString &uri, QWidget *parent) : QMainWindow(parent)
{
    ...
    auto start_cost_time = QDateTime::currentMSecsSinceEpoch()- PeonyApplication::explorer_start_time;
...
//        m_thumbnail = new QGSettings("org.lingmo.explorer.settings", QByteArray(), this);
