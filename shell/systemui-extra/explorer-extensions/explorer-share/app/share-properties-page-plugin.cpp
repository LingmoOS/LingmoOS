...
SharePropertiesPagePlugin::SharePropertiesPagePlugin(QObject *parent) : QObject(parent)
{
    ...
    qDebug()<<"\n\n\n\n\n\n\n SharePropertiesPagePlugin translate:"<<t->load(":/translations/explorer-share-extension_"+QLocale::system().name());
    QFile file(":/translations/explorer-share-extension_"+QLocale::system().name()+".ts");
