...
/* ------------------------------------------------------------------------
 * Code for interface com.lingmo.lingmosdk.SyncConfig
 * ------------------------------------------------------------------------
 */
 ...
 * SECTION:SyncConfig
 * @title: SyncConfig
 * @short_description: Generated C code for the com.lingmo.lingmosdk.SyncConfig D-Bus interface
 *
 * This section contains code for working with the <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link> D-Bus interface in C.
 */

/* ---- Introspection data for com.lingmo.lingmosdk.SyncConfig ---- */
...
static const _ExtendedGDBusInterfaceInfo _sync_config__interface_info =
{
  {
    -1,
    (gchar *) "com.lingmo.lingmosdk.SyncConfig",
 ...
 *
 * Gets a machine-readable description of the <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link> D-Bus interface.
 *
 ...
 * SyncConfig:
 *
 * Abstract interface type for the D-Bus interface <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link>.
 */
 ...
 *
 * Virtual table for the D-Bus interface <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link>.
 */
...
sync_config__default_init (SyncConfigIface *iface)
{
   ...
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.RegisterSchema">RegisterSchema()</link> D-Bus method.
   *
   ...
   * @arg_SchemaPath: Argument passed by remote caller.
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.UnregisterSchema">UnregisterSchema()</link> D-Bus method.
   *
   ...
   * @arg_state: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-com-lingmo-lingmosdk-SyncConfig.state">"state"</link> is received.
   *
 ...
 *
 * Emits the <link linkend="gdbus-signal-com-lingmo-lingmosdk-SyncConfig.state">"state"</link> D-Bus signal.
 */
void
sync_config__emit_state (
    SyncConfig *object,
 ...
 *
 * Asynchronously invokes the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.RegisterSchema">RegisterSchema()</link> D-Bus method on @proxy.
 ...
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.RegisterSchema">RegisterSchema()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously invokes the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.UnregisterSchema">UnregisterSchema()</link> D-Bus method on @proxy.
 * When the operation is finished, @callback will be invoked in the thread-default main loop of the thread you are calling this method from (see g_main_context_push_thread_default()).
 ...
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.UnregisterSchema">UnregisterSchema()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 ...
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.RegisterSchema">RegisterSchema()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 ...
 * @ArgOut: Parameter to return.
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-com-lingmo-lingmosdk-SyncConfig.UnregisterSchema">UnregisterSchema()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 * This method will free @invocation, you cannot use it afterwards.
 */
void
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link>. See g_dbus_proxy_new() for more details.
 *
 * When the operation is finished, @callback will be invoked in the thread-default main loop of the thread you are calling this method from (see g_main_context_push_thread_default()).
...
sync_config__proxy_new (
    ...
    gpointer             user_data)
{
  g_async_initable_new_async (SYNC_CONFIG_TYPE__PROXY, G_PRIORITY_DEFAULT, cancellable, callback, user_data, "g-flags", flags, "g-name", name, "g-connection", connection, "g-object-path", object_path, "g-interface-name", "com.lingmo.lingmosdk.SyncConfig", NULL);
}
 ...
 * @error: Return location for error or %NULL
 *
 * Synchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link>. See g_dbus_proxy_new_sync() for more details.
 *
...
{
  GInitable *ret;
  ret = g_initable_new (SYNC_CONFIG_TYPE__PROXY, cancellable, error, "g-flags", flags, "g-name", name, "g-connection", connection, "g-object-path", object_path, "g-interface-name", "com.lingmo.lingmosdk.SyncConfig", NULL);
  if (ret != NULL)
    return SYNC_CONFIG_ (ret);
  else
    return NULL;
...
sync_config__proxy_new_for_bus (
    ...
    gpointer             user_data)
{
  g_async_initable_new_async (SYNC_CONFIG_TYPE__PROXY, G_PRIORITY_DEFAULT, cancellable, callback, user_data, "g-flags", flags, "g-name", name, "g-bus-type", bus_type, "g-object-path", object_path, "g-interface-name", "com.lingmo.lingmosdk.SyncConfig", NULL);
}
...
{
  GInitable *ret;
  ret = g_initable_new (SYNC_CONFIG_TYPE__PROXY, cancellable, error, "g-flags", flags, "g-name", name, "g-bus-type", bus_type, "g-object-path", object_path, "g-interface-name", "com.lingmo.lingmosdk.SyncConfig", NULL);
  if (ret != NULL)
    return SYNC_CONFIG_ (ret);
  else
    return NULL;
  ...
  for (n = 0; _sync_config__interface_info.parent_struct.properties[n] != NULL; n++)
    {
      ...
      if (info->flags & G_DBUS_PROPERTY_INFO_FLAGS_READABLE)
        {
          GVariant *value;
          value = _sync_config__skeleton_handle_get_property (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)), NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "com.lingmo.lingmosdk.SyncConfig", info->name, NULL, skeleton);
          if (value != NULL)
            {
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      ...
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "com.lingmo.lingmosdk.SyncConfig", "state",
        signal_variant, NULL);
    }
 ...
 *
 * Creates a skeleton object for the D-Bus interface <link linkend="gdbus-interface-com-lingmo-lingmosdk-SyncConfig.top_of_page">com.lingmo.lingmosdk.SyncConfig</link>.
 *
