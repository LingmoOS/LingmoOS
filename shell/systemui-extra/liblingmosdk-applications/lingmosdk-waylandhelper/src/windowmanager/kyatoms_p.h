...
ENUM_BEGIN(KyAtom)
    ...
    // LINGMO extensions
    ENUM(_LINGMO_NET_WM_WINDOW_TYPE_SYSTEMWINDOW),
    ENUM(_LINGMO_NET_WM_WINDOW_TYPE_INPUTPANEL),
    ENUM(_LINGMO_NET_WM_WINDOW_TYPE_LOGOUT),
    ENUM(_LINGMO_NET_WM_WINDOW_TYPE_SCREENLOCK),
    ENUM(_LINGMO_NET_WM_WINDOW_TYPE_SCREENLOCKNOTIFICATION),
    ENUM(_LINGMO_NET_WM_WINDOW_TYPE_WATERMARK),
