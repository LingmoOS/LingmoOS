...
#ifndef LINGMOFILEMETADATA_PROPERTIES
#define LINGMOFILEMETADATA_PROPERTIES
...
/** @file properties.h <LingmoUIFileMetadata/Properties> */
namespace LingmoUIFileMetadata {
namespace Property {

/**
 * @brief The Property enum contains all files property types that LingmoUIFileMetadata manipulates
 *
 */
enum Property {
    FirstProperty = 0,
...
Q_DECLARE_METATYPE(LingmoUIFileMetadata::Property::Property)
