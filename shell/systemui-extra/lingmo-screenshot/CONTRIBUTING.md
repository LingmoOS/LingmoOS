...
2. [Open an issue](https://github.com/UbuntuLingmo/lingmo-screenshot/issues/new) and describe the issue you are having - you could include:
     - Screenshots
     - Ways to reproduce the issue.
     - Your lingmo-screenshot version.
...
I improve lingmo-screenshot in my free time because I want to create something good for everyone to use.
