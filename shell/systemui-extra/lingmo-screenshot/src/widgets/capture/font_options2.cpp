...
void Font_Options2::setCenterWidget(QWidget *widget)
{
    ...
    Font_type->setGeometry(13, 17, 134, 26);
    Font_size = new  QSpinBox(this);
    Font_size->setMinimum(6);
    Font_size->setGeometry(153, 17, 56, 26);
...
void Font_Options2::is_font_bold_selete(bool selected)
{
...
void Font_Options2::is_font_delete_selete(bool selected)
{
...
void Font_Options2::is_font_underline_selete(bool selected)
{
...
void Font_Options2::is_font_italic_selete(bool selected)
{
...
bool Font_Options2::IsDarkTheme()
{
    bool isDrak;
    context.style_settings = new QGSettings("org.lingmo.style");
    context.style_name = context.style_settings->get("style-name").toString();
