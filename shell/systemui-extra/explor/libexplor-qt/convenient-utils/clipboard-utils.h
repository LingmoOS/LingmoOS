 ...
 * \details
 * This class provide some nessersary method which other libexplor-qt's class need.
...
public:
     ...
     * in explor-qt for judge how we deal with the files in clipboard when we do
     * a 'paste' (copy/move).
