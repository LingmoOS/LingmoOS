...
public:
    ...
    virtual const QString description() override {return QObject::tr("Default custom vfs info of explor");}
    virtual const QIcon icon() override {return QIcon();}
...
public:
    ...
    virtual const QString description() override {return QObject::tr("Default local vfs info of explor");}
    virtual const QIcon icon() override {return QIcon();}
    virtual void setEnable(bool enable) {Q_UNUSED(enable)}
    virtual bool isEnable() {return true;}
