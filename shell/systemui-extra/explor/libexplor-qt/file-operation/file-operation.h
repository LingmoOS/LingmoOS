...
public:
     ...
     * The FileOperationInfo is a part of explor-qt's undo/redo stack(s). FileOperationManager
...
Q_SIGNALS:
     ...
     * \param message
     * \details
     * Before a file operation start, explor-qt will do some simple checks.
     ...
     * \details
     * In explor-qt, we perfer user using native move function for fast moving.
     ...
     * \param srcUri
     * \details
     * In explor-qt, if a file operation was cancelled, it not just simply cancel the operation.
