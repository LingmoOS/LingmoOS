...
/*!
 * \brief The FMWindow class, the normal window of explor-qt's file manager.
 * \details
 * This class show the directory as the common window which used by explor-qt.
 ...
 * directory views.
 *
 * The tab view's design is improving and refactoring from explor's window-pane-slot
 * window framework. There is no concept pane in explor-qt (stand by preview page).
