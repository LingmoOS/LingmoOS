...
TARGET = explor-qt-menu-plugin-mate-terminal
TEMPLATE = lib
...
LIBS += -L$$PWD/../../libexplor-qt/ -lexplor-qt
...
HEADERS += \
        ...
        explor-qt-menu-plugin-mate-terminal_global.h 

DESTDIR = ../../testdir

TRANSLATIONS += translations/explor-qt-mate-terminal-extension_zh_CN.ts
...
RESOURCES += \
    explor-qt-menu-plugin-mate-terminal.qrc
