...
TRANSLATIONS += ../translations/explor-qt-desktop/explor-qt-desktop_zh_CN.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_tr.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_cs.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_de.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_es.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_fr.ts \
#                ../translations/explor-qt-desktop/explor-qt-desktop_kk_KZ.ts \
#                ../translations/explor-qt-desktop/explor-qt-desktop_ug_CN.ts \
#                ../translations/explor-qt-desktop/explor-qt-desktop_ky_KG.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_bo_CN.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_mn.ts \
                ../translations/explor-qt-desktop/explor-qt-desktop_zh_HK.ts

SOURCES += \
    desktop-background-manager.cpp \
    desktopbackgroundwindow.cpp \
    main.cpp \
    explor-desktop-application.cpp \
    fm-dbus-service.cpp \
    ...
    explor-json-operation.cpp \
    bw-list-info.cpp \
    explor-dbus-service.cpp \
...
HEADERS += \
    ...
    explor-json-operation.h \
    bw-list-info.h \
    explor-dbus-service.h \
...
#QM_FILES_RESOURCE_PREFIX = ../translations/explor-qt-desktop
QM_FILES_INSTALL_PATH = /usr/share/explor-qt-desktop

desktop_data.path = /etc/xdg/autostart
desktop_data.files += ../data/explor-desktop.desktop
INSTALLS += desktop_data

DISTFILES +=

RESOURCES += \
    explor-qt-desktop-style.qrc
