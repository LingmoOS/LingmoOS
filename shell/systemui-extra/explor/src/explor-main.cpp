...
void messageOutput(QtMsgType type, const QMessageLogContext &context, const QString &msg)
{
    ...
    bool showDebug = true;
    QString logFilePath = QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/explor-qt.log";
    //屏蔽代码，自动生成日志，无需手动创建
...
int main(int argc, char *argv[])
{
    ...
    PeonyApplication::explor_start_time = QDateTime::currentMSecsSinceEpoch();
...
//    qInstallMessageHandler(messageOutput);
    ...
    initLingmoUILog4qt("explor");
#endif
    qDebug() << "explor start in main time:" <<PeonyApplication::explor_start_time ;
    ...
    PeonyApplication app(argc, argv, "explor-qt");
