...
#define DirectoryViewPluginIface2_iid "org.lingmo.explor-qt.plugin-iface.DirectoryViewPluginInterface2"
 ...
 * interface for making newly type item view for explor.
 *
 * There are 2 kinds of internal implement at explor, icon view and list view.
 *
 * \verbatim
 *
 ...
 *
 * I defined some rules to indicate how explor zoom its view.
