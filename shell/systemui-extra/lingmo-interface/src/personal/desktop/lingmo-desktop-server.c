...
#define schemaID "org.mate.caja.desktop"

static GMainLoop         *pLoop     = NULL;
static Desktop *pSkeleton = NULL;

static gboolean lingmo_set_bool(Desktop* object,
                               ...
                               gpointer user_data)
{
    ...
    desktop_complete_transfer_bool_value(object, invocation);
...
static gboolean lingmo_set_int(Desktop* object,
                              GDBusMethodInvocation* invocation,
                              GVariant *in_arg,
                              gpointer user_data)
{
    ...
    desktop_complete_transfer_int_value(object, invocation);
...
static gboolean lingmo_set_char(Desktop* object,
                               GDBusMethodInvocation* invocation,
                               GVariant *in_arg,
                               gpointer user_data)
{
    ...
    desktop_complete_transfer_string_value(object, invocation);
                            ...
                            gpointer user_data)
{
    ...
    pSkeleton = desktop_skeleton_new();
...
bool InitDBusCommunicationServer(void)
{
    ...
    (void)g_bus_own_name(DESKTOP_BUS,
                        DESKTOP_BUS_NAME,
