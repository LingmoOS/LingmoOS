...
#define schemaID "org.mate.font-rendering"

static GMainLoop         *pLoop     = NULL;
static Font *pSkeleton = NULL;

static gboolean lingmo_set_double(Font* object,
                      ...
                      gpointer user_data)
{
    ...
    font_complete_transfer_double_value(object, invocation);

    GSettings *setting=gsettings_get_schemaID(schemaID);
    gsettings_set_double(setting, key, value);
    Dec_ref(setting);
...
static gboolean lingmo_set_int(Font* object,
                              GDBusMethodInvocation* invocation,
                              GVariant *in_arg,
                              gpointer user_data)
{
    ...
    font_complete_transfer_int_value(object, invocation);
