...
static gboolean lingmo_set_bool(Mouse* object,
...
static gboolean lingmo_get_bool(Mouse *object,
                               GDBusMethodInvocation* invocation,
                               char *in_arg,
                               gpointer user_data)
{
...
static gboolean lingmo_set_double(Mouse* object,
                                GDBusMethodInvocation* invocation,
                                GVariant *in_arg,
                                gpointer user_data)
{
...
static gboolean lingmo_get_double(Mouse *object,
                               GDBusMethodInvocation* invocation,
                               char *in_arg,
                               gpointer user_data)
{
...
static gboolean lingmo_set_int(Mouse* object,
                              GDBusMethodInvocation* invocation,
                              GVariant *in_arg,
                              gpointer user_data)
{
...
static gboolean lingmo_get_int(Mouse *object,
                               GDBusMethodInvocation* invocation,
                               char *in_arg,
                               gpointer user_data)
{
...
static gboolean lingmo_set_char(Mouse* object,
                               GDBusMethodInvocation* invocation,
                               GVariant *in_arg,
                               gpointer user_data)
{
...
static gboolean lingmo_get_char(Mouse *object,
                               GDBusMethodInvocation* invocation,
                               char *in_arg,
                               gpointer user_data)
{
                            ...
                            gpointer user_data)
{
    ...
    (void) g_signal_connect(pSkeleton, "handle-transfer-double-value", G_CALLBACK(lingmo_set_double), NULL);
    (void) g_signal_connect(pSkeleton, "handle-get-double-value", G_CALLBACK(lingmo_get_double), NULL);
