...
static gboolean lingmo_set_bool(Keyboard* object,
...
static gboolean lingmo_get_bool(Keyboard* object,
                               GDBusMethodInvocation* invocation,
                               gchar *in_arg,
                               gpointer user_data)
{
...
static gboolean lingmo_set_int(Keyboard* object,
                              GDBusMethodInvocation* invocation,
                              GVariant *in_arg,
                              gpointer user_data)
{
...
static gboolean lingmo_get_int(Keyboard* object,
                              GDBusMethodInvocation* invocation,
                              gchar *in_arg,
                              gpointer user_data)
{
