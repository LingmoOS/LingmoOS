...
AdminMenuPlugin::AdminMenuPlugin(QObject *parent) : QObject(parent)
{
    ...
    bool b_load = t->load(":/translations/explor-admin_"+QLocale::system().name());
    qDebug()<<"\n\n\n\n\n\n\n  AdminMenuPlugin translate:"<<b_load;
    QFile file(":/translations/explor-admin_"+QLocale::system().name()+".ts");
