    ...
    , m_stashManager(this)
{
     ...
     * important: choose between kate and notepad mode here to submit the right product id
     */
    m_userFeedbackProvider.setProductIdentifier(isKate() ? QStringLiteral("org.kde.kate") : QStringLiteral("org.lingmo.notepad"));
...
void KateApp::fillAuthorsAndCredits(KAboutData &aboutData)
{
    ...
    aboutData.addAuthor(i18n("Jochen Wilhemly"), i18n("Notepad Author"), QStringLiteral("digisnap@cs.tu-berlin.de"));
    aboutData.addAuthor(i18n("Michael Koch"), i18n("Notepad port to KParts"), QStringLiteral("koch@kde.org"));
    ...
    aboutData.addAuthor(i18n("Glen Parker"), i18n("Notepad Undo History, Kspell integration"), QStringLiteral("glenebob@nwlink.com"));
    aboutData.addAuthor(i18n("Scott Manson"), i18n("Notepad XML Syntax highlighting support"), QStringLiteral("sdmanson@alltel.net"));
