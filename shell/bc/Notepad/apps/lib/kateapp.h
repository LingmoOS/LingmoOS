...
public:
    /**
     *  Are we full featured Kate or the simplified Notepad?
     */
    enum ApplicationMode { ApplicationKate, ApplicationNotepad };

    /**
     * application constructor
     * @param arg command line parser, reference will be stored, needs to survive as long as application object is alive
     * @param mode application mode, either Kate or Notepad
    ...
    {
        return mode() == KateApp::ApplicationNotepad;
    }
...
private:
    ...
    /**
     * application mode, kate or notepad
     */
