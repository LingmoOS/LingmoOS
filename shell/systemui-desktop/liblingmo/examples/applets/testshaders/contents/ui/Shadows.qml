    ...
    Item {
        ...
        Item {
            ...
            Column {
                ...
                LingmoComponents.Label {
                    text:"In Lingmo 2, the user interface is based on an OpenGL scenegraph, composition of the UI happens on the graphics card. In the past weeks, we've been working on getting a Lingmo 2 shell up and running, and on porting the QML imports of the Lingmo Components."
                }
