...
#ifndef LINGMO_THEME_H
#define LINGMO_THEME_H
...
/**
 * @class Theme lingmo/theme.h <Lingmo/Theme>
 *
 * @short Interface to the Lingmo theme
 *
 *
 * Lingmo::Theme provides access to a common and standardized set of graphic
 ...
 *
 * Lingmo::Svg uses Lingmo::Theme internally to locate and load the appropriate
 * SVG data. Alternatively, Lingmo::Theme can be used directly to retrieve
 * file system paths to SVGs by name.
 */
class LINGMO_EXPORT Theme : public QObject
{
    Q_OBJECT
...
public:
    ...
    /**
     * Default constructor. It will be the global theme configured in lingmorc
    ...
    /** This method allows Lingmo to enable and disable the background
    ...
    /** This method allows Lingmo to enable and disable the adaptive
    ...
    /** This method allows Lingmo to set a background contrast effect
    ...
    /** This method allows Lingmo to enable and disable the blurring
     ...
     * \code
     * Item {
     *     width: LingmoCore.Theme.mSize(LingmoCore.Theme.defaultFont).height
     *     height: width
     * }
     * \endcode
