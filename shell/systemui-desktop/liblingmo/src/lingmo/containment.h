...
#ifndef LINGMO_CONTAINMENT_H
#define LINGMO_CONTAINMENT_H

#include <KPluginMetaData>
#include <KSharedConfig>
#include <lingmo/applet.h>
...
/**
 * @class Containment lingmo/containment.h <Lingmo/Containment>
 *
 ...
 *
 * Since containment is actually just a Lingmo::Applet, all the techniques used
 ...
 * of Lingmo/Containment. Plugins registered with both the Applet and the Containment
 ...
 */
class LINGMO_EXPORT Containment : public Applet
{
    Q_OBJECT
     ...
     */
    Q_PROPERTY(QList<Lingmo::Applet *> applets READ applets NOTIFY appletsChanged)

    /**
     * The corona for this contaiment
     */
    Q_PROPERTY(Lingmo::Corona *corona READ corona CONSTANT)

    /**
     * Type of this containment
     */
    Q_PROPERTY(Lingmo::Containment::Type containmentType READ containmentType NOTIFY containmentTypeChanged)
    ...
    Q_PROPERTY(Lingmo::Types::ContainmentDisplayHints containmentDisplayHints READ containmentDisplayHints WRITE setContainmentDisplayHints NOTIFY
...
public:
     ...
     *
     * This value is specified in the "X-Lingmo-ContainmentType" JSON-metadata value of containments.
     */
    enum Type {
...
Q_SIGNALS:
     ...
     *           the gui might choose whether to respect or not this hint
     */
    void appletAdded(Lingmo::Applet *applet, const QRectF &geometryHint);
     ...
     *           the gui might choose whether to respect or not this hint
     */
    void appletAboutToBeAdded(Lingmo::Applet *applet, const QRectF &geometryHint);
     ...
     */
    void appletAboutToBeRemoved(Lingmo::Applet *applet);
     ...
     * @since 5.16
     */
    void appletCreated(Lingmo::Applet *applet, const QRectF &geometryHint);
     ...
     */
    void configureRequested(Lingmo::Applet *applet);

    /**
     * Emitted when the user wants to chose an alternative for this applet or containment.
     */
    void appletAlternativesRequested(Lingmo::Applet *applet);
...
public Q_SLOTS:
     ...
     * Applets.
     */
    void setFormFactor(Lingmo::Types::FormFactor formFactor);
     ...
     * @since 5.77
     */
    void setContainmentDisplayHints(Lingmo::Types::ContainmentDisplayHints hints);
...
private:
    ...
    Q_PRIVATE_SLOT(d, void appletDeleted(Lingmo::Applet *))
    Q_PRIVATE_SLOT(d, void triggerShowAddWidgets())
    Q_PRIVATE_SLOT(d, void checkStatus(Lingmo::Types::ItemStatus))
