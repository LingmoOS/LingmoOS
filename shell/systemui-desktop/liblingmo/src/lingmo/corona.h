...
#ifndef LINGMO_CORONA_H
#define LINGMO_CORONA_H
...
/**
 * @class Corona lingmo/Corona.h <Lingmo/Corona>
 *
 * @short A bookkeeping Scene for Lingmo::Applets
 */
class LINGMO_EXPORT Corona : public QObject
{
    Q_OBJECT
...
public:
    ...
    /**
     * Returns the number of screens available to lingmo.
     ...
     */
    QList<Lingmo::Types::Location> freeEdges(int screen) const;
     ...
     * @since 4.6
     */
    QList<Lingmo::Containment *> importLayout(const KConfigGroup &config);
...
Q_SIGNALS:
     ...
     */
    void containmentAdded(Lingmo::Containment *containment);
     ...
     * @since 5.16
     */
    void containmentCreated(Lingmo::Containment *containment);
     ...
     * this is for use by things that don't get constraints events, like lingmoapp.
     ...
     */
    void immutabilityChanged(Lingmo::Types::ImmutabilityType immutability);
