 ...
 *
 * LingmoQuick::SharedQmlEngine provides a class to conveniently use QML based
 ...
 * @since 6.0
 */
class LINGMOQUICK_EXPORT SharedQmlEngine : public QObject
{
    Q_OBJECT
...
public:
    /**
     * Construct a new LingmoQuick::SharedQmlEngine
     *
     * @param parent The QObject parent for this object.
     */
    explicit SharedQmlEngine(QObject *parent = nullptr);
    explicit SharedQmlEngine(Lingmo::Applet *applet, QObject *parent = nullptr);
