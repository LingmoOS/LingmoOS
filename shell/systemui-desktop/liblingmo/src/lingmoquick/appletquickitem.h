...
class LINGMOQUICK_EXPORT AppletQuickItem : public QQuickItem
{
    Q_OBJECT
...
public:
    ...
    static bool hasItemForApplet(Lingmo::Applet *applet);
    static AppletQuickItem *itemForApplet(Lingmo::Applet *applet);
...
protected:
    ...
    virtual void init();
    LingmoQuick::SharedQmlEngine *qmlObject();
