...
/**
 * Dialog creates a Lingmo themed top level window that can contain any QML component.
 *
 ...
 * @version 2.0
 */
class LINGMOQUICK_EXPORT Dialog : public QQuickWindow, public QQmlParserStatus
{
    Q_OBJECT
    ...
    /**
     * Lingmo Location of the dialog window. Useful if this dialog is a popup for a panel
     */
