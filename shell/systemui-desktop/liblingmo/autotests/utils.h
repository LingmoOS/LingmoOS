...
static void installLingmoTheme(const QString &theme = QStringLiteral("ocean"))
{
    QString destinationTheme = (theme == QLatin1String("ocean") ? QStringLiteral("default") : theme);
    ...
    QDir themePath(qttestPath + QLatin1String("/lingmo/desktoptheme/") + destinationTheme);
