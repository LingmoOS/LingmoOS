...
void QuickViewSharedEngineTest::resizemodeitem()
{
    ...
    auto view = new LingmoQuick::QuickViewSharedEngine(&window);
    QVERIFY(view);
    ...
    view->setResizeMode(LingmoQuick::QuickViewSharedEngine::SizeViewToRootObject);
    ...
    window.hide();
    delete view;
    view = new LingmoQuick::QuickViewSharedEngine(&window);
    QVERIFY(view);
    view->setResizeMode(LingmoQuick::QuickViewSharedEngine::SizeViewToRootObject);
    view->setSource(testFileUrl("resizemodeitem.qml"));
...
void QuickViewSharedEngineTest::engine()
{
    ...
    auto view2 = new LingmoQuick::QuickViewSharedEngine();
