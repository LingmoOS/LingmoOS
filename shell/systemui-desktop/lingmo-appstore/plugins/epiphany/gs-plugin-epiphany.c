 ...
 *    looks like "org.lingmo.Appstore.WebApp_527a2dd6729c3574227c145bbc447997f0048537.desktop"
 *    See https://github.com/LingmoOS/mwleeds/lingmo-pwa-list/-/blob/6e8b17b018f99dbf00b1fa956ed75c4a0ccbf389/pwa-metainfo-generator.py#L84-89
...
gs_plugin_epiphany_init (GsPluginEpiphany *self)
{
	...
	gs_plugin_set_appstream_id (GS_PLUGIN (self), "org.lingmo.Appstore.Plugin.Epiphany");
			      ...
			      GsApp    *app)
{
	...
	if (gs_app_get_state (app) == GS_APP_STATE_UNKNOWN) {
		 ...
		 * in Appstore that was originally installed from Epiphany,
		...
		if (cached_app)
			...
			gs_app_set_url_missing (app,
						"https://github.com/LingmoOS/lingmo-appstore/-/wikis/How-to-reinstall-a-web-app");
		}
	}
}
	    ...
	    const char          *url)
{
	...
	gs_app_set_metadata (app, "LingmoAppstore::PackagingFormat", _("Web App"));
	gs_app_set_metadata (app, "LingmoAppstore::PackagingIcon", "web-browser-symbolic");
...
generate_app_id_for_url (const gchar *url)
{
	 ...
	 * https://github.com/LingmoOS/mwleeds/lingmo-pwa-list
	...
	return g_strconcat ("org.lingmo.Appstore.WebApp_", url_hash, ".desktop", NULL);
}
			     ...
			     GError           **error)
{
	...
	for (guint i = 0; i < n_webapps; i++) {
		 ...
		 * https://github.com/LingmoOS/epiphany/-/blob/master/lib/ephy-web-app-utils.c
		 */
