...
void FolderModel::setUsedByContainment(bool used)
{
    if (m_usedByContainment != used) {
        ...
        if (action) {
            action->setText(m_usedByContainment ? i18n("&Refresh") : i18n("&Refresh View"));
            action->setIcon(m_usedByContainment ? QIcon::fromTheme(QStringLiteral("view-refresh")) : QIcon::fromTheme(QStringLiteral("view-refresh")));
        }
