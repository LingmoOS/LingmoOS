...
class TestUbi(infra.basetest.BRTest):
    config = infra.basetest.BASIC_TOOLCHAIN_CONFIG + \
        """
        LINGMO_TARGET_ROOTFS_UBIFS=y
        LINGMO_TARGET_ROOTFS_UBIFS_LEBSIZE=0x3ff80
        LINGMO_TARGET_ROOTFS_UBIFS_MINIOSIZE=0x1
        LINGMO_TARGET_ROOTFS_UBI=y
        LINGMO_TARGET_ROOTFS_UBI_PEBSIZE=0x40000
        LINGMO_TARGET_ROOTFS_UBI_SUBSIZE=1
        LINGMO_TARGET_ROOTFS_UBI_USE_CUSTOM_CONFIG=y
        LINGMO_TARGET_ROOTFS_UBI_CUSTOM_CONFIG_FILE="{}"
        """.format(
