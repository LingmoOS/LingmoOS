...
SettingsProvider::SettingsProvider()
    : m_config(KSharedConfig::openConfig(QStringLiteral("lingmo/lingmorc")))
        ...
        */
        ...
        if (rx.match(windowPropertyValue).hasMatch()) {
            ...
            if (!internalSettings->exceptionPreset().isEmpty()) {
                if (!m_presetsConfig) {
                    KSharedConfigPtr presetsConfig = KSharedConfig::openConfig(QStringLiteral("lingmo/windecopresetsrc"));
