...
TOOLCHAIN_WRAPPER_OPTS = \
	...
	$(call qstrip,$(LINGMO_SSP_OPTION)) \
	$(call qstrip,$(LINGMO_TARGET_OPTIMIZATION))
...
ifeq ($(LINGMO_TOOLCHAIN_GCC_AT_LEAST_7),)
TOOLCHAIN_WRAPPER_OPTS += -DBR_NEED_SOURCE_DATE_EPOCH
endif
ifeq ($(LINGMO_TOOLCHAIN_GCC_AT_LEAST_6),)
...
ifeq ($(LINGMO_TOOLCHAIN_GCC_AT_LEAST_10)$(LINGMO_microblaze),yy)
...
ifeq ($(LINGMO_CCACHE_USE_BASEDIR),y)
TOOLCHAIN_WRAPPER_ARGS += -DBR_CCACHE_BASEDIR='"$(BASE_DIR)"'
endif

ifeq ($(LINGMO_PIC_PIE),y)
TOOLCHAIN_WRAPPER_ARGS += -DLINGMO_PIC_PIE
endif

ifeq ($(LINGMO_RELRO_PARTIAL),y)
TOOLCHAIN_WRAPPER_ARGS += -DLINGMO_RELRO_PARTIAL
else ifeq ($(LINGMO_RELRO_FULL),y)
TOOLCHAIN_WRAPPER_ARGS += -DLINGMO_RELRO_FULL
endif
