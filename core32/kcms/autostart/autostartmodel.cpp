...
void AutostartModel::load()
{
    ...
    loadScriptsFromDir(QStringLiteral("lingmo-workspace/env/"), AutostartModel::AutostartEntrySource::PlasmaEnvScripts);

    loadScriptsFromDir(QStringLiteral("lingmo-workspace/shutdown/"), AutostartModel::AutostartEntrySource::PlasmaShutdown);
