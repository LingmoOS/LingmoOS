...
class Gencontrol(Base):
    ...
    env_flags = [
        ('LINGMO_KERNEL_DISABLE_INSTALLER', 'disable_installer', 'installer modules'),
        ('LINGMO_KERNEL_DISABLE_SIGNED', 'disable_signed', 'signed code'),
    ]
