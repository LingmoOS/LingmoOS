...
Prepare_config ()
{
	...
	LINGMO_SYS_BUILD_DISTRIBUTION="${LINGMO_SYS_BUILD_DISTRIBUTION:-hydrogen}"
	...
	if [ "${LINGMO_SYS_BUILD_MODE}" = "debian" ]; then
		LINGMO_SYS_BUILD_MIRROR_BOOTSTRAP="${LINGMO_SYS_BUILD_MIRROR_BOOTSTRAP:-http://packages.lingmo.org/lingmo}"
	...
	if [ "${LINGMO_SYS_BUILD_MODE}" = "debian" ]; then
		...
		LINGMO_SYS_BUILD_MIRROR_BINARY="${LINGMO_SYS_BUILD_MIRROR_BINARY:-http://packages.lingmo.org/lingmo}"
