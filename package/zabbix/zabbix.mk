...
ifeq ($(LINGMO_PACKAGE_OPENIPMI),y)
...
ifeq ($(LINGMO_PACKAGE_NETSNMP_ENABLE_MIBS),y)
...
ifeq ($(LINGMO_PACKAGE_ZABBIX_SERVER),y)
...
ifeq ($(LINGMO_PACKAGE_ZABBIX_SERVER_COPY_FRONTEND),y)
...
ifeq ($(LINGMO_PACKAGE_ZABBIX_SERVER_MYSQL),y)
...
else ifeq ($(LINGMO_PACKAGE_ZABBIX_SERVER_POSTGRESQL),y)
...
ifeq ($(LINGMO_PACKAGE_ZABBIX_SERVER_COPY_DUMPS),y)
...
endif # LINGMO_PACKAGE_ZABBIX_SERVER
