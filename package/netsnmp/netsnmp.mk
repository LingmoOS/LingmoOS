...
NETSNMP_CONF_OPTS = \
	...
	--with-mib-modules="$(call qstrip,$(LINGMO_PACKAGE_NETSNMP_WITH_MIB_MODULES))" \
	--with-out-mib-modules="$(call qstrip,$(LINGMO_PACKAGE_NETSNMP_WITHOUT_MIB_MODULES))" \
	--disable-manuals
...
else ifeq ($(LINGMO_PACKAGE_NETSNMP_OPENSSL_INTERNAL),y)
...
ifeq ($(LINGMO_PACKAGE_PCIUTILS),y)
