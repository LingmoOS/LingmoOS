...
ifeq ($(LINGMO_PACKAGE_MESA3D_DRIVER)$(LINGMO_PACKAGE_XORG7),yy)
...
ifeq ($(LINGMO_PACKAGE_MESA3D_LLVM),y)
...
ifeq ($(LINGMO_PACKAGE_MESA3D_OPENCL),y)
...
ifeq ($(LINGMO_PACKAGE_MESA3D_NEEDS_ELFUTILS),y)
MESA3D_DEPENDENCIES += elfutils
endif

ifeq ($(LINGMO_PACKAGE_MESA3D_OPENGL_GLX),y)
...
MESA3D_CONF_OPTS += \
	-Dglx=dri \
	-Dglx-direct=true
ifeq ($(LINGMO_PACKAGE_MESA3D_NEEDS_XA),y)
...
#Gallium Drivers
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_CROCUS)   += crocus
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_ETNAVIV)  += etnaviv
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_FREEDRENO) += freedreno
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_I915)     += i915
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_IRIS)     += iris
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_LIMA)     += lima
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_NOUVEAU)  += nouveau
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_PANFROST) += panfrost
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_R300)     += r300
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_R600)     += r600
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_RADEONSI) += radeonsi
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_SVGA)     += svga
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_SWRAST)   += swrast
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_TEGRA)    += tegra
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_V3D)      += v3d
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_VC4)      += vc4
MESA3D_GALLIUM_DRIVERS-$(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER_VIRGL)    += virgl
# Vulkan Drivers
MESA3D_VULKAN_DRIVERS-$(LINGMO_PACKAGE_MESA3D_VULKAN_DRIVER_BROADCOM) += broadcom
MESA3D_VULKAN_DRIVERS-$(LINGMO_PACKAGE_MESA3D_VULKAN_DRIVER_INTEL)   += intel
MESA3D_VULKAN_DRIVERS-$(LINGMO_PACKAGE_MESA3D_VULKAN_DRIVER_SWRAST) += swrast

ifeq ($(LINGMO_PACKAGE_MESA3D_GALLIUM_DRIVER),)
MESA3D_CONF_OPTS += \
	-Dgallium-drivers= \
...
ifeq ($(LINGMO_PACKAGE_MESA3D_VULKAN_DRIVER),)
MESA3D_CONF_OPTS += \
	-Dvulkan-drivers=
else
...
ifeq ($(LINGMO_PACKAGE_MESA3D_OPENGL_GLX),y)
MESA3D_PROVIDES += $(if $(LINGMO_PACKAGE_LIBGLVND),,libgl)
else
...
ifeq ($(LINGMO_PACKAGE_MESA3D_NEEDS_X11),y)
MESA3D_DEPENDENCIES += \
	xlib_libX11 \
	xlib_libXext \
	xlib_libXdamage \
...
ifeq ($(LINGMO_PACKAGE_MESA3D_OPENGL_EGL),y)
MESA3D_PROVIDES += $(if $(LINGMO_PACKAGE_LIBGLVND),,libegl)
MESA3D_CONF_OPTS += \
	-Degl=enabled
else
MESA3D_CONF_OPTS += \
...
ifeq ($(LINGMO_PACKAGE_MESA3D_OPENGL_ES),y)
MESA3D_PROVIDES += $(if $(LINGMO_PACKAGE_LIBGLVND),,libgles)
...
ifeq ($(LINGMO_PACKAGE_MESA3D_VDPAU),y)
...
ifeq ($(LINGMO_PACKAGE_LIBGLVND),y)
ifneq ($(LINGMO_PACKAGE_MESA3D_OPENGL_GLX)$(LINGMO_PACKAGE_MESA3D_OPENGL_EGL),)
