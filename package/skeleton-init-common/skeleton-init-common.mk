...
define SKELETON_INIT_COMMON_INSTALL_TARGET_CMDS
	...
	$(SED) 's,@PATH@,$(LINGMO_SYSTEM_DEFAULT_PATH),' $(TARGET_DIR)/etc/profile
...
SKELETON_INIT_COMMON_HOSTNAME = $(call qstrip,$(LINGMO_TARGET_GENERIC_HOSTNAME))
SKELETON_INIT_COMMON_ISSUE = $(call qstrip,$(LINGMO_TARGET_GENERIC_ISSUE))
SKELETON_INIT_COMMON_ROOT_PASSWD = $(call qstrip,$(LINGMO_TARGET_GENERIC_ROOT_PASSWD))
SKELETON_INIT_COMMON_PASSWD_METHOD = $(call qstrip,$(LINGMO_TARGET_GENERIC_PASSWD_METHOD))
SKELETON_INIT_COMMON_BIN_SH = $(call qstrip,$(LINGMO_SYSTEM_BIN_SH))
...
ifeq ($(LINGMO_TARGET_ENABLE_ROOT_LOGIN),y)
...
else # !LINGMO_TARGET_ENABLE_ROOT_LOGIN
