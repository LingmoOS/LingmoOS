...
ifeq ($(LINGMO_KERNEL_HEADERS_AS_KERNEL),y)
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(LINGMO_LINUX_KERNEL_CUSTOM_TARBALL))
LINUX_HEADERS_CUSTOM_GIT = $(call qstrip,$(LINGMO_LINUX_KERNEL_CUSTOM_GIT))
LINUX_HEADERS_CUSTOM_HG = $(call qstrip,$(LINGMO_LINUX_KERNEL_CUSTOM_HG))
LINUX_HEADERS_CUSTOM_SVN = $(call qstrip,$(LINGMO_LINUX_KERNEL_CUSTOM_SVN))
LINUX_HEADERS_VERSION = $(call qstrip,$(LINGMO_LINUX_KERNEL_VERSION))
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call qstrip,$(LINGMO_LINUX_KERNEL_CUSTOM_TARBALL_LOCATION))
LINUX_HEADERS_REPO_URL = $(call qstrip,$(LINGMO_LINUX_KERNEL_CUSTOM_REPO_URL))
LINUX_HEADERS_CIP = $(LINGMO_LINUX_KERNEL_LATEST_CIP_VERSION)$(LINGMO_LINUX_KERNEL_LATEST_CIP_RT_VERSION)
ifneq ($(LINUX_HEADERS_OVERRIDE_SRCDIR),)
$(error LINUX_HEADERS_OVERRIDE_SRCDIR must not be set when LINGMO_KERNEL_HEADERS_AS_KERNEL=y)
endif
LINUX_HEADERS_OVERRIDE_SRCDIR = $(LINUX_OVERRIDE_SRCDIR)
else # ! LINGMO_KERNEL_HEADERS_AS_KERNEL
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(LINGMO_KERNEL_HEADERS_CUSTOM_TARBALL))
LINUX_HEADERS_CUSTOM_GIT = $(call qstrip,$(LINGMO_KERNEL_HEADERS_CUSTOM_GIT))
LINUX_HEADERS_CUSTOM_HG =
LINUX_HEADERS_CUSTOM_SVN =
LINUX_HEADERS_VERSION = $(call qstrip,$(LINGMO_DEFAULT_KERNEL_HEADERS))
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call qstrip,$(LINGMO_KERNEL_HEADERS_CUSTOM_TARBALL_LOCATION))
LINUX_HEADERS_REPO_URL = $(call qstrip,$(LINGMO_KERNEL_HEADERS_CUSTOM_REPO_URL))
LINUX_HEADERS_CIP =
endif # LINGMO_KERNEL_HEADERS_AS_KERNEL

ifeq ($(LINGMO_KERNEL_HEADERS_VERSION)$(BR_BUILDING),yy)
ifeq ($(LINUX_HEADERS_VERSION),)
$(error No kernel headers version set, check your LINGMO_DEFAULT_KERNEL_VERSION setting)
endif
endif
...
$(error No kernel headers tarball location set, check your LINGMO_KERNEL_HEADERS_CUSTOM_TARBALL_LOCATION setting)
endif
endif
...
LINUX_HEADERS_SITE = $(LINGMO_KERNEL_MIRROR)/linux/kernel/v2.6
else
LINUX_HEADERS_SITE = $(LINGMO_KERNEL_MIRROR)/linux/kernel/v$(firstword $(subst ., ,$(LINUX_HEADERS_VERSION))).x
endif # x2.6
...
# build.
ifeq ($(LINGMO_KERNEL_HEADERS_AS_KERNEL),y)
LINUX_HEADERS_PATCHES = $(call qstrip,$(LINGMO_LINUX_KERNEL_PATCH)) \
	$(wildcard $(addsuffix /linux,$(call qstrip,$(LINGMO_GLOBAL_PATCH_DIR))))
...
ifeq ($(LINGMO_KERNEL_HEADERS_VERSION)$(LINGMO_KERNEL_HEADERS_CUSTOM_TARBALL)$(LINGMO_KERNEL_HEADERS_CUSTOM_GIT),y)
...
ifeq ($(LINGMO_KERNEL_HEADERS_LATEST),y)
...
LINUX_HEADERS_DEPENDENCIES = $(LINGMO_MAKE_HOST_DEPENDENCY)
...
ifeq ($(LINGMO_KERNEL_HEADERS_VERSION)$(LINGMO_KERNEL_HEADERS_AS_KERNEL)$(LINGMO_KERNEL_HEADERS_CUSTOM_TARBALL)$(LINGMO_KERNEL_HEADERS_CUSTOM_GIT),y)
