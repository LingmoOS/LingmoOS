...
ifeq ($(LINGMO_PACKAGE_REFPOLICY_CUSTOM_GIT),y)
REFPOLICY_VERSION = $(call qstrip,$(LINGMO_PACKAGE_REFPOLICY_CUSTOM_REPO_VERSION))
REFPOLICY_SITE = $(call qstrip,$(LINGMO_PACKAGE_REFPOLICY_CUSTOM_REPO_URL))
...
REFPOLICY_POLICY_VERSION = $(LINGMO_PACKAGE_LIBSEPOL_POLICY_VERSION)
REFPOLICY_POLICY_STATE = \
	$(call qstrip,$(LINGMO_PACKAGE_REFPOLICY_POLICY_STATE))
...
REFPOLICY_EXTRA_MODULES_DIRS = \
	$(strip \
		$(call qstrip,$(LINGMO_REFPOLICY_EXTRA_MODULES_DIRS)) \
		$(PACKAGES_SELINUX_EXTRA_MODULES_DIRS))
$(foreach dir,$(REFPOLICY_EXTRA_MODULES_DIRS),\
	$(if $(wildcard $(dir)),,\
		$(error LINGMO_REFPOLICY_EXTRA_MODULES_DIRS contains nonexistent directory $(dir))))
...
REFPOLICY_MODULES = \
	...
	$(call qstrip,$(LINGMO_REFPOLICY_EXTRA_MODULES)) \
...
endif # LINGMO_PACKAGE_REFPOLICY_UPSTREAM_VERSION = y
