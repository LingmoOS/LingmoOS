...
ifneq ($(LINGMO_PACKAGE_DOCKER_ENGINE_DRIVER_BTRFS),y)
DOCKER_ENGINE_TAGS += exclude_graphdriver_btrfs
endif

ifeq ($(LINGMO_PACKAGE_DOCKER_ENGINE_DRIVER_DEVICEMAPPER),y)
DOCKER_ENGINE_DEPENDENCIES += lvm2
else
DOCKER_ENGINE_TAGS += exclude_graphdriver_devicemapper
endif

ifeq ($(LINGMO_PACKAGE_DOCKER_ENGINE_DRIVER_VFS),y)
...
ifeq ($(LINGMO_PACKAGE_DOCKER_ENGINE_DRIVER_BTRFS),y)
