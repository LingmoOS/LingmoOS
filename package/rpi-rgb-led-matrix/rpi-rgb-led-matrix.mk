...
ifeq ($(LINGMO_PACKAGE_RPI_RGB_LED_MATRIX_IMAGE_VIEWER),y)
...
ifeq ($(LINGMO_PACKAGE_RPI_RGB_LED_MATRIX_TEXT_SCROLLER),y)
...
ifeq ($(LINGMO_PACKAGE_RPI_RGB_LED_MATRIX_VIDEO_VIEWER),y)
