...
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43012) += \
	brcmfmac43012-sdio.bin \
	brcmfmac43012-sdio.1LV.clm_blob \
	brcmfmac43012-sdio.1LV.txt \
	CYW43012C0.1LV.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43340) += \
	brcmfmac43340-sdio.bin \
	brcmfmac43340-sdio.1BW.txt \
	CYW43341B0.1BW.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43362) += \
	brcmfmac43362-sdio.bin \
	brcmfmac43362-sdio.SN8000.txt
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW4339) += \
	brcmfmac4339-sdio.bin
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW4339_1CK) += \
	brcmfmac4339-sdio.1CK.txt
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW4339_ZP) += \
	brcmfmac4339-sdio.ZP.txt \
	CYW4335C0.ZP.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43430) += \
	brcmfmac43430-sdio.bin
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43430_1DX) += \
	brcmfmac43430-sdio.1DX.clm_blob \
	brcmfmac43430-sdio.1DX.txt \
	CYW43430A1.1DX.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43430_1FX) += \
	brcmfmac43430-sdio.1FX.clm_blob \
	brcmfmac43430-sdio.1FX.txt
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43430_1LN) += \
	brcmfmac43430-sdio.1LN.clm_blob \
	brcmfmac43430-sdio.1LN.txt
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43455) += \
	brcmfmac43455-sdio.bin
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43455_1HK) += \
	brcmfmac43455-sdio.1HK.clm_blob \
	brcmfmac43455-sdio.1HK.txt
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43455_1LC) += \
	brcmfmac43455-sdio.1LC.clm_blob \
	brcmfmac43455-sdio.1LC.txt
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW43455_1MW) += \
	brcmfmac43455-sdio.1MW.clm_blob \
	brcmfmac43455-sdio.1MW.txt \
	CYW4345C0.1MW.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW4354) += \
	brcmfmac4354-sdio.bin \
	brcmfmac4354-sdio.1BB.clm_blob \
	brcmfmac4354-sdio.1BB.txt \
	CYW4350C0.1BB.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW4356) += \
	brcmfmac4356-pcie.bin \
	brcmfmac4356-pcie.1CX.clm_blob \
	brcmfmac4356-pcie.1CX.txt \
	CYW4354A2.1CX.hcd
MURATA_CYW_FW_FILES_$(LINGMO_PACKAGE_MURATA_CYW_FW_CYW4359) += \
