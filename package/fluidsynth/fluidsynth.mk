...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_ALSA_LIB),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_DBUS),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_FLOATS),y)
FLUIDSYNTH_CONF_OPTS += -Denable-floats=1
else
FLUIDSYNTH_CONF_OPTS += -Denable-floats=0
endif

ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_JACK2),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_LIBSNDFILE),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_PORTAUDIO),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_PULSEAUDIO),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_READLINE),y)
...
ifeq ($(LINGMO_PACKAGE_FLUIDSYNTH_SDL2),y)
