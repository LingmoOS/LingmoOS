...
LIBIDN_VERSION = 1.41
LIBIDN_SITE = $(LINGMO_GNU_MIRROR)/libidn
LIBIDN_INSTALL_STAGING = YES
LIBIDN_CONF_ENV = EMACS="no" MAKEINFO=true
LIBIDN_CONF_OPTS = --disable-java --enable-csharp=no
LIBIDN_DEPENDENCIES = host-pkgconf $(TARGET_NLS_DEPENDENCIES) $(if $(LINGMO_PACKAGE_LIBICONV),libiconv)
...
ifneq ($(LINGMO_PACKAGE_LIBIDN_BINARY),y)
