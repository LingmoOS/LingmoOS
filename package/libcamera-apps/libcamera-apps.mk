...
ifeq ($(LINGMO_PACKAGE_FFMPEG)$(LINGMO_PACKAGE_LIBDRM),yy)
...
LIBCAMERA_APPS_DEPENDENCIES += \
	$(if $(LINGMO_PACKAGE_LIBEPOXY),libepoxy) \
	$(if $(LINGMO_PACKAGE_XLIB_LIBX11),xlib_libX11)
LIBCAMERA_APPS_CONF_OPTS += -DENABLE_X11=1
else
LIBCAMERA_APPS_CONF_OPTS += -DENABLE_X11=0
endif

ifeq ($(LINGMO_PACKAGE_QT5),y)
