...
BATMAN_ADV_MODULE_MAKE_OPTS = \
	...
	CONFIG_BATMAN_ADV_BATMAN_V=$(if $(LINGMO_PACKAGE_BATMAN_ADV_BATMAN_V),y,n) \
	CONFIG_BATMAN_ADV_DEBUG=$(if $(LINGMO_PACKAGE_BATMAN_ADV_DEBUG),y,n) \
	CONFIG_BATMAN_ADV_NC=$(if $(LINGMO_PACKAGE_BATMAN_ADV_NC),y,n)
