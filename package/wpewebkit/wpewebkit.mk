...
ifeq ($(LINGMO_PACKAGE_WPEWEBKIT_SANDBOX),y)
WPEWEBKIT_CONF_OPTS += \
...
ifeq ($(LINGMO_PACKAGE_WPEWEBKIT_MULTIMEDIA),y)
WPEWEBKIT_CONF_OPTS += \
	-DENABLE_VIDEO=ON \
...
ifeq ($(LINGMO_PACKAGE_WPEWEBKIT_MEDIA_STREAM),y)
...
ifeq ($(LINGMO_PACKAGE_WPEWEBKIT_USE_GSTREAMER_GL),y)
WPEWEBKIT_CONF_OPTS += -DUSE_GSTREAMER_GL=ON
else
WPEWEBKIT_CONF_OPTS += -DUSE_GSTREAMER_GL=OFF
endif

ifeq ($(LINGMO_PACKAGE_WPEWEBKIT_WEBDRIVER),y)
...
ifeq ($(LINGMO_PACKAGE_LIBBACKTRACE),y)
