...
HWDATA_FILES = \
	$(if $(LINGMO_PACKAGE_HWDATA_IAB_OUI_TXT),iab.txt oui.txt) \
	$(if $(LINGMO_PACKAGE_HWDATA_PCI_IDS),pci.ids) \
	$(if $(LINGMO_PACKAGE_HWDATA_PNP_IDS),pnp.ids) \
	$(if $(LINGMO_PACKAGE_HWDATA_USB_IDS),usb.ids)
