...
WGET_SITE = $(LINGMO_GNU_MIRROR)/wget
...
# LINGMO_ENABLE_LOCALE and LINGMO_PACKAGE_LIBICONV are mutually exclusive
ifeq ($(LINGMO_ENABLE_LOCALE)$(LINGMO_PACKAGE_LIBICONV)$(LINGMO_PACKAGE_LIBIDN2),yy)
