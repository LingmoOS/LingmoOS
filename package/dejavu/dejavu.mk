...
ifeq ($(LINGMO_PACKAGE_DEJAVU_MONO),y)
...
ifeq ($(LINGMO_PACKAGE_DEJAVU_SANS),y)
...
ifeq ($(LINGMO_PACKAGE_DEJAVU_SERIF),y)
...
ifeq ($(LINGMO_PACKAGE_DEJAVU_SANS_CONDENSED),y)
DEJAVU_FONTS_INSTALL += DejaVuSansCondensed*.ttf
endif

ifeq ($(LINGMO_PACKAGE_DEJAVU_SERIF_CONDENSED),y)
