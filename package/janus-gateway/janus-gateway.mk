...
JANUS_GATEWAY_DEPENDENCIES = host-pkgconf jansson libnice \
	...
	$(if $(LINGMO_PACKAGE_LIBOGG),libogg)
...
ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_DEMOS),)
...
ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_AUDIO_BRIDGE),y)
...
ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_DUKTAPE),y)
...
ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_RABBITMQ),y)
...
ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_REST),y)
...
ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_UNIX_SOCKETS),y)
JANUS_GATEWAY_CONF_OPTS += --enable-unix-sockets
else
JANUS_GATEWAY_CONF_OPTS += --disable-unix-sockets
endif

ifeq ($(LINGMO_PACKAGE_JANUS_GATEWAY_WEBSOCKETS),y)
