...
ifeq ($(LINGMO_PACKAGE_MPD_AVAHI_SUPPORT),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_ALSA),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_BZIP2),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_CDIO_PARANOIA),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_CURL),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_DSD),y)
MPD_CONF_OPTS += -Ddsd=true
else
MPD_CONF_OPTS += -Ddsd=false
endif

ifeq ($(LINGMO_PACKAGE_MPD_FAAD2),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_FFMPEG),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_FLAC),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_FLUIDSYNTH),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_HTTPD_OUTPUT),y)
MPD_CONF_OPTS += -Dhttpd=true
else
MPD_CONF_OPTS += -Dhttpd=false
endif

ifeq ($(LINGMO_PACKAGE_MPD_ID3TAG),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_IO_URING),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_JACK2),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LAME),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBMPDCLIENT),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBMMS),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBNFS),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBSMBCLIENT),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBSAMPLERATE),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBSNDFILE),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_LIBSOXR),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_MODPLUG),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_MPG123),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_MUSEPACK),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_NEIGHBOR_DISCOVERY_SUPPORT),y)
MPD_CONF_OPTS += -Dneighbor=true
else
MPD_CONF_OPTS += -Dneighbor=false
endif

ifeq ($(LINGMO_PACKAGE_MPD_OPENAL),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_OPUS),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_OSS),y)
MPD_CONF_OPTS += -Doss=enabled
else
MPD_CONF_OPTS += -Doss=disabled
endif

ifeq ($(LINGMO_PACKAGE_MPD_PULSEAUDIO),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_QOBUZ),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_SHOUTCAST),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_SIDPLAY),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_SOUNDCLOUD),y)
MPD_CONF_OPTS += -Dsoundcloud=enabled
else
MPD_CONF_OPTS += -Dsoundcloud=disabled
endif

ifeq ($(LINGMO_PACKAGE_MPD_SQLITE),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_TCP),y)
MPD_CONF_OPTS += -Dtcp=true
else
MPD_CONF_OPTS += -Dtcp=false
endif

ifeq ($(LINGMO_PACKAGE_MPD_TREMOR),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_TWOLAME),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_UPNP_PUPNP),y)
MPD_DEPENDENCIES += \
	libupnp
MPD_CONF_OPTS += -Dupnp=pupnp
else ifeq ($(LINGMO_PACKAGE_MPD_UPNP_NPUPNP),y)
MPD_DEPENDENCIES += \
	libnpupnp
MPD_CONF_OPTS += -Dupnp=npupnp
else ifeq ($(LINGMO_PACKAGE_MPD_UPNP_DISABLED),y)
MPD_CONF_OPTS += -Dupnp=disabled
endif

ifeq ($(LINGMO_PACKAGE_MPD_VORBIS),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_WAVPACK),y)
...
ifeq ($(LINGMO_PACKAGE_MPD_ZZIP),y)
