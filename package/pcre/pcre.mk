...
PCRE_CONF_OPTS += $(if $(LINGMO_PACKAGE_PCRE_16),--enable-pcre16,--disable-pcre16)
PCRE_CONF_OPTS += $(if $(LINGMO_PACKAGE_PCRE_32),--enable-pcre32,--disable-pcre32)
PCRE_CONF_OPTS += $(if $(LINGMO_PACKAGE_PCRE_UTF),--enable-utf,--disable-utf)
PCRE_CONF_OPTS += $(if $(LINGMO_PACKAGE_PCRE_UCP),--enable-unicode-properties,--disable-unicode-properties)
