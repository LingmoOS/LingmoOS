...
# x86 optimization options. While we have a LINGMO_X86_CPU_HAS_AVX512, it
# is not clear yet how it maps to all the avx512* options of Qt, so we
# for now keeps them disabled.
QT6BASE_CONF_OPTS += \
	-DFEATURE_sse2=$(if $(LINGMO_X86_CPU_HAS_SSE2),ON,OFF) \
	-DFEATURE_sse3=$(if $(LINGMO_X86_CPU_HAS_SSE3),ON,OFF) \
	-DFEATURE_sse4_1=$(if $(LINGMO_X86_CPU_HAS_SSE4),ON,OFF) \
	-DFEATURE_sse4_2=$(if $(LINGMO_X86_CPU_HAS_SSE42),ON,OFF) \
	-DFEATURE_ssse3=$(if $(LINGMO_X86_CPU_HAS_SSSE3),ON,OFF) \
	-DFEATURE_avx=$(if $(LINGMO_X86_CPU_HAS_AVX),ON,OFF) \
	-DFEATURE_avx2=$(if $(LINGMO_X86_CPU_HAS_AVX2),ON,OFF) \
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_GUI),y)
QT6BASE_CONF_OPTS += \
	-DFEATURE_gui=ON \
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_VULKAN),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_HARFBUZZ),y)
...
else #LINGMO_TOOLCHAIN_HAS_SYNC_4
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_PNG),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_GIF),y)
QT6BASE_CONF_OPTS += -DFEATURE_gif=ON
else
QT6BASE_CONF_OPTS += -DFEATURE_gif=OFF
endif

ifeq ($(LINGMO_PACKAGE_QT6BASE_JPEG),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_PRINTSUPPORT),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_FONTCONFIG),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_WIDGETS),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_TSLIB),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_EGLFS),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_OPENGL_DESKTOP),y)
QT6BASE_CONF_OPTS += \
	-DFEATURE_opengl=ON \
	-DFEATURE_opengl_desktop=ON
QT6BASE_DEPENDENCIES += libgl
else ifeq ($(LINGMO_PACKAGE_QT6BASE_OPENGL_ES2),y)
QT6BASE_CONF_OPTS += \
	-DFEATURE_opengl=ON \
...
QT6BASE_DEFAULT_QPA = $(call qstrip,$(LINGMO_PACKAGE_QT6BASE_DEFAULT_QPA))
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_CONCURRENT),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_DBUS),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_NETWORK),y)
...
# Qt6 SQL Plugins
ifeq ($(LINGMO_PACKAGE_QT6BASE_SQL),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_MYSQL),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_PSQL),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_SQLITE),y)
...
ifeq ($(LINGMO_PACKAGE_QT6BASE_SYSLOG),y)
