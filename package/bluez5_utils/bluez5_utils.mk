...
BLUEZ5_UTILS_SITE = $(LINGMO_KERNEL_MIRROR)/linux/bluetooth
...
BLUEZ5_UTILS_DEPENDENCIES = \
	$(if $(LINGMO_PACKAGE_BLUEZ5_UTILS_HEADERS),bluez5_utils-headers) \
	dbus \
	libglib2
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_OBEX),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_CLIENT),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_MONITOR),y)
BLUEZ5_UTILS_CONF_OPTS += --enable-monitor
else
BLUEZ5_UTILS_CONF_OPTS += --disable-monitor
endif

ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_TOOLS),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_EXPERIMENTAL),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_AUDIO),y)
BLUEZ5_UTILS_CONF_OPTS += \
	--enable-a2dp \
	--enable-avrcp \
	--enable-bap \
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_HEALTH),y)
...
# enable hid plugin
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_HID),y)
...
# enable hog plugin
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_HOG),y)
...
# enable mesh profile
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_MESH),y)
...
# enable midi profile
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_MIDI),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_NETWORK),y)
...
# enable nfc plugin
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_NFC),y)
...
# enable sap plugin
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_SAP),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_PLUGINS_SIXAXIS),y)
BLUEZ5_UTILS_CONF_OPTS += --enable-sixaxis
else
BLUEZ5_UTILS_CONF_OPTS += --disable-sixaxis
endif

ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_DEPRECATED),y)
...
# enable test
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_TEST),y)
...
# enable hid2hci tool
ifeq ($(LINGMO_PACKAGE_BLUEZ5_UTILS_TOOLS_HID2HCI),y)
