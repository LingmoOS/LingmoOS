...
ifeq ($(LINGMO_PACKAGE_FREESCALE_IMX_PLATFORM_IMX8X),y)
...
endef
else ifeq ($(LINGMO_PACKAGE_FREESCALE_IMX_PLATFORM_IMX8DXL),y)
define IMX_SC_FIRMWARE_INSTALL_IMAGES_CMDS
	cp $(@D)/mx8dxl-evk-scfw-tcm.bin $(BINARIES_DIR)/
endef
else ifeq ($(LINGMO_PACKAGE_FREESCALE_IMX_PLATFORM_IMX8),y)
define IMX_SC_FIRMWARE_INSTALL_IMAGES_CMDS
