...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_BLUETOOTH),y)
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_EXAMPLES),y)
SCONESERVER_CONF_OPTS += -DWITH_EXAMPLES=ON
else
SCONESERVER_CONF_OPTS += -DWITH_EXAMPLES=OFF
endif

ifeq ($(LINGMO_PACKAGE_SCONESERVER_HTTP_SCONESITE),y)
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_LOCATION),y)
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_MATHS),y)
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_MYSQL),y)
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_RSS),y)
SCONESERVER_DEPENDENCIES += libxml2
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_SQLITE),y)
...
ifeq ($(LINGMO_PACKAGE_SCONESERVER_TESTBUILDER),y)
