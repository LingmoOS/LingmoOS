...
CIVETWEB_CONF_OPTS = TARGET_OS=LINUX WITH_IPV6=1 \
	$(if $(LINGMO_INSTALL_LIBSTDCPP),WITH_CPP=1)
...
else ifeq ($(LINGMO_PACKAGE_LUA):$(LINGMO_STATIC_LIBS),y:)
...
ifeq ($(LINGMO_PACKAGE_CIVETWEB_SERVER),y)
...
endif # LINGMO_PACKAGE_CIVETWEB_LIB
