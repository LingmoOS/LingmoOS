...
ifeq ($(LINGMO_KERNEL_64_USERLAND_32),y)
EBTABLES_CONF_OPTS += --enable-kernel-64-userland-32
endif

ifeq ($(LINGMO_PACKAGE_EBTABLES_UTILS_SAVE),y)
...
# selected
ifeq ($(LINGMO_PACKAGE_EBTABLES_UTILS_RESTORE),)
...
ifeq ($(LINGMO_PACKAGE_IPTABLES_NFTABLES),)
