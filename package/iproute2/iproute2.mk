...
IPROUTE2_SITE = $(LINGMO_KERNEL_MIRROR)/linux/utils/net/iproute2
IPROUTE2_DEPENDENCIES = host-bison host-flex host-pkgconf \
	$(if $(LINGMO_PACKAGE_LIBMNL),libmnl)
...
ifeq ($(LINGMO_PACKAGE_IPTABLES)x$(LINGMO_STATIC_LIBS),yx)
...
ifeq ($(LINGMO_PACKAGE_BERKELEYDB_COMPAT185),y)
IPROUTE2_DEPENDENCIES += berkeleydb
endif

ifeq ($(LINGMO_PACKAGE_LIBBPF),y)
...
define IPROUTE2_BUILD_CMDS
	$(TARGET_MAKE_ENV) LDFLAGS="$(TARGET_LDFLAGS)" \
		...
		SHARED_LIBS="$(if $(LINGMO_STATIC_LIBS),n,y)" -C $(@D)
endef
