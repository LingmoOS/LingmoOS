...
ifeq ($(LINGMO_PACKAGE_ALSA_PLUGINS),y)
BLUEZ_ALSA_DEPENDENCIES += alsa-plugins
endif

ifeq ($(LINGMO_PACKAGE_FDK_AAC),y)
...
ifeq ($(LINGMO_PACKAGE_BLUEZ_ALSA_RFCOMM),y)
...
ifeq ($(LINGMO_PACKAGE_LIBOPENAPTX),y)
