...
DNSMASQ_I18N = $(if $(LINGMO_SYSTEM_ENABLE_NLS),-i18n)

ifneq ($(LINGMO_PACKAGE_DNSMASQ_DHCP),y)
DNSMASQ_COPTS += -DNO_DHCP
endif

ifeq ($(LINGMO_PACKAGE_DNSMASQ_DNSSEC),y)
DNSMASQ_DEPENDENCIES += gmp nettle
DNSMASQ_COPTS += -DHAVE_DNSSEC
endif

ifneq ($(LINGMO_PACKAGE_DNSMASQ_TFTP),y)
DNSMASQ_COPTS += -DNO_TFTP
endif

ifeq ($(LINGMO_PACKAGE_DNSMASQ_IDN),y)
...
ifeq ($(LINGMO_PACKAGE_DNSMASQ_CONNTRACK),y)
DNSMASQ_DEPENDENCIES += libnetfilter_conntrack
DNSMASQ_COPTS += -DHAVE_CONNTRACK
endif

ifeq ($(LINGMO_PACKAGE_DNSMASQ_LUA),y)
