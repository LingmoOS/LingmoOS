...
ifneq ($(LINGMO_PACKAGE_LINUXCONSOLETOOLS_INPUTATTACH),y)
LINUXCONSOLETOOLS_MAKE_OPTS += DISABLE_INPUTATTACH=1
endif

ifneq ($(LINGMO_PACKAGE_LINUXCONSOLETOOLS_JOYSTICK),y)
LINUXCONSOLETOOLS_MAKE_OPTS += DISABLE_JOYSTICK=1
endif

ifneq ($(LINGMO_PACKAGE_LINUXCONSOLETOOLS_FORCEFEEDBACK),y)
