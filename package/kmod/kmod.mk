...
KMOD_SITE = $(LINGMO_KERNEL_MIRROR)/linux/utils/kernel/kmod
...
ifeq ($(LINGMO_PACKAGE_KMOD_TOOLS),y)
...
ifeq ($(LINGMO_PACKAGE_HOST_KMOD_GZ),y)
...
ifeq ($(LINGMO_PACKAGE_HOST_KMOD_ZSTD),y)
...
ifeq ($(LINGMO_PACKAGE_HOST_KMOD_XZ),y)
