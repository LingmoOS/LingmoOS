...
ifeq ($(LINGMO_PACKAGE_WIRESHARK_GUI),y)
...
ifeq ($(LINGMO_PACKAGE_MINIZIP_ZLIB),y)
...
# LINGMO_SHARED_STATIC_LIBS=y case, we want ENABLE_STATIC=OFF even if
