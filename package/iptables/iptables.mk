...
IPTABLES_CONF_OPTS = --libexecdir=/usr/lib --with-kernel=$(STAGING_DIR)/usr \
	$(if $(LINGMO_STATIC_LIBS),,--disable-static)

# For connlabel match
ifeq ($(LINGMO_PACKAGE_LIBNETFILTER_CONNTRACK),y)
IPTABLES_DEPENDENCIES += libnetfilter_conntrack
endif

# For nfnl_osf
ifeq ($(LINGMO_PACKAGE_LIBNFNETLINK),y)
IPTABLES_DEPENDENCIES += libnfnetlink
endif

# For iptables-compat tools
ifeq ($(LINGMO_PACKAGE_IPTABLES_NFTABLES),y)
...
ifeq ($(LINGMO_PACKAGE_IPTABLES_BPF_NFSYNPROXY),y)
