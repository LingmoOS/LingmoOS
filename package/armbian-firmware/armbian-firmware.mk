...
ifeq ($(LINGMO_PACKAGE_ARMBIAN_FIRMWARE_AP6212),y)
ARMBIAN_FIRMWARE_DIRS += ap6212
endif

# AP6256 WiFi/BT combo firmware
ifeq ($(LINGMO_PACKAGE_ARMBIAN_FIRMWARE_AP6256),y)
...
ifeq ($(LINGMO_PACKAGE_ARMBIAN_FIRMWARE_AP6255),y)
ARMBIAN_FIRMWARE_FILES += \
	BCM4345C0.hcd \
...
ifeq ($(LINGMO_PACKAGE_ARMBIAN_FIRMWARE_RTL8822CS),y)
ARMBIAN_FIRMWARE_FILES += \
...
# XR819 WiFi firmware
ifeq ($(LINGMO_PACKAGE_ARMBIAN_FIRMWARE_XR819),y)
ARMBIAN_FIRMWARE_FILES += \
