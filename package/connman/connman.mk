...
CONNMAN_SITE = $(LINGMO_KERNEL_MIRROR)/linux/network/connman
...
ifeq ($(LINGMO_PACKAGE_CONNMAN_OFONO),y)
...
ifeq ($(LINGMO_PACKAGE_CONNMAN_WISPR),y)
...
ifeq ($(LINGMO_PACKAGE_CONNMAN_CLIENT),y)
