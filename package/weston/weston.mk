...
ifeq ($(LINGMO_PACKAGE_WESTON_SIMPLE_CLIENTS),y)
...
ifeq ($(LINGMO_TOOLCHAIN_HEADERS_AT_LEAST_3_8),y)
# dmabuf-v4l uses VIDIOC_EXPBUF, only available from 3.8+
WESTON_SIMPLE_CLIENTS += dmabuf-v4l
endif
endif # LINGMO_PACKAGE_WESTON_SIMPLE_CLIENTS
...
ifeq ($(LINGMO_PACKAGE_HAS_LIBEGL_WAYLAND)$(LINGMO_PACKAGE_HAS_LIBGBM)$(LINGMO_PACKAGE_HAS_LIBGLES),yyy)
WESTON_CONF_OPTS += -Drenderer-gl=true
WESTON_DEPENDENCIES += libegl libgbm libgles
ifeq ($(LINGMO_PACKAGE_WESTON_SIMPLE_CLIENTS),y)
WESTON_SIMPLE_CLIENTS += dmabuf-egl dmabuf-feedback egl
endif
ifeq ($(LINGMO_PACKAGE_PIPEWIRE)$(LINGMO_PACKAGE_WESTON_DRM),yy)
...
ifeq ($(LINGMO_PACKAGE_WESTON_RDP),y)
...
WESTON_CONF_OPTS += -Dbackend-default=$(call qstrip,$(LINGMO_PACKAGE_WESTON_DEFAULT_COMPOSITOR))

ifeq ($(LINGMO_PACKAGE_WESTON_XWAYLAND),y)
