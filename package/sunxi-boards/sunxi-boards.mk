...
SUNXI_BOARDS_FEX_FILE = $(call qstrip,$(LINGMO_PACKAGE_SUNXI_BOARDS_FEX_FILE))
...
ifeq ($(LINGMO_PACKAGE_SUNXI_BOARDS)$(BR_BUILDING),yy)
# we NEED a board name
ifeq ($(SUNXI_BOARDS_FEX_FILE),)
$(error No sunxi .fex file specified. Check your LINGMO_PACKAGE_SUNXI_BOARDS_FEX_FILE settings)
endif
endif
