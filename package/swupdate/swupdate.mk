...
ifeq ($(LINGMO_PACKAGE_LIBCONFIG),y)
...
ifeq ($(LINGMO_PACKAGE_HAS_LUAINTERPRETER),y)
SWUPDATE_DEPENDENCIES += luainterpreter host-pkgconf
# defines the base name for the pkg-config file ("lua" or "luajit")
define SWUPDATE_SET_LUA_VERSION
	$(call KCONFIG_SET_OPT,CONFIG_LUAPKG,$(LINGMO_PACKAGE_PROVIDES_LUAINTERPRETER))
endef
...
ifeq ($(LINGMO_PACKAGE_LIBRSYNC),y)
...
ifeq ($(LINGMO_PACKAGE_SWUPDATE_WEBSERVER),y)
...
SWUPDATE_KCONFIG_FILE = $(call qstrip,$(LINGMO_PACKAGE_SWUPDATE_CONFIG))
SWUPDATE_KCONFIG_EDITORS = menuconfig xconfig gconfig nconfig

SWUPDATE_MAKE_OPTS = \
	SWU_VER="$(SWUPDATE_VERSION) (Buildroot $(LINGMO_VERSION_FULL))" \
...
define SWUPDATE_INSTALL_TARGET_CMDS
	...
	$(if $(LINGMO_PACKAGE_SWUPDATE_INSTALL_WEBSITE), \
...
ifeq ($(LINGMO_PACKAGE_SWUPDATE)$(BR_BUILDING),yy)
ifeq ($(call qstrip,$(LINGMO_PACKAGE_SWUPDATE_CONFIG)),)
$(error No Swupdate configuration file specified, check your LINGMO_PACKAGE_SWUPDATE_CONFIG setting)
endif
endif
...
define SWUPDATE_INSTALL_COMMON
	...
	$(if $(LINGMO_PACKAGE_SWUPDATE_WEBSERVER), \
...
define SWUPDATE_INSTALL_INIT_SYSTEMD
	...
	$(if $(LINGMO_PACKAGE_SWUPDATE_USB), \
