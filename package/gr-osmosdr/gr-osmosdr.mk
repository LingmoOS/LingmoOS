...
ifeq ($(LINGMO_PACKAGE_GR_OSMOSDR_IQFILE),y)
GR_OSMOSDR_CONF_OPTS += -DENABLE_FILE=ON
else
GR_OSMOSDR_CONF_OPTS += -DENABLE_FILE=OFF
endif

ifeq ($(LINGMO_PACKAGE_GR_OSMOSDR_RTLSDR),y)
