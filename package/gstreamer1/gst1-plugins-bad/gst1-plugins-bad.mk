...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_WAYLAND),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_BLUEZ),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_MPEGTSMUX),y)
GST1_PLUGINS_BAD_CONF_OPTS += -Dmpegtsmux=enabled
else
GST1_PLUGINS_BAD_CONF_OPTS += -Dmpegtsmux=disabled
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_MPEGTSDEMUX),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_AES),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_ASSRENDER),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_BZ2),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_CURL),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_DASH),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_DECKLINK),y)
GST1_PLUGINS_BAD_CONF_OPTS += -Ddecklink=enabled
else
GST1_PLUGINS_BAD_CONF_OPTS += -Ddecklink=disabled
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_DIRECTFB),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_DVB),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_FAAD),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_FBDEV),y)
GST1_PLUGINS_BAD_CONF_OPTS += -Dfbdev=enabled
else
GST1_PLUGINS_BAD_CONF_OPTS += -Dfbdev=disabled
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_FDK_AAC),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_FLUIDSYNTH),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_GL),y)
GST1_PLUGINS_BAD_CONF_OPTS += -Dgl=enabled
else
GST1_PLUGINS_BAD_CONF_OPTS += -Dgl=disabled
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_HLS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_KMS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_DTLS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_TTML),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_MPEG2ENC),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_MUSEPACK),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_NEON),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_OPENAL),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_OPENH264),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_OPENJPEG),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_OPUS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_QROVERLAY),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_RSVG),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_SBC),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_SCTP),y)
GST1_PLUGINS_BAD_CONF_OPTS += \
	-Dsctp=enabled \
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_SHM),y)
GST1_PLUGINS_BAD_CONF_OPTS += -Dshm=enabled
else
GST1_PLUGINS_BAD_CONF_OPTS += -Dshm=disabled
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_SNDFILE),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_SRTP),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_UVCH264),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_VA),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_VOAACENC),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_WEBP),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_WEBRTC),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_WEBRTCDSP),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_WPE),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_V4L2CODECS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_X265),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_ZBAR),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BAD_ZXING),y)
