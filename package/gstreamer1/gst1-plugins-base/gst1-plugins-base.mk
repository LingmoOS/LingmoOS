...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_INSTALL_TOOLS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_HAS_API)$(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_HAS_PLATFORM)$(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_HAS_WINDOW),yyy)
GST1_PLUGINS_BASE_CONF_OPTS += -Dgl=enabled
else
GST1_PLUGINS_BASE_CONF_OPTS += -Dgl=disabled
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_OPENGL),y)
GST1_PLUGINS_BASE_GL_API_LIST = opengl
GST1_PLUGINS_BASE_DEPENDENCIES += libgl libglu
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_GLES2),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_GLX),y)
GST1_PLUGINS_BASE_GL_PLATFORM_LIST += glx
GST1_PLUGINS_BASE_DEPENDENCIES += xorgproto xlib_libXrender
endif

ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_EGL),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_ALSA),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_TREMOR),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_OPUS),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_OGG),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_PANGO),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_THEORA),y)
...
ifeq ($(LINGMO_PACKAGE_GST1_PLUGINS_BASE_PLUGIN_VORBIS),y)
