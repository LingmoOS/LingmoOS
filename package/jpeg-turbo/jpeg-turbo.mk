...
ifeq ($(LINGMO_PACKAGE_JPEG_SIMD_SUPPORT),y)
JPEG_TURBO_CONF_OPTS += -DWITH_SIMD=ON
# x86 simd support needs nasm
JPEG_TURBO_DEPENDENCIES += $(if $(LINGMO_X86_CPU_HAS_MMX),host-nasm)
else
...
# This allow to avoid link issues with LINGMO_SSP_ALL:
...
ifeq ($(LINGMO_PACKAGE_JPEG_TURBO_TOOLS),)
