...
ifeq ($(LINGMO_PACKAGE_MINETEST_CLIENT),y)
...
ifeq ($(LINGMO_PACKAGE_MINETEST_SERVER),y)
MINETEST_CONF_OPTS += -DBUILD_SERVER=ON
else
MINETEST_CONF_OPTS += -DBUILD_SERVER=OFF
endif

ifeq ($(LINGMO_PACKAGE_MINETEST_SOUND),y)
...
ifeq ($(LINGMO_PACKAGE_LIBSPATIALINDEX),y)
