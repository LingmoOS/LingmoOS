...
UCLIBC_CONFIG_FILE = $(call qstrip,$(LINGMO_UCLIBC_CONFIG))
endif

UCLIBC_KCONFIG_EDITORS = menuconfig nconfig
UCLIBC_KCONFIG_FILE = $(UCLIBC_CONFIG_FILE)
UCLIBC_KCONFIG_FRAGMENT_FILES = $(call qstrip,$(LINGMO_UCLIBC_CONFIG_FRAGMENT_FILES))
...
UCLIBC_TARGET_ARCH = $(call qstrip,$(LINGMO_UCLIBC_TARGET_ARCH))

UCLIBC_GENERATE_LOCALES = $(call qstrip,$(LINGMO_GENERATE_LOCALE))
...
ifeq ($(LINGMO_BINFMT_FLAT_SHARED),y)
define UCLIBC_BINFMT_CONFIG
...
UCLIBC_ARM64_PAGE_SIZE = CONFIG_AARCH64_PAGE_SIZE_$(call qstrip,$(LINGMO_ARM64_PAGE_SIZE))
...
ifeq ($(LINGMO_ARM_INSTRUCTIONS_THUMB2):$(LINGMO_ARM_CPU_HAS_ARM),y:)
...
UCLIBC_MIPS_ABI = CONFIG_MIPS_$(call qstrip,$(LINGMO_UCLIBC_MIPS_ABI))_ABI
define UCLIBC_MIPS_ABI_CONFIG
	$(SED) '/CONFIG_MIPS_[NO].._ABI/d' $(@D)/.config
	$(call KCONFIG_ENABLE_OPT,$(UCLIBC_MIPS_ABI))
endef

UCLIBC_MIPS_NAN = CONFIG_MIPS_NAN_$(call qstrip,$(LINGMO_UCLIBC_MIPS_NAN))
...
UCLIBC_SH_TYPE = CONFIG_$(call qstrip,$(LINGMO_UCLIBC_SH_TYPE))
...
UCLIBC_SPARC_TYPE = CONFIG_SPARC_$(call qstrip,$(LINGMO_UCLIBC_SPARC_TYPE))
...
UCLIBC_POWERPC_TYPE = CONFIG_$(call qstrip,$(LINGMO_UCLIBC_POWERPC_TYPE))
...
UCLIBC_X86_TYPE = CONFIG_$(call qstrip,$(LINGMO_UCLIBC_X86_TYPE))
...
# SSP
#
ifeq ($(LINGMO_TOOLCHAIN_BUILDROOT_USE_SSP),y)
...
ifeq ($(LINGMO_TOOLCHAIN_BUILDROOT_LOCALE),y)
...
ifeq ($(LINGMO_TOOLCHAIN_BUILDROOT_WCHAR),y)
...
ifeq ($(LINGMO_UCLIBC_INSTALL_UTILS),y)
...
ifeq ($(LINGMO_PACKAGE_UCLIBC)$(BR_BUILDING),yy)
ifeq ($(call qstrip,$(LINGMO_UCLIBC_CONFIG)),)
$(error No uClibc configuration file specified, check your LINGMO_UCLIBC_CONFIG setting)
endif
endif
