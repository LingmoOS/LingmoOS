...
ifeq ($(LINGMO_PACKAGE_FFTW_FAST),y)
...
FFTW_COMMON_CONF_OPTS += $(if $(LINGMO_TOOLCHAIN_HAS_OPENMP),--without,--with)-combined-threads
else
FFTW_COMMON_CONF_OPTS += --disable-threads
endif
FFTW_COMMON_CONF_OPTS += $(if $(LINGMO_TOOLCHAIN_HAS_OPENMP),--enable,--disable)-openmp
