...
RSH_REDONE_BINS-y =
RSH_REDONE_BINS-$(LINGMO_PACKAGE_RSH_REDONE_RLOGIN) += rlogin
RSH_REDONE_BINS-$(LINGMO_PACKAGE_RSH_REDONE_RSH) += rsh
RSH_REDONE_SBINS-y =
RSH_REDONE_SBINS-$(LINGMO_PACKAGE_RSH_REDONE_RLOGIND) += in.rlogind
RSH_REDONE_SBINS-$(LINGMO_PACKAGE_RSH_REDONE_RSHD) += in.rshd

RSH_REDONE_MAKE_FLAGS = \
	BIN="$(RSH_REDONE_BINS-y)" SBIN="$(RSH_REDONE_SBINS-y)"

ifneq ($(LINGMO_PACKAGE_RSH_REDONE_RSHD)$(LINGMO_PACKAGE_RSH_REDONE_RLOGIND),)
