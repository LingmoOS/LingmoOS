...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_NL80211),y)
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_WIRED),y)
WPA_SUPPLICANT_DEPENDENCIES += host-pkgconf libnl
WPA_SUPPLICANT_CONFIG_ENABLE += \
	CONFIG_LIBNL32 \
	CONFIG_DRIVER_WIRED \
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_HOTSPOT),)
WPA_SUPPLICANT_CONFIG_DISABLE += \
	CONFIG_HS20 \
	CONFIG_INTERWORKING
endif

ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_AP_SUPPORT),y)
WPA_SUPPLICANT_CONFIG_ENABLE += \
	CONFIG_AP \
	CONFIG_P2P
else
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_AUTOSCAN),y)
WPA_SUPPLICANT_CONFIG_ENABLE += \
	CONFIG_AUTOSCAN_EXPONENTIAL \
	CONFIG_AUTOSCAN_PERIODIC
endif

ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_WPS),)
WPA_SUPPLICANT_CONFIG_DISABLE += CONFIG_WPS
endif

ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_WPA3),y)
WPA_SUPPLICANT_CONFIG_ENABLE += \
	CONFIG_DPP \
	CONFIG_SAE \
	CONFIG_SAE_PK \
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_CTRL_IFACE),)
WPA_SUPPLICANT_CONFIG_DISABLE += CONFIG_CTRL_IFACE\>
endif

ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_DBUS),y)
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_DBUS_INTROSPECTION),y)
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_DEBUG_SYSLOG),)
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_CLI),y)
...
ifeq ($(LINGMO_PACKAGE_WPA_SUPPLICANT_PASSPHRASE),y)
...
ifeq ($(LINGMO_PACKAGE_IFUPDOWN_SCRIPTS),y)
