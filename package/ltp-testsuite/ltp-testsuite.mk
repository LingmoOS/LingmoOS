...
ifeq ($(LINGMO_PACKAGE_LTP_TESTSUITE_OPEN_POSIX),y)
LTP_TESTSUITE_CONF_OPTS += --with-open-posix-testsuite
endif

ifeq ($(LINGMO_PACKAGE_LTP_TESTSUITE_REALTIME),y)
...
ifeq ($(LINGMO_PACKAGE_LIBCAP)$(LINGMO_PACKAGE_ATTR),yy)
...
LTP_TESTSUITE_UNSUPPORTED_TEST_CASES_$(LINGMO_TOOLCHAIN_USES_UCLIBC) += \
	testcases/misc/math/float/bessel/ \
	testcases/misc/math/float/float_bessel.c

LTP_TESTSUITE_UNSUPPORTED_TEST_CASES_$(LINGMO_TOOLCHAIN_USES_MUSL) += \
...
LTP_TESTSUITE_UNSUPPORTED_TEST_CASES_$(LINGMO_STATIC_LIBS) += \
