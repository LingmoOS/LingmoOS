...
ifneq ($(LINGMO_PACKAGE_CONTAINERD_DRIVER_BTRFS),y)
CONTAINERD_TAGS += no_btrfs
endif

ifneq ($(LINGMO_PACKAGE_CONTAINERD_DRIVER_DEVMAPPER),y)
CONTAINERD_TAGS += no_devmapper
endif

ifneq ($(LINGMO_PACKAGE_CONTAINERD_DRIVER_ZFS),y)
CONTAINERD_TAGS += no_zfs
endif

ifneq ($(LINGMO_PACKAGE_CONTAINERD_CRI),y)
