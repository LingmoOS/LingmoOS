...
ifeq ($(LINGMO_PACKAGE_MIMIC_AUDIO_BACKEND_ALSA),y)
MIMIC_AUDIO_BACKEND = alsa
MIMIC_DEPENDENCIES += alsa-lib
else ifeq ($(LINGMO_PACKAGE_MIMIC_AUDIO_BACKEND_PORTAUDIO),y)
MIMIC_AUDIO_BACKEND = portaudio
MIMIC_DEPENDENCIES += portaudio
else ifeq ($(LINGMO_PACKAGE_MIMIC_AUDIO_BACKEND_PULSEAUDIO),y)
MIMIC_AUDIO_BACKEND = pulseaudio
MIMIC_DEPENDENCIES += pulseaudio
else ifeq ($(LINGMO_PACKAGE_MIMIC_AUDIO_BACKEND_NONE),y)
