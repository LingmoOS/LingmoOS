...
ifeq ($(LINGMO_PACKAGE_LIBARCHIVE_BSDTAR),y)
...
ifeq ($(LINGMO_PACKAGE_LIBARCHIVE_BSDCPIO),y)
ifeq ($(LINGMO_STATIC_LIBS),y)
...
ifeq ($(LINGMO_PACKAGE_LIBARCHIVE_BSDCAT),y)
ifeq ($(LINGMO_STATIC_LIBS),y)
...
ifeq ($(LINGMO_TOOLCHAIN_HAS_THREADS)$(LINGMO_PACKAGE_XZ),yy)
