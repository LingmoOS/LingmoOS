...
ifeq ($(LINGMO_PACKAGE_LIBDRM_INTEL),y)
...
ifeq ($(LINGMO_PACKAGE_LIBDRM_INSTALL_TESTS),y)
LIBDRM_CONF_OPTS += -Dtests=true -Dinstall-test-programs=true
ifeq ($(LINGMO_PACKAGE_CUNIT),y)
