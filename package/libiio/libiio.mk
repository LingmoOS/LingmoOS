...
LIBIIO_CONF_OPTS = -DENABLE_IPV6=ON \
	-DWITH_LOCAL_BACKEND=$(if $(LINGMO_PACKAGE_LIBIIO_LOCAL_BACKEND),ON,OFF) \
	-DWITH_NETWORK_BACKEND=$(if $(LINGMO_PACKAGE_LIBIIO_NETWORK_BACKEND),ON,OFF) \
	-DINSTALL_UDEV_RULE=$(if $(LINGMO_PACKAGE_HAS_UDEV),ON,OFF) \
	-DWITH_TESTS=$(if $(LINGMO_PACKAGE_LIBIIO_TESTS),ON,OFF) \
	-DWITH_DOC=OFF
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_XML_BACKEND),y)
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_USB_BACKEND),y)
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_SERIAL_BACKEND),y)
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_IIOD),y)
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_IIOD_USBD),y)
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_BINDINGS_PYTHON),y)
...
ifeq ($(LINGMO_PACKAGE_LIBIIO_BINDINGS_CSHARP),y)
