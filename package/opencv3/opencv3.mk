...
OPENCV3_CONF_OPTS += \
	...
	-DBUILD_DOCS=OFF \
	-DBUILD_PERF_TESTS=$(if $(LINGMO_PACKAGE_OPENCV3_BUILD_PERF_TESTS),ON,OFF) \
	-DBUILD_TESTS=$(if $(LINGMO_PACKAGE_OPENCV3_BUILD_TESTS),ON,OFF) \
	-DBUILD_WITH_DEBUG_INFO=OFF \
	-DDOWNLOAD_EXTERNAL_TEST_DATA=OFF \
	-DOPENCV_ENABLE_PKG_CONFIG=ON

ifeq ($(LINGMO_PACKAGE_OPENCV3_BUILD_TESTS)$(LINGMO_PACKAGE_OPENCV3_BUILD_PERF_TESTS),)
...
OPENCV3_CONF_OPTS += \
	...
	-DBUILD_opencv_calib3d=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_CALIB3D),ON,OFF) \
	-DBUILD_opencv_core=ON \
	-DBUILD_opencv_features2d=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_FEATURES2D),ON,OFF) \
	-DBUILD_opencv_flann=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_FLANN),ON,OFF) \
	-DBUILD_opencv_highgui=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_HIGHGUI),ON,OFF) \
	-DBUILD_opencv_imgcodecs=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_IMGCODECS),ON,OFF) \
	-DBUILD_opencv_imgproc=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_IMGPROC),ON,OFF) \
	-DBUILD_opencv_java=OFF \
	-DBUILD_opencv_ml=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_ML),ON,OFF) \
	-DBUILD_opencv_objdetect=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_OBJDETECT),ON,OFF) \
	-DBUILD_opencv_photo=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_PHOTO),ON,OFF) \
	-DBUILD_opencv_shape=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_SHAPE),ON,OFF) \
	-DBUILD_opencv_stitching=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_STITCHING),ON,OFF) \
	-DBUILD_opencv_superres=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_SUPERRES),ON,OFF) \
	-DBUILD_opencv_ts=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_TS),ON,OFF) \
	-DBUILD_opencv_video=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_VIDEO),ON,OFF) \
	-DBUILD_opencv_videoio=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_VIDEOIO),ON,OFF) \
	-DBUILD_opencv_videostab=$(if $(LINGMO_PACKAGE_OPENCV3_LIB_VIDEOSTAB),ON,OFF) \
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_FFMPEG),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_GSTREAMER1),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_JPEG),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_OPENGL),y)
...
OPENCV3_CONF_OPTS += -DWITH_OPENMP=$(if $(LINGMO_TOOLCHAIN_HAS_OPENMP),ON,OFF)

ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_PNG),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_PROTOBUF),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_QT5),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_TIFF),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_V4L),y)
OPENCV3_CONF_OPTS += \
	-DWITH_LIBV4L=$(if $(LINGMO_PACKAGE_LIBV4L),ON,OFF) \
	-DWITH_V4L=ON
OPENCV3_DEPENDENCIES += $(if $(LINGMO_PACKAGE_LIBV4L),libv4l)
else
OPENCV3_CONF_OPTS += -DWITH_V4L=OFF -DWITH_LIBV4L=OFF
endif

ifeq ($(LINGMO_PACKAGE_OPENCV3_WITH_WEBP),y)
...
ifeq ($(LINGMO_PACKAGE_OPENCV3_LIB_PYTHON),y)
OPENCV3_CONF_OPTS += \
...
ifneq ($(LINGMO_PACKAGE_OPENCV3_INSTALL_DATA),y)
