...
SPANDSP_CONF_OPTS = \
	...
	$(if $(LINGMO_x86_64),--enable-mmx,--disable-mmx) \
	$(if $(LINGMO_X86_CPU_HAS_SSE),--enable-sse,--disable-sse) \
	$(if $(LINGMO_X86_CPU_HAS_SSE2),--enable-sse2,--disable-sse2) \
	$(if $(LINGMO_X86_CPU_HAS_SSE3),--enable-sse3,--disable-sse3) \
	$(if $(LINGMO_X86_CPU_HAS_SSSE3),--enable-ssse3,--disable-ssse3) \
	$(if $(LINGMO_X86_CPU_HAS_SSE4),--enable-sse4-1,--disable-sse4-1) \
	$(if $(LINGMO_X86_CPU_HAS_SSE42),--enable-sse4-2,--disable-sse4-2)
