...
ifeq ($(LINGMO_PACKAGE_MDNSD_MQUERY),y)
...
MDNSD_SERVICES_$(LINGMO_PACKAGE_MDNSD_FTP_SERVICE) += ftp
MDNSD_SERVICES_$(LINGMO_PACKAGE_MDNSD_HTTP_SERVICE) += http
MDNSD_SERVICES_$(LINGMO_PACKAGE_MDNSD_IPP_SERVICE) += ipp
MDNSD_SERVICES_$(LINGMO_PACKAGE_MDNSD_PRINTER_SERVICE) += printer
MDNSD_SERVICES_$(LINGMO_PACKAGE_MDNSD_SSH_SERVICE) += ssh
