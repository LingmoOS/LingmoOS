...
Name
----
paccache - flexible lpm cache cleaning utility
...
Description
-----------
'paccache' removes old packages from the lpm cache directory.
...
*-c, \--cachedir <dir>*::
	...
	Default is to use the cache directory configured in 'lpm.conf'.
...
See Also
--------
linkman:lpm[8], linkman:lpm.conf[5], linkman:systemctl[1]
