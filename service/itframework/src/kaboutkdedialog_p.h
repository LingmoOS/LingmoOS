...
{
/**
 * @short Standard "About Lingmo OS" dialog box
 *
 * This class provides the standard "About Lingmo OS" dialog box that is used
...
public:
    /**
     * Constructor. Creates a fully featured "About Lingmo OS" dialog box.
