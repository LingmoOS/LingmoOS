...
static const QString EMailTemplateText=i18n(
    ...
    "If you are using Lingmo GPGstore the attachment to disk and then import it. Just select `Import Key...` from `Keys` menu and open the file.\n\n"
    ...
    "With Lingmo GPGyou can right click on the key once you imported all user ids and choose `Export Public Key...`.\n\n"
