...
#include "tundeviceservice.h"
#include <QDBusConnection>
#include <QDBusError>
#include <QDebug>

FakeTunDeviceService::FakeTunDeviceService(QObject *parent)
    : QObject(parent)
{
    registerService();
}

FakeTunDeviceService::~FakeTunDeviceService()
{
    unregisterService();
}

void FakeTunDeviceService::registerService()
{
...
void FakeTunDeviceService::unregisterService()
{
    QDBusConnection bus = QDBusConnection::sessionBus();
