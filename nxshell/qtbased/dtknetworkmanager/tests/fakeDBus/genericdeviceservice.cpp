...
#include "genericdeviceservice.h"
#include <QDBusConnection>
#include <QDBusError>
#include <QDebug>

FakeGenericDeviceService::FakeGenericDeviceService(QObject *parent)
    : QObject(parent)
{
    registerService();
}

FakeGenericDeviceService::~FakeGenericDeviceService()
{
    unregisterService();
}

void FakeGenericDeviceService::registerService()
{
...
void FakeGenericDeviceService::unregisterService()
{
    QDBusConnection bus = QDBusConnection::sessionBus();
