...
FakeNetworkManagerService::FakeNetworkManagerService(QObject *parent)
    : QObject(parent)
{
    registerService();
}

FakeNetworkManagerService::~FakeNetworkManagerService()
{
    unregisterService();
}

void FakeNetworkManagerService::registerService()
{
...
void FakeNetworkManagerService::unregisterService()
{
    QDBusConnection bus = QDBusConnection::sessionBus();
