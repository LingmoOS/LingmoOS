...
#define GSETTING_SCHEMA_XML_PATH "/usr/share/glib-2.0/schemas/com.deepin.dde.deepin-defender.gschema.xml"
...
void SettingsSql::setDefaultKeyValues()
{
    ...
    while (!xmlReader.atEnd()) {
        if (xmlReader.isStartElement() && "schema" == xmlReader.name()) {
            ...
            if ("/com/deepin/dde/deepin-defender/" == schemaPath
                && DEEPIN_DEFENDER_GSETTING_PATH == schemaId) {
