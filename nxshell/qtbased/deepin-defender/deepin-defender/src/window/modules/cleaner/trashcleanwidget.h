...
#include "../../deepin-defender/src/window/namespace.h"
...
class MyItemDelegateTree : public QItemDelegate
{
    Q_OBJECT
public:
    MyItemDelegateTree(QObject *parent = nullptr);
...
private:
    ...
    void addChildItem(int rootIndex, QString title, QString tip, QStringList paths);
    void addChildItem(int rootIndex, QString title, QString tip, QList<QStringList> paths, bool isRemained = false);
