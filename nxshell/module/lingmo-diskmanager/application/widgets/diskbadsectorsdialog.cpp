...
//        title1.replace("so", "so\n");
    ...
    MessageBox messageBox(this);
    messageBox.setIcon(QIcon::fromTheme("://icons/lingmo/builtin/exception-logo.svg"));
...
void DiskBadSectorsDialog::onRepairComplete()
{
    ...
    // 磁盘修复完毕，共修复xxx个坏道区域
    DMessageManager::instance()->sendMessage(this, QIcon::fromTheme("://icons/lingmo/builtin/ok.svg"), tr("Disk repair completed. %1 bad blocks repaired.").arg(m_repairedCount));
