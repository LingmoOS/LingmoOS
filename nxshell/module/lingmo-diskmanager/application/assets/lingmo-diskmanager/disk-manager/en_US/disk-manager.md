# Disk Utility|lingmo-diskmanager|
...
1. Click ![launcher](../common/lingmo_launcher.svg) in the Dock and enter the Launcher interface.
...
2. Click **Confirm** to enter the Create volume group interface, where you can view and select the  name and capacity of the disks and partitions available. The disks and partitions that are not shown include the following:
   ...
   - Read-only disks
   - Partitions or disks that are aoceand to the other logical volume
   - Mounted partitions
...
1. Select a disk or partition that has been aoceand to the logical volume group and click  the ![edit_delete](../common/edit_delete.svg) icon on the top toolbar.
