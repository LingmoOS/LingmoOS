...
const QString DiskManagerServiceName = "com.lingmo.diskmanager";
const QString DiskManagerPath = "/com/lingmo/diskmanager";
...
void checkFrontEndQuit(uint frontEndPid)
{
    ...
    if (info.symLinkTarget() != "/usr/bin/lingmo-diskmanager") {
...
int main(int argc, char *argv[])
{
    ...
    a.setApplicationName("lingmo-diskmanager-service");
