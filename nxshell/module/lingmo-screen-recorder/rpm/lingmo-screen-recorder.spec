...
Name:           lingmo-screen-recorder
Version:        5.8.0
Release:        1
Summary:        Lingmo Screen Recorder
License:        GPLv3+
URL:            https://github.com/lingmoos/lingmo-screen-recorder
...
%{_datadir}/dbus-1/services/com.lingmo.ScreenRecorder.service

%{_sysconfdir}/modprobe.d/lingmo-screen-recorder.conf
%{_sysconfdir}/modules-load.d/lingmo-screen-recorder.conf
#%{_datarootdir}/appdata/lingmo-screen-recorder.appdata.xml
%{_datarootdir}/dbus-1/services/com.lingmo.Screenshot.service
