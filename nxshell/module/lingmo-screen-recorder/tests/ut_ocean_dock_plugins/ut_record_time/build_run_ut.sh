...
rm -rf ./ut_ocean_dock_plugins/ut_record_time/build-ut
mkdir ./ut_ocean_dock_plugins/ut_record_time/build-ut

cd ./ut_ocean_dock_plugins/ut_record_time/build-ut
pwd
...
extract_info="*/ocean-dock-plugins/*" #针对当前目录进行覆盖率操作
