...
#include "../../../src/ocean-dock-plugins/recordtime/recordtimeplugin.h"
...
static const QString PLUGIN_NAME = QString("lingmo-screen-recorder-plugin");
static const QString PLUGIN_DISPLAY_NAME = QString("lingmo-screen-recorder");
