...
public:
    ...
    virtual void TearDown() override{
        ...
        notifyDBus->RemoveRecord("ut-lingmo-screen-recorder");
...
{
    notifyDBus->Notify("ut-lingmo-screen-recorder", 0,  "lingmo-screen-recorder", "",
                       "ut-lingmo-screen-recorder", QStringList(), QVariantMap(), 3000);
}
