...
{
    QVariant v = DBusUtils::redDBusProperty("com.lingmo.daemon.Audio", "/com/lingmo/daemon/Audio",
                                            "com.lingmo.daemon.Audio", "DefaultSource");
...
{
    QVariant v = DBusUtils::redDBusMethod("com.lingmo.daemon.Display", "/com/lingmo/daemon/Display","com.lingmo.daemon.Display","CanRotate");
    EXPECT_TRUE(v.isValid());
