 ...
 * Command line was: qdbusxml2cpp -c DBusZone -p dbuszone com.lingmo.daemon.Zone.xml
 *
...
/*
 * Proxy class for interface com.lingmo.daemon.Zone
 */
class DBusZone: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
    {
        ...
        if (interfaceName !="com.lingmo.daemon.Zone")
            return;
