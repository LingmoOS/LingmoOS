 ...
 * Command line was: qdbusxml2cpp -c DBusSoundEffect -p dbussoundeffect com.lingmo.daemon.SoundEffect.xml
 *
...
/*
 * Proxy class for interface com.lingmo.daemon.SoundEffect
 */
class DBusSoundEffect: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
    {
        ...
        if (interfaceName !="com.lingmo.daemon.SoundEffect")
            return;
...
public:
    ...
    { return "com.lingmo.daemon.SoundEffect"; }
