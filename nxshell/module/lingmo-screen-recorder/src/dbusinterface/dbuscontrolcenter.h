 ...
 * Command line was: qdbusxml2cpp -c DBusControlCenter -p dbuscontrolcenter com.lingmo.ocean.ControlCenter.xml
 *
...
/*
 * Proxy class for interface com.lingmo.ocean.ControlCenter
 */
class DBusControlCenter: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
    {
        ...
        if (interfaceName !="com.lingmo.ocean.ControlCenter")
            return;
...
public:
    ...
    { return "com.lingmo.ocean.ControlCenter"; }
