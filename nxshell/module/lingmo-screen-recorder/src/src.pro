...
# 1050 新添加Wayland相关库
# 103x 不支持滚动截图和ocr
# 102x DBus接口Server中不支持startocean相关接口
# /etc/os-version 依赖包lingmo-desktop-base
...
# 社区版
        ...
        DEFINES += OCEAN_START_FLAGE_ON
        message("startocean support: OK!!!")
...
RESOURCES = ../assets/image/lingmo-screen-recorder.qrc \
...
isEmpty(DSRDIR):DSRDIR=$$PREFIX/share/lingmo-screen-recorder
isEmpty(DOCDIR):DOCDIR=$$PREFIX/share/dman/lingmo-screen-recorder
...
icon.files = ../assets/image/lingmo-screen-recorder.svg ../assets/image/lingmo-screenshot.svg
desktop.files = ../lingmo-screen-recorder.desktop


dbus_service.files = $$PWD/../assets/com.lingmo.ScreenRecorder.service $$PWD/../assets/com.lingmo.Screenshot.service
contains(DEFINES, OCEAN_START_FLAGE_ON ) {
    dbus_service.files = $$PWD/../com.lingmo.ScreenRecorder.service $$PWD/../com.lingmo.Screenshot.service
}
dbus_service.path = $$PREFIX/share/dbus-1/services

manual_dir.files = $$PWD/../assets/lingmo-screen-recorder
manual_dir.path= $$PREFIX/share/lingmo-manual/manual-assets/application/
...
equals(AC_FUNC_ENABLE, true ){
    ...
    message("lingmo-screen-recorder enabled accessibility function with set: " $$AC_FUNC_ENABLE)
}
