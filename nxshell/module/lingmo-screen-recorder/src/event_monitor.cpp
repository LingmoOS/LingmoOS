...
void EventMonitor::initWaylandEventMonitor()
{
    ...
    if (!sessionBus.interface()->isServiceRegistered("com.lingmo.daemon.InputDevices")) {
        qDebug() << "DBusError" << "com.lingmo.daemon.InputDevices";
        return;
    }

    // 监控全局鼠标信号。
    sessionBus.connect("com.lingmo.daemon.InputDevices",
                       "/com/lingmo/api/XEventMonitor", "com.lingmo.api.XEventMonitor", "ButtonPress",
                       this, SLOT(ButtonPressEvent(int, int, int, QString)));

    sessionBus.connect("com.lingmo.daemon.InputDevices",
                       "/com/lingmo/api/XEventMonitor", "com.lingmo.api.XEventMonitor", "ButtonRelease",
                       this, SLOT(ButtonReleaseEvent(int, int, int, QString)));

    sessionBus.connect("com.lingmo.daemon.InputDevices",
                       "/com/lingmo/api/XEventMonitor", "com.lingmo.api.XEventMonitor", "CursorMove",
