// Copyright (C) 2011 ~ 2018 Lingmo, Inc.
...
int main(int argc, char *argv[])
{
    ...
    //    dbus.registerService("com.lingmo.ScreenRecorder");
    if (dbus.registerService("com.lingmo.ScreenRecorder")) {
        app->setOrganizationName("lingmo");
        app->setApplicationName("lingmo-screen-recorder");
        ...
        cmdParser.setApplicationDescription("lingmo-screen-recorder");
        ...
        // Load translator.
        app->loadTranslator();
        Utils::appName = MainWindow::tr("lingmo-screen-recorder");
        ...
        dbus.registerObject("/com/lingmo/ScreenRecorder", &window, QDBusConnection::ExportScriptableSignals | QDBusConnection::ExportScriptableSlots);
        QDBusConnection conn = QDBusConnection::sessionBus();

        if (!conn.registerService("com.lingmo.Screenshot") || !conn.registerObject("/com/lingmo/Screenshot", &window)) {
            qDebug() << "lingmo-screenshot is running!";
            qApp->quit();
            if (Utils::isWaylandMode) {
                _Exit(0);
            }
        ...
        QDBusInterface notification("com.lingmo.ScreenRecorder",
                                    "/com/lingmo/ScreenRecorder",
                                    "com.lingmo.ScreenRecorder",
