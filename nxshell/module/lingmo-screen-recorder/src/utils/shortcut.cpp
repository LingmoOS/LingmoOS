...
Shortcut::Shortcut(QObject *parent) : QObject(parent)
{
    ...
    recordGroup.groupItems << ShortcutItem(tr("Start recording"), getSysShortcuts("lingmo-screen-recorder"))
...
{
    QDBusInterface shortcuts("org.lingmo.ocean.Keybinding1", "/org/lingmo/ocean/Keybinding1", "org.lingmo.ocean.Keybinding1");
