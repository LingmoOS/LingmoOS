...
const QString RecordIconWidget::itemContextMenu()
{
    ...
    recorder["itemText"] = tr("Recording") + getSysShortcuts("lingmo-screen-recorder");
...
void RecordIconWidget::invokedMenuItem(const QString &menuId)
{
    if (menuId == "shot") {
        ...
        QDBusInterface shotDBusInterface("com.lingmo.ScreenRecorder",
...
{
    QDBusInterface shortcuts("com.lingmo.daemon.Keybinding", "/com/lingmo/daemon/Keybinding", "com.lingmo.daemon.Keybinding");
...
QString RecordIconWidget::getDefaultValue(const QString &type)
{
    ...
    } else if (type == "lingmo-screen-recorder") {
