    ...
    m_pressed(false)
{
    ...
    m_dockInter = new DBusDock("com.lingmo.ocean.daemon.Dock", "/com/lingmo/ocean/daemon/Dock", QDBusConnection::sessionBus(), this);
...
bool TimeWidget::createCacheFile()
{
    ...
    std::string path = ("/home/" + userName + "/.cache/lingmo/lingmo-screen-recorder/").toStdString();
...
void TimeWidget::mouseReleaseEvent(QMouseEvent *e)
{
    ...
    if (e->pos().x() > 0 && e->pos().x() < width) {
        ...
        if (flag) {
            ...
            QDBusInterface notification(QString::fromUtf8("com.lingmo.ScreenRecorder"),
                                        QString::fromUtf8("/com/lingmo/ScreenRecorder"),
                                        QString::fromUtf8("com.lingmo.ScreenRecorder"),
