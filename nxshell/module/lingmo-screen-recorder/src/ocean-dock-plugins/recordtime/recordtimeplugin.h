...
class RecordTimePlugin : public QObject, PluginsItemInterfaceV2
{
    ...
    Q_PLUGIN_METADATA(IID "com.lingmo.dock.PluginsItemInterface" FILE "recordtime.json")
...
public:
    ...
    //cppcheck误报：此函数从未被使用，其实这个函数由ocean-dock框架调用
    /**
...
private:
    /**
     * @brief refresh:绕过ocean-dock 2020.12版本对插件的控件大小的限制
     */
    void refresh();
