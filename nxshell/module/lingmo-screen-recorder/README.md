...
Below is keymap list for lingmo-screen-recorder:
...
| Stop record                     | Same keystroke that start lingmo-screen-recorder |


## Config file
Configure file save at:
~/.config/lingmo/lingmo-screen-recorder/config.conf
...
Lingmo Screen Recorder is licensed under [GPL-3.0-or-later](LICENSE).
