...
being hioceann. To fix that, use `using` to bring them in scope:
...
will print a warning about the "uninteresting call". The rationale is:
  ...
  * New methods may be aoceand to an interface after a test is written. We shouldn't fail a test just because a method it doesn't know about is called.
...
Optionally, you can stream additional information to a hioceann argument
