...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到熒幕錄影 ![lingmo_screenshot](../common/lingmo_screenshot.svg) 單擊執行。

3. 右鍵單擊 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，您可以：

   - 單擊 **建立桌面捷徑**，在桌面建立捷徑。
   - 單擊 **釘選到Dock**，將應用程式固定到Dock。
   - 單擊 **開機啟動**，將應用程式添加到開機啟動項，在電腦開機時自動執行該應用。
   
   > ![tips](../common/tips.svg) 竅門：在任務欄系統外掛程式區域中，單擊圖示 ![icon](../common/capture.svg)，或右鍵單擊該圖示選擇 **截圖** 或 **錄屏**，也可以啟動截圖錄屏應用。
...
- 如果您已經將熒幕錄影固定到任務欄，右鍵單擊任務欄上的 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，然後選擇截取全螢幕 。
...
- 在終端中執行指令  「lingmo-screen-recorder -d n」，其中n表示以秒為單位的延時時長。
...
> ![notes](../common/notes.svg) 說明：採用不同的解碼技術，其所支援的功能也會不同，具體請參考應用介面。
