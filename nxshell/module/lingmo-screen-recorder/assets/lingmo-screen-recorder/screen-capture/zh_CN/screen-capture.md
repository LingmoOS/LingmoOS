...
1. 单击任务栏上的启动器图标 ![lingmo_launcher](../common/lingmo_launcher.svg)，进入启动器界面。
2. 上下滚动鼠标滚轮浏览或通过搜索，找到截图录屏图标 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，单击运行。
3. 右键单击 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，您可以：
...
- 如果您已经将截图录屏固定到任务栏，右键单击任务栏上的图标 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，选择 **全屏截图** 。
...
- 在终端中执行命令 “lingmo-screen-recorder -d n”，其中n表示以秒为单位的延时时长。
