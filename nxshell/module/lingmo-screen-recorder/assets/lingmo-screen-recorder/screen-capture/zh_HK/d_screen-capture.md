...
1. 單擊任務欄上的啟動器圖標 ![lingmo_launcher](../common/lingmo_launcher.svg)，進入啟動器界面。
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到螢幕錄影圖標 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，單擊運行。
...
- 如果您已經將截圖錄屏固定到任務欄，右鍵單擊任務欄上的圖標 ![lingmo_screenshot](../common/lingmo_screenshot.svg)，選擇 **全屏截圖** 。
...
- 在終端中執行命令「lingmo-screen-recorder -d n」，其中n表示以秒為單位的延時時長。
