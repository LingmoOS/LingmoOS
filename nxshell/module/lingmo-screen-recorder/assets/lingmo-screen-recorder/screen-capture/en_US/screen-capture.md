# Screen Capture|lingmo-screen-recorder|
...
2. Locate Screen Capture ![lingmo_screenshot](../common/lingmo_screenshot.svg) by scrolling the mouse wheel or searching "screen capture" in the Launcher interface and click it to run. 

3. Right-click ![lingmo_screenshot](../common/lingmo_screenshot.svg) and you can:
...
- If Screen Capture has been fixed in the Dock, right-click ![lingmo_screenshot](../common/lingmo_screenshot.svg) in the Dock to select **Full creenshot**. 
...
- Execute  “lingmo-screen-recorder -d n”  in Terminal, among which n represents the delayed time in seconds.
