...
const QString SERVICE_NAME = "com.lingmo.SystemMonitorPluginPopup";
const QString SERVICE_PATH = "/com/lingmo/SystemMonitorPluginPopup";

const QString DBUS_COMMAND = "gdbus call -e -d com.lingmo.SystemMonitorPluginPopup -o /com/lingmo/SystemMonitorPluginPopup -m  com.lingmo.SystemMonitorPluginPopup.slotShowOrHideSystemMonitorPluginPopupWidget";
...
void DBusInterface::showOrHideLingmoSystemMonitorPluginPopupWidget()
{
    // 调用dbus接口弹出插件主界面
