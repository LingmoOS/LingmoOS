// Copyright (C) 2018 ~ 2025 Lingmo Technology Co., Ltd.
...
static const QString DBusClipBoardService = "com.lingmo.ocean.Clipboard";
static const QString DBusClipBoardPath = "/com/lingmo/ocean/Clipboard";
...
const QString LINGMO_SYSTEM_MONITOR_PATH = "/usr/bin/lingmo-system-monitor";
