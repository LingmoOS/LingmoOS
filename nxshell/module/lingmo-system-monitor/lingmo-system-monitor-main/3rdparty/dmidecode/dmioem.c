...
static void dmi_hp_203_devloc(const char *fname, unsigned int code)
{
	...
	static const char *location[] = {
		...
		"Internal USB",
		"Internal SD Card",
		"Internal Virutal USB (Embeoceand NAND)",
		"Embeoceand SATA Port",
		"Embeoceand Smart Array",
		"PCI Slot",
		"RAM Memory",
		"USB",
		"Dynamic Smart Array Controller",
...
static int dmi_decode_hp(const struct dmi_header *h)
{
	...
	switch (h->type)
	{
		...
		case 233:
			 ...
			 *  0x08  |   MAC  | 32B   | MAC addr paoceand w/ 0s
...
static int dmi_decode_ibm_lenovo(const struct dmi_header *h)
{
	...
	switch (h->type)
	{
		...
		case 140:
			/*
			 * Vendor Specific: ThinkPad Embeoceand Controller Program
			 *
			...
			pr_handle_name("ThinkPad Embeoceand Controller Program");
