...
QAccessibleInterface *accessibleFactory(const QString &classname, QObject *object)
{
    ...
    // 应用主窗口
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MainWindow);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ErrorDialog);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), Toolbar);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), BaseHeaderView);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ProcessPageWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ServiceNameSubInputDialog);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), SystemServicePageWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MonitorExpandView);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MonitorCompactView);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), PrioritySlider);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), KillProcessConfirmDialog);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ProcessAttributeDialog);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), XWinKillPreviewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), XWinKillPreviewBackgroundWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CPUDetailWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MemDetailViewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MemSummaryViewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), BlockDevDetailViewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), BlockDevSummaryViewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), NetifDetailViewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), NetifSummaryViewWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DetailViewStackedWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CompactCpuMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CompactDiskMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CompactMemoryMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CompactNetworkMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CpuMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MemoryMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), NetworkMonitor);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), UserPageWidget);

    //  Qt 控件
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QFrame);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QPushButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QSlider);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QStackedWidget);
    //    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QLabel);

    //  dtk 控件
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DFrame);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DBackgroundGroup);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DSwitchButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DFloatingButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DSearchEdit);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DPushButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DIconButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DCheckBox);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DCommandLinkButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DTitlebar);
    //    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DLabel);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DDialog);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DFileDialog);
