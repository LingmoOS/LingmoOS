...
const QString SERVICE_NAME = "com.lingmo.SystemMonitorMain";
const QString SERVICE_PATH = "/com/lingmo/SystemMonitorMain";
    ...
    : DMainWindow(parent), m_pDbusService(new DBusForSystemoMonitorPluginServce)
{
    ...
    DConfig *dconfig = DConfig::create("org.lingmo.system-monitor", "org.lingmo.system-monitor.main");
    //需要判断Dconfig文件是否合法
...
void MainWindow::initUI()
{
    ...
    // set titlebar icon
    titlebar()->setIcon(QIcon::fromTheme("lingmo-system-monitor"));
