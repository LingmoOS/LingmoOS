...
// 为了兼容性
    ...
    if (DGuiApplicationHelper::setSingleInstance(QString("lingmo-system-monitor"),
        ...
        const QString acknowledgementLink =
                "https://www.lingmo.org/acknowledgments/lingmo-system-monitor#thanks";
        ...
        app.setProductIcon(QIcon::fromTheme("lingmo-system-monitor"));
        ...
        //app.setWindowIcon(QIcon::fromTheme("lingmo-system-monitor")); //耗时40ms
