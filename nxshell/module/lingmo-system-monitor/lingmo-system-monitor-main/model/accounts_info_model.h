...
//#include <com_lingmo_ocean_controlcenter.h>
#include <QMetaType>
#include <QtDBus>
#include <QDBusInterface>


//using Accounts = com::lingmo::daemon::Accounts;
//using AccountsUser = com::lingmo::daemon::accounts::User;
//using LoginManager = org::freedesktop::login1::Manager;
//using ControlCenter = com::lingmo::ocean::ControlCenter;
