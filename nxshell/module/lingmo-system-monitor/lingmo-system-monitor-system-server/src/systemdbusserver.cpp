...
const QString s_PolkitActionSet = "org.lingmo.systemmonitor.systemserver.set";
...
SystemDBusServer::SystemDBusServer(QObject *parent)
    : QObject(parent)
{
    // name: 配置文件中的服务名称 org.lingmo.SystemMonitorSystemServer
    QDBusConnection dbus = QDBusConnection::systemBus();
    if (dbus.registerService("org.lingmo.SystemMonitorSystemServer")) {
        QDBusConnection::RegisterOptions opts =
                QDBusConnection::ExportAllSlots | QDBusConnection::ExportAllSignals | QDBusConnection::ExportAllProperties;
        if (!dbus.registerObject("/org/lingmo/SystemMonitorSystemServer", this, opts)) {
...
bool SystemDBusServer::checkCaller() const
{
    ...
    QString dbmExe = QStandardPaths::findExecutable("lingmo-system-monitor", { "/usr/bin" });
