...
./tests/lingmo-system-monitor-test --gtest_output=xml:./report/report.xml

mkdir -p report
lcov -d $workdir -c -o ./report/coverage.info

lcov --extract ./report/coverage.info '*/lingmo-system-monitor-main/*' -o ./report/coverage.info
