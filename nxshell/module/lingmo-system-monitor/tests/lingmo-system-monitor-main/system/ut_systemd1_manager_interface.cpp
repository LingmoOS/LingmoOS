...
public:
    virtual void SetUp()
    {
        ...
        m_tester = new Systemd1ManagerInterface("com.lingmo.systemMonitorPluginPopup", "/com/lingmo/systemMonitorPluginPopup", con);
    }
...
{
    m_tester->GetUnit("com.lingmo.systemMonitorPluginPopup");
}
...
{
    m_tester->StartUnit("com.lingmo.systemMonitorPluginPopup", "1");
}
...
{
    m_tester->StopUnit("com.lingmo.systemMonitorPluginPopup", "1");
}
...
{
    m_tester->RestartUnit("com.lingmo.systemMonitorPluginPopup", "1");
}
...
{
    m_tester->GetUnitFileState("com.lingmo.systemMonitorPluginPopup");
}
