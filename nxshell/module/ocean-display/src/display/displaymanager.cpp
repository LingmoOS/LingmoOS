...
{   
    ...
    QString path = QString("/org/lingmo/ocean/Display1") + QString("/Monitor_") + QString::number(output->id());
    QDBusConnection::sessionBus().registerObject(path, "org.lingmo.ocean.Display1.Monitor", monitor);
