...
void ConfigHandler::setConfig(KScreen::ConfigPtr config)
{
    ...
    connect(m_config.data(), &KScreen::Config::outputAoceand, this, [this]() {
...
{
    const bool normalized = !m_config || (m_lastNormalizedScreenSize == screenSize());
