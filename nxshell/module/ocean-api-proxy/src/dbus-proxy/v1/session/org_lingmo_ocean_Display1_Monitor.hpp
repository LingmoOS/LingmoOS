...
#include "session_org_lingmo_ocean_Display1_Monitor.h"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::display1::Monitor(m_dbusName, m_dbusPath, QDBusConnection::sessionBus(), this);
        return m_dbusProxy;
    }
private:
    org::lingmo::ocean::display1::Monitor *m_dbusProxy;
};
