...
#include "session_org_lingmo_ocean_daemon_Dock1.h"

#include "session/org_lingmo_ocean_daemon_Dock1_Entry.hpp"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::daemon::Dock1(m_dbusName, m_dbusPath, QDBusConnection::sessionBus(), this);
        return m_dbusProxy;
    }
    virtual void signalMonitorCustom()
    {
        SubPathInit("Entries", DBusProxySubPathInfo{
                "/com/lingmo/ocean/daemon/Dock/entries/",
                "com.lingmo.ocean.daemon.Dock.Entry",
                "org.lingmo.ocean.daemon.Dock1.Entry"},
...
private:
    org::lingmo::ocean::daemon::Dock1 *m_dbusProxy;
};
