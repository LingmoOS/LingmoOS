...
#include "session_org_lingmo_ocean_Audio1_Source.h"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::audio1::Source(m_dbusName, m_dbusPath, QDBusConnection::sessionBus(), this);
        return m_dbusProxy;
    }
private:
    org::lingmo::ocean::audio1::Source *m_dbusProxy;
};
