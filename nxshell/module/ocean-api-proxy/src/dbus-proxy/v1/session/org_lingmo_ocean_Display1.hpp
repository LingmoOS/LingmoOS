...
#include "session_org_lingmo_ocean_Display1.h"

#include "session/org_lingmo_ocean_Display1_Monitor.hpp"
...
public:
    ...
    virtual void signalMonitorCustom()
    {
        SubPathInit("Monitors", DBusProxySubPathInfo{
                "/com/lingmo/daemon/Display/",
                "com.lingmo.daemon.Display.Monitor",
                "org.lingmo.ocean.Display1.Monitor"},
