...
#include "session_org_lingmo_ocean_daemon_Dock1_Entry.h"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::daemon::dock1::Entry(m_dbusName, m_dbusPath, QDBusConnection::sessionBus(), this);
        return m_dbusProxy;
    }
private:
    org::lingmo::ocean::daemon::dock1::Entry *m_dbusProxy;
};
