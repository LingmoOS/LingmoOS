...
#include "session_org_lingmo_ocean_Keybinding1.h"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::Keybinding1(m_dbusName, m_dbusPath, QDBusConnection::sessionBus(), this);
        return m_dbusProxy;
    }
private:
    org::lingmo::ocean::Keybinding1 *m_dbusProxy;
};
