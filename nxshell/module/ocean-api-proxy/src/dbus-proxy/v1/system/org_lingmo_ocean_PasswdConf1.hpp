...
#include "system_org_lingmo_ocean_PasswdConf1.h"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::PasswdConf1(m_dbusName, m_dbusPath, QDBusConnection::systemBus(), this);
        return m_dbusProxy;
    }
private:
    org::lingmo::ocean::PasswdConf1 *m_dbusProxy;
};
