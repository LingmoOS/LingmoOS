...
#include "org_lingmo_ocean_Lastore1_Job.hpp"
#include "system_org_lingmo_ocean_Lastore1_Manager.h"
#include "system_org_lingmo_ocean_Lastore1_Updater.h"
...
public:
    ...
    {
        m_dbusProxy = new org::lingmo::ocean::lastore1::Manager(m_dbusName, m_dbusPath, QDBusConnection::systemBus(), this);
        m_dbusUpdaterProxy = new org::lingmo::ocean::lastore1::Updater(m_dbusName, m_dbusPath, QDBusConnection::systemBus(), this);
        return m_dbusProxy;
    }
    virtual void signalMonitorCustom()
    {
        ...
        if (m_proxyDbusName == "com.lingmo.lastore") {
            updaterProxyInterface = "com.lingmo.lastore.Updater";
        } else if (m_proxyDbusName == "org.lingmo.lastore1") {
            updaterProxyInterface = "org.lingmo.lastore1.Updater";
        }
        ...
        SubPathInit("JobList", DBusProxySubPathInfo{"/org/lingmo/ocean/Lastore1/",
                                                    "com.lingmo.lastore.Job",
                                                    "org.lingmo.ocean.Lastore1.Job"},
...
private:
    org::lingmo::ocean::lastore1::Manager *m_dbusProxy;
    org::lingmo::ocean::lastore1::Updater *m_dbusUpdaterProxy;
};
