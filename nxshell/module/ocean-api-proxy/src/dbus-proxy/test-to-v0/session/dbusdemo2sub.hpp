...
public:
    ...
    virtual DDBusExtendedAbstractInterface * initConnect() {
        m_dbusProxy = new com::lingmo::dbusdemo(m_dbusName, m_dbusPath, QDBusConnection::sessionBus(), this);
        return m_dbusProxy;
    }
    virtual void signalMonitorCustom()
    {
        connect(m_dbusProxy, &com::lingmo::dbusdemo::Tick2, this, [this](QString ret){
            qInfo() << "Tick2:" << ret;
        ...
        connect(m_dbusProxy, &com::lingmo::dbusdemo::AreaTestSig, this, [this](const QString &id, AreaList areaList){
