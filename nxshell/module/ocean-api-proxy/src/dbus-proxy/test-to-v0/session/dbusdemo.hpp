...
public:
    DBusProxy(QObject *parent = nullptr) :QDBusVirtualObject(parent)
    {
        ...
        m_dbusProxy = new com::lingmo::dbusdemo("com.lingmo.dbusdemo", "/com/lingmo/dbusdemo", QDBusConnection::sessionBus(), this);
        signalMonitor();
    }
    virtual	~DBusProxy(){}
...
//            return true;
    ...
    void signalMonitor()
    {
        connect(m_dbusProxy, &com::lingmo::dbusdemo::Tick2, this, [](QString ret){
            qInfo() << "Tick2:" << ret;
        ...
        connect(m_dbusProxy, &com::lingmo::dbusdemo::AreaTestSig, this, [](const QString &id, AreaList areaList){
        ...
        connect(m_dbusProxy, &com::lingmo::dbusdemo::propertyChanged, this, [](const QString &propName, const QVariant &value){
...
private:
    com::lingmo::dbusdemo *m_dbusProxy;
};
