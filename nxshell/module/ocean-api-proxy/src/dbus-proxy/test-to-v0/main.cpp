...
#include "system/com_lingmo_daemon_Accounts.hpp"
...
int main(int argc, char *argv[])
{
    ...
    parser.setApplicationDescription("ocean-api-proxy");
    ...
    if(parser.isSet(systemOption)) {
        ...
        new SystemAccountsProxy("com.lingmo.daemon.Accounts", "/com/lingmo/daemon/Accounts", "com.lingmo.daemon.Accounts",
        ...
        // new SoundEffect();
        // new DBusProxy2("com.lingmo.dbusdemo", "/com/lingmo/dbusdemo", "com.lingmo.dbusdemo",
