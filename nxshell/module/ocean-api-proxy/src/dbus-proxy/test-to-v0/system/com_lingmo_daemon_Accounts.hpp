...
#include "system/com_lingmo_daemon_Accounts_User.hpp"
...
public:
    ...
    {
        m_dbusProxy = new com::lingmo::daemon::Accounts(m_dbusName, m_dbusPath, QDBusConnection::systemBus(), this);
        return m_dbusProxy;
        return nullptr;
    }
    virtual void signalMonitorCustom()
    {
        SubPathInit("UserList", [=](QString path){
            ...
            return new SystemAccountsUserProxy(m_dbusName,
                path,
                "com.lingmo.daemon.Accounts.User",
                m_proxyDbusName,
...
private:
    com::lingmo::daemon::Accounts *m_dbusProxy;
};
