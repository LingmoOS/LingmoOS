        ...
        if (message.interface() == "org.freedesktop.DBus.Properties") {
            ...
            if (message.member() == "Get") {
                ...
                if (!var.isValid()) {
                    ...
                    connection.send(message.createErrorReply("com.lingmo.ocean.error.Unknow", "unknow error"));
                } else {
                    ...
                    if (iterFind != m_pathInfoMap.end()) {
                        ...
                        if (subPathVariantCast(var, pathInfo.proxyPathPrefix, varFix)) {
                            ...
                            connection.send(message.createErrorReply("com.lingmo.ocean.error.NotAllowed", "get is not allowed"));
                        }
                        return true;
                    }
                ...
                if (iterFind != m_pathInfoMap.end()) {
                    ...
                    connection.send(message.createErrorReply("com.lingmo.ocean.error.NotAllowed", "set is not allowed"));
                    return true;
                }
