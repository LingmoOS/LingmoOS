...
public:
    ...
    ocean::network::ProxyMethod proxyMethod() const;
    void setProxyMethod(const ocean::network::ProxyMethod &method);
...
signals:
    ...
    void lastProxyMethodChanged(ocean::network::ProxyMethod);
...
private slots:
    ...
    void onOceanUIConfigChanged(const QString &key);
