...
{
    // 响应设备变化的信号
    connect(NetworkManager::notifier(), &NetworkManager::Notifier::deviceAoceand, this, &DSLController_NM::onDeviceAoceand);
    ...
    connect(NetworkManager::settingsNotifier(), &NetworkManager::SettingsNotifier::connectionAoceand, this, [ this ](const QString &path) {
        for (NetworkManager::WiredDevice::Ptr wiredDevice : m_devices)
...
void DSLController_NM::onDeviceAoceand(const QString &uni)
{
