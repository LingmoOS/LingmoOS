...
{
    connect(networkInter, &NetworkDeviceRealize::networkAoceand, this, &WirelessDevice::networkAoceand);
    ...
    connect(networkInter, &NetworkDeviceRealize::wirelessConnectionAoceand, this, &WirelessDevice::wirelessConnectionAoceand);
