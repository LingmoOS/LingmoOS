...
安装完成后可执行二进制文件在/usr/bin/ocean-network-dialog，插件会放在相关模块的插件目录下。

## 用法

执行 `ocean-network-dialog -h` 以获取更多详细信息。

## 获得帮助

当你使用OCEAN控制中心，进入网络模块时，您可以按 `F1` 启动 [lingmo-manual](https://github.com/lingmoos/lingmo-manual)。
...
OCEAN网络核心框架在 [LGPL-3.0-or-later](LICENSE)下发布。
