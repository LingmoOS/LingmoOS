...
static QString networkService = "org.lingmo.service.SystemNetwork";
...
void SessionContainer::initConnection()
{
    ...
    QDBusConnection::sessionBus().connect("com.lingmo.daemon.Network", "/com/lingmo/daemon/Network", "com.lingmo.daemon.Network", "ProxyMethodChanged", this, SLOT(onProxyMethodChanged(const QString &)));
}
