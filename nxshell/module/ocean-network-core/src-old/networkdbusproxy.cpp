...
#include "oceanuidbusinterface.h"
...
const QString NetworkService = QStringLiteral("org.lingmo.ocean.Network1");
const QString NetworkPath = QStringLiteral("/org/lingmo/ocean/Network1");
const QString NetworkInterface = QStringLiteral("org.lingmo.ocean.Network1");

const QString ProxyChainsService = QStringLiteral("org.lingmo.ocean.Network1");
const QString ProxyChainsPath = QStringLiteral("/org/lingmo/ocean/Network1/ProxyChains");
const QString ProxyChainsInterface = QStringLiteral("org.lingmo.ocean.Network1.ProxyChains");

const QString AirplaneModeService = QStringLiteral("org.lingmo.ocean.AirplaneMode1");
const QString AirplaneModePath = QStringLiteral("/org/lingmo/ocean/AirplaneMode1");
const QString AirplaneModeInterface = QStringLiteral("org.lingmo.ocean.AirplaneMode1");
