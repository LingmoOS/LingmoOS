    ...
    , m_thread(new QThread(this))
{
    ...
    // 构造所有的设备冲突检测对象
    connect(m_networkProcesser, &NetworkProcesser::deviceAoceand, this, &IPConfilctChecker::onDeviceAoceand, Qt::QueuedConnection);
    m_thread->start();
}
...
void IPConfilctChecker::onDeviceAoceand(QList<NetworkDeviceBase *> devices)
{
