...
#include "oceanuiplugintestwidget.h"
...
#include "oceanuinetworkmodule.h"
...
OceanUIPluginTestWidget::OceanUIPluginTestWidget(QWidget *parent)
    : DMainWindow(parent)
...
OceanUIPluginTestWidget::~OceanUIPluginTestWidget()
{
}

int OceanUIPluginTestWidget::getScrollPos(const int index)
{
    int pos = 0;
...
void OceanUIPluginTestWidget::showPage(const QString &url, const UrlType &uType)
{
...
void OceanUIPluginTestWidget::showPage(ModuleObject *module, const QString &url, const UrlType &uType)
{
...
void OceanUIPluginTestWidget::changeEvent(QEvent *event)
{
...
void OceanUIPluginTestWidget::initUI()
{
    ...
    connect(m_backwardBtn, &DIconButton::clicked, this, &OceanUIPluginTestWidget::toHome);
}

void OceanUIPluginTestWidget::initConfig()
{
}

void OceanUIPluginTestWidget::loadModules()
{
    ...
    QFuture<ModuleObject *> future = QtConcurrent::run([this] {
        OceanUINetworkPlugin *net = new OceanUINetworkPlugin();
...
void OceanUIPluginTestWidget::toHome()
{
    showModule(m_rootModule);
}

void OceanUIPluginTestWidget::updateMainView()
{
    if (!m_mainView)
        return;
    // set background
...
void OceanUIPluginTestWidget::clearPage(QWidget *const widget)
{
...
void OceanUIPluginTestWidget::configLayout(QBoxLayout *const layout)
{
    layout->setMargin(0);
    layout->setSpacing(0);
}

void OceanUIPluginTestWidget::showModule(ModuleObject *module, const int index)
{
...
QWidget *OceanUIPluginTestWidget::getPage(QWidget *const widget, const QString &title)
{
    if (!widget)
        return nullptr;
...
QWidget *OceanUIPluginTestWidget::getExtraPage(QWidget *const widget)
{
...
void OceanUIPluginTestWidget::onAddModule(ModuleObject *const module)
{
    QString url;
    ...
    while (!modules.isEmpty()) {
        ...
        connect(moduleObject, &ModuleObject::insertedChild, this, &OceanUIPluginTestWidget::onAddModule);
        connect(moduleObject, &ModuleObject::removedChild, this, &OceanUIPluginTestWidget::onRemoveModule);
        connect(moduleObject, &ModuleObject::childStateChanged, this, &OceanUIPluginTestWidget::onChildStateChanged);
        connect(moduleObject, &ModuleObject::triggered, this, &OceanUIPluginTestWidget::onTriggered, Qt::QueuedConnection);
...
void OceanUIPluginTestWidget::onRemoveModule(ModuleObject *module)
{
    QList<ModuleObject *> modules;
...
void OceanUIPluginTestWidget::onTriggered()
{
...
void OceanUIPluginTestWidget::openManual()
{
}
