...
private:
    ...
    QMap<ocean::network::NetworkDeviceBase *, DCC_NAMESPACE::ModuleObject *> m_deviceMap;
};

class OceanUINetworkPlugin : public DCC_NAMESPACE::PluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "com.lingmo.ocean.network.oceanui" FILE "network.json")
    Q_INTERFACES(DCC_NAMESPACE::PluginInterface)
public:
    explicit OceanUINetworkPlugin(QObject *parent = nullptr);
    ~OceanUINetworkPlugin() override;
