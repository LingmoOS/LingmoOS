...
class WiredModule : public DCC_NAMESPACE::PageModule
{
    Q_OBJECT
public:
    explicit WiredModule(ocean::network::WiredDevice *dev, QObject *parent = nullptr);

private Q_SLOTS:
    void initWirelessList(DTK_WIDGET_NAMESPACE::DListView *lvProfiles);
    void editConnection(ocean::network::ControllItems *item, QWidget *parent);
    void onNameChanged(const QString &name);

private:
    ocean::network::WiredDevice *m_device;
