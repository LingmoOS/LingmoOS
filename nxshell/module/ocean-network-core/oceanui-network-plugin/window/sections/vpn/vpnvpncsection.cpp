...
VpnVPNCSection::VpnVPNCSection(VpnSetting::Ptr vpnSetting, QFrame *parent)
    ...
    , m_caFile(new oceanui::network::FileChooseWidget(this))
{
    initStrMaps();
...
void VpnVPNCSection::initConnection()
{
    ...
    connect(m_caFile, &oceanui::network::FileChooseWidget::requestFrameKeepAutoHide, this, &VpnVPNCSection::requestFrameAutoHide);
