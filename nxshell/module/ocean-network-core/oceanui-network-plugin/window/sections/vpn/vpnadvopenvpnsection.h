...
private:
    ...
    oceanui::network::SpinBoxWidget *m_port;
    oceanui::network::SpinBoxWidget *m_renegInterval;
    oceanui::network::SpinBoxWidget *m_tunnelMTU;
    oceanui::network::SpinBoxWidget *m_udpFragSize;
};
