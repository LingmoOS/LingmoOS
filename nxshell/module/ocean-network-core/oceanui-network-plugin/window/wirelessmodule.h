...
class WirelessModule : public DCC_NAMESPACE::PageModule
{
    Q_OBJECT
public:
    explicit WirelessModule(ocean::network::WirelessDevice *dev, QObject *parent = nullptr);
...
private Q_SLOTS:
    ...
    void onApWidgetEditRequested(ocean::network::AccessPoints *ap, QWidget *parent);
