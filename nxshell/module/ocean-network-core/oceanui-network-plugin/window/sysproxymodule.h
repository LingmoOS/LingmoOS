...
private Q_SLOTS:
    ...
    void applySettings();
    void uiMethodChanged(ocean::network::ProxyMethod uiMethod);
    void resetData(ocean::network::ProxyMethod uiMethod);
    void checkConf();
...
private:
    ...
    ocean::network::ProxyMethod m_uiMethod; // ui修改的ProxyMethod
