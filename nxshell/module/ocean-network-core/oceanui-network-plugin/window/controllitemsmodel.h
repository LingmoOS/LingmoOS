...
Q_SIGNALS:
    void detailClick(ocean::network::ControllItems *conn, QWidget *parent);

public Q_SLOTS:
    void updateDate(QList<ocean::network::ControllItems *> conns);
    void addConnection(QList<ocean::network::ControllItems *> conns);
    void removeConnection(QList<ocean::network::ControllItems *> conns);
    void updateStatus();
    void sortList();
