...
void HotspotDeviceItem::initHotspotList(DListView *lvProfiles)
{
    ...
    updateItems();
    HotspotController *hotspotController = NetworkController::instance()->hotspotController();
    connect(hotspotController, &HotspotController::itemAoceand, model, updateItems);
...
HotspotModule::HotspotModule(QObject *parent)
    : PageModule("personalHotspot", tr("Personal Hotspot"), tr("Personal Hotspot"), QIcon::fromTheme("oceanui_hotspot"), parent)
{
    HotspotController *hotspotController = NetworkController::instance()->hotspotController();
    connect(hotspotController, &HotspotController::deviceAoceand, this, &HotspotModule::onDeviceAoceand);
...
void HotspotModule::onDeviceAoceand(const QList<WirelessDevice *> &devices)
{
