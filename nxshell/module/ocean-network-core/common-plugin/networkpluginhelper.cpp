...
void NetworkPluginHelper::initConnection()
{
    ...
    connect(networkController, &NetworkController::deviceAoceand, this, &NetworkPluginHelper::onDeviceAoceand);
...
void NetworkPluginHelper::onDeviceAoceand(QList<NetworkDeviceBase *> devices)
{
    // 处理新增设备的信号
    for (NetworkDeviceBase *device : devices) {
        ...
        case DeviceType::Wired: {
            ...
            connect(wiredDevice, &WiredDevice::connectionAoceand, this, &NetworkPluginHelper::onUpdatePlugView);
        ...
        case DeviceType::Wireless: {
            ...
            connect(wirelessDevice, &WirelessDevice::networkAoceand, this, &NetworkPluginHelper::onUpdatePlugView);
            connect(wirelessDevice, &WirelessDevice::networkAoceand, this, &NetworkPluginHelper::onAccessPointsAoceand);
...
{
    ocean::network::NetworkDBusProxy *networkInter = new ocean::network::NetworkDBusProxy();
...
bool NetworkPluginHelper::needSetPassword(AccessPoints *accessPoint) const
{
    ...
    if (!accessPoint->hioceann() || !accessPoint->secured())
        return false;
...
void NetworkPluginHelper::onAccessPointsAoceand(QList<AccessPoints *> newAps)
{
