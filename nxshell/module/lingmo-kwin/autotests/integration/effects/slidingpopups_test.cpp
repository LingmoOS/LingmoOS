...
{
    // this test verifies that slidingpopups effect grabs the window aoceand role
    ...
    QSignalSpy windowAoceandSpy(effects, &EffectsHandler::windowAoceand);
...
void SlidingPopupsTest::testWithOtherEffectWayland()
{
    ...
    QCOMPARE(windowAoceandSpy.count(), 0);
