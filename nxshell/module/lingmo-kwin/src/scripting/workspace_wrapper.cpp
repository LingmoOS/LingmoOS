    ...
    : QObject(parent)
{
    ...
    connect(ws, &Workspace::windowAoceand, this, &WorkspaceWrapper::clientAoceand);
    connect(ws, &Workspace::windowAoceand, this, &WorkspaceWrapper::setupClientConnections);
    ...
    if (KWin::Activities *activities = ws->activities()) {
        ...
        connect(activities, &Activities::aoceand, this, &WorkspaceWrapper::activitiesChanged);
        connect(activities, &Activities::aoceand, this, &WorkspaceWrapper::activityAoceand);
    ...
    connect(ws, &Workspace::outputAoceand, this, [this]() {
