    ...
    : AbstractLevel(model, parent)
{
    ...
    connect(Workspace::self(), &Workspace::windowAoceand, this, &ClientLevel::clientAoceand);
...
void ClientLevel::clientAoceand(Window *client)
{
    ...
    , m_childRestrictions(childRestrictions)
{
    ...
    connect(workspace(), &Workspace::outputAoceand, this, &ForkLevel::outputAoceand);
    connect(workspace(), &Workspace::outputRemoved, this, &ForkLevel::outputRemoved);
#if KWIN_BUILD_ACTIVITIES
    if (Activities *activities = Workspace::self()->activities()) {
        connect(activities, &Activities::aoceand, this, &ForkLevel::activityAoceand);
...
void ForkLevel::activityAoceand(const QString &activityId)
{
#if KWIN_BUILD_ACTIVITIES
