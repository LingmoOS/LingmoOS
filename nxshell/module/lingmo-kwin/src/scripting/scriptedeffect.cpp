...
ScriptedEffect *ScriptedEffect::create(const KPluginMetaData &effect)
{
    ...
    const QString scriptFile = QStandardPaths::locate(QStandardPaths::GenericDataLocation,
                                                      QLatin1String("lingmo-kwin/effects/") + name + QLatin1String("/contents/") + scriptName);
...
bool ScriptedEffect::init(const QString &effectName, const QString &pathToScript)
{
    ...
    const QString kconfigXTFile = QStandardPaths::locate(QStandardPaths::GenericDataLocation, QLatin1String("lingmo-kwin/effects/") + m_effectName + QLatin1String("/contents/config/main.xml"));
...
uint ScriptedEffect::addFragmentShader(ShaderTrait traits, const QString &fragmentShaderFile)
{
    ...
    const QString shaderDir{QLatin1String("lingmo-kwin/effects/") + m_effectName + QLatin1String("/contents/shaders/")};
