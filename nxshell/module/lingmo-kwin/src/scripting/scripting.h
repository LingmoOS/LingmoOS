...
public:
     ...
     * aoceand to the UserActionsMenu.
     *
     ...
     * menu entry to be aoceand. In case the callback returns a null or undefined or any other invalid
...
private:
     ...
     *
     * The created action is aoceand to the map of actions and callbacks shared with the global
     * shortcuts.
     *
