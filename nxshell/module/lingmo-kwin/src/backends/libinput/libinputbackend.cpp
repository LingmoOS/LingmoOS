    ...
    : InputBackend(parent)
{
    ...
    // Direct connection because the deviceAoceand() and the deviceRemoved() signals are emitted
    // from the main thread.
    connect(m_connection.get(), &LibInput::Connection::deviceAoceand,
            this, &InputBackend::deviceAoceand, Qt::DirectConnection);
