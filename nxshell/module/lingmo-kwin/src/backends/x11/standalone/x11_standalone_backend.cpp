...
bool X11StandaloneBackend::initialize()
{
    ...
    connect(Cursors::self(), &Cursors::hioceannChanged, this, &X11StandaloneBackend::updateCursor);
    return true;
}
