...
void DrmBackend::reactivate()
{
    ...
    // While the session had been inactive, an output could have been aoceand or
...
DrmGpu *DrmBackend::addGpu(const QString &fileName)
{
    ...
    m_active = true;
    connect(gpu, &DrmGpu::outputAoceand, this, &DrmBackend::addOutput);
    connect(gpu, &DrmGpu::outputRemoved, this, &DrmBackend::removeOutput);
    Q_EMIT gpuAoceand(gpu);
    return gpu;
}
