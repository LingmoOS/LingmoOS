...
#define BASE_THEME "lingmo"
#define BASE_THEME_DIR ":/lingmo/themes"
        ...
        if (!btnObj.isEmpty()) {
            ...
            for (const auto& item : btnObj.keys()) {
                if (item == "menu") {
                    ...
                    config->titlebarConfig.menuBtn.btnIcon = takeIcon(menuObj.value("icon").toObject(), QIcon(), ":/lingmo/themes/lingmo/light/icons/menu");
                    ...
                    config->titlebarConfig.minimizeBtn.btnIcon = takeIcon(minimizeObj.value("icon").toObject(), QIcon(), ":/lingmo/themes/lingmo/light/icons/minimize");
                    ...
                    config->titlebarConfig.maximizeBtn.btnIcon = takeIcon(maximizeObj.value("icon").toObject(), QIcon(), ":/lingmo/themes/lingmo/light/icons/maximize");
                    ...
                    config->titlebarConfig.unmaximizeBtn.btnIcon = takeIcon(unmaximizeObj.value("icon").toObject(), QIcon(), ":/lingmo/themes/lingmo/light/icons/unmaximize");
                } else if (item == "close") {
                    ...
                    config->titlebarConfig.closeBtn.btnIcon = takeIcon(closeObj.value("icon").toObject(), QIcon(), ":/lingmo/themes/lingmo/light/icons/close");
                }
            }
        }
    }
