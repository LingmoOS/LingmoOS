...
#include "lingmo-nightcolorsettings.h"
#include "suncalc.h"
...
NightColorManager::NightColorManager()
{
    ...
    if (i18n("Toggle Night Color") != QStringLiteral("Toggle Night Color")) {
        ...
        toggleActionLegacy.setProperty("componentName", QStringLiteral("lingmo-kwin"));
        toggleActionLegacy.setObjectName(i18n("Toggle Night Color"));
        KGlobalAccel::self()->removeAllShortcuts(&toggleActionLegacy);
    }

    QAction *toggleAction = new QAction(this);
    toggleAction->setProperty("componentName", QStringLiteral("lingmo-kwin"));
    ...
    connect(kwinApp()->colorManager(), &ColorManager::deviceAoceand, this, &NightColorManager::hardReset);
