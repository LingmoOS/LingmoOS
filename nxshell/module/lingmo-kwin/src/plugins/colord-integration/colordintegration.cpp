...
void ColordIntegration::initialize()
{
    ...
    connect(workspace(), &Workspace::outputAoceand, this, &ColordIntegration::handleOutputAoceand);
...
void ColordIntegration::teardown()
{
    ...
    disconnect(workspace(), &Workspace::outputAoceand, this, &ColordIntegration::handleOutputAoceand);
    disconnect(workspace(), &Workspace::outputRemoved, this, &ColordIntegration::handleOutputRemoved);
}

void ColordIntegration::handleOutputAoceand(Output *output)
{
    ...
    if (output->isInternal()) {
        properties.insert(QStringLiteral("Embeoceand"), QString());
    }
