                                               ...
                                               qreal devicePixelRatio, bool rotated)
{
    ...
    QSize paoceandImageSize = imageSize;
    paoceandImageSize.rheight() += verticalPadding;
    paoceandImageSize.rwidth() += horizontalPadding;
    QImage image(paoceandImageSize, QImage::Format_ARGB32_Premultiplied);
