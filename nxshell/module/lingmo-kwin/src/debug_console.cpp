    ...
    : QAbstractItemModel(parent)
{
    ...
    for (auto window : windows) {
        handleWindowAoceand(window);
    }
    connect(workspace(), &Workspace::windowAoceand, this, &DebugConsoleModel::handleWindowAoceand);
    ...
    connect(workspace(), &Workspace::unmanagedAoceand, this, [this](Unmanaged *u) {
    ...
    connect(workspace(), &Workspace::internalWindowAoceand, this, [this](InternalWindow *window) {
...
void DebugConsoleModel::handleWindowAoceand(Window *window)
{
    ...
    : QAbstractItemModel(parent)
{
    ...
    auto watchSubsurfaces = [this, reset](Window *c) {
        ...
        connect(monitor, &SubSurfaceMonitor::subSurfaceAoceand, this, reset);
    ...
    connect(workspace(), &Workspace::windowAoceand, this, [reset, watchSubsurfaces](Window *c) {
        watchSubsurfaces(c);
        reset();
    });
    connect(workspace(), &Workspace::windowRemoved, this, reset);
    connect(workspace(), &Workspace::unmanagedAoceand, this, reset);
    ...
    , m_devices(input()->devices())
{
    ...
    connect(input(), &InputRedirection::deviceAoceand, this, [this](InputDevice *d) {
