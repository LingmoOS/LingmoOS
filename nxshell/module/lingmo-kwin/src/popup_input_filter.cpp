...
PopupInputFilter::PopupInputFilter()
    : QObject()
{
    connect(workspace(), &Workspace::windowAoceand, this, &PopupInputFilter::handleWindowAoceand);
    connect(workspace(), &Workspace::internalWindowAoceand, this, &PopupInputFilter::handleWindowAoceand);
}

void PopupInputFilter::handleWindowAoceand(Window *window)
{
    ...
    if (window->hasPopupGrab()) {
        ...
        connect(window, &Window::windowShown, this, &PopupInputFilter::handleWindowAoceand, Qt::UniqueConnection);
