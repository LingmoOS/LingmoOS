...
// Use qdbusxml2cpp panels/dock/api/old/org.lingmo.ocean.daemon.Dock1.xml -p dockrect
...
/*
 * Proxy class for interface org.lingmo.ocean.daemon.Dock1
 */
class OrgLingmoDdeDaemonDock1Interface : public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    {
        return "org.lingmo.ocean.daemon.Dock1";
    }

public:
    OrgLingmoDdeDaemonDock1Interface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~OrgLingmoDdeDaemonDock1Interface();
...
namespace daemon
{
typedef ::OrgLingmoDdeDaemonDock1Interface Dock1;
}
}
}
}
