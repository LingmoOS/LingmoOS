...
public:
    ...
    void installOCEANShellSurface(KWaylandServer::OCEANShellSurfaceInterface *shellSurface);

    KWaylandServer::OCEANShellSurfaceInterface *oceanShellSurface() const;
...
protected:
    ...
    QPointer<KWaylandServer::OCEANShellSurfaceInterface> m_oceanShellSurface;
