...
#define DBUS_LINGMO_WM_SERVICE "com.lingmo.wm"
#define DBUS_LINGMO_WM_OBJ "/com/lingmo/wm"
#define DBUS_LINGMO_WM_INTF "com.lingmo.wm"

#define DBUS_APPEARANCE_SERVICE "org.lingmo.ocean.Appearance1"
#define DBUS_APPEARANCE_OBJ "/org/lingmo/ocean/Appearance1"
#define DBUS_APPEARANCE_INTF "org.lingmo.ocean.Appearance1"
#define KWinDBusPropertyInterface "org.freedesktop.DBus.Properties"

#define DBUS_IMAGEEFFECT_SERVICE "org.lingmo.ocean.ImageEffect1"
#define DBUS_BLUR_OBJ "/org/lingmo/ocean/ImageBlur1"
#define DBUS_BLUR_INTF "org.lingmo.ocean.ImageBlur1"
...
public:
    ...
    bool isOCEANSessionRegister() const {
        return m_isOCEANSessionRegister;
    }

    void setOCEANSessionRegister(bool isRegister) {
        m_isOCEANSessionRegister = isRegister;
    }

    // from ocean-kwin: let startocean know that ocean has started
    void registerOCEANSession() const;
...
private:
    ...
    bool m_isOCEANSessionRegister = false;
...
public:
    ...
    KWaylandServer::OCEANShellSurfaceInterface* getOCEANShellSurface(KWin::Window* c);
...
private Q_SLOTS:
    ...
    void slotDesktopAoceand(VirtualDesktop *desktop);
...
Q_SIGNALS:
     ...
     */
    void internalWindowAoceand(KWin::InternalWindow *window);
...
private:
    ...
    org::lingmo::ocean::daemon::Dock1 *m_dockInter = nullptr;
