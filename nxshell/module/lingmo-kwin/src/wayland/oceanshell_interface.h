 ...
 * @since 5.5
 */
class KWIN_EXPORT OCEANShellInterface : public QObject
{
    Q_OBJECT
public:
...
class KWIN_EXPORT OCEANShellSurfaceInterface : public QObject
{
    Q_OBJECT
public:
...
private:
    ...
    explicit OCEANShellSurfaceInterface(Display *display, SurfaceInterface *surface, wl_resource *resource);
