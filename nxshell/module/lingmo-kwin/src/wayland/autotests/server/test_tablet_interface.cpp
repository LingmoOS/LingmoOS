...
public:
    ...
    void zwp_tablet_seat_v2_tablet_aoceand(struct ::zwp_tablet_v2 *id) override
    {
        m_tablets << new Tablet(id);
        Q_EMIT tabletAoceand();
    }
    void zwp_tablet_seat_v2_tool_aoceand(struct ::zwp_tablet_tool_v2 *id) override
    {
        m_tools << new Tool(id);
        Q_EMIT toolAoceand();
    }

    void zwp_tablet_seat_v2_pad_aoceand(struct ::zwp_tablet_pad_v2 *id) override
    {
...
void TestTabletInterface::testAdd()
{
    ...
    QSignalSpy tabletSpy(m_tabletSeatClient, &TabletSeat::tabletAoceand);
    ...
    QSignalSpy toolSpy(m_tabletSeatClient, &TabletSeat::toolAoceand);
...
void TestTabletInterface::testAddPad()
{
    ...
    QSignalSpy tabletPadSpy(m_tabletSeatClient, &TabletSeat::padAoceand);
    m_tabletPad =
