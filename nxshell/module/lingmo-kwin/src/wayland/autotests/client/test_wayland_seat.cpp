...
void TestWaylandSeat::testTouch()
{
    ...
    QSignalSpy pointAoceandSpy(touch, &KWayland::Client::Touch::pointAoceand);
    ...
    QCOMPARE(pointAoceandSpy.count(), 0);
    ...
    QCOMPARE(pointAoceandSpy.count(), 1);
    QCOMPARE(pointMovedSpy.count(), 1);
    QCOMPARE(pointRemovedSpy.count(), 0);
    QCOMPARE(touch->sequence().count(), 2);
    QCOMPARE(touch->sequence().first(), tp);
    KWayland::Client::TouchPoint *tp2 = pointAoceandSpy.first().first().value<KWayland::Client::TouchPoint *>();
    QVERIFY(tp2);
    ...
    QCOMPARE(pointAoceandSpy.count(), 2);
    QCOMPARE(pointMovedSpy.count(), 1);
