...
class StrutInterfacePrivate: public QtWaylandServer::com_lingmo_kwin_strut
{
public:
...
private:
   void com_lingmo_kwin_strut_set_strut_partial(Resource *resource,
...
StrutInterfacePrivate::StrutInterfacePrivate(StrutInterface *q, Display *d)
    : QtWaylandServer::com_lingmo_kwin_strut(*d, s_version)
    , q(q)
{
}

void StrutInterfacePrivate::com_lingmo_kwin_strut_set_strut_partial(Resource *resource,
                                                                    struct ::wl_resource *surface,
                                                                    int32_t left,
                                                                    int32_t right,
                                                                    int32_t top,
                                                                    ...
                                                                    int32_t bottom_end_x)
{
    ...
    struct lingmoKwinStrut kwinStrut(left,
                                     right,
                                     top,
                                     bottom,
                                     left_start_y,
