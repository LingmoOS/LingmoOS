...
#include "qwayland-server-com-lingmo-client-management.h"
...
class ClientManagementInterfacePrivate: public QtWaylandServer::com_lingmo_client_management
{
public:
...
protected:
    void com_lingmo_client_management_get_window_states(Resource *resource) override;
    void com_lingmo_client_management_get_window_from_point(Resource *resource) override;
    void com_lingmo_client_management_show_split_menu(Resource *resource,
            int32_t x, int32_t y, int32_t width, int32_t height, uint32_t wid) override;
    void com_lingmo_client_management_hide_split_menu(Resource *resource, int32_t delay) override;
    void com_lingmo_client_management_get_all_window_id(Resource *resource) override;
    void com_lingmo_client_management_get_specific_window_state(Resource *resource, uint32_t wid) override;
...
ClientManagementInterfacePrivate::ClientManagementInterfacePrivate(ClientManagementInterface *q, Display *d)
    : QtWaylandServer::com_lingmo_client_management(*d, s_version)
    , q(q)
{
}

void ClientManagementInterfacePrivate::com_lingmo_client_management_get_window_states(Resource *resource)
{
    Q_UNUSED(resource);
...
void ClientManagementInterfacePrivate::com_lingmo_client_management_get_window_from_point(Resource *resource)
{
    Q_UNUSED(resource);
...
void ClientManagementInterfacePrivate::com_lingmo_client_management_show_split_menu(Resource *resource,
...
void ClientManagementInterfacePrivate::com_lingmo_client_management_hide_split_menu(Resource *resource, int32_t delay)
{
    Q_UNUSED(resource);
...
void ClientManagementInterfacePrivate::com_lingmo_client_management_get_all_window_id(Resource *resource)
{
    Q_UNUSED(resource);
...
void ClientManagementInterfacePrivate::com_lingmo_client_management_get_specific_window_state(Resource *resource, uint32_t wid)
{
    Q_UNUSED(resource);
...
void ClientManagementInterfacePrivate::sendWindowStates(wl_resource *resource)
{
    ...
    com_lingmo_client_management_send_window_states(resource, m_windowCount, &data);
...
void ClientManagementInterfacePrivate::sendWindowCaption(int windowId, bool succeed, wl_resource *buffer)
{
    ...
    for (Resource *resource : clientResources) {
        ...
        // com_lingmo_client_management_send_capture_callback(resource->handle, windowId, succeed, buffer);
    }
}
...
void ClientManagementInterfacePrivate::sendWindowFromPoint(uint32_t wid)
{
    const auto clientResources = resourceMap();
    for (Resource *resource : clientResources)
        com_lingmo_client_management_send_window_from_point(resource->handle, wid);
}
...
void ClientManagementInterfacePrivate::sendAllWindowId(const QList<uint32_t> &id_list)
{
    ...
    const auto clientResources = resourceMap();
    for (Resource *resource : clientResources)
        com_lingmo_client_management_send_all_window_id(resource->handle, &id_array);
    wl_array_release(&id_array);
}
...
void ClientManagementInterfacePrivate::sendSpecificWindowState(const ClientManagementInterface::WindowState &state)
{
    const auto clientResources = resourceMap();
    for (Resource *resource : clientResources)
        com_lingmo_client_management_send_specific_window_state(resource->handle, state.pid, state.windowId,
