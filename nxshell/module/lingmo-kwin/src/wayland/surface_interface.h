 ...
 * but goes further by integrating the information aoceand to a SurfaceInterface by other interfaces.
...
Q_SIGNALS:
    ...
    /**
     * Emitted whenever a new child sub-surface @p subSurface is aoceand.
     */
    void childSubSurfaceAoceand(SubSurfaceInterface *subSurface);
    /**
