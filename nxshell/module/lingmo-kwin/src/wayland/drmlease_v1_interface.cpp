    ...
    , m_display(display)
{
    ...
    connect(m_backend, &KWin::DrmBackend::gpuAoceand, this, &DrmLeaseManagerV1::addGpu);
    ...
    , m_gpu(gpu)
{
    ...
    connect(gpu, &KWin::DrmGpu::outputAoceand, this, &DrmLeaseDeviceV1Interface::addOutput);
