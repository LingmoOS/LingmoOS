...
public:
    ...
    /**
     * @returns The suffix aoceand to the caption (e.g. shortcut, machine name, etc.)
     * @see caption
     * @see captionNormal
     */
    ...
    /**
     * Restores the Window after it had been hioceann due to show on screen edge functionality.
    ...
    void setStrut(KWaylandServer::lingmoKwinStrut& strutArea) {m_strutArea = strutArea; }
    KWaylandServer::lingmoKwinStrut strut() const {return m_strutArea; }
...
Q_SIGNALS:
     ...
     * a screen being removed/aoceand or if the Window's geometry changes.
     * @since 4.11
     */
    void screenChanged();
...
private:
    ...
    KWaylandServer::lingmoKwinStrut m_strutArea;
