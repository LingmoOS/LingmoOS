...
SlideBackEffect::SlideBackEffect()
{
    ...
    connect(effects, &EffectsHandler::windowAoceand, this, &SlideBackEffect::slotWindowAoceand);
    ...
    connect(effects, &EffectsHandler::tabBoxAoceand, this, &SlideBackEffect::slotTabBoxAoceand);
...
void SlideBackEffect::slotStackingOrderChanged()
{
    ...
    if (m_upmostWindow == m_justMapped) { // a window was aoceand, got on top, stacking changed. Nothing impressive
...
void SlideBackEffect::slotWindowAoceand(EffectWindow *w)
{
    m_justMapped = w;
}
...
void SlideBackEffect::slotTabBoxAoceand()
{
    ++m_tabboxActive;
}
