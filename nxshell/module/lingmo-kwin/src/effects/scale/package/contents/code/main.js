...
const blacklist = [
    ...
    "ocean-blackwidget ocean-blackwidget",
    "ocean-desktop ocean-desktop",
    "lingmo-screen-recorder lingmo-screen-recorder",
    "plasmashell plasmashell",
    "plasmashell org.kde.plasmashell"
];

const whitelist = [
    "ocean-lock org.lingmo.ocean.lock",
    "ocean-launcher ocean-launcher",
    "ocean-polkit-agent ocean-polkit-agent"
];
...
var scaleEffect = {
    ...
    isScaleWindow: function (window) {
        if (window.windowClass == "ocean-lock org.lingmo.ocean.lock")
            return true;
    ...
    slotWindowAoceand: function (window) {
        ...
        if (window.windowClass == "ocean-launcher ocean-launcher" || window.startEffectType == 16) {
    ...
    slotWindowDataChanged: function (window, role) {
        if (role == Effect.WindowAoceandGrabRole) {
    ...
    init: function () {
        ...
        effects.windowAoceand.connect(scaleEffect.slotWindowAoceand);
