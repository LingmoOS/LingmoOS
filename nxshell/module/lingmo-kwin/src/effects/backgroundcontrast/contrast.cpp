...
ContrastEffect::ContrastEffect()
{
    ...
    connect(effects, &EffectsHandler::windowAoceand, this, &ContrastEffect::slotWindowAoceand);
...
void ContrastEffect::slotWindowAoceand(EffectWindow *w)
{
    KWaylandServer::SurfaceInterface *surf = w->surface();
