...
#define ProhibitScreenshotDBusInterface "lingmo.prohibitscreenshot.interface"
    ...
    , m_dbusInterface2(new ScreenShotDBusInterface2(this))
{
    ...
    connect(effects, &EffectsHandler::screenAoceand, this, &ScreenShotEffect::handleScreenAoceand);
...
void ScreenShotEffect::handleScreenAoceand()
{
    cancelAreaScreenShots();
}
