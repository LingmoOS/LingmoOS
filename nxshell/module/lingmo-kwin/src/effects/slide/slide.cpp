...
SlideEffect::SlideEffect()
{
    ...
    connect(effects, &EffectsHandler::windowAoceand,
            this, &SlideEffect::windowAoceand);
    ...
    connect(effects, &EffectsHandler::screenAoceand,
            this, &SlideEffect::finishedSwitching);
...
void SlideEffect::windowAoceand(EffectWindow *w)
{
    if (m_state == State::Inactive) {
        return;
    }
