...
public:
    ...
    */
    ...
    /**
     * Determines if given client will be aoceand to the list:
     * <UL>
     * <LI>Depends on desktop</LI>
     * <LI>if the client wants to have tab focus.</LI>
     * <LI>The client won't be aoceand if it has modal dialogs</LI>
     * <LI>In that case the modal dialog will be returned if it isn't already
     * included</LI>
     * <LI>Won't be aoceand if it isn't on active screen when using separate
     * screen focus</LI>
     * </UL>
     ...
     * It can also be invoked when clients are aoceand or removed.
