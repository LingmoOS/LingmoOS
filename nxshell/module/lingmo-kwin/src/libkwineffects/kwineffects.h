 ...
 * plugin factory. This macro will take the embeoceand json metadata filename as the second argument.
 *
 ...
 * @code
 *     kcoreaddons_add_plugin(cooleffect SOURCES cooleffect.cpp INSTALL_NAMESPACE "lingmo-kwin/effects/plugins")
 * @endcode
 *
 * @subsection creating-json-metadata Effect's .json file for embeoceand metadata
...
public:
    ...
    /**
     * The cursor image should be hioceann.
     * @see showCursor
     * @since 5.9
     */
    ...
    /**
     * The cursor image should be shown again after having been hioceann.
     * @see hideCursor
     * @since 5.9
     */
...
Q_SIGNALS:
    /**
     * This signal is emitted whenever a new @a screen is aoceand to the system.
     */
    void screenAoceand(KWin::EffectScreen *screen);
    /**
    ...
    /**
     * Signal emitted when a new window has been aoceand to the Workspace.
     * @param w The aoceand window
     * @since 4.7
     */
    void windowAoceand(KWin::EffectWindow *w);
    /**
    ...
    /**
     * Signal emitted when a tabbox is aoceand.
    ...
    void tabAoceand(KWin::EffectWindow *from, KWin::EffectWindow *to); // from merged with to
     ...
     * processing from windowAoceand() (e.g. simply calling propertyNotify() from it)
     * is usually needed.
    ...
    /**
     * This signal is emitted when a new activity is aoceand
     * @param id id of the new activity
     * @since 4.9
     */
    void activityAoceand(const QString &id);
    /**
    ...
    /**
     * The window @p w got hioceann but not yet closed.
     ...
     * window first goes through the window hioceann state and might get shown again, or might
    ...
    void startupAoceand(const QString &id, const QIcon &icon);
...
public:
     ...
     * desktop the window has been aoceand to.
...
public:
     ...
     * device coordinates when they are aoceand.
     */
...
public:
     ...
     *
     * The default projection matrix can be overrioceann by setting this matrix
