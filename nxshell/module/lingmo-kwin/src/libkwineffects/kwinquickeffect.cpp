...
void QuickSceneEffect::handleScreenAoceand(EffectScreen *screen)
{
    addScreen(screen);
}
...
void QuickSceneEffect::startInternal()
{
    ...
    connect(effects, &EffectsHandler::screenAoceand, this, &QuickSceneEffect::handleScreenAoceand);
...
{
    disconnect(effects, &EffectsHandler::screenAoceand, this, &QuickSceneEffect::handleScreenAoceand);
