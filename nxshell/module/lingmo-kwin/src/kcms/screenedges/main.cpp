...
KWinScreenEdgesConfig::KWinScreenEdgesConfig(QWidget *parent, const QVariantList &args)
    ...
    , m_config(KSharedConfig::openConfig("lingmo-kwinrc"))
...
void KWinScreenEdgesConfig::monitorInit()
{
    ...
    const auto effects = KPackage::PackageLoader::self()->listPackages(QStringLiteral("KWin/Script"), QStringLiteral("kwin/builtin-effects/")) << KPackage::PackageLoader::self()->listPackages(QStringLiteral("KWin/Script"), QStringLiteral("lingmo-kwin/effects/"));
    ...
    const QString scriptFolder = QStringLiteral("lingmo-kwin/scripts/");
