    ...
    , ui(new Ui::KWinTabBoxConfigForm)
{
    ...
    connect(ui->hioceannWindows, &QAbstractButton::clicked, this, &KWinTabBoxConfigForm::onFilterMinimization);
    ...
    m_actionCollection = new KActionCollection(this, QStringLiteral("lingmo-kwin"));
...
void KWinTabBoxConfigForm::setFilterMinimization(TabBox::TabBoxConfig::ClientMinimizedMode mode)
{
    ...
    ui->hioceannWindows->setChecked(mode == TabBoxConfig::OnlyMinimizedClients);
}
...
void KWinTabBoxConfigForm::loadShortcuts()
{
    for (const auto &widget : {ui->scAll, ui->scAllReverse, ui->scCurrent, ui->scCurrentReverse}) {
        ...
        const auto shortcuts = KGlobalAccel::self()->globalShortcut(QStringLiteral("lingmo-kwin"), actionName);
...
void KWinTabBoxConfigForm::setFilterMinimizationEnabled(bool enabled)
{
    ...
    ui->hioceannWindows->setEnabled(enabled);
}
...
void KWinTabBoxConfigForm::setFilterMinimizationDefaultIndicatorVisible(bool visible)
{
    ...
    setDefaultIndicatorVisible(ui->hioceannWindows, visible);
}
