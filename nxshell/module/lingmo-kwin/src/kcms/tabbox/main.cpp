...
// own
#include "lingmo-kwinpluginssettings.h"
#include "lingmo-kwinswitcheffectsettings.h"
#include "kwintabboxconfigform.h"
#include "kwintabboxdata.h"
#include "lingmo-kwintabboxsettings.h"
...
static QList<KPackage::Package> availableLnFPackages()
{
    ...
    for (const QString &path : p) {
        ...
        if (!pkg.filePath("defaults").isEmpty()) {
            ...
            KConfigGroup cg = KConfigGroup(conf, "lingmo-kwinrc");
...
void KWinTabBoxConfig::initLayoutLists()
{
    ...
    for (const auto &offer : offers) {
        ...
        const QString scriptFile = QStandardPaths::locate(QStandardPaths::GenericDataLocation,
                                                          QLatin1String("lingmo-kwin/tabbox/") + pluginName + QLatin1String("/contents/")
                                                              + scriptName);
