...
A new Feature can only be aoceand to KWin if:
...
All new aoceand features are under probation, that is if any of the non-functional requirements as listed above do not hold true in the next two feature releases, the aoceand feature will be removed again.
