...
* **desktop:**  add generic name. ([78df0a1b](https://github.com/lingmoos/lingmo-picker/commit/78df0a1b33c9300d9d222e07292d657d1361506b))
...
- Provide dbus API to make other application can call lingmo-picker for color pick
...
- Fix the first system notification can not be hioceann immediately
