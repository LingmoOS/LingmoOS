...
*   chore(mips): remove lingmo-movie in ocean-dock
...
* **sw:**  add lingmo-movie and smplayer ([be2accba](be2accba))
...
*   fix: com.lingmo.ocean.power battery-*-delay
...
*   add ocean session daemon module grub-gfx

## [3.5.0] - 2018-11-23
*   fix: some types
*   add touchscreen settings
*   add lingmo-editor settings
...
## [3.2.18] - 2018-08-01
*   update com.lingmo.ocean.launcher.override to add evince 

## [3.2.17] - 2018-08-01
*   chore: rename org.lingmo.flatdeb.lingmo-calendar to org.lingmo.flatdeb.ocean-calendar
...
*   feat: com.lingmo.ocean.daemon add key 'trayicon' and 'x-event-monitor'
*   feat: com.lingmo.ocean.daemon add key 'lastore'
...
*   add ocean-welcome to zone black list ([7c059359](7c059359))
*   desktop add enable hotzone setting ([36638d65](36638d65))
*   add auto exit for lingmo-notification ([23b19fbe](23b19fbe))
*   add auto exit for ocean-osd ([1c1e74fc](1c1e74fc))
*   add auto-exit settings for ocean-control-center ([b318a6fe](b318a6fe))
*   startocean add key iowait-enabled and memchecker-enabled ([3591218f](3591218f))
*   add calltrace ([4d1b5e0f](4d1b5e0f))
*   add debug ([a1d72dd0](a1d72dd0))
*   remove the failed grab keys from mediakey ([f55c5cf8](f55c5cf8))
*   com.lingmo.ocean.dameon add key 'service-trigger' ([40cb97c3](40cb97c3))
*   default-applications.terminal add key 'app-id' ([1e99107a](1e99107a))
*   ocean.power add key 'adjust-brightness-enabled' ([afc1d37d](afc1d37d))
...
*   remove lingmo-movie from fullscreen-workaround-list ([407ae707](407ae707))
*   add shortcut color-picker ([1c91d4a3](1c91d4a3))
*   add shortcut lingmo-system-monitor ([bcaa6105](bcaa6105))
...
* **x86:**  add lingmo flatpak apps to apps order ([ca1450d8](ca1450d8))
...
## [3.2.1] - 2017-11-09
+ change apps-order: add lingmo-clone and lingmo-picker and lingmo flatpak apps
+ revert "fix: repalce `Above_Tab` with other keysym string"


## [3.2.0] - 2017-11-03
+ change the icon size default value
+ remove lingmo-move from fullscreen workaround list
+ add shortcut for color-picker
+ add flatpak apps order list
+ add shortcut for lingmo-system-monitor
