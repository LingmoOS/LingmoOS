...
Version:        5.4.3+rpm
Release:        1%{?dist}
Summary:        Lingmo tool kit widget modules
License:        LGPLv3+
URL:            https://github.com/lingmoos/dtkwidget
%if 0%{?fedora}
...
%description
DtkWidget is Lingmo graphical user interface for lingmo desktop development.
