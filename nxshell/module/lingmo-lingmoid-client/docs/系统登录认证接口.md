...
系统在Session DBus上提供统一登录接口，应用程序调用登录接口完成lingmoid用户的OAuth2登录流程。
...
1 应用调用 com.lingmo.lingmoid.Client.Register 注册应用

2 调用com.lingmo.lingmoid.Client.Authorize接口进行认证
