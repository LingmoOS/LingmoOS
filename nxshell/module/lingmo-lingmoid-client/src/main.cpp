...
const char DBusService[] = "com.lingmo.lingmoid.Client";

const char DBusPath[] = "/com/lingmo/lingmoid/Client";
...
int main(int argc, char **argv)
{
    ...
    app.setApplicationName(QObject::tr("lingmo ID"));
    app.setApplicationDisplayName(QObject::tr("lingmo ID"));
    app.setProductIcon(QIcon::fromTheme("lingmo-id"));
    app.setWindowIcon(QIcon::fromTheme("lingmo-id"));
    ...
    if (!DGuiApplicationHelper::setSingleInstance("com.lingmo.lingmoid.Client")) {
    ...
    if (translator.load(QString("/usr/share/lingmo-lingmoid-client/translations/lingmo-lingmoid-client_%1").arg(QLocale().name()))) {
        app.installTranslator(&translator);
    }

    ddc::LoginWindow lw;
    lw.setWindowIcon(QIcon::fromTheme("lingmo-id"));
