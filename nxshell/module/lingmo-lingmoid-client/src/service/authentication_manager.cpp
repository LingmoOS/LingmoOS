            ...
            if (resp.success) {
                ...
                if (resp.networkError) {
                    DDBusSender()
                        ...
                        .arg(QString("lingmo-lingmoid-client"))
                        .arg(static_cast<uint>(0))
                        .arg(QString("lingmo-id"))
                        .arg(QString(QObject::tr("Synchronization of lingmo ID login status failed")))
                        .arg(QString(QObject::tr("Due to network anomalies, your lingmo ID login status could not be synchronized. Please log in manually or try again later")))
                        .arg(QStringList())
                        .arg(QVariantMap())
                        .arg(5000)
                        .call();
