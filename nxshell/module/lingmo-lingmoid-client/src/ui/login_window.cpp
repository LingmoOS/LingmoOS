...
#include "ipc/lingmoid_interface.h"
#include "ipc/const.h"
...
public:
        ...
        : q_ptr(parent)
    {
        ...
        LingmoIDInterface daemonIf(Const::SyncDaemonService, Const::SyncDaemonPath, QDBusConnection::sessionBus());
        ...
        QString redirectURI = "https://sync.lingmoid.lingmo.com/oauth/callback";
    ...
    , m_loginView(new LoginView(this))
{
    ...
    this->titlebar()->setIcon(QIcon::fromTheme("lingmo-id"));
