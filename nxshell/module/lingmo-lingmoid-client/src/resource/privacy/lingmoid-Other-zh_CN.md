...
您可以通过我们的网站 ([www.lingmo.com](www.lingmo.com)) 注册Lingmo ID并登录到本软件或我们的合作伙伴提供的产品。在本软件中登录账户后，您可以在不同设备之间实现本软件的系统配置和应用软件同步。您关闭Lingmo ID服务后，您的系统配置和应用软件将不能再继续在各设备之间同步。

**1.2.1.Lingmo ID注册**

为实现本服务功能并符合中华人民共和国相关监管要求，您需要提供**个人手机号码**以完成Lingmo ID注册。受限于中华人民共和国监管要求，若您拒绝提供手机号码，我们将无法向您提供Lingmo ID服务。若您位于中华人民共和国以外的其他地区，您需要提供**个人邮箱地址**以完成Lingmo ID注册。

**1.2.2.系统配置同步服务**

若您通过本软件控制中心的云同步模块登录Lingmo ID并授权开启“云同步”开关，以实现您在使用同一Lingmo ID下不同设备间的配置同步。出于该同步目的，云同步服务将会读取您的设备信息和系统信息。您拒绝提供前述信息不会导致本软件其他服务的正常提供。

**1.2.3.应用软件同步服务**

您可以通过本软件控制中心的云同步模块登录Lingmo ID，以实现同一Lingmo ID下不同设备间的本软件应用软件同步。出于该同步目的，应用软件同步服务将会读取您的应用软件信息、应用软件购买信息（包括您为完成支付所必须的实名认证信息和银行账户信息）、历史应用评论数据、历史打赏数据。您拒绝提供前述信息不会导致本软件其他服务的正常提供。
...
若您使用本软件预装的应用商店来下载、安装和卸载应用软件时，我们会收集您的设备信息、系统信息和应用软件信息。您在登录了Lingmo ID之后可以对应用商店中的应用进行评价和/或评分，该评价和/或评分信息会和您Lingmo ID一起关联存储。
...
**2.若无其他约定，您同意在您注销Lingmo ID账户后，出于交易安全需求，我们有权保留您在使用Lingmo ID期间于应用商店产生的购买、评论及评分记录直至届满三年；其余Lingmo ID账户个人信息我们将在您注销账户后及时删除。**
...
如果您希望访问或编辑您的Lingmo ID中的个人基本信息，如手机号码、邮箱地址、性别、教育信息、职业信息或其他个人资料信息，您可以登录Lingmo ID注册网站，通过“[用户中心]”执行此类操作
...
5.1.Lingmo ID支持账户注销，您可以访问[个人中心中的账户信息] 页面自行操作或通过本政策【第十部分】公布的联系方式联系我们注销您的Lingmo ID，我们可能要求您进行身份验证以保障您的账户安全。 
