...
#ifndef LINGMOID_INTERFACE_H
#define LINGMOID_INTERFACE_H
...
/*
 * Proxy class for interface com.lingmo.lingmoid
 */
class LingmoIDInterface: public QDBusAbstractInterface
{
Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "com.lingmo.lingmoid"; }

public:
    LingmoIDInterface(const QString &service,
                      const QString &path,
