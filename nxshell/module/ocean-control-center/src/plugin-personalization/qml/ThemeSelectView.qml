...
ListView {
    ...
    model: Math.ceil((oceanuiData.globalThemeModel.rowCount()  + 1) / (2 * gridMaxColumns))
    spacing: 0
    clip: true
    ...
    Connections {
        target: oceanuiData.globalThemeModel
        onModelReset: {
    ...
    delegate: Item {
        ...
        D.SortFilterModel {
            id: sortedModel
            model: oceanuiData.globalThemeModel
            ...
            delegate: Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        oceanuiData.worker.setGlobalTheme(model.id)
                    }
                }
            }
        }
        GridLayout {
            ...
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        oceanuiData.worker.goDownloadTheme()
                    }
                }
            }
        }
