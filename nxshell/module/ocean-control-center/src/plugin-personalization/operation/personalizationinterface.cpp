...
void ThemeVieweModel::setThemeModel(ThemeModel *model)
{
    ...
    connect(m_themeModel, &ThemeModel::picAoceand, this, &ThemeVieweModel::updateData);
    connect(m_themeModel, &ThemeModel::itemAoceand, this, &ThemeVieweModel::updateData);
...
void PersonalizationInterface::initAppearanceSwitchModel()
{
    ...
    connect(globalTheme, &ThemeModel::itemAoceand, updateDefault);
