...
DCORE_USE_NAMESPACE
Q_LOGGING_CATEGORY(DdcPersonalWorker, "oceanui-personal-workder")

static const std::vector<int> OPACITY_SLIDER{ 0, 25, 40, 55, 70, 85, 100 };

const QList<int> FontSizeList{ 11, 12, 13, 14, 15, 16, 18, 20 };

constexpr auto ORG_LINGMO_CONTROL_CENTER = "org.lingmo.ocean.control-center";
constexpr auto CONTROL_CENTER_PERSONALIZATION = "org.lingmo.ocean.control-center.personalization";
constexpr auto DTK_PREFERENCE_NAME = "org.lingmo.dtk.preference";
...
PersonalizationWorker::PersonalizationWorker(PersonalizationModel *model, QObject *parent)
    ...
    , m_personalizationConfig(DConfig::create(ORG_LINGMO_CONTROL_CENTER, CONTROL_CENTER_PERSONALIZATION, "", this))
    , m_dtkConfig(DConfig::createGeneric(DTK_PREFERENCE_NAME, "", this))
{
    ...
    connect(qApp, &QGuiApplication::screenAoceand, this, &PersonalizationWorker::onScreensChanged);
...
void PersonalizationWorker::addList(ThemeModel *model, const QString &type, const QJsonArray &array)
{
    ...
    QScopedPointer<DConfig> personalizationConfig(DConfig::create("org.lingmo.ocean.control-center", QStringLiteral("org.lingmo.ocean.control-center.personalization"), QString(), this));
