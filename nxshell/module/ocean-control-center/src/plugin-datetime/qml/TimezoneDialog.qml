...
import org.lingmo.dtk 1.0 as D
import org.lingmo.oceanui 1.0 as OceanUI
...
D.DialogWindow {
    ...
    ColumnLayout {
        ...
        function showIndicator(zoneId, zoneDiplayName) {
            ...
            let zonePos = oceanuiData.zonePosition(zoneId, size.width, size.height)
        ...
        D.DciIcon {
            ...
            MouseArea {
                ...
                onPressed: function(mouse) {
                    let zones = oceanuiData.zones(mouse.x, mouse.y, zoneMap.width, zoneMap.height)
                    if (zones.length < 1) {
                    ...
                    zonePos = oceanuiData.zonePosition(zones[0], zoneMap.width, zoneMap.height)
            ...
            Component.onCompleted: {
                // show with indicator
                layout.showIndicator(oceanuiData.systemTimeZone, oceanuiData.timeZoneDispalyName)
            }
        }
