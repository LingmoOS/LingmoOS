...
Q_LOGGING_CATEGORY(DdcDateTimeDbusProxy, "oceanui-datetime-dbusproxy")
...
const QString SystemTimedatedService = QStringLiteral("org.lingmo.ocean.Timedate1");
const QString SystemTimedatedPath = QStringLiteral("/org/lingmo/ocean/Timedate1");
const QString SystemTimedatedInterface = QStringLiteral("org.lingmo.ocean.Timedate1");

const QString PropertiesInterface = QStringLiteral("org.freedesktop.DBus.Properties");
const QString PropertiesChanged = QStringLiteral("PropertiesChanged");

const QString LangSelectorService = QStringLiteral("org.lingmo.ocean.LangSelector1");
const QString LangSelectorPath = QStringLiteral("/org/lingmo/ocean/LangSelector1");
const QString LangSelectorInterface = QStringLiteral("org.lingmo.ocean.LangSelector1");

const QString FormatService = QStringLiteral("org.lingmo.ocean.Format1");
const QString FormatPath = QStringLiteral("/org/lingmo/ocean/Format1");
const QString FormatInterface = QStringLiteral("org.lingmo.ocean.Format1");
