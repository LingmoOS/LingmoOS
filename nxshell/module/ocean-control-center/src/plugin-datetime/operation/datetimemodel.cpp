...
static QString translate(const QString &localeName, const QString &langRegion)
{
    ...
    if (langRegions[0] == "Traditional Chinese" || langRegions[0] == "Simplified Chinese"
        ...
        QString langCountry =
                QString("%1(%2)")
                        .arg(QCoreApplication::translate("oceanui::datetime::Language",
                                                         langRegions.at(0).toUtf8().data()))
                        .arg(QCoreApplication::translate("oceanui::datetime::Country",
...
QAbstractListModel *DatetimeModel::userTimezoneModel()
{
    ...
    m_userTimezoneModel = new oceanuiV25::UserTimezoneModel(this);
    connect(this, &DatetimeModel::userTimeZoneAoceand, m_userTimezoneModel, &oceanuiV25::UserTimezoneModel::reset);
    connect(this, &DatetimeModel::userTimeZoneRemoved, m_userTimezoneModel, &oceanuiV25::UserTimezoneModel::reset);
...
QSortFilterProxyModel *DatetimeModel::zoneSearchModel()
{
    ...
    auto sourceModel = new oceanuiV25::ZoneInfoModel(this);
    m_zoneSearchModel->setSourceModel(sourceModel);
    m_zoneSearchModel->setFilterRole(oceanuiV25::ZoneInfoModel::SearchTextRole);
...
QSortFilterProxyModel *DatetimeModel::langSearchModel()
{
    ...
    auto sourceModel = new oceanuiV25::LanguageListModel(this);
    sourceModel->setMetaData(m_langModel->langLists());
    sourceModel->setLocalLang(m_langModel->localLang());
    connect(m_langModel, &oceanuiV25::KeyboardModel::langChanged, sourceModel, &oceanuiV25::LanguageListModel::setMetaData);
    connect(m_langModel, &oceanuiV25::KeyboardModel::curLocalLangChanged, sourceModel, &oceanuiV25::LanguageListModel::setLocalLang);

    m_langSearchModel->setSourceModel(sourceModel);
    m_langSearchModel->setFilterRole(oceanuiV25::LanguageListModel::SearchTextRole);
...
QSortFilterProxyModel *DatetimeModel::langRegionSearchModel()
{
    ...
    auto sourceModel = new oceanuiV25::LangRegionModel(this);
    m_regionSearchModel->setSourceModel(sourceModel);
    m_regionSearchModel->setFilterRole(oceanuiV25::ZoneInfoModel::SearchTextRole);
...
{
    auto m = dynamic_cast<oceanuiV25::FormatsModel *>(model);
    if (!m)
        return;

    QList<oceanuiV25::FormatsInfo> datas;
    for (int i = indexBegin; i <= indexEnd && (i - indexBegin) < names.count(); ++i) {
        oceanuiV25::FormatsInfo info;
...
QAbstractListModel *DatetimeModel::timeDateModel()
{
    ...
    auto model = new oceanuiV25::FormatsModel(this);
...
void DatetimeModel::addUserTimeZone(const ZoneInfo &zone)
{
    ...
    if (!m_userZoneIds.contains(zoneName)) {
        ...
        Q_EMIT userTimeZoneAoceand(zone);
    }
}
...
void DatetimeModel::ensureLangModel()
{
    ...
    m_langModel = new oceanuiV25::KeyboardModel(this);
    connect(m_langModel, &oceanuiV25::KeyboardModel::curLocalLangChanged, this, &DatetimeModel::langListChanged);
    connect(m_langModel, &oceanuiV25::KeyboardModel::curLangChanged, this, &DatetimeModel::currentLangChanged);
    connect(m_langModel, &oceanuiV25::KeyboardModel::onSetCurLangFinish, this, &DatetimeModel::langStateChanged);
}
