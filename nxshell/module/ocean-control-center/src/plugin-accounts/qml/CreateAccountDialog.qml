    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ComboBox {
                ...
                Layout.fillWidth: true
                model: oceanuiData.userTypes(true)
            }
        }
        ...
        Rectangle {
            ...
            function checkNames() {
                ...
                if (!edit0 || !edit1)
                    return true
                let alertText = oceanuiData.checkUsername(edit0.text)
                ...
                alertText = oceanuiData.checkFullname(edit1.text)
                if (alertText.length > 0) {
