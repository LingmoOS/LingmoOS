...
OceanUIObject {
    ...
    icon: "oceanui_nav_keyboard" // TODO: shortcut icon required
    ...
    OceanUIObject {
        ...
        page: ColumnLayout {
            ...
            ListView {
                ...
                model: oceanuiData.shortcutSearchModel()
                    ...
                    contentItem: ColumnLayout {
                        KeySequenceDisplay {
                            ...
                            onRequestKeys: {
                                ...
                                edit.keys = ""
                                oceanuiData.updateKey(model.id)
                            ...
                            onRequestDeleteKeys: {
                                ...
                                oceanuiData.deleteCustomShortcut(model.id)
                            }

                            function modifyShortcut(accels) {
                                console.log("modifyShortcut", model.id, accels)
                                if (accels.length > 0)
                                    oceanuiData.modifyShortcut(model.id, accels)
                            }
                ...
                Connections {
                    ...
                    function onKeyDone(accels) {
                        if (!shortcutView.editItem)
                            return
                        shortcutView.editItem.focus = false
                        shortcutView.editItem.keys = oceanuiData.formatKeys(accels)
                        shortcutView.conflictText.visible = false
