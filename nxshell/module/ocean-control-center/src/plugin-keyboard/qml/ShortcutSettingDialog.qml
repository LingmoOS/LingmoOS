    ...
    ColumnLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    if (ddialog.keyId.length > 0)
                        oceanuiData.modifyCustomShortcut(ddialog.keyId, nameEdit.text, commandEdit.text, edit.accels)
                    else
                        oceanuiData.addCustomShortcut(nameEdit.text, commandEdit.text, edit.accels)
        ...
        Connections {
            ...
            function onKeyConflicted(oldAccels, newAccels) {
                ...
                conflictText.text = oceanuiData.conflictText + ", " + qsTr("Click Add to replace")
            }
            function onKeyDone(accels) {
                edit.keys = oceanuiData.formatKeys(accels)
                edit.accels = accels
                conflictText.text = ""
            }
