    ...
    OceanUIObject {
        ...
        OceanUIObject {
            ...
            page: RowLayout {
                ...
                Label {
                    ...
                    visible: oceanuiData.mode().developerModeState || oceanuiData.mode().isActivate
                    text: qsTr("Allowed")
                    font.pixelSize: 12
                }
                ...
                Loader {
                    id: loader
                    active: oceanuiData.mode().needShowModalDialog
                ...
                DialogWindow {
                    ...
                    ColumnLayout {
                        ...
                        RecommandButton {
                            id: confirmBtn
                            text: oceanuiData.mode().isLogin ? qsTr("Request Root Access") : qsTr("Login UOS ID")
                            width: parent.width
                            ...
                            onClicked: {
                                ...
                                if (oceanuiData.mode().isLogin) {
                                    oceanuiData.work().setEnableDeveloperMode(true)
                                    developDlg.close()
                                } else {
                                    oceanuiData.work().login()
                                }
                        ...
                        FileDialog {
                            ...
                            onAccepted: {
                                oceanuiData.work().exportMessage(exportFileDlg.file)
                                developDlg.close()
                            }
                        }
                        ...
                        FileDialog {
                            ...
                            folder: StandardPaths.writableLocation(StandardPaths.DocumentsLocation)
                            onAccepted: {
                                oceanuiData.work().importCertificate(fileDlg.file)
                        ...
                        Component {
                            ...
                            ColumnLayout{
                                Rectangle {
                                    ...
                                    Image {
                                        id: tikc
                                        source: oceanuiData.mode().isLogin ? "common_tick" : "qrc:/icons/lingmo/builtin/icons/develop_bind.dci"
                                        width: 128
                                        height: 128
                                        z: 2
                                    ...
                                    Image {
                                        id: ok
                                        visible: oceanuiData.mode().isLogin
                                        source: "common_ok"
                                        z: 1
                                        anchors.centerIn: parent
                                        width: 128
                                ...
                                Label {
                                    ...
                                    Layout.alignment: Qt.AlignHCenter
                                    text: oceanuiData.mode().isLogin ? qsTr("Your UOS ID has been logged in, click to enter developer mode") : qsTr("Please sign in to your UOS ID first and continue")
                                }
                            }
                        }
        ...
        OceanUIObject {
            ...
            page: Label {
                ...
                onLinkActivated: function(url) {
                    console.log("点击的链接是: " + url)
                    oceanuiData.work().jumpToSecurityCenter();
                }
            }
        }
    }
    ...
    OceanUIObject {
        ...
        page:  Row{
            ComboBox {
                ...
                flat: true
                currentIndex: oceanuiData.mode().debugLogCurrentIndex
                onCurrentIndexChanged: {
                    console.log("Selected index:", currentIndex)
                    oceanuiData.work().setLogDebug(currentIndex)
                }
            }
        }
    }
