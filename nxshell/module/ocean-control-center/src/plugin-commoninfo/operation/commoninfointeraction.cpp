...
CommonInfoInteraction::CommonInfoInteraction(QObject *parent)
    ...
    , m_mode(NULL)
{
    qmlRegisterType<CommonInfoWork>("org.lingmo.oceanui.systemInfo", 1, 0, "CommonInfoWork");
    qmlRegisterType<CommonInfoModel>("org.lingmo.oceanui.systemInfo", 1, 0, "CommonInfoModel");
