...
const QString USER_EXPERIENCE_SERVICE = "com.lingmo.userexperience.Daemon";
...
void SystemInfoWork::activate()
{
    ...
    http = IS_COMMUNITY_SYSTEM ? tr("https://www.lingmo.org/en/agreement/privacy/") : tr("https://www.uniontech.com/agreement/privacy-en");
    if (IS_COMMUNITY_SYSTEM) {
        text = tr("<p>Joining User Experience Program means that you grant and authorize us to collect and use the information of your device, system and applications. "
                  ...
                  "For details, please refer to Lingmo Privacy Policy (<a href=\"%1\"> %1</a>).</p>")
               .arg(http);
    } else {
        text = tr("<p>Joining User Experience Program means that you grant and authorize us to collect and use the information of your device, system and applications. "
                  "If you refuse our collection and use of the aforementioned information, do not join User Experience Program. "
...
void SystemInfoWork::updateFrequency(bool state)
{
    ...
    QDBusInterface interface("com.lingmo.daemon.SystemInfo",
                             "/com/lingmo/daemon/SystemInfo",
    ...
    if (state) {
        ...
        QDBusMessage replyCPU = interface.call("Get", "com.lingmo.daemon.SystemInfo", "CPUHardware");
    ...
    QDBusMessage reply = interface.call("Get", "com.lingmo.daemon.SystemInfo", validFrequency);
...
QString SystemInfoWork::getSystemInstallDate(int shortDateFormat, QString timezone)
{
    ...
    QSettings settings("/etc/lingmo-installer/lingmo-installer.conf", QSettings::NativeFormat);
