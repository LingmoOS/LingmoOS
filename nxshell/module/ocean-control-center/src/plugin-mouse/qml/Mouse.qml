...
OceanUIObject {
    ...
    OceanUIObject {
        ...
        page: ColumnLayout {
            ...
            D.TipsSlider {
                ...
                slider.value: oceanuiData.mouseMoveSpeed
                slider.from: 0
                ...
                slider.onValueChanged: {
                    oceanuiData.mouseMoveSpeed = slider.value
                }
            }
        }
    }
        ...
        page: RowLayout {
            ColumnLayout {
                ...
                D.TipsSlider {
                    ...
                    tickDirection: D.TipsSlider.TickDirection.Back
                    slider.handleType: Slider.HandleType.ArrowBottom
                    slider.value: oceanuiData.scrollSpeed
                    slider.from: 200
                    slider.to: 800
                    slider.live: true
                    slider.stepSize: 100
                    ...
                    slider.onValueChanged: {
                        oceanuiData.doubleSpeed = slider.value
                    }
                }
            }
        }
    ...
    OceanUIObject {
        ...
        OceanUIObject {
            ...
            page: D.Switch {
                checked: oceanuiData.accelProfile
                onCheckedChanged: {
                    oceanuiData.accelProfile = checked
                }
            }
        }
        OceanUIObject {
            ...
            pageType: OceanUIObject.Editor
            page: D.Switch {
                checked: oceanuiData.disTpad
                onCheckedChanged: {
                    oceanuiData.disTpad = checked
                }
            }
        }
        OceanUIObject {
            ...
            pageType: OceanUIObject.Editor
            page: D.Switch {
                checked: oceanuiData.mouseNaturalScroll
                onCheckedChanged: {
                    oceanuiData.mouseNaturalScroll = checked
                }
            }
        }
    }
