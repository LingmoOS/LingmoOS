...
const QString Service = "org.lingmo.ocean.InputDevices1";
const QString MousePath = "/org/lingmo/ocean/InputDevice1/Mouse";
const QString TouchpadPath = "/org/lingmo/ocean/InputDevice1/TouchPad";
const QString TrackpointPath = "/org/lingmo/ocean/InputDevice1/Mouse";
const QString InputDevicesPath = "/org/lingmo/ocean/InputDevices1";
const QString PropertiesInterface = "org.freedesktop.DBus.Properties";
const QString MouseInterface = "org.lingmo.ocean.InputDevice1.Mouse";
const QString TouchpadInterface = "org.lingmo.ocean.InputDevice1.TouchPad";
const QString TrackpointInterface = "org.lingmo.ocean.InputDevice1.TrackPoint";
const QString InputDevicesInterface = "org.lingmo.ocean.InputDevices1";
...
void MouseDBusProxy::init()
{
    ...
    // set Mouse settings from ocean-control-center
    ...
    // set Touchpad settings from ocean-control-center
