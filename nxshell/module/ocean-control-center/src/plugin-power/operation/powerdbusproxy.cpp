...
const QString PowerService = QStringLiteral("org.lingmo.ocean.Power1");
const QString PowerPath = QStringLiteral("/org/lingmo/ocean/Power1");
const QString PowerInterface = QStringLiteral("org.lingmo.ocean.Power1");

const QString SysPowerService = QStringLiteral("org.lingmo.ocean.Power1");
const QString SysPowerPath = QStringLiteral("/org/lingmo/ocean/Power1");
const QString SysPowerInterface = QStringLiteral("org.lingmo.ocean.Power1");
...
const QString accountsService = QStringLiteral("org.lingmo.ocean.Accounts1");
const QString defaultAccountsPath = QStringLiteral("/org/lingmo/ocean/Accounts1");
const QString accountsInterface = QStringLiteral("org.lingmo.ocean.Accounts1");

const QString accountsUserInterface = QStringLiteral("org.lingmo.ocean.Accounts1.User");

const QString timeDateService = QStringLiteral("org.lingmo.ocean.Timedate1");
const QString timeDatePath = QStringLiteral("/org/lingmo/ocean/Timedate1");
const QString timeDateInterface = QStringLiteral("org.lingmo.ocean.Timedate1");
...
{
    QDBusInterface Interface("org.lingmo.ocean.Display1",
                             "/org/lingmo/ocean/Display1",
                             "org.lingmo.ocean.Display1",
