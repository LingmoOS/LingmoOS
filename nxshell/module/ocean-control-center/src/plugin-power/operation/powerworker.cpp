...
static const QStringList DCC_CONFIG_FILES {
    "/etc/lingmo/ocean-control-center.conf",
    "/usr/share/ocean-control-center/ocean-control-center.conf"
};
...
PowerWorker::PowerWorker(PowerModel *model, QObject *parent)
    ...
    , m_cfgDock(DConfig::create("org.lingmo.ocean.tray-loader", "org.lingmo.ocean.dock.plugin.power", QString(), this))
    , m_cfgPower(DConfig::create("org.lingmo.ocean.control-center", "org.lingmo.ocean.control-center.power", QString(), this))
    , m_cfgTime(DConfig::createGeneric("org.lingmo.region-format", QString(), this))
{
