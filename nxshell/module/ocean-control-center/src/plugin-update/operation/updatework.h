...
const QString UpdateManagerService = QStringLiteral("org.lingmo.UpdateManager1");
const QString UpdateManagerPath = QStringLiteral("/org/lingmo/UpdateManager1");
const QString UpdateManagerInterface = QStringLiteral("org.lingmo.UpdateManager1");
