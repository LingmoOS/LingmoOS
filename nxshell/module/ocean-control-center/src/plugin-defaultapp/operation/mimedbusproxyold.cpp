...
const QString MimeService = QStringLiteral("org.lingmo.ocean.Mime1");
const QString MimePath = QStringLiteral("/org/lingmo/ocean/Mime1");
const QString MimeInterface = QStringLiteral("org.lingmo.ocean.Mime1");
