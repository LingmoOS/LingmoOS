...
Q_LOGGING_CATEGORY(DdcDefaultWorkerOld, "oceanui-default-worker-old")
...
void DefAppWorkerOld::onCreateFile(const QString &mime, const QFileInfo &info)
{
    ...
    if (isDesktop) {
        ...
        QString newfile = m_userLocalPath + "lingmo-custom-" + info.fileName();
        file.copy(newfile);
        file.close();
        ...
        const QString &filename = "lingmo-custom-" + fileInfo.completeBaseName() + ".desktop";
        ...
        QFile file(m_userLocalPath + "lingmo-custom-" + info.baseName() + ".desktop");
        ...
        QFileInfo fileInfo(info.filePath());
        m_dbusManager->AddUserApp(mimelist, "lingmo-custom-" + fileInfo.baseName() + ".desktop");

        App app;
        app.Id = "lingmo-custom-" + fileInfo.baseName() + ".desktop";
        app.Name = fileInfo.baseName();
        app.DisplayName = fileInfo.baseName();
        app.Icon = "application-default-icon";
        app.Description = "";
