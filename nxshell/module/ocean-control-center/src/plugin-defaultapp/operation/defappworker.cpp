...
Q_LOGGING_CATEGORY(DdcDefaultWorker, "oceanui-default-worker")

const QString TerminalGSetting = QStringLiteral("com.lingmo.desktop.default-applications.terminal");
...
void DefAppWorker::getManagerObjectFinished(QDBusPendingCallWatcher *call)
{
    ...
    for (auto it = map.cbegin(); it != map.cend(); it++) {
        ...
        for (const QVariantMap &mapInter : mapInterface) {
            ...
            bool isLingmoVendor = qdbus_cast<QString>(mapInter["X_Lingmo_Vendor"]) == "lingmo";
