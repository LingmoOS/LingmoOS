...
OceanUIObject {
    DetailItem {
        ...
        icon: "defapp_network"
        weight: 10
        categoryModel: oceanuiData.browser()
    }
    DetailItem {
        name: "defappMail"
        parentName: "defaultapp"
        ...
        icon: "defapp_mail"
        weight: 20
        categoryModel: oceanuiData.mail()
    }
    DetailItem {
        name: "defappText"
        parentName: "defaultapp"
        ...
        icon: "defapp_text"
        weight: 30
        categoryModel: oceanuiData.text()
    }
    DetailItem {
        name: "defappMusic"
        parentName: "defaultapp"
        ...
        icon: "defapp_music"
        weight: 40
        categoryModel: oceanuiData.music()
    }
    DetailItem {
        name: "defappVideo"
        parentName: "defaultapp"
        ...
        icon: "defapp_video"
        weight: 50
        categoryModel: oceanuiData.video()
    }
    DetailItem {
        name: "defappPicture"
        parentName: "defaultapp"
        ...
        icon: "defapp_picture"
        weight: 60
        categoryModel: oceanuiData.picture()
    }
    DetailItem {
        name: "defappTerminal"
        parentName: "defaultapp"
        ...
        weight: 70
        categoryModel: oceanuiData.terminal()
    }
}
