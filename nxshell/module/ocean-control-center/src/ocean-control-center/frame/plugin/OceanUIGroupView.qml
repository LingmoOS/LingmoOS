...
Rectangle {
    ...
    property var model: OceanUIModel {
        root: oceanuiObj
    }
    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: DelegateChooser {
                role: "pageType"
                DelegateChoice {
                    roleValue: OceanUIObject.Menu
                    delegate: OceanUIMenuItem {
                ...
                DelegateChoice {
                    roleValue: OceanUIObject.Editor
                    delegate: OceanUIEditorItem {
                        topInset: root.isGroup ? 0 : 5
                        bottomInset: root.isGroup ? 0 : 5
                        separatorVisible: root.isGroup
                ...
                DelegateChoice {
                    roleValue: OceanUIObject.Item
                    delegate: OceanUIItem {
                        topInset: root.isGroup ? 0 : 5
                        bottomInset: root.isGroup ? 0 : 5
                        separatorVisible: root.isGroup
                        backgroundType: model.item.backgroundType | (root.isGroup ? 1 : 0)
                ...
                DelegateChoice {
                    roleValue: OceanUIObject.MenuEditor
                    delegate: OceanUIMenuEditorItem {
                        topInset: root.isGroup ? 0 : 5
                        bottomInset: root.isGroup ? 0 : 5
                        separatorVisible: root.isGroup
                        backgroundType: model.item.backgroundType | 3
