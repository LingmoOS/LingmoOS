...
Q_LOGGING_CATEGORY(DdcBluetoothWorkder, "oceanui-bluetooth-worker")
    ...
    , m_state(m_bluetoothDBusProxy->state())
{
    ...
    connect(m_bluetoothDBusProxy, &BluetoothDBusProxy::AdapterAoceand, this, &BluetoothWorker::addAdapter);
    ...
    connect(m_bluetoothDBusProxy, &BluetoothDBusProxy::DeviceAoceand, this, &BluetoothWorker::addDevice);
...
{
    QDBusMessage message = QDBusMessage::createMethodCall("com.lingmo.ocean.ControlCenter", // 服务名
                                                           "/com/lingmo/ocean/ControlCenter", // 对象路径
                                                           "com.lingmo.ocean.ControlCenter", // 接口名
                                                           "ShowPage"); // 方法名
