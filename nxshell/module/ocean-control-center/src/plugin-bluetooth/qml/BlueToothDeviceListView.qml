                    ...
                    MouseArea {
                        ...
                        onDoubleClicked: {
                            ...
                            if (model.connectStatus !== 2) {
                                oceanuiData.work().connectDevice(model.id, model.adapterId)
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            D.LineEdit {
                                ...
                                onEditingFinished: {
                                    ...
                                    oceanuiData.work().setDeviceAlias(model.id, nameEdit.text)
                        ...
                        RowLayout {
                            ...
                            D.Button {
                                ...
                                onClicked: {
                                    if (model.connectStatus === 2) {
                                        oceanuiData.work().disconnectDevice(model.id)
                                    } else {
                                        oceanuiData.work().connectDevice(model.id, model.adapterId)
                                    }
                                }
                            ...
                            D.IconButton {
                                ...
                                icon.name: "qrc:/icons/lingmo/builtin/icons/bluetooth_option.dci"
                                icon.width: 16
                                icon.height: 16
                                width: 20
                                height: 20
                                ...
                                D.Menu {
                                    ...
                                    D.MenuItem {
                                        ...
                                        padding: 0
                                        onTriggered: {
                                            oceanuiData.work().ignoreDevice(model.id, model.adapterId)
                                        }
                                    }
                                ...
                                FileDialog {
                                    ...
                                    onAccepted: {
                                        ...
                                        oceanuiData.work().showBluetoothTransDialog(model.address, fileDlg.files)
