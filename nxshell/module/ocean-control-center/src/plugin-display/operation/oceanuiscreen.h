...
class OceanUIScreen : public QObject
{
    Q_OBJECT
...
protected:
    explicit OceanUIScreen(QObject *parent = nullptr);
    ~OceanUIScreen() override;

    QScopedPointer<OceanUIScreenPrivate> d_ptrOceanUIScreen;
    Q_DECLARE_PRIVATE_D(d_ptrOceanUIScreen, OceanUIScreen)
    Q_DISABLE_COPY(OceanUIScreen)
    friend class OceanUIScreenPrivate;
};
} // namespace oceanuiV25
#endif // DCCSCREEN_H
