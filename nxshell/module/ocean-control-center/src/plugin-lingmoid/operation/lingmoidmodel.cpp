...
LingmoidModel::LingmoidModel(QObject *parent)
    : QObject{ parent }
    , m_loginState(false)
    , m_activation(false)
    , m_enableSync(false)
...
void LingmoidModel::setUserinfo(const QVariantMap &userinfo)
{
...
void LingmoidModel::setActivation(bool activation)
{
...
void LingmoidModel::setEnableSync(bool enableSync)
{
