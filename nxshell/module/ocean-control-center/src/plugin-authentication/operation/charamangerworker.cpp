...
{
    // 获取DeviceInfo属性
    QDBusInterface charaManagerInter("org.lingmo.ocean.Authenticate1",
                             "/org/lingmo/ocean/Authenticate1/CharaManger",
                             "org.freedesktop.DBus.Properties",
                             QDBusConnection::systemBus());
    QDBusPendingCall call = charaManagerInter.asyncCall("Get", "org.lingmo.ocean.Authenticate1.CharaManger", "DriverInfo");
