...
class OceanUIQuickDBusInterface : public QObject, public QQmlParserStatus
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    explicit OceanUIQuickDBusInterface(QObject *parent = nullptr);
    ~OceanUIQuickDBusInterface() override;
