...
class OceanUIObject : public QObject
{
    Q_OBJECT
public:
    ...
    Q_PROPERTY(OceanUIObject* currentObject READ currentObject WRITE setCurrentObject NOTIFY currentObjectChanged DESIGNABLE false)
    Q_PROPERTY(QVector<OceanUIObject *> children READ getChildren NOTIFY childrenChanged DESIGNABLE false)
    ...
    explicit OceanUIObject(QObject *parent = nullptr);
    ~OceanUIObject() override;
    ...
    OceanUIObject *currentObject();
    void setCurrentObject(OceanUIObject *obj);
...
Q_SIGNALS:
    ...
    void deactive();
    // 子项变化信号
    void childAboutToBeAoceand(const OceanUIObject *parent, int pos);
    void childAoceand(OceanUIObject *child);
    void childAboutToBeRemoved(const OceanUIObject *parent, int pos);
    void childRemoved(OceanUIObject *child);
    void childAboutToBeMoved(const OceanUIObject *parent, int pos, int oldPos);
    void childMoved(OceanUIObject *child);
    void childrenChanged(const QVector<OceanUIObject *> &children);
    // 属性变化信号
    ...
    void currentObjectChanged(OceanUIObject *obj);
