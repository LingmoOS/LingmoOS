...
PowerModule::PowerModule(QObject *parent)
    : HListModule("power", tr("Power"), DIconTheme::findQIcon("oceanui_nav_power"), parent)
    , m_model(nullptr)
    ...
    , m_useBattery(nullptr)
{
    ...
    QGSettings *m_powerSetting = new QGSettings("com.lingmo.ocean.control-center", QByteArray(), this);
