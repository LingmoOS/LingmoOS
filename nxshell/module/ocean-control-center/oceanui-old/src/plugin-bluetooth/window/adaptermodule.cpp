...
void AdapterModule::initAnonymousCheckBox(QWidget *w)
{
    ...
    refreshBtn->setIcon(DIconTheme::findQIcon("oceanui_refresh"));
...
void AdapterModule::setAdapter(const BluetoothAdapter *adapter)
{
    ...
    connect(adapter, &BluetoothAdapter::deviceAoceand, this, &AdapterModule::deviceChanged, Qt::QueuedConnection);
