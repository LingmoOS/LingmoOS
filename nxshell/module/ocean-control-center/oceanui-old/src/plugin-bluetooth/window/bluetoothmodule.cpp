...
Q_LOGGING_CATEGORY(DdcBluetoothModule, "oceanui-bluetooth-module")

using namespace DCC_NAMESPACE;

BluetoothModule::BluetoothModule(QObject *parent)
    : PageModule("bluetooth", tr("Bluetooth"), tr("Bluetooth device manager"), DIconTheme::findQIcon("oceanui_nav_bluetooth"), parent)
{
    ...
    connect(m_model, &BluetoothModel::adapterAoceand, this, &BluetoothModule::addAdapter);
