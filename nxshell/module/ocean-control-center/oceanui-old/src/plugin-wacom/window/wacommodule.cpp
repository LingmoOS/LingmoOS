...
Q_LOGGING_CATEGORY(DdcWacomModule, "oceanui-wacom-module")
...
WacomModule::WacomModule(QObject *parent)
    : PageModule("wacom", tr("Drawing Tablet") , tr("Drawing Tablet"), DIconTheme::findQIcon("oceanui_nav_wacom"), parent)
