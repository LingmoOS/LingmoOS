...
const static QString WacomService = "org.lingmo.ocean.InputDevices1";
const static QString WacomPath = "/org/lingmo/ocean/InputDevice1/Wacom";
const static QString WacomInterface = "org.lingmo.ocean.InputDevice1.Wacom";
