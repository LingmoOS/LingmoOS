...
const static QString CharaMangerService = QStringLiteral("org.lingmo.ocean.Authenticate1");

const static QString CharaMangerPath = QStringLiteral("/org/lingmo/ocean/Authenticate1/CharaManger");
const static QString CharaMangerInterface = QStringLiteral("org.lingmo.ocean.Authenticate1.CharaManger");

const static QString FingerprintPath = QStringLiteral("/org/lingmo/ocean/Authenticate1/Fingerprint");
const static QString FingerprintInterface = QStringLiteral("org.lingmo.ocean.Authenticate1.Fingerprint");

const static QString SessionManagerService = QStringLiteral("org.lingmo.ocean.SessionManager1");
const static QString SessionManagerPath = QStringLiteral("/org/lingmo/ocean/SessionManager1");
const static QString SessionManagerInterface = QStringLiteral("org.lingmo.ocean.SessionManager1");
