...
ModuleObject *DefAppPlugin::module()
{
    QList<DATE> moduleInfo = {
        ...
        DATE("defappMail", tr("Mail"), "oceanui_mail", DefAppWorker::DefaultAppsCategory::Mail),
        DATE("defappText", tr("Text"), "oceanui_text", DefAppWorker::DefaultAppsCategory::Text),
        DATE("defappMusic", tr("Music"), "oceanui_music", DefAppWorker::DefaultAppsCategory::Music),
        DATE("defappVideo", tr("Video"), "oceanui_video", DefAppWorker::DefaultAppsCategory::Video),
        DATE("defappPicture",
             tr("Picture"),
             "oceanui_photo",
...
DefAppModule::DefAppModule(QObject *parent)
    : VListModule(
            "defapp", tr("Default Applications"), DIconTheme::findQIcon("oceanui_nav_defapp"), parent)
