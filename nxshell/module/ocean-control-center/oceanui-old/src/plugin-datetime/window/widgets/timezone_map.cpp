...
const char kDotFile[] = ":/icons/lingmo/builtin/images/indicator_active.png";
const char kTimezoneMapFile[] = ":/icons/lingmo/builtin/images/timezone_map_big@1x.svg";
...
{
    // Hide dot when popup-zones window is hioceann.
