...
TouchScreenModule::TouchScreenModule(QObject *parent)
    : PageModule("touchscreen", tr("Touch Screen"), tr("Touch Screen"), DIconTheme::findQIcon("oceanui_nav_touchscreen"), parent)
{
...
QString oceanuiV23::TouchScreenPlugin::name() const
{
