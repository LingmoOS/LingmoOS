...
#include "widgets/oceanuidbusinterface.h"
...
const QString &GrubService = QStringLiteral("org.lingmo.ocean.Grub2");
const QString &GrubPath = QStringLiteral("/org/lingmo/ocean/Grub2");
const QString &GrubInterface = QStringLiteral("org.lingmo.ocean.Grub2");

const QString &GrubThemePath = QStringLiteral("/org/lingmo/ocean/Grub2/Theme");
const QString &GrubThemeInterface = QStringLiteral("org.lingmo.ocean.Grub2.Theme");

const QString &GrubEditAuthPath = QStringLiteral("/org/lingmo/ocean/Grub2/EditAuthentication");
const QString &GrubEditAuthInterface = QStringLiteral("org.lingmo.ocean.Grub2.EditAuthentication");

const QString &LingmoIdService = QStringLiteral("com.lingmo.lingmoid");
const QString &LingmoIdPath = QStringLiteral("/com/lingmo/lingmoid");
const QString &LingmoIdInterface = QStringLiteral("com.lingmo.lingmoid");

const QString &LicenseService = QStringLiteral("com.lingmo.license");
const QString &LicensePath = QStringLiteral("/com/lingmo/license/Info");
const QString &LicenseInterface = QStringLiteral("com.lingmo.license.Info");
...
const QString &NotificationService = QStringLiteral("org.lingmo.ocean.Notification1");
const QString &NotificationPath = QStringLiteral("/org/lingmo/ocean/Notification1");
const QString &NotificationInterface = QStringLiteral("org.lingmo.ocean.Notification");

const QString &PlyMouthScaleService = QStringLiteral("org.lingmo.ocean.Daemon1");
const QString &PlyMouthScalePath = QStringLiteral("/org/lingmo/ocean/Daemon1");
const QString &PlyMouthScaleInterface = QStringLiteral("org.lingmo.ocean.Daemon1");
...
CommonInfoProxy::CommonInfoProxy(QObject *parent)
    ...
    , m_lingmoIdInter(new DDBusInterface(LingmoIdService, LingmoIdPath, LingmoIdInterface, QDBusConnection::sessionBus(), this))
...
{
    return qvariant_cast<bool>(m_lingmoIdInter->property("IsLogin"));
}

bool CommonInfoProxy::DeviceUnlocked()
{
    return qvariant_cast<bool>(m_lingmoIdInter->property("DeviceUnlocked"));
}

void CommonInfoProxy::UnlockDevice()
{
    m_lingmoIdInter->asyncCall("UnlockDevice");
}

void CommonInfoProxy::Login()
{
    m_lingmoIdInter->asyncCall("Login");
}
