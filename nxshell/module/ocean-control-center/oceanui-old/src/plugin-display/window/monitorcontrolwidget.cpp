...
MonitorControlWidget::MonitorControlWidget(int activateHeight, QWidget *parent)
    ...
    , m_recognize(new QPushButton(DIconTheme::findQIcon("oceanui_recognize"), tr("Identify")))
    , m_gather(new QPushButton(DIconTheme::findQIcon("oceanui_gather"), tr("Gather Windows")))
