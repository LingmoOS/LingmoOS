...
// Updater
const static QString UpdaterService = QStringLiteral("org.lingmo.ocean.Lastore1");
const static QString UpdaterPath = QStringLiteral("/org/lingmo/ocean/Lastore1");
const static QString UpdaterInterface = QStringLiteral("org.lingmo.ocean.Lastore1.Updater");

// Manager
const static QString ManagerService = QStringLiteral("org.lingmo.ocean.Lastore1");
const static QString ManagerPath = QStringLiteral("/org/lingmo/ocean/Lastore1");
const static QString ManagerInterface = QStringLiteral("org.lingmo.ocean.Lastore1.Manager");
...
const static QString AtomicUpdaterPath = QStringLiteral("/org/lingmo/AtomicUpgrade1");
...
UpdateDBusProxy::UpdateDBusProxy(QObject *parent)
    ...
    , m_atomicUpgradeInter(new DDBusInterface(AtomicUpdaterService,
                                              ...
                                              this))
    , m_smartMirrorInter(new DDBusInterface("org.lingmo.ocean.Lastore1.Smartmirror",
                                            "/org/lingmo/ocean/Lastore1/Smartmirror",
                                              "org.lingmo.ocean.Lastore1.Smartmirror",
                                              QDBusConnection::systemBus(),
                                              this))
