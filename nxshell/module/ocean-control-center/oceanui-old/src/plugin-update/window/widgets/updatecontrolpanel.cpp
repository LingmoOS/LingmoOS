...
void updateControlPanel::setButtonIcon(ButtonStatus status)
{
    ...
    case ButtonStatus::start:
        m_startButton->setIcon(DIconTheme::findQIcon("oceanui_start"));
        break;
    case ButtonStatus::pause:
        m_startButton->setIcon(DIconTheme::findQIcon("oceanui_pause"));
        break;
    case ButtonStatus::retry:
        m_startButton->setIcon(DIconTheme::findQIcon("oceanui_retry"));
        break;
    default:
