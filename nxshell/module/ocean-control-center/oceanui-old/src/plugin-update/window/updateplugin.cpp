...
Q_LOGGING_CATEGORY(DdcUpdatePlugin, "oceanui-update-plugin")
...
UpdateModule::UpdateModule(QObject *parent)
    : HListModule("update", tr("Updates"), DIconTheme::findQIcon("oceanui_nav_update"), parent)
...
{
    m_work->activate();
    // 相应授权状态 com.lingmo.license.Info
