...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "com.lingmo.ocean.ControlCenter.Dock" FILE "plugin-dock.json")
...
private:
    QIcon getIcon(const QString &oceanuiIcon, bool isDeactivate, QString itemKey) const;
    void updateIcons();
