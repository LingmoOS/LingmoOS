...
const static QString DaemonDockService = "org.lingmo.ocean.daemon.Dock1";
const static QString DaemonDockPath = "/org/lingmo/ocean/daemon/Dock1";
const static QString DaemonDockInterface = "org.lingmo.ocean.daemon.Dock1";
const static QString DockService = "org.lingmo.ocean.Dock1";
const static QString DockPath = "/org/lingmo/ocean/Dock1";
const static QString DockInterface = "org.lingmo.ocean.Dock1";
...
{
    arg.beginStructure();
    arg << info.name << info.displayName << info.itemKey << info.settingKey << info.oceanui_icon << info.visible;
    arg.endStructure();
    return arg;
}
