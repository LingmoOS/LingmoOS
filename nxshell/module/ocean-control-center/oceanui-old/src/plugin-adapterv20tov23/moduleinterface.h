...
public:
    ...
    virtual QIcon icon() const {
        return DIconTheme::findQIcon(QString("oceanui_nav_%1").arg(name()));
    }
    ...
    virtual QString translationPath() const {
        return QStringLiteral(":/translations/ocean-control-center_%1.ts");
    }
...
#define ModuleInterface_V1_0_iid "com.lingmo.ocean.ControlCenter.module/1.0"
Q_DECLARE_INTERFACE(oceanuiV20::ModuleInterface, ModuleInterface_V1_0_iid)
