...
Q_LOGGING_CATEGORY(DdcAdapterV20toV23Worker, "oceanui-adapterv20tov23-worker")
...
void PluginManagerV20::loadPlugin(QString path, oceanuiV20::FrameProxyInterface *frameProxy)
{
    Q_UNUSED(frameProxy)
