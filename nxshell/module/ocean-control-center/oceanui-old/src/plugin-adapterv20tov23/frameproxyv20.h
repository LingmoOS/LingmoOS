...
class FrameProxyV20 : public QObject, public oceanuiV20::FrameProxyInterface
{
public:
...
public:
    ...
    virtual void pushWidget(oceanuiV20::ModuleInterface *const inter, QWidget *const w, oceanuiV20::FrameProxyInterface::PushType type = Normal) override;
    virtual void popWidget(oceanuiV20::ModuleInterface *const inter) override;
    virtual void setModuleVisible(oceanuiV20::ModuleInterface *const inter, const bool visible) override;
    ...
    virtual void setSearchPath(oceanuiV20::ModuleInterface *const inter) const override;
...
private:
    QMap<oceanuiV20::ModuleInterface *, AdapterV20toV23Module *> m_moduleMap;
