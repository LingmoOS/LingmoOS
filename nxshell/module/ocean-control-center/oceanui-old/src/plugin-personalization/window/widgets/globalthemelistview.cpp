...
void GlobalThemeModel::setThemeModel(ThemeModel *model)
{
    ...
    connect(m_themeModel, &ThemeModel::picAoceand, this, &GlobalThemeModel::updateData);
    connect(m_themeModel, &ThemeModel::itemAoceand, this, &GlobalThemeModel::updateData);
