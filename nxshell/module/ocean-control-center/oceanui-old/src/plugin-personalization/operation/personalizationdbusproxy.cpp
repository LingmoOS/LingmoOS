...
const QString WMSwitcherService = QStringLiteral("org.lingmo.ocean.WMSwitcher1");
const QString WMSwitcherPath = QStringLiteral("/org/lingmo/ocean/WMSwitcher1");
const QString WMSwitcherInterface = QStringLiteral("org.lingmo.ocean.WMSwitcher1");
