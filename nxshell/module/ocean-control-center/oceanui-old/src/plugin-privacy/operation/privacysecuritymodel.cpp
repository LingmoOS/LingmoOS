    ...
    : QObject(parent)
{
    ...
    m_moduleInfo = {
        DCC_PRIVACY_NAMESPACE::DATE("camera",tr("Camera"), "oceanui_camera", ServiceCategory::Camera),
        DCC_PRIVACY_NAMESPACE::DATE("mic",tr("Microphone"), "oceanui_microphone", ServiceCategory::Microphone),
        DCC_PRIVACY_NAMESPACE::DATE("userdir",tr("User Folders"), "folder", ServiceCategory::UserFolders),
        DCC_PRIVACY_NAMESPACE::DATE("calendar",tr("Calendar"), "ocean-calendar", ServiceCategory::Calendar),
        DCC_PRIVACY_NAMESPACE::DATE("screenshot",tr("Screen Capture"), "lingmo-screen-recorder", ServiceCategory::Screenshots),
    };
