...
ModuleObject *KeyboardPlugin::module()
{
    ...
    moduleInterface->setIcon(DIconTheme::findQIcon("oceanui_nav_keyboard"));
...
QWidget *KBLayoutSettingModule::page()
{
    ...
    w->setModel(m_model);
    connect(w, &KBLayoutSettingWidget::layoutAoceand, this, &KBLayoutSettingModule::onPushKeyboard);
    connect(w, &KBLayoutSettingWidget::requestCurLayoutAoceand, this, &KBLayoutSettingModule::setCurrentLayout);
...
QWidget *SystemLanguageSettingModule::page()
{
    ...
    w->setVisible(false);
    connect(w, &SystemLanguageWidget::onSystemLanguageAoceand, this, &SystemLanguageSettingModule::onPushSystemLanguageSetting);
