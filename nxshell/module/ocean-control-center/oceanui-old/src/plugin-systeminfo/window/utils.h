...
inline const static QString serverEnduserAgreement_old =
        "/usr/share/lingmo-lingmoid-client/privacy/End-User-License-Agreement-Server/"
...
inline const static QString homeEnduserAgreement_old =
        "/usr/share/lingmo-lingmoid-client/privacy/End-User-License-Agreement-Home/"
...
inline const static QString professionalEnduserAgreement_old =
        "/usr/share/lingmo-lingmoid-client/privacy/End-User-License-Agreement-Professional/"
...
inline const static QString oldAgreement =
        "/usr/share/lingmo-lingmoid-client/privacy/End-User-License-Agreement-%1.%2";
inline static const QStringList DCC_CONFIG_FILES{
    "/etc/lingmo/ocean-control-center.conf", "/usr/share/ocean-control-center/ocean-control-center.conf"
};
...
[[maybe_unused]] inline void getPrivacyFile(QString &zhCNContent, QString &enUSContent)
{
    ...
    const QString oldCNContent = "/usr/share/lingmo-lingmoid-client/privacy/lingmoid-CN-zh_CN.md";
    const QString oldENContent = "/usr/share/lingmo-lingmoid-client/privacy/lingmoid-CN-en_US.md";
