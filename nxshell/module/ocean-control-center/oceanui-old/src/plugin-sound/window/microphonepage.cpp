...
{
    QDBusInterface interface("org.lingmo.ocean.Audio1", "/org/lingmo/ocean/Audio1", "org.lingmo.ocean.Audio1", QDBusConnection::sessionBus(), this);
    ...
    if (defaultPath.path() == "/" || defaultPath.path().isEmpty()) //路径为空
        ...
        QDBusInterface *defaultSource = new QDBusInterface("org.lingmo.ocean.Audio1", defaultPath.path(), "org.lingmo.ocean.Audio1.Source", QDBusConnection::sessionBus(), this);
...
void MicrophonePage::setModel(SoundModel *model)
{
    ...
    connect(m_model, &SoundModel::portAoceand, this, &MicrophonePage::addPort);
...
void MicrophonePage::initSlider()
{
    ...
    slider2->setLeftIcon(DIconTheme::findQIcon("oceanui_feedbacklow"));
    slider2->setRightIcon(DIconTheme::findQIcon("oceanui_feedbackhigh"));
