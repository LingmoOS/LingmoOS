...
const static QString SoundEffectService = QStringLiteral("org.lingmo.ocean.SoundEffect1");
const static QString SoundEffectPath = QStringLiteral("/org/lingmo/ocean/SoundEffect1");
const static QString SoundEffectInterface = QStringLiteral("org.lingmo.ocean.SoundEffect1");

const static QString PowerService = QStringLiteral("org.lingmo.ocean.Power1");
const static QString PowerPath = QStringLiteral("/org/lingmo/ocean/Power1");
const static QString PowerInterface = QStringLiteral("org.lingmo.ocean.Power1");
...
const static QString MeterInterface = QStringLiteral("org.lingmo.ocean.Audio1.Meter");
