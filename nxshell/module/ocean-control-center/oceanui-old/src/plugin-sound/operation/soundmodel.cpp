...
static const QMap<DDesktopServices::SystemSoundEffect, QString> SOUND_EFFECT_MAP{
    ...
    { DDesktopServices::SystemSoundEffect::SSE_SendFileComplete, "x-lingmo-app-sent-to-desktop" },
    ...
    { DDesktopServices::SystemSoundEffect::SSE_DeviceAoceand, "device-aoceand" },
    ...
    , m_outputVisibled(false)
{
    m_soundEffectMapBattery = {
        ...
        { tr("Removable device connected"), DDesktopServices::SSE_DeviceAoceand },
