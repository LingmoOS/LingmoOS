...
const static QString NotificationService = "org.lingmo.ocean.Notification1";
const static QString NotificationPath = "/org/lingmo/ocean/Notification1";
const static QString NotificationInterface = "org.lingmo.ocean.Notification1";
...
void NotificationDBusProxy::init()
{
    ...
    dbusConnection.connect(NotificationService, NotificationPath, NotificationInterface, "AppAoceandSignal", this, SIGNAL(AppAoceandSignal(QString)));
    ...
    dbusConnection.connect(NotificationService, NotificationPath, NotificationInterface, "RecordAoceand", this, SIGNAL(RecordAoceand(QString)));
    ...
    dbusConnection.connect(NotificationService, NotificationPath, NotificationInterface, "appAoceand", this, SIGNAL(appAoceand(QString)));
