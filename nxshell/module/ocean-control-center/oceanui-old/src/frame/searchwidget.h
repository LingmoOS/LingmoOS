...
class OceanUICompleter : public QCompleter
{
public:
    OceanUICompleter(QObject *parent = nullptr);
    OceanUICompleter(QAbstractItemModel *model, QObject *parent = nullptr);

public:
    bool eventFilter(QObject *o, QEvent *e) override;
};

class OceanUICompleterStyledItemDelegate : public QStyledItemDelegate
{
    Q_OBJECT
public:
    explicit OceanUICompleterStyledItemDelegate(QObject *parent = nullptr);
