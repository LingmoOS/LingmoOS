...
OceanUICompleter::OceanUICompleter(QObject *parent)
    : QCompleter(parent)
{
}

OceanUICompleter::OceanUICompleter(QAbstractItemModel *model, QObject *parent)
    : QCompleter(model, parent)
{
}

bool OceanUICompleter::eventFilter(QObject *o, QEvent *e)
{
    // 匹配列表隐藏时，将滑动条恢复到顶部
...
OceanUICompleterStyledItemDelegate::OceanUICompleterStyledItemDelegate(QObject *parent)
    : QStyledItemDelegate(parent)
{
}

void OceanUICompleterStyledItemDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
QSize OceanUICompleterStyledItemDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
bool OceanUICompleterStyledItemDelegate::helpEvent(QHelpEvent *event, QAbstractItemView *view, const QStyleOptionViewItem &option, const QModelIndex &index)
{
    switch (event->type()) {
...
QRect OceanUICompleterStyledItemDelegate::calculateIconRect(const QRect &rect) const
{
    return QRect(8, rect.y() + (rect.height() - 24) / 2, 24, 24);
}

QRect OceanUICompleterStyledItemDelegate::calculateTextRect(const QRect &rect) const
{
...
SearchWidget::SearchWidget(QWidget *parent)
    ...
    , m_completer(new OceanUICompleter(m_model, this))
    ...
    , m_bIsChinese(false)
{
    ...
    OceanUICompleterStyledItemDelegate *delegate = new OceanUICompleterStyledItemDelegate(m_completer);
