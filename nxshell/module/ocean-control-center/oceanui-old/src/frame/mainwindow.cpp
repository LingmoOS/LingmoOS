...
const QString ControlCenterConfig = QStringLiteral("org.lingmo.ocean.control-center");
...
const QString ControlCenterGroupName =
        "com.lingmo.ocean-grand-search.group.ocean-control-center-setting";

MainWindow::MainWindow(QWidget *parent)
    : DMainWindow(parent)
    , m_backwardBtn(new DIconButton(QStyle::SP_ArrowBack, this))
    , m_dconfig(DConfig::create(
              "org.lingmo.ocean.control-center", ControlCenterConfig, QString(), this))
...
void MainWindow::openManual()
{
    ...
    QDBusMessage reply = interface.call("OpenTitle", "ocean", helpTitle);
