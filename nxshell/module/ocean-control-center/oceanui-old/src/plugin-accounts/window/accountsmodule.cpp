...
#include "widgets/oceanuilistview.h"
...
AccountsModule::AccountsModule(QObject *parent)
    : PageModule("accounts", tr("Users"), tr("User management") , DIconTheme::findQIcon("oceanui_nav_accounts"), parent)
    , m_model(nullptr)
    , m_worker(nullptr)
...
QWidget *AccountsModule::initFullNameIcon(ModuleObject *module)
{
    ...
    fullNameBtn->setIcon(DIconTheme::findQIcon("oceanui_edit"));
...
QWidget *AccountsModule::initName(ModuleObject *module)
{
    ...
    shortnameBtn->setPixmap(DIconTheme::findQIcon("oceanui_avatar").pixmap(12, 12));
...
void AccountsModule::onCreateAccount()
{
    ...
    PolkitQt1::Authority::instance()->checkAuthorization("org.lingmo.ocean.accounts.user-administration", PolkitQt1::UnixProcessSubject(getpid()),
