    ...
    , m_path(std::nullopt)
{
    ...
    QList<AvatarItem> items = {
        AvatarItem(tr("Person"), "oceanui_user_human", Role::Person, true),
        AvatarItem(tr("Animal"), "oceanui_user_animal", Role::Animal, true),
        AvatarItem(tr("Illustration"), "oceanui_user_funny", Role::Illustration, true),
        AvatarItem(tr("Expression"), "oceanui_user_emoji", Role::Expression, true),
        AvatarItem(tr("Custom Picture"), "oceanui_user_custom", Role::Custom, true),
    };
