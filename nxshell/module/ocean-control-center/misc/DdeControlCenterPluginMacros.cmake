...
macro(oceanui_build_plugin)
    ...
    set(plugin_dirs ${PROJECT_BINARY_DIR}/lib/${OCEAN_CONTROL_CENTER_PLUGIN_DIR}/${_config_NAME}/)
...
function(oceanui_install_plugin)
    oceanui_build_plugin(${ARGN})
    install(DIRECTORY ${plugin_dirs} DESTINATION ${OCEAN_CONTROL_CENTER_PLUGIN_INSTALL_DIR}/${_config_NAME})
endfunction()

function(oceanui_handle_plugin_translation)
    ...
    # /usr/share/ocean-control-center/translations/xxx.qm
    file(GLOB QM_FILES  "${CMAKE_CURRENT_BINARY_DIR}/*.qm")
    list(APPEND QM_FILES ${TRANSLATED_FILES})
    install(FILES ${QM_FILES} DESTINATION ${OCEAN_CONTROL_CENTER_TRANSLATION_INSTALL_DIR})
endfunction()
