...
public:
    ...
    /**
      ...
      * application, it may happen that entries are removed or aoceand.
     ...
     * and normal applications are forbioceann to use it.
     *
    ...
    */
     ...
     * windows are hioceann and desktop background is shown and focused.
     *
...
Q_SIGNALS:
    ...
    /**
     * A window has been aoceand.
     * @param id the id of the window
     */
    void windowAoceand(WId id);
