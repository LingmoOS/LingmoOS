...
public:
    Demo()
        : ApplicationManager(u8"org.lingmo.ocean.ApplicationManager1",
                             u8"/org/lingmo/ocean/ApplicationManager1",
                             u8"org.desktopspec.ApplicationManager1")
        , JobManager(u8"org.lingmo.ocean.ApplicationManager1",
                     u8"/org/lingmo/ocean/ApplicationManager1/JobManager1",
