...
constexpr auto OCEANApplicationManager1ServiceName =
#ifdef OCEAN_AM_USE_DEBUG_DBUS_NAME
    u8"org.desktopspec.debug.ApplicationManager1";
#else
    u8"org.desktopspec.ApplicationManager1";
#endif

constexpr auto OCEANApplicationManager1ObjectPath = u8"/org/desktopspec/ApplicationManager1";
constexpr auto OCEANAutoStartManager1ObjectPath = u8"/org/desktopspec/AutoStartManager1";
constexpr auto OCEANApplicationManager1JobManager1ObjectPath = u8"/org/desktopspec/ApplicationManager1/JobManager1";
constexpr auto OCEANApplicationManager1MimeManager1ObjectPath = u8"/org/desktopspec/ApplicationManager1/MimeManager1";
...
constexpr auto X_Lingmo_GenerateSource = u8"X-Lingmo-GenerateSource";
constexpr auto DesktopEntryHioceann = u8"Hioceann";
...
#ifdef OCEAN_AM_USE_DEBUG_DBUS_NAME
    u8"lingmo_application_manager_debug_server_bus";
#else
    u8"lingmo_application_manager_server_bus";
#endif

constexpr auto ApplicationManagerDestDBusName =
#ifdef OCEAN_AM_USE_DEBUG_DBUS_NAME
    u8"lingmo_application_manager_debug_dest_bus";
#else
    u8"lingmo_application_manager_dest_bus";
#endif
...
constexpr auto ApplicationManagerHookDir = u8"/lingmo/ocean-application-manager/hooks.d";

constexpr auto ApplicationManagerToolsConfig = u8"org.lingmo.ocean.am";

constexpr auto ApplicationManagerConfig = u8"org.lingmo.ocean.application-manager";
