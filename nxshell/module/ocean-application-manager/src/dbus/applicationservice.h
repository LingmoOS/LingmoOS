...
public:
    ...
    Q_PROPERTY(QString X_Lingmo_Vendor READ X_Lingmo_Vendor)
    [[nodiscard]] QString X_Lingmo_Vendor() const noexcept;
...
Q_SIGNALS:
    void InterfacesAoceand(const QDBusObjectPath &object_path, const ObjectInterfaceMap &interfaces);
