...
Q_LOGGING_CATEGORY(OCEANAMProf, "ocean.am.prof", QtInfoMsg)
...
int main(int argc, char *argv[])
{
    ...
    auto storageDir = getXDGDataHome() + QDir::separator() + "lingmo" + QDir::separator() + "ApplicationManager";
    ...
    qCInfo(OCEANAMProf) << std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count() << "ms";
    return 0;
#else
