...
ObjectMap getManagedObjects()
{
    ...
    auto msg = QDBusMessage::createMethodCall(
        OCEANApplicationManager1ServiceName, OCEANApplicationManager1ObjectPath, ObjectManagerInterface, "GetManagedObjects");
...
QString Launcher::appId() const
{
    ...
    const auto startIndex = QString(OCEANApplicationManager1ObjectPath).size();
