...
Image editor 是深度开发的用于  lingmo-image-viewer 和 lingmo-album 的图像处理公共库。
...
如果你使用的是 [Lingmo](https://distrowatch.com/table.php?distribution=lingmo) 或者其它提供了image-editor的发行版:
