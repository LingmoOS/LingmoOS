...
Image editor is a public library for lingmo-image-viewer and lingmo-album  developed by Lingmo Technology.
...
Assume you are using [Lingmo](https://distrowatch.com/table.php?distribution=lingmo) or other debian-based distro which got image-editor delivered:
