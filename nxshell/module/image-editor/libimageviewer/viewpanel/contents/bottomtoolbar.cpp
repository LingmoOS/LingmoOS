...
{
    m_ocrIsExists = Libutils::base::checkCommandExist("lingmo-ocr");
...
//        m_clBT->setIcon(QIcon::fromTheme("oceanui_ccollection"));
...
//        Q_UNUSED(themeType);
//        m_clBT->setIcon(QIcon::fromTheme("oceanui_collection_normal"));
//        m_clBT->setIconSize(QSize(36, 36));
...
//    AC_SET_ACCESSIBLE_NAME(m_backButton, BottomToolbar_Back_Button);
    m_backButton->setIcon(QIcon::fromTheme("oceanui_back"));
...
//    AC_SET_ACCESSIBLE_NAME(m_preButton, BottomToolbar_Pre_Button);
    ...
    m_preButton->setIcon(QIcon::fromTheme("oceanui_previous"));
...
//    AC_SET_ACCESSIBLE_NAME(m_nextButton, BottomToolbar_Next_Button);
    ...
    m_nextButton->setIcon(QIcon::fromTheme("oceanui_next"));
...
//    AC_SET_ACCESSIBLE_NAME(m_adaptImageBtn, BottomToolbar_AdaptImg_Button);
    ...
    m_adaptImageBtn->setIcon(QIcon::fromTheme("oceanui_11"));
...
//    AC_SET_ACCESSIBLE_NAME(m_adaptScreenBtn, BottomToolbar_AdaptScreen_Button);
    m_adaptScreenBtn->setIcon(QIcon::fromTheme("oceanui_fit"));
...
//    AC_SET_ACCESSIBLE_NAME(m_clBT, BottomToolbar_Collect_Button);
    ...
    if (m_ocrIsExists) {
        ...
        m_ocrBtn->setIcon(QIcon::fromTheme("oceanui_ocr"));
...
//    AC_SET_ACCESSIBLE_NAME(m_rotateLBtn, BottomToolbar_Rotate_Left_Button);
    ...
    m_rotateLBtn->setIcon(QIcon::fromTheme("oceanui_left"));
...
//    AC_SET_ACCESSIBLE_NAME(m_rotateRBtn, BottomToolbar_Rotate_Right_Button);
    ...
    m_rotateRBtn->setIcon(QIcon::fromTheme("oceanui_right"));
...
//    AC_SET_ACCESSIBLE_NAME(m_trashBtn, BottomToolbar_Trash_Button);
    m_trashBtn->setIcon(QIcon::fromTheme("oceanui_delete"));
