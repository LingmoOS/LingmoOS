...
// DBus
static const QString s_EnhanceService = "com.lingmo.imageenhance";
static const QString s_EnhancePath = "/com/lingmo/imageenhance";
static const QString s_EnhanceInterface = "com.lingmo.imageenhance";
// DBus Interface
...
void AIModelService::saveFileDialog(const QString &filePath, QWidget *target)
{
    ...
    expiredDialog.setIcon(QIcon::fromTheme("lingmo-image-viewer"));
...
void AIModelService::showWarningDialog(const QString &notify, QWidget *target)
{
    ...
    dialog.setIcon(QIcon::fromTheme("lingmo-image-viewer"));
    dialog.setMessage(" ");
