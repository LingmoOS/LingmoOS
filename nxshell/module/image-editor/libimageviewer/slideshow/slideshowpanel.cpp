...
SlideShowBottomBar::SlideShowBottomBar(QWidget *parent) : DFloatingWidget(parent)
{
    ...
    m_preButton->setIcon(QIcon::fromTheme("oceanui_previous_normal"));
    ...
    m_playpauseButton->setIcon(QIcon::fromTheme("oceanui_suspend_normal"));
...
//    connect(dApp->signalM, &SignalManager::initSlideShowButton, this, &SlideShowBottomBar::onInitSlideShowButton);
    ...
    m_nextButton->setIcon(QIcon::fromTheme("oceanui_next_normal"));
    ...
    m_cancelButton->setIcon(QIcon::fromTheme("oceanui_exit_normal"));
...
{
    if (!isStop) {
        m_playpauseButton->setIcon(QIcon::fromTheme("oceanui_play_normal"));
