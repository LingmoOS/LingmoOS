...
#define HOST_PORT       80
#define SERVER_ADDR     "printer.lingmo.com"
#define OS_VERSION      "eagle"
#define DRIVER_PLATFORM_URL "https://driver.uniontech.com/api/v1/drive/search"
static QMap<int, QString> LingmoTypeStrMap({{0, "unknown"}, {1, "apricot"}, {2, "eagle"}, {3, "fou"}, {4, "plum"}});
...
zSettings *zSettings::getInstance()
{
    ...
    QString configFile = strHome + "/.config/ocean-printer.ini";
