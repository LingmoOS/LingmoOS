...
TRANSLATIONS  +=  translations/ocean-printer.ts
...
desktop.files = $${PWD}/platform/linux/ocean-printer.desktop

hicolor.path =  $${PREFIX}/share/icons/hicolor/48x48/apps
hicolor.files = $${PWD}/images/ocean-printer.svg

trans.path =  $${PREFIX}/share/ocean-printer/translations
trans.files = $${PWD}/translations/*.qm

polkit.path = $${PREFIX}/share/polkit-1/actions
polkit.files = $${PWD}/policy/com.lingmo.pkexec.devPrinter.policy

dconfigfile.path = $${PREFIX}/share/dsg/configs/ocean-printer
dconfigfile.files = $${PWD}/logconf/org.lingmo.ocean.printer.json

debugconf.path = $${PREFIX}/share/lingmo-debug-config/lingmo-debug-config.d
debugconf.files = $${PWD}/logconf/ocean-printer_debug.json

logconf.path = $${PREFIX}/share/lingmo-log-viewer/lingmo-log.conf.d
logconf.files = $${PWD}/logconf/ocean-printer.json

canonscript.path = /opt/lingmo/ocean-printer/printer-drivers/cndrvcups-capt/
