# Lingmo Desktop Environment Print Manager {#mainpage}

Lingmo Desktop Environment Print Manager(ocean-printer) is an easy tool to manage printers.
...
Lingmo Desktop Environment Print Manager is licensed under [GPL-3.0-or-later](LICENSE).
