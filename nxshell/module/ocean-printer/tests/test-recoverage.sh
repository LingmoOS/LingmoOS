...
BUILD_DIR=build
REPORT_DIR=report
PROJECT_REALNAME=ocean-printer
...
../tests --gtest_output=xml:ocean_test_report_${PROJECT_REALNAME}.xml
...
cp $BUILD_DIR/ocean_test_report_${PROJECT_REALNAME}.xml ../$BUILDUT_DIR

cd ../$BUILDUT_DIR
mv ./report ./html
cd html
mv ./index.html ./cov_ocean-printer.html
chmod 755 cov_ocean-printer.html

cd ..
mkdir report
mv ocean_test_report_${PROJECT_REALNAME}.xml ./report/report_${PROJECT_REALNAME}.xml
