...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到「列印管理器」按鈕 ![ocean_printer](../common/ocean_printer.svg)，單擊開啟。
3. 右鍵單擊 ![ocean_printer](../common/ocean_printer.svg)，您可以：
   - 單擊 **建立桌面捷徑**，在桌面建立捷徑。
...
- 右鍵單擊任務欄上的 ![ocean_printer](../common/ocean_printer.svg) 圖示，選擇 **全部關閉** 來關閉列印管理器。
