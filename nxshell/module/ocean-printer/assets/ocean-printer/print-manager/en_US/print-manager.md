...
1. Click ![lingmo_launcher](../common/lingmo_launcher.svg) on the Dock to enter the interface of launcher.
2. Locate ![ocean_printer](../common/ocean_printer.svg) by scrolling the mouse wheel or searching "Print Manager" in the Launcher interface and click it to run. 
3. Right-click![ocean_printer](../common/ocean_printer.svg) to:
...
- Right-click ![ocean_printer](../common/ocean_printer.svg) on the Dock, select **Close all** to exit.
...
When the printer is connected to the computer through USB, the printer will be automatically aoceand to Print Manager in background, and you can operate according to the configuration results.
...
Once a printer is aoceand successfully, when you click the printer in the interface of Print Manager, you can see buttons on the right, which are "Properties", "Print Queue", "Print Test Page", "Supplies" and "Troubleshoot". 
...
3. Basic server settings include: 
   ...
   - Publish shared printers connected to this system: Allow printing from the Internet. Check this option to share the aoceand printers to users in the same LAN.
