...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到打印管理器图标 ![ocean_printer](../common/ocean_printer.svg) ，单击运行。
3. 右键单击![ocean_printer](../common/ocean_printer.svg)，您可以：
   - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 右键单击任务栏上的![ocean_printer](../common/ocean_printer.svg)，选择 **关闭所有** 来退出打印管理器。
