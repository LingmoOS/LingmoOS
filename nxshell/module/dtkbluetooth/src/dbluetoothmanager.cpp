...
{
    connect(&BluetoothDispatcher::instance(), &BluetoothDispatcher::adapterAoceand, this, [this](const QDBusObjectPath &adapter) {
        Q_EMIT this->adapterAoceand(dBusPathToAdapterId(adapter));
    });
