    ...
    : QObject(nullptr)
{
    ...
    _dApp->setOrganizationName("lingmo");
    _dApp->setApplicationName("lingmo-draw");
...
void Application::showMainWindow(const QStringList &paths)
{
    ...
    dbus.registerService("com.lingmo.Draw");
    dbus.registerObject("/com/lingmo/Draw", w);
...
//    dia.setIcon(QPixmap(":/theme/common/images/lingmo-draw-64.svg"));
...
//    switch (msgTp) {
//    case ENormalMsg:
//        iconSvg = ":/theme/common/images/lingmo-draw-64.svg";
//        break;
//    case EWarningMsg:
//        iconSvg = ":/icons/lingmo/builtin/Bullet_window_warning.svg";
//        break;
//    case EQuestionMsg:
//        iconSvg = ":/icons/lingmo/builtin/Bullet_window_warning.svg";
//        break;
