...
class DRAWLIB_EXPORT LayerItemAoceand : public LayerUndoCommand
{
public:
    ...
    explicit LayerItemAoceand(ChangedType tp);
    ~LayerItemAoceand();
    ...
    static UndoCommand *creatLayerItemAoceandCommand();
...
class DRAWLIB_EXPORT LayerGroupAoceand: public LayerUndoCommand
{
public:
    enum Type {ADD, REMOVE};
    LayerGroupAoceand(Type tp = ADD);
    ~LayerGroupAoceand();
...
private:
    GroupItem *aoceandGroup = nullptr;
    QList<PageItem *> items;
