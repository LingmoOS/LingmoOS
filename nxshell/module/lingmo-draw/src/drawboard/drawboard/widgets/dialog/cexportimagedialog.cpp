...
void CExportImageDialog::initUI()
{
    ...
    setIcon(QIcon::fromTheme("lingmo-draw"));
...
int CExportImageDialog::execCheckFile(const QString &text)
{
    ...
    if (fileName.startsWith(".")) {
        int status = MessageDlg::execMessage(tr("This file will be hioceann if the file name starts with a dot (.). Do you want to hide it?"), EWarningMsg,
