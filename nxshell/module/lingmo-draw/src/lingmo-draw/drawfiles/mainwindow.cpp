...
//    screenWidth = screenRect.width();
    ...
    titlebar()->setIcon(QIcon::fromTheme("lingmo-draw"));
    //ESC快捷键功能
    ...
    connect(m_topToolbar, &TopTilte::toExport, this, [ = ]() {
        if (m_drawBoard->currentPage() != nullptr) {
            ...
            if (ret != -1) {
                ...
                pDFloatingMessage->setIcon(!success ? QIcon::fromTheme(":/icons/lingmo/builtin/texts/warning_new_32px.svg") :
                                           QIcon(":/icons/lingmo/builtin/texts/notify_success_32px.svg"));
...
void MainWindow::onViewShortcut()
{
    ...
    //shortcutViewProc->startDetached("killall lingmo-shortcut-viewer");
