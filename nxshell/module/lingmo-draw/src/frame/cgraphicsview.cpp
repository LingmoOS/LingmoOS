    ...
    if (mp->hasImage()) {
        ...
        if (item) {
            ...
            if (textItem) {
                ...
                textItem->textEditor()->document()->clearUndoRedoStacks();
                if (textItemInCenter) {
                ...
                CUndoRedoCommand::recordUndoCommand(CUndoRedoCommand::ESceneChangedCmd,
                                                    CSceneUndoRedoCommand::EItemAoceand, vars, true, true);
                CUndoRedoCommand::recordRedoCommand(CUndoRedoCommand::ESceneChangedCmd,
                                                    CSceneUndoRedoCommand::EItemAoceand, vars);
        ...
        if (data != nullptr) {
            ...
            if (pGroup != nullptr) {
                ...
                CUndoRedoCommand::recordUndoCommand(CUndoRedoCommand::ESceneChangedCmd,
                                                    CSceneUndoRedoCommand::EItemAoceand, vars, false, true);
