    ...
    if (_noticeOnfinished) {
        ...
        for (CUndoRedoCommand *pCmd : _allCmds) {
            ...
            if (pItemCmd != nullptr) {
                ...
                bool finished = false;
                switch (pSceneCmd->tp()) {
                case CSceneUndoRedoCommand::EItemAoceand:
...
CSceneUndoRedoCommand *CSceneUndoRedoCommand::getCmdBySceneCmdInfo(const CUndoRedoCommand::SCommandInfoCouple &info)
{
    ...
    case EItemAoceand:
    case EItemRemoved: {
        pCmd = new CSceneItemNumChangedCommand(expTp == EItemAoceand ? CSceneItemNumChangedCommand::Aoceand : CSceneItemNumChangedCommand::Removed);
        break;
    }
    case EGroupChanged: {
...
CSceneItemNumChangedCommand::CSceneItemNumChangedCommand(EChangedType tp)
    : CSceneUndoRedoCommand(EItemAoceand)
    , _changedTp(tp)
{
}
    ...
    : _doRedo(doRedo), _pScene(pScene), _scenChangedType(EchangedTp)
{
    ...
    } else if (EchangedTp == CSceneUndoRedoCommand::EItemAoceand || EchangedTp == CSceneUndoRedoCommand::EItemRemoved) {
...
CCmdBlock::~CCmdBlock()
{
    if (_pScene != nullptr) {
        ...
        if (_scenChangedType != CSceneUndoRedoCommand::EItemAoceand && _scenChangedType != CSceneUndoRedoCommand::EItemRemoved) {
