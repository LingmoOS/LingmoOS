...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到畫板 ![draw](../common/lingmo_draw.svg) 單擊執行。
3. 右鍵單擊 ![draw](../common/lingmo_draw.svg)，您可以：
 - 單擊 **建立桌面捷徑**，在桌面建立捷徑。
 - 單擊 **釘選到Dock**，將應用程式固定到Dock。
 - 單擊 **開機啟動**，將應用程式添加到開機啟動項，在電腦開機時自動執行該應用。

![tips](../common/tips.svg) 竅門：您可以在控制中心中將畫板設定為預設的圖片查看程式，具體操作請參考 [預設程式設定](dman:///ocean#預設程式設定)。

### 關閉畫板

- 在畫板介面單擊  ![close_icon](../common/close_icon.png)，關閉畫板。
- 在任務欄右鍵單擊 ![draw](../common/lingmo_draw.svg)，選擇 **全部關閉**，關閉畫板。
