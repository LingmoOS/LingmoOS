...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到画板图标 ![draw](../common/lingmo_draw.svg)，单击运行。
3. 右键单击 ![draw](../common/lingmo_draw.svg)，您可以：
 - 单击 **发送到桌面**，在桌面创建快捷方式。
 - 单击 **发送到任务栏**，将应用程序固定到任务栏。
 - 单击 **开机自动启动**，将应用程序添加到开机启动项，在电脑开机时自动运行该应用。

![tips](../common/tips.svg)窍门：您可以在控制中心中将画板设置为默认的图片查看程序，具体操作请参考 [默认程序设置](dman:///ocean#默认程序设置)。

### 关闭画板

- 在画板界面单击 ![close_icon](../common/close_icon.png)，退出画板。
- 在任务栏右键单击 ![draw](../common/lingmo_draw.svg)，选择 **关闭所有**，退出画板。
