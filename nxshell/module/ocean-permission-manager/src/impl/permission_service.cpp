...
const QString polikitPermissionActionId = "org.lingmo.ocean.permission.modify-app-permissions";
const QString dbusErrorName = "org.lingmo.ocean.Permission1.";
...
void PermissionService::ShowDisablePermissionDialog(const QString &appId, const QString &permissionGroup, const QString &permissionId)
{
    ...
    org::lingmo::ocean::Permission1::Client client("org.lingmo.ocean.Permission1.Client", "/org/lingmo/ocean/Permission1/Client", QDBusConnection::sessionBus());
        ...
        for (auto it1 = mapTmp.begin(); it1 != mapTmp.end(); ++it1) {
            ...
            for (int i = 0; i < m_groupPermissionInfo.size(); ++i) {
                ...
                if (!it2->group.contains("group") || (it2->group.contains("group") && it2->group["group"] != group)) {
                    ...
                    groupPmInfoAoceand = true;
                    bool pmInfoAoceand = false;
