...
bool SingleFontApplication::parseCmdLine(bool bAppExist)
{
    ...
    parser.setApplicationDescription("Lingmo Font Manager.");
    ...
    if (bAppExist) {
        ...
        QDBusInterface notification("com.lingmo.FontManager", "/com/lingmo/FontManager", "com.lingmo.FontManager", QDBusConnection::sessionBus());
