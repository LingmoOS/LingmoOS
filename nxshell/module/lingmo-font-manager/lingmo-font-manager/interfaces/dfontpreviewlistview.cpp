...
/*************************************************************************
 ...
 <Note>          null
*************************************************************************/
void DFontPreviewListView::onMultiItemsAoceand(QList<DFontPreviewItemData> &data, DFontSpinnerWidget::SpinnerStyles styles)
{
    if (data.isEmpty())
        return;
...
/*************************************************************************
 <Function>      onStartupMultiItemAoceand
 ...
 <Note>          null
*************************************************************************/
void DFontPreviewListView::onStartupMultiItemAoceand(QList<DFontPreviewItemData> &data)
{
...
void DFontPreviewListView::initConnections()
{
    ...
    connect(this, &DFontPreviewListView::multiItemsAoceand, this, &DFontPreviewListView::onMultiItemsAoceand);
    connect(this, &DFontPreviewListView::refreshListview, this, &DFontPreviewListView::onRefreshListview);
    //  connect(this, &DFontPreviewListView::startupMultiItemsAoceand, this, &DFontPreviewListView::onStartupMultiItemAoceand);
...
//        m_parentWidget->showSpinner(DFontSpinnerWidget::Load);
        ...
        connect(m_dataLoadThread, &LoadFontDataThread::dataLoadFinish, this, &DFontPreviewListView::onStartupMultiItemAoceand);
    }
}
...
void DFontPreviewListView::updateModel(int deleteCount, bool showSpinner)
{
    ...
    onMultiItemsAoceand(modelist, spinnerstyle);
...
void DFontPreviewListView::selectFonts(const QStringList &fileList)
{
    ...
    Q_EMIT requestInstFontsUiAoceand();
    //同步tab聚焦状态
    syncTabStatus();
}
