...
DFontMgrMainWindow::~DFontMgrMainWindow()
{
    ...
    dbus.unregisterService("com.lingmo.FontManager");
}
...
void DFontMgrMainWindow::initTileFrame()
{
    ...
    //Add logo
    titlebar()->setIcon(QIcon::fromTheme(LINGMO_FONT_MANAGER));
...
{
    D_D(DFontMgrMainWindow);
    setWindowIcon(QIcon::fromTheme(LINGMO_FONT_MANAGER));
...
void DFontMgrMainWindow::onInstallWindowDestroyed(QObject *)
{
    ...
    if (m_installOutFileList.size() > 0) {
        ...
        Q_EMIT DFontPreviewListDataThread::instance()->requestAoceand(m_installOutFileList);
...
/*************************************************************************
 <Function>      onRequestInstFontsUiAoceand
 ...
 <Note>          null
*************************************************************************/
void DFontMgrMainWindow::onRequestInstFontsUiAoceand()
{
