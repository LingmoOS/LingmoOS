...
void FontIconText::paintEvent(QPaintEvent *event)
{
    ...
    if (m_isTtf == true) {
        //then draw text
        m_fontIcon = QIcon("/usr/share/icons/bloom/mimetypes/256/font-ttf.svg");// QIcon::fromTheme("lingmo-font-manager");
    } else {
        m_fontIcon = QIcon("/usr/share/icons/bloom/mimetypes/256/font-x-generic.svg");// QIcon::fromTheme("lingmo-font-manager");
    }
