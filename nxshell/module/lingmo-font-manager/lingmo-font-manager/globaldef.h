...
#define LINGMO_FILE_MANAGE_NAME "ocean-file-manager"
...
//Lingmo manaul binary name
#define LINGMO_MANUAL_NAME "dman"

//Font manager binary name
#define LINGMO_FONT_MANAGER "lingmo-font-manager"
