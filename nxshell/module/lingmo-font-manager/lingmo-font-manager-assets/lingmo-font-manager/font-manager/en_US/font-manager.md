# Font Manager|lingmo-font-manager|
...
1. Click the Launcher icon ![launcher](../common/lingmo_launcher.svg) in the Dock to enter the Launcher interface.

2. Locate Font Manager ![lingmo_font_manager](../common/lingmo_font_manager.svg) by scrolling the mouse wheel or searching "font manager" in the Launcher interface, and click it to run.

3. Right-click ![lingmo_font_manager](../common/lingmo_font_manager.svg) , and you can:
...
- Right-click ![lingmo_font_manager](../common/lingmo_font_manager.svg) in the Dock, and select **Close All** to exit.
...
-  Right-click the font file and select **Open with** > ![lingmo_font_manager](../common/lingmo_font_manager.svg) **Font Manager** to enter the Font Manager interface, and install the font.
