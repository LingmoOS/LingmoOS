...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到字體管理器圖標 ![lingmo_font_manager](../common/lingmo_font_manager.svg)，單擊運行。
...
- 在任務欄右鍵單擊 ![lingmo_font_manager](../common/lingmo_font_manager.svg)，選擇 **關閉所有**，關閉字體管理器。
...
- 右鍵單擊字體文件並選擇 **打開方式** > ![lingmo_font_manager](../common/lingmo_font_manager.svg)**字體管理器**，進入字體管理器界面，安裝字體。
- 雙擊字體文件，安裝字體。
- 將字體文件拖拽到字體管理器界面或圖標上。
