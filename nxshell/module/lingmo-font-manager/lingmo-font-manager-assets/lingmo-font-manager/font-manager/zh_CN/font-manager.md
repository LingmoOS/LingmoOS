...
1. 单击任务栏上的启动器图标 ![launcher](../common/lingmo_launcher.svg)，进入启动器界面。
2. 上下滚动鼠标滚轮浏览或通过搜索，找到字体管理器图标 ![lingmo_font_manager](../common/lingmo_font_manager.svg)，单击运行。
3. 右键单击 ![lingmo_font_manager](../common/lingmo_font_manager.svg)，您可以：
...
- 在任务栏右键单击 ![lingmo_font_manager](../common/lingmo_font_manager.svg)，选择 **关闭所有** ，退出字体管理器。
...
- 右键单击字体文件并选择 **打开方式** > ![lingmo_font_manager](../common/lingmo_font_manager.svg)**字体管理器**，进入字体管理器界面，安装字体。
- 双击字体文件，安装字体。
- 将字体文件拖拽到字体管理器界面或图标上。
