...
#else
#include "ocean-file-manager/dfmfilepreviewplugin.h"
#endif
...
#endif
{
    Q_OBJECT
#ifdef DFM_BASE
    Q_PLUGIN_METADATA(IID FilePreviewFactoryInterface_iid FILE "lingmo-font-preview-plugin.json")
#else
    Q_PLUGIN_METADATA(IID DFMFilePreviewFactoryInterface_iid FILE "lingmo-font-preview-plugin.json")
#endif
