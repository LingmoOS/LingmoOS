...
using LauncherInter = org::lingmo::ocean::daemon::Launcher1;
...
public:
    ...
    virtual void appAoceand(const LauncherItemInfo &info) = 0;
...
public:
    ...
    void appAoceand(const LauncherItemInfo &info) override { Q_UNUSED(info); Q_UNREACHABLE(); }
