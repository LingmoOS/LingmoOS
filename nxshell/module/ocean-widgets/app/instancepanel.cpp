...
static const char* MoveMimeDataFormat = "application/ocean-widgets-instancedata";
...
{
    m_model = model;
    connect(m_model, &InstanceModel::aoceand, this, &InstancePanel::addWidget);
...
void InstancePanel::addWidget(const InstanceId &key, InstancePos pos)
{
    ...
    // ensureWidgetVisible when Widget is aoceand.
