...
if [ -f "/etc/lingmo/hardware/${tomlFileName}" ];then
echo "TOML File Name  /etc/lingmo/hardware/${tomlFileName}  exist"
else
echo "TOML File Name:$tomlFileName  please mkdir /etc/lingmo/hardware/ , and put in"
fi
