...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到設備管理器圖標 ![lingmo_devicemanager](../common/lingmo_devicemanager.svg)，單擊運行。
...
- 右鍵單擊任務欄上的 ![lingmo_devicemanager](../common/lingmo_devicemanager.svg)，選擇 **關閉所有** 來退出設備管理器。
