...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到设备管理器图标 ![lingmo_devicemanager](../common/lingmo_devicemanager.svg) ，并单击运行。

3. 右键单击 ![lingmo_devicemanager](../common/lingmo_devicemanager.svg) ，您可以：
...
- 右键单击任务栏上的 ![lingmo_devicemanager](../common/lingmo_devicemanager.svg) ，选择 **关闭所有** 来退出设备管理器。
