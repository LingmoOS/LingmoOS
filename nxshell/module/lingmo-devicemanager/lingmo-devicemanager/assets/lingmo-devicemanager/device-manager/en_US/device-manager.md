# Device Manager|lingmo-devicemanager|
...
2. Locate ![lingmo_devicemanager](../common/lingmo_devicemanager.svg) by scrolling the mouse wheel or searching "Device Manager" in the Launcher interface and click it to run. 

3. Right-click ![lingmo_devicemanager](../common/lingmo_devicemanager.svg) to:
...
- Right-click ![lingmo_devicemanager](../common/lingmo_devicemanager.svg)  on the Dock, select **Close all** to exit.
