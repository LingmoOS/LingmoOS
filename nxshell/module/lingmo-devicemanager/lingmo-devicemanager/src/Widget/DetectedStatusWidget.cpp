...
#ifdef OS_BUILD_V23
const QString SERVICE_NAME = "org.lingmo.ocean.ShutdownFront1";
const QString DEVICE_SERVICE_PATH = "/org/lingmo/ocean/ShutdownFront1";
const QString DEVICE_SERVICE_INTERFACE = "org.lingmo.ocean.ShutdownFront1";
#else
const QString SERVICE_NAME = "com.lingmo.ocean.shutdownFront";
const QString DEVICE_SERVICE_PATH = "/com/lingmo/ocean/shutdownFront";
const QString DEVICE_SERVICE_INTERFACE = "com.lingmo.ocean.shutdownFront";
#endif
...
void DetectedStatusWidget::setDetectFinishUI(const QString &size, const QString &model, bool hasInstall)
{
    hideAll();
    // Icon Label
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/update.svg"));
...
void DetectedStatusWidget::setInstallSuccessUI(const QString &success, const QString &failed)
{
    hideAll();
    // Icon Label
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/latest.svg"));
    QPixmap pic = icon.pixmap(ICON_LABEL_SIZE, ICON_LABEL_SIZE);
    mp_PicLabel->setPixmap(pic);
...
void DetectedStatusWidget::setInstallFailedUI()
{
    hideAll();
    // Icon Label
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/update failed.svg"));
    QPixmap pic = icon.pixmap(ICON_LABEL_SIZE, ICON_LABEL_SIZE);
    mp_PicLabel->setPixmap(pic);
...
void DetectedStatusWidget::setNetworkErrorUI(const QString &speed, int progressValue)
{
    hideAll();
    // Icon Label
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/erro-96.svg"));
    QPixmap pic = icon.pixmap(ICON_LABEL_SIZE, ICON_LABEL_SIZE);
    mp_PicLabel->setPixmap(pic);
...
void DetectedStatusWidget::setBackableDriverUI(int backableSize, int backedupSize)
{
    ...
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/backup_96.svg"));
    QPixmap pic = icon.pixmap(ICON_LABEL_SIZE, ICON_LABEL_SIZE);
    mp_PicLabel->setPixmap(pic);
...
void DetectedStatusWidget::setRestoreDriverUI(int restorableSize)
{
    ...
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/restore_96.svg"));
    QPixmap pic = icon.pixmap(ICON_LABEL_SIZE, ICON_LABEL_SIZE);
    mp_PicLabel->setPixmap(pic);
