...
void DriverScanWidget::setScanFailedUI()
{
    hideAll();
    // Scan Failed Label
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/fail.svg"));
...
void DriverScanWidget::setNetworkErr()
{
    hideAll();
    // Scan Failed Label
    QIcon icon(QIcon::fromTheme(":/icons/lingmo/builtin/icons/erro-128.svg"));
    QPixmap pix = icon.pixmap(ICON_LABEL_SIZE, ICON_LABEL_SIZE);
    mp_ErrPicLabel->setPixmap(pix);
    mp_ErrPicLabel->show();
...
void DriverScanWidget::initUI()
{
    this->setLineWidth(0);
    // 设置动画关键帧
    mp_ScanningPicLabel->setImageList(QStringList() << ":/icons/lingmo/builtin/icons/animation/0.png"
                                      << ":/icons/lingmo/builtin/icons/animation/1.png"
                                      << ":/icons/lingmo/builtin/icons/animation/2.png"
                                      << ":/icons/lingmo/builtin/icons/animation/3.png"
                                      << ":/icons/lingmo/builtin/icons/animation/4.png"
                                      << ":/icons/lingmo/builtin/icons/animation/5.png"
                                      << ":/icons/lingmo/builtin/icons/animation/6.png"
                                      << ":/icons/lingmo/builtin/icons/animation/7.png");
