...
#ifdef OS_BUILD_V23
const QString INPUT_SERVICE_NAME = "org.lingmo.ocean.InputDevices1";
const QString INPUT_WAKEUP_SERVICE_PATH = "/org/lingmo/ocean/InputDevices1";
const QString INPUT_WAKEUP_INTERFACE = "org.lingmo.ocean.InputDevices1";
#else
const QString INPUT_SERVICE_NAME = "com.lingmo.system.InputDevices";
const QString INPUT_WAKEUP_SERVICE_PATH = "/com/lingmo/system/InputDevices";
const QString INPUT_WAKEUP_INTERFACE = "com.lingmo.system.InputDevices";
#endif
