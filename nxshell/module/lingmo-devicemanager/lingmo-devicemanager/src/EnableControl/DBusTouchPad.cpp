...
const QString Path = "/org/lingmo/ocean/InputDevice1/TouchPad";
const QString Interface = "org.lingmo.ocean.InputDevice1.TouchPad";
#else
const QString Service = "com.lingmo.daemon.InputDevices";
const QString Path = "/com/lingmo/daemon/InputDevice/TouchPad";
const QString Interface = "com.lingmo.daemon.InputDevice.TouchPad";
#endif
