...
QMap<DriverType, QString> CommonTools::m_MapDriverIcon = {
    {DR_Bluetooth, QString(":/icons/lingmo/builtin/icons/bluetooth.svg")}
    , {DR_Camera, QString(":/icons/lingmo/builtin/icons/image.svg")}
    , {DR_Gpu, QString(":/icons/lingmo/builtin/icons/GPU.svg")}
    , {DR_Keyboard, QString(":/icons/lingmo/builtin/icons/keyboard.svg")}
    , {DR_Sound, QString(":/icons/lingmo/builtin/icons/voice.svg")}
    , {DR_Mouse, QString(":/icons/lingmo/builtin/icons/mouse.svg")}
    , {DR_Network, QString(":/icons/lingmo/builtin/icons/network.svg")}
    , {DR_Printer, QString(":/icons/lingmo/builtin/icons/printer.svg")}
    , {DR_Scaner, QString(":/icons/lingmo/builtin/icons/scaner.svg")}
    , {DR_Tablet, QString(":/icons/lingmo/builtin/icons/tablet.svg")}
    , {DR_WiFi, QString(":/icons/lingmo/builtin/icons/Wi-Fi.svg")}
    , {DR_OtherDevice, QString(":/icons/lingmo/builtin/icons/scaner.svg")}
};
...
QMap<Status, QString> CommonTools::m_MapStatusIcon = {
    {ST_SUCESS, QString(":/icons/lingmo/builtin/icons/ok.svg")}
    , {ST_FAILED, QString(":/icons/lingmo/builtin/icons/warning.svg")}
    , {ST_DOWNLOADING, QString("")}
    , {ST_INSTALL, QString("")}
    , {ST_NOT_INSTALL, QString(":/icons/lingmo/builtin/icons/alert.svg")}
    , {ST_CAN_UPDATE, QString(":/icons/lingmo/builtin/icons/alert.svg")}
    , {ST_WAITING, QString(":/icons/lingmo/builtin/icons/waiting.svg")}
    , {ST_DRIVER_NOT_BACKUP, QString(":/icons/lingmo/builtin/icons/alert.svg")}
    , {ST_DRIVER_BACKING_UP, QString("")}
    , {ST_DRIVER_BACKUP_FAILED, QString(":/icons/lingmo/builtin/icons/warning.svg")}
    , {ST_DRIVER_BACKUP_SUCCESS, QString(":/icons/lingmo/builtin/icons/ok.svg")}
...
{
    QDBusInterface interface("com.lingmo.ocean.ServiceAndSupport",
                              "/com/lingmo/ocean/ServiceAndSupport",
                              "com.lingmo.ocean.ServiceAndSupport");
     ...
     if (reply.isValid()) {
         qCDebug(appLog) << "call com.lingmo.ocean.ServiceAndSupport success";
     } else {
         qCDebug(appLog) << "call com.lingmo.ocean.ServiceAndSupport failed";
     }
}
...
{
    return "/usr/share/lingmo-devicemanager/";
}
