...
#include<QDateTime>
#ifdef OS_BUILD_V23
const QString DISPLAY_SERVICE_NAME = "org.lingmo.ocean.Display1";
const QString DISPLAY_SERVICE_PATH = "/org/lingmo/ocean/Display1";
const QString DISPLAY_INTERFACE = "org.lingmo.ocean.Display1";

const QString DISPLAY_DAEMON_SERVICE_NAME = "org.lingmo.ocean.Display1";
const QString DISPLAY_DAEMON_SERVICE_PATH = "/org/lingmo/ocean/Display1";
const QString DISPLAY_DAEMON_INTERFACE = "org.lingmo.ocean.Display1";
const QString DISPLAY_PROPERTIES_INTERFACE = "org.freedesktop.DBus.Properties";
const QString DISPLAY_MONITOR_INTERFACE = "org.lingmo.ocean.Display1.Monitor";
#else
const QString DISPLAY_SERVICE_NAME = "com.lingmo.system.Display";
const QString DISPLAY_SERVICE_PATH = "/com/lingmo/system/Display";
const QString DISPLAY_INTERFACE = "com.lingmo.system.Display";

const QString DISPLAY_DAEMON_SERVICE_NAME = "com.lingmo.daemon.Display";
const QString DISPLAY_DAEMON_SERVICE_PATH = "/com/lingmo/daemon/Display";
const QString DISPLAY_DAEMON_INTERFACE = "com.lingmo.daemon.Display";
const QString DISPLAY_PROPERTIES_INTERFACE = "org.freedesktop.DBus.Properties";
const QString DISPLAY_MONITOR_INTERFACE = "com.lingmo.daemon.Display.Monitor";
#endif
