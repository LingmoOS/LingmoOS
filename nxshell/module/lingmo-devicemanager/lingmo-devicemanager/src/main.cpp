...
#ifdef OS_BUILD_V23
const QString SERVICE_NAME = "org.lingmo.ocean.Notification1";
const QString DEVICE_SERVICE_PATH = "/org/lingmo/ocean/Notification1";
const QString DEVICE_SERVICE_INTERFACE = "org.lingmo.ocean.Notification1";
#else
const QString SERVICE_NAME = "com.lingmo.ocean.Notification";
const QString DEVICE_SERVICE_PATH = "/com/lingmo/ocean/Notification";
const QString DEVICE_SERVICE_INTERFACE = "com.lingmo.ocean.Notification";
#endif
...
int main(int argc, char *argv[])
{
    ...
    /*if (DGuiApplicationHelper::instance()->setSingleInstance("lingmo-devicemanager",
                                                             DGuiApplicationHelper::UserScope))*/ {
        app.loadTranslator();
        app.setOrganizationName("lingmo");
        app.setApplicationName("lingmo-devicemanager");
        ...
        const QString acknowledgementLink = "https://www.lingmo.org/original/device-manager/";
        app.setApplicationAcknowledgementPage(acknowledgementLink);

        if (!DGuiApplicationHelper::instance()->setSingleInstance(app.applicationName(), DGuiApplicationHelper::UserScope)) {
            exit(0);
        }
        Authority::Result result = Authority::instance()->checkAuthorizationSync("com.lingmo.lingmo-devicemanager.checkAuthentication",
        ...
        QIcon appIcon = QIcon::fromTheme("lingmo-devicemanager");
...
void notify(int argc, char *argv[])
{
    ...
    QString appname("lingmo-devicemanager");
    uint replaces_id = 0;
    QString appicon("lingmo-devicemanager");
    QString title = "";

    QStringList actionlist;
    actionlist << "view" << view;
    QVariantMap hints;
    hints.insert(QString("x-lingmo-action-view"),
                 QVariant(QString("/usr/bin/lingmo-devicemanager,driver")));  //实现查看2按钮点击打开控制中心账户界面)
    int timeout = 3000;
