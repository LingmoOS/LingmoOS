...
void PageDriverManager::testScanDevices()
{
    ...
    info->m_Status = ST_NOT_INSTALL;
    info->m_Checked = true;
    info->m_DriverName = "lingmo-log-viewer";
    info->m_Packages = "lingmo-log-viewer";
    ...
    info->m_Status = ST_NOT_INSTALL;
    info->m_Checked = true;
    info->m_DriverName = "lingmo-reader";
    info->m_Packages = "lingmo-reader";
    ...
    info->m_Status = ST_NOT_INSTALL;
    info->m_Checked = true;
    info->m_DriverName = "lingmo-diskmanager";
    info->m_Packages = "lingmo-diskmanager";
    ...
    info->m_DriverName = "lingmo-calculator";
    info->m_Packages = "lingmo-calculator";
    ...
    info->m_Status = ST_CAN_UPDATE;
    info->m_Checked = false;
    info->m_DriverName = "lingmo-defender";
    info->m_Packages = "lingmo-defender";
...
//    addDriverInfo(info);
    ...
    info->m_Status = ST_CAN_UPDATE;
    info->m_Checked = false;
    info->m_DriverName = "lingmo-system-monitor";
    info->m_Packages = "lingmo-system-monitor";
...
//    addDriverInfo(info);
    ...
    info->m_Checked = false;
    info->m_DriverName = "ocean-introduction";
    info->m_Packages = "ocean-introduction";
