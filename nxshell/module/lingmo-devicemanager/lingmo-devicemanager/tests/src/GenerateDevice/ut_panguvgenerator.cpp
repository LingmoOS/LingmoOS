...
public:
    void SetUp()
    {
        ...
        mapInfo1.insert("OS","Linux version 4.19.0-amd64-desktop (uos@x86-compile-PC) (gcc version 8.3.0 (Uos 8.3.0.5-1+ocean)) #4016 SMP Wed Jun 23 13:35:29 CST 2021");
        ...
        mapInfo2.insert("OS","Linux version 4.19.0-amd64-desktop (uos@x86-compile-PC) (gcc version 8.3.0 (Uos 8.3.0.5-1+ocean)) #4016 SMP Wed Jun 23 13:35:29 CST 2021");
