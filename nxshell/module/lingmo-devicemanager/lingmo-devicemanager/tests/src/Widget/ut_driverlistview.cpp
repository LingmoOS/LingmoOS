...
TEST_F(UT_DriverListView, UT_DriverListView_keyPressEvent_002)
{
    ...
    QString path = "/data/home/jixiaomei/.local/share/Trash/files/lingmo-devicemanager_5.6.12.13-1_arm64.deb";
    QFileInfo info(path);
    ...
    QStandardItem *textItem = new QStandardItem("lingmo-devicemanager_5.6.12.13-1_arm64.deb");
