...
License:        GPLv3+
URL:            https://github.com/lingmoos/lingmo-devicemanager
...
%post
systemctl enable lingmo-devicemanager-server.service
...
/usr/share/dbus-1/services/com.lingmo.Devicemanager.service
/usr/share/polkit-1/actions/com.lingmo.lingmo-devicemanager.policy
/lib/systemd/system/lingmo-devicemanager-server.service
%{_bindir}/lingmo-devicemanager-server
%{_datadir}/lingmo-manual/manual-assets/application/lingmo-devicemanager/device-manager/*
/etc/dbus-1/system.d/com.lingmo.devicemanager.conf
