...
## Installation
sudo apt-get install lingmo-devicemanager
...
## Usage
Caution: lingmo-devicemanager is depend on polkit, So if build from source code, 
you have to add policy to usr/share/polkit-1/actions/. 
add lingmo-devicemanager-authenticateProxy to /usr/bin.
...
- sudo cp authenticateProxy/policy/com.lingmo.pkexec.lingmo-devicemanager-authenticateProxy.policy /usr/share/polkit-1/actions/
- sudo cp build-all-unknown-Debug/authenticateProxy/lingmo-devicemanager-authenticateProxy /usr/bin

- ./lingmo-devicemanager

## License
lingmo-devicemanager is licensed under [GPL-3.0-or-later](LICENSE).
