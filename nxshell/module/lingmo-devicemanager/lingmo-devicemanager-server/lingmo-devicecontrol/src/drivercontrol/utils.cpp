...
bool Utils::isDriverPackage(const QString &filepath)
{
    ...
    if (tmpDir.mkdir(tmpPath)) {
        ...
        // 不能直接通过包名判断 比如 "lingmo-devicemanager_1.0.deb" 判断是否包含 "lingmo-devicemanager" 此时同样会过滤 "/home/uos/lingmo-devicemanager/driver.deb"
...
{
    static const QString kHierService = "com.lingmo.daemon.ACL";
    static const QString kHierPath = "/org/lingmo/security/hierarchical/Control";
    static const QString kHierInterface = "org.lingmo.security.hierarchical.Control";
