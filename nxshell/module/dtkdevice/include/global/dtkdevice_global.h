...
#define OCEANVICE_NAMESPACE Device
#define DTK_DEVICE_NAMESPACE DTK_NAMESPACE::OCEANVICE_NAMESPACE

#define OCEANVICE_BEGIN_NAMESPACE namespace DTK_NAMESPACE { namespace OCEANVICE_NAMESPACE {
#define OCEANVICE_END_NAMESPACE }}
#define OCEANVICE_USE_NAMESPACE using namespace DTK_DEVICE_NAMESPACE;
