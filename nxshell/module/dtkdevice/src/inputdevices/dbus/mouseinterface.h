...
public:
    static inline const char *staticInterfaceName() { return "com.lingmo.daemon.InputDevice.Mouse"; }
    explicit MouseInterface(const QString &service = QStringLiteral("com.lingmo.daemon.InputDevices"),
