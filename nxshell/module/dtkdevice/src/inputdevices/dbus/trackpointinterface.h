...
public:
    static inline const char *staticInterfaceName() { return "com.lingmo.daemon.InputDevice.TrackPoint"; }
    TrackPointInterface(const QString &service = QStringLiteral("com.lingmo.daemon.InputDevices"),
