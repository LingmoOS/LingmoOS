...
public:
    static inline const char *staticInterfaceName() { return "com.lingmo.daemon.InputDevice.Keyboard"; }
    KeyboardInterface(const QString &service = QStringLiteral("com.lingmo.daemon.InputDevices"),
                      const QString &path = QStringLiteral("/com/lingmo/daemon/InputDevice/Keyboard"),
