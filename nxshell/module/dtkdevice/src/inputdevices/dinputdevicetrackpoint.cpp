    ...
    : DInputDevicePointerPrivate(q)
{
    ...
    const QString &Service = QStringLiteral("org.lingmo.dtk.InputDevices");
#else
    const QString &Service = QStringLiteral("com.lingmo.daemon.InputDevices");
#endif
...
{
    // TODO(asterwyx): Here we cannot acquire the profile using ocean-daemon
