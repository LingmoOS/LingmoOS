...
{
//    Tabbar * tab = new Tabbar();
//    tab->addTab(".cache/lingmo/lingmo-editor","aabb");
...
{
//    Tabbar * tab = new Tabbar();
//    tab->addTabWithIndex(0,".cache/lingmo/lingmo-editor","aabb");
...
TEST(UT_Tabbar_closeTab, UT_Tabbar_closeTab)
{
    ...
    window->addTab("/.cache/lingmo/lingmo-editor",true);
...
{
//    Tabbar * tab = new Tabbar();
//    tab->addTab("/.cache/lingmo/lingmo-editor","aa");
//    EXPECT_EQ(tab->m_tabPaths.contains("/.cache/lingmo/lingmo-editor"),true);

//    tab->updateTab(0,"/.cache/lingmo/lingmo-editor","aa");
...
//    tab->addTab("/.cache/lingmo/lingmo-editor","bb");
//    tab->previousTab();
...
TEST(UT_Tabbar_indexOf, UT_Tabbar_indexOf)
{
    ...
    tab->addTab("/.cache/lingmo/lingmo-editor","aa");
    EXPECT_EQ(tab->m_tabPaths.contains("/.cache/lingmo/lingmo-editor"),true);
    EXPECT_NE(tab->indexOf("/.cache/lingmo/lingmo-editor"),2);
...
TEST(UT_Tabbar_createDragPixmapFromTab, UT_Tabbar_createDragPixmapFromTab)
{
    ...
    Window * window = new Window;
    window->addTab("/.cache/lingmo/lingmo-editor",true);
    EXPECT_EQ(window->m_tabbar->m_tabPaths.contains("/.cache/lingmo/lingmo-editor"),true);
...
TEST(UT_Tabbar_handleTabReleased, UT_Tabbar_handleTabReleased)
{
    ...
    EditWrapper* wrapper = new EditWrapper(window);
    window->getTabbar()->m_listOldTabPath.push_back("/.cache/lingmo/lingmo-editor");
    EXPECT_EQ(window->getTabbar()->m_listOldTabPath.contains("/.cache/lingmo/lingmo-editor"),true);
