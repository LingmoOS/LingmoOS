...
TEST(UT_test_textedit_setTheme, UT_test_textedit_setTheme_001)
{
    ...
    QString strThemeFilePath("./../themes/lingmo.theme");
...
//void checkBookmarkLineMove(int from, int charsRemoved, int charsAoceand);
...
QStringList UT_test_textedit_setTextFinished_002_readHistoryRecordofFilePath_stub()
{
    ...
    filePathList << "~/.local/share/lingmo/lingmo-editor/blank-files/blank_file_2021-09-28_08-44-42-244";
    filePathList << "~/.local/share/lingmo/lingmo-editor/blank-files/blank_file_2021-09-26_11-37-20-780";
...
//void updateMark(int from, int charsRemoved, int charsAoceand);
