...
int main(int argc, char *argv[])
{
    ...
    if (dbus.registerService("com.lingmo.Editor")) {
        ...
        Utils::loadCustomDLL();
#endif
        dbus.registerObject("/com/lingmo/Editor", startManager, QDBusConnection::ExportScriptableSlots);
    ...
    // Just send dbus message to exist editor process.
        ...
        QDBusInterface notification(
            "com.lingmo.Editor", "/com/lingmo/Editor", "com.lingmo.Editor", QDBusConnection::sessionBus());
