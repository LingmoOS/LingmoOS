...
isEmpty(DSRDIR):DSRDIR=/usr/share/lingmo-editor

target.path = $$INSTROOT$$BINDIR
desktop.path = $$INSTROOT$$APPDIR
desktop.files = $$PWD/../lingmo-editor.desktop

themes.path = $$DSRDIR/themes
themes.files += themes/lingmo.theme
...
DISTFILES += \
    themes/lingmo_dark.theme \
    images/warning.svg
TRANSLATIONS += ../translations/lingmo-editor_zh_CN.ts\
    ../translations/lingmo-editor_zh_HK.ts\
    ../translations/lingmo-editor_zh_TW.ts\
    ../translations/lingmo-editor.ts
