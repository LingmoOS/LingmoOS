...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到文字編輯器圖示![lingmo_editor](../common/lingmo_editor.svg)，單擊執行。
...
- 在Dock上右鍵單擊 ![lingmo_editor](../common/lingmo_editor.svg)，選擇 **全部關閉**， 關閉文字編輯器。
...
![read_only](fig/d_read_only_02.png)
