...
- 新建标签页/窗口
   ...
   - 单击标签页上的 ![plus_icon](../common/+.svg) 或 ![icon_menu](../common/icon_menu.svg) > **新标签页** 或使用快捷键 **Ctrl + T** 创建一个新的标签页。
...
1. 单击 ![icon_menu](../common/icon_menu.svg) > **打印**，也可以使用快捷键 **Ctrl + P** 打开打印预览。
