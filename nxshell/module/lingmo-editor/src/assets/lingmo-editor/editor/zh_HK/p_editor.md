...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到文本編輯器圖標 ![lingmo_editor](../common/lingmo_editor.svg)，單擊運行。
3. 右鍵單擊 ![lingmo_editor](../common/lingmo_editor.svg)，您可以：
...
- 在任務欄右鍵單擊 ![lingmo_editor](../common/lingmo_editor.svg)，選擇 **關閉所有** ，關閉文本編輯器。
