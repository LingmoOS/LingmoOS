...
#define LINGMO_THEME QString("%1share/lingmo-editor/themes/lingmo.theme").arg(LINGLONG_PREFIX)
#define LINGMO_DARK_THEME QString("%1share/lingmo-editor/themes/lingmo_dark.theme").arg(LINGLONG_PREFIX)
