...
EditorApplication::EditorApplication(int &argc, char *argv[]) : DApplication(argc, argv)
{
    ...
    const QString acknowledgementLink = "https://www.lingmo.org/original/lingmo-editor/";

    setAttribute(Qt::AA_UseHighDpiPixmaps);
    loadTranslator();
    setOrganizationName("lingmo");
    setApplicationName("lingmo-editor");
    setApplicationDisplayName(QObject::tr("Text Editor"));
    setApplicationVersion(VERSION);
    setProductIcon(QIcon::fromTheme("lingmo-editor"));
