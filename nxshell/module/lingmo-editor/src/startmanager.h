...
#include <com_lingmo_ocean_daemon_dock.h>
#include <com_lingmo_ocean_daemon_dock_entry.h>
#include <QObject>

using Dock          = com::lingmo::ocean::daemon::Dock;
using Entry         = com::lingmo::ocean::daemon::dock::Entry;
...
class StartManager : public QObject
{
    ...
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.Editor")
