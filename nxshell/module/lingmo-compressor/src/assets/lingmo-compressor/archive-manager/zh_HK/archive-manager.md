...
1. 單擊任務欄上的啟動器圖標 ![launcher](../common/lingmo_launcher.svg)，進入啟動器界面。
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到歸檔管理器圖標 ![lingmo_compressor](../common/lingmo_compressor.svg)，單擊運行。
...
- 在任務欄右鍵單擊 ![lingmo_compressor](../common/lingmo_compressor.svg)，選擇 **關閉所有**，關閉歸檔管理器。
