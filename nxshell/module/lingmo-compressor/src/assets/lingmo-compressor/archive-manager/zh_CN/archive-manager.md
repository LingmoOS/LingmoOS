...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到归档管理器图标 ![lingmo_compressor](../common/lingmo_compressor.svg)，单击运行。
3. 右键单击 ![lingmo_compressor](../common/lingmo_compressor.svg)，您可以：
 - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 在任务栏右键单击 ![lingmo_compressor](../common/lingmo_compressor.svg)，选择 **关闭所有** ，退出归档管理器。
