# Archive Manager|lingmo-compressor|
...
1.  Click ![launcher](../common/lingmo_launcher.svg) on dock  to enter the Launcher interface.
2.  Locate ![lingmo_compressor](../common/lingmo_compressor.svg) by scrolling the mouse wheel or searching Archive Manager in the Launcher interface and click it to run.
3.  Right-click ![lingmo_compressor](../common/lingmo_compressor.svg) and you can:
...
- Right-click ![lingmo_compressor](../common/lingmo_compressor.svg) on dock and select **Close All** to exit.
