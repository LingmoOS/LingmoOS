...
1. 單擊任務欄上的啟動器圖示 ![launcher](../common/lingmo_launcher.svg)，進入啟動器介面。
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到歸檔管理器圖示 ![lingmo_compressor](../common/lingmo_compressor.svg)，單擊執行。
3. 右鍵單擊 ![lingmo_compressor](../common/lingmo_compressor.svg)，您可以：
 - 單擊 **建立桌面捷徑**，在桌面建立捷徑。
...
- 在任務欄右鍵單擊 ![lingmo_compressor](../common/lingmo_compressor.svg)，選擇 **全部關閉** 來關閉歸檔管理器。
