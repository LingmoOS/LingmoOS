    ...
    : DDialog(parent)
{
    setFixedWidth(380);
    // 设置对话框图标
    QPixmap pixmap = UiTools::renderSVG(":assets/icons/lingmo/builtin/icons/compress_warning_32px.svg", QSize(32, 32));
    setIcon(pixmap);
}
    ...
    : DDialog(parent)
{
    setFixedWidth(380);
    // 设置对话框图标
    QPixmap pixmap = UiTools::renderSVG(":assets/icons/lingmo/builtin/icons/compress_warning_32px.svg", QSize(64, 64));
    setIcon(pixmap);
}
