...
QString DFMStandardPaths::location(DFMStandardPaths::StandardLocation type)
{
    ...
    default:
        return QStringLiteral("bug://ocean-file-manager-lib/interface/dfmstandardpaths.cpp#") + QT_STRINGIFY(type);
    }
}
...
QString DFMStandardPaths::getConfigPath()
{
    ...
    QDir::home().mkpath(QString("%1/lingmo/%2/").arg(".config", projectName));
    QString defaultPath = QString("%1/%2/lingmo/%3").arg(QDir::homePath(), ".config", projectName);
    return defaultPath;
}
#endif
