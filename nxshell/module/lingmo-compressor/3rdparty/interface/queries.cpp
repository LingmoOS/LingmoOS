...
void OverwriteQuery::execute()
{
    ...
    // 设置对话框图标
    QPixmap pixmap = renderSVG(":assets/icons/lingmo/builtin/icons/compress_warning_32px.svg", QSize(64, 64));
...
void LoadCorruptQuery::execute()
{
    ...
    dialog->setFixedWidth(380);
    QPixmap pixmap = renderSVG(":assets/icons/lingmo/builtin/icons/compress_warning_32px.svg", QSize(32, 32));
    dialog->setIcon(pixmap);
