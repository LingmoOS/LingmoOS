...
{
    // 初始化安全中心gsetting配置
    m_gsetting = InvokerFactory::GetInstance().CreateSettings(LINGMO_PC_MANAGER_GSETTING_PATH, QByteArray(), this);

    m_netCheckDBusInvokerInter = InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.netcheck",
                                                                             "/com/lingmo/pc/manager/netcheck",
                                                                             "com.lingmo.pc.manager.netcheck",
    ...
    m_netWorkDBusInvokerInter = InvokerFactory::GetInstance().CreateInvoker("com.lingmo.daemon.Network",
                                                                            "/com/lingmo/daemon/Network",
                                                                            "com.lingmo.daemon.Network",
