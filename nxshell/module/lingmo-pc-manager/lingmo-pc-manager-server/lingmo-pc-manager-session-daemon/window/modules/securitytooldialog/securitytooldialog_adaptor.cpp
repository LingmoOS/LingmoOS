...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.GetInstallingApps
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.GetUninstallingApps
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.GetUpdatingApps
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.OnInstallPackage
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.OnRequestUpdateToolsInfo
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.OnShowTool
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.OnUnInstallPackage
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.OnUpdatePackage
...
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.SetDefenderPaletteType
    QMetaObject::invokeMethod(parent(), "SetDefenderPaletteType", Q_ARG(int, type));
}

void SecuritytooldialogAdaptor::ShowNetCheck()
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.ShowNetCheck
    QMetaObject::invokeMethod(parent(), "ShowNetCheck");
}

void SecuritytooldialogAdaptor::ShowStartup()
{
    // handle method call com.lingmo.pc.manager.securitytooldialog.ShowStartup
