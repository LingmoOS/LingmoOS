...
#include "../../lingmo-pc-manager/src/window/modules/securitytools/defsecuritytoolinfo.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface com.lingmo.pc.manager.securitytooldialog
 */
class SecuritytooldialogAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.pc.manager.securitytooldialog")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"com.lingmo.pc.manager.securitytooldialog\">\n"
