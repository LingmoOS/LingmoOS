...
{
    // handle method call com.lingmo.pc.manager.session.daemon.DeleteSpecifiedFiles
    QMetaObject::invokeMethod(parent(), "DeleteSpecifiedFiles", Q_ARG(QStringList, path));
}

void DaemonAdaptor::ExitApp()
{
    // handle method call com.lingmo.pc.manager.session.daemon.ExitApp
    QMetaObject::invokeMethod(parent(), "ExitApp");
}

QString DaemonAdaptor::GetAppTrashInfoList()
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetAppTrashInfoList
    QString cleanerPath;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetBrowserCookiesInfoList
    QString cleanerPath;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetCacheInfoList
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetHistoryInfoList
    QStringList cleanerPath;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetLogInfoList
    QStringList cleanerPath;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetSystemArchitecture
    QString arch;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.GetTrashInfoList
    QStringList cleanerPath;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.ModulesRequestAuthorityActived
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.RequestAuthWithID
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.RequestCleanSelectTrash
    QMetaObject::invokeMethod(parent(), "RequestCleanSelectTrash");
}

void DaemonAdaptor::RequestStartTrashScan()
{
    // handle method call com.lingmo.pc.manager.session.daemon.RequestStartTrashScan
    QMetaObject::invokeMethod(parent(), "RequestStartTrashScan");
}

void DaemonAdaptor::StartApp()
{
    // handle method call com.lingmo.pc.manager.session.daemon.StartApp
    QMetaObject::invokeMethod(parent(), "StartApp");
}

bool DaemonAdaptor::exeAutostart(int nStatus, const QString &sPath)
{
    // handle method call com.lingmo.pc.manager.session.daemon.exeAutostart
    bool value;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.getAppsInfoDisable
    QString value;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.getAppsInfoEnable
    QString value;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.isAutostart
    bool value;
...
{
    // handle method call com.lingmo.pc.manager.session.daemon.preInitialize
    QMetaObject::invokeMethod(parent(), "preInitialize");
}

bool DaemonAdaptor::startLauncherManage()
{
    // handle method call com.lingmo.pc.manager.session.daemon.startLauncherManage
    bool value;
