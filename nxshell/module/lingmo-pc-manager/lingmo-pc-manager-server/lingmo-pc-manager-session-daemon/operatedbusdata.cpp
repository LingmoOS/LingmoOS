...
#include "../../lingmo-pc-manager/src/window/modules/common/common.h"
#include "../../lingmo-pc-manager/src/window/modules/common/gsettingkey.h"
#include "../../lingmo-pc-manager/src/window/modules/common/invokers/invokerfactory.h"
#include "../../lingmo-pc-manager/src/window/modules/common/systemsettings/systemsettings.h"
#include "common.h"
#include "dpinyin.h"
...
const QString WhitePathsFile = "/usr/share/lingmo-pc-manager/cleanerwhite.json";
const QString appPathsFile = "/usr/share/lingmo-pc-manager/appInfomation.json";
// 第三方病毒查杀应用程序信息
const QString natiavOptApps = "/usr/share/lingmo-pc-manager/natiavoptapps.json";
...
// 合法调用进程路径列表
const QStringList ValidInvokerExePathList = {"/usr/bin/lingmo-pc-manager",
                                             "/usr/bin/lingmo-pc-manager-session-daemon",
                                             "/usr/bin/lingmo-pc-manager-system-daemon"};

OperateDBusData::OperateDBusData(QObject *parent)
    : QObject(parent)
    , m_daemonAdaptor(nullptr)
    , m_gsetting(new QGSettings(LINGMO_PC_MANAGER_GSETTING_PATH, QByteArray(), this))
    ...
    , m_authWrapper(nullptr)
{
    ...
    // 取应用数据接口
    m_launcherInter = InvokerFactory::GetInstance().CreateInvoker("com.lingmo.ocean.daemon.Launcher",
    ...
    m_rootMonitorDBusInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.system.daemon",
                                                    "/com/lingmo/pc/manager/sysem/daemon",
                                                    "com.lingmo.pc.manager.system.daemon",
                                                    ConnectType::SYSTEM,
                                                    this);
    m_managerInter = InvokerFactory::GetInstance().CreateInvoker("org.lingmo.lastore1",
                                                                 "/org/lingmo/lastore1",
                                                                 "org.lingmo.lastore1.Manager",
                                                                 ConnectType::SYSTEM,
                                                                 this);
    m_startManagerInterface =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.SessionManager",
                                                    "/com/lingmo/StartManager",
                                                    "com.lingmo.StartManager",
                                                    ConnectType::SESSION,
                                                    this);
