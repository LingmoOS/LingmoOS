...
/*
 * Adaptor class for interface com.lingmo.pc.manager.session.daemon
 */
class DaemonAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.pc.manager.session.daemon")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"com.lingmo.pc.manager.session.daemon\">\n"
