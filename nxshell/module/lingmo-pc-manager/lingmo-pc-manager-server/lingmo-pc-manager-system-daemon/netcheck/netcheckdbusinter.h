// Copyright (C) 2019 ~ 2023 Lingmo Technology Co., Ltd.
...
#define NET_CHECK_DBUS_NAME "com.lingmo.pc.manager.netcheck"
#define NET_CHECK_DBUS_PATH "/com/lingmo/pc/manager/netcheck"
