...
/*
 * Adaptor class for interface com.lingmo.pc.manager.netcheck
 */
class NetcheckAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.pc.manager.netcheck")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"com.lingmo.pc.manager.netcheck\">\n"
