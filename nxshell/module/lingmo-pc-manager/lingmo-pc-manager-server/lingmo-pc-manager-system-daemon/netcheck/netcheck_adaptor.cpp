...
{
    // handle method call com.lingmo.pc.manager.netcheck.ExitApp
    QMetaObject::invokeMethod(parent(), "ExitApp");
}

bool NetcheckAdaptor::GetNetCheckStatus()
{
    // handle method call com.lingmo.pc.manager.netcheck.GetNetCheckStatus
    bool status;
