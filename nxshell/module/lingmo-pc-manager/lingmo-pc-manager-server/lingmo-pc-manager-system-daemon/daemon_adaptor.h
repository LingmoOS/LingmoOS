...
#include "../lingmo-pc-manager-session-daemon/window/modules/common/defenderprocinfolist.h"
...
/*
 * Adaptor class for interface com.lingmo.pc.manager.system.daemon
 */
class DaemonAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.pc.manager.system.daemon")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"com.lingmo.pc.manager.system.daemon\">\n"
