...
{
    // handle method call com.lingmo.pc.manager.system.daemon.CleanJournal
    QMetaObject::invokeMethod(parent(), "CleanJournal");
}

void DaemonAdaptor::CleanSelectFile(const QStringList &pathList)
{
    // handle method call com.lingmo.pc.manager.system.daemon.CleanSelectFile
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.DeleteUninstalledAppRecord
    QMetaObject::invokeMethod(parent(), "DeleteUninstalledAppRecord", Q_ARG(QString, sAppID));
}

void DaemonAdaptor::ExitApp()
{
    // handle method call com.lingmo.pc.manager.system.daemon.ExitApp
    QMetaObject::invokeMethod(parent(), "ExitApp");
}

QStringList DaemonAdaptor::GetDiskDevicePathList()
{
    // handle method call com.lingmo.pc.manager.system.daemon.GetDiskDevicePathList
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.GetSysSettingValue
    QDBusVariant value;
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.GetUnInstalledApps
    QVariantList out0;
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.InsertUninstalledAppRecord
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.QueryPackageName
    QString sPkgName;
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.RefreshPackageTable
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.SetSysSettingValue
    bool succeed;
...
{
    // handle method call com.lingmo.pc.manager.system.daemon.StartApp
    QMetaObject::invokeMethod(parent(), "StartApp");
}

QString DaemonAdaptor::getProExePath(const QString &sId)
{
    // handle method call com.lingmo.pc.manager.system.daemon.getProExePath
    QString value;
