...
int main(int argc, char *argv[])
{
    ...
    a.setApplicationName("lingmo-pc-manager");
    ...
    a.setWindowIcon(QIcon::fromTheme("lingmo-pc-manager"));
    a.setProductIcon(QIcon::fromTheme("lingmo-pc-manager"));
    a.setApplicationDescription(
        QApplication::translate("main",
                                "Lingmo PC Manager is an application tool designed to help users "
