...
void MainWindow::initData()
{
    m_pSecurityToolDBusInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.securitytooldialog",
    ...
    // 初始化安全中心gsetting配置
    m_gsetting = InvokerFactory::GetInstance().CreateSettings(LINGMO_PC_MANAGER_GSETTING_PATH,
                                                              QByteArray(),
                                                              this);
