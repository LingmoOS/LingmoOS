    ...
    , m_developModeChecking(false)
{
    ...
    m_gSettingsInvokerInter =
        InvokerFactory::GetInstance().CreateSettings(LINGMO_PC_MANAGER_GSETTING_PATH, "", this);
    m_defenderDataInvokerInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.session.daemon",
                                                    "/com/lingmo/pc/manager/session/daemon",
                                                    "com.lingmo.pc.manager.session.daemon",
                                                    ConnectType::SESSION,
                                                    this);
    // 控制中心dbus服务对象
    m_controlCenterInvokerInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.ocean.ControlCenter",
    ...
    m_defenderWindowInvokerInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager",
                                                    "/com/lingmo/pc/manager",
                                                    "com.lingmo.pc.manager",
                                                    ConnectType::SESSION,
                                                    this);
    // 同步助手dbus服务，用于查询是否处于开发者模式
    m_helperInvokerInter = InvokerFactory::GetInstance().CreateInvoker("com.lingmo.sync.Helper",
    ...
    m_diskManagerInvokerInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.diskmanager",
    ...
    m_netFlowMonitorInvokerInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.MonitorNetFlow",
                                                    "/com/lingmo/pc/manager/MonitorNetFlow",
                                                    "com.lingmo.pc.manager.MonitorNetFlow",
                                                    ConnectType::SYSTEM,
                                                    this);

    m_securityCenterInter =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.datainterface",
                                                    "/com/lingmo/pc/manager/securitytooldialog",
                                                    "com.lingmo.pc.manager.securitytooldialog",
                                                    ConnectType::SESSION,
                                                    this);
