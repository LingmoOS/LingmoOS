...
const QString k1stPageLogoPath = "oceanui_syscheck_main_logo";
const QString kprogressingLogoPath = "oceanui_syscheck_progressing";
const QString kAbnormalStatusIconPath = "oceanui_syscheck_item_abnormal";
const QString kNormalStatusIconPath = "oceanui_syscheck_item_normal";

const QString kAbnormalResultLogoPath = "oceanui_syscheck_result_abnormal";
const QString kRepairingResultLogoPath = "oceanui_syscheck_result_repair";
const QString k100PointResultLogoPath = "oceanui_syscheck_result_100point";

const QString kIgnoreBtnIconPath = "oceanui_syscheck_item_ignore";
const QString kDisIgnoreBtnIconPath = "oceanui_syscheck_item_noignore";

const QString kProgressCancelIconPath = "oceanui_syscheck_progress_cancel";
...
const QList<QString> kSystemCheckTypeIconList = {
    "oceanui_syscheck_item_antivirus", "oceanui_syscheck_item_avupdate", "oceanui_syscheck_item_ssh",
    "oceanui_syscheck_item_disk",      "oceanui_syscheck_item_garbage",  "oceanui_syscheck_item_sysupdate",
    "oceanui_syscheck_item_dev",       "oceanui_syscheck_item_autostart"
};
