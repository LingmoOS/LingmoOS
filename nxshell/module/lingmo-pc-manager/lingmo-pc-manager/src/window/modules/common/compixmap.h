...
#define DIALOG_CARE_TIP_YELLOW "oceanui_care_tip" // 提示框---黄色感叹号(小图片)
#define DIALOG_OK_TIP_GREEN "oceanui_ok_tip" // 提示框---绿色感叹号(小图片)
#define DIALOG_DEFENDER "lingmo-defender" // 提示框---安全中心
#define DIALOG_PC_MANAGER "lingmo-pc-manager" // 提示框---电脑管家

/********************导航栏*****************************/
#define HOMEPAGE_MODEL_LIGHT "oceanui_home" // 首页模块--浅色
#define HOMEPAGE_MODEL_DARK "oceanui_home_dark" // 首页模块--深色
#define HOMEPAGE_ANTIVIRUS_LIGHT "oceanui_virus_scan" // 病毒查杀模块--浅色
#define HOMEPAGE_ANTIVIRUS_DARK "oceanui_Virus_Scan_dark" // 病毒查杀模块--深色
#define ICON_MODULE_ICON_FIREWALL "oceanui_network_protection" // 防火墙
#define ICON_MODULE_ICON_DARK_FIREWALL "oceanui_network_protection_dark" // 防火墙
...
#define HOMEPAGE_UOS_LIGHT "oceanui_home_image_oem" // 首页 UOS--浅色
#define HOMEPAGE_UOS_DARK "oceanui_home_image_oem_dark" // 首页 UOS--深色
...
/*******************病毒查杀*********************/
#define VIRUS_HOME_PAGE "oceanui_virus_home_page" // 病毒查杀首页图标
#define VIRUS_CHECK_UPDATE "oceanui_virus_check_update" // 病毒查杀检查更新图标
#define VIRUS_UPDATE "oceanui_virus_update" // 病毒查杀更新图标
...
#define ICON_SYS_SEC_LEVEL_HIGH "oceanui_system_level_high"
#define ICON_SYS_SEC_LEVEL_MEDIUM "oceanui_system_level_medium"
#define ICON_SYS_SEC_LEVEL_LOW "oceanui_system_level_low"
