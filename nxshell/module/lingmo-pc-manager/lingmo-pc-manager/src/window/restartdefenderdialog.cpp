// Copyright (C) 2020 ~ 2021 Lingmo Technology Co., Ltd.
    ...
    , m_daemonservice(nullptr)
{
    // 安全中心心跳服务
    m_daemonservice =
        InvokerFactory::GetInstance().CreateInvoker("com.lingmo.pc.manager.daemonservice",
                                                    "/com/lingmo/pc/manager/daemonservice",
                                                    "com.lingmo.pc.manager.daemonservice",
                                                    ConnectType::SESSION,
                                                    this);
    // 初始化界面
...
void RestartDefenderDialog::initUi()
{
    ...
    clearContents();
    clearButtons();
    setIcon(QIcon::fromTheme("lingmo-pc-manager"));
