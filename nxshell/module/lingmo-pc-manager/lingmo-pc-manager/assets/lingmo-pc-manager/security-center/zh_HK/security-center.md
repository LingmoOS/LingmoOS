...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到安全中心圖標 ![lingmo_defender](../common/lingmo_defender.svg)，單擊運行。
3. 右鍵單擊 ![lingmo_defender](../common/lingmo_defender.svg)，您可以：
   - 單擊 **傳送到桌面**，在桌面創建快捷方式。
...
- 右鍵單擊托盤上的安全中心圖標 ![lingmo_defender](../common/lingmo_defender.svg) ，選擇 **退出** 來退出安全中心。
