...
import (
	"lingmo-upgrade-manager/pkg/bootkit"
...
var (
	_config = flag.String("config", "/usr/share/lingmo-boot-kit/config.json", "the configuration file path")
...
func main() {
	...
	logger.NewLogger("lingmo-boot-kit", false)
