...
const (
	NodifydbusDest      = "com.lingmo.ocean.Notification"
	NodifydbusPath      = "/com/lingmo/ocean/Notification"
	NodifydbusInterface = NodifydbusDest
)

const (
	NodifydbusDestV23      = "org.lingmo.ocean.Notification1"
	NodifydbusPathV23      = "/org/lingmo/ocean/Notification1"
...
func SetNotifyText(text string) error {
	...
	arg3 = text
	arg7 = 10000
	// using lingmo clone icon
	if util.IsExists("/usr/share/lingmo-clone") {
		arg2 = "lingmo-clone"
	}
