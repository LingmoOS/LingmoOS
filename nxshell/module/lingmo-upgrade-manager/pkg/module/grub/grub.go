...
func Init() *GrubManager {
	...
	if len(osVersion) == 0 || osVersion == "23" {
		m.dbusDest = "org.lingmo.daemon.Grub2"
		m.dbusPath = "/org/lingmo/daemon/Grub2"
		m.dbusInterface = m.dbusDest
	} else {
		m.dbusDest = "com.lingmo.daemon.Grub2"
		m.dbusPath = "/com/lingmo/daemon/Grub2"
		m.dbusInterface = m.dbusDest
	}
	/*
...
func (m *GrubManager) ChangeDbusDest() *GrubManager {
	if m.dbusDest == "com.lingmo.daemon.Grub2" {
		m.dbusDest = "org.lingmo.daemon.Grub2"
		m.dbusPath = "/org/lingmo/daemon/Grub2"
		m.dbusInterface = m.dbusDest
	} else {
