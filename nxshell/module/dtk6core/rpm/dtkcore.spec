...
Version:        5.5.18
Release:        1%{?dist}
Summary:        Lingmo tool kit core modules
License:        LGPLv3+
URL:            https://github.com/lingmoos/dtkcore
%if 0%{?fedora}
...
# since f30
Obsoletes:      lingmo-tool-kit <= 0.3.3
Obsoletes:      lingmo-tool-kit-devel <= 0.3.3
Obsoletes:      dtksettings <= 0.1.7
Obsoletes:      dtksettings-devel <= 0.1.7

%description
Lingmo tool kit core modules.
...
%{_libexecdir}/dtk5/lingmo-os-release
