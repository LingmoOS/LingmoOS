...
ocean-account-faces provides account-faces of ocean
...
```bash
sudo apt build-dep ocean-account-faces
```
...
## License
ocean-account-faces is licensed under [GPL-3.0-or-later](LICENSE).