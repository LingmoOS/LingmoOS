...
\begin{itemize}
    ...
    \item Lingmo-Boot-Kit: 是一套 Grub 管理框架，使用其框架的所有工具需要遵循其规则。
...
\begin{figure}[H]
    ...
    \begin{plantuml}
        ...
        participant "lingmo-system-upgrade-tool" as UT
        participant "lingmo-system-upgrade-daemon" as UD                             
        endbox
