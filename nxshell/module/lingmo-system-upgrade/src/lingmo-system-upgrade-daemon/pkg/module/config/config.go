...
const (
	dbusPath      = "/org/lingmo/SystemUpgrade1/ConfigManager"
	dbusInterface = "org.lingmo.SystemUpgrade1.ConfigManager"
)

// Configuration files carried by the upgrade tool
const (
	YamlConfigPath = "/etc/lingmo-system-upgrade/config.yaml"
	YamlBackupPath = "/etc/lingmo-system-upgrade/backup.yaml"
)
