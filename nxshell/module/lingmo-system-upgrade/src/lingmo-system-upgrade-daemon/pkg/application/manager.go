...
var logger = log.NewLogger("lingmo-system-upgrade/application")

// DBus path and DBus interface
const (
	dbusPath      = "/org/lingmo/SystemUpgrade1/AppManager"
	dbusInterface = "org.lingmo.SystemUpgrade1.AppManager"
)
...
const (
	...
	RepackDebStorageDir      = "/tmp/lingmo-system-upgrade"
	AtomicUpgradeVersionData = "/var/lib/lingmo-boot-kit/version.data"
	UpgradeAutoStartFile     = "/etc/xdg/autostart/lingmo-system-upgrade-tool.desktop"
	UpgradeDesktopFile       = "/usr/share/applications/lingmo-system-upgrade-tool.desktop"
	MigrateFlagsPath         = "/var/cache/lingmo-system-upgrade/migrate.state"
	MigrateListPath          = "/var/cache/lingmo-system-upgrade/migrate.list"
...
func (a *AppManager) handleAfterMigrate(sender dbus.Sender) {
	...
	// out, err := exec.Command("/usr/bin/apt", "-y", "purge", "lingmo-system-upgrade").CombinedOutput()
	// if err != nil {
...
func (a *AppManager) buildPkgFilter() error {
	// filter blacklist
	var filterList = []string{"grub-efi-amd64-signed", "ocean", "ocean-calendar", "lingmo-album", "lingmo-calculator", "lingmo-camera", "lingmo-compressor", "lingmo-draw", "lingmo-editor", "com.lingmo.gomoku", "lingmo-image-viewer", "com.lingmo.lianliankan", "lingmo-mail", "lingmo-movie", "lingmo-music", "lingmo-reader", "lingmo-screen-recorder", "org.lingmo.browser"}
