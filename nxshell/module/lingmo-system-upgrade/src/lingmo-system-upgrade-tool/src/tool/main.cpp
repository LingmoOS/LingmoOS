...
int main(int argc, char *argv[])
{
    ...
    app->setApplicationName("lingmo-system-upgrade-tool");
    ...
    {
        bool isSingleInstanceSet = app->setSingleInstance("lingmo-system-upgrade-tool");
        ...
        if (QFile::exists("/var/cache/lingmo-system-upgrade/migrate.state"))
        {
            // App Migration
    ...
    else
    {
        ...
        system("rm -f ~/Desktop/lingmo-system-upgrade-tool.desktop");
        system("rm -f ~/Desktop/lingmo-installer.desktop");
