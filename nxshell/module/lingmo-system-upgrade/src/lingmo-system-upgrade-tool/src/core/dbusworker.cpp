...
DBusWorker::DBusWorker(QObject *parent)
    ...
    , m_checkerInter(new QDBusInterface(
                       "org.lingmo.SystemUpgrade1",
                       "/org/lingmo/SystemUpgrade1/Checker",
                       "org.lingmo.SystemUpgrade1.Checker",
                       QDBusConnection::systemBus(),
                       this
                   ))
    , m_configInter(new QDBusInterface(
                      "org.lingmo.SystemUpgrade1",
                      "/org/lingmo/SystemUpgrade1/ConfigManager",
                      "org.lingmo.SystemUpgrade1.ConfigManager",
                      QDBusConnection::systemBus(),
                      this
                  ))
    , m_appInter(new QDBusInterface(
                   "org.lingmo.SystemUpgrade1",
                   "/org/lingmo/SystemUpgrade1/AppManager",
                   "org.lingmo.SystemUpgrade1.AppManager",
                   QDBusConnection::systemBus(),
                   this
               ))
    , m_versionInter(new QDBusInterface(
                       "org.lingmo.SystemUpgrade1",
                       "/org/lingmo/SystemUpgrade1/VersionManager",
                       "org.lingmo.SystemUpgrade1.VersionManager",
                       QDBusConnection::systemBus(),
                       this
                   ))
    ...
    , m_isoInter(new QDBusInterface(
                       "org.lingmo.SystemUpgrade1",
                       "/org/lingmo/SystemUpgrade1/ISOManager",
                       "org.lingmo.SystemUpgrade1.ISOManager",
                       QDBusConnection::systemBus(),
                       this
                   ))
...
{
//    SetPlymouthTheme("lingmo-upgrade");
