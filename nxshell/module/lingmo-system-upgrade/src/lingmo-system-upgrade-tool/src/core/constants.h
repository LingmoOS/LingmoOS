...
const QString kDownloadPath(".cache/lingmo-system-upgrade-tool");
// Upgrade state file path
const QString kUpgradeStatesPath("/etc/lingmo-upgrade-manager/state.records");

const QVersionNumber kUosMinimalVersion = QVersionNumber::fromString("1060");
const QVersionNumber kLingmoMinimalVersion = QVersionNumber::fromString("20.9");
const QVersionNumber kLingmoTargetVersion = QVersionNumber::fromString("23");
