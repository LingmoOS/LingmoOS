...
#include <KWayland/Client/oceanseat.h>
...
public:
    ...
    static void createOCEANShell(quint32 name, quint32 version);
    static void createOCEANSeat(quint32 name, quint32 version);
    static void createStrut(quint32 name, quint32 version);
    static void createOCEANPointer();
    static void createOCEANKeyboard();
    static void createOCEANFakeInput();
