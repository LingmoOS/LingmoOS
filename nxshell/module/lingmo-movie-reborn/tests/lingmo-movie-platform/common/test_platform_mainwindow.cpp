...
TEST(MainWindow, DBus)
{
    ...
    DBusUtils utils;
    QVariant v = Platform_ApplicationAdaptor::redDBusProperty("com.lingmo.daemon.Audio", "/com/lingmo/daemon/Audio",
    ...
    if (v.isValid()) {
        ...
        for (auto curPath : allSinkInputsList) {
            QVariant name = Platform_ApplicationAdaptor::redDBusProperty("com.lingmo.daemon.Audio", curPath.path(),
    ...
    QVariant method = Platform_ApplicationAdaptor::redDBusMethod("com.lingmo.daemon.Audio", "/com/lingmo/daemon/Audio",
                                                        "com.lingmo.daemon.Audio", "SinkInputs");
...
TEST(MainWindow, ThumbnailPreview)
{
    ...
    Platform_ThumbnailWorker::get().requestThumb(QUrl("/data/source/lingmo-movie-reborn/movie/demo.mp4"),
                                        200);
