...
//    QTest::qWait(500);
    ...
    QStringList command;
    command << "-rf" << QString("%1/.config/lingmo-movie-test").arg(homePath);
...
//    emit DGuiApplicationHelper::instance()->paletteTypeChanged(DGuiApplicationHelper::DarkType);
    ...
    fileList << "/data/source/lingmo-movie-reborn/movie/demo.mp4"\
             <<"/data/source/lingmo-movie-reborn/movie/bensound-sunny.mp3";
