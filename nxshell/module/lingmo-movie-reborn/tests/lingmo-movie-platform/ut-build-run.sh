...
executable=lingmo-movie-platform-test #可执行程序的文件名

platform=`uname -m`
echo ${platform}

cd ./tests/lingmo-movie-platform/

mkdir -p html
mkdir -p report
rm -fr /data/source/lingmo-movie-reborn/movie/play.conf
cp ../../../tests/lingmo-movie-platform/play.conf /data/source/lingmo-movie-reborn/movie/play.conf
echo " ===================CREAT LCOV REPROT==================== "
lcov --directory ./CMakeFiles/lingmo-movie-platform-test.dir --zerocounters
