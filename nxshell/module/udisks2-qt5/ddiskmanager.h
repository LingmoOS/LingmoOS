...
Q_SIGNALS:
    void blockDeviceAoceand(const QString &path);
    void blockDeviceRemoved(const QString &path);
    void diskDeviceAoceand(const QString &path);
    void diskDeviceRemoved(const QString &path);
    void fileSystemAoceand(const QString &blockDevicePath);
    void fileSystemRemoved(const QString &blockDevicePath);
    void mountAoceand(const QString &blockDevicePath, const QByteArray &mountPoint);
    ...
    void jobAoceand(const QString &jobPath);
...
private Q_SLOTS:
    void onInterfacesAoceand(const QDBusObjectPath &, const QMap<QString, QVariantMap> &);
