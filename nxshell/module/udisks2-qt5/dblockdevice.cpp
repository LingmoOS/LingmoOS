...
void DBlockDevice::onInterfacesAoceand(const QDBusObjectPath &object_path, const QMap<QString, QVariantMap> &interfaces_and_properties)
{
    Q_D(DBlockDevice);
...
void DBlockDevice::setWatchChanges(bool watchChanges)
{
    ...
    if (watchChanges) {
        connect(object_manager, &OrgFreedesktopDBusObjectManagerInterface::InterfacesAoceand,
                this, &DBlockDevice::onInterfacesAoceand);
