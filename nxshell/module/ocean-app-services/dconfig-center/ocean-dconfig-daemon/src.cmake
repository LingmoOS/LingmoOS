...
if(EnableDtk5)
qt5_add_dbus_adaptor(DCONFIG_DBUS_XML ../ocean-dconfig-daemon/services/org.desktopspec.ConfigManager.xml
    dconfigserver.h DSGConfigServer
    configmanager_adaptor DSGConfigAdaptor)

qt5_add_dbus_adaptor(DCONFIG_DBUS_XML ../ocean-dconfig-daemon/services/org.desktopspec.ConfigManager.Manager.xml
    dconfigconn.h DSGConfigConn
    manager_adaptor DSGConfigManagerAdaptor)
endif()

if(EnableDtk6)
qt_add_dbus_adaptor(DCONFIG_DBUS_XML ../ocean-dconfig-daemon/services/org.desktopspec.ConfigManager.xml
    dconfigserver.h DSGConfigServer
    configmanager_adaptor DSGConfigAdaptor)

qt_add_dbus_adaptor(DCONFIG_DBUS_XML ../ocean-dconfig-daemon/services/org.desktopspec.ConfigManager.Manager.xml
    dconfigconn.h DSGConfigConn
    manager_adaptor DSGConfigManagerAdaptor)
endif()
