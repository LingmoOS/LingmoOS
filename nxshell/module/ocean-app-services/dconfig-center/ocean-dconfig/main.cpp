...
int main(int argc, char *argv[])
{
    ...
    parser.addPositionalArgument(listOption.names().constFirst(), listOption.description(), "\n list: ocean-dconfig list \n");
    parser.addPositionalArgument(getOption.names().constFirst(), getOption.description(), "get: ocean-dconfig get -a dconfig-example -r example -k key1 \n");
    parser.addPositionalArgument(setOption.names().constFirst(), setOption.description(), "set: ocean-dconfig set -a dconfig-example -r example -k key1 -v 1 \n");
    parser.addPositionalArgument(resetOption.names().constFirst(), resetOption.description(), "reset: ocean-dconfig reset -a dconfig-example -r example -k key1 \n");
    parser.addPositionalArgument(watchOption.names().constFirst(), watchOption.description(), "watch: ocean-dconfig watch -a dconfig-example -r example -k key1 \n");
    parser.addPositionalArgument(guiOption.names().constFirst(), guiOption.description(), "gui: ocean-dconfig gui \n");
    ...
    if (parser.isSet(guiOption) || guiOption.names().contains(subcommand)) {
        const QString guiTool("ocean-dconfig-editor");
