...
#include <ocean-shell/panel.h>
#include <ocean-shell/pluginfactory.h>
...
static const char *const kDesktopPluginInterface = "org.lingmo.plugin.desktop.qt6";
static const char *const kCommonPluginInterface = "org.lingmo.plugin.common.qt6";
...
static QStringList translationDir()
{
    ...
    QString appName { "ocean-file-manager" };
...
static void checkUpgrade()
{
    ...
    args.insert(dfm_upgrade::kArgDesktop, "ocean-shell");
...
public:
    ...
    {
        // Translator
        DGuiApplicationHelper::loadTranslator(QStringLiteral("ocean-file-manager"),
