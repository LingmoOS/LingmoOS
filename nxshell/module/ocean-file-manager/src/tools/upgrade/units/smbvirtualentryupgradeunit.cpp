...
static constexpr char kConfigFile[] { "/lingmo/ocean-file-manager.json" };
...
{
    const QString &dbPath = QStandardPaths::writableLocation(QStandardPaths::ConfigLocation) + "/lingmo/ocean-file-manager/database";
