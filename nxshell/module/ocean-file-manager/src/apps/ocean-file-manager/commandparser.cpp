...
void CommandParser::initOptions()
{
    ...
    // blumia: about -w and -r: -r will exec `ocean-file-manager-pkexec` (it use `pkexec` command) which won't pass the currect
