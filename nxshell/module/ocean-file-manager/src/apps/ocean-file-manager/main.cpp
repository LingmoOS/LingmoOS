...
Q_LOGGING_CATEGORY(logAppFileManager, "org.lingmo.ocean.filemanager.filemanager")
...
// defualt plugin IID
static constexpr char kFmPluginInterface[] { "org.lingmo.plugin.filemanager" };
static constexpr char kCommonPluginInterface[] { "org.lingmo.plugin.common" };
...
static void checkUpgrade(SingleApplication *app)
{
    ...
    args.insert(dfm_upgrade::kArgFileManger, "ocean-file-manager");
...
int main(int argc, char *argv[])
{
    ...
    a.setProductIcon(QIcon::fromTheme("ocean-file-manager"));
    a.setApplicationAcknowledgementPage("https://www.lingmo.org/acknowledgments/" + qApp->applicationName());
