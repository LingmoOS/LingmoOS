...
Q_LOGGING_CATEGORY(logAppDesktop, "org.lingmo.ocean.filemanager.desktop")
...
static const char *const kDesktopPluginInterface = "org.lingmo.plugin.desktop";
static const char *const kCommonPluginInterface = "org.lingmo.plugin.common";
...
static bool pluginsLoad()
{
    ...
    // TODO(xust): the GVolumeMonitor object MUST be initialized in MAIN thread, so a initialize operation is aoceand in dbusregister::initialize.
    ...
    if (qEnvironmentVariable("OCEAN_CURRENT_COMPOSITOR") == "TreeLand") {
...
#ifdef COMPILE_ON_V23
#    define SESSION_MANAGER_SERVICE "org.lingmo.ocean.SessionManager1"
#    define SESSION_MANAGER_PATH "org/lingmo/ocean/SessionManager1"
#    define SESSION_MANAGER_INTERFACE "org.lingmo.ocean.SessionManager1"
#else
#    define SESSION_MANAGER_SERVICE "com.lingmo.SessionManager"
#    define SESSION_MANAGER_PATH "/com/lingmo/SessionManager"
#    define SESSION_MANAGER_INTERFACE "com.lingmo.SessionManager"
#endif

static void registerOCEANSession()
{
    const char *envName = "OCEAN_SESSION_PROCESS_COOKIE_ID";
...
static void checkUpgrade(DApplication *app)
{
    ...
    args.insert(dfm_upgrade::kArgDesktop, "ocean-desktop");
...
int main(int argc, char *argv[])
{
    ...
    a.setProductIcon(QIcon::fromTheme("lingmo-toggle-desktop"));
    a.setWindowIcon(QIcon::fromTheme("lingmo-toggle-desktop"));
    {
        // load translation
        QString appName = a.applicationName();
        a.setApplicationName("ocean-file-manager");
        a.loadTranslator();
    ...
    // Notify ocean-desktop start up
    registerOCEANSession();
