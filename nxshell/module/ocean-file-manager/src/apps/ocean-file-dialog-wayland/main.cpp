...
Q_LOGGING_CATEGORY(logAppDialogWayland, "org.lingmo.ocean.filemanager.filedialog-wayland")
...
static constexpr char kDialogPluginInterface[] { "org.lingmo.plugin.filedialog" };
...
int main(int argc, char *argv[])
{
    ...
    a.setWindowIcon(QIcon::fromTheme("ocean-file-manager"));
