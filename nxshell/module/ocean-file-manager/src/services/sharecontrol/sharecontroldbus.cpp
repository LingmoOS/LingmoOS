...
static constexpr char kUserShareObjPath[] { "/org/lingmo/Filemanager/UserShareManager" };
static constexpr char kPolicyKitActionId[] { "org.lingmo.Filemanager.UserShareManager" };
