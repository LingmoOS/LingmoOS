...
static constexpr char kActionEncrypt[] { "org.lingmo.Filemanager.DiskEncrypt.Encrypt" };
static constexpr char kActionDecrypt[] { "org.lingmo.Filemanager.DiskEncrypt.Decrypt" };
static constexpr char kActionChgPwd[] { "org.lingmo.Filemanager.DiskEncrypt.ChangePassphrase" };
...
void DiskEncryptDBus::createReencryptDesktop()
{
    ...
    QByteArray desktop {
        ...
        "Exec=/usr/bin/ocean-file-manager -d\n"
        "GenericName=Disk Reencrypt\n"
        "Icon=ocean-file-manager\n"
        "Name=Disk Reencrypt\n"
        "Terminal=false\n"
        "Type=Application\n"
        "NoDisplay=true\n"
        "X-AppStream-Ignore=true\n"
        "X-Lingmo-AppID=ocean-file-manager\n"
        "X-Lingmo-Vendor=lingmo\n"
    };
