...
static constexpr char kAccessControlManagerObjPath[] { "/org/lingmo/Filemanager/AccessControlManager" };
static constexpr char kPolicyKitDiskPwdActionId[] { "org.lingmo.Filemanager.AccessControlManager.DiskPwd" };
static constexpr char kPolicyKitChmodActionId[] { "org.lingmo.Filemanager.AccessControlManager.Chmod" };
...
void AccessControlDBus::onBlockDevAoceand(const QString &deviceId)
{
    DFM_MOUNT_USE_NS
...
void AccessControlDBus::initConnect()
{
    ...
    connect(monitor.data(), &DBlockMonitor::deviceAoceand, this, &AccessControlDBus::onBlockDevAoceand);
    connect(monitor.data(), &DBlockMonitor::mountAoceand, this, &AccessControlDBus::onBlockDevMounted);
}
