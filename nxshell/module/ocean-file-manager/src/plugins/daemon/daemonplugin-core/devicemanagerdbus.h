...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.lingmo.Filemanager.Daemon.DeviceManager")
...
signals:
    ...
    void BlockDeviceAoceand(QString id);
    void BlockDeviceRemoved(QString id, const QString &oldMpt);
    void BlockDeviceFilesystemAoceand(QString id);
    ...
    void ProtocolDeviceAoceand(QString id);
