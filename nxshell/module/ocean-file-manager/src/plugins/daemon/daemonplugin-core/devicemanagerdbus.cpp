...
void DeviceManagerDBus::initConnection()
{
    ...
    connect(DevMngIns, &DeviceManager::blockDriveAoceand, this, &DeviceManagerDBus::BlockDriveAoceand);
    connect(DevMngIns, &DeviceManager::blockDriveRemoved, this, &DeviceManagerDBus::BlockDriveRemoved);
    connect(DevMngIns, &DeviceManager::blockDevAoceand, this, &DeviceManagerDBus::BlockDeviceAoceand);
    connect(DevMngIns, &DeviceManager::blockDevFsAoceand, this, &DeviceManagerDBus::BlockDeviceFilesystemAoceand);
    ...
    connect(DevMngIns, &DeviceManager::protocolDevAoceand, this, &DeviceManagerDBus::ProtocolDeviceAoceand);
