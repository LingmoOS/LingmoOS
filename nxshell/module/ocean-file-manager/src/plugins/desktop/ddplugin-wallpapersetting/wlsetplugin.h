...
class WlSetPlugin : public dpf::Plugin
{
    ...
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.desktop" FILE "wallpapersetting.json")
#else
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.desktop.qt6" FILE "wallpapersetting.json")
#endif
