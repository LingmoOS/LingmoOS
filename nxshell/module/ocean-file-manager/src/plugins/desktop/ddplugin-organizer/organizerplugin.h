...
class OrganizerPlugin : public dpf::Plugin
{
    ...
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.desktop" FILE "organizerplugin.json")
#else
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.desktop.qt6" FILE "organizerplugin.json")
#endif
public:
