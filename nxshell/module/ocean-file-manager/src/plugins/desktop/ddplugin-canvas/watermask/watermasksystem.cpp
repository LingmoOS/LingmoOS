...
static constexpr char kConfName[] = "org.lingmo.ocean.file-manager.desktop.sys-watermask";
static constexpr char kDefaults[] = "defaults";

WatermaskSystem::WatermaskSystem(QWidget *parent) : QObject(parent)
{
    LingmoLicenseHelper::instance()->init();

    // 授权状态改变
    connect(LingmoLicenseHelper::instance(), &LingmoLicenseHelper::postLicenseState,
...
{
    QFileInfo info("/usr/share/lingmo/ocean-desktop-watermask");
...
void WatermaskSystem::getResource(const QString &root, const QString &lang, QString *logo, QString *text)
{
    ...
    QString path = QString("/usr/share/lingmo/ocean-desktop-watermask/") + root;
...
void WatermaskSystem::refresh()
{
    ...
    LingmoLicenseHelper::instance()->delayGetState();
}
...
void WatermaskSystem::stateChanged(int state, int prop)
{
    ...
    static QMap<int, QString> docs = {
        {LingmoLicenseHelper::LicenseProperty::Secretssecurity, QString("secretssecurity")},
        {LingmoLicenseHelper::LicenseProperty::Government, QString("government")},
        {LingmoLicenseHelper::LicenseProperty::Enterprise, QString("enterprise")},
        {LingmoLicenseHelper::LicenseProperty::Office, QString("office")},
        {LingmoLicenseHelper::LicenseProperty::BusinessSystem, QString("businesssystem")},
        {LingmoLicenseHelper::LicenseProperty::Equipment, QString("equipment")},
    };
    ...
    if (state == LingmoLicenseHelper::Authorized) {
        ...
        if (showSate) {
            switch (state) {
            case LingmoLicenseHelper::Unauthorized:
            case LingmoLicenseHelper::AuthorizedLapse:
            case LingmoLicenseHelper::TrialExpired: {
                textLabel->setText(tr("Not authorized"));
                textLabel->setObjectName(tr("Not authorized"));
            }
                break;
            case LingmoLicenseHelper::TrialAuthorized:{
