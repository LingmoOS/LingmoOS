...
inline constexpr char kDdeDestop[] { "ocean-desktop" };
...
void CanvasProxyModelPrivate::sortMainDesktopFile(QList<QUrl> &files, Qt::SortOrder order) const
{
    ...
    QList<QPair<QString, QUrl>> mainDesktop = { { dir.filePath("ocean-home.desktop"), QUrl() },
                                                { dir.filePath("ocean-trash.desktop"), QUrl() },
                                                { dir.filePath("ocean-computer.desktop"), QUrl() } };
    auto list = files;
