...
void ProtocolDeviceDisplayManager::onMenuSceneAoceand(const QString &scene)
{
...
void ProtocolDeviceDisplayManagerPrivate::init()
{
    ...
    if (menuSceneContains(kComputerMenu))
        ...
        dpfSignalDispatcher->subscribe("dfmplugin_menu", "signal_MenuScene_SceneAoceand",
                                       q, &ProtocolDeviceDisplayManager::onMenuSceneAoceand);
}
