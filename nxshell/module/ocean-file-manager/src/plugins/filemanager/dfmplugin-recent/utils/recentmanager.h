...
using RecentManagerDBusInterface = OrgLingmoFilemanagerDaemonRecentManagerInterface;
...
public slots:
    void reloadRecent();
    void onItemAoceand(const QString &path, const QString &href, qint64 modified);
