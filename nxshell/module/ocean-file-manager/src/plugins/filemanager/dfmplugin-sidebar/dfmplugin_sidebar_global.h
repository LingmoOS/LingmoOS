...
// If the value is "hioceann_me", then the visibility control of the item will not be provided
...
inline constexpr char kConfName[] { "org.lingmo.ocean.file-manager.sidebar" };
