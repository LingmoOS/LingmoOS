...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.filemanager" FILE "myshares.json")
...
protected Q_SLOTS:
    ...
    void onShareAoceand(const QString &path);
...
private:
    ...
    void beMySubOnAoceand(const QString &newScene);
    void followEvents();
    void bindWindows();
    void doInitialize();
