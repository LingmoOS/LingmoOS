...
void ShareWatcher::shareAoceand(const QString &path)
{
...
bool ShareWatcherPrivate::start()
{
    ...
    auto ret = true;
    ret &= dpfSignalDispatcher->subscribe("dfmplugin_dirshare", "signal_Share_ShareAoceand", qp, &ShareWatcher::shareAoceand);
...
bool ShareWatcherPrivate::stop()
{
    auto qp = qobject_cast<ShareWatcher *>(q);
    auto ret = true;
    ret &= dpfSignalDispatcher->unsubscribe("dfmplugin_dirshare", "signal_Share_ShareAoceand", qp, &ShareWatcher::shareAoceand);
