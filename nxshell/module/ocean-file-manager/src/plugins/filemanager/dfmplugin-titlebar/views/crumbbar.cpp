 ...
 *
 * \brief CrumbBar is the crumb bar widget of Lingmo File Manager
 *
 * CrumbBar is the crumb bar widget of Lingmo File Manager, provide the interface to manage
 * crumb bar state.
 *
...
void CrumbBar::customMenu(const QUrl &url, QMenu *menu)
{
    ...
    bool displayIcon { false };   // TODO: use ocean-dconfig
