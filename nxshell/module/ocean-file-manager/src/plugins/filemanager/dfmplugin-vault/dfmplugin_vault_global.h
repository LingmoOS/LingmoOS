...
inline constexpr char kDeamonServiceName[] { "org.lingmo.Filemanager.AccessControlManager" };
#ifdef COMPILE_ON_V2X
inline constexpr char kAppSessionService[] { "org.lingmo.ocean.SessionManager1" };
inline constexpr char kAppSessionPath[] { "/org/lingmo/ocean/SessionManager1" };
#else
inline constexpr char kAppSessionService[] { "com.lingmo.SessionManager" };
inline constexpr char kAppSessionPath[] { "/com/lingmo/SessionManager" };
#endif
inline constexpr char kNetWorkDBusServiceName[] { "org.lingmo.service.SystemNetwork" };
inline constexpr char kNetWorkDBusPath[] { "/org/lingmo/service/SystemNetwork" };
inline constexpr char kNetWorkDBusInterfaces[] { "org.lingmo.service.SystemNetwork" };

inline constexpr char kFileManagerDBusDaemonName[] { "org.lingmo.Filemanager.Daemon" };
inline constexpr char kFileManagerVaultDBusPath[] { "/org/lingmo/Filemanager/Daemon/VaultManager" };
inline constexpr char kFileManagerVaultDBusInterfaces[] { "org.lingmo.Filemanager.Daemon.VaultManager" };
...
inline constexpr char kVaultDConfigName[] { "org.lingmo.ocean.file-manager.vault" };
}
