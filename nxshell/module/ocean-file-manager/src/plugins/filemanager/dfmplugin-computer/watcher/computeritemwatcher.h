...
Q_SIGNALS:
    ...
    void itemAoceand(const ComputerItemData &item);
...
protected Q_SLOTS:
    void onDeviceAoceand(const QUrl &devUrl, int groupId, ComputerItemData::ShapeType shape = ComputerItemData::kLargeItem, bool needSidebarItem = true);
    ...
    void onBlockDeviceAoceand(const QString &id);
