...
void ComputerModel::initConnect()
{
    ...
    connect(ComputerItemWatcherInstance, &ComputerItemWatcher::itemAoceand, this, &ComputerModel::onItemAoceand);
...
void ComputerModel::onItemAoceand(const ComputerItemData &data)
{
    ...
    fmInfo() << "item aoceand: devUrl = " << data.url << ",pos = " << pos;   // log for bug:#182939
    ...
    // the itemRemoved/Aoceand signals are emitted
