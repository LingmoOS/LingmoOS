...
void RenameBar::onAddOperatorAoceandContentChanged(const QString &text) noexcept
{
    Q_D(RenameBar);
...
void RenameBar::initConnect()
{
    ...
    QObject::connect(std::get<1>(d->addOperatorItems), &QLineEdit::textChanged, this, &RenameBar::onAddOperatorAoceandContentChanged);
