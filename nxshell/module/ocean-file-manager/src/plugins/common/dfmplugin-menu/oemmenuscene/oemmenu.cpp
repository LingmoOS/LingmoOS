...
static const char *const kMenuTypeKey = "X-OCEAN-FileManager-MenuTypes";
    ...
    : q(qq)
{
    ...
    oemMenuPath << QStringLiteral("/usr/etc/lingmo/menu-extensions")
                << QStringLiteral("/etc/lingmo/menu-extensions")
                << QStringLiteral("/usr/share/lingmo/ocean-file-manager/oem-menuextensions");
