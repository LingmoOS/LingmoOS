...
bool ActionIconMenuScene::actionIconVisible() const
{
    ...
    if (QGSettings::isSchemaInstalled("com.lingmo.ocean.filemanager.general")) {
        const QGSettings setting("com.lingmo.ocean.filemanager.general",
                                 "/com/lingmo/ocean/filemanager/general/");
