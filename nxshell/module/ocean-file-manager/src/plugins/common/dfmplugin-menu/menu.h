...
private slots:
    void publishSceneAoceand(const QString &scene);
...
class Menu : public dpf::Plugin
{
    ...
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.common" FILE "menu.json")
#else
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.common.qt6" FILE "menu.json")
#endif
...
private:
    ...
    // MenuScene
    DPF_EVENT_REG_SIGNAL(signal_MenuScene_SceneAoceand)
