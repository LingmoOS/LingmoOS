    ...
    for (int i = 1; i <= maxPos; ++i) {
        ...
        if (current == locate.end()) {
            if (orgin.isEmpty()) {
                ...
                //用原有数据占位
                int aoceand = i - currentCount;
                for (int j = 0; j < aoceand;) {
                    if (orgin.isEmpty())
                        break;
...
static const char *const kConfCombo("X-OCEAN-FileManager-MenuTypes");
static const char *const kConfComboAlias("X-DFM-MenuTypes");
static const char *const kConfMimeType("MimeType");
static const char *const kConfExcludeMimeTypes("X-OCEAN-FileManager-ExcludeMimeTypes");
static const char *const kConfExcludeMimeTypesAlias("X-DFM-ExcludeMimeTypes");
static const char *const kConfSupportSchemes("X-OCEAN-FileManager-SupportSchemes");
static const char *const kConfSupportSchemesAlias("X-DFM-SupportSchemes");
static const char *const kConfNotShowIn("X-OCEAN-FileManager-NotShowIn");   // "Desktop", "Filemanager"
static const char *const kConfNotShowInAlias("X-DFM-NotShowIn");
static const char *const kConfSupportSuffix("X-OCEAN-FileManager-SupportSuffix");   // for lingmo-compress *.7z.001,*.7z.002,*.7z.003...
...
static const char *const kActionPos("X-OCEAN-FileManager-PosNum");
static const char *const kActionPosAlias("PosNum");
static const char *const kActionSeparator("X-OCEAN-FileManager-Separator");
