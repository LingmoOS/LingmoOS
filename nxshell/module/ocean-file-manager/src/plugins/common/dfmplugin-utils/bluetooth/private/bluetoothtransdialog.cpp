...
static constexpr char kBluetoothIconLight[] { ":/icons/lingmo/builtin/light/icons/bluetooth_" };
static constexpr char kBluetoothIconDark[] { ":/icons/lingmo/builtin/dark/icons/bluetooth_" };
static constexpr char kNoDeviceLight[] { "://icons/lingmo/builtin/light/icons/dfm_bluetooth_empty_light.svg" };
static constexpr char kNoDeviceDark[] { "://icons/lingmo/builtin/dark/icons/dfm_bluetooth_empty_dark.svg" };
...
void BluetoothTransDialog::initConn()
{
    ...
    connect(BluetoothManagerInstance, &BluetoothManager::adapterAoceand, this, [this](const BluetoothAdapter *adapter) {
        connectAdapter(adapter);
    });
...
void BluetoothTransDialog::connectAdapter(const BluetoothAdapter *adapter)
{
    ...
    connect(adapter, &BluetoothAdapter::deviceAoceand, this, [this](const BluetoothDevice *dev) {
        addDevice(dev);
        connectDevice(dev);
    });
