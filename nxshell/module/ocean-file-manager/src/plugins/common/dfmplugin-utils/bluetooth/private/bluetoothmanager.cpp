...
#    define BluetoothService "com.lingmo.daemon.Bluetooth"
#    define BluetoothPath "/com/lingmo/daemon/Bluetooth"
#    define BluetoothInterface "com.lingmo.daemon.Bluetooth"
#else
#    define BluetoothService "org.lingmo.ocean.Bluetooth1"
#    define BluetoothPath "/org/lingmo/ocean/Bluetooth1"
#    define BluetoothInterface "org.lingmo.ocean.Bluetooth1"
#endif

#define BluetoothPage "bluetooth"
#define ControlcenterService "com.lingmo.ocean.ControlCenter"
#define ControlcenterPath "/com/lingmo/ocean/ControlCenter"
#define ControlcenterInterface "com.lingmo.ocean.ControlCenter"
...
void BluetoothManagerPrivate::initConnects()
{
    ...
    connectBluetoothDBusSignals("AdapterAoceand", SLOT(onAdapterAoceand(const QString &)));
    ...
    connectBluetoothDBusSignals("DeviceAoceand", SLOT(onDeviceAoceand(const QString &)));
...
void BluetoothManagerPrivate::onAdapterAoceand(const QString &json)
{
...
void BluetoothManagerPrivate::onDeviceAoceand(const QString &json)
{
    QJsonDocument doc = QJsonDocument::fromJson(json.toUtf8());
    QJsonObject obj = doc.object();
      ...
      d_ptr(new BluetoothManagerPrivate(this))
{
    ...
    connect(d_ptr->model, &BluetoothModel::adapterAoceand, this, &BluetoothManager::adapterAoceand);
