...
static constexpr char kTagDBusPath[] { "/org/lingmo/Filemanager/Daemon/TagManager" };
...
void TagProxyHandlePrivate::connectToDBus()
{
    ...
    connections << q->connect(ptr, &TagManagerDBusInterface::NewTagsAoceand, q, &TagProxyHandle::newTagsAoceand);
