...
static const char *kOperationsStackService { "org.lingmo.Filemanager.Daemon" };
static const char *kOperationsStackPath { "/org/lingmo/Filemanager/Daemon/OperationsStackManager" };
