...
{
    dpfSignalDispatcher->unsubscribe("dfmplugin_dirshare", "signal_Share_ShareAoceand", this, &ShareControlWidget::updateWidgetStatus);
...
void ShareControlWidget::initConnection()
{
    ...
    dpfSignalDispatcher->subscribe("dfmplugin_dirshare", "signal_Share_ShareAoceand", this, &ShareControlWidget::updateWidgetStatus);
