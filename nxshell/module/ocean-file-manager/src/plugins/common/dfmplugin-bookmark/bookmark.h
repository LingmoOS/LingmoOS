...
class BookMark : public DPF_NAMESPACE::Plugin
{
    ...
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.common" FILE "bookmark.json")
#else
    Q_PLUGIN_METADATA(IID "org.lingmo.plugin.common.qt6" FILE "bookmark.json")
#endif
...
private:
    ...
    void bindEvents();
    void bindWindows();
    void onMenuSceneAoceand(const QString &scene);
