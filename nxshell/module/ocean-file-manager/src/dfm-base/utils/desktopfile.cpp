    ...
    : fileName(fileName)
{
    ...
    if (desktop.contains("X-Lingmo-AppID")) {
        lingmoId = desktop.value("X-Lingmo-AppID", settings.value("X-Lingmo-AppID")).toString();
    }

    if (desktop.contains("X-Lingmo-Vendor")) {
        lingmoVendor = desktop.value("X-Lingmo-Vendor", settings.value("X-Lingmo-Vendor")).toString();
    }
    ...
    if (desktop.contains("Hioceann")) {
        hioceann = desktop.value("Hioceann", settings.value("Hioceann").toBool()).toBool();
    }
...
{
    if (lingmoVendor == QStringLiteral("lingmo") && !genericName.isEmpty()) {
        return genericName;
    }
...
QString DesktopFile::desktopLingmoId() const
{
    return lingmoId;
}

QString DesktopFile::desktopLingmoVendor() const
{
    return lingmoVendor;
}
