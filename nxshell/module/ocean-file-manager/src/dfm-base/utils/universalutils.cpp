...
#    define SYSTEM_SYSTEMINFO_SERVICE "org.lingmo.ocean.SystemInfo1"
#    define SYSTEM_SYSTEMINFO_PATH "/org/lingmo/ocean/SystemInfo1"
#    define SYSTEM_SYSTEMINFO_INTERFACE "org.lingmo.ocean.SystemInfo1"

#    define DEAMON_DOCK_SERVICE "org.lingmo.ocean.daemon.Dock1"
#    define DEAMON_DOCK_PATH "/org/lingmo/ocean/daemon/Dock1"
#    define DEAMON_DOCK_INTERFACE "org.lingmo.ocean.daemon.Dock1"

#    define OCEAN_LOCKSERVICE_SERVICE "org.lingmo.ocean.LockService1"
#    define OCEAN_LOCKSERVICE_PATH "/org/lingmo/ocean/LockService1"
#    define OCEAN_LOCKSERVICE_INTERFACE "org.lingmo.ocean.LockService1"

#    define DESKTOP_FILEMONITOR_SERVICE "org.lingmo.ocean.desktop.filemonitor"
#    define DESKTOP_FILEMONITOR_PATH "/org/lingmo/ocean/desktop/filemonitor"
#    define DESKTOP_FILEMONITOR_INTERFACE "org.lingmo.ocean.desktop.filemonitor"
#else
#    define APP_MANAGER_SERVICE "com.lingmo.SessionManager"
#    define APP_MANAGER_PATH "/com/lingmo/StartManager"
#    define APP_MANAGER_INTERFACE "com.lingmo.StartManager"

#    define SYSTEM_SYSTEMINFO_SERVICE "com.lingmo.system.SystemInfo"
#    define SYSTEM_SYSTEMINFO_PATH "/com/lingmo/system/SystemInfo"
#    define SYSTEM_SYSTEMINFO_INTERFACE "com.lingmo.system.SystemInfo"

#    define DEAMON_SYSTEMINFO_SERVICE "com.lingmo.daemon.SystemInfo"
#    define DEAMON_SYSTEMINFO_PATH "/com/lingmo/daemon/SystemInfo"
#    define DEAMON_SYSTEMINFO_INTERFACE "com.lingmo.daemon.SystemInfo"

#    define DEAMON_DOCK_SERVICE "com.lingmo.ocean.daemon.Dock"
#    define DEAMON_DOCK_PATH "/com/lingmo/ocean/daemon/Dock"
#    define DEAMON_DOCK_INTERFACE "com.lingmo.ocean.daemon.Dock"

#    define OCEAN_LOCKSERVICE_SERVICE "com.lingmo.ocean.LockService"
#    define OCEAN_LOCKSERVICE_PATH "/com/lingmo/ocean/LockService"
#    define OCEAN_LOCKSERVICE_INTERFACE "com.lingmo.ocean.LockService"

#    define DESKTOP_FILEMONITOR_SERVICE "com.lingmo.ocean.desktop.filemonitor"
#    define DESKTOP_FILEMONITOR_PATH "/com/lingmo/ocean/desktop/filemonitor"
#    define DESKTOP_FILEMONITOR_INTERFACE "com.lingmo.ocean.desktop.filemonitor"
#endif
...
void UniversalUtils::notifyMessage(const QString &msg)
{
    DDBusSender()
            ...
            .arg(QObject::tr("ocean-file-manager"))
            .arg(static_cast<uint>(0))
            .arg(QString("ocean-file-manager"))
            .arg(msg)
            .arg(QString())
            .arg(QStringList())
            .arg(QVariantMap())
...
{
    //! 从com.lingmo.system.SystemInfo中获取实际安装的内存的大小
    QDBusInterface lingmoSystemInfo(SYSTEM_SYSTEMINFO_SERVICE,
                                    SYSTEM_SYSTEMINFO_PATH,
                                    SYSTEM_SYSTEMINFO_INTERFACE,
                                    QDBusConnection::systemBus());
    // 部分数据优先从dbus读取
    // 获取安装的内存总量
    if (lingmoSystemInfo.isValid())
        return static_cast<qint64>(lingmoSystemInfo.property("MemorySize").toULongLong());
...
{
    QDBusInterface lingmoDockInfo(DEAMON_DOCK_SERVICE,
                                  DEAMON_DOCK_PATH,
                                  DEAMON_DOCK_INTERFACE,
                                  QDBusConnection::sessionBus());

    int dockHeight = 0;
    if (lingmoDockInfo.isValid()) {
        QVariant temp = lingmoDockInfo.property("WindowSizeEfficient");
...
QString UniversalUtils::getCurrentUser()
{
    ...
    QDBusInterface sessionManagerIface(OCEAN_LOCKSERVICE_SERVICE,
                                       OCEAN_LOCKSERVICE_PATH,
                                       OCEAN_LOCKSERVICE_INTERFACE,
                                       QDBusConnection::systemBus());
