...
static constexpr char kDeviceService[] { "org.lingmo.Filemanager.Daemon" };
static constexpr char kDevMngPath[] { "/org/lingmo/Filemanager/Daemon/DeviceManager" };
...
const OrgLingmoFilemanagerDaemonDeviceManagerInterface *DeviceProxyManager::getDBusIFace() const
{
...
void DeviceProxyManagerPrivate::connectToDBus()
{
    ...
    connections << q->connect(ptr, &DeviceManagerInterface::BlockDriveAoceand, q, &DeviceProxyManager::blockDriveAoceand);
    connections << q->connect(ptr, &DeviceManagerInterface::BlockDriveRemoved, q, &DeviceProxyManager::blockDriveRemoved);
    connections << q->connect(ptr, &DeviceManagerInterface::BlockDeviceAoceand, q, &DeviceProxyManager::blockDevAoceand);
    ...
    connections << q->connect(ptr, &DeviceManagerInterface::BlockDeviceFilesystemAoceand, q, &DeviceProxyManager::blockDevFsAoceand);
    ...
    connections << q->connect(ptr, &DeviceManagerInterface::ProtocolDeviceAoceand, q, &DeviceProxyManager::protocolDevAoceand);
...
void DeviceProxyManagerPrivate::connectToAPI()
{
    ...
    devMngDBus.reset();
    auto ptr = DevMngIns;
    connections << q->connect(ptr, &DeviceManager::blockDriveAoceand, q, &DeviceProxyManager::blockDriveAoceand);
    connections << q->connect(ptr, &DeviceManager::blockDriveRemoved, q, &DeviceProxyManager::blockDriveRemoved);
    connections << q->connect(ptr, &DeviceManager::blockDevAoceand, q, &DeviceProxyManager::blockDevAoceand);
    ...
    connections << q->connect(ptr, &DeviceManager::blockDevFsAoceand, q, &DeviceProxyManager::blockDevFsAoceand);
    ...
    connections << q->connect(ptr, &DeviceManager::protocolDevAoceand, q, &DeviceProxyManager::protocolDevAoceand);
