...
class OrgLingmoFilemanagerDaemonDeviceManagerInterface;
namespace dfmbase {
...
public:
    ...
    const OrgLingmoFilemanagerDaemonDeviceManagerInterface *getDBusIFace() const;
...
Q_SIGNALS:
    ...
    void blockDriveAoceand();
    void blockDriveRemoved();
    void blockDevAoceand(const QString &id);
    ...
    void blockDevFsAoceand(const QString &id);
    void blockDevFsRemoved(const QString &id);

    void protocolDevAoceand(const QString &id);
