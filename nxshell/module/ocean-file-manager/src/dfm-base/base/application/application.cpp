...
Q_LOGGING_CATEGORY(logDFMBase, "org.lingmo.ocean.filemanager.lib.base")

namespace dfmbase {

Q_GLOBAL_STATIC_WITH_ARGS(Settings, gsGlobal, ("lingmo/ocean-file-manager", Settings::kGenericConfig))
Q_GLOBAL_STATIC_WITH_ARGS(Settings, asGlobal, ("lingmo/ocean-file-manager/ocean-file-manager", Settings::kGenericConfig))

Q_GLOBAL_STATIC_WITH_ARGS(Settings, gosGlobal, ("lingmo/ocean-file-manager.obtusely", Settings::kGenericConfig))
Q_GLOBAL_STATIC_WITH_ARGS(Settings, aosGlobal, ("lingmo/ocean-file-manager/ocean-file-manager.obtusely", Settings::kGenericConfig))

Q_GLOBAL_STATIC_WITH_ARGS(Settings, dpGlobal, ("", "", "/tmp/.config/lingmo/ocean-file-manager/ocean-file-manager.dp"))

// blumia: since ocean-desktop now also do show file selection dialog job, thus ocean-desktop should share the same config file
//         with ocean-file-manager, so we use GenericConfig with specify path to simulate AppConfig.
