...
public:
    // Application-level configuration, default in the ~/.config/lingmo/{AppName}/ocean-file-manager.json
    ...
    // Generic configuration, default in the ~/.config/lingmo/ocean-file-manager.json
