...
inline constexpr char kDefaultCfgPath[] { "org.lingmo.ocean.file-manager" };
inline constexpr char kPluginsDConfName[] { "org.lingmo.ocean.file-manager.plugins" };
inline constexpr char kViewDConfName[] { "org.lingmo.ocean.file-manager.view" };
inline constexpr char kAnimationDConfName[] { "org.lingmo.ocean.file-manager.animation" };
}   // namespace ConfigPath
