...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到文件管理器图标 ![lingmo_file_manager](../common/lingmo_file_manager.svg)，单击运行。
3. 右键单击 ![lingmo_file_manager](../common/lingmo_file_manager.svg)，您可以：
 - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 在任务栏右键单击 ![lingmo_file_manager](../common/lingmo_file_manager.svg)，选择 **关闭所有** ，退出文件管理器。
...
1. 在文件管理器界面，右键单击文件（夹）。
2. 选择 **病毒查杀**，弹出安全中心病毒查杀界面，您可以对该文件（夹）进行安全扫描，具体操作请参阅安全中心 [病毒查杀](dman:///lingmo-defender#病毒查杀)。
...
前提条件：发送端与接收端蓝牙设备已配对并成功连接。具体连接方法请参阅 [连接蓝牙设备](dman:///ocean#连接蓝牙设备)。
