...
inline constexpr char kIsOCEANDesktopFileIncluded[] = "isOCEANDesktopFileIncluded";   // bool, contains 'ocean-computer.desktop','ocean-trash.desktop' and 'ocean-home.desktop'
inline constexpr char kIsFocusOnOCEANDesktopFile[] = "isFocusOnOCEANDesktopFile";   // bool
}
