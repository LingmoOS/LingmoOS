...
TEST_F(UT_PluginManager, test_pluginIIDs)
{
    ...
    manager.addPluginIID("org.lingmo.ocean-file-manager");
    manager.addPluginIID("org.lingmo.ocean-desktop");
    manager.addPluginIID("org.lingmo.ocean-desktop");

    EXPECT_EQ(2, manager.pluginIIDs().size());
    EXPECT_TRUE(manager.pluginIIDs().contains("org.lingmo.ocean-file-manager"));
    EXPECT_TRUE(manager.pluginIIDs().contains("org.lingmo.ocean-desktop"));
}
