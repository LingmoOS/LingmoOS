...
TEST(DesktopDBusInterface, Refresh)
{
    ...
    ifs.Refresh();
    EXPECT_EQ(srv, QString("com.lingmo.ocean.desktop"));
    EXPECT_EQ(addr, QString("/org/lingmo/ocean/desktop/canvas"));
    EXPECT_EQ(sifs, QString("org.lingmo.ocean.desktop.canvas"));
...
TEST(DesktopDBusInterface, ShowWallpaperChooser)
{
    ...
    EXPECT_EQ(srv, QString("com.lingmo.ocean.desktop"));
    EXPECT_EQ(addr, QString("/org/lingmo/ocean/desktop/wallpapersettings"));
    EXPECT_EQ(sifs, QString("org.lingmo.ocean.desktop.wallpapersettings"));
