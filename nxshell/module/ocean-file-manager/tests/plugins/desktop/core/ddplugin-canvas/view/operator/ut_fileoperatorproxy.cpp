...
{
    QUrl url1 = QUrl::fromLocalFile(StandardPaths::location(StandardPaths::kDesktopPath) + "/ocean-trash.desktop");
    QUrl url2= QUrl::fromLocalFile(StandardPaths::location(StandardPaths::kDesktopPath) + "/ocean-computer.desktop");
    QUrl url3 = QUrl::fromLocalFile(StandardPaths::location(StandardPaths::kDesktopPath) + "/ocean-home.desktop");
