...
TEST(CanvasProxyModelPrivate, doSort)
{
    ...
    QUrl computer = QUrl::fromLocalFile("/home/test/ocean-computer.desktop");
    QUrl trash = QUrl::fromLocalFile("/home/test/ocean-trash.desktop");
    QUrl home = QUrl::fromLocalFile("/home/test/ocean-home.desktop");
