...
{
    const QString dirPath("/tmp/ut-ocean-desktop/watermask");
    QDir dir(dirPath);
    dir.mkpath(dirPath);
...
namespace  {
    ...
    public:
        ...
        const QString path = "/usr/share/lingmo/ocean-desktop-watermask.json";
...
TEST_F(WaterMaskFrameTest, update)
{
    ...
    cfg.maskLogoUri = "/usr/share/lingmo/uos_logo.svg";
    cfg.valid = true;
