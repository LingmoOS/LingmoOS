...
TEST(UT_TagProxyHandle, deleteFileTags)
{
    bool isRun { false };
    stub_ext::StubExt stub;
    stub.set_lamda(&OrgLingmoFilemanagerServerTagManagerInterface::Delete, [&isRun]() {
        isRun = true;
...
TEST(UT_TagProxyHandle, update)
{
    int isRun = 0;
    stub_ext::StubExt stub;
    stub.set_lamda(&OrgLingmoFilemanagerServerTagManagerInterface::Update, [&isRun]() {
        isRun++;
        return QDBusPendingReply<bool>();
    });
    QMap<QString, QVariant> fileWithTag;
...
TEST(UT_TagProxyHandle, Insert)
{
    int isRun = 0;
    stub_ext::StubExt stub;
    stub.set_lamda(&OrgLingmoFilemanagerServerTagManagerInterface::Insert, [&isRun]() {
        isRun++;
        return QDBusPendingReply<bool>();
    });
    stub.set_lamda(&QDBusPendingCall::isValid, []() {
...
TEST(UT_TagProxyHandle, Query)
{
    int isRun = 0;
    stub_ext::StubExt stub;
    auto func = static_cast<QDBusPendingReply<QDBusVariant> (OrgLingmoFilemanagerServerTagManagerInterface::*)(int opt, const QStringList &)>(&OrgLingmoFilemanagerServerTagManagerInterface::Query);
...
TEST(UT_TagProxyHandle, Query2)
{
    int isRun = 0;
    stub_ext::StubExt stub;
    auto func = static_cast<QDBusPendingReply<QDBusVariant> (OrgLingmoFilemanagerServerTagManagerInterface::*)(int opt)>(&OrgLingmoFilemanagerServerTagManagerInterface::Query);
    stub.set_lamda(func, [&isRun]() {
        isRun++;
        return QDBusPendingReply<QDBusVariant>();
    });
