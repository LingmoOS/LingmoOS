...
TEST_F(UT_MyShares, Start)
{
    ...
    typedef void (MyShares::*SubFunc1)(const QString &);   // type of MyShares::onShareAoceand, MyShares::onShareRemoved
...
TEST_F(UT_MyShares, OnShareAoceand)
{
    stub_ext::StubExt stub;
    stub.set_lamda(&MyShares::addToSidebar, [] { __DBG_STUB_INVOKE__ });
    EXPECT_NO_FATAL_FAILURE(ins.onShareAoceand(""));
}
...
TEST_F(UT_MyShares, BeMySubOnAoceand)
{
    stub_ext::StubExt stub;
    ...
    EXPECT_NO_FATAL_FAILURE(ins.beMySubOnAoceand("hello"));
}
