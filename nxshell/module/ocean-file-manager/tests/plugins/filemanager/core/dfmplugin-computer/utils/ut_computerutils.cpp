...
TEST_F(UT_ComputerUtils, MakeAppEntryUrl)
{
    ...
    EXPECT_NO_FATAL_FAILURE(ComputerUtils::makeAppEntryUrl("/usr/share/ocean-file-manager/extensions/appEntry/.readme").isValid());
    EXPECT_NO_FATAL_FAILURE(ComputerUtils::makeAppEntryUrl("/usr/share/ocean-file-manager/extensions/appEntry/readme.desktop").isValid());
}
