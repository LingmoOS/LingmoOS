...
TEST_F(UT_ProtocolDeviceDisplayManager, OnDConfigChanged)
{
    ...
    EXPECT_NO_FATAL_FAILURE(ProtocolDeviceDisplayManager::instance()->onDConfigChanged("org.lingmo.ocean.file-manager", "dfm.samba.permanent"));
...
TEST_F(UT_ProtocolDeviceDisplayManager, OnMenuSceneAoceand)
{
    ...
    EXPECT_NO_FATAL_FAILURE(ProtocolDeviceDisplayManager::instance()->onMenuSceneAoceand("hello"));
    EXPECT_NO_FATAL_FAILURE(ProtocolDeviceDisplayManager::instance()->onMenuSceneAoceand("ComputerMenu"));
}
