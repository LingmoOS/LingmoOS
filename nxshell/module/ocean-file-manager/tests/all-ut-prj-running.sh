...
UT_PRJ_TYPE=${3}
UT_TYPE_ALL="all"
UT_TYPE_FILE_MANAGER="ocean-file-manager"
...
echo `pwd`
echo "start ocean-file-manager all UT cases:" $UT_PRJ_TYPE
...
businessTestList=(
# apps
  # apps/ocean-file-manager
    apps/ocean-desktop
  # apps/ocean-file-manager-daemon
  # apps/ocean-file-manager-server
...
echo "end ocean-file-manager all UT cases"
