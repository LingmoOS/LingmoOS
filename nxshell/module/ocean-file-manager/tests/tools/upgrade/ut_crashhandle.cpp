...
{
    QString ret = QStandardPaths::standardLocations(QStandardPaths::GenericCacheLocation).first() + "/lingmo/ocean-file-manager";
    EXPECT_EQ(ret, CrashHandle::upgradeCacheDir());
}

TEST(CrashHandle, isCrashed)
{
    const QString dir = QStandardPaths::standardLocations(QStandardPaths::GenericCacheLocation).first() + "/lingmo/ocean-file-manager";
