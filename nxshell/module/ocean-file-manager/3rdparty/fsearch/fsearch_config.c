...
//        trace ("loaded config file\n");
        ...
        config->update_database_on_launch = config_load_boolean (key_file,
                                                                 ...
                                                                 false);
        config->exclude_hioceann_items = config_load_boolean (key_file,
                                                            "Database",
                                                            "exclude_hioceann_files_and_folders",
                                                            false);
...
config_load_default (FsearchConfig *config)
{
    ...
    config->exclude_hioceann_items = false;
...
config_save (FsearchConfig *config)
{
    ...
    g_key_file_set_boolean (key_file, "Database", "exclude_hioceann_files_and_folders", config->exclude_hioceann_items);
