...
bool config_make_dir(void);

bool config_load(FsearchConfig *config);

bool config_load_default(FsearchConfig *config);

bool config_save(FsearchConfig *config);

void config_build_dir(char *path, size_t len);

void database_build_dir(char *path, size_t len);

void config_free(FsearchConfig *config);
