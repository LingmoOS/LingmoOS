...
void TestWindowManagement::testCreateAfterUnmap()
{
    ...
    QSignalSpy windowAoceandSpy(m_windowManagement, &KWayland::Client::PlasmaWindowManagement::windowCreated);
...
void TestWindowManagement::testParentWindow()
{
    ...
    QSignalSpy windowAoceandSpy(m_windowManagement, &PlasmaWindowManagement::windowCreated);
    QVERIFY(windowAoceandSpy.isValid());
    ...
    auto transient = windowAoceandSpy.first().first().value<PlasmaWindow *>();
...
void TestWindowManagement::testGeometry()
{
    ...
    QVERIFY(!pm.isNull());
    QSignalSpy windowAoceandSpy(pm.data(), &PlasmaWindowManagement::windowCreated);
    QVERIFY(windowAoceandSpy.isValid());
    QVERIFY(windowAoceandSpy.wait());
