...
#include "../src/client/oceanshell.h"
...
private:
    ...
    GlobalProperty *m_oceanGlobalProperty = nullptr;

    OCEANShell *m_oceanShell = nullptr;
    OCEANShellSurface *m_oceanShellSurface = nullptr;
...
void GlobalPropertyTest::setupRegistry(Registry *registry)
{
    ...
    connect(registry, &Registry::oceanShellAnnounced, this, [this, registry](quint32 name, quint32 version) {
        m_oceanShell = registry->createOCEANShell(name, version, this);
        m_oceanShell->setEventQueue(m_eventQueue);
    });
    connect(registry, &Registry::oceanGlobalPropertyAnnounced, this, [this, registry](quint32 name, quint32 version) {
        m_oceanGlobalProperty = registry->createGlobalProperty(name, version, this);
        m_oceanGlobalProperty->setEventQueue(m_eventQueue);
    });
    ...
    connect(registry, &Registry::interfacesAnnounced, this, [this] {
        ...
        m_oceanShellSurface = m_oceanShell->createShellSurface(m_surface, this);
        ...
        m_oceanGlobalProperty->setProperty("window", "decorate", m_surface, 1, jsonByteArr.constData());
    });
