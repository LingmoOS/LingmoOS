...
static const QMap<Registry::Interface, SuppertedInterfaceData> s_interfaces = {
    ...
    {Registry::Interface::ClientManagement, {
        1,
        QByteArrayLiteral("com_lingmo_client_management"),
        &com_lingmo_client_management_interface,
        &Registry::clientManagementAnnounced,
        &Registry::clientManagementRemoved
    }},
    {Registry::Interface::OCEANShell, {
        1,
        QByteArrayLiteral("ocean_shell"),
        &ocean_shell_interface,
        &Registry::oceanShellAnnounced,
        &Registry::oceanShellRemoved
    }},
    {Registry::Interface::GlobalProperty, {
        1,
        QByteArrayLiteral("ocean_globalproperty"),
        &ocean_globalproperty_interface,
        &Registry::oceanGlobalPropertyAnnounced,
        &Registry::oceanGlobalPropertyRemoved
    }},
    {Registry::Interface::OCEANSeat, {
        1,
        QByteArrayLiteral("ocean_seat"),
        &ocean_seat_interface,
        &Registry::oceanSeatAnnounced,
        &Registry::oceanSeatRemoved
    }},
    {Registry::Interface::Strut, {
        1,
        QByteArrayLiteral("com_lingmo_kwin_strut"),
        &com_lingmo_kwin_strut_interface,
...
BIND(ClientManagement, com_lingmo_client_management)
BIND(OCEANSeat, ocean_seat)
BIND(OCEANShell, ocean_shell)
BIND(Strut, com_lingmo_kwin_strut)
BIND(GlobalProperty, ocean_globalproperty)
