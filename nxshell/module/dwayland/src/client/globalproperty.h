...
public:
     ...
     * method.
     **/
    void setup(ocean_globalproperty *oceanglobalproperty);

    bool isValid() const;

    operator ocean_globalproperty*();
    operator ocean_globalproperty*() const;
    ocean_globalproperty *oceanGlobalProperty();
