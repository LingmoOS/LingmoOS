...
/**
 * @short Wrapper for the com_lingmo_client_management interface.
 *
 * This class provides a convenient wrapper for the com_lingmo_client_management interface.
 ...
 * @endcode
 *
 * The ClientManagement can be used as a drop-in replacement for any com_lingmo_client_management
...
public:
     ...
     * method.
     **/
    void setup(com_lingmo_client_management *clientManagement);

    /**
     * @returns @c true if managing a com_lingmo_client_management.
     **/
    bool isValid() const;
    operator com_lingmo_client_management*();
    operator com_lingmo_client_management*() const;
    com_lingmo_client_management *clientManagement();
