...
struct com_lingmo_client_management;
struct ocean_seat;
struct ocean_shell;
struct com_lingmo_kwin_strut;
struct ocean_globalproperty;
 ...
 * aoceand or an existing interface is removed. For the well known interfaces
...
public:
    ...
    enum class Interface {
        ...
        ClientManagement,///refers to com_lingmo_client_management, @since 5.83
        OCEANSeat, ///refers to ocean_shell, @since 5.54
        OCEANShell, ///<refers to ocean_shell, @since 5.54
        Strut, ///< refers to com_lingmo_kwin_strut interface
        GlobalProperty,
     ...
     * The EventQueue gets automatically aoceand to all interfaces created by
    ...
    /**
     * Binds the com_lingmo_client_management with @p name and @p version.
     * If the @p name does not exist,
     * @c null will be returned.
     *
     ...
     * @since 5.83
     **/
    com_lingmo_client_management *bindClientManagement(uint32_t name, uint32_t version) const;

   /**
     * Binds the ocean_shell with @p name and @p version.
     * If the @p name does not exist,
     * @c null will be returned.
     *
     * Prefer using createOCEANShell instead.
     * @see createOCEANShell
     * @since 5.54
     **/
    ocean_shell *bindOCEANShell(uint32_t name, uint32_t version) const;

    /**
     * Binds the ocean_globalproperty with @p name and @p version.
     * If the @p name does not exist,
     * @c null will be returned.
     *
     ...
     * @since 5.54
     **/
    ocean_globalproperty *bindGlobalProperty(uint32_t name, uint32_t version) const;
     ...
     * @c null will be returned.
     *
     * Prefer using createOCEANSeat instead.
     * @see createOCEANSeat
     * @since 5.54
     **/
    ocean_seat *bindOCEANSeat(uint32_t name, uint32_t version) const;

    /**
     * Binds the com_lingmo_kwin_strut with @p name and @p version.
     ...
     * @since 5.5
     **/
    com_lingmo_kwin_strut *bindStrut(uint32_t name, uint32_t version) const;
    ...
    /**
     * Creates an OCEANShell and sets it up to manage the interface identified by
     * @p name and @p version.
     *
     * Note: in case @p name is invalid or isn't for the zxdg_decoration_manager_v1 interface,
     * the returned OCEANShell will not be valid. Therefore it's recommended to call
     * isValid on the created instance.
     *
     * @param name The name of the zxdg_decoration_manager_v1 interface to bind
     * @param version The version or the zxdg_decoration_manager_v1 interface to use
     * @param parent The parent for OCEANShell
     *
     * @returns The created OCEANShell.
     * @since 5.54
     **/
    OCEANShell *createOCEANShell(quint32 name, quint32 version, QObject *parent = nullptr);
    ...
    /**
     * Creates an OCEANSeat and sets it up to manage the interface identified by
     * @p name and @p version.
     *
     * Note: in case @p name is invalid or isn't for the zxdg_decoration_manager_v1 interface,
     * the returned OCEANSeat will not be valid. Therefore it's recommended to call
     * isValid on the created instance.
     *
     * @param name The name of the zxdg_decoration_manager_v1 interface to bind
     * @param version The version or the zxdg_decoration_manager_v1 interface to use
     * @param parent The parent for OCEANSeat
     *
     * @returns The created OCEANSeat.
     * @since 5.54
     **/
    OCEANSeat *createOCEANSeat(quint32 name, quint32 version, QObject *parent = nullptr);

    /**
     * Creates a Strut and sets it up to manage the interface identified by
     * @p name and @p version.
     *
     * Note: in case @p name is invalid or isn't for the com_lingmo_kwin_strut interface,
     * the returned Strut will not be valid. Therefore it's recommended to call
     * isValid on the created instance.
     *
     * @param name The name of the com_lingmo_kwin_strut interface to bind
     * @param version The version or the com_lingmo_kwin_strut interface to use
...
Q_SIGNALS:
    ...
    /**
     * Emitted whenever a com_lingmo_client_management interface gets announced.
     * @param name The name for the announced interface
     * @param version The maximum supported version of the announced interface
     * @since 5.83
     **/
    ...
    /**
     * Emitted whenever a ocean_shell interface gets announced.
     * @param name The name for the announced interface
     * @param version The maximum supported version of the announced interface
     * @since 5.54
     **/
    void oceanShellAnnounced(quint32 name, quint32 version);

    /**
     * Emitted whenever a ocean_globalProperty interface gets announced.
     * @param name The name for the announced interface
     * @param version The maximum supported version of the announced interface
     * @since 5.54
     **/
    void oceanGlobalPropertyAnnounced(quint32 name, quint32 version);
     ...
     * @since 5.54
     **/
    void oceanSeatAnnounced(quint32 name, quint32 version);

    /**
     * Emitted whenever a com_lingmo_kwin_strut interface gets announced.
     * @param name The name for the announced interface
     * @param version The maximum supported version of the announced interface
     * @since 5.5
     **/
    ...
    /**
     * Emitted whenever a com_lingmo_client_management gets removed.
     * @param name The name of the removed interface
     * @since 5.83
     **/
    void clientManagementRemoved(quint32 name);

    void oceanShellRemoved(quint32 name);

    void oceanGlobalPropertyRemoved(quint32 name);

    /**
     * Emitted whenever a ocean_shell gets removed.
     * @param name The name of the removed interface
     * @since 5.54
     **/
    void oceanSeatRemoved(quint32 name);

    /**
     * Emitted whenever a com_lingmo_kwin_strut interface gets removed.
     * @param name The name for the removed interface
     * @since 5.5
     **/
