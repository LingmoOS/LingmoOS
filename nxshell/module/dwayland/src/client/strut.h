...
struct lingmoKwinStrut
{
    ...
    lingmoKwinStrut& operator=(const lingmoKwinStrut& rhs)
    {
        if(this == &rhs) {
            return *this;
        }
...
/**
 * @short Wrapper for the com_lingmo_kwin_strut interface.
 *
 * This class is a convenient wrapper for the com_lingmo_kwin_strut interface.
 *
 *
...
public:
     ...
     * Set the strut area.
     **/
    void setStrutPartial(wl_surface *surface,lingmoKwinStrut& sStrut);
    /**
     * @returns @c true if managing a com_lingmo_kwin_strut.
     **/
    bool isValid() const;
    /**
     * Setup this com_lingmo_kwin_strut to manage the @p strut.
     * When using Registry::createStrut there is no need to call this
     * method.
     **/
    void setup(com_lingmo_kwin_strut *strut);
    /**
     * Releases the com_lingmo_kwin_strut interface.
     * After the interface has been released the strut instance is no
     * longer valid and can be setup with another com_lingmo_kwin_strut interface.
     **/
    void release();
    /**
    ...
    operator com_lingmo_kwin_strut*();
    operator com_lingmo_kwin_strut*() const;
