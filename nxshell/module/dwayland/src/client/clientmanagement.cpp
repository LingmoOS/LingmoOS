...
public:
    ...
    void setup(com_lingmo_client_management *o);
    ...
    WaylandPointer<com_lingmo_client_management, com_lingmo_client_management_destroy> clientManagement;
    EventQueue *queue = nullptr;
    uint m_windowsCount;
    WindowStates m_windowStates;

private:
    static void windowStatesCallback(void *data, com_lingmo_client_management *clientManagement, uint32_t count, wl_array *windowStates);
    static void windowCaptureCallback(void *data, com_lingmo_client_management *clientManagement, int windowId, int succeed, wl_buffer *buffer);
    static void splitChangeCallback(void *data, com_lingmo_client_management *clientManagement, const char *uuid, uint32_t splitable);
    ...
    ClientManagement *q;
    static struct com_lingmo_client_management_listener s_clientManagementListener;
};
...
void ClientManagement::Private::get_window_states()
{
    ...
    com_lingmo_client_management_get_window_states(clientManagement);
}

void ClientManagement::Private::getWindowCaption(int windowId, wl_buffer *buffer)
{
    Q_ASSERT(clientManagement);
    com_lingmo_client_management_capture_window_image(clientManagement, windowId, buffer);
}

void ClientManagement::Private::requestSplitWindow(const char *uuid, int splitType)
{
    Q_ASSERT(clientManagement);
    com_lingmo_client_management_split_window(clientManagement, uuid, splitType);
}

void ClientManagement::Private::setup(com_lingmo_client_management *o)
{
    Q_ASSERT(o);
    Q_ASSERT(!clientManagement);
    clientManagement.setup(o);
    com_lingmo_client_management_add_listener(clientManagement, &s_clientManagementListener, this);
}
...
com_lingmo_client_management_listener ClientManagement::Private::s_clientManagementListener = {
...
void ClientManagement::Private::windowStatesCallback(void *data, com_lingmo_client_management *clientManagement,
                                                uint32_t count,
...
void ClientManagement::Private::windowCaptureCallback(void *data, com_lingmo_client_management *clientManagement,
...
void ClientManagement::Private::splitChangeCallback(void *data, com_lingmo_client_management *clientManagement,
...
void ClientManagement::setup(com_lingmo_client_management *clientManagement)
{
...
com_lingmo_client_management *ClientManagement::clientManagement()
{
...
ClientManagement::operator com_lingmo_client_management*() {
    return d->clientManagement;
}

ClientManagement::operator com_lingmo_client_management*() const {
    return d->clientManagement;
}
