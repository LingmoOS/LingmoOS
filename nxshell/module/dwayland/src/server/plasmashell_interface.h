...
public:
    ...
    /**
     * Informs the PlasmaShellSurfaceInterface that the auto-hiding panel got hioceann.
...
Q_SIGNALS:
    ...
    /**
     * A surface with Role Panel and PanelBehavior AutoHide requested to be hioceann.
     *
     * The compositor should inform the PlasmaShellSurfaceInterface about the actual change.
     * Once the surface is hioceann it should invoke {@link hideAutoHidingPanel}. If the compositor
