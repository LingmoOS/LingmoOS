...
public:
    ...
    OCEANPointerInterfacePrivate(OCEANPointerInterface *q, OCEANSeatInterface *seat, wl_resource *resource);
...
public:
    ...
    OCEANTouchInterfacePrivate(OCEANTouchInterface *q, OCEANSeatInterface *seat, wl_resource *resource);
