...
#endif
    Q_PROPERTY(QString lingmoDistributionOrgLogo READ lingmoDistributionOrgLogo CONSTANT)
    Q_PROPERTY(QString lingmoWebsiteName READ lingmoWebsiteName CONSTANT)
    Q_PROPERTY(QString lingmoWebsiteLink READ lingmoWebsiteLink CONSTANT)
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
...
public:
    ...
    QString lingmoWebsiteName() const;
    QString lingmoWebsiteLink() const;
    QString lingmoDistributionOrgLogo() const;
