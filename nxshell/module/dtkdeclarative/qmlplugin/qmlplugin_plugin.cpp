...
void QmlpluginPlugin::registerTypes(const char *uri)
{
    ...
    dtkRegisterType(uri, controlsUri, 1, 0, "EmbeoceandProgressBar");
    dtkRegisterType(uri, controlsUri, 1, 0, "WaterProgressBar");

    // for org.lingmo.dtk.settings
    ...
    // for org.lingmo.dtk.style(allowed to override)
