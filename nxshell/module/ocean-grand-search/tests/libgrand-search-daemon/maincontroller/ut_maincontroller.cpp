...
TEST(MainControllerTestPrivate, ut_checkSearcher_0)
{
    ...
    resultTest.append("com.lingmo.ocean-grand-search.file-lingmo");
    resultTest.append("com.lingmo.ocean-grand-search.file-fsearch");
    EXPECT_EQ(result, resultTest);
    ...
    resultTest.append("com.lingmo.ocean-grand-search.file-lingmo");
    resultTest.append("com.lingmo.ocean-grand-search.file-fsearch");
    resultTest.append("com.lingmo.ocean-grand-search.app-desktop");
    EXPECT_EQ(result, resultTest);
}
