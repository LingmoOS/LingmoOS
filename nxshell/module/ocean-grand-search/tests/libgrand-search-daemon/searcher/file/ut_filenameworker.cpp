...
public:
    FileNameWorkerTest() : testing::Test()
    {
        ...
        worker.reset(new FileNameWorker(GRANDSEARCH_CLASS_FILE_LINGMO, false));
    }
...
{
    stub_ext::StubExt st;
    st.set_lamda(&ComLingmoAnythingInterface::isValid, [](){ return false; });
...
TEST_F(FileNameWorkerTest, ut_working_1)
{
    ...
    stub_ext::StubExt st;
    st.set_lamda(&ComLingmoAnythingInterface::isValid, [](){ return true; });
    st.set_lamda(&ComLingmoAnythingInterface::hasLFT, [](){
...
TEST_F(FileNameWorkerTest, ut_searchByAnything_1)
{
    ...
    stub_ext::StubExt st;
    SearchType (ComLingmoAnythingInterface::*search_addr)(int, qlonglong, uint, uint, const QString &, const QString &, bool) = &ComLingmoAnythingInterface::search;
