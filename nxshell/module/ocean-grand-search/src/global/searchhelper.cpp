...
{
    m_groupSearcherHash.insert(DOCUMENT_GROUP, {GRANDSEARCH_CLASS_FILE_LINGMO, GRANDSEARCH_CLASS_FILE_FSEARCH});
    m_groupSearcherHash.insert(PICTURE_GROUP, {GRANDSEARCH_CLASS_FILE_LINGMO, GRANDSEARCH_CLASS_FILE_FSEARCH});
    m_groupSearcherHash.insert(AUDIO_GROUP, {GRANDSEARCH_CLASS_FILE_LINGMO, GRANDSEARCH_CLASS_FILE_FSEARCH});
    m_groupSearcherHash.insert(VIDEO_GROUP, {GRANDSEARCH_CLASS_FILE_LINGMO, GRANDSEARCH_CLASS_FILE_FSEARCH});
    m_groupSearcherHash.insert(FILE_GROUP, {GRANDSEARCH_CLASS_FILE_LINGMO, GRANDSEARCH_CLASS_FILE_FSEARCH});
    m_groupSearcherHash.insert(FOLDER_GROUP, {GRANDSEARCH_CLASS_FILE_LINGMO, GRANDSEARCH_CLASS_FILE_FSEARCH});
