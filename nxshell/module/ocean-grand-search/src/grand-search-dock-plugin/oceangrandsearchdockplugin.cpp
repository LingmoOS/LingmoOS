...
#define GrandSearchApp "ocean-grand-search"

#define SchemaId "com.lingmo.ocean.dock.module.grand-search"
#define SchemaPath "/com/lingmo/ocean/dock/module/grand-search/"
