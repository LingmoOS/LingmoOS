...
#ifndef OCEANGRANDSEARCHDOCKPLUGIN_H
#define OCEANGRANDSEARCHDOCKPLUGIN_H
...
class DdeGrandSearchDockPlugin : public QObject, public PluginsItemInterfaceV2
{
    ...
    // 插件元数据
    Q_PLUGIN_METADATA(IID ModuleInterface_iid_V2 FILE "oceangrandsearch_dockplugin2.json")
#else
class DdeGrandSearchDockPlugin : public QObject, PluginsItemInterface
{
    ...
    // 插件元数据
    Q_PLUGIN_METADATA(IID "com.lingmo.dock.PluginsItemInterface" FILE "oceangrandsearch_dockplugin.json")
#endif
public:
...
#endif   // OCEANGRANDSEARCHDOCKPLUGIN_H
