 ...
 * Command line was: qdbusxml2cpp -m -p anything_interface /usr/share/dbus-1/interfaces/com.lingmo.anything.xml
 *
...
/*
 * Proxy class for interface com.lingmo.anything
 */
class ComLingmoAnythingInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "com.lingmo.anything"; }

public:
    ComLingmoAnythingInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~ComLingmoAnythingInterface();
...
namespace com {
  namespace lingmo {
    typedef ::ComLingmoAnythingInterface anything;
  }
}
#endif
