...
1. Click ![lingmo-launcher](../common/lingmo_launcher.svg) on the Dock to enter the interface of launcher.
...
When a task status changes, the system will notify you about the change. Please read [Notification Settings](dman:///ocean#Notification Settings) for details. 
