...
Name:           org.lingmo.downloader
Version:        5.3.34
Release:        1%{pkgrelease}
Summary:        a user-friendly download tool, supporting URLs and torrent files
License:        GPLv3+
URL:            https://github.com/lingmoos/org.lingmo.downloader
Source0:        lingmo-downloader_%{version}.orig.tar.gz
...
%{_datadir}/lingmo-manual/manual-assets/application/downloader/*
