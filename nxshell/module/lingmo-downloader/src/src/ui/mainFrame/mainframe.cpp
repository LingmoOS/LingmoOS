...
void MainFrame::init()
{
    ...
    m_DownloadingItem = new DStandardItem(QIcon::fromTheme("oceanui_list_downloading"), tr("Downloading"));
    m_DownloadingItem->setAccessibleText("Downloading");
    m_DownloadingItem->setFont(font);
    m_DownloadFinishItem = new DStandardItem(QIcon::fromTheme("oceanui_print_done"), tr("Completed"));
    m_DownloadFinishItem->setAccessibleText("Completed");
    m_DownloadFinishItem->setFont(font);
    m_RecycleItem = new DStandardItem(QIcon::fromTheme("oceanui_list_delete"), tr("Trash"));
...
void MainFrame::setPaletteType()
{
    ...
    if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::DarkType) {
        ...
        m_DownloadingItem->setIcon(QIcon::fromTheme("oceanui_list_downloading_dark", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_list_downloading_dark_11px.svg")));
        m_DownloadFinishItem->setIcon(QIcon::fromTheme("oceanui_print_done_dark", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_print_done_dark_11px.svg")));
        m_RecycleItem->setIcon(QIcon::fromTheme("oceanui_list_delete_dark", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_list_delete_dark_11px.svg")));
        ...
        m_TaskNumWidget->setPalette(palette);
        m_NotaskLabel->setWindowOpacity(0.2);
        m_DownloadingItem->setIcon(QIcon::fromTheme("oceanui_list_downloading", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_list_downloading_dark_11px.svg")));
        m_DownloadFinishItem->setIcon(QIcon::fromTheme("oceanui_print_done", QIcon(":/icons/lingmo/builtin/light/actions/oceanui_print_done_11px.svg")));
        m_RecycleItem->setIcon(QIcon::fromTheme("oceanui_list_delete", QIcon(":/icons/lingmo/builtin/light/actions/oceanui_list_delete_11px.svg")));
        //m_pdownloadingItem->setBackground(DGuiApplicationHelper::instance()->applicationPalette().base());
        //m_pdownloadfinishItem->setBackground(DGuiApplicationHelper::instance()->applicationPalette().base());
        //m_precycleItem->setBackground(DGuiApplicationHelper::instance()->applicationPalette().base());
...
void MainFrame::btNotificaitonSettings(QString head, QString text, bool isBt)
{
    ...
    if (downloadInfoNotify) {
        QDBusInterface tInterNotify("com.lingmo.ocean.Notification",
        ...
        if (isBt) {
            in5 << "_view" << tr("View");
            in6["x-lingmo-action-_view"] = "downloader";
        }
