...
void TopButton::Init()
{
    ...
    m_newDownloadBtn->setIcon(QIcon::fromTheme("oceanui_newdownload"));
    ...
    m_pauseDownloadBtn->setIcon(QIcon::fromTheme("oceanui_list_icon_pause"));
    ...
    m_startDownloadBtn->setIcon(QIcon::fromTheme("oceanui_icon_start"));
    ...
    m_deleteDownloadBtn->setIcon(QIcon::fromTheme("oceanui_list_icon_delete"));
...
{
    if (index == 2) {
        m_startDownloadBtn->setIcon(QIcon::fromTheme("oceanui_recycel_delete"));
        m_pauseDownloadBtn->setIcon(QIcon::fromTheme("oceanui_recycel_restore"));
        m_deleteDownloadBtn->setIcon(QIcon::fromTheme("oceanui_list_icon_delete"));
        ...
        m_startDownloadBtn->setIcon(QIcon::fromTheme("oceanui_finish_openfolder"));
        m_pauseDownloadBtn->setIcon(QIcon::fromTheme("oceanui_finish_openfile"));
        m_deleteDownloadBtn->setIcon(QIcon::fromTheme("oceanui_list_icon_delete"));
