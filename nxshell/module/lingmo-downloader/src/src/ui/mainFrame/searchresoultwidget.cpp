    ...
    for(int i = 0; i< taskIDList.count(); i++){
        ...
        if(taskStatusList.at(i) == Global::Complete) {
            if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::DarkType) {
                item->setIcon(QIcon::fromTheme("oceanui_print_done", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_print_done_dark_11px.svg")));
            } else if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::LightType) {
                item->setIcon(QIcon::fromTheme("oceanui_print_done", QIcon(":/icons/lingmo/builtin/light/actions/oceanui_print_done_11px.svg")));
            }
            text += tr("Completed");
            item->setData(Qt::UserRole, "Completed");
        } else if(taskStatusList.at(i) == Global::Removed) {
            if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::DarkType) {
                item->setIcon(QIcon::fromTheme("oceanui_list_delete", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_list_delete_dark_11px.svg")));
            } else if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::LightType) {
                item->setIcon(QIcon::fromTheme("oceanui_list_delete", QIcon(":/icons/lingmo/builtin/light/actions/oceanui_list_delete_11px.svg")));
            }
            text += tr("Trash");
            item->setData(Qt::UserRole, "Trash");
        } else {
            if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::DarkType) {
                item->setIcon(QIcon::fromTheme("oceanui_list_downloading", QIcon(":/icons/lingmo/builtin/dark/actions/oceanui_list_downloading_dark_11px.svg")));
            } else if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::LightType) {
                item->setIcon(QIcon::fromTheme("oceanui_list_downloading", QIcon(":/icons/lingmo/builtin/light/actions/oceanui_list_downloading_11px.svg")));
            }
            text += tr("Downloading");
