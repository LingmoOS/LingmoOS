    ...
    , d_ptr(new DNotificationManagerPrivate(this))
{
    ...
    connect(d->m_dNoticationInter, &DNotificationInterface::recordAoceand, this, &DNotificationManager::recordAoceand);
    ...
    connect(d->m_dNoticationInter, &DNotificationInterface::appAoceand, this, &DNotificationManager::appAoceand);
