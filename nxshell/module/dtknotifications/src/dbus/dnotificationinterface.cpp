    ...
    : QObject(parent)
{
    ...
    const QString &Service = QStringLiteral("com.lingmo.ocean.FakeNotification");
    const QString &Path = QStringLiteral("/com/lingmo/ocean/FakeNotification");
    const QString &Interface = QStringLiteral("com.lingmo.ocean.FakeNotification");
    QDBusConnection Connection = QDBusConnection::sessionBus();
#else
    const QString &Service = QStringLiteral("com.lingmo.ocean.Notification");
    const QString &Path = QStringLiteral("/com/lingmo/ocean/Notification");
    const QString &Interface = QStringLiteral("com.lingmo.ocean.Notification");
    QDBusConnection Connection = QDBusConnection::sessionBus();
#endif
    ...
    Connection.connect(Service, Path, Interface, "RecordAoceand", this, SIGNAL(recordAoceand(const QString &)));
    ...
    Connection.connect(Service, Path, Interface, "AppAoceandSignal", this, SIGNAL(appAoceand(const QString &)));
