...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.ocean.FakeNotification")
    Q_CLASSINFO("D-Bus Introspection", ""
                "  <interface name=\"com.lingmo.ocean.FakeNotification\">\n"
...
public:
    ...
    QStringList m_appList{"ocean-control-center", "ocean-dock"};
    QStringList m_capabilities{"action-icons", "actions", "body", "body-hyperlinks", "body-markup"};
    QString m_getAllRecords{"test"}, m_record{"test"}, m_records{"test0, test1"}, m_serverInfo{"lingmo"};
