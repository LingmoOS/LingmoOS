...
{
    const QString &Service = QLatin1String("com.lingmo.ocean.FakeNotification");
    const QString &Path = QLatin1String("/com/lingmo/ocean/FakeNotification");
...
{
    QDBusConnection bus = QDBusConnection::sessionBus();
    bus.unregisterObject("/com/lingmo/ocean/FakeNotification");
    bus.unregisterService("com.lingmo.ocean.FakeNotification");
}
