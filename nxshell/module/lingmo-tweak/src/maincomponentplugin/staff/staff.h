...
{
    qmlRegisterUncreatableType<FileBackend>("org.lingmo.tweak",
                                            1,
                                            0,
                                            "FileBackend",
                                            "cannot create filebackend object.");
    qmlRegisterType<FileMode>("org.lingmo.tweak", 1, 0, "FileMode");
    qmlRegisterUncreatableType<LauncherCall>("org.lingmo.tweak",
                                             1,
                                             0,
                                             "LauncherCall",
                                             "cannot create LauncherCall object.");
    qmlRegisterUncreatableType<SettingsBackend>("org.lingmo.tweak",
                                                1,
                                                0,
                                                "SettingsBackend",
                                                "cannot create Settings object.");
    qmlRegisterUncreatableType<GSettingsBackend>("org.lingmo.tweak",
                                                 1,
                                                 0,
                                                 "GSettingsBackend",
                                                 "cannot create GSettings object.");
    qmlRegisterSingletonType<Staff>("org.lingmo.tweak",
                                    1,
                                    0,
                                    "Tweak",
