    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Image {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: Qt.openUrlExternally("https://github.com/lingmoos/")
                }
            }
            Image {
                source: "/images/lingmo-logo.svg"
                MouseArea {
                    anchors.fill: parent
                    onClicked: Qt.openUrlExternally("https://www.lingmo.org/")
                }
            }
            Item {
            ...
            Text {
                text: qsTr("Made by lingmo Opensource Community with love.")
