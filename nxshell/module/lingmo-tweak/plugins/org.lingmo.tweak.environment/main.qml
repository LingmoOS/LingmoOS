...
ColumnLayout {
    ...
    Text {
        ...
        text: qsTr('Please modify environment variables carefully.You must clearly understand the importance of system environment variables. This operation is irreversible.If there is a problem, please log in with tty and delete the $HOME/.ocean_env file to restore the environment. Please login again to apply changes.')
    }
