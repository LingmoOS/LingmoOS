...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到五子棋图标 ![lingmo_gomoku](../common/lingmo_gomoku.svg) ，单击运行  。
3. 右键单击 ![lingmo_gomoku](../common/lingmo_gomoku.svg)，您可以：
   - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 右键单击任务栏上的 ![lingmo_gomoku](../common/lingmo_gomoku.svg)，选择 **关闭所有** 来退出五子棋。
