...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到五子棋圖標 ![lingmo_gomoku](../common/lingmo_gomoku.svg) ，單擊運行  。
3. 右鍵單擊 ![lingmo_gomoku](../common/lingmo_gomoku.svg)，您可以：
   - 單擊 **發送到桌面**，在桌面創建快捷方式。
...
- 右鍵單擊任務欄上的 ![lingmo_gomoku](../common/lingmo_gomoku.svg)，選擇 **關閉所有** 來退出五子棋。
