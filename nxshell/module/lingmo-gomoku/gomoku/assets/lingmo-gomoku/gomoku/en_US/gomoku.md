...
1. Click ![lingmo_launcher](../common/lingmo_launcher.svg) in the Dock to enter the interface of launcher.
2. Locate ![lingmo_gomoku](../common/lingmo_gomoku.svg) by scrolling the mouse wheel or searching "Gomoku" in the Launcher interface and click it to run. 

3. Right-click![lingmo_gomoku](../common/lingmo_gomoku.svg) to:
...
- Right-click ![lingmo_gomoku](../common/lingmo_gomoku.svg)  in the Dock, select **Close all** to exit.
