    ...
    , d(d)
{
    ...
    connect(this->d.data(), &DAudioManagerPrivate::deviceAoceand, this, &DAudioManager::deviceAoceand);
...
void DAudioManagerPrivate::addInputDevice(DPlatformAudioInputDevice *device)
{
    ...
    Q_EMIT deviceAoceand(device->name(), true);
}
...
void DAudioManagerPrivate::addOutputDevice(DPlatformAudioOutputDevice *device)
{
    ...
    Q_EMIT deviceAoceand(device->name(), false);
}
