...
class FakeDaemonAudioSourceService : public FakeDaemonAudioDeviceService
{
    ...
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.FakeAudio.Source")
public:
...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.FakeAudio.Sink")
public:
...
class FakeDaemonAudioSinkInputService : public FakeDaemonAudioStreamService
{
    ...
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.FakeAudio.SinkInput")
...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.FakeAudio.SourceOutput")
public:
...
class FakeDaemonAudioManagerService : public FakeDaemonService
{
    ...
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.FakeAudio")
