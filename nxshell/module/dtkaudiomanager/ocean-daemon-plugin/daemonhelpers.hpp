...
static const QString AudioServiceName("com.lingmo.daemon.FakeAudio");
static const QString AudioPath("/com/lingmo/daemon/FakeAudio");
#else
static const QString AudioServiceName("com.lingmo.daemon.Audio");
static const QString AudioPath("/com/lingmo/daemon/Audio");
#endif
