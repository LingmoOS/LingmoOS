...
int main(int argc, char *argv[])
{
    ...
    a.loadTranslator();
    a.setApplicationName(QObject::tr("lingmo-screensaver"));
    a.setApplicationDisplayName(QObject::tr("lingmo-screensaver"));
    ...
    if (CommandLineManager::instance()->isSet("window-id")) {
        ...
        screensaver.setProperty("_q_embeoceand_native_parent_handle", QVariant(windowHwnd));
        screensaver.winId();
