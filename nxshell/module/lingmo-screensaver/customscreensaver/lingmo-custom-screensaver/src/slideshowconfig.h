...
static const char *const kLingmoScreenSaver = "lingmo-screensaver";

static const int kMaxIntervalTime = 3600;
static const int kMinIntervalTime = 3;
static const int kDefaultTime = 10;

static constexpr char kCfgAppId[] { "org.lingmo.screensaver" };
static constexpr char kCfgName[] { "org.lingmo.customscreensaver" };
