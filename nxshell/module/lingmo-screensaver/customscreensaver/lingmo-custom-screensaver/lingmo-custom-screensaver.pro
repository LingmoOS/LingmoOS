...
TARGET = lingmo-custom-screensaver
TEMPLATE = app
...
#system($$DTK_SETTINGS -o lingmo-custom-screensaver_translation.cpp $$PWD/data/lingmo-custom-screensaver.json)
#SOURCES += lingmo-custom-screensaver_translation.cpp
...
target.path = /usr/lib/lingmo-screensaver/modules/

translations.path = /usr/share/$${TARGET}/translations
translations.files = translations/*.qm

desktop.path = /etc/lingmo-screensaver/$${TARGET}/
desktop.files = data/$${TARGET}.desktop

icons.path = /usr/lib/lingmo-screensaver/modules/cover/
...
# DConfig
meta_file.files += \
    $$PWD/data/org.lingmo.customscreensaver.json
meta_file.base = $$PWD/data
meta_file.appid = org.lingmo.screensaver
