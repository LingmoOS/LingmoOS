...
screensaver.files = $$PWD/com.lingmo.ScreenSaver.xml
...
screensaver_service.files = $$PWD/com.lingmo.ScreenSaver.service
...
# DConfig
meta_file.files += \
    $$PWD/configs/org.lingmo.screensaver.json
