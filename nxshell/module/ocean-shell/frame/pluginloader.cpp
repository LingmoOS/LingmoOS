...
public:
    ...
    {
        QStringList result;
        // 'OCEAN_SHELL_PACKAGE_PATH' directory.
        const auto dtkPluginPath = qEnvironmentVariable("OCEAN_SHELL_PACKAGE_PATH");
    ...
    QStringList builtinPluginPaths()
    {
        QStringList result;
        // 'OCEAN_SHELL_PACKAGE_PATH' directory.
        const auto dtkPluginPath = qEnvironmentVariable("OCEAN_SHELL_PLUGIN_PATH");
        if (!dtkPluginPath.isEmpty())
            result << dtkPluginPath.split(QDir::listSeparator());
        ...
        result <<  OCEAN_SHELL_PLUGIN_INSTALL_DIR;
