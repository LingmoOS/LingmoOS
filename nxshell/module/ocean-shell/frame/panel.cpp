...
void DPanelPrivate::ensurePopupWindow() const
{
    ...
    auto object = DQmlEngine::createObject(QUrl("qrc:/oceanshell/qml/PanelPopupWindow.qml"));
     if (!object)
         return;
...
void DPanelPrivate::ensureToolTipWindow() const
{
    ...
    auto object = DQmlEngine::createObject(QUrl("qrc:/oceanshell/qml/PanelToolTipWindow.qml"));
    if (!object)
        return;
...
void DPanelPrivate::ensureMenuWindow() const
{
    ...
    auto object = DQmlEngine::createObject(QUrl("qrc:/oceanshell/qml/PanelMenuWindow.qml"));
    if (!object)
        return;
