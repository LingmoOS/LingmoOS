...
Q_LOGGING_CATEGORY(osdKBLog, "ocean.shell.osd.kblayout")

static DDBusSender keyboardInter()
{
    return DDBusSender().service("org.lingmo.ocean.InputDevices1")
        .path("/org/lingmo/ocean/InputDevice1/Keyboard")
        .interface("org.lingmo.ocean.InputDevice1.Keyboard");
}
