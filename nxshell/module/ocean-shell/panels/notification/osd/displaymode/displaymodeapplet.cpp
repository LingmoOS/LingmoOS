...
Q_LOGGING_CATEGORY(osdDPLog, "ocean.shell.osd.display")
...
{
    return DDBusSender().service("org.lingmo.ocean.Display1")
        .path("/org/lingmo/ocean/Display1")
        .interface("org.lingmo.ocean.Display1");
}
...
int DisPlayModeApplet::fetchState() const
{
    ...
    int state = 1;
    QScopedPointer<DConfig> config(DConfig::create("org.lingmo.ocean.control-center", "org.lingmo.ocean.control-center", QString()));
