...
Q_LOGGING_CATEGORY(dockSettingsLog, "ocean.shell.dock.docksettings")
...
DockSettings::DockSettings(QObject* parent)
    : QObject(parent)
    , m_dockConfig(DConfig::create("org.lingmo.ocean.shell", "org.lingmo.ds.dock", QString(), this))
...
void DockSettings::init()
{
    if (m_dockConfig && m_dockConfig->isValid()) {
        ...
        qCCritical(dockSettingsLog()) << "unable to create config for org.lingmo.ocean.dock";
    }
}
