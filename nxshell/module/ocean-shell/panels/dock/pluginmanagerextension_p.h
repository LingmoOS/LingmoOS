...
class PluginSurface : public QWaylandShellSurfaceTemplate<PluginSurface>, public QtWaylandServer::plugin
{
    ...
    Q_PROPERTY(QString oceanuiIcon READ oceanuiIcon CONSTANT)
...
protected:
    ...
    virtual void plugin_oceanui_icon(Resource *resource, const QString &icon) override;
