...
Q_LOGGING_CATEGORY(x11WindowPreview, "ocean.shell.dock.taskmanager.x11WindowPreview")
    ...
    void paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const override
    {
        ...
        if (WM_HELPER->hasComposite() && WM_HELPER->hasBlurWindow()) {
            ...
            auto rect = QRect((option.rect.left()),
                                ...
                                .marginsAoceand(QMargins(-PREVIEW_HOVER_BORDER, -PREVIEW_HOVER_BORDER, -PREVIEW_HOVER_BORDER, -PREVIEW_HOVER_BORDER));
            ...
            if (option.state.testFlag(QStyle::State_MouseOver)) {
                ...
                hoverRect = hoverRect.marginsAoceand(QMargins(-2, -2, -2, -2));
