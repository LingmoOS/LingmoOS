...
private:
    ...
    // surface IDs that should be invisible/hioceann from the tray area.
    QStringList m_hioceannIds;
    ...
    QString findSection(const QString &surfaceId, const QString &fallback, const QStringList &forbioceannSections, int pluginFlags);
