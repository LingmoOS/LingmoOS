...
Item {
    ...
    DropArea {
        id: dropArea
        anchors.fill: parent
        keys: ["text/x-ocean-shell-tray-dnd-surfaceId"]
        onEntered: function (dragEvent) {
            let surfaceId = dragEvent.getDataAsString("text/x-ocean-shell-tray-dnd-surfaceId")
            let source = dragEvent.getDataAsString("text/x-ocean-shell-tray-dnd-source")
        ...
        onPositionChanged: function (dragEvent) {
            ...
            let isStash = dragEvent.getDataAsString("text/x-ocean-shell-tray-dnd-sectionType") === "stashed"
        ...
        onDropped: function (dropEvent) {
            let surfaceId = dropEvent.getDataAsString("text/x-ocean-shell-tray-dnd-surfaceId")
