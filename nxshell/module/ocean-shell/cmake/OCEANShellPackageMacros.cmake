...
function(ds_install_package)
    ...
    install(DIRECTORY ${package_dirs} DESTINATION ${OCEAN_SHELL_PACKAGE_INSTALL_DIR}/${_config_PACKAGE})

    if (DEFINED _config_TARGET)
        install(TARGETS ${_config_TARGET} DESTINATION ${OCEAN_SHELL_PLUGIN_INSTALL_DIR}/)
    endif()
endfunction()
...
function(ds_handle_package_translation)
    ...
    # /usr/share/ocean-shell/org.lingmo.xxx/translations/org.lingmo.xxx.qm
    install(FILES ${TRANSLATED_FILES} DESTINATION ${OCEAN_SHELL_TRANSLATION_INSTALL_DIR}/${_config_PACKAGE}/translations)
endfunction()
