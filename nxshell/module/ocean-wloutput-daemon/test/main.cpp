...
int main(int argc, char *argv[])
{
    ...
    QDBusInterface interface("org.lingmo.ocean.KWayland1", "/org/lingmo/ocean/KWayland1/Output",
                             "org.lingmo.ocean.KWayland1.Output",
    ...
    signal_handler sh;
    QObject::connect(&interface, SIGNAL(OutputAoceand(QString)),
                     &sh, SLOT(onOutputAoceand(QString)));
