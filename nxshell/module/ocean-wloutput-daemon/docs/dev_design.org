...
目前 =startocean= 中使用的是 =kwin= 的 =wayland= 协议实现的，目前存在如下问题：
...
+ [[https://gitlab.lingmo.io/longqi_cm/kvu-display][kvu-display]]
+ [[https://docsin.lingmo.com/?p=2775][在Qt中使用DBus]]
