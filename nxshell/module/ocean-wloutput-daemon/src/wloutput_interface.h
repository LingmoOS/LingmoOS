...
#include <DWayland/Client/oceanseat.h>
...
const QString SERVER = "org.lingmo.ocean.KWayland1";
const QString PATH = "/org/lingmo/ocean/KWayland1/Output";
const QString INTERFACE = "org.lingmo.ocean.KWayland1.Output";
...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.lingmo.ocean.KWayland1.Output")
...
signals:
    void OutputAoceand(QString output);
...
private:
    ...
    Idle *m_idle{nullptr};
    Seat *m_seat{nullptr};
    OCEANSeat *m_oceanSeat = nullptr;
    OCEANPointer *m_oceanPointer = nullptr;
    OCEANTouch *m_oceanTouch = nullptr;
