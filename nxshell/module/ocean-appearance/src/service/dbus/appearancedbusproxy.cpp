...
const QString DaemonService = QStringLiteral("org.lingmo.ocean.Daemon1");
const QString DaemonPath = QStringLiteral("/org/lingmo/ocean/Daemon1");
const QString DaemonInterface = QStringLiteral("org.lingmo.ocean.Daemon1");

AppearanceDBusProxy::AppearanceDBusProxy(QObject *parent)
    : QObject(parent)
    , m_displayInterface(new DDBusInterface("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", "org.lingmo.ocean.Display1", QDBusConnection::sessionBus(), this))
    , m_xSettingsInterface(new DDBusInterface("org.lingmo.ocean.XSettings1", "/org/lingmo/ocean/XSettings1", "org.lingmo.ocean.XSettings1", QDBusConnection::sessionBus(), this))
    ...
    , m_nid(0)
{
    ...
    if (sessionType == "wayland") {
        ...
        m_wmInterface = new DDBusInterface("com.lingmo.wm", "/com/lingmo/wm", "com.lingmo.wm", QDBusConnection::sessionBus(), this);
    }
    ...
    QDBusConnection::sessionBus().connect(QStringLiteral("org.lingmo.ocean.Timedate1"), QStringLiteral("/org/lingmo/ocean/Timedate1"), QStringLiteral("org.lingmo.ocean.Timedate1"), "TimeUpdate", this, SIGNAL(TimeUpdate()));
}

void AppearanceDBusProxy::setUserInterface(const QString &userPath)
{
    m_userInterface = QSharedPointer<DDBusInterface>(new DDBusInterface("org.lingmo.ocean.Accounts1",
                                                                            userPath,
...
void AppearanceDBusProxy::SetDecorationLingmoTheme(const QString &lingmoThemeName)
{
    if (m_wmInterface == nullptr) {
        return;
    }
    m_wmInterface->asyncCall(QStringLiteral("SetDecorationLingmoTheme"), lingmoThemeName);
}
...
{
    QDBusMessage accountsMessage = QDBusMessage::createMethodCall("org.lingmo.ocean.Accounts1", "/org/lingmo/ocean/Accounts1", "org.lingmo.ocean.Accounts1", "FindUserById");
    accountsMessage << uid;
...
{
    QDBusMessage imageBlurMessage = QDBusMessage::createMethodCall("org.lingmo.ocean.ImageBlur1", "/org/lingmo/ocean/ImageBlur1", "org.lingmo.ocean.ImageBlur1", "Delete");
...
{
    QDBusMessage imageBlurMessage = QDBusMessage::createMethodCall("org.lingmo.ocean.ImageBlur1", "/org/lingmo/ocean/ImageBlur1", "org.lingmo.ocean.ImageBlur1", "Get");
    imageBlurMessage << file;
...
{
    QDBusMessage imageEffectMessage = QDBusMessage::createMethodCall("org.lingmo.ocean.ImageEffect1", "/org/lingmo/ocean/ImageEffect1", "org.lingmo.ocean.ImageEffect1", "Delete");
...
{
    QDBusMessage imageEffectMessage = QDBusMessage::createMethodCall("org.lingmo.ocean.ImageEffect1", "/org/lingmo/ocean/ImageEffect1", "org.lingmo.ocean.ImageEffect1", "Get");
    imageEffectMessage << effect << filename;
    QDBusConnection::systemBus().asyncCall(imageEffectMessage);
