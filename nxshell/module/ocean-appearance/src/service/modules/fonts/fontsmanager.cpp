...
FontsManager::FontsManager()
    ...
    ,filePath(utils::GetUserConfigDir()+"/fontconfig"+"/conf.d"+"/99-lingmo.conf")
...
{
    fileName = utils::GetUserHomeDir()+"/.cache/lingmo/ocean-daemon/fonts/family_table";
    if(!isFcCacheUpdate())
    { 
...
bool FontsManager::checkFontConfVersion()
{
    ...
    homeDir += homeDir+ "/.config/fontconfig/conf.d/lingmo_conf.version";
