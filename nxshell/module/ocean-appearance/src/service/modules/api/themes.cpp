...
QVector<QString> ThemesApi::listGlobalTheme()
{
    ...
    QDir home = QDir::home();
    local.push_back(QString("%1/ocean-appearance/lingmo-themes/").arg(QStandardPaths::writableLocation(QStandardPaths::ConfigLocation)));
...
{
    if (!scanner->isGlobalTheme(getThemePath(name, TYPEGLOBALTHEME, "lingmo-theme"))) {
...
static const char *findAlternative(const char *name)
{
    ...
    static const char *xcursor_alter[] = {
        ...
        "forbioceann", "03b6e0fcb3499374a867c041f52298f0",
