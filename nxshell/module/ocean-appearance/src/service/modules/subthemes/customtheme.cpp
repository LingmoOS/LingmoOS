...
const QString CUSTOMTHEMEPATH =
        QString("%1/ocean-appearance/lingmo-themes/custom").arg(QStandardPaths::writableLocation(QStandardPaths::ConfigLocation));
...
void CustomTheme::openCustomTheme()
{
    ...
    m_customTheme->removeSection("Lingmo Theme");
    m_customTheme->setKey("Lingmo Theme", "Name", "Custom");
    m_customTheme->setKey("Lingmo Theme", "DefaultTheme", "DefaultTheme");
    m_customTheme->setKey("Lingmo Theme", "DarkTheme", "DarkTheme");
    m_customTheme->setKey("Lingmo Theme", "Example", "/usr/share/ocean-appearance/custom.svg");
}
