...
#ifndef LINGMOWMFAKER_H
#define LINGMOWMFAKER_H
...
class LingmoWMFaker : public QObject, protected QDBusContext
{
    Q_OBJECT
...
public:
    explicit LingmoWMFaker(QObject *parent = nullptr);
    ~LingmoWMFaker();
    ...
    // OCEAN currently only support the four corners
    enum ElectricBorder {
        ElectricTop,
        ElectricTopRight,
        ElectricRight,
...
public Q_SLOTS:
    ...
    void SetDecorationLingmoTheme(const QString &name);
...
private:
    ...
    bool isX11Platform();
#ifndef DISABLE_LINGMO_WM
    void onGsettingsOCEANAppearanceChanged(const QString &key);
    void onGsettingsOCEANZoneChanged(const QString &key);
#endif
...
private:
    ...
    KConfig *m_lingmoWMConfig;
    KConfigGroup *m_lingmoWMGeneralGroup;
    KConfigGroup *m_lingmoWMWorkspaceBackgroundGroup;
...
#ifndef DISABLE_LINGMO_WM
    QString m_lingmoWMBackgroundUri;
