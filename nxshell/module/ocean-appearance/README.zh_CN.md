## ocean-appearance
ocean-appearance 是一个用来设置lingmo桌面主题和外观的程序。
...
## 用法
直接运行`/usr/bin/ocean-appearance`, 它将提供`org.lingmo.ocean.Appearance1`服务。
...
ocean-appearance 在 [GPL-3.0-or-later](LICENSE)下发布。
