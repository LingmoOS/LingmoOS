...
1. Click the Launcher icon ![launcher](../common/lingmo_launcher.svg) in the Dock and enter the Launcher interface.
2. Locate Album ![lingmo_album](../common/lingmo_album.svg) by scrolling the mouse wheel or searching "album" in the Launcher interface and click it to run.
3. Right-click ![lingmo_album](../common/lingmo_album.svg) and you can:
 - Click **Send to desktop** to create a desktop shortcut.
 - Click **Send to dock** to fix the application in the Dock.
 - Click **Add to startup** to add the application to startup and it will automatically run when the system starts up.

> ![tips](../common/tips.svg) Tips: In Control Center, you can set Album as the default photo viewing application. Please refer to [Default Applications](dman:///ocean#Default Applications) for specific operations.

### Exit Album

- On the Album interface, click![close_icon](../common/close_icon.svg)to exit Album.
- Right-click ![lingmo_album](../common/lingmo_album.svg) in the Dock and select **Close All** to exit Album.
...
1. On the Album interface, right-click a photo or video.
2. Select **Favorite** and the photo or video will be aoceand to the **Favorites** album.
...
3. Fill in your password and submit your feedback in the forum of lingmo.
