...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到相册图标 ![lingmo_album](../common/lingmo_album.svg) ，单击运行。
3. 右键单击 ![lingmo_album](../common/lingmo_album.svg)，您可以：
 - 单击 **发送到桌面**，在桌面创建快捷方式。
 - 单击 **发送到任务栏**，将应用程序固定到任务栏。
 - 单击 **开机自动启动**，将应用程序添加到开机启动项，在电脑开机时自动运行该应用。

   > ![tips](../common/tips.svg) 窍门：您可以在控制中心将相册设置为默认的照片查看程序，具体操作请参考 [默认程序设置](dman:///ocean#默认程序设置)。

### 关闭相册

- 在相册界面，单击 ![close_icon](../common/close_icon.svg)，退出相册。
- 在任务栏右键单击 ![lingmo_album](../common/lingmo_album.svg)，选择 **关闭所有** ，退出相册。
