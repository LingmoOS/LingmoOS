...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到相冊圖標 ![lingmo_album](../common/lingmo_album.svg) ，單擊運行。
3. 右鍵單擊 ![lingmo_album](../common/lingmo_album.svg)，您可以：
 - 單擊 **發送到桌面**，在桌面創建快捷方式。
 - 單擊 **發送到任務欄**，將應用程序固定到任務欄。
 - 單擊 **開機自動啟動**，將應用程序添加到開機啟動項，在電腦開機時自動運行該應用。

   > ![tips](../common/tips.svg)竅門：您可以在控制中心將相冊設置為默認的照片查看程序，具體操作請參考 [默認程序設置](dman:///ocean#默認程序設置)。

### 關閉相冊

- 在相冊界面，單擊 ![close_icon](../common/close_icon.svg)，退出相冊。
- 在任務欄右鍵單擊 ![lingmo_album](../common/lingmo_album.svg)，選擇 **關閉所有** ，退出相冊。
