...
{
public:
    explicit AccessibleKeyLabelWidget(oceanui_fcitx_configtool::widgets::FcitxKeyLabelWidget *keylablewidget);
    ~AccessibleKeyLabelWidget();

    QString text(int startOffset, int endOffset) const Q_DECL_OVERRIDE;

private:
    oceanui_fcitx_configtool::widgets::FcitxKeyLabelWidget *m_keylablewidget;
};
...
{
public:
    explicit AccessibleKeySettingsItem(oceanui_fcitx_configtool::widgets::FcitxKeySettingsItem *keysettingsitem);
    ~AccessibleKeySettingsItem();

    QString text(int startOffset, int endOffset) const Q_DECL_OVERRIDE;

private:
    oceanui_fcitx_configtool::widgets::FcitxKeySettingsItem *m_keysettingsitem;
};
...
{
public:
    explicit AccessibleComBoboxSettingsItem(oceanui_fcitx_configtool::widgets::FcitxComBoboxSettingsItem *comboboxsettingsitem);
    ~AccessibleComBoboxSettingsItem();

    QString text(int startOffset, int endOffset) const Q_DECL_OVERRIDE;

private:
    oceanui_fcitx_configtool::widgets::FcitxComBoboxSettingsItem *m_comboboxsettingsitem;
};
