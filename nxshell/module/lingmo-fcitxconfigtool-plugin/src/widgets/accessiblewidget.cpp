...
AccessibleKeyLabelWidget::AccessibleKeyLabelWidget(oceanui_fcitx_configtool::widgets::FcitxKeyLabelWidget *keylablewidget)
...
AccessibleComBoboxSettingsItem::AccessibleComBoboxSettingsItem(oceanui_fcitx_configtool::widgets::FcitxComBoboxSettingsItem *comboboxsettingsitem)
...
AccessibleKeySettingsItem::AccessibleKeySettingsItem(oceanui_fcitx_configtool::widgets::FcitxKeySettingsItem *keysettingsitem)
