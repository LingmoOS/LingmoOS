...
#include <QProcess>
#include <com_lingmo_daemon_inputdevice_keyboard.h>
...
{
    if (!oceanui_fcitx_configtool::IsCommunitySystem) return;
    QString fcitxUniqueName = "fcitx-keyboard-";
    QString uniqueName = item.uniqueName();
    __Keyboard keyboard("com.lingmo.daemon.InputDevices",
            "/com/lingmo/daemon/InputDevice/Keyboard",
