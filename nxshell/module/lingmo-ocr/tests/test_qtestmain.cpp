...
#define QMYTEST_MAIN(TestObject) \
    ...
    { \
        ...
        dAppNew->setOrganizationName("lingmo"); \
        dAppNew->setApplicationName("lingmo-ocr"); \
...
{
    testing::GTEST_FLAG(output) = "xml:./report/report_lingmo-ocr.xml";
    int argc = 1;
    ...
    // 内存分析屏蔽mips
#ifndef SYSTEM_MIPS
    __sanitizer_set_report_path("asan_lingmo-ocr.log");
#endif
}
