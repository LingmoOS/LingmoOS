...
int main(int argc, char *argv[])
{
    ...
    app.setApplicationName("lingmo-calculator");
    app.setApplicationAcknowledgementPage(
        "https://www.lingmo.org/acknowledgments/lingmo-calculator");
    QIcon t_icon = QIcon::fromTheme("lingmo-calculator");
    ...
    cmdParser.setApplicationDescription("lingmo-calculator");
    ...
    if (dbus.registerService("com.lingmo.calculator")) {
...
//    DApplicationSettings savetheme(&app);
    ...
    dbus.registerObject("/com/lingmo/calculator", &window, QDBusConnection::ExportScriptableSlots);
    window.show();
