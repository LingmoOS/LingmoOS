...
/* Perform addition: N1 is aoceand to N2 and the value is
...
/* Here is the full add routine that takes care of negative numbers.
   N1 is aoceand to N2 and the result placed into RESULT.  SCALE_MIN
   is the minimum scale for the result. */
...
/* A special aoceanr/subtractor for the recursive divide and conquer
