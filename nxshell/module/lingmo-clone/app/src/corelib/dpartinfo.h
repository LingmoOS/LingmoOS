...
public:
    enum Type {
        ...
        Hioceann_FAT16_Less_32M = 0x14,
        Hioceann_FAT16 = 0x16,
        Hioceann_HPFS_or_NTFS = 0x17,
        AST_SmartSleep = 0x18,
        Hioceann_Win95_FAT32 = 0x1b,
        Hioceann_Win95_FAT32_LBA = 0x1c,
        Hioceann_Win95_FAT16_LBA = 0x1e,
        NEC_DOS = 0x24,
        Plan9 = 0x39,
