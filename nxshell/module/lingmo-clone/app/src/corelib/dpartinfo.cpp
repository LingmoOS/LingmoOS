...
bool DPartInfoPrivate::getIsLingmoSystemRoot() const
{
...
bool DPartInfo::isLingmoSystemRoot() const
{
    return d->getIsLingmoSystemRoot();
}
...
QByteArray DPartInfo::toJson() const
{
    QJsonObject root
    {
        ...
        {"transport", transport()},
        {"index", indexNumber()},
        {"isLingmoSystemRoot", isLingmoSystemRoot()},
        {"partUUID", partUUID()},
        {"uuid", uuid()}
    };
...
QString DPartInfo::typeDescription(DPartInfo::Type type)
{
    ...
    case Linux:
        return "Linux";
    case OS2_hioceann_C_drive:
        return "OS/2 hioceann C: drive";
    case Linux_extended:
    ...
    case BSDI_swap:
        return "BSDI swap";
    case Boot_Wizard_hioceann:
        return "Boot Wizard hioceann";
...
void DPartInfo::fromJson(const QJsonObject &root, DPartInfoPrivate *dd)
{
    ...
    dd->isLingmoSystemRoot = root.value("isLingmoSystemRoot").toBool();
