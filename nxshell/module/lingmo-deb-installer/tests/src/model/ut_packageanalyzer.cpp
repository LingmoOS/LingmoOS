...
TEST_F(ut_packageanalyzer_TEST, PackageAnalyzer_UT_packageInstallStatus)
{
    DebIr ir;
    ir.isValid = true;
    ir.packageName = "lingmo-hd;o3h8dhoewl";
...
{
    auto package = PackageAnalyzer::instance().packageWithArch("libc6", "lingmo-hd;o3h8dhoewl", "");
    ASSERT_NE(package, nullptr);
}

TEST_F(ut_packageanalyzer_TEST, PackageAnalyzer_UT_virtualPackageIsExist)
{
    auto result = PackageAnalyzer::instance().virtualPackageIsExist("lingmo-hd;o3h8dhoewl");
