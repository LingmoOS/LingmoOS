...
static QByteArray kUabJsonDataExample { "{"
                                        ...
                                        "                    \"x86_64\""
                                        "                ],"
                                        "                \"base\": \"main:org.lingmo.foundation/23.0.0/x86_64\","
                                        "                \"channel\": \"main\","
                                        "                \"command\": ["
                                        "                    \"ocean-calendar\""
                                        "                ],"
                                        "                \"description\": \"calendar for lingmo os.\n\","
                                        "                \"id\": \"org.ocean.calendar\","
                                        "                \"kind\": \"app\","
                                        "                \"module\": \"binary\","
                                        "                \"name\": \"ocean-calendar\","
                                        "                \"runtime\": \"main:org.lingmo.Runtime/23.0.1/x86_64\","
                                        "                \"schema_version\": \"1.0\","
                                        "                \"size\": 51503113,"
                                        "                \"version\": \"5.1.2.1\""
                                        "            },"
...
{
    pkgList.append(createPtr("org.lingmo.pkg1", "2.0.0"));
    pkgList.append(createPtr("com.lingmo.pkg1", "1.0.2"));
    pkgList.append(createPtr("com.lingmo.pkg1", "1.0.0"));
    pkgList.append(createPtr("com.lingmo.pkg1", "1.0.1"));
    pkgList.append(createPtr("com.lingmo.pkg2", "1.0.0"));
}
...
TEST_F(utDebBackend, sortPackagesNormalSuccess)
{
    ...
    EXPECT_EQ(QString("com.lingmo.pkg1"), pkgList.first()->id);
    EXPECT_EQ(QString("1.0.2"), pkgList.first()->version);
    EXPECT_EQ(QString("com.lingmo.pkg2"), pkgList.at(3)->id);
    EXPECT_EQ(QString("org.lingmo.pkg1"), pkgList.last()->id);
}
...
TEST_F(utDebBackend, findPackageContainFind)
{
    ...
    auto findPtr = insPtr->findPackage("com.lingmo.pkg1");
    ASSERT_FALSE(findPtr.isNull());
    EXPECT_EQ(findPtr->id, QString("com.lingmo.pkg1"));
    EXPECT_EQ(findPtr->version, QString("1.0.2"));

    findPtr = insPtr->findPackage("com.lingmo.pkg2");
    ASSERT_FALSE(findPtr.isNull());
    EXPECT_EQ(findPtr->id, QString("com.lingmo.pkg2"));
    EXPECT_EQ(findPtr->version, QString("1.0.0"));

    findPtr = insPtr->findPackage("org.lingmo.pkg1");
    ASSERT_FALSE(findPtr.isNull());
    EXPECT_EQ(findPtr->id, QString("org.lingmo.pkg1"));
...
TEST_F(utDebBackend, packageFromMetaJsonNormalSuccess)
{
    ...
    EXPECT_EQ(uabPtr->id, QString("org.ocean.calendar"));
    EXPECT_EQ(uabPtr->appName, QString("ocean-calendar"));
