...
#ifndef LINGMODEBINSTALLERLIB_H
#define LINGMODEBINSTALLERLIB_H

#include "lingmo-deb-installer-lib_global.h"

#include <QtCore>
#include <QObject>

class PackagesManager;
class LINGMODEBINSTALLERLIBSHARED_EXPORT LingmoDebInstallerLib : public QObject
{
    Q_OBJECT
public:
    LingmoDebInstallerLib();

    virtual ~LingmoDebInstallerLib();
