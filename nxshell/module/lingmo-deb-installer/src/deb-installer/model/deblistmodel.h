...
public slots:
     ...
     * @param str  命令返回的安装信息
     * 如果命令返回的信息是Cannot run program lingmo-deb-installer-dependsInstall: No such file or directory
     * 意味着当前/usr/bin下没有lingmo-deb-installer-dependsInstall命令，此版本有问题，需要重新安装lingmo-deb-installer-dependsInstall命令
     */
