...
const QString kDebInstallManagerService = "com.lingmo.DebInstaller";
const QString kDebInstallManagerIface = "/com/lingmo/DebInstaller";
...
bool SingleInstallerApplication::parseCmdLine()
{
    ...
    parser.setApplicationDescription("Lingmo Package Installer.");
