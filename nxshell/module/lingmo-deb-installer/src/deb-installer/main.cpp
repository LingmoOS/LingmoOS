...
int main(int argc, char *argv[])
{
    ...
    app.setApplicationName("lingmo-deb-installer");
    app.setApplicationVersion(VERSION);  // qmake 转cmake 解决版本不对的问题
    app.setApplicationAcknowledgementPage("https://www.lingmo.org/acknowledgments/lingmo-package-manager/");
    app.setProductIcon(QIcon::fromTheme("lingmo-deb-installer"));
