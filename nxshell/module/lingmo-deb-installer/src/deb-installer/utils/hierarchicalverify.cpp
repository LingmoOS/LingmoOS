...
// 分级管控DBus接口信息
const char DBUS_HIERARCHICAL_BUS[] = "com.lingmo.daemon.ACL";
const char DBUS_HIERARCHICAL_PATH[] = "/org/lingmo/security/hierarchical/Control";
...
// 分级管控安全中心界面跳转接口
const char DBUS_DEFENDER_BUS[] = "com.lingmo.defender.hmiscreen";
const char DBUS_DEFENDER_PATH[] = "/com/lingmo/defender/hmiscreen";
...
// 匹配正则,%1为错误码
const char VERIFY_ERROR_REGEXP[] = "(lingmo)+[^\\n]*(hook)+[^\\n]*(%1|%2)\\b";
