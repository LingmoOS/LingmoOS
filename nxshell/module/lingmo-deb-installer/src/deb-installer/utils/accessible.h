...
QAccessibleInterface *accessibleFactory(const QString &classname, QObject *object)
{
    ...
    // 应用主窗口
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), AptConfigMessage);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ChooseFileButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DebInfoLabel);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DebInstaller);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DRoundBgFrame);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), FileChooseWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), InfoCommandLinkButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), InfoControlButton);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), InstallProcessInfoView);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), MultipleInstallPage);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), SingleInstallPage);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), UninstallConfirmPage);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), WorkerProgress);
    ...
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), QMenu);
