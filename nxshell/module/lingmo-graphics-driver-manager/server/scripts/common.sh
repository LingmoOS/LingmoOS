...
export WORKING_DIR_G=/usr/lib/lingmo-graphics-driver-manager/working-dir
...
export PRIME_GLTEST_G=${WORKING_DIR_G}/lingmo-prime-gltest
export REAL_INSTALLE_DESKTOP=/etc/xdg/autostart/lingmo-gradvrmgr-installer.desktop

export INSTALLER_DESKTOP_FILE_SOURCE=/usr/lib/lingmo-graphics-driver-manager/lingmo-gradvrmgr-installer.desktop
export INSTALLER_DESKTOP_FILE_DEST=/etc/xdg/autostart/lingmo-gradvrmgr-installer.desktop
export TEST_INSTALLER_DESKTOP_FILE_SOURCE=/usr/lib/lingmo-graphics-driver-manager/lingmo-gradvrmgr-test-installer.desktop
export TEST_INSTALLER_DESKTOP_FILE_DEST=/etc/xdg/autostart/lingmo-gradvrmgr-test-installer.desktop

export is10GENERATIONS_CPU=false

export OVERLAY_LOWDIR=/media/root-ro/

export GLTEST_FLAG=/usr/lib/lingmo-graphics-driver-manager/working-dir/dgradvrmgr_gltest_flag
