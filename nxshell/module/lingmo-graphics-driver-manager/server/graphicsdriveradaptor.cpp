...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.CancelInstall
    QMetaObject::invokeMethod(parent(), "CancelInstall");
}

QString GraphicsDriverAdaptor::GetCurrDriverName()
{
    // handle method call com.lingmo.daemon.GraphicsDriver.GetCurrDriverName
    QString out0;
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.GetDevice
    QString out0;
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.GetNewDriverName
    QString out0;
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.GetOldDriverName
    QString out0;
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.GetResolutionTitle
    QString out0;
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.IsTestSuccess
    bool out0;
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.PrepareInstall
...
{
    // handle method call com.lingmo.daemon.GraphicsDriver.RealInstall
    QMetaObject::invokeMethod(parent(), "RealInstall");
}

void GraphicsDriverAdaptor::TestInstall()
{
    // handle method call com.lingmo.daemon.GraphicsDriver.TestInstall
    QMetaObject::invokeMethod(parent(), "TestInstall");
}

void GraphicsDriverAdaptor::TestSuccess()
{
    // handle method call com.lingmo.daemon.GraphicsDriver.TestSuccess
