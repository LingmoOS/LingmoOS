...
/*
 * Adaptor class for interface com.lingmo.daemon.GraphicsDriver
 */
class GraphicsDriverAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.GraphicsDriver")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"com.lingmo.daemon.GraphicsDriver\">\n"
