...
#define INSTALLER_DESKTOP_FILE_SOURCE "/usr/lib/lingmo-graphics-driver-manager/lingmo-gradvrmgr-installer.desktop"
#define INSTALLER_DESKTOP_FILE_DEST "/etc/xdg/autostart/lingmo-gradvrmgr-installer.desktop"

#define TEST_INSTALLER_DESKTOP_FILE_SOURCE "/usr/lib/lingmo-graphics-driver-manager/lingmo-gradvrmgr-test-installer.desktop"
#define TEST_INSTALLER_DESKTOP_FILE_DEST "/etc/xdg/autostart/lingmo-gradvrmgr-test-installer.desktop"
...
void GraphicsDriverInterface::PrepareInstall(QString name, QString language)
{
    ...
    connect(this, &GraphicsDriverInterface::Cancel, proc, [=]{
        ...
        QFile overlay_flag("/usr/lib/lingmo-graphics-driver-manager/working-dir/test_in_overlay_flag");
...
void GraphicsDriverInterface::TestSuccess()
{
    ...
    QPROCESS_DELETE_SELF(proc);
    proc->setProcessChannelMode(QProcess::MergedChannels);
    proc->execute("/usr/lib/lingmo-graphics-driver-manager/gltest-set-success.sh");
}
