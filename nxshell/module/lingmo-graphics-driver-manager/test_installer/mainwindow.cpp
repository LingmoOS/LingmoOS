...
MainWindow::MainWindow(QWidget *parent)
    ...
    m_rebootDelay(3)
{
    m_graphicsDriver = new ComLingmoDaemonGraphicsDriverInterface(
    ...
    titlebar()->setTitle(" ");
    titlebar()->setIcon(QIcon(":/resources/icons/lingmo-graphics-driver-manager-64px.svg"));
...
void MainWindow::onInstall()
{
    ...
    m_process = 0;
    updateProgress();
    connect(m_graphicsDriver, &ComLingmoDaemonGraphicsDriverInterface::ReportProgress, [=](QString ratio){
