...
public:
    explicit ResolutionWidget(ComLingmoDaemonGraphicsDriverInterface *graphicsDriver, const Resolution &resolution,  QWidget *parent = nullptr);
...
protected:
    ComLingmoDaemonGraphicsDriverInterface *m_graphicsDriver;
