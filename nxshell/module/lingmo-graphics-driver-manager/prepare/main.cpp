...
int main(int argc, char* argv[])
{
    ...
    QString loc_tr_file = QString(TRANSLATIONS_DIR"/lingmo-graphics-driver-manager_%1.qm");
    ...
    QStringList args{"-c", "ps aux | grep /usr/lib/lingmo-graphics-driver-manager |grep -v grep"};
    ...
    app.setApplicationName("lingmo-graphics-driver-manager");
    app.setApplicationVersion(VERSION);
    app.setApplicationAcknowledgementPage("https://www.lingmo.org/acknowledgments/lingmo-graphics-driver-manager/");
    app.setProductIcon(QIcon(":/resources/icons/lingmo-graphics-driver-manager-64px.svg"));
    ...
    QString log_file(QString("/home/%1/.cache/lingmo/lingmo-graphics-driver-manager/").arg(getUserName()));
    QDir dir(log_file);
    if (!dir.exists()) {
        dir.mkpath(log_file);
    }
    log_file += "lingmo-graphics-driver-manager.log";
