...
desktop.files += $$PWD/ocean-introduction.desktop

target.path = $$PREFIX/bin/

TRANSLATIONS = translations/ocean-introduction.ts
...
qm_files.path = $$PREFIX/share/ocean-introduction/translations/
qm_files.files = translations/*.qm

icon.path = $$PREFIX/share/icons/hicolor/scalable/apps
icon.files = resources/ocean-introduction.svg
...
videos.path = $$PREFIX/share/ocean-introduction/
