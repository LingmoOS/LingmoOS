...
void Worker::setDesktopMode(Model::DesktopMode mode)
{
    ...
    switch (mode) {
        case Model::EfficientMode:
            args << "--print-reply"
                 << "--dest=com.lingmo.ocean.daemon.Launcher"
                 << "/com/lingmo/ocean/daemon/Launcher"
                 << "org.freedesktop.DBus.Properties.Set"
//                 << "string:com.lingmo.ocean.daemon.Launcher"
//                 << "string:Fullscreen"
...
void Worker::setWMMode(Model::WMType type)
{
    if (m_model->wmType() != type){
        ...
        QDBusInterface Interface("com.lingmo.wm",
                                 "/com/lingmo/wm",
                                 "org.freedesktop.DBus.Properties",
                                 QDBusConnection::sessionBus());
        QDBusMessage reply = Interface.call("Set","com.lingmo.wm","compositingEnabled",
...
{
    m_model->setWmType(wm == "lingmo wm" ? Model::WM_3D : Model::WM_2D);
}
...
void Worker::onWMChang(/*const quint32 &wm*/)
{
    ...
    //m_model->setWmType(m_windowManage->windowManagerName() == DWindowManagerHelper::WMName::LingmoWM
    //                       ? Model::WM_3D
    //                       : Model::WM_2D);
}
...
Worker::Worker(QObject *parent)
    ...
    , m_iconInter(new Icon("com.lingmo.daemon.Appearance", "/com/lingmo/daemon/Appearance",
                           QDBusConnection::sessionBus(), this))
    , m_wmInter(new WMSwitcher("com.lingmo.WMSwitcher", "/com/lingmo/WMSwitcher",
                               QDBusConnection::sessionBus(), this))
    , m_dockInter(new Dock("com.lingmo.ocean.daemon.Dock", "/com/lingmo/ocean/daemon/Dock",
                           QDBusConnection::sessionBus(), this))
{
