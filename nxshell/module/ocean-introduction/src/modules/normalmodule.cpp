...
NormalModule::NormalModule(DWidget *parent)
    ...
    , m_wmSwitcher(new WMSwitcher("com.lingmo.WMSwitcher", "/com/lingmo/WMSwitcher",
    ...
    , m_index(-1)//这个值初始化
{
    ...
    //    QPixmap pixmap = std::move(QIcon::fromTheme("ocean-introduction",
    QIcon(":/resources/ocean-introduction.svg")).pixmap(QSize(24, 24) * devicePixelRatioF())); QPixmap
    pixmap = QIcon::fromTheme("ocean-introduction").pixmap(QSize(24, 24) * devicePixelRatioF());
