...
//   s int type = DGuiApplicationHelper::instance()->paletteType();
    ...
    /*m_text = QString("<p style=\"font-family: SourceHanSansSC-Medium;font-size: 16px;color: #000000;line-height: 18px;\">%1</p>"
                                  "<div style=\"font-family: SourceHanSansSC-Medium;font-size: 12px;color: #303030;line-height: 18px;\">%2<a href=http://www.lingmo.org/donate>%3</a>%4</div>"
                                  "<p style=\"font-family: SourceHanSansSC-Medium;font-size: 16px;color: #000000;line-height: 18px;\">%5</p>"
                                  "<div style=\"font-family: SourceHanSansSC-Medium;font-size: 12px;color: #303030;line-height: 18px;\">%6<a href=http://www.lingmo.org/donate>%7</a></div>"
                                  "<p style=\"font-family: SourceHanSansSC-Medium;font-size: 16px;color: #000000;line-height: 18px;\">%8</p>"
                                  "<div style=\"font-family: SourceHanSansSC-Medium;font-size: 12px;color: #303030;line-height: 18px;\">%9<a href=http://www.lingmo.org>%10</a></div>")
                          .arg(tr("■Localization"))
...
//{
    ...
    if (type == 2) {
        m_text = QString("<p><span style=\"font-family: SourceHanSansSC-Medium;font-size: 10px;color: #FFFFFF;line-height: 18px;\">%11</span>"
                         ...
                         "<div style=\"font-family: SourceHanSansSC-Medium;font-size: 12px;color: #D9D9D9;line-height: 18px;\">%2<a href=http://www.lingmo.org/donate>%3</a>%4</div>"
                         ...
                         "<div style=\"font-family: SourceHanSansSC-Medium;font-size: 12px;color: #D9D9D9;line-height: 18px;\">%6<a href=http://www.lingmo.org/donate>%7</a></div>"
                         "<p><span style=\"font-family: SourceHanSansSC-Medium;font-size: 10px;color: #FFFFFF;line-height: 18px;\">%11</span>"
                         "<span=\"font-family: SourceHanSansSC-Medium;font-size: 16px;color: #FFFFFF;line-height: 18px;\">%8</span></p>"
                         "<div style=\"font-family: SourceHanSansSC-Medium;font-size: 12px;color: #D9D9D9;line-height: 18px;\">%9<a href=http://www.lingmo.org>%10</a></div>")
                 .arg(tr("Localization"))
                 .arg(tr("Deep OS supports 30 languages, but we want to do better! If you want to use your own national language perfectly in Deep Operating System, please join our "))
                 .arg(tr("transfixer"))
                 .arg(tr(" community to help us!"))
