    ...
    : DWidget(parent)
{
    ...
    m_buttons[twitterBtn] = "https://twitter.com/linux_lingmo";
    m_buttons[facebook] = "https://www.facebook.com/lingmolinux/";

    /*#ifndef PROFESSIONAL
        m_buttons[offical] = "https://www.lingmo.org/";
    #else
        m_buttons[offical] = "https://www.lingmo.com/";
    #endif*/
    m_buttons[community] = "https://bbs.lingmo.org/";
    m_buttons[feedback] = "http://feedback.lingmo.org/";
    m_buttons[thank] = "https://www.lingmo.org/acknowledgments/lingmo/";
    m_buttons[mail] = "mailto:support@lingmo.com";
