...
int main(int argc, char *argv[])
{
    ...
    a->setApplicationName("ocean-introduction");
    ...
    /* 必须在setOrganizationName("lingmo")之后设置才生效 */
    Dtk::Core::DLogManager::registerConsoleAppender();
    Dtk::Core::DLogManager::registerFileAppender();

    QDBusConnection dbus = QDBusConnection::sessionBus();
    dbus.registerService("com.lingmo.introduction");

    QCommandLineParser cmdParser;
    cmdParser.setApplicationDescription("ocean-introduction");
    ...
    dbus.registerObject("/com/lingmo/introduction", &w, QDBusConnection::ExportScriptableSlots);
