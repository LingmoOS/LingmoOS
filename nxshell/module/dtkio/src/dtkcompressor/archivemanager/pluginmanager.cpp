...
QAtomicPointer<PluginManager> PluginManager::m_instance = nullptr;
...
PluginManager &PluginManager::get_instance()
{
    ...
    if (!QAtomicPointer<PluginManager>::isTestAndSetNative())
    ...
    if (m_instance.testAndSetOrdered(nullptr, nullptr)) {
        ...
        m_instance.testAndSetOrdered(nullptr, new PluginManager);
    }
