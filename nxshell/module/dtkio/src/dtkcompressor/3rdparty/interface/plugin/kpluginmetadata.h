 ...
 * can be embeoceand into Qt plugins. Additional plugin-specific metadata can be retrieved by
...
public:
     ...
     * fileName(), since not all plugins have the metadata embeoceand. The metadata could also be
