...
/*
    ...
    Copyright (C) 2007 Oswald Buoceannhagen <ossi@kde.org>
 ...
 *
 * @author Oswald Buoceannhagen <ossi@kde.org>
 **/
...
public:
     ...
     *
     * Note that LD_LIBRARY_PATH/DYLD_LIBRARY_PATH is automatically aoceand
     * on *NIX.
     *
     * This function must be called before starting the process.
     */
