...
void DBlockDevicePrivate::onInterfacesAoceand(const QDBusObjectPath &objectPath, const QMap<QString, QVariantMap> &interfacesAndProperties)
{
    Q_Q(DBlockDevice);
...
void DBlockDevice::setWatchChanges(bool watchChanges)
{
    ...
    if (watchChanges) {
        connect(objectManager, &OrgFreedesktopDBusObjectManagerInterface::InterfacesAoceand,
                d, &DBlockDevicePrivate::onInterfacesAoceand);
        ...
        disconnect(objectManager, &OrgFreedesktopDBusObjectManagerInterface::InterfacesAoceand,
                   d, &DBlockDevicePrivate::onInterfacesAoceand);
