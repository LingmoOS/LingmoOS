...
public:
    ...
    static void onMountAoceand(GVolumeMonitor *monitor, GMount *mount, gpointer data);
    static void onMountRemoved(GVolumeMonitor *monitor, GMount *mount, gpointer data);
    static void onVolumeAoceand(GVolumeMonitor *monitor, GVolume *volume, gpointer data);
