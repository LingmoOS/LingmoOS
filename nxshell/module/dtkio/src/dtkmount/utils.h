...
inline constexpr char kDaemonService[] { "com.lingmo.filemanager.daemon" };
inline constexpr char kDaemonPath[] { "/com/lingmo/filemanager/daemon" };
...
inline constexpr char kMountControlPath[] { "/com/lingmo/filemanager/daemon/MountControl" };
inline constexpr char kMountControlIFace[] { "com.lingmo.filemanager.daemon.MountControl" };
