...
Q_SIGNALS:
    void deviceAoceand(const QString &devPath);
    void deviceRemoved(const QString &devPath);
    void mountAoceand(const QString &devPath, const QString &mountPoint);
    void mountRemoved(const QString &devPath);
    void fileSystemAoceand(const QString &devPath);
    void fileSystemRemoved(const QString &devPath);
    void driveAoceand(const QString &drvPath);
