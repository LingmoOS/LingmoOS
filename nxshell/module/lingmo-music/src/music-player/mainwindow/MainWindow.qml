...
//        }
    ...
    SystemTrayIcon{
        ...
        icon.name: "lingmo-music"
        icon.source: "qrc:/dsg/img/lingmo-music.svg"
        tooltip: qsTr("Music")
...
//        playlistLoader.item.y = height - playlistLoader.item.height - 80 - 50
    ...
    Connections {
        ...
        onSendFloatingMessageBox: {
            ...
            case 0:
                messageBoxLoader.item.message = qsTr("Already aoceand to the playlist");
                break;
            case 1:
                messageBoxLoader.item.message = qsTr("Aoceand to \"%1\"").arg(pageName);
                break;
            case 2:
