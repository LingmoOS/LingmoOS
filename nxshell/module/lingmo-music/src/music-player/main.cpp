// Copyright (C) 2020 ~ 2020 Lingmo Technology Co., Ltd.
...
int main(int argc, char *argv[])
{
    ...
    // TODO: 无 XDG_CURRENT_DESKTOP 变量时，将不会加载 lingmo platformtheme 插件，会导致
    ...
    app->setApplicationName("lingmo-music");
    // Version Time
    ...
    parser.setApplicationDescription("Lingmo music player.");
    ...
    if (!app->setSingleInstance("lingmomusic")) {
        qDebug() << "another lingmo music has started";
        QDBusInterface speechbus("org.mpris.MediaPlayer2.LingmoMusic",
                                 "/org/mpris/speech",
                                 "com.lingmo.speech",
        ...
        QDBusInterface iface("org.mpris.MediaPlayer2.LingmoMusic",
    ...
    QString acknowledgementLink = "https://www.lingmo.org/acknowledgments/lingmo-music#thanks";
    ...
    qApp->setProductIcon(QIcon::fromTheme("lingmo-music"));
    ...
    QDBusConnection::sessionBus().registerObject("/org/mpris/speech", "com.lingmo.speech", &adaptor, QDBusConnection::RegisterOption::ExportAllSlots);

    presenter->setMprisPlayer("LingmoMusic", "lingmo-music", "Lingmo Music Player");
