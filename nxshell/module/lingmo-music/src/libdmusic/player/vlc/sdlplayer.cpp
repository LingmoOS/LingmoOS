...
{
    QVariant v = Utils::readDBusProperty("com.lingmo.daemon.Audio1", "/com/lingmo/daemon/Audio1",
                                             "com.lingmo.daemon.Audio1", "SinkInputs");
    ...
    for (auto curPath : allSinkInputsList) {
        QVariant nameV = Utils::readDBusProperty("com.lingmo.daemon.Audio1", curPath.path(),
                                                     "com.lingmo.daemon.Audio1.SinkInput", "Name");
...
void SdlPlayer::resetVolume()
{
    ...
    QVariant volumeV = Utils::readDBusProperty("com.lingmo.daemon.Audio1", m_sinkInputPath,
                                                   "com.lingmo.daemon.Audio1.SinkInput", "Volume");

    if (!volumeV.isValid()) return;

    QDBusInterface ainterface("com.lingmo.daemon.Audio1", m_sinkInputPath,
                              "com.lingmo.daemon.Audio1.SinkInput",
