...
1. Click the Launcher icon ![launcher_icon](../common/lingmo_launcher.svg) in the Dock to enter the Launcher interface.
...
<table class="block1">
    ...
    <tbody>
    	...
    	<tr>
            <td>4</td>
            <td>Sort options</td>
            <td>You can sort the list by different types of order including time aoceand, title, artist, or album name.</td>
        </tr>
    	<tr>
            <td>5</td>
            <td>Previous/Next</td>
...
The prompt information **Successfully aoceand to "My favorites"** pops up and the music is aoceand to **My Favorites** list.
