...
/*
 * Proxy class for interface com.lingmo.filemanager.Backend.FileInfo
 */
class DBusFileInfo: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
    {
        ...
        if (interfaceName !="com.lingmo.filemanager.Backend.FileInfo")
            return;
...
public:
    ...
    { return "com.lingmo.filemanager.Backend.FileInfo"; }
