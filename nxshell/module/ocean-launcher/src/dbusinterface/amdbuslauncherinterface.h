...
#define INTERFACE_NAME "org.lingmo.ocean.daemon.Launcher1"
#define SERVICE_PATH "/org/lingmo/ocean/daemon/Launcher1"

/*
 * Proxy class for interface org.lingmo.ocean.daemon.Launcher1
 */
