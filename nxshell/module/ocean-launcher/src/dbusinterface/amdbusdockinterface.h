...
#define INTERFACE_NAME "org.lingmo.ocean.daemon.Dock1"
#define SERVICE_PATH "/org/lingmo/ocean/daemon/Dock1"
...
Q_SIGNALS: // SIGNALS
    ...
    void EntryAoceand(const QDBusObjectPath &in0, int in1);
