...
Q_SIGNALS:
    void InterfacesAoceand(const QDBusObjectPath &objPath, const ObjectInterfaceMap &objInterMap);
...
Q_SIGNALS: // SIGNALS
    void InterfacesAoceand(const QDBusObjectPath &objectPath, ObjectInterfaceMap interfacesProperties);
...
public Q_SLOTS:
    void onInterfaceAoceand(const QDBusObjectPath &objectPath, const ObjectInterfaceMap &interfaces);
