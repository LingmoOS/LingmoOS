 ...
 * Command line was: qdbusxml2cpp -p monitorinterface -c MonitorInterface org.lingmo.ocean.Display1.Monitor.xml
 *
...
/*
 * Proxy class for interface org.lingmo.ocean.Display1.Monitor
 */
class MonitorInterface: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage &msg)
    {
        ...
        if (interfaceName != "org.lingmo.ocean.Display1.Monitor") {
            return;
        }
