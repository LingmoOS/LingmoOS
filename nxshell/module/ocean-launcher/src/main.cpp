...
#define LAUNCHER_INTERFACE "org.lingmo.ocean.Launcher1"
#define LAUNCHER_SERVICE_PATH "/org/lingmo/ocean/Launcher1"
...
int main(int argc, char *argv[])
{
    ...
    app->setApplicationName("ocean-launcher");
...
#ifndef QT_DEBUG
    // 默认日志路径是 ~/.cache/ocean-launcher/ocean-launcher.log
    DLogManager::registerFileAppender();
#endif

    bool quit = !app->setSingleInstance(QString("ocean-launcher_%1").arg(getuid()));
    ...
    cmdParser.setApplicationDescription("OCEAN Launcher");
