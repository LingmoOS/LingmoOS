...
static const auto DBUS_DAEMON_SERVICE_NAME = "org.lingmo.ocean.daemon.Launcher1";
static const auto DBUS_DAEMON_PATH_NAME = "/org/lingmo/ocean/daemon/Launcher1";
...
static const QString DEFAULT_META_CONFIG_NAME = "org.lingmo.ocean.launcher";          // 默认的配置文件名称
