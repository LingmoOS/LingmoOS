...
DisplayHelper::DisplayHelper(QObject *parent)
    : QObject(parent)
    , m_displayInter(new DisplayInter("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", QDBusConnection::sessionBus(), this))
{
...
BackgroundManager::BackgroundManager(QObject *parent)
    ...
    , m_wmInter(new wm("com.lingmo.wm", "/com/lingmo/wm", QDBusConnection::sessionBus(), this))
    , m_imageEffectInter(new ImageEffectInter("org.lingmo.ocean.ImageEffect1", "/org/lingmo/ocean/ImageEffect1", QDBusConnection::systemBus(), this))
    , m_imageblur(new ImageEffeblur("org.lingmo.ocean.ImageEffect1", "/org/lingmo/ocean/ImageBlur1", QDBusConnection::systemBus(), this))
    , m_appearanceInter(new AppearanceInter("org.lingmo.ocean.Appearance1", "/org/lingmo/ocean/Appearance1", QDBusConnection::sessionBus(), this))
    , m_displayInter(new DisplayInter("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", QDBusConnection::sessionBus(), this))
    , m_fileName(QString())
{
...
void BackgroundManager::updateBlurBackgrounds()
{
    ...
    QDBusMessage message = QDBusMessage::createMethodCall("org.lingmo.ocean.Appearance1", "/org/lingmo/ocean/Appearance1", "org.lingmo.ocean.Appearance1", "GetCurrentWorkspaceBackgroundForMonitor");
    message << screenName;
...
void BackgroundManager::onGetBlurImageFromDbus(const QString &file, const QString &blurFile, bool status)
{
    ...
    if (status && file == m_fileName) {
        ...
        // 按照ocean-session-ui/ocean-pixmix 的算法处理
