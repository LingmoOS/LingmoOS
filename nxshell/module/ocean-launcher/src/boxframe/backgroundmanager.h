...
using ImageEffeblur = org::lingmo::ocean::ImageBlur1;
using ImageEffectInter = org::lingmo::ocean::ImageEffect1;
using AppearanceInter = org::lingmo::ocean::Appearance1;
...
private:
    ...
    QPointer<com::lingmo::wm> m_wmInter;
