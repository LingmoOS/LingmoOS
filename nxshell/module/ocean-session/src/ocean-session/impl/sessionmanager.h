...
#include "org_lingmo_ocean_PowerManager1.h"
...
signals:
    // signals on dbus
    void Unlock();
    void InhibitorAoceand(const QDBusObjectPath &);
...
private:
    ...
    // dbus client
    org::lingmo::ocean::PowerManager1 *m_powerInter;
    org::lingmo::ocean::Audio1 *m_audioInter;
