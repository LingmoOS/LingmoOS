...
# 工程列表
targets=()
targets[${#targets[*]}]=ocean-bluetooth-dialog
targets[${#targets[*]}]=ocean-license-dialog
targets[${#targets[*]}]=ocean-lowpower
targets[${#targets[*]}]=ocean-notification-plugin
targets[${#targets[*]}]=ocean-osd
targets[${#targets[*]}]=ocean-suspend-dialog
targets[${#targets[*]}]=ocean-warning-dialog
targets[${#targets[*]}]=ocean-welcome
targets[${#targets[*]}]=ocean-wm-chooser
targets[${#targets[*]}]=dmemory-warning-dialog
targets[${#targets[*]}]=dnetwork-secret-dialog
targets[${#targets[*]}]=ocean-touchscreen-dialog
