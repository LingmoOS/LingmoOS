...
public:
    void SetUp() override
    {
        ...
        EXPECT_CALL(*notifySetting, appAoceand(testing::_)).
                    WillRepeatedly(testing::Invoke(settingHelper, &NotifySettingHelper::appAoceand));
...
TEST_F(UT_BubbleManager, coverageTest)
{
    ...
    obj->recordCount();
    obj->GetAppList();
    obj->GetAppInfo("lingmo-editor", 1);
    obj->GetSystemInfo(1);
    obj->SetAppInfo("lingmo-editor", 0, QDBusVariant(true));
...
{
    obj->Notify("lingmo-editor", 1, "", "", "", QStringList(), QVariantMap(), 1);
    obj->SetSystemInfo(3, QDBusVariant("00:00"));
    obj->SetSystemInfo(4, QDBusVariant("00:00"));
    obj->Notify("ocean-control-center", 1, "", "", "", QStringList(), QVariantMap(), 1);
    obj->Notify("lingmo-editor", 1, "", "", "", QStringList(), QVariantMap(), 1);
}
