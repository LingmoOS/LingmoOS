...
{
    auto notification = std::make_shared<NotificationEntity>("lingmo-editor");
    ListItem item = model->getAppData("lingmo-editor");
    ...
    model->expandData("lingmo-editor");
    model->collapseData();
    model->removeAppGroup("lingmo-editor");
