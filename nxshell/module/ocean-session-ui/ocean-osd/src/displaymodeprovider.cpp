...
const QString DisplayDBusServer = "org.lingmo.ocean.Display1";
const QString DisplayDBusPath = "/org/lingmo/ocean/Display1";
const QString AppIdAndName = "org.lingmo.ocean.control-center";
