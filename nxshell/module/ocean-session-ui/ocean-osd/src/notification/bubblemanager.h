...
#include "org_lingmo_ocean_sessionmanager1.h"
#include "org_lingmo_ocean_soundeffect1.h"
#include "org_lingmo_ocean_gesture1.h"
#include "org_lingmo_ocean_display1.h"
#include "org_lingmo_ocean_daemon_dock1.h"
#include "org_lingmo_ocean_appearance1.h"

#include "bubble.h"
#include "constants.h"

using Appearance = org::lingmo::ocean::Appearance1;
using UserInter = org::lingmo::ocean::SessionManager1;
using SoundeffectInter = org::lingmo::ocean::SoundEffect1;
using GestureInter = org::lingmo::ocean::Gesture1;
using DisplayInter = org::lingmo::ocean::Display1;
using DockInter = org::lingmo::ocean::daemon::Dock1;
...
static const QString DockDaemonDBusServie = "org.lingmo.ocean.daemon.Dock1";
static const QString DockDaemonDBusPath = "/org/lingmo/ocean/daemon/Dock1";
static const QString DisplayDaemonDBusServie = "org.lingmo.ocean.Display1";
static const QString DisplayDaemonDBusPath = "/org/lingmo/ocean/Display1";
static const QString LauncherDaemonDBusServie = "org.lingmo.ocean.daemon.Launcher1";
static const QString LauncherDaemonDBusPath = "/org/lingmo/ocean/daemon/Launcher1";
static const QString SoundEffectDaemonDBusServie = "org.lingmo.ocean.SoundEffect1";
static const QString SoundEffectDaemonDBusPath = "/org/lingmo/ocean/SoundEffect1";
static const QString SessionDBusServie = "org.lingmo.ocean.SessionManager1";
...
Q_SIGNALS:
    ...
    // Extra DBus APIs
    void RecordAoceand(const QString &);
    ...
    void AppAoceandSignal(const QString &id);
    ...
    // 旧接口之后废弃
    void appAoceand(QString appName);
...
private:
    ...
    void emitRecordAoceand(EntityPtr notify);
    void emitRecordAoceand(const QString &id);
private:
