...
/*
 * Adaptor class for interface org.lingmo.ocean.Notification1
 */
class OCEANNotifyDBus: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.lingmo.ocean.Notification1")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"org.lingmo.ocean.Notification1\">\n"
...
"  </interface>\n"
        "")
public:
    explicit OCEANNotifyDBus(QObject *parent);
    virtual ~OCEANNotifyDBus();
