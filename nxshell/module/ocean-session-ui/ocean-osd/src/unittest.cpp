...
static const QString NotifyInterPath = "/org/lingmo/ocean/Notification1";
static const QString NotifyInterSrever = "org.lingmo.ocean.Notification1";
...
{
    QString appName = "lingmo-screen-recorder";
    uint id = 0;
    QString appIcon = "lingmo-screenshot";
...
void UnitTest::test_NotifyInter()
{
    ...
    foreach(QString arg , argList) {
        DDBusSender().service("org.lingmo.ocean.Osd1").interface("org.lingmo.ocean.Osd1").path("/")
...
{
    QString key = "lingmo-screen-recorder";
    QString appName = BubbleTool::getLingmoAppName(key);//获取应用名称
