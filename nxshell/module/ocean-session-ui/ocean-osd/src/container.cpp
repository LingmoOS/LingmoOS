...
void Container::moveToCenter()
{
    ...
    DisplayInter displayInter("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", QDBusConnection::sessionBus());
...
{
    const QGSettings gsettings("com.lingmo.ocean.osd", "/com/lingmo/ocean/osd/");
