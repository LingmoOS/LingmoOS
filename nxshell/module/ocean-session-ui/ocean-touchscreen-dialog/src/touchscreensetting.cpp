...
const QString DisplayServer = "org.lingmo.ocean.Display1";
const QString DisplayServerPath = "/org/lingmo/ocean/Display1";
    ...
    , m_monitorIndicator(new MonitorIndicator)
{
    ...
    setIcon(QIcon::fromTheme("oceanui_touchscreen"));
