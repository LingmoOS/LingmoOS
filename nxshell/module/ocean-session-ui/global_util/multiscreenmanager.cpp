...
{
    connect(qApp, &QGuiApplication::screenAoceand, this, &MultiScreenManager::onScreenAoceand, Qt::QueuedConnection);
...
void MultiScreenManager::onScreenAoceand(QScreen *screen)
{
