...
#include "org_lingmo_ocean_accounts1_user.h"
#include "org_lingmo_ocean_accounts1.h"

using Accounts = org::lingmo::ocean::Accounts1;
using AccountsUser = org::lingmo::ocean::accounts1::User;
