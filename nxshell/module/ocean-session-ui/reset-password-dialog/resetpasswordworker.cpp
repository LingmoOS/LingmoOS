...
ResetPasswordWorker::ResetPasswordWorker(const QString& userName, QObject *parent)
    : QObject (parent)
    , m_accountInter(new Accounts("org.lingmo.ocean.Accounts1", "/org/lingmo/ocean/Accounts1", QDBusConnection::systemBus(), this))
    , m_syncHelperInter(new QDBusInterface("com.lingmo.sync.Helper", "/com/lingmo/sync/Helper", "com.lingmo.sync.Helper", QDBusConnection::systemBus(), this))
{
    ...
    if (reply.isError()) {
        ...
        m_userInter = new AccountsUser("org.lingmo.ocean.Accounts1", reply.value(), QDBusConnection::systemBus(), this);
        m_userQInter = new QDBusInterface("org.lingmo.ocean.Accounts1", reply.value(),"org.lingmo.ocean.Accounts1.User", QDBusConnection::systemBus(), this);
    }
...
int ResetPasswordWorker::bindCheck()
{
    ...
    QDBusInterface userInter("org.lingmo.ocean.Accounts1",
                             m_userPath,
