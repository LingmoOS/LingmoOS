...
#define DBUS_SERV "org.lingmo.ocean.LowPower1"
#define DBUS_PATH "/org/lingmo/ocean/LowPower1"
#define DBUS_IFCE "org.lingmo.ocean.LowPower1"
...
int main(int argc, char *argv[])
{
    ...
    QCommandLineOption quitOption("quit", "quit all ocean-lowpower instances.");
