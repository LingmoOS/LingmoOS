...
void WidgetGallery::createBottomRightGroupBox()
{
    ...
    comboBoxEdit->addItem(QIcon::fromTheme("ocean-file-manager"), "ocean-file-manager");
    comboBoxEdit->addItem(QIcon::fromTheme("ocean-introduction"), "ocean-introduction");
    comboBoxEdit->addItem(QIcon::fromTheme("lingmo-deb-installer"), "lingmo-deb-installer");
