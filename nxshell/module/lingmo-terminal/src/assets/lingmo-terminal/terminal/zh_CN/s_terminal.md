...
> ![tips](../common/tips.svg)窍门 ：鼠标右键单击任务栏上的图标 ![lingmo_terminal](../common/lingmo_terminal.svg)，选择 **雷神终端**，打开雷神模式的终端窗口。
...
在终端界面，通过以下方法新建窗口：
 ...
 - 右键单击任务栏上的图标 ![lingmo_terminal](../common/lingmo_terminal.svg) ，选择 **新建窗口**。
