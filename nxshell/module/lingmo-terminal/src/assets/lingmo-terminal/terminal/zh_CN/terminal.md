...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到终端图标 ![lingmo_terminal](../common/lingmo_terminal.svg)，单击运行。
3. 右键单击 ![lingmo_terminal](../common/lingmo_terminal.svg)，您可以：
   - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 在任务栏右键单击 ![lingmo_terminal](../common/lingmo_terminal.svg)，选择 **关闭所有**，退出终端。
...
> ![tips](../common/tips.svg)窍门 ：右键单击任务栏上的终端图标 ![lingmo_terminal](../common/lingmo_terminal.svg)，选择 **雷神终端**，打开雷神模式的终端窗口。
...
在终端界面，通过以下方法新建窗口：
 ...
 - 右键单击任务栏上的终端图标 ![lingmo_terminal](../common/lingmo_terminal.svg)，选择 **新建窗口**。
