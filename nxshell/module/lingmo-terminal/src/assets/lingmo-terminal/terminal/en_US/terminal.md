...
1. Click the Launcher icon ![lingmo_launcher](../common/lingmo_launcher.svg) in the Dock to enter launcher interface.
2. Locate Terminal ![lingmo_terminal](../common/lingmo_terminal.svg) by scrolling the mouse wheel or searching "terminal" in the Launcher interface and click it to run.
3. Right-click ![lingmo_terminal](../common/lingmo_terminal.svg) to: 
...
2. Right-click ![lingmo_terminal](../common/lingmo_terminal.svg) in the Dock and select **Close All** to exit.
...
> ![tips](../common/tips.svg) Tips: You can also right-click ![lingmo_terminal](../common/lingmo_terminal.svg) in the Dock to select **Quake Terminal** to open a quake window.
...
- Click ![lingmo_terminal](../common/lingmo_terminal.svg) in the Dock to select **New Window**.
...
You can open remote management panel to add remote servers via the main menu or right-click menu. Once a remote server is aoceand into the management list, you can automatically login just by one click. 
...
When you set a group for a server, it will be aoceand in the corresponding group and displayed in the remote management panel on the right side.
...
2. In the **Basic** options, you can:
   ...
   >![notes](../common/notes.svg)Notes: if Window Effect is turned off in Control Center, the **Opacity** scroll bar will be hioceann.
...
2. In the **Advanced** options, you can:
  ...
  - Enable or disable **Blur background**.
   >![notes](../common/notes.svg)Notes: If Window Effect is turned off in Control Center, **Blur background** option will be hioceann.
