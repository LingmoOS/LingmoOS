...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到終端圖標 ![lingmo_terminal](../common/lingmo_terminal.svg)，單擊運行。
3. 右鍵單擊 ![lingmo_terminal](../common/lingmo_terminal.svg)，您可以：
   - 單擊 **傳送到桌面**，在桌面創建快捷方式。
...
- 在任務欄右鍵單擊 ![lingmo_terminal](../common/lingmo_terminal.svg)，選擇 **關閉所有** 來關閉終端。
...
> ![tips](../common/tips.svg)竅門 ：您也可以右鍵單擊任務欄上的圖標 ![lingmo_terminal](../common/lingmo_terminal.svg)，選擇 **雷神終端**，打開雷神模式的終端窗口。
...
在終端界面，通過以下方法新建視窗：
 ...
 - 右鍵單擊任務欄上的圖標 ![lingmo_terminal](../common/lingmo_terminal.svg)，選擇 **新建視窗**。
