...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到終端機 ![lingmo_terminal](../common/lingmo_terminal.svg) 單擊執行。
...
- 在Dock中右鍵單擊 ![lingmo_terminal](../common/lingmo_terminal.svg)，選擇 **全部關閉** 關閉終端機。
...
> ![tips](../common/tips.svg)竅門：右鍵單擊Dock中的 ![lingmo_terminal](../common/lingmo_terminal.svg) 圖示，選擇 **雷神模式終端器**，打開雷神模式的終端視窗。
...
在啟動器介面開啟終端，可以透過以下方法新增視窗：
 ...
 - 右鍵單擊任務欄上的 ![lingmo_terminal](../common/lingmo_terminal.svg) 圖示，選擇 **新增視窗**。
