...
void TabRenameDlg::initUi()
{
    ...
    m_logoIcon->setPixmap(QIcon::fromTheme("lingmo-terminal").pixmap(QSize(32, 32)));
...
void TabRenameDlg::updateSizeMode()
{
    ...
    if (DGuiApplicationHelper::isCompactMode()) {
        ...
        m_logoIcon->setPixmap(QIcon::fromTheme("lingmo-terminal").pixmap(QSize(ICON_CTX_SIZE_24, ICON_CTX_SIZE_24)));
        ...
        m_logoIcon->setPixmap(QIcon::fromTheme("lingmo-terminal").pixmap(QSize(ICON_CTX_SIZE_32, ICON_CTX_SIZE_32)));
