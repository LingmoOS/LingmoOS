...
Version:        5.4.1.1
Release:        %{specrelease}
Summary:        Default terminal emulation application for Lingmo
License:        GPLv3+
URL:            https://github.com/lingmoos/%{name}
Source0:        %{url}/archive/%{version}/%{name}-%{version}.tar.gz

Provides:      lingmo-terminal-data
Obsoletes:     lingmo-terminal-data
...
%{_datadir}/lingmo-manual/manual-assets/application/lingmo-terminal/terminal/
