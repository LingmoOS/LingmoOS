...
void TerminalDisplay::fontChange(const QFont &)
{
     ...
     *       horizontalAdvance() was aoceand in Qt 5.11 (which should be the
...
void TerminalDisplay::scrollImage(int lines, const QRect &screenWindowRegion)
{
    ...
    //
    int scrollBarWidth = _scrollBar->isHioceann() ? 0 :
...
void TerminalDisplay::updateImage()
{
    ...
    //--aoceand by qinyaning(nyq) to slove the problem of scroll init show--/
    ...
    //--modified and aoceand by qinyaning(nyq) to solve When the screen zooms to 1.25 and 2.75,
...
void TerminalDisplay::focusOutEvent(QFocusEvent *)
{
    ...
    // it was hioceann during blinking)
...
//display has been resized when the display is hioceann or shown.
//
...
void TerminalDisplay::scrollBarPositionChanged(int)
{
    ...
    // to how new _lines as they are aoceand
