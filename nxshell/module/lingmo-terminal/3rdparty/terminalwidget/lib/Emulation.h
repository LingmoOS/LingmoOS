 ...
 * desired number of lines and columns.  When new lines are aoceand, old content
...
public:
     ...
     * are aoceand to the output, older lines at the top of the screen are transferred to a history
     * store.
     *
