...
public:
    ...
    ///
    virtual void itemAoceand(PluginsItemInterface * const itemInter, const QString &itemKey) = 0;
    ///
    /// \brief itemUpdate
    ...
    ///
    /// \brief saveValue
    /// save module config to .config/lingmo/ocean-dock.conf
    ...
    /// \brief getValue
    /// SeeAlse: saveValue
    /// return value from .config/lingmo/ocean-dock.conf
    ///
