...
#define NETWORKSERVICE "org.lingmo.ocean.Network1"
#define NETWORKPATH "/org/lingmo/ocean/Network1"
#define NETWORKINTERFACE "org.lingmo.ocean.Network1"
...
{
    connect(NetworkManager::settingsNotifier(), &NetworkManager::SettingsNotifier::connectionAoceand, this, &VPNController_NM::onConnectionAoceand);
...
void VPNController_NM::onConnectionAoceand(const QString &path)
{
    qCInfo(DNC) << "On connection aoceand, new vpn connection: " << path;
    NetworkManager::Connection::List connections = NetworkManager::listConnections();
...
{
    // 调用com.lingmo.system.Network的相关接口来设置VPN
