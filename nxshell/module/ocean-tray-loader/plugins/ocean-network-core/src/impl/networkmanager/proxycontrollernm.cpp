...
const static QString proxyChainsPath        = "/org/lingmo/ocean/Network1/ProxyChains";
const static QString proxyChainsInterface   = "org.lingmo.ocean.Network1.ProxyChains";
...
{
    if (interface != "org.lingmo.ocean.Network1.ProxyChains")
        return;
