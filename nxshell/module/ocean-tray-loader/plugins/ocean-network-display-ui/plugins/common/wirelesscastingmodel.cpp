...
const QString dbusService = "com.lingmo.Cooperation.NetworkDisplay";
const QString dbusPath = "/com/lingmo/Cooperation/NetworkDisplay";
const QString dbusInterface = "com.lingmo.Cooperation.NetworkDisplay";
const QString sinkInterface = "com.lingmo.Cooperation.NetworkDisplay.Sink";
...
{
    if ("com.lingmo.Cooperation.NetworkDisplay" == name && !newOwner.isEmpty()) {
