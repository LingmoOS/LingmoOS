...
EyeComfortModeController::EyeComfortModeController()
        : m_displayInter(new QDBusInterface("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", "org.lingmo.ocean.Display1", QDBusConnection::sessionBus(), this))
        , m_themeInter(new DBusTheme("org.lingmo.ocean.Appearance1", "/org/lingmo/ocean/Appearance1", QDBusConnection::sessionBus(), this))
        ...
        , m_supportColorTemperature(false)
{
    ...
    QDBusConnection::sessionBus().connect("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", "org.freedesktop.DBus.Properties", "PropertiesChanged", this, SLOT(onPropertiesChanged(QString, QVariantMap, QStringList)));
