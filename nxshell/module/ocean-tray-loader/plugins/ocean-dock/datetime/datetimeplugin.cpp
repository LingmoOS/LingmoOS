...
Q_LOGGING_CATEGORY(DOCK_DATETIME, "org.lingmo.ocean.dock.datetime")
...
void DatetimePlugin::init(PluginProxyInterface *proxyInter)
{
    ...
    // transfer config
    QSettings settings("lingmo", "ocean-dock-datetime");
...
void DatetimePlugin::invokedMenuItem(const QString &itemKey, const QString &menuId, const bool checked)
{
    ...
    if (menuId == "open") {
        ...
        QProcess::startDetached("dbus-send --print-reply --dest=com.lingmo.Calendar /com/lingmo/Calendar com.lingmo.Calendar.RaiseWindow");
    }
}
