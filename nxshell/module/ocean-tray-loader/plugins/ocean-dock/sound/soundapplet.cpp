...
SoundApplet::SoundApplet(QWidget* parent)
    ...
    , m_dConfig(Dtk::Core::DConfig::create("org.lingmo.ocean.tray-loader", "org.lingmo.ocean.dock.plugin.sound", QString(), this))
    , m_minHeight(-1)
...
void SoundApplet::initUi()
{
    ...
    m_settingButton->setOceanUIPage("sound", "output");
...
void SoundApplet::initConnections()
{
    ...
    connect(&SoundModel::ref(), &SoundModel::enabledPortAoceand, this, &SoundApplet::addPort);
