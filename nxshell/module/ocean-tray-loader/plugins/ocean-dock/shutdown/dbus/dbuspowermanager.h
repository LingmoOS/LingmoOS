 ...
 * Command line was: qdbusxml2cpp -c PowerManager -p com_lingmo_daemon_powermanager com.lingmo.daemon.PowerManager.xml
 *
...
/*
 * Proxy class for interface com.lingmo.daemon.PowerManager
 */
