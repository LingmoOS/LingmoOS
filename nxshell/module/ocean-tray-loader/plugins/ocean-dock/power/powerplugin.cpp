...
Q_LOGGING_CATEGORY(DOCK_POWER, "org.lingmo.ocean.dock.power")
...
PowerPlugin::PowerPlugin(QObject *parent)
    ...
    , m_config(Dtk::Core::DConfig::create("org.lingmo.ocean.tray-loader", "org.lingmo.ocean.dock.plugin.power", "", this))
{
...
void PowerPlugin::updateBatteryVisible()
{
    ...
    if (!exist)
        ...
        m_proxyInter->itemAoceand(this, POWER_KEY);
}
...
void PowerPlugin::loadPlugin()
{
    ...
    m_systemPowerInter = new SystemPowerInter("org.lingmo.ocean.Power1", "/org/lingmo/ocean/Power1", QDBusConnection::systemBus(), this);
