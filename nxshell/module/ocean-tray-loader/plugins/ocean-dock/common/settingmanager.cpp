...
{
    if (!dockConfig)
        dockConfig = DConfig::create("org.lingmo.ocean.tray-loader", "org.lingmo.ocean.dock", QString(), this);

    if (!quickPanelConfig)
        quickPanelConfig = DConfig::create("org.lingmo.ocean.tray-loader", "org.lingmo.ocean.dock.plugin.quick-panel", QString(), this);
