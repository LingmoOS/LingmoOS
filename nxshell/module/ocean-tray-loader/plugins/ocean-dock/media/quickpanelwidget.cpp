...
void QuickPanelWidget::updateUI()
{
    ...
    if (!pixmapExist) {
        info.pixmap = Dtk::Gui::DIcon::loadNxPixmap(":/lingmo-music.svg").scaled(QSize(32 * qApp->devicePixelRatio(), 32 * qApp->devicePixelRatio()), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    }
