...
BrightnessController::BrightnessController(QObject *parent)
    : QObject(parent)
    , m_displayInter(DisplayInterface, "/org/lingmo/ocean/Display1", QDBusConnection::sessionBus(), this)
    , m_displayDBusInter(new QDBusInterface("org.lingmo.ocean.Display1",
                                            "/org/lingmo/ocean/Display1",
                                            "org.lingmo.ocean.Display1",
                                            QDBusConnection::sessionBus()))
    , m_dConfig(DConfig::create("org.lingmo.ocean.control-center", "org.lingmo.ocean.control-center.display", QString(), this))
...
void BrightnessController::monitorAoceand(const QString &path)
{
    ...
    BrightnessModel::ref().monitorAoceand(mon);
