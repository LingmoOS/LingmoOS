...
void KeyboardPlugin::init(PluginProxyInterface *proxyInter)
{
    ...
    if (!m_dbusAdaptors) {
        ...
        QDBusConnection::sessionBus().registerService("org.lingmo.ocean.Keyboard1");
        QDBusConnection::sessionBus().registerObject("/org/lingmo/ocean/Keyboard1", "org.lingmo.ocean.Keyboard1", this);
    }
}
