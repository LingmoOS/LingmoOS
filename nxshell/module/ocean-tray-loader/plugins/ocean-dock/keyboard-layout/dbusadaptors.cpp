...
// oceanui keyboard layout key in gsettings
...
Q_LOGGING_CATEGORY(KEYBOARD_LAYOUT, "org.lingmo.ocean.dock.keyboardLayout")

DBusAdaptors::DBusAdaptors(QObject *parent)
    : QDBusAbstractAdaptor(parent),
      m_keyboard(new Keyboard("org.lingmo.ocean.InputDevices1",
                              "/org/lingmo/ocean/InputDevice1/Keyboard",
...
#if 0 // TODO origin gsettings: "com.lingmo.ocean.dock.module.keyboard"
...
{
    // TODO origin gsettings: "com.lingmo.ocean.keybinding.system.enable"
#if 0
    ...
    // TODO origin gsettings: "com.lingmo.ocean.control-center"
    // hide keyboard layout setttings in ocean-control-center, resume it after fcitx stopped
    if (m_oceanuiSettings && m_oceanuiSettings->keys().contains(KDB_LAYOUT_DCC_NAME)) {
        m_oceanuiSettings->set(KDB_LAYOUT_DCC_NAME, QVariant(!m_fcitxRunning));
    }
#endif
}
