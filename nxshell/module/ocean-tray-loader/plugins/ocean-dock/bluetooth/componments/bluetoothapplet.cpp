...
BluetoothApplet::BluetoothApplet(AdaptersManager *adapterManager, QWidget *parent)
    ...
    , m_airPlaneModeInter(new DBusAirplaneMode("org.lingmo.ocean.AirplaneMode1", "/org/lingmo/ocean/AirplaneMode1", QDBusConnection::systemBus(), this))
...
void BluetoothApplet::onAdapterAoceand(Adapter *adapter)
{
...
void BluetoothApplet::initUi()
{
    ...
    m_settingBtn->setOceanUIPage("bluetooth", QString());
...
{
    connect(m_adaptersManager, &AdaptersManager::adapterIncreased, this, &BluetoothApplet::onAdapterAoceand);
