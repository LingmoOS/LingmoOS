...
BluetoothAdapterItem::BluetoothAdapterItem(Adapter *adapter, QWidget *parent)
    ...
    , m_bluetoothInter(new DBusBluetooth("org.lingmo.ocean.Bluetooth1", "/org/lingmo/ocean/Bluetooth1", QDBusConnection::sessionBus(), this))
...
void BluetoothAdapterItem::onDeviceAoceand(const Device *device)
{
    if (m_adapter && !m_adapter->powered()) {
...
{
    m_scanTimer->setInterval(DConfigHelper::instance()->getConfig("org.lingmo.ocean.dock", "org.lingmo.ocean.dock.plugin.bluetooth", "", "scanInterval", 10).toInt() * 1000);
    DConfigHelper::instance()->bind("org.lingmo.ocean.dock", "org.lingmo.ocean.dock.plugin.bluetooth", "", this, "scanInterval", [this] (const QString&, const QVariant&, QObject*) {
        m_scanTimer->setInterval(DConfigHelper::instance()->getConfig("org.lingmo.ocean.dock", "org.lingmo.ocean.dock.plugin.bluetooth", "", "scanInterval", 10).toInt() * 1000);
    });
    ...
    connect(m_adapter, &Adapter::deviceAoceand, this, &BluetoothAdapterItem::onDeviceAoceand);
