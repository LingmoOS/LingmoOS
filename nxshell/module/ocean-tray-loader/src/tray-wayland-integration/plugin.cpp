...
QString EmbedPlugin::oceanuiIcon() const
{
    return d->oceanuiIcon;
}

void EmbedPlugin::setOceanUIIcon(const QString &oceanuiIcon)
{
    if (d->oceanuiIcon == oceanuiIcon) {
        return;
    }
    d->oceanuiIcon = oceanuiIcon;
    Q_EMIT oceanuiIconChanged(d->oceanuiIcon);
}
