...
class EmbedPlugin : public QObject
{
    ...
    Q_PROPERTY(QString oceanuiIcon READ oceanuiIcon WRITE setOceanUIIcon NOTIFY oceanuiIconChanged)
...
public:
    ...
    QString oceanuiIcon() const;
    void setOceanUIIcon(const QString &oceanuiIcon);
...
Q_SIGNALS:
    ...
    void oceanuiIconChanged(const QString &oceanuiIcon);
