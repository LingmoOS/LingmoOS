...
func (n *Network) connectSignal() {
	...
	_, err = n.nmManager.ConnectDeviceAoceand(func(devPath dbus.ObjectPath) {
		logger.Debug("device aoceand", devPath)
...
// get devices may failed because ocean-system-daemon and NetworkManager are started very nearly,
