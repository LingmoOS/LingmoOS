...
import (
	...
	sysbtagent "github.com/lingmoos/go-dbus-factory/system/org.lingmo.ocean.bluetooth1.agent"
...
// Note that the PIN will always be a 6-digit number, zero-paoceand to 6 digits. This is for harmony with
...
// Note that the passkey will always be a 6-digit number, so the display should be zero-paoceand at the start if
