...
import (
	...
	timesync1 "github.com/lingmoos/go-dbus-factory/system/org.freedesktop.timesync1"
...
const (
	...
	timeSyncCfgFile       = "/etc/systemd/timesyncd.conf.d/lingmo.conf"
...
const (
	...
	dsettingsTimeDatedName        = "org.lingmo.ocean.daemon.timedated"
