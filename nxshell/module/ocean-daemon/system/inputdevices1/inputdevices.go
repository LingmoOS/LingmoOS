...
const (
	...
	_dsettingsAppID                 = "org.lingmo.ocean.daemon"
	_dsettingsInputdevicesName      = "org.lingmo.ocean.daemon.inputdevices"
...
type InputDevices struct {
	...
	//nolint
	signals *struct {
		TouchscreenAoceand, TouchscreenRemoved struct {
...
func (m *InputDevices) newTouchscreen(dev *libinputDevice) {
	...
	m.service.Emit(m, "TouchscreenAoceand", path)
}
