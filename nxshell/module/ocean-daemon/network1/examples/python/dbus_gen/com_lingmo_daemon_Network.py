...
* pydbusclient.tpl
* ./dbus_gen/dbus_ocean_daemon_network.xml
...
class Network(object):
    ...
    def __init__(self, bus_name, object_path, interface=None, bus=None):
        '''Constructor'''
        self._dbus_interface_name = interface or "org.lingmo.ocean.Network1"
    ...
    def AccessPointAoceand(self, callback):
        '''
        Signal (wait for me)
        callback params:
             STRING
        ...
        See also:
            http://dbus.freedesktop.org/doc/dbus-specification.html#idp94392448s
        '''
        self._dbus_interface.connect_to_signal('AccessPointAoceand', callback)
        return self
...
class LifeManager(object):
    ...
    def __init__(self, bus_name, object_path, interface=None, bus=None):
        '''Constructor'''
        self._dbus_interface_name = interface or "com.lingmo.DBus.LifeManager"
        self._dbus_object_path = object_path 
        self._dbus_name = bus_name 
