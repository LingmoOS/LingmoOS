...
from dbus_gen.com_lingmo_daemon_Network import Network
from dbus_gen.com_lingmo_daemon_Network_ConnectionSession import ConnectionSession

dbus_network = Network('org.lingmo.ocean.Network1', '/org/lingmo/ocean/Network1')
...
dbus_session = ConnectionSession('org.lingmo.ocean.Network1', session_path)
