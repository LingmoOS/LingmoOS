...
const (
	// #nosec
	nmSecretDialogBin              = "/usr/lib/lingmo-daemon/dnetwork-secret-dialog"
...
func isSecretDialogExist() bool {
	...
	return strings.Contains(string(out), "/usr/lib/lingmo-daemon/dnetwork-secret-dialog")
}
...
func (sa *SecretAgent) SaveSecretsLingmo(connectionData map[string]map[string]dbus.Variant,
...
func (*SecretAgentSession) GetInterfaceName() string {
	return "org.lingmo.ocean.Network1.SecretAgent"
}
