...
import (
	...
	proxy "github.com/lingmoos/go-dbus-factory/system/com.lingmo.system.proxy"
...
func NewManager(service *dbusutil.Service) *Manager {
	...
	jsonFile := filepath.Join(cfgDir, "lingmo", "proxychains.json")
	confFile := filepath.Join(cfgDir, "lingmo", "proxychains.conf")
...
const (
	DBusPath      = "/org/lingmo/ocean/Network1/ProxyChains"
	dbusInterface = "org.lingmo.ocean.Network1.ProxyChains"
)
