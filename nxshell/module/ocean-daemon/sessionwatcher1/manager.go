...
import (
	...
	libdisplay "github.com/lingmoos/go-dbus-factory/session/org.lingmo.ocean.display1"
...
const (
	dbusServiceName = "org.lingmo.ocean.SessionWatcher1"
	dbusPath        = "/org/lingmo/ocean/SessionWatcher1"
...
func (m *Manager) initUserSessions() {
	...
	_, err = m.loginManager.ConnectSessionNew(func(id string, path dbus.ObjectPath) {
		logger.Debug("Session aoceand:", id, path)
