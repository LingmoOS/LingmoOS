...
// 处理从 ocean-system-daemon 在 system bus 传递给 session 的消息
...
func (m *Manager) loadServices() {
	...
	m.loadServicesFromDir("/usr/lib/lingmo-daemon/" + moduleName)
	m.loadServicesFromDir("/etc/lingmo-daemon/" + moduleName)
