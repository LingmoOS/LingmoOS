...
const (
	dbusServiceName    = "org.lingmo.ocean.daemon.Launcher1"
	dbusObjPath        = "/org/lingmo/ocean/daemon/Launcher1"
	dbusInterface      = dbusServiceName
	desktopMainSection = "Desktop Entry"
	launcherExecPath   = "/usr/bin/ocean-launcher"
)
...
func (m *Manager) RequestSendToDesktop(id string) (ok bool, busErr *dbus.Error) {
	...
	kf.SetString(desktopMainSection, "X-Lingmo-CreatedBy", dbusServiceName)
	kf.SetString(desktopMainSection, "X-Lingmo-AppID", id)
