...
import (
	...
	udcp "github.com/lingmoos/go-dbus-factory/system/com.lingmo.udcp.iam"
	...
	"github.com/lingmoos/go-lib/tasker"
...
const (
	...
	userConfigDir      = actConfigDir + "/lingmo/users"
	...
	interfacesFile = "/usr/share/ocean-daemon/accounts/dbus-udcp.json"
)
...
const (
	...
	dsettingsAccountName       = "org.lingmo.ocean.daemon.account"
	dsettingsIsTerminalLocked  = "isTerminalLocked"
	gsSchemaDdeControlCenter   = "com.lingmo.ocean.control-center"
...
type Manager struct {
	...
	userAoceandChanMap map[string]chan string
...
func NewManager(service *dbusutil.Service) *Manager {
	...
	m.userAoceandChanMap = make(map[string]chan string)
...
func (m *Manager) exportUserByUid(uId string) error {
	...
	m.usersMapMu.Lock()
	ch := m.userAoceandChanMap[u.UserName]
	m.usersMapMu.Unlock()
...
const (
	greeterAppId             = "org.lingmo.ocean.lightdm-lingmo-greeter"
	daemonAccountsResourceId = "org.lingmo.ocean.daemon.accounts"
