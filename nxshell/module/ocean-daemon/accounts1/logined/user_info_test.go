...
func Test_Equal(t *testing.T) {
	...
	var testSessionInfo1 = &SessionInfo{Uid: 1, Desktop: "lingmo", Display: ":0", sessionPath: "/org/freedesktop/login1/session/self"}
	var testSessionInfo2 = &SessionInfo{Uid: 1, Desktop: "lingmo", Display: ":0", sessionPath: "/org/freedesktop/login1/session/self"}
