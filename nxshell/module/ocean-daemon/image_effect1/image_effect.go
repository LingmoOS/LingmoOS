...
const (
	dbusServiceName = "org.lingmo.ocean.ImageEffect1"
	dbusInterface   = dbusServiceName
	dbusPath        = "/org/lingmo/ocean/ImageEffect1"

	cacheDir      = "/var/cache/lingmo/ocean-daemon/image-effect"
	effectPixmix  = "pixmix"
...
func newImageEffect() *ImageEffect {
	...
	ie.tools[effectPixmix] = effectToolFunc(oceanPixmix)
	return ie
}

func oceanPixmix(userName, inputFile, outputFile string, envVars []string) error {

	return runCmdRedirectStdOut(userName, outputFile, []string{"ocean-pixmix", "-o=-", inputFile}, envVars)
}
