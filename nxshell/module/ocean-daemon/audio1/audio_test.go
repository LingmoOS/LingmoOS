...
func Test_objectPathSliceEqual(t *testing.T) {
	var str = []dbus.ObjectPath{"/org/lingmo/ocean/Bluetooth1", "/org/lingmo/ocean/Audio1"}
	var str1 = []dbus.ObjectPath{"/org/lingmo/ocean/Bluetooth1", "/org/lingmo/ocean/Audio1"}
	var str2 = []dbus.ObjectPath{"/org/lingmo/ocean/Bluetooth1", "/org/lingmo/ocean/Audio1", "/"}
	var str3 = []dbus.ObjectPath{"/org/lingmo/ocean/Bluetooth1", "/org/lingmo/ocean/Accounts1"}
