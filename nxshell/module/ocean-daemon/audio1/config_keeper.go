...
var globalConfigKeeperFile = filepath.Join(basedir.GetUserConfigDir(), "lingmo/ocean-daemon/audio-config-keeper.json")
var globalConfigKeeperMuteFile = filepath.Join(basedir.GetUserConfigDir(), "lingmo/ocean-daemon/audio-config-keeper-mute.json")
