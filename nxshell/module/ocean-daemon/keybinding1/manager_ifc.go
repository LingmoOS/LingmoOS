...
const (
	dbusServiceName = "org.lingmo.ocean.Keybinding1"
	dbusPath        = "/org/lingmo/ocean/Keybinding1"
	dbusInterface   = "org.lingmo.ocean.Keybinding1"
)
...
func (m *Manager) AddCustomShortcut(name, action, keystroke string) (id string,
	...
	m.emitShortcutSignal(shortcutSignalAoceand, shortcut)
	id = shortcut.GetId()
