[3.27.2] 2019-05-09
*   feat(dock): window identify for lingmo archon apps
...
*   feat(dock): process X-Lingmo-Vendor field
*   feat: add pam module lingmo_auth

[3.27.0] 2019-04-19
*   chore: auto pull translation files from transifex
*   change(api): ocean-authority add method HasCookie
*   feat(ocean-authority): fprint transcation give message based on user locale

[3.26.0] 2019-04-18
*   fix(appearance): do not change background after logging in
*   fix: lingmo-installer.conf
...
*   feat(launcher): process X-Lingmo-Vendor field
...
*   feat(appearance): add greeter background for lingmo sync
*   feat(network): add sync supported
*   feat(inputdevices): add sync supported
*   feat(screenedge): add sync supported
*   feat(dock): continue to support lingmo sync
*   feat(dock): support lingmo sync
*   feat(appearance): support lingmo sync
*   feat(launcher): support lingmo sync
*   feat(ocean-session-daemon): sync login sound config after all module started
*   fix(soundeffect): still play login sound even if sound effect switch is off
*   chore: auto pull translation files from transifex
*   change(api): org.lingmo.ocean.Greeter1 add method UpdateGreeterQtTheme
*   fix: ScreenScaleFactors cannot be easily parsed by greeter
*   feat: also set the screen scale factors of the greeter
*   fix(accounts): user was not aoceand to some groups when creating user
*   feat(grub2): keep GRUB_BACKGROUND empty if enable theme
*   feat(keybinding): add support for ocean-kwin shortucts
...
*   feat: add pam-config for lingmo-auth
...
[3.22.0] 2019-01-25
*   feat: use ocean-api package userenv
...
*   feat: speed up ocean-session-daemon part2 startup
...
*   feat(grub2): gfxmode detect failed fallback to lingmo-falback
...
*   chore(dock): specially stated that ocean-launcher should not be displayed
...
[3.7.0] 2018-11-12
*   fix(dock): ocean-launcher show on dock
...
*   chore: remove grub-themes-lingmo from suggests
*   auto sync po files from transifex
...
*   chore: update call method for org.lingmo.ocean.device1
...
*   chore(appearance): move set/get scale factor code to startocean
...
*   feat: merge ocean-session-daemon and ocean-session-init
...
*   chore(timedated): no use github.com/lingmoos/go-lib/polkit
*   chore(grub2): no use github.com/lingmoos/go-lib/polkit
...
*   chore: do not beep if ocean-session-init request name failed
...
*   chore(launcher): move launcher module to ocean-session-daemon
...
*   fix(miracast): failed to emit signal Aoceand and Removed
...
[3.2.12] 2018-03-22
*   auto sync po files from transifex
*   feat(dock): add window identify for org.lingmo.flatdeb.*
...
*   feat(ocean-lockservice): use newly lib dbusutil
*   feat(ocean-greeter-setter): use newly lib dbusutil
...
*   fix: terminal opened by ocean-file-manager work dir is wrong
*   feat: use tool lingmo-policy-ts-convert to handle the
*   docs: `add service_trigger.md`
*   feat: ocean-session-daemon add new module `service_trigger`
...
*   swapsched: create cgroup sessionID@ocean/DE
*   ocean-session-init: add module `x_event_monitor`
...
*   dock: fix index in signal EntryAoceand is wrong
...
## [3.2.4] - 2017-11-09
#### Features
*   add org.lingmo.ocean.ImageBlur1 interface
...
*   add shortcut for lingmo-system-monitor and color-picker
*   support lingmo qt theme settings
...
*   Add 'ocean-greeter-setter' ([4dd38e68](4dd38e68))
...
* Support to uninstall 'lingmo-fpapp-*' package
