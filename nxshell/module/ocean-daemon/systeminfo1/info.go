...
import (
	...
	"github.com/lingmoos/ocean-daemon/common/cpuinfo"
...
const (
	dbusServiceName         = "org.lingmo.ocean.SystemInfo1"
	dbusPath                = "/org/lingmo/ocean/SystemInfo1"
	dbusInterface           = dbusServiceName
	dsettingsAppID          = "org.lingmo.ocean.daemon"
	dsettingsSystemInfoName = "org.lingmo.ocean.daemon.systeminfo"
	dsettingsIsM900Config   = "IsM900Config"
)

type SystemInfo struct {
	// Current lingmo version, ex: "2015 Desktop"
	Version string
	// Distribution ID
	DistroID string
...
func (d *Daemon) initSysSystemInfo() {
	...
	// 通过 demicode 获取 "CPU 频率", 接收 org.lingmo.ocean.SystemInfo1 的属性 CurrentSpeed 改变信号
