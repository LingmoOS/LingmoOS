...
const (
	dbusServiceName = "org.lingmo.ocean.Grub2"
	dbusPath        = "/org/lingmo/ocean/Grub2"
	dbusInterface   = dbusServiceName

	polikitActionIdCommon               = "org.lingmo.ocean.grub2"
	polikitActionIdPrepareGfxmodeDetect = "org.lingmo.ocean.grub2.prepare-gfxmode-detect"
...
func (g *Grub2) PrepareGfxmodeDetect(sender dbus.Sender) *dbus.Error {
	...
	if gfxmodeDetectState == gfxmodeDetectStateDetecting {
		...
		cur, _, err := grub_common.GetBootArgLingmoGfxmode()
		if err == nil {
