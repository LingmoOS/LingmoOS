...
import (
	...
	"github.com/lingmoos/go-x11-client/ext/screensaver"
)
...
func (ss *ScreenSaver) setTimeout(seconds, interval uint32, blank bool) {
	...
	if strings.Contains(sessionType, "wayland") {
		...
		err = sessionBus.Object("org.lingmo.ocean.KWayland1",
			"/org/lingmo/ocean/KWayland1/Output").Call("org.lingmo.ocean.KWayland1.Idle.SetIdleTimeout", 0, seconds*1000).Err
