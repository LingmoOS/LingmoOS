...
import (
	...
	notifications "github.com/lingmoos/go-dbus-factory/session/com.lingmo.ocean.notification"
	abrecovery "github.com/lingmoos/go-dbus-factory/system/com.lingmo.abrecovery"
...
const (
	dbusPath        = "/org/lingmo/ocean/LastoreSessionHelper1"
	dbusServiceName = "org.lingmo.ocean.LastoreSessionHelper1"
)

const (
	dSettingsAppID                  = "org.lingmo.lastore"
	dSettingsLastoreName            = "org.lingmo.lastore"
...
const distUpgradeJobPath = "/org/lingmo/ocean/Lastore1/Jobdist_upgrade"
...
func (d *Daemon) Start() error {
	...
	go func() {
		...
		if err != nil {
			...
			if len(msg) != 0 {
				_, err = osd.Notify(0, "ocean-control-center", 0, "preferences-system", "", msg, nil, nil, NotifyExpireTimeoutNoHide)
				if err != nil {
					logger.Warning(err)
				}
			}
