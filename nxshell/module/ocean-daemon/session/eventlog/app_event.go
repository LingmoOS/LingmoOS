...
func (c *appEventCollector) Collect() error {
	...
	_, err = c.dockObj.ConnectEntryAoceand(func(path dbus.ObjectPath, index int32) {
	...
	_, err = c.dockObj.ConnectEntryRemoved(func(entryId string) {
		...
		entryPath := dbus.ObjectPath(filepath.Join("/org/lingmo/ocean/daemon/Dock1/entries/", entryId))
...
func (c *appEventCollector) monitor(entryObj dock.Entry) {
	...
	//such as /com/lingmo/ocean/daemon/Dock/entries/e0T61978f3b
