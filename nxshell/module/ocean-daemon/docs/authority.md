# org.lingmo.ocean.Authority1 服务
...
对象路径：/org/lingmo/ocean/Authority1

### org.lingmo.ocean.Authority1 接口
...
对象路径：/org/lingmo/ocean/Authority1/TranscationN

### org.lingmo.ocean.Authority1.Transcation 接口
...
UI 程序在 system bus 上导出一个对象，这个对象实现 org.lingmo.ocean.Authority1.Agent 接口，把对象的路径作为 org.lingmo.ocean.Authority1.Start 方法的 agentObj 参数。

### org.lingmo.ocean.Authority1.Agent 接口
