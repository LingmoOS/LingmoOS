...
### 目录优先级
由高到低
- /etc/lingmo-daemon/service-trigger/
- /usr/lib/lingmo-daemon/service-trigger/
...
```json
{
    "Monitor": {
        ...
        "DBus": {
            "BusType": "System",
            "Sender": "org.lingmo.ocean.Apps1",
            "Interface": "org.lingmo.ocean.Apps1.LaunchedRecorder",
            "Path": "/org/lingmo/ocean/Apps1",
            "Signal": "StatusSaved"
        }
    },
...
这样会让 service_trigger 监听 system bus 的 org.lingmo.ocean.Apps 服务的 /org/lingmo/ocean/Apps1 对象的 org.lingmo.ocean.Apps1.LaunchedRecorder 接口的 StatusSaved 信号，如果收到将执行 echo 命令输出信号参数。
