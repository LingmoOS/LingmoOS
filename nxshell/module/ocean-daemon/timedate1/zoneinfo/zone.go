...
var (
	...
	_lingmoZoneList []string
	_zoneListMap    map[string]struct{}

	// Error, invalid timezone
	ErrZoneInvalid = fmt.Errorf("invalid time zone")

	lingmoDefaultZoneTab = "/usr/share/ocean/zoneinfo/zone1970.tab"
...
func loadZoneListWithoutLock() (err error) {
	...
	_lingmoZoneList, err = getZoneListFromFile(lingmoDefaultZoneTab)
	_zoneListMap = make(map[string]struct{})

	for _, zone := range _lingmoZoneList {
