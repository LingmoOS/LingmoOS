...
import (
	...
	inputdevices "github.com/lingmoos/go-dbus-factory/system/org.lingmo.ocean.inputdevices1"
...
const (
	tpadSchema = "com.lingmo.ocean.touchpad"
	...
	dsettingsInputdevices = "org.lingmo.ocean.daemon.inputdevices"
...
func (tpad *Touchpad) init() {
	...
	if tpad.systemConn != nil {
		sysTouchPad, err := inputdevices.NewTouchpad(tpad.systemConn, "/org/lingmo/ocean/InputDevices1/Touchpad")
		if err != nil {
			logger.Warning(err)
		} else {
...
func enableGesture(enabled bool) {
	s, err := dutils.CheckAndNewGSettings("com.lingmo.ocean.gesture")
	if err != nil {
		return
	}
