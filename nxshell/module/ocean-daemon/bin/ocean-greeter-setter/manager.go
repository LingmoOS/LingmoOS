...
const (
	dbusServiceName = "org.lingmo.ocean.Greeter1"
	dbusPath        = "/org/lingmo/ocean/Greeter1"
	dbusInterface   = dbusServiceName
)

const (
	themeFile                  = "/etc/lightdm/lingmo/qt-theme.ini"
	themeSection               = "Theme"
...
const (
	xsettingsFile             = "/etc/lightdm/lingmo/xsettingsd.conf"
...
func updateGreeterQtTheme(fd dbus.UnixFD) error {
	...
	defer f.Close()
	err := os.MkdirAll("/etc/lightdm/lingmo", 0755)
	if err != nil {
		return err
	}
