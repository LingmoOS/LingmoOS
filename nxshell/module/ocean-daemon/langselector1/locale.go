...
import (
	...
	"github.com/lingmoos/ocean-api/language_support"
	"github.com/lingmoos/ocean-api/userenv"
	ddbus "github.com/lingmoos/ocean-daemon/dbus"
	libnetwork "github.com/lingmoos/go-dbus-factory/session/org.lingmo.ocean.network1"
	notifications "github.com/lingmoos/go-dbus-factory/session/org.freedesktop.notifications"
	lastore "github.com/lingmoos/go-dbus-factory/system/org.lingmo.ocean.lastore1"
	localehelper "github.com/lingmoos/go-dbus-factory/system/org.lingmo.ocean.localehelper1"
...
const (
	...
	gsSchemaLocale = "com.lingmo.ocean.locale"
...
func sendNotify(icon, summary, body string) {
	...
	_, err = n.Notify(0, "ocean-control-center", 0,
		icon, summary, body,
		nil, nil, -1)
...
func (lang *LangSelector) setLocale(locale string) {
	...
	fontCfgFile := filepath.Join(basedir.GetUserConfigDir(),
		"fontconfig/conf.d/99-lingmo.conf")
...
func (lang *LangSelector) generateLocale(locale string) error {
	successMatchRule := dbusutil.NewMatchRuleBuilder().ExtSignal("/org/lingmo/ocean/LocaleHelper1", "org.lingmo.ocean.LocaleHelper1", "Success").Build()
...
func (lang *LangSelector) installPackages(pkgs []string) error {
	...
	jobMatchRule := dbusutil.NewMatchRuleBuilder().ExtPropertiesChanged(
		string(jobPath), "com.lingmo.lastore.Job").Build()
