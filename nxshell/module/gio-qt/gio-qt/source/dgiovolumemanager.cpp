...
private:
    ...
    void slot_mountAoceand(const Glib::RefPtr< Mount >& gmmMount);
    ...
    void slot_volumeAoceand(const Glib::RefPtr< Volume >& gmmVolume);
    ...
    : q_ptr(qq)
{
    ...
    m_connections.append(m_gmmVolumeMonitorPtr->signal_mount_aoceand().connect(sigc::mem_fun(*this, &DGioVolumeManagerPrivate::slot_mountAoceand)));
    ...
    m_connections.append(m_gmmVolumeMonitorPtr->signal_volume_aoceand().connect(sigc::mem_fun(*this, &DGioVolumeManagerPrivate::slot_volumeAoceand)));
...
void DGioVolumeManagerPrivate::slot_mountAoceand(const Glib::RefPtr<Mount> &gmmMount)
{
...
void DGioVolumeManagerPrivate::slot_volumeAoceand(const Glib::RefPtr<Volume> &gmmVolume)
{
    Q_Q(DGioVolumeManager);
