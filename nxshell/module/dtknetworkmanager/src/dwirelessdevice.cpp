...
DWirelessDevicePrivate::DWirelessDevicePrivate(const quint64 id, DWirelessDevice *parent)
    ...
    , m_wireless(new DWirelessDeviceInterface("/com/lingmo/FakeNetworkManager/Devices/" + QByteArray::number(id), this))
#else
    ...
    : DDevice(*new DWirelessDevicePrivate(id, this), parent)
{
    ...
    connect(d->m_wireless, &DWirelessDeviceInterface::AccessPointAoceand, this, [this](const QDBusObjectPath &ap) {
        Q_EMIT this->AccessPointAoceand(getIdFromObjectPath(ap));
    });
