    ...
    , m_manager(new DAgentManagerInterface(this))
{
    ...
    managerConnection.connect("org.freedesktop.NetworkManager",
                              ...
                              QLatin1String("InterfacesAoceand"),
                              q,
                              SLOT(dbusInterfacesAoceand(QDBusObjectPath, QVariantMap)));
...
void DSecretAgentPrivate::dbusInterfacesAoceand(const QDBusObjectPath &path, const QVariantMap &interfaces)
{
    Q_UNUSED(path);
