    ...
    : DDeviceInterface(path, parent)
{
    ...
    const QString &Interface = QStringLiteral("com.lingmo.FakeNetworkManager.Device.Wireless");
    ...
    Connection.connect(Service, path, Interface, "AccessPointAoceand", this, SIGNAL(AccessPointAoceand(const QDBusObjectPath &)));
