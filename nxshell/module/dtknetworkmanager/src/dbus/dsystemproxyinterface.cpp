    ...
    : QObject(parent)
{
    ...
    const QString &Interface = QStringLiteral("com.lingmo.daemon.FakeNetwork.Network");
    const QString &Path = QStringLiteral("/com/lingmo/daemon/FakeNetwork/Network");
    QDBusConnection Connection = QDBusConnection::sessionBus();
#else
    const QString &Service = QStringLiteral("com.lingmo.daemon.Network");
    const QString &Interface = QStringLiteral("com.lingmo.daemon.Network");
    const QString &Path = QStringLiteral("/com/lingmo/daemon/Network");
    QDBusConnection Connection = QDBusConnection::sessionBus();
#endif
