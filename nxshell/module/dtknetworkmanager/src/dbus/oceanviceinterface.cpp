    ...
    : QObject(parent)
{
    ...
    const QString &deviceInterface = QStringLiteral("com.lingmo.FakeNetworkManager.Device");
    const QString &statisticsInterface = QStringLiteral("com.lingmo.FakeNetworkManager.Device.Statistics");
