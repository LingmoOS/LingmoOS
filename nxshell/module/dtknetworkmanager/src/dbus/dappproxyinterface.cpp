    ...
    : QObject(parent)
{
    ...
    const QString &Service = QStringLiteral("com.lingmo.daemon.FakeNetwork");
    const QString &Interface = QStringLiteral("com.lingmo.daemon.FakeNetwork.ProxyChains");
    const QString &Path = QStringLiteral("/com/lingmo/daemon/FakeNetwork/ProxyChains");
    QDBusConnection Connection = QDBusConnection::sessionBus();
#else
    const QString &Service = QStringLiteral("com.lingmo.daemon.Network");
    const QString &Interface = QStringLiteral("com.lingmo.daemon.Network.ProxyChains");
    const QString &Path = QStringLiteral("/com/lingmo/daemon/Network/ProxyChains");
    QDBusConnection Connection = QDBusConnection::sessionBus();
#endif
