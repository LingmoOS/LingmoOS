    ...
    : QObject(parent)
{
    ...
    const QString &Interface = QStringLiteral("com.lingmo.FakeNetworkManager.AgentManager");
    const QString &Path = QStringLiteral("/com/lingmo/FakeNetworkManager/AgentManager");
