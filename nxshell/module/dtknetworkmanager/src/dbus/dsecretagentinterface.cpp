    ...
    : QObject(parent)
{
    ...
    const QString &Interface = QStringLiteral("com.lingmo.FakeNetworkManager.SecretAgent");
    const QString &Path = QStringLiteral("/com/lingmo/FakeNetworkManager/SecretAgent");
