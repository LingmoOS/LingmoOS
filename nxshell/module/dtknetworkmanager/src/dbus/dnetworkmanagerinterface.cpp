    ...
    : QObject(parent)
{
    ...
    const QString &Service = QStringLiteral("com.lingmo.FakeNetworkManager");
    const QString &Path = QStringLiteral("/com/lingmo/FakeNetworkManager");
    const QString &Interface = QStringLiteral("com.lingmo.FakeNetworkManager");
    ...
    Connection.connect(Service, Path, Interface, "DeviceAoceand", this, SIGNAL(DeviceAoceand(const QDBusObjectPath &)));
