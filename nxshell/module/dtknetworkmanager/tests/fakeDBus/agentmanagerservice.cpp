...
#include "agentmanagerservice.h"
#include <QDBusConnection>
#include <QDBusError>
#include <QDebug>

FakeAgentManagerService::FakeAgentManagerService(QObject *parent)
    : QObject(parent)
{
    registerService();
}

FakeAgentManagerService::~FakeAgentManagerService()
{
    unregisterService();
}

void FakeAgentManagerService::registerService()
{
...
void FakeAgentManagerService::unregisterService()
{
    QDBusConnection bus = QDBusConnection::sessionBus();
