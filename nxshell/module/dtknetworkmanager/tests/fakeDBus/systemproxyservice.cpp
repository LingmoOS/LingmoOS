...
FakeSystemProxyService::FakeSystemProxyService(QObject *parent)
    : QObject(parent)
{
    registerService();
}

FakeSystemProxyService::~FakeSystemProxyService()
{
    unregisterService();
}

void FakeSystemProxyService::registerService()
{
...
void FakeSystemProxyService::unregisterService()
{
    QDBusConnection bus = QDBusConnection::sessionBus();
