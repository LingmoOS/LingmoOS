...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.FakeSystem.IPWatchD")
public:
...
private:
    ...
    const QString Service{"com.lingmo.FakeSystem.IPWatchD"};
    const QString Path{"/com/lingmo/FakeSystem/IPWatchD"};
};
