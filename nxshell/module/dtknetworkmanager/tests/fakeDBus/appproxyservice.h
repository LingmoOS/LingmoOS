...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.daemon.FakeNetwork.ProxyChains")
public:
...
private:
    ...
    const QString Service{"com.lingmo.daemon.FakeNetwork"};
    const QString Path{"/com/lingmo/daemon/FakeNetwork/ProxyChains"};
};
