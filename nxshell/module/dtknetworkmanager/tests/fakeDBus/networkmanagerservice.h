...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.FakeNetworkManager")
public:
    ...
    QList<QDBusObjectPath> m_activeConnections{QDBusObjectPath{"/com/lingmo/FakeNetworkManager/ActiveConnection/1"}};
    QDBusObjectPath m_primaryConnection{"/com/lingmo/FakeNetworkManager/ActiveConnection/1"};
...
private:
    ...
    const QString Service{"com.lingmo.FakeNetworkManager"};
    const QString Path{"/com/lingmo/FakeNetworkManager"};
};
