...
#include "dhcp6configservice.h"
#include <QDBusConnection>
#include <QDBusError>
#include <QDebug>
#include <QDBusMetaType>

FakeDHCP6ConfigService::FakeDHCP6ConfigService(QObject *parent)
    : QObject(parent)
{
    registerService();
}

FakeDHCP6ConfigService::~FakeDHCP6ConfigService()
{
    unregisterService();
}

void FakeDHCP6ConfigService::registerService()
{
...
void FakeDHCP6ConfigService::unregisterService()
{
    QDBusConnection bus = QDBusConnection::sessionBus();
