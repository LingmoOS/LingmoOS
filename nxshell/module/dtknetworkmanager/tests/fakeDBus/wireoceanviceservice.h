...
#ifndef WIREOCEANVICESERVICE_H
#define WIREOCEANVICESERVICE_H
...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.lingmo.FakeNetworkManager.Device.Wired")
public:
...
private:
    ...
    const QString Path{"/com/lingmo/FakeNetworkManager/Devices/2"};
};
