...
dtknetworkmanager是对于lingmo/UOS系统上的org.freedesktop.NetworkManager和com.lingmo.daemon.Network的DBus接口的封装，同时也提供了对于NetworkManager的配置文件的封装，方便应用开发者轻松且快速的调用接口进行开发。
