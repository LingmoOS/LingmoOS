...
// https://gitlabwh.uniontech.com/wuhan/se/lingmo-specifications/-/issues/3
...
@~english
    ...
    Not visible to the outside world. Such configuration items are completely read and written by the program itself, and can be aoceand, deleted and rewritten at will without compatibility consideration,
...
@~english
    ...
    \a key Configure the name of the option, NoOverride This option can't be overrioceann, and Global ignores the user identity
    @return
*/
