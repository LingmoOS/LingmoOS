...
@~english
  ...
  @sa localizedValue(), genericName(), oceanDisplayName()
 */
...
@~english
  ...
  @sa localizedValue(), name(), oceanDisplayName()
 */
...
/*!
@~english
  @brief Display name specially for OCEAN applications.
  
  This will check "X-Lingmo-Vendor" and will return the localized string value of "GenericName" if
  "X-Lingmo-Vendor" is "lingmo", or it will return the localized string value of "Name".

  @return Returns the display name specially for OCEAN applications.
  
  @sa localizedValue(), name(), genericName()
 */
QString DDesktopEntry::oceanDisplayName() const
{
    QString lingmoVendor = stringValue("X-Lingmo-Vendor");
    QString genericNameStr = genericName();
    if (lingmoVendor == QStringLiteral("lingmo") && !genericNameStr.isEmpty()) {
