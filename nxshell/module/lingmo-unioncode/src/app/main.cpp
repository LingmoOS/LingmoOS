...
static const char *const IID = "org.lingmo.plugin.unioncode";
...
void installTranslator(DApplication &a)
{
    ...
    QString configFile = CustomPaths::user(CustomPaths::Flags::Configures)
            + QDir::separator() + "lingmo-unioncode.json";
...
int main(int argc, char *argv[])
{
    ...
    a.setApplicationDisplayName(a.translate("Application", "lingmo-unioncode"));
    a.setApplicationVersion(version());
    a.setProductIcon(QIcon::fromTheme("about_logo"));
    a.setApplicationDescription(a.translate("Application",
                                            "Lingmo Union Code is a lightweight integrated development environment,\
