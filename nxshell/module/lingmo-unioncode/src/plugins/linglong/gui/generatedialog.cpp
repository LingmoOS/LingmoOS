...
void GenerateDialog::initUi()
{
    ...
    d->idEdit->setPlaceholderText("org.lingmo.hello");
...
void GenerateDialog::generate()
{
    ...
    if (d->dependsCbBox->currentText() == Depends_Version_V20) {
        base["base"] = "org.lingmo.foundation/20.0.0";
        runtime["runtime"] = "org.lingmo.Runtime/20.0.0";
    } else {
        base["base"] = "org.lingmo.foundation/23.0.0";
        runtime["runtime"] = "org.lingmo.Runtime/23.0.1";
    }
    YAML::Node command;
    ...
    YAML::Node depend;
    depend["kind"] = "file";
    depend["url"] = "https://pools.uniontech.com/lingmo-beige/pool/main/a/acl/libacl1_2.3.1-1_amd64.deb";
    depend["digest"] = "f06e936eb913b8e9271c17e6d8b94d9e4f0aa558d7debdc324c9484908ee8dc8";
    YAML::Node source;
    source["kind"] = "git";
    source["url"] = "https://github.com/lingmoos/linglong-builder-demo.git";
