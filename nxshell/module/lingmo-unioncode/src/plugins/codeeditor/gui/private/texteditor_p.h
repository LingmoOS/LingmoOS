...
public:
    ...
    void updateCacheInfo(int pos, int aoceand);
    void provideInlineCompletion(int pos, int aoceand);
...
public slots:
    ...
    void onModified(int pos, int mtype, const QString &text, int len, int aoceand,
                    int line, int foldNow, int foldPrev, int token, int annotationLinesAoceand);
    void updateSettings();
