...
public:
    ...
    /**
     * Gets the top stack frame that is not hioceann if the callstack has already been received from the debug adapter
     */
...
struct IDebugSession : public ITreeElement
{
    ...
    virtual bool launch(dap::LaunchRequest &config) = 0;
