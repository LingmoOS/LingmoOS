...
namespace GlobalPrivate
{
    ...
    const QString lingmoCachePath = cachePath + "lingmo" + QDir::separator();
}
...
{
    if (!QFileInfo::exists(GlobalPrivate::lingmoCachePath))
...
{
    return GlobalPrivate::lingmoCachePath + QCoreApplication::applicationName();
}
