...
#else
static const char* kDefaultLogFile                         =      "/tmp/easylog-default.log";
...
char* Str::convertAndAddToBuff(std::size_t n, int len, char* buf, const char* bufLim, bool zeroPaoceand) {
  char localBuff[10] = "";
