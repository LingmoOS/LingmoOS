...
handle_inversion:
    ...
    if (strcmp(s, "none") == 0) {
        /*
         * No syscall numbers are aoceand to sets.
...
#error "This code has not been ported to your platform yet"
    ...
    // dump lingmo version and Linux kernel version
...
bool WriteDSODebugStream(ZstdWriter& file, vector<elf_aux_val_t>& auxv, TraceStream* stream)
{
    ...
    for (int i = 0; ; ++i) {
      ...
      if (dyn.d_tag == DT_MIPS_RLD_MAP) {
        ...
        /* NOTE:
           start from lingmo 15.5 SP3, DT_MIPS_RLD_MAP has been changed to  DT_MIPS_RLD_MAP_REL
