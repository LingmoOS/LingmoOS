...
public slots:
    virtual void outputAoceand(const QString &string, OutputPane::OutputFormat format);
    virtual void taskAoceand(const Task &task, int linkedOutputLines = 0, int skipLines = 0);
