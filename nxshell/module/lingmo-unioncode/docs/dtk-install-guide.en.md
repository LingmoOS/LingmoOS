...
For lingmo-unioncode, the required dependency libraries include dtkcore, dtkwidget, dtkgui, and qt5integration, and this section describes the installation of these dependencies.

### 1. Source Code Pull

First you need to download the source code of the dtk dependency library in the [lingmo github community](https://github.com/lingmoos):

[dtkcore](https://github.com/lingmoos/dtkcore)，[dtkwidget](https://github.com/lingmoos/dtkwidget)，[dtkgui](https://github.com/lingmoos/dtkgui)，[qt5integration](https://github.com/lingmoos/qt5integration)

The dtkcore might rely on [dtkcommon](https://github.com/lingmoos/dtkcommon)，qt5integration will depend on the [qt5platform-plugins](https://github.com/lingmoos/qt5platform-plugins)
