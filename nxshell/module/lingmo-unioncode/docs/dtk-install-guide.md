...
对于Lingmo-IDE，所需要的依赖库包括dtkcore，dtkwidget，dtkgui以及qt5integration，本部分介绍这几个依赖的安装。
...
其中，dtkcore可能会依赖[dtkcommon](https://github.com/lingmoos/dtkcommon)，qt5integration会依赖[qt5platform-plugins](https://github.com/lingmoos/qt5platform-plugins)
