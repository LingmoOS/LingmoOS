...
// @file LexAU3.cxx
// Lexer for AutoIt3  http://www.hioceannsoft.com/autoit3
// by Jos van der Zande, jvdzande@yahoo.com
//
// Changes:
// March 28, 2004 - Aoceand the standard Folding code
// April 21, 2004 - Aoceand Preprosessor Table + Syntax Highlighting
...
//                  Aoceand support for Sendkey strings that have second parameter e.g. {UP 5} or {a down}
// April 26, 2004 - Fixed # pre-processor statement inside of comment block would invalidly change the color.
//                  Aoceand logic for #include <xyz.au3> to treat the <> as string
//                  Aoceand underscore to IsAOperator.
// May 17, 2004   - Changed the folding logic from indent to keyword folding.
//                  Aoceand Folding logic for blocks of single-commentlines or commentblock.
//                        triggered by: fold.comment=1
//                  Aoceand Folding logic for preprocessor blocks triggered by fold.preprocessor=1
//                  Aoceand Special for #region - #endregion syntax highlight and folding.
// May 30, 2004   - Fixed issue with continuation lines on If statements.
// June 5, 2004   - Aoceand comma to Operators for better readability.
//                  Aoceand fold.compact support set with fold.compact=1
...
// Sep 5, 2004    - Aoceand logic to handle colourizing words on the last line.
//                        Typed Characters now show as "default" till they match any table.
// Oct 10, 2004   - Aoceand logic to show Comments in "Special" directives.
// Nov  1, 2004   - Aoceand better testing for Numbers supporting x and e notation.
// Nov 28, 2004   - Aoceand logic to handle continuation lines for syntax highlighting.
// Jan 10, 2005   - Aoceand Abbreviations Keyword used for expansion
...
//                - Aoceand folding support for With...EndWith
//                - Aoceand support for a DOT in variable names
...
// Aug 23, 2005   - Aoceand Switch/endswitch support to the folding logic.
...
// Apr  8, 2006   - Aoceand support for AutoIt3 Standard UDF library (SCE_AU3_UDF)
