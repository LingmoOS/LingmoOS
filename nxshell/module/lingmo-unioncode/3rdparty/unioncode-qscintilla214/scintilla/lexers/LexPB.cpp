...
// 29.10.2003: 1. Bug: Toggling didn't work for subs/functions aoceand in editor
...
// 12.07.2004: 1. Toggling for macros aoceand
...
//  - Statement aoceand to KeyWords.cxx:      'LINK_LEXER(lmPB);'
//  - Statement aoceand to scintilla_vc6.mak: '$(DIR_O)\LexPB.obj: ...\src\LexPB.cxx $(LEX_HEADERS)'
//
