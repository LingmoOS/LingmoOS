...
#define SC_WRAPINDENT_LINGMODENT 3
...
#define SCI_MULTIPLESELECTAOCEANACH 2689
...
struct SCNotification {
	...
	int ch;
	/* SCN_CHARAOCEAND, SCN_KEY, SCN_AUTOCCOMPLETED, SCN_AUTOCSELECTION, */
	...
	Sci_Position linesAoceand;	/* SCN_MODIFIED */
	...
	Sci_Position annotationLinesAoceand;	/* SCN_MODIFIED with SC_MOD_CHANGEANNOTATION */
