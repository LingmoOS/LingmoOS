...
/** @file SciLexer.h
 ** Interface to the aoceand lexer functions in the SciLexer version of the edit control.
 **/
...
#define SCE_MYSQL_HIOCEANNCOMMAND 21
