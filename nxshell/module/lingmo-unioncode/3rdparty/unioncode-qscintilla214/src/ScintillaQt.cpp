...
void QsciScintillaQt::NotifyParent(SCNotification scn)
{
    ...
    case SCN_CHARAOCEAND:
        emit qsb->SCN_CHARAOCEAND(scn.ch);
        break;
    ...
    case SCN_MODIFIED:
        {
            ...
            emit qsb->SCN_MODIFIED(scn.position, scn.modificationType, text,
                    scn.length, scn.linesAoceand, scn.line, scn.foldLevelNow,
                    scn.foldLevelPrev, scn.token, scn.annotationLinesAoceand);
