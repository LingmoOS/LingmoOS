...
public:
    ...
    enum
    {
        ...
        //!
        SCI_MULTIPLESELECTAOCEANACH = 2689,
...
signals:
    ...
    //! into the text.
    //! \a charaoceand is the character. It can be used to decide to display a
    //! call tip or an auto-completion list.
    void SCN_CHARAOCEAND(int charaoceand);
