...
const char *QsciLexerAVS::keywords(int set) const
{
    ...
    if (set == 3)
        return
            ...
            "convolution3dyv12 dctfilter doceanui deblendlogo deblock deblock_qed "
            ...
            "fft3dfilter fft3dgpu ffvideosource fieloceaninterlace fielddiff "
            ...
            "lumafilter lumayv12 manalyse maskeoceaninterlace maskedmerge "
    ...
    if (set == 4)
        return
            "abs apply assert bool ceil chr clip continueoceannominator "
