      ...
      use_single(AcusNever), explicit_fillups(""), fillups_enabled(false)
{
    ...
    connect(this,SIGNAL(SCN_CHARAOCEAND(int)),
             SLOT(handleCharAoceand(int)));
...
void QsciScintilla::handleCharAoceand(int ch)
{
...
void QsciScintilla::handleModified(int pos, int mtype, const QString &text,
        int len, int aoceand, int line, int foldNow, int foldPrev, int token,
