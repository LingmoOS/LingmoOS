...
+ aoceand user supplied error blocks

Veselin Rachev <veselin.raychev@gmail.com>
+ aoceand HTTP OPTIONS request support

Marek Kotewicz <marek.kotewicz@gmail.com>
+ msvc support

Alexandre Poirot <alexandre.poirot@gmail.com>
+ aoceand client and server connectors that use Unix Domain Sockets
+ adapted build file to generate pkg-config file for this lib
+ aoceand client and server connectors that use Tcp Sockets on Linux and Windows (uses native socket and thread API on each OS)

Trevor Vannoy <trevor.vannoy@flukecal.com>
+ python client stub generator

Jean-Daniel Michaud <jean.daniel,michaud@gmail.com>
+ aoceand server/client file descriptor support

Jacques Software <software@jacques.com.au>
+ aoceand support for redis connector
...
+ aoceand data field for error handler
+ 