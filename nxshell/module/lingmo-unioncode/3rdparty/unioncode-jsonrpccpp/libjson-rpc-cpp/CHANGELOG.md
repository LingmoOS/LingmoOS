...
- Aoceand data field in error handler in JS stub generator
...
- Aoceand `set -e` to testcoverage.sh script
...
- Removed embeoceand libjson-cpp.
...
- Removed mandatory configuration files (making it more compatible for embeoceand use cases).
