...
struct CompletionItem
{
    ...
    // attribute) where the completion text is aoceand. If missing the text is aoceand
...
struct Message
{
    // A format string for the message. Embeoceand variables have the form '{name}'.
...
// The event indicates that some source has been aoceand, changed, or removed from
...
//
// Additional attributes can be aoceand to the module. They will show up in the
...
struct RunInTerminalRequest : public Request
{
    ...
    string cwd;
    // Environment key-value pairs that are aoceand to or removed from the default
    // environment.
    optional<object> env;
