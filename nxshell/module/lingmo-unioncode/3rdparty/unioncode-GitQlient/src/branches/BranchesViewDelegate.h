...
public:
   ...
   */
   ...
   /*!
    \brief Overrioceann paint method used to display different colors when mouse actions happen.
   ...
   */
   ...
   /*!
    \brief Overrioceann method that returns the size of the row, both height and width.
