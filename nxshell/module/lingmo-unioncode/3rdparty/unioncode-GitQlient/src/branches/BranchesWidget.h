...
private:
   ...
   /*!
    ...
    \param branch The branch to be aoceand in the tree widget.
   */
   ...
   /*!
    ...
    \param branch The remote branch to be aoceand in the tree widget.
   */
   ...
   */
   ...
   /*!
    \brief Once all the items have been aoceand to the conrresponding BranchTreeWidget, the columns are adjusted to show
