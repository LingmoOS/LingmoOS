...
- The green color is used to indicate which lines have been aoceand.
...
Since GitQlient it's a Git client, you will need to have Git installed and aoceand to the path.
