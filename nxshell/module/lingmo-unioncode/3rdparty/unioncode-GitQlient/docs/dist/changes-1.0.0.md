...
Big features:
- **Multi-repository support**: Aoceand support to have multiple repositories opened at the same time.
- **Submodules**: Aoceand support for opening, adding and updating the submodules in a repository. The submodules can be opened as a normal repository to work with them.
...
- New Diff view:
   ...
   - Aoceand information about the commits that are compared and the files that are modified
- Aoceand option to reset staged files
