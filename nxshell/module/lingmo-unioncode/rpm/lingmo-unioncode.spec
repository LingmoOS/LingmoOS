...
Name: lingmo-unioncode
Version: 1.1.18.1
Release: 1%{?dist}
Summary: IDE 'Lingmo Union Code'
License: GPLv3+
URL: http://www.lingmo.org
...
%exclude /usr/include/lingmo-unioncode/framework/*

%changelog
* Tue Jan 01 2019 Lingmo Packages Builder <packages@lingmoos.com> 1.0.0-1
- Initial RPM release.
