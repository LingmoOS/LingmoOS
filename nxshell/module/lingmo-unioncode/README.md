...
lingmo-unioncode 是一款支持多语言、跨平台兼容特性的轻量级集成开发环境。
...
可执行程序为 `/usr/bin/lingmo-unioncode`

## 使用

启动栏执行 `lingmo-unioncode`

*注意：lingmo-unioncode安装后，部分功能需要安装依赖包后才能正常使用。*
...
| 应用名              | 描述         | 仓库地址                                                     |
| ------------------- | ------------ | ------------------------------------------------------------ |
| lingmo-draw         | 深度画板应用 | https://github.com/lingmoos/lingmo-draw<br />(https://gitee.com/lingmo-community/lingmo-draw.git) |
| lingmo-image-viewer | 深度看图应用 | https://github.com/lingmoos/lingmo-image-viewer<br />(https://gitee.com/lingmo-community/lingmo-image-viewer.git) |
| lingmo-album        | 深度相册应用 | https://github.com/lingmoos/lingmo-album<br />(https://gitee.com/lingmo-community/lingmo-album.git) |

## 帮助

- [官方论坛](https://bbs.lingmo.org/) 
- [用户使用手册](https://wiki.lingmo.org/zh/05_HOW-TO/02_%E5%BC%80%E5%8F%91%E7%9B%B8%E5%85%B3/lingmo-unioncode)
- [扩展指南](./docs/extended-guide.md)
- [开发者中心](https://github.com/lingmoos/developer-center) 
- [Gitter](https://gitter.im/orgs/lingmoos/rooms)
- [聊天室](https://webchat.freenode.net/?channels=lingmo)
...
lingmo-unioncode 在 [GPL-3.0-or-later](LICENSE)下发布。
