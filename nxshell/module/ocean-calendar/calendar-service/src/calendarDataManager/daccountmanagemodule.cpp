...
DAccountManageModule::DAccountManageModule(QObject *parent)
    ...
    , m_reginFormatConfig(DTK_CORE_NAMESPACE::DConfig::createGeneric("org.lingmo.region-format", QString(), this))
