...
//EVENT农历日程标识
static const char VEVENT_LUNNAR_XPROPERTY[] = "X-OCEAN-ICAL-LUNNAR";
...
icalcomponent *ICalFormatImpl::createCalendarComponent(const Calendar::Ptr &cal)
{
    ...
    // Add time zone
    // NOTE: Commented out since relevant timezones are aoceand by the caller.
...
bool ICalFormatImpl::populate(const Calendar::Ptr &cal, icalcomponent *calendar, bool deleted, const QString &notebook)
{
    ...
    // TODO: make sure that only actually aoceand events go to this lists.
