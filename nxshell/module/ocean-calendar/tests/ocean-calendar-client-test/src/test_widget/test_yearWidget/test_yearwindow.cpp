...
{
    CalendarGlobalEnv::getGlobalEnv()->registerKey(OCEANCalendar::CursorPointKey, QPoint(20, 20));
...
{
    CalendarGlobalEnv::getGlobalEnv()->reviseValue(OCEANCalendar::CursorPointKey, QPoint(20, 20));
