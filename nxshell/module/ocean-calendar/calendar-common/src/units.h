...
const QString serviceBaseName = "com.lingmo.dataserver.Calendar";
const QString serviceBasePath = "/com/lingmo/dataserver/Calendar";
#define accountServiceInterface "com.lingmo.dataserver.Calendar.Account"
