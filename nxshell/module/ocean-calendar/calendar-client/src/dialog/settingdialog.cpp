...
const QString ControlCenterDBusName = "org.lingmo.ocean.ControlCenter1";
const QString ControlCenterDBusPath = "/org/lingmo/ocean/ControlCenter1";
...
QPair<QWidget *, QWidget *> CSettingDialog::createSyncTagRadioButton(QObject *obj)
{
    ...
    if (DAccount::Account_Calendar == type)
        iconLabel->setPixmap(DIcon::loadNxPixmap(":/icons/lingmo/builtin/icons/ocean_calendar_sync_schedule_32px.svg"));
    if (DAccount::Account_Setting == type)
        iconLabel->setPixmap(DIcon::loadNxPixmap(":/icons/lingmo/builtin/icons/ocean_calendar_sync_setting_32px.svg"));
...
QWidget *CSettingDialog::createControlCenterLink(QObject *obj)
{
    ...
    connect(myLabel, &DLabel::linkActivated, this, [this]{
        qCDebug(ClientLogger) << "open lingmo control center";
