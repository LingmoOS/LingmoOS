...
void CDayHuangLiLabel::paintEvent(QPaintEvent *e)
{
    ...
    QPixmap pixmap;
    if (m_type == 0)
        pixmap = DIcon::loadNxPixmap(":/icons/lingmo/builtin/icons/ocean_calendar_yi_32px.svg");
    else {
        pixmap = DIcon::loadNxPixmap(":/icons/lingmo/builtin/icons/ocean_calendar_ji_32px.svg");
    }
