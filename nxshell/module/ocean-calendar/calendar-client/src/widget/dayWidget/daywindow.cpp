...
void CDayWindow::initUI()
{
    ...
    m_YearLabel->setMinimumHeight(OCEANDayCalendar::D_YLabelHeight);
    QFont labelF;
    labelF.setWeight(QFont::Medium);
    labelF.setPixelSize(OCEANCalendar::FontSizeTwentyfour);
    ...
    m_LunarLabel->setFixedHeight(OCEANDayCalendar::D_YLabelHeight);
    labelF.setPixelSize(OCEANCalendar::FontSizeFourteen);
    ...
    labelF.setPixelSize(OCEANCalendar::FontSizeTen);
    m_SolarDay->setFixedHeight(OCEANDayCalendar::D_YLabelHeight);
