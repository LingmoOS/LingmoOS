...
void CMonthWindow::initUI()
{
    ...
    m_today->setText(QCoreApplication::translate("today", "Today", "Today"));
    m_today->setFixedSize(OCEANMonthCalendar::MTodayWindth, OCEANMonthCalendar::MTodayHeight);
    ...
    m_YearLabel->setFixedHeight(OCEANMonthCalendar::M_YLabelHeight);
    ...
    yLabelF.setPixelSize(OCEANCalendar::FontSizeTwentyfour);
