...
void SidebarAccountItemWidget::initView()
{
    ...
    m_syncIconButton->setIcon(QIcon(":/icons/lingmo/builtin/icons/icon_refresh.svg"));
    ...
    m_warningLabel->setPixmap(QIcon(":/icons/lingmo/builtin/icons/ocean_calendar_warning_light_32px.svg").pixmap(18, 18));
