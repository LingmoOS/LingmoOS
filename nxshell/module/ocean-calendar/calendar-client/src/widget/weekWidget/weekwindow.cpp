...
void CWeekWindow::initUI()
{
    ...
    m_today->setFixedSize(OCEANWeekCalendar::WTodayWindth, OCEANWeekCalendar::WTodayHeight);
    ...
    m_YearLabel->setFixedHeight(OCEANWeekCalendar::W_YLabelHeight);
    ...
    m_YearLunarLabel->setFixedSize(OCEANWeekCalendar::W_YLunatLabelWindth, OCEANWeekCalendar::W_YLunatLabelHeight);

    m_weekview  = new CWeekView(&CalendarManager::getWeekNumOfYear, this);

    m_weekLabel = new QLabel();
    m_weekLabel->setFixedHeight(OCEANWeekCalendar::W_YLabelHeight);
    QFont weeklabelF;
    weeklabelF.setWeight(QFont::Medium);
    weeklabelF.setPixelSize(OCEANCalendar::FontSizeFourteen);
    ...
    top->setFixedHeight(OCEANMonthCalendar::M_YTopHeight);
