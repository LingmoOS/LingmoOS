...
QAccessibleInterface *accessibleFactory(const QString &classname, QObject *object)
{
    ...
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CYearWindow);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CMonthWindow);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CWeekWindow);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CDayWindow);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ScheduleRemindWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CAllDayEventWeekView);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CMonthGraphicsview);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CGraphicsView);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CustomFrame);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), AnimationStackedWidget);
