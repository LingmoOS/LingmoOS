    ...
    : QWidget(parent)
{
    ...
    viewfont.setPixelSize(OCEANCalendar::FontSizeFourteen);
    ...
    m_buttonBox->setId(m_yearButton, OCEANCalendar::CalendarYearWindow);
    m_buttonBox->setId(m_monthButton, OCEANCalendar::CalendarMonthWindow);
    m_buttonBox->setId(m_weekButton, OCEANCalendar::CalendarWeekWindow);
    m_buttonBox->setId(m_dayButton, OCEANCalendar::CalendarDayWindow);
...
{
    m_sidebarIcon->setIcon(QIcon::fromTheme("ocean_calendar_sidebar"));
}
