...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到日历图标 ![draw](../common/ocean_calendar.svg)，单击运行。
3. 右键单击 ![draw](../common/ocean_calendar.svg) ，您可以：
...
- 在任务栏右键单击 ![draw](../common/ocean_calendar.svg) ，选择 **关闭所有**，退出日历。
...
> ![notes](../common/notes.svg) 说明：该功能暂不对老版本UOS系统和lingmo系统开放。
