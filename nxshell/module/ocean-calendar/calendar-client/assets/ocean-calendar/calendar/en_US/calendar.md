...
1.  Click ![lingmo_launcher](../common/lingmo_launcher.svg) in the Dock to enter the Launcher interface.
2.  Locate ![draw](../common/ocean_calendar.svg) by scrolling the mouse wheel or searching for "Calendar" on the Launcher interface and click it to run.
3.  Right-click ![draw](../common/ocean_calendar.svg), you can:
...
- Right-click ![draw](../common/ocean_calendar.svg) in the Dock and select **Close All** to exit.
...
> ![notes](../common/notes.svg) Notes: It is not available in old system versions and lingmo system at present.
