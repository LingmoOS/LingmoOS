...
ocean-clipboard is a beautifully designed and simple clipboard management component developed by Lingmo Technology.
...
```bash
sudo apt build-dep ocean-clipboard
```
...
## License
ocean-clipboard is licensed under [GPL-3.0-or-later](LICENSE).