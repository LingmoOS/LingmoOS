...
#define MONITOR_SERVICE "org.lingmo.ocean.XEventMonitor1"

const QString AppearanceService = QStringLiteral("org.lingmo.ocean.Appearance1");
const QString AppearancePath = QStringLiteral("/org/lingmo/ocean/Appearance1");
const QString AppearanceInterface = QStringLiteral("org.lingmo.ocean.Appearance1");
...
MainWindow::MainWindow(QWidget *parent)
    ...
    , m_displayInter(new DBusDisplay("org.lingmo.ocean.Display1", "/org/lingmo/ocean/Display1", QDBusConnection::sessionBus(), this))
    , m_daemonDockInter(new DBusDaemonDock("org.lingmo.ocean.daemon.Dock1", "/org/lingmo/ocean/daemon/Dock1", QDBusConnection::sessionBus(), this))
...
void MainWindow::initUI()
{
    ...
    // When exclusion zone is set to 0, OCEAN Dock will not occupy the space before clipboard (works like -1 in Wayland)
