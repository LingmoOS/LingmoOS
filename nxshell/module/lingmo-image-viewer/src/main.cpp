...
int main(int argc, char *argv[])
{
    ...
    // @uri org.lingmo.image.viewer
    const QString uri("org.lingmo.image.viewer");
    ...
    QDBusConnection::sessionBus().registerService("com.lingmo.imageViewer");
