# Image Viewer|lingmo-image-viewer|
...
2. Locate Image Viewer ![viewer](../common/lingmo_image_viewer.svg) by scrolling the mouse wheel or searching "image viewer" in the Launcher interface.
3. Right-click ![viewer](../common/lingmo_image_viewer.svg) and the user can:
...
- Right-click ![viewer](../common/lingmo_image_viewer.svg) in the Dock and select **Close All** to exit Image Viewer.
...
> ![tips](../common/tips.svg) Tips: In Control Center, you can set Image Viewer as the default image viewer. Please refer to [Default Applications](dman:///ocean#Default Applications) for specific operations.
