...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到看图图标 ![viewer](../common/lingmo_image_viewer.svg)，单击运行。
3. 右键单击 ![viewer](../common/lingmo_image_viewer.svg)，您可以：
 - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 在任务栏右键单击 ![viewer](../common/lingmo_image_viewer.svg)，选择 **关闭所有** ，退出看图。
...
> ![tips](../common/tips.svg) 窍门：您可以在控制中心中将看图设置为默认的图片查看程序，具体操作请参阅 [默认程序设置](dman:///ocean#默认程序设置)。
