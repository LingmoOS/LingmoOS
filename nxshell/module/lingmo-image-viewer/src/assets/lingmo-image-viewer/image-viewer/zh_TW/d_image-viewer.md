...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到看圖 ![viewer](../common/lingmo_image_viewer.svg)單擊執行。
...
- 在任務欄右鍵單擊 ![viewer](../common/lingmo_image_viewer.svg)，選擇 **全部關閉** 關閉看圖。
...
> ![tips](../common/tips.svg)竅門：您可以在控制中心中將看圖設定為預設的圖片檢視程式，具體操作請參閱 [預設程式設定](dman:///ocean#預設程式設定)。
