...
DWindow {
    ...
    function updateSimpleEntries(feedbackType, reportTitle, email, helpLingmo){
    ...
    function getJsonData(){
        var jsonObj = {
            "method": "Lingmo.Feedback.putFeedback",
            "version": "1.1",
            "params": {
    ...
    DataSender {
        ...
        onPostFinish: {
            ...
            adjunctPanel.clearAllAdjunct()
            mainWindow.close()
            dataSender.showSuccessNotification(dsTr("Lingmo User Feedback")
    ...
    Connections {
        ...
        onUploadFailed:{
            ...
            if (isBackendGenerateResult(filePath)) {
                ...
                dataSender.showErrorNotification(dsTr("Lingmo User Feedback")
                                                 ,dsTr("Failed to send your feedback, resend?")
                                                 ,dsTr("Resend"))
            }
        }
    ...
    Rectangle {
        ...
        Row {
            ...
            TextButton {
                ...
                onClicked: {
                    //for lingmo-feedback-web,not collect sys info
