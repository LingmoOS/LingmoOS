...
import Lingmo.Locale 1.0
import Lingmo.Widgets 1.0
import DBus.Com.Lingmo.Daemon.Display 1.0
import DBus.Com.Lingmo.Daemon.Search 1.0
import DBus.Com.Lingmo.Feedback 1.0
...
QtObject {
    ...
    function setSimpleEntries(_feedbackType,_reportTitle,_email,_helpLingmo){
        mainWindow.updateSimpleEntries(_feedbackType,_reportTitle,_email,_helpLingmo)
    }
