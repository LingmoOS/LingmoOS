...
#define DBUS_NAME "com.lingmo.ocean.UserFeedback"
#define DBUS_PATH "/com/lingmo/ocean/UserFeedback"
...
struct Draft{
    ...
    Draft(DataConverter::FeedbackType _feedbackType = DataConverter::DFeedback_Bug,
          ...
          QString _content = "",
          QString _email = "",
          bool _helpLingmo = true,
          QStringList _adjunctPathList = QStringList())
        :feedbackType(_feedbackType),title(_title),content(_content),email(_email),helpLingmo(_helpLingmo),adjunctPathList(_adjunctPathList){}
};
