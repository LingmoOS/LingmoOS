...
const QString DRAFT_SAVE_PATH_NARMAL = QDir::homePath() + "/.cache/lingmo-feedback/draft/";
...
const QString EMAILS_LIST_FILE_NAME = QDir::homePath() + "/.cache/lingmo-feedback/emails.json";
