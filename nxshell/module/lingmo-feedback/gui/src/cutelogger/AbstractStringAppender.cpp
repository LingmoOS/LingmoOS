 ...
 * internally). For example, \c "%{type:-7}" will be replaced with the left paoceand debug level of the message
...
//! Strips the long function signature (as aoceand by Q_FUNC_INFO macro)
/**
