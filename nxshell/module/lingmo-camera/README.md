...
Lingmo camera is Lingmo Desktop Environment Camera Software.
...
When install complete, the executable binary file is placed into `/usr/bin/lingmo-camera`.
...
lingmo-camera is licensed under [GPL-3.0-or-later](LICENSE).



## Include Third Libraries Source Codes

Lingmo Camera  is based on Guvcview which is a excellent software uses USB-camera to take photos & videos.
