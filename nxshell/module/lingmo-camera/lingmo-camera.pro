...
isEmpty(DSRDIR):DSRDIR=/usr/share/lingmo-camera
isEmpty(PREFIX){
    PREFIX = /usr
}
...
icon_files.files = $$PWD/src/assets/lingmo-camera.svg

desktop.path = $$INSTROOT$$APPDIR
desktop.files = $$PWD/src/lingmo-camera.desktop

manual_dir.files = $$PWD/src/assets/lingmo-camera
manual_dir.path=/usr/share/lingmo-manual/manual-assets/application/

dbus_service.files = $$PWD/src/com.lingmo.Camera.service
...
translations.path = $$PREFIX/share/lingmo-camera/translations
