...
#include "src/accessibility/ac-lingmo-camera-define.h"
...
int main(int argc, char *argv[])
{
    ...
    qApp->setWindowIcon(QIcon(":/images/logo/lingmo-camera-96px.svg"));
    //a.setProductIcon(QIcon::fromTheme("lingmo-camera"));
    qApp->setProductIcon(QIcon(":/images/logo/lingmo-camera-96px.svg")); //用于显示关于窗口的应用图标
    ...
    //仅允许打开一个相机，设置共享内存段
    QSharedMemory shared_memory("lingmocamera");
