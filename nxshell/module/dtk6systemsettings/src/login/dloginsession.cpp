    ...
    , d_ptr(new DLoginSessionPrivate(this))
{
    ...
    const QString &StartManagerService = QStringLiteral("com.lingmo.FakeSessionManager");
    const QString &StartManagerPath = QStringLiteral("/com/lingmo/FakeStartManager");
    const QString &SessionManagerService = StartManagerService;
    const QString &SessionManagerPath = QStringLiteral("/com/lingmo/FakeSessionManager");
#else
    const QString &Service = QStringLiteral("org.freedesktop.login1");
    QDBusConnection connection = QDBusConnection::systemBus();
    const QString &StartManagerService = QStringLiteral("com.lingmo.SessionManager");
    const QString &StartManagerPath = QStringLiteral("/com/lingmo/StartManager");
    const QString &SessionManagerService = StartManagerService;
    ...
    connect(d->m_startManagerInter,
            ...
            [=](const QString &status, const QString &name) {
                if (status == "aoceand") {
                    Q_EMIT this->autostartAoceand(name);
