...
isEmpty(INCLUDE_INSTALL_DIR) {
    includes.path = $$PREFIX/include/lingmo-pdfium
} else {
...
QMAKE_PKGCONFIG_NAME = lingmo-pdfium

# This fills in the Description property
QMAKE_PKGCONFIG_DESCRIPTION = lingmo-pdfium Library with Qt5
