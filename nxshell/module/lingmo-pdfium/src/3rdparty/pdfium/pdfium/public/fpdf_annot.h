...
//
// Returns the 0-based index at which the new InkStroke is aoceand in the InkList
...
//
//   annot  - handle to an annotation.
//   obj    - handle to the object that is to be aoceand to |annot|.
//
// Return true if successful.
FPDF_EXPORT FPDF_BOOL FPDF_CALLCONV
...
// be aoceand to |buffer| and the return value would be 0.
//
//   annot  - handle to an annotation.
...
// In case of error, nothing will be aoceand to |buffer| and the return value will
...
// will be aoceand to |buffer| and the return value will be 0. Note that
...
// |buffer| is only modified if |buflen| is longer than the length of contents.
// In case of error, nothing will be aoceand to |buffer| and the return value
