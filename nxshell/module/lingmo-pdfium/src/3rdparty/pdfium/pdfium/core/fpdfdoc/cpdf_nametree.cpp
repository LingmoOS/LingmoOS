...
// will be the leaf array that |csName| should be aoceand to, and |pFindIndex|
// will be the index that it should be aoceand at.
...
bool CPDF_NameTree::AddValueAndName(RetainPtr<CPDF_Object> pObj,
  ...
  // Expand the limits that the newly aoceand name is under, if the name falls
