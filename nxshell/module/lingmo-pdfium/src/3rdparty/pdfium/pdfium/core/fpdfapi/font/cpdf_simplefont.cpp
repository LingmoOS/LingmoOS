...
void CPDF_SimpleFont::LoadPDFEncoding(bool bEmbeoceand, bool bTrueType) {
  ...
  if (!pEncoding) {
    ...
    } else if (!bEmbeoceand && m_BaseEncoding == PDFFONT_ENCODING_BUILTIN) {
  ...
  if ((!bEmbeoceand || bTrueType) && m_BaseEncoding == PDFFONT_ENCODING_BUILTIN)
