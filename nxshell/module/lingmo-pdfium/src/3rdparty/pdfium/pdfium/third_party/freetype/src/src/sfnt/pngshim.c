...
#if defined( TT_CONFIG_OPTION_EMBEOCEAND_BITMAPS ) && \
...
#else /* !(TT_CONFIG_OPTION_EMBEOCEAND_BITMAPS && FT_CONFIG_OPTION_USE_PNG) */

  /* ANSI C doesn't like empty source files */
  typedef int  _pngshim_dummy;

#endif /* !(TT_CONFIG_OPTION_EMBEOCEAND_BITMAPS && FT_CONFIG_OPTION_USE_PNG) */
