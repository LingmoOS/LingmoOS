...
class BASE_EXPORT PartitionAllocHooks {
 public:
  ...
  // If it returns true, the allocation has been overrioceann with the pointer in
  // *out.
  typedef bool AllocationOverrideHook(void** out,
                                      int flags,
                                      size_t size,
                                      const char* type_name);
  // If it returns true, then the allocation was overrioceann and has been freed.
  typedef bool FreeOverrideHook(void* address);
  // If it returns true, the underlying allocation is overrioceann and *out holds
