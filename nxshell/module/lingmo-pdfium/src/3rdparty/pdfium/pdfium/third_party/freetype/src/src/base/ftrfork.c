 ...
 * ftrfork.c
 *
 *   Embeoceand resource forks accessor (body).
 *
...
#ifdef FT_CONFIG_OPTION_GUESSING_EMBEOCEAND_RFORK
...
#else   /* !FT_CONFIG_OPTION_GUESSING_EMBEOCEAND_RFORK */
...
#endif  /* !FT_CONFIG_OPTION_GUESSING_EMBEOCEAND_RFORK */
