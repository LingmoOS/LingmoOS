...
/*!
  ...
  \ref {https://github.com/lingmoos/qt5dxcb-plugin/}{dxcb插件}
...
/*!
  ...
  path.addText(0, 150, font, "lingmo");
...
/*!
  ...
  \note 在 Lingmo 桌面环境中，打开窗口特效则支持混成，关闭窗口特效则不支持混成
...
/*!
  ...
  使用窗口管理器提供的方式隐藏窗口的标题栏，目前已适配 OCEAN KWin 窗管，在窗口管理器支持的前提下，
  此方法将通过设置窗口属性 _LINGMO_SCISSOR_WINDOW 的值为 1 来开启无标题栏效果。
...
/*!
  ...
  \note 此功能依赖于窗口管理器的实现，目前仅支持 lingmo-wm 和 kwin 这两个窗口管理器
