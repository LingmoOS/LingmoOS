...
QString DIconTheme::findDciIconFile(const QString &iconName, const QString &themeName)
{
    ...
    // name. eg: "org.lingmo.app/accounts", hypothesis the icon search path is "/usr/share/dsg/icons" and
    // icon theme name is "theme_name", then the icon files list for find is:
    // "/usr/share/dsg/icons/theme_name/org.lingmo.app/accounts.dci"
    // "qrc:/dsg/icons/theme_name/org.lingmo.app/accounts.dci" // fallback to the qrc directory
