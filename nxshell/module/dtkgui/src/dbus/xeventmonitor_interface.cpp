...
//    qRegisterMetaType<AreaList>("AreaList");
    qDBusRegisterMetaType<ComLingmoApiXEventMonitorInterface::AreaList>();
}
Q_CONSTRUCTOR_FUNCTION(registerAreaListMetaType);

QDBusArgument &operator<<(QDBusArgument &a, const ComLingmoApiXEventMonitorInterface::AreaList &rects)
{
...
const QDBusArgument &operator>>(const QDBusArgument &a, ComLingmoApiXEventMonitorInterface::AreaList &rects)
{
    a.beginArray();
    rects.clear();
...
ComLingmoApiXEventMonitorInterface::ComLingmoApiXEventMonitorInterface(const QString &service, const QString &path,
...
ComLingmoApiXEventMonitorInterface::~ComLingmoApiXEventMonitorInterface()
{
}
