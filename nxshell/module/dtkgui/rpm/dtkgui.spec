...
Version:        5.5.17
Release:        1%{?dist}
Summary:        Lingmo dtkgui
License:        LGPLv3+
URL:            https://github.com/lingmoos/dtkgui
...
BuildRequires:  make
%description
Dtkgui is the GUI module for OCEAN look and feel.
...
%{_libexecdir}/dtk5/lingmo-gui-settings
%{_libexecdir}/dtk5/taskbar
%{_libexecdir}/dtk5/ocean-kwin-debug
