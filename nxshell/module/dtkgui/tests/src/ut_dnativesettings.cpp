...
{
    ASSERT_EQ(settings->getSetting("Net/ThemeName").toString(), "lingmo");
    settings->setSetting("Net/ThemeName", "lingmo-themeName");
    ASSERT_EQ(settings->getSetting("Net/ThemeName").toString(), "lingmo-themeName");
}
