...
void PluginManager::load()
{
    ...
    QStringList pluginsDirs = QProcessEnvironment::systemEnvironment().value("OCEAN_POLKIT_AGENT_PLUGINS_DIRS").split(QDir::listSeparator(), Qt::SkipEmptyParts);
    pluginsDirs.append("/usr/lib/polkit-1-ocean/plugins/");
