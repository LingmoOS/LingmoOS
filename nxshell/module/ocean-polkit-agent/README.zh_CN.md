...
OCEAN Polkit Agent 是 [polkit](https://www.freedesktop.org/software/polkit/docs/latest/polkit.8.html) 在深度桌面环境上的代理。
...
## 开源许可证
OCEAN Polkit Agent 在 [GPL-3.0-or-later](LICENSE) 下发布。
