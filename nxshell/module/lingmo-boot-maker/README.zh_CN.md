...
“启动盘制作工具”是一款帮助用户快速轻松创建可启动u盘的工具，它的设计是支持Lingmo安装iso，但它也适用于所有ubuntu live安装iso。

![screenshot](https://raw.githubusercontent.com/lingmoos/lingmo-boot-maker/master/docs/lingmo-boot-maker.png)
...
目前唯一的二进制版本来自Lingmo系统iso。iso文件下载路径: https://www.lingmo.org/original/lingmo-boot-maker/ 或者你可以在iso的根目录下找到二进制文件。

- 仓库安装

如果你是lingmo用户，你可以从仓库安装“启动盘制作工具”:

```bash
sudo apt-get install lingmo-boot-maker
```
