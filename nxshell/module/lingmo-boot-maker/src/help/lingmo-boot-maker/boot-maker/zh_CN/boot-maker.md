...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到启动盘制作工具图标![lingmo_boot_maker](../common/lingmo_boot_maker.svg) ，单击运行。
3. 右键单击 ![lingmo_boot_maker](../common/lingmo_boot_maker.svg)  ，您可以：
 - 单击 **发送到桌面**，在桌面创建快捷方式。
...
### 关闭启动盘制作工具
   ...
   - 在任务栏右键单击 ![lingmo_boot_maker](../common/lingmo_boot_maker.svg) ，选择 **关闭所有** 来退出启动盘制作工具。
