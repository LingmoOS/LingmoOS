...
2. Locate ![lingmo_boot_maker](../common/lingmo_boot_maker.svg) by scrolling the mouse wheel or searching "Boot Maker" in the Launcher interface and click it to run. 

3. Right-click![lingmo_boot_maker](../common/lingmo_boot_maker.svg) to:
...
- Right-click ![lingmo_boot_maker](../common/lingmo_boot_maker.svg)  on the Dock, select **Close all** to exit.
