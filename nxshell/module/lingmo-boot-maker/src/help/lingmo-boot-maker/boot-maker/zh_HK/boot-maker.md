...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到啟動盤製作工具圖標![lingmo_boot_maker](../common/lingmo_boot_maker.svg) ，單擊運行。
3. 右鍵單擊 ![lingmo_boot_maker](../common/lingmo_boot_maker.svg)  ，您可以：
 - 單擊 **發送到桌面**，在桌面創建快捷方式。
...
### 關閉啟動盤製作工具
   ...
   - 在任務欄右鍵單擊 ![lingmo_boot_maker](../common/lingmo_boot_maker.svg) ，選擇 **關閉所有** 來退出啟動盤製作工具。
