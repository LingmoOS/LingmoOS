...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到「開機碟製作器」按鈕 ![lingmo_boot_maker](../common/lingmo_boot_maker.svg)，單擊開啟。
...
- 在任務欄右鍵單擊 ![lingmo_boot_maker](../common/lingmo_boot_maker.svg)，選擇 **關閉所有** 來關閉開機碟製作器。
