...
binary.files = $${OUT_PWD}/lingmo-boot-maker

desktop.path = $${PREFIX}/share/applications
desktop.files = $$PWD/platform/linux/lingmo-boot-maker.desktop

hicolor.path =  $${PREFIX}/share/icons/hicolor/scalable/apps
hicolor.files = $$PWD/view/resource/theme/light/image/lingmo-boot-maker.svg
...
#    QMAKE_LFLAGS += /MANIFESTUAC:\"level=\'requireAdministrator\' uiAccess=\'false\'\"
    RC_FILE += $$PWD/platform/windows/lingmo-boot-maker.rc
}

mac* {
    CONFIG += app_bundle

    ICON = $$PWD/platform/mac/lingmo-boot-maker.icns
    ...
    QMAKE_POST_LINK = macdeployqt lingmo-boot-maker.app/ -libpath=/Users/lingmo/Development/ci/usr/lib
}
