    ...
    : BMWindowBaseClass(parent), d_ptr(new BMWindowPrivate(this))
{
    ...
    QString acknowledgementLink = "https://www.lingmo.org/acknowledgments/lingmo-boot-maker#thanks";
    qApp->setProductName(tr("Boot Maker"));
    qApp->setApplicationAcknowledgementPage(acknowledgementLink);
//    qApp->setProductIcon(QIcon(":/theme/light/image/lingmo-boot-maker.svg"));
    qApp->setProductIcon(QIcon::fromTheme("lingmo-boot-maker"));
    ...
    title->setTitle("");
    title->setIcon(QIcon::fromTheme("lingmo-boot-maker")/*QIcon(":/theme/light/image/lingmo-boot-maker.svg")*/);
