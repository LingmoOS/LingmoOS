...
const QString s_PolkitActionCreate = "com.lingmo.bootmaker.create";
const QString s_PolkitActionReboot = "com.lingmo.bootmaker.reboot";

/**
   @brief Polkit action authorization check.
        Use com.lingmo.bootmaker.policy config file.
        Default action id: "com.lingmo.bootmaker"
...
bool BootMakerServicePrivate::checkCaller()
{
    ...
    QString dbmExe = QStandardPaths::findExecutable("lingmo-boot-maker", {"/usr/bin"});
