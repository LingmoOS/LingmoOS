...
static constexpr char kConfName[] = "org.lingmo.ocean.file-manager.desktop.videowallpaper";
    ...
    , d(new WallpaperConfigPrivate(this))
{
    ...
    d->settings = DConfig::create("org.lingmo.ocean.file-manager", kConfName, "", this);
    if (!d->settings)
