...
bool updateAnnotation_stub(int, lingmo_reader::Annotation *, const QString &, const QColor &)
{
    g_funcName = __FUNCTION__;
    return true;
}
...
QList<lingmo_reader::Word> getWords_stub(int)
{
    Word w1("test", QRectF(0, 0, 20, 10));
    Word w2("test", QRectF(20, 0, 40, 10));
    QList<lingmo_reader::Word> words{w1, w2};
    return words;
}
...
bool removeAnnotation_stub(int, lingmo_reader::Annotation *)
{
    return true;
}
