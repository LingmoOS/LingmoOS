...
/***********桩函数**********/
PDFDocument *loadpdfDocument_stub(const QString &, const QString &, lingmo_reader::Document::Error &error)
{
    error = Document::FileError;
    return nullptr;
}

DjVuDocument *loaddjvuDocument_stub(const QString &, lingmo_reader::Document::Error &error)
{
    error = Document::FileError;
    return nullptr;
}
...
TEST(UT_DocumentFactory_getDocument, UT_DocumentFactory_getDocument_001)
{
    ...
    lingmo_reader::Document *pdocument = nullptr;
...
TEST(UT_DocumentFactory_getDocument, UT_DocumentFactory_getDocument_002)
{
    ...
    QString password;
    QProcess **pprocess = nullptr;
    lingmo_reader::Document::Error error = Document::NoError;
    lingmo_reader::Document *pdocument = nullptr;
