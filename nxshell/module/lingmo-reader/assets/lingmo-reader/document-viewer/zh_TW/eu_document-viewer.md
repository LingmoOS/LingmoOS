...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到文件查看器 ![lingmo_reader_24](../common/lingmo_reader_24.svg)單擊執行。
...
- 在任務欄右鍵單擊 ![lingmo_reader_24](../common/lingmo_reader_24.svg)，選擇 **全部關閉** 來關閉文件查看器。
...
文件查看器支援查看PDF和DJVU格式的文件，您可以採用以下方式開啟文件。
