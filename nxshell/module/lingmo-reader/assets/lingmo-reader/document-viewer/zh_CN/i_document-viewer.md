...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到文档查看器图标 ![lingmo_reader_24](../common/lingmo_reader_24.svg)，单击运行。
3. 右键单击 ![lingmo_reader_24](../common/lingmo_reader_24.svg)，您可以：
...
- 在任务栏右键单击 ![lingmo_reader_24](../common/lingmo_reader_24.svg)，选择 **关闭所有**，退出文档查看器。
...
在主菜单中，您可以新建窗口、新建标签页、保存文件、[搜索文件](#搜索)、切换窗口主题、查看帮助手册、了解文档查看器的更多信息。
