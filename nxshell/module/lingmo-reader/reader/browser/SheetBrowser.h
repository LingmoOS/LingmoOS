...
public:
     ...
     * @param index 哪一页
     */
    void jumpToHighLight(lingmo_reader::Annotation *annotation, const int index);
     ...
     * @return 注释列表
     */
    QList< lingmo_reader::Annotation * > annotations();
     ...
     * @return 操作状态
     */
    bool removeAnnotation(lingmo_reader::Annotation *annotation);
     ...
     * @return 是否更新成功
     */
    bool updateAnnotation(lingmo_reader::Annotation *annotation, const QString &text, QColor color = QColor());
     ...
     * @param point 显示位置
     */
    void showNoteEditWidget(lingmo_reader::Annotation *annotation, const QPoint &point);
     ...
     * @param rects
     */
    void handleSearchResultComming(const lingmo_reader::SearchResult &res);
...
signals:
    ...
    void sigOperaAnnotation(int type, int index, lingmo_reader::Annotation *annotation);
...
private slots:
     ...
     * @param tips 是否显示提示框
     */
    void onRemoveAnnotation(lingmo_reader::Annotation *annotation, bool tips);
     ...
     * @param text 注释内容
     */
    void onUpdateAnnotation(lingmo_reader::Annotation *annotation, const QString &text);
...
private:
    ...
    lingmo_reader::Annotation *m_iconAnnot = nullptr; // 当前选中的图标注释
