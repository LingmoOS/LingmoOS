...
signals:
    ...
    void sigDocPageWordTaskFinished(DocPageWordTask, QList<lingmo_reader::Word>);

    void sigDocPageAnnotationTaskFinished(DocPageAnnotationTask, QList<lingmo_reader::Annotation *>);

    void sigDocPageThumbnailTaskFinished(DocPageThumbnailTask, QPixmap);

    void sigDocOpenTask(DocOpenTask, lingmo_reader::Document::Error, lingmo_reader::Document *, QList<lingmo_reader::Page *>);
...
private slots:
    ...
    void onDocPageWordTaskFinished(DocPageWordTask task, QList<lingmo_reader::Word> words);

    void onDocPageAnnotationTaskFinished(DocPageAnnotationTask task, QList<lingmo_reader::Annotation *> annots);

    void onDocPageThumbnailTask(DocPageThumbnailTask task, QPixmap pixmap);

    void onDocOpenTask(DocOpenTask task, lingmo_reader::Document::Error error, lingmo_reader::Document *document, QList<lingmo_reader::Page *> pages);
