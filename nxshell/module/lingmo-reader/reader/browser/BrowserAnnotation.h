...
public:
    explicit BrowserAnnotation(QGraphicsItem *parent, QRectF rect, lingmo_reader::Annotation *annotation, qreal scalefactor);
     ...
     * @return
     */
    lingmo_reader::Annotation *annotation();
     ...
     * @return
     */
    bool isSame(lingmo_reader::Annotation *annotation);
...
private:
    lingmo_reader::Annotation *m_annotation;
