...
public:
     ...
     */
    bool updateAnnotation(lingmo_reader::Annotation *annotation, const QString &, const QColor &);
     ...
     */
    bool hasAnnotation(lingmo_reader::Annotation *annotation);
...
private:
    ...
    QList<BrowserAnnotation *> m_annotationItems;           //一个lingmo_reader::Annotation可能对应多个annotationItems
