...
QAccessibleInterface *accessibleFactory(const QString &classname, QObject *object)
{
    ...
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), Central);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CentralDocPage);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CentralNavPage);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DocSheet);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), DocTabBar);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), TitleWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), SheetSidebar);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), SheetBrowser);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), ThumbnailWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), CatalogWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), BookMarkWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), NotesWidget);
    USE_ACCESSIBLE(QString(classname).replace("oceanuiV20::", ""), SearchResWidget);
