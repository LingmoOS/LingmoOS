...
public:
     ...
     * @return 是否执行成功
     */
    bool removeAnnotation(lingmo_reader::Annotation *annotation, bool tips = true);
...
private slots:
     ...
     */
    void onSearchResultComming(const lingmo_reader::SearchResult &searchResult);
     ...
     * @param error
     */
    void onOpened(lingmo_reader::Document::Error error);
...
public:
     ...
     */
    void docBasicInfo(lingmo_reader::FileInfo &fileInfo);
...
signals:
     ...
     * @param error 错误
     */
    void sigFileOpened(DocSheet *sheet, lingmo_reader::Document::Error error);
...
private slots:
     ...
     */
    void onBrowserOperaAnnotation(int type, int index, lingmo_reader::Annotation *annotation);
