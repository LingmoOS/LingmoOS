    ...
    : DSplitter(parent), m_filePath(filePath), m_fileType(fileType)
{
    ...
    qRegisterMetaType<lingmo_reader::SearchResult>("lingmo_reader::SearchResult");
    ...
    connect(m_browser, SIGNAL(sigOperaAnnotation(int, int, lingmo_reader::Annotation *)), this, SLOT(onBrowserOperaAnnotation(int, int, lingmo_reader::Annotation *)));
...
lingmo_reader::Outline DocSheet::outline()
{
...
void DocSheet::jumpToHighLight(lingmo_reader::Annotation *annotation, const int index)
{
...
QList<lingmo_reader::Annotation *> DocSheet::annotations()
{
    if (nullptr == m_browser)
...
bool DocSheet::removeAnnotation(lingmo_reader::Annotation *annotation, bool tips)
{
...
void DocSheet::onOpened(lingmo_reader::Document::Error error)
{
    if (lingmo_reader::Document::NeedPassword == error) {
        showEncryPage();
    } else if (lingmo_reader::Document::WrongPassword == error) {
        showEncryPage();

        m_encryPage->wrongPassWordSlot();
    } else if (lingmo_reader::Document::NoError == error) {
...
void DocSheet::docBasicInfo(lingmo_reader::FileInfo &tFileInfo)
{
...
void DocSheet::onBrowserOperaAnnotation(int type, int index, lingmo_reader::Annotation *anno)
{
...
void DocSheet::onSearchResultComming(const lingmo_reader::SearchResult &res)
{
