...
desktop.files = $$PWD/lingmo-reader.desktop

icon.path = $$PREFIX/share/icons/hicolor/scalable/apps

icon.files = $$PWD/lingmo-reader.svg

manual.path = $$PREFIX/share/lingmo-manual/manual-assets/application
...
#translate
TRANSLATIONS += $$PWD/../translations/lingmo-reader.ts
