...
void SheetSidebar::handleSearchResultComming(const lingmo_reader::SearchResult &res)
{
...
void SheetSidebar::handleAnntationMsg(const int &msg, int index, lingmo_reader::Annotation *anno)
{
    if (m_notesWidget)
