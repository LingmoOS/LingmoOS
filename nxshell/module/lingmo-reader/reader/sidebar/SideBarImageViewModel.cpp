...
void SideBarImageViewModel::removeItemForAnno(lingmo_reader::Annotation *annotation)
{
...
int SideBarImageViewModel::findItemForAnno(lingmo_reader::Annotation *annotation)
{
