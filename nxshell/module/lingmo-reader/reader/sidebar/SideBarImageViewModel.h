...
typedef struct ImagePageInfo_t {
    ...
    lingmo_reader::Annotation *annotation = nullptr;
...
public:
     ...
     * @param annotation
     */
    void removeItemForAnno(lingmo_reader::Annotation *annotation);
     ...
     * @return
     */
    int findItemForAnno(lingmo_reader::Annotation *annotation);
