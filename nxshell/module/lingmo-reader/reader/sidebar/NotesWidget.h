...
public:
     ...
     * @param anno
     */
    void handleAnntationMsg(const int &, lingmo_reader::Annotation *anno);
...
private:
     ...
     * @param anno
     */
    void addNoteItem(lingmo_reader::Annotation *anno);
     ...
     * @param anno
     */
    void deleteNoteItem(lingmo_reader::Annotation *anno);
