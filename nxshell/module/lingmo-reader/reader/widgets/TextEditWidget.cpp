...
void TextEditWidget::setAnnotation(lingmo_reader::Annotation *annotation)
{
...
void TextEditWidget::hideEvent(QHideEvent *event)
{
    ...
    if (m_annotation->type() == lingmo_reader::Annotation::AText &&  sText.isEmpty() && !event->spontaneous()) {
