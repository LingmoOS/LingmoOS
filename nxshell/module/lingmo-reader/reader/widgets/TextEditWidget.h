...
signals:
     ...
     * @param tips
     */
    void sigRemoveAnnotation(lingmo_reader::Annotation *annotation, bool tips);
     ...
     * @param text
     */
    void sigUpdateAnnotation(lingmo_reader::Annotation *annotation, const QString &text);
...
public:
     ...
     * @param annotation
     */
    void setAnnotation(lingmo_reader::Annotation *annotation);
...
private:
    ...
    lingmo_reader::Annotation *m_annotation = nullptr;
