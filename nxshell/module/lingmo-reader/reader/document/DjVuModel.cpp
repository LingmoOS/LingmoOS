...
lingmo_reader::DjVuDocument *DjVuDocument::loadDocument(const QString &filePath, lingmo_reader::Document::Error &error)
{
    ddjvu_context_t *context = ddjvu_context_create("lingmo_reader");
