    ...
    : DApplication(argc, argv)
{
    ...
    setApplicationName("lingmo-reader");
    setOrganizationName("lingmo");
    //setWindowIcon(QIcon::fromTheme("lingmo-reader"));     //耗时40ms
    setApplicationVersion(DApplication::buildVersion(APP_VERSION));
    setApplicationAcknowledgementPage("https://www.lingmo.org/acknowledgments/lingmo_reader");
    ...
    setProductIcon(QIcon::fromTheme("lingmo-reader"));
}
