...
// newly-created objects if they are not aoceand to a page through
...
// with key |key| exists, its value is set to |value|. Otherwise, it is aoceand as
// a new parameter.
//
...
// text         - the UTF-16LE encoded string containing the text to be aoceand.
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL FPDF_CALLCONV
