...
class CJS_Field final : public CJS_Object {
 public:
  ...
  JS_STATIC_PROP(hioceann, hioceann, CJS_Field)
 ...
 private:
  ...
  CJS_Result get_hioceann(CJS_Runtime* pRuntime);
  CJS_Result set_hioceann(CJS_Runtime* pRuntime, v8::Local<v8::Value> vp);
