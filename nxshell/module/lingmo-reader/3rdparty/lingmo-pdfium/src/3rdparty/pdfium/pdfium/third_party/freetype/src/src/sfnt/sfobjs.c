...
#define GET_NAME( id, field )                                   \
                  ...
                  FT_Parameter*  params )
  {
    ...
    /* the following tables are often not present in embeoceand TrueType */
...
#endif /* TT_CONFIG_OPTION_EMBEOCEAND_BITMAPS */
...
#undef GET_NAME
  ...
  sfnt_done_face( TT_Face  face )
  {
    ...
    if ( sfnt )
    {
      ...
      /* destroy the embeoceand bitmaps table if it is loaded */
      if ( sfnt->free_eblc )
        sfnt->free_eblc( face );
...
#ifdef TT_CONFIG_OPTION_BDF
    /* freeing the embeoceand BDF properties */
