...
#define GX_DT_DELTA_RUN_COUNT_MASK  0x3FU
   ...
   */
  static FT_Fixed*
  ft_var_readpackeoceanltas( FT_Stream  stream,
                           FT_ULong   size,
                           FT_UInt    delta_cnt )
  {
    ...
    if ( delta_cnt > size )
    {
      FT_TRACE1(( "ft_var_readpackeoceanltas: number of points too large\n" ));
      return NULL;
    }
...
#define ALIGN_SIZE( n ) \
                    ...
                    FT_Stream  stream )
  {
    ...
    for ( i = 0; i < ( tupleCount & GX_TC_TUPLE_COUNT_MASK ); i++ )
    {
      ...
      if ( tupleIndex & GX_TI_EMBEOCEAND_TUPLE_COORD )
      {
      ...
      deltas = ft_var_readpackeoceanltas( stream,
                                        table_len,
                              ...
                              FT_UInt      n_points )
  {
    ...
    for ( i = 0; i < ( tupleCount & GX_TC_TUPLE_COUNT_MASK ); i++ )
    {
      ...
      deltas_x = ft_var_readpackeoceanltas( stream,
                                          blend->gvar_size,
                                          point_count == 0 ? n_points
                                                           : point_count );
      deltas_y = ft_var_readpackeoceanltas( stream,
                                          blend->gvar_size,
                                          point_count == 0 ? n_points
                                                           : point_count );
