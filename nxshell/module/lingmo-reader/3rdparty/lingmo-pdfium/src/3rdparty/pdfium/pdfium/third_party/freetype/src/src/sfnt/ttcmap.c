...
#define TT_NEXT_ULONG   FT_NEXT_ULONG
   ...
   *   aoceand to it (modulo 65536) to form a new glyph index.
   *
   ...
   * the segment, and the value of `idDelta' is aoceand to it.
   *
   *
  ...
  /*****      Area.                                                    *****/
  /*****                                                               *****/
  /***** The `is32' table embeoceand in the charmap indicates whether a  *****/
