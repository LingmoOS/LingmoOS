...
#define FT_COMPONENT  cffdriver
                         ...
                         PS_FontExtraRec*  afont_extra )
  {
    ...
    if ( cff && cff->font_extra == NULL )
    {
      ...
      FT_Memory         memory     = face->root.memory;
      FT_String*        embeoceand_postscript;
      ...
      embeoceand_postscript = cff_index_get_sid_string(
                              cff,
                              dict->embeoceand_postscript );
      if ( embeoceand_postscript )
      {
        ...
        if ( ( start_fstype = ft_strstr( embeoceand_postscript,
                                         "/FSType" ) ) != NULL    &&
