...
static const QString ActionEnableAutoLogin = "org.lingmo.ocean.accounts.enable-auto-login";
static const QString ActionDisableAutoLogin = "org.lingmo.ocean.accounts.disable-auto-login";
static const QString ActionEnableNopassLogin = "org.lingmo.ocean.accounts.enable-nopass-login";
static const QString ActionDisableNopassLogin = "org.lingmo.ocean.accounts.disable-nopass-login";
static const QString ActionEnrollFingerprint = "org.lingmo.ocean.authenticate.fingerprint.enroll";
static const QString ActionEnrollFace = "org.lingmo.ocean.authenticate.face.enroll";
static const QString ActionEnrollIris = "org.lingmo.ocean.authenticate.iris.enroll";
...
QButtonGroup *GnomeKeyringExtention::options()
{
    ...
    QDBusInterface *inter = new QDBusInterface("org.lingmo.ocean.Accounts1",
                                               "/org/lingmo/ocean/Accounts1/User" + QString::number(getuid()),
...
void GnomeKeyringExtention::setKeyringPassword(const QString current, const QString newPass)
{
    ...
    do {
        ...
        ret = g_dbus_connection_call_sync(bus,
                                          ...
                                          "org.gnome.keyring.InternalUnsupportedGuiltRioceannInterface",
