...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logJournalboot, "org.lingmo.log.viewer.parse.boot.journal.work")
#else
Q_LOGGING_CATEGORY(logJournalboot, "org.lingmo.log.viewer.parse.boot.journal.work", QtInfoMsg)
#endif
