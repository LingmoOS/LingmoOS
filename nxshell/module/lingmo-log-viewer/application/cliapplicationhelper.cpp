...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(dgAppHelper, "org.lingmo.logger")
#else
Q_LOGGING_CATEGORY(dgAppHelper, "org.lingmo.logger", QtInfoMsg)
#endif
...
bool CliApplicationHelper::setSingleInstance(const QString &key, CliApplicationHelper::SingleScope singleScope)
{
    ...
    QString socket_key = "_d_lingmo_logger_single_instance_";
