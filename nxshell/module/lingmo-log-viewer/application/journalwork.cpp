...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logJournal, "org.lingmo.log.viewer.parse.system.journal.work")
#else
Q_LOGGING_CATEGORY(logJournal, "org.lingmo.log.viewer.parse.system.journal.work", QtInfoMsg)
#endif
