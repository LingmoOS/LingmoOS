...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logSegementExport, "org.lingmo.log.viewer.segement.export.work")
#else
Q_LOGGING_CATEGORY(logSegementExport, "org.lingmo.log.viewer.segement.export.work", QtInfoMsg)
#endif
