...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到日誌收集工具圖標 ![lingmo_log_viewer](../common/lingmo_log_viewer.svg)，單擊運行。
3. 右鍵單擊 ![lingmo_log_viewer](../common/lingmo_log_viewer.svg)，您可以：
   - 單擊 **發送到桌面**，在桌面創建快捷方式。
...
- 在任務欄上右鍵單擊 ![lingmo_log_viewer](../common/lingmo_log_viewer.svg) ，選擇 **關閉所有**，退出日誌收集工具。
