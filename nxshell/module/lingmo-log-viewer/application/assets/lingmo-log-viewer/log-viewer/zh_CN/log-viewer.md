...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到日志收集工具图标 ![lingmo_log_viewer](../common/lingmo_log_viewer.svg)，单击运行。
3. 右键单击 ![lingmo_log_viewer](../common/lingmo_log_viewer.svg)，您可以：
   - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 在任务栏上右键单击 ![lingmo_log_viewer](../common/lingmo_log_viewer.svg) ，选择 **关闭所有**，退出日志收集工具。
