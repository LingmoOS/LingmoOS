...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logParseWorkKern, "org.lingmo.log.viewer.parse.work.kern")
#else
Q_LOGGING_CATEGORY(logParseWorkKern, "org.lingmo.log.viewer.parse.work.kern", QtInfoMsg)
#endif
