...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logParseWorkKwin, "org.lingmo.log.viewer.parse.work.kwin")
#else
Q_LOGGING_CATEGORY(logParseWorkKwin, "org.lingmo.log.viewer.parse.work.kwin", QtInfoMsg)
#endif
