...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logDebugTime, "org.lingmo.log.viewer.debug.timemanager")
#else
Q_LOGGING_CATEGORY(logDebugTime, "org.lingmo.log.viewer.debug.timemanager", QtInfoMsg)
#endif
