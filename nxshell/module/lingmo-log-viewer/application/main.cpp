...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logAppMain, "org.lingmo.log.viewer.main")
#else
Q_LOGGING_CATEGORY(logAppMain, "org.lingmo.log.viewer.main", QtInfoMsg)
#endif
...
int main(int argc, char *argv[])
{
    ...
    if (argc > 1) {
        ...
        QCommandLineOption appOption(QStringList() << "d" << "lingmo-application", DApplication::translate("main", "Export logs of specified self-developed applications"), DApplication::translate("main", "SELF APPNAME"));
        ...
        a.setApplicationName("lingmo-log-viewer");
        a.setApplicationVersion(VERSION);
        a.setProductIcon(QIcon::fromTheme("lingmo-log-viewer"));
        a.setWindowIcon(QIcon::fromTheme("lingmo-log-viewer"));
