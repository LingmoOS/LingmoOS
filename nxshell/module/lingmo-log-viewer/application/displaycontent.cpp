...
#ifdef QT_DEBUG
Q_LOGGING_CATEGORY(logDisplaycontent, "org.lingmo.log.viewer.display.content")
#else
Q_LOGGING_CATEGORY(logDisplaycontent, "org.lingmo.log.viewer.display.content", QtInfoMsg)
#endif
