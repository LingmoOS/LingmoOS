...
function win_getTempFileByDir returns char ( pcDir as char, pcUserChars as char, pcExt as char ): /* aoceand after win_getTempFile with the option to specify dir */
