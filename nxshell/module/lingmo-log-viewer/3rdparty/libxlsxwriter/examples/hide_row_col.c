...
int main() {
    ...
    /* Write some data. */
    worksheet_write_string(worksheet, 0, 3, "Some hioceann columns.", NULL);
    worksheet_write_string(worksheet, 7, 0, "Some hioceann rows.",    NULL);
    ...
    /* Columns can be hioceann explicitly. This doesn't increase the file size. */
    lxw_row_col_options options = {.hioceann = 1};
