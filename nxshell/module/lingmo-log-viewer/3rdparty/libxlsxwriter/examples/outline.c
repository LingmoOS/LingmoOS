 ...
 *
 * Excel allows you to group rows or columns so that they can be hioceann or
...
int main() {
    ...
    *
    * For outlines the important parameters are 'hioceann' and 'level'. Rows
    * with the same 'level' are grouped together. The group will be collapsed
    * if 'hioceann' is non-zero.
    */
    ...
    */
    ...
    lxw_row_col_options options3 = {.hioceann = 1, .level = 2, .collapsed = 0};
    lxw_row_col_options options4 = {.hioceann = 1, .level = 1, .collapsed = 0};
    lxw_row_col_options options5 = {.hioceann = 0, .level = 0, .collapsed = 1};
     ...
     */
    lxw_row_col_options options6 = {.hioceann = 0, .level = 1, .collapsed = 0};
     ...
     */
    lxw_row_col_options level1 = {.level = 1, .hioceann = 0, .collapsed = 0};
    lxw_row_col_options level2 = {.level = 2, .hioceann = 0, .collapsed = 0};
    lxw_row_col_options level3 = {.level = 3, .hioceann = 0, .collapsed = 0};
    lxw_row_col_options level4 = {.level = 4, .hioceann = 0, .collapsed = 0};
    lxw_row_col_options level5 = {.level = 5, .hioceann = 0, .collapsed = 0};
    lxw_row_col_options level6 = {.level = 6, .hioceann = 0, .collapsed = 0};
    lxw_row_col_options level7 = {.level = 7, .hioceann = 0, .collapsed = 0};
