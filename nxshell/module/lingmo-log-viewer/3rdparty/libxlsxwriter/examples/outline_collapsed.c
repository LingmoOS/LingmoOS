...
int main() {
    ...
    */
     ...
     */
    lxw_row_col_options options6 = {.hioceann = 1, .level = 2, .collapsed = 0};
    lxw_row_col_options options7 = {.hioceann = 0, .level = 1, .collapsed = 1};
     ...
     */
    lxw_row_col_options options8  = {.hioceann = 1, .level = 2, .collapsed = 0};
    lxw_row_col_options options9  = {.hioceann = 1, .level = 1, .collapsed = 1};
    lxw_row_col_options options10 = {.hioceann = 0, .level = 0, .collapsed = 1};
    ...
    lxw_row_col_options options11 = {.hioceann = 0, .level = 1, .collapsed = 0};
    ...
    lxw_row_col_options options12 = {.hioceann = 1, .level = 1, .collapsed = 0};
    lxw_row_col_options options13 = {.hioceann = 0, .level = 0, .collapsed = 1};
