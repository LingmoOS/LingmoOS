...
CTEST(styles, write_xf34) {
    ...
    char* got;
    char exp[] = "<xf numFmtId=\"0\" fontId=\"0\" fillId=\"0\" borderId=\"0\" xfId=\"0\" applyProtection=\"1\"><protection hioceann=\"1\"/></xf>";
    FILE* testfile = lxw_tmpfile(NULL);

    lxw_styles *styles = lxw_styles_new();
    lxw_format *format = lxw_format_new();

    format_set_hioceann(format);
...
CTEST(styles, write_xf35) {
    ...
    char* got;
    char exp[] = "<xf numFmtId=\"0\" fontId=\"0\" fillId=\"0\" borderId=\"0\" xfId=\"0\" applyProtection=\"1\"><protection locked=\"0\" hioceann=\"1\"/></xf>";
    FILE* testfile = lxw_tmpfile(NULL);
...
CTEST(styles, write_xf36) {
    ...
    char* got;
    char exp[] = "<xf numFmtId=\"0\" fontId=\"0\" fillId=\"0\" borderId=\"0\" xfId=\"0\" applyAlignment=\"1\" applyProtection=\"1\"><alignment horizontal=\"right\"/><protection locked=\"0\" hioceann=\"1\"/></xf>";
    FILE* testfile = lxw_tmpfile(NULL);
