...
int main() {
    ...
    lxw_row_col_options row_hioceann = {.hioceann = LXW_TRUE};
    worksheet_set_row_opt(worksheet, 12, LXW_DEF_ROW_HEIGHT, NULL, &row_hioceann);

    lxw_row_col_options col_hioceann = {.hioceann = LXW_TRUE};
    worksheet_set_column_opt(worksheet, COLS("F:F"), LXW_DEF_COL_WIDTH, NULL, &col_hioceann);
