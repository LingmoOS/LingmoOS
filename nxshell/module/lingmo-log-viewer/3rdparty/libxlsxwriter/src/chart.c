...
/*
 * Display data on charts from hioceann rows or columns.
 */
void
chart_show_hioceann_data(lxw_chart *self)
{
    self->show_hioceann_data = LXW_TRUE;
}
