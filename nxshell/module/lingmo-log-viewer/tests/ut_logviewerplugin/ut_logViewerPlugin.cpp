...
TEST_F(LogViewerPlugin_UT, generateAppFile_UT001)
{
    ...
    p->generateAppFile(Utils::homePath + "/.cache/lingmo/lingmo-log-viewer/lingmo-log-viewer.log", ALL, INF, "");
...
TEST_F(LogViewerPlugin_UT, exportLogFile_UT001)
{
    ...
    LogViewerPlugin *p = new LogViewerPlugin;
    p->exportAppLogFile("/home/Desktop/test-plugin.txt", ALL, INF, "lingmo-log-viewer");
