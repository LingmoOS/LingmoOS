...
%{_datadir}/lingmo-manual/manual-assets/application/lingmo-log-viewer/log-viewer/*
%{_prefix}/lib/lingmo-daemon/log-view-service
%{_datadir}/dbus-1/system-services/com.lingmo.logviewer.service
%{_datadir}/dbus-1/system.d/com.lingmo.logviewer.conf
%{_datadir}/%{name}/DocxTemplate/*.dfw
%{_datadir}/dsg/configs/org.lingmo.lingmo-log-viewer/*.json
