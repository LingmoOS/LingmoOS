...
lingmo-gettext-tools is convenient tool for desktop file translation.
...
```bash
sudo apt build-dep lingmo-gettext-tools
```
...
## License
lingmo-gettext-tools is licensed under [GPL-2.0-or-later](LICENSE).
