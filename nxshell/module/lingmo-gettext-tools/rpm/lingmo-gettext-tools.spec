Name:           lingmo-gettext-tools
Version:        1.0.9
Release:        1
Summary:        Lingmo Gettext Tools
License:        GPLv3
URL:            https://github.com/lingmoos/lingmo-gettext-tools
...
sed -i 's|lconvert|lconvert-qt5|; s|lingmo-lupdate|lupdate-qt5|' src/update_pot.py

%build

%install
install -d %{buildroot}%{_bindir}
install -m755 src/desktop_ts_convert.pl %{buildroot}%{_bindir}/lingmo-desktop-ts-convert
install -m755 src/policy_ts_convert.py %{buildroot}%{_bindir}/lingmo-policy-ts-convert
install -m755 src/generate_mo.py %{buildroot}%{_bindir}/lingmo-generate-mo
install -m755 src/update_pot.py %{buildroot}%{_bindir}/lingmo-update-pot
...
%doc README.md
%license LICENSE
%{_bindir}/lingmo-desktop-ts-convert
%{_bindir}/lingmo-policy-ts-convert
%{_bindir}/lingmo-update-pot
%{_bindir}/lingmo-generate-mo
