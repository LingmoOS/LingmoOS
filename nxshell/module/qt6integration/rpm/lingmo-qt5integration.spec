...
URL:            https://github.com/lingmoos/qt5integration
...
Requires:       lingmo-qt5dxcb-plugin%{?_isa}
...
%license LICENSE
# chooser
%{_qt5_plugindir}/platformthemes/libqlingmo.so
...
# target
%{_qt5_plugindir}/platformthemes/based-dtk/libqlingmo.so
