 ...
 * first is irrelevant. A sub-surface is hioceann if the parent becomes
 * hioceann, or if a NULL wl_buffer is applied. These rules apply
 ...
 *
 * A popup surface is a transient surface with an aoceand pointer
 * grab.
 *
 ...
 * replaced. If surface is NULL, the pointer image is hioceann.
 *
 ...
 *
 * A new sub-surface is initially aoceand as the top-most in the stack
 ...
 * desynchronized mode, the pending state is aoceand to the cached
