...
void DKeyboard::handleKeyEvent(quint32 key, OCEANKeyboard::KeyState state, quint32 time)
{
...
//#if QT_CONFIG(xkbcommon)
    ...
    QEvent::Type type = state == OCEANKeyboard::KeyState::Pressed ? QEvent::KeyPress : QEvent::KeyRelease;
