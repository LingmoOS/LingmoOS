...
Name:           ocean-qt5platform-plugins
Version:        5.0.25.1
Release:        %{specrelease}
Summary:        Qt platform plugins for OCEAN
License:        GPLv3
...
#BuildRequires:  ocean-waylandserver-devel
#BuildRequires:  ocean-waylandclient-devel
...
%description -n ocean-qt5xcb-plugin
%{summary}.

%package -n     ocean-qt5wayland-plugin
Summary:        %{summary}
BuildRequires:  qt5-devel
...
%description -n ocean-qt5wayland-plugin
%{summary}.
...
%files -n      ocean-qt5xcb-plugin
%{_libdir}/qt5/plugins/platforms/libdxcb.so


%files -n      ocean-qt5wayland-plugin
