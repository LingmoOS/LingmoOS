...
private:
    ...
    xcb_atom_t _net_wm_lingmo_blur_region_rounded_atom = 0;
    xcb_atom_t _kde_net_wm_blur_rehind_region_atom = 0;
    xcb_atom_t _net_wm_lingmo_blur_region_mask = 0;
    xcb_atom_t _lingmo_wallpaper = 0;
    xcb_atom_t _lingmo_wallpaper_shared_key = 0;
    xcb_atom_t _lingmo_no_titlebar = 0;
    xcb_atom_t _lingmo_scissor_window = 0;
