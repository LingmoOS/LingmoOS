...
{
    _net_wm_lingmo_blur_region_rounded_atom = Utility::internAtom(QT_STRINGIFY(_NET_WM_LINGMO_BLUR_REGION_ROUNDED), false);
    _net_wm_lingmo_blur_region_mask = Utility::internAtom(QT_STRINGIFY(_NET_WM_LINGMO_BLUR_REGION_MASK), false);
    _kde_net_wm_blur_rehind_region_atom = Utility::internAtom(QT_STRINGIFY(_KDE_NET_WM_BLUR_BEHIND_REGION), false);
    _lingmo_wallpaper = Utility::internAtom(QT_STRINGIFY(_LINGMO_WALLPAPER), false);
    _lingmo_wallpaper_shared_key = Utility::internAtom(QT_STRINGIFY(_LINGMO_WALLPAPER_SHARED_MEMORY), false);
    _lingmo_no_titlebar = Utility::internAtom(QT_STRINGIFY(_LINGMO_NO_TITLEBAR), false);
    _lingmo_scissor_window = Utility::internAtom(QT_STRINGIFY(_LINGMO_SCISSOR_WINDOW), false);
    ...
    m_isLingmoWM = (m_wmName == QStringLiteral("Mutter(LingmoGala)"));
    m_isKwin = !m_isLingmoWM && (m_wmName == QStringLiteral("KWin"));
...
{
    bool hasBlurWindow((m_isLingmoWM && isSupportedByWM(_net_wm_lingmo_blur_region_rounded_atom))
...
{
    bool hasNoTitlebar(net_wm_atoms.contains(_lingmo_no_titlebar));
...
{
    bool hasScissorWindow(net_wm_atoms.contains(_lingmo_scissor_window) && hasComposite());
...
{
    bool hasWallpaperEffect(net_wm_atoms.contains(_lingmo_wallpaper));
...
bool DXcbWMSupport::isLingmoWM() const
{
    return m_isLingmoWM;
}
