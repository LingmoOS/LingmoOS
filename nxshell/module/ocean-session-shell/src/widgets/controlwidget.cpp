...
void ControlWidget::initKeyboardLayoutList()
{
    ...
    m_kbLayoutListView->setMinimumWidth(OCEANSESSIONCC::KEYBOARDLAYOUT_WIDTH);
    m_kbLayoutListView->setMaximumSize(OCEANSESSIONCC::KEYBOARDLAYOUT_WIDTH, OCEANSESSIONCC::LAYOUTBUTTON_HEIGHT * 7);
