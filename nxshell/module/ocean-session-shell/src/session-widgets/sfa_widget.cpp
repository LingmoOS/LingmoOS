...
void SFAWidget::initFingerprintAuth()
{
    ...
    m_fingerprintAuth->setAuthFactorType(OCEANSESSIONCC::SingleAuthFactor);
...
void SFAWidget::initFaceAuth()
{
    ...
    m_faceAuth->setAuthFactorType(OCEANSESSIONCC::SingleAuthFactor);
    m_faceAuth->hide();
...
void SFAWidget::initIrisAuth()
{
    ...
    m_irisAuth->setAuthFactorType(OCEANSESSIONCC::SingleAuthFactor);
