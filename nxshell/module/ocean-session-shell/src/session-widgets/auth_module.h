...
#define ResetPassword_Exe_Path QStringLiteral("/usr/lib/ocean-control-center/reset-password-dialog")

DWIDGET_USE_NAMESPACE
using namespace OCEANSESSIONCC;
...
public:
    ...
    inline bool isMFA() const { return m_authFactorType == OCEANSESSIONCC::MultiAuthFactor; }
    bool isLocked() const;
