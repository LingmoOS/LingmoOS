...
void AuthSingle::showResetPasswordMessage()
{
    ...
    connect(suggestButton, &QPushButton::clicked, this, [ this ]{
        const QString AccountsService("org.lingmo.ocean.Accounts1");
        const QString path = QString("/org/lingmo/ocean/Accounts1/User%1").arg(m_currentUid);
        org::lingmo::ocean::accounts1::User user(AccountsService, path, QDBusConnection::systemBus());
...
{
    QDBusInterface syncHelperInter("com.lingmo.sync.Helper",
    ...
    QDBusInterface accountsInter("org.lingmo.ocean.Accounts1",
                                 QString("/org/lingmo/ocean/Accounts1/User%1").arg(m_currentUid),
