...
static const QString DEFAULT_SESSION_NAME = "ocean-x11";
static const QString WAYLAND_SESSION_NAME = "ocean-wayland";
...
{
    const QStringList standardIconList = {"lingmo", "fluxbox", "gnome",
