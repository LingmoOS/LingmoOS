 ...
 * Command line was: qdbusxml2cpp -c DBusLockService -p dbuslockservice org.lingmo.ocean.LockService1.xml
 *
...
/*
 * Proxy class for interface org.lingmo.ocean.LockService1
 */
...
public:
    ...
    { return "org.lingmo.ocean.LockService1"; }
