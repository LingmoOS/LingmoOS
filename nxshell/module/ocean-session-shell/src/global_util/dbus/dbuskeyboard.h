...
/*
 * Proxy class for interface org.lingmo.ocean.InputDevice1.Keyboard
 */
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
        {
            ...
            if (interfaceName !="org.lingmo.ocean.InputDevice1.Keyboard")
                return;
...
public:
    ...
    { return "org.lingmo.ocean.InputDevice1.Keyboard"; }
