...
namespace OCEANSESSIONCC
{

static const QString CONFIG_FILE("/var/lib/AccountsService/lingmo/users/");
static const QString DEFAULT_CURSOR_THEME("/usr/share/icons/default/index.theme");
static const QString LAST_USER_CONFIG("/var/lib/lightdm/lightdm-lingmo-greeter");
...
const QStringList session_ui_configs {
    "/etc/lightdm/lightdm-lingmo-greeter.conf",
    "/etc/lingmo/ocean-session-ui.conf",
    "/usr/share/ocean-session-shell/ocean-session-shell.conf",
    "/usr/share/ocean-session-ui/ocean-session-ui.conf"
};

const QStringList SHUTDOWN_CONFIGS {
    "/etc/lightdm/lightdm-lingmo-greeter.conf",
    "/etc/lingmo/ocean-session-ui.conf",
    "/etc/lingmo/ocean-shutdown.conf",
    "/usr/share/ocean-session-ui/ocean-shutdown.conf"
};

static const QString SOLID_BACKGROUND_COLOR = "#000F27";        // 纯色背景色号
static const QString LOCK_DCONFIG_SOURCE = "org.lingmo.ocean.lock"; // 锁屏配置文件
static const QString LOGIN_DCONFIG_SOURCE = "org.lingmo.ocean.lightdm-lingmo-greeter"; // 登录配置文件
