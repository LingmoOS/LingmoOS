...
LoginTipsWindow::LoginTipsWindow(QWidget *parent)
    : QWidget(parent)
    , m_tips(findValueByQSettings<QString>(OCEANSESSIONCC::session_ui_configs, "Greeter", "tipsTitle", QString()))
    , m_content(findValueByQSettings<QString>(OCEANSESSIONCC::session_ui_configs, "Greeter", "tipsContent", QString()))
{
    initUI();
