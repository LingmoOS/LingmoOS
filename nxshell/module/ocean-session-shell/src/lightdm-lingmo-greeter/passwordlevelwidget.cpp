...
void PasswordLevelWidget::setLevel(PASSWORD_LEVEL_TYPE level)
{
    ...
    case PASSWORD_STRENGTH_LEVEL_LOW:
    {
        ...
        m_lowIcon->setPixmap(QPixmap(IMG_PREFIX + "oceanui_lingmo_password_strength_low.svg"));
        m_mediumIcon->setPixmap(defaultIcon());
        m_highIcon->setPixmap(defaultIcon());
    }
        break;
    case PASSWORD_STRENGTH_LEVEL_MIDDLE:
    {
        ...
        m_lowIcon->setPixmap(QPixmap(IMG_PREFIX + "oceanui_lingmo_password_strength_middle.svg"));
        m_mediumIcon->setPixmap(QPixmap(IMG_PREFIX + "oceanui_lingmo_password_strength_middle.svg"));
        m_highIcon->setPixmap(defaultIcon());
    }
        break;
    case PASSWORD_STRENGTH_LEVEL_HIGH:
    {
        ...
        m_lowIcon->setPixmap(QPixmap(IMG_PREFIX + "oceanui_lingmo_password_strength_high.svg"));
        m_mediumIcon->setPixmap(QPixmap(IMG_PREFIX + "oceanui_lingmo_password_strength_high.svg"));
        m_highIcon->setPixmap(QPixmap(IMG_PREFIX + "oceanui_lingmo_password_strength_high.svg"));
    }
        break;
    default:
        reset();
...
QString PasswordLevelWidget::defaultIcon()
{
    if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::LightType) {
        return IMG_PREFIX + "oceanui_lingmo_password_strength_unactive_light_mode.svg";
    } else if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::LightType) {
        return IMG_PREFIX + "oceanui_lingmo_password_strength_unactive_deep_mode.svg";
    } else {
        return QString();
    }
}
