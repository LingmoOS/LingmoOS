...
const QString DBUS_LOCK_PATH = "/org/lingmo/ocean/LockFront1";
const QString DBUS_LOCK_NAME = "org.lingmo.ocean.LockFront1";

const QString DBUS_SHUTDOWN_PATH = "/org/lingmo/ocean/ShutdownFront1";
const QString DBUS_SHUTDOWN_NAME = "org.lingmo.ocean.ShutdownFront1";
