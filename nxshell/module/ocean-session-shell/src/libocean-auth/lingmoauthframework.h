...
#ifndef LINGMOAUTHFRAMEWORK_H
#define LINGMOAUTHFRAMEWORK_H
...
#define AUTHRNTICATESERVICE "org.lingmo.ocean.Authenticate1"
#define AUTHRNTICATEINTERFACE "org.lingmo.ocean.Authenticate1.Session"

using AuthInter = org::lingmo::ocean::Authenticate1;
using AuthControllerInter = org::lingmo::ocean::authenticate1::Session;
...
class LingmoAuthFramework : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit LingmoAuthFramework(QObject *parent = nullptr);
    ~LingmoAuthFramework() override;
