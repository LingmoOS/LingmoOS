...
class UT_LingmoAuthFramework : public testing::Test
{
protected:
    void SetUp() override;
    void TearDown() override;

    //LingmoAuthFramework *m_authFramework;
};

void UT_LingmoAuthFramework::SetUp()
{
//    m_authFramework = new LingmoAuthFramework();
}

void UT_LingmoAuthFramework::TearDown()
{
//    delete m_authFramework;
}

TEST_F(UT_LingmoAuthFramework, PAMTest)
{
...
TEST_F(UT_LingmoAuthFramework, DATest)
{
