...
%global repo   ocean-qt-dbus-factory

%if 0%{?fedora}
Name:           lingmo-qt-dbus-factory
%else
Name:           ocean-qt-dbus-factory
%endif
Version:        5.3.0.20
...
%if 0%{?fedora}
URL:            https://github.com/lingmoos/ocean-qt-dbus-factory
Source0:        %{url}/archive/%{version}/%{repo}-%{version}.tar.gz
%else
URL:            http://shuttle.corp.lingmo.com/cache/repos/eagle/release-candidate/56qX566h6IGU6LCD5rWL6K-V6aqM6K-BMDUyMTQ5Mg/pool/main/d/ocean-qt-dbus-factory/
