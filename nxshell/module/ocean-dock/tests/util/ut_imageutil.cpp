...
TEST_F(Test_ImageUtil, coverage_test)
{
    ...
    ASSERT_FALSE(ImageUtil::loadSvg(":/res/ocean-calendar.svg", QSize(100, 100), 1.5).isNull());
    ASSERT_EQ(ImageUtil::loadSvg(":/res/ocean-calendar.svg", "ocean-printer", 100, 1.25).size(), QSize(125, 125));
