...
#include "org_lingmo_ocean_inputdevice1_keyboard.h"

using Keyboard = org::lingmo::ocean::inputdevice1::Keyboard;
class QGSettings;

class DBusAdaptors : public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.lingmo.ocean.Dock1.KeyboardLayout")
//    Q_CLASSINFO("D-Bus Introspection", ""
//                "  <interface name=\"org.lingmo.ocean.Dock1.KeyboardLayout\">\n"
