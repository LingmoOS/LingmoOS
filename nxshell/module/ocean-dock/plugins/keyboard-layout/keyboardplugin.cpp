...
void KeyboardPlugin::init(PluginProxyInterface *proxyInter)
{
    ...
    if (!m_dbusAdaptors) {
        ...
        QString serverName = "org.lingmo.ocean.InputDevices1";
        ...
        QDBusConnection::sessionBus().registerService("org.lingmo.ocean.Dock1.KeyboardLayout");
        QDBusConnection::sessionBus().registerObject("/org/lingmo/ocean/Dock1/KeyboardLayout", "org.lingmo.ocean.Dock1.KeyboardLayout", this);
    }
}
