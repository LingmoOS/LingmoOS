...
#include "org_lingmo_ocean_systempower1.h"

#include <QLabel>

using SystemPowerInter = org::lingmo::ocean::Power1;
...
class PowerPlugin : public QObject, PluginsItemInterface
{
    ...
    Q_PLUGIN_METADATA(IID "com.lingmo.dock.PluginsItemInterface" FILE "power.json")
