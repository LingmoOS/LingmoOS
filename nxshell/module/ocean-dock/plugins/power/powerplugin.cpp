...
PowerPlugin::PowerPlugin(QObject *parent)
    ...
    , m_dconfig(new DConfig(QString("org.lingmo.ocean.dock.power"), QString()))
...
{
    if (itemKey == POWER_KEY)
        return QString("dbus-send --print-reply --dest=org.lingmo.ocean.ControlCenter1 /org/lingmo/ocean/ControlCenter1 org.lingmo.ocean.ControlCenter1.ShowPage string:power");
