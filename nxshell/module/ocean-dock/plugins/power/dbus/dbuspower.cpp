 ...
 * Command line was: qdbusxml2cpp -c DBusPower -p dbuspower org.lingmo.ocean.Power1.xml
 *
...
DBusPower::DBusPower(QObject *parent)
    : QDBusAbstractInterface("org.lingmo.ocean.Power1", "/org/lingmo/ocean/Power1", staticInterfaceName(), QDBusConnection::sessionBus(), parent)
{
