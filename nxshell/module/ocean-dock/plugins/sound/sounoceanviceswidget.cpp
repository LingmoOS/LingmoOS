...
SoundDevicesWidget::SoundDevicesWidget(QWidget *parent)
    ...
    , m_soundInter(new DBusAudio("org.lingmo.ocean.Audio1", "/org/lingmo/ocean/Audio1", QDBusConnection::sessionBus(), this))
    , m_sinkInter(new DBusSink("org.lingmo.ocean.Audio1", m_soundInter->defaultSink().path(), QDBusConnection::sessionBus(), this))
