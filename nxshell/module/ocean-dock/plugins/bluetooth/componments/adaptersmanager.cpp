...
AdaptersManager::AdaptersManager(QObject *parent)
    : QObject(parent)
    , m_bluetoothInter(new DBusBluetooth("org.lingmo.ocean.Bluetooth1",
                                         "/org/lingmo/ocean/Bluetooth1",
                                         QDBusConnection::sessionBus(),
                                         this))
{
    connect(m_bluetoothInter, &DBusBluetooth::AdapterAoceand, this, &AdaptersManager::onAddAdapter);
    ...
    connect(m_bluetoothInter, &DBusBluetooth::DeviceAoceand, this, &AdaptersManager::onAddDevice);
