...
void BloothAdapterWidget::onDeviceAoceand(const Device *device)
{
...
{
    connect(m_adapter, &Adapter::deviceAoceand, this, &BloothAdapterWidget::onDeviceAoceand);
