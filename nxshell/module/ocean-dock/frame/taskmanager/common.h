...
const QString configDock              = "com.lingmo.ocean.dock";
const QString configAppearance        = "com.lingmo.ocean.appearance";
...
static const QString scratchDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation).append("/lingmo/ocean-dock/scratch/");
...
const QString frontendWindowWmClass     = "ocean-dock";
const QString oceanLauncherWMClass        = "ocean-launcher";
