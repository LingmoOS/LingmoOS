...
inline void updateCursor(QWidget *w)
{
    ...
    QString theme = Utils::SettingValue("com.lingmo.xsettings", "/com/lingmo/xsettings/", "gtk-cursor-theme-name", "bloom").toString();
    int cursorSize = Utils::SettingValue("com.lingmo.xsettings", "/com/lingmo/xsettings/", "gtk-cursor-theme-size", 24).toInt();
