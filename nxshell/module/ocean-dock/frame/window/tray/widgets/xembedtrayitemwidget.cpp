...
void XEmbedTrayItemWidget::wrapWindow()
{
    ...
    values[0] = ParentRelative; //draw a solid background so the embeoceand icon doesn't get garbage in it
...
//    setX11PassMouseEvent(true);
    ...
    /*
     * Render the embeoceand window offscreen
     */
    ...
    */
    ...
    // xembed_message_send(m_windowId, XEMBED_EMBEOCEAND_NOTIFY, m_containerWid, 0, 0);
...
//    if (clientGeom->width > iconSize || clientGeom->height > iconSize )
    ...
    //show the embeoceand window otherwise nothing happens
