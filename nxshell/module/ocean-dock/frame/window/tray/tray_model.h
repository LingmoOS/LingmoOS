...
private Q_SLOTS:
    void onXEmbedTrayAoceand(quint32 winId);
    void onXEmbedTrayRemoved(quint32 winId);
    void onSniTrayAoceand(const QString &servicePath);
    void onSniTrayRemoved(const QString &servicePath);

    void onIndicatorFounded(const QString &indicatorName);
    void onIndicatorAoceand(const QString &indicatorName);
    void onIndicatorRemoved(const QString &indicatorName);

    void onSystemTrayAoceand(PluginsItemInterface *itemInter);
