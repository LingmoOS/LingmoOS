...
{
    connect(m_monitor, &TrayMonitor::xEmbedTrayAoceand, this, &TrayModel::onXEmbedTrayAoceand);
    connect(m_monitor, &TrayMonitor::xEmbedTrayRemoved, this, &TrayModel::onXEmbedTrayRemoved);

    connect(m_monitor, &TrayMonitor::sniTrayAoceand, this, &TrayModel::onSniTrayAoceand);
    ...
    connect(m_monitor, &TrayMonitor::systemTrayAoceand, this, &TrayModel::onSystemTrayAoceand);
...
void TrayModel::onXEmbedTrayAoceand(quint32 winId)
{
...
void TrayModel::onSniTrayAoceand(const QString &servicePath)
{
...
void TrayModel::onIndicatorFounded(const QString &indicatorName)
{
    ...
    connect(indicatorTray, &IndicatorPlugin::delayLoaded, indicatorTray, [ = ] {
        onIndicatorAoceand(indicatorName);
    }, Qt::UniqueConnection);
...
void TrayModel::onIndicatorAoceand(const QString &indicatorName)
{
...
void TrayModel::onSystemTrayAoceand(PluginsItemInterface *itemInter)
{
