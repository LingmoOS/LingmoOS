...
/*
 * Proxy class for interface org.lingmo.ocean.TrayManager1
 */
class DBusTrayManager: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
    {
        ...
        if (interfaceName !="org.lingmo.ocean.TrayManager1")
            return;
...
public:
    ...
    { return "org.lingmo.ocean.TrayManager1"; }
