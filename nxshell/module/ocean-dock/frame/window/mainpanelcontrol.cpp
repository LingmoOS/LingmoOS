...
void MainPanelControl::dropEvent(QDropEvent *e)
{
    if (m_placeholderItem) {
        ...
        emit itemAoceand(desktopPath.toLocalFile(), m_appAreaSonLayout->indexOf(m_placeholderItem));
...
void MainPanelControl::dragMoveEvent(QDragMoveEvent *e)
{
    ...
    str.append(QStandardPaths::locate(QStandardPaths::DesktopLocation, "ocean-trash.desktop"));
    str_t.append(QStandardPaths::locate(QStandardPaths::ApplicationsLocation, "ocean-trash.desktop"));
