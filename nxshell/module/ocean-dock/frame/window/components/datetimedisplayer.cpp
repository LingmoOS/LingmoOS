// Copyright (C) 2022 ~ 2023 Lingmo Technology Co., Ltd.
...
DateTimeDisplayer::DateTimeDisplayer(bool showMultiRow, QWidget *parent)
    : QWidget (parent)
    , m_timedateInter(new Timedate("org.lingmo.ocean.Timedate1", "/org/lingmo/ocean/Timedate1", QDBusConnection::sessionBus(), this))
    ...
    , m_config(DTK_CORE_NAMESPACE::DConfig::createGeneric("org.lingmo.region-format", QString(), this))
{
...
void DateTimeDisplayer::mouseReleaseEvent(QMouseEvent *event)
{
    ...
    DDBusSender().service("com.lingmo.Calendar")
            .path("/com/lingmo/Calendar")
