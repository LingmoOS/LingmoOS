...
DisplayManager::DisplayManager(QObject *parent)
    : QObject(parent)
    , m_gsettings(Utils::SettingsPtr("com.lingmo.ocean.dock.mainwindow", "/com/lingmo/ocean/dock/mainwindow/", this))
    , m_onlyInPrimary(Utils::SettingValue("com.lingmo.ocean.dock.mainwindow", "/com/lingmo/ocean/dock/mainwindow/", "onlyShowPrimary", false).toBool())
{
    ...
    connect(qApp, &QGuiApplication::screenAoceand, this, &DisplayManager::screenCountChanged);
