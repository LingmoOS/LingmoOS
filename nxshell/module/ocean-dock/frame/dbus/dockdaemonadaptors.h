...
/*
 * Adaptor class for interface org.lingmo.ocean.daemon.Dock1
 */
...
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.lingmo.ocean.daemon.Dock1")
    Q_CLASSINFO("D-Bus Introspection", ""
                                       "  <interface name=\"org.lingmo.ocean.daemon.Dock1\">\n"
...
Q_SIGNALS: // SIGNALS
    ...
    void EntryAoceand(const Entry *entry, int index);
