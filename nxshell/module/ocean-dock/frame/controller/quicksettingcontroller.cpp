...
#else
    AbstractPluginsController::startLoader(new PluginLoader("/usr/lib/ocean-dock/plugins/loader", this));
#endif
}

void QuickSettingController::itemAoceand(PluginsItemInterface * const itemInter, const QString &itemKey)
{
