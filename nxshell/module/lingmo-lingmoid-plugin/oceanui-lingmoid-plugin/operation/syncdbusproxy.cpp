...
const static QString SYNC_SERVICE = QStringLiteral("com.lingmo.sync.Daemon");
const static QString SYNC_INTERFACE = QStringLiteral("com.lingmo.sync.Daemon");
const static QString SYNC_PATH = QStringLiteral("/com/lingmo/sync/Daemon");
