...
void DeviceSyncPage::onAddDeviceList(const QList<DeviceInfo> &devlist)
{
    ...
    for (auto &devInfo: devlist)
    {
        ...
        else
        {
            ...
            removeLabel->setPixmap(QIcon::fromTheme("oceanui_del_account").pixmap(12, 14));
...
{
    m_delDialog->setIcon(QIcon::fromTheme(QStringLiteral("lingmo-browser")));
...
QString DeviceSyncPage::getDeviceIcon(DeviceType devType)
{
    ...
    {
    case DEVICETYPE_PC:
        strType = QStringLiteral("oceanui_pc");
        break;
    case DEVICETYPE_TABLET:
        strType = QStringLiteral("oceanui_pad");
        break;
    case DEVICETYPE_NOTEBOOK:
        strType = QStringLiteral("oceanui_laptop");
        break;
