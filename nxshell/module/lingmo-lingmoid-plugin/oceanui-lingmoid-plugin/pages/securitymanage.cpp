...
static const QString STRING_ICONUOSID = QStringLiteral("oceanui_union_id");
static const QString CLIENT_SERVICE = QStringLiteral("com.lingmo.lingmoid.Client");
static const QString CLIENT_PATH = QStringLiteral("/com/lingmo/lingmoid/Client");
...
{
    m_itemPhone->SetIcon("oceanui_trust_phone");
    m_itemMail->SetIcon("oceanui_trust_email");
    m_itemAccount->SetIcon("oceanui_secwechat");
    m_itemPasswd->SetIcon("oceanui_seckey");
