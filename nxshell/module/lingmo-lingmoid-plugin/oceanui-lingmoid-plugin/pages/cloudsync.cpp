  ...
  , m_syncState(false)
{
    m_sysConfig =
    {
        {SyncType::Sound, TransString::getTransString(STRING_SOUND), "oceanui_cloud_voice", true},
        {SyncType::Theme, TransString::getTransString(STRING_THEME), "oceanui_cloud_them", true},
        {SyncType::Power, TransString::getTransString(STRING_POWER), "oceanui_cloud_power", true},
        {SyncType::Network, TransString::getTransString(STRING_NETWORK), "oceanui_cloud_net", true},
        {SyncType::Mouse, TransString::getTransString(STRING_MOUSE), "oceanui_cloud_mouse", true},
        {SyncType::Update, TransString::getTransString(STRING_UPDATE), "oceanui_cloud_update", true},
        {SyncType::Dock, TransString::getTransString(STRING_DOCK), "oceanui_cloud_taskbar", true},
        {SyncType::Launcher, TransString::getTransString(STRING_LAUNCHER), "oceanui_cloud_luncher", true},
        {SyncType::Wallpaper, TransString::getTransString(STRING_WALLPAPER), "oceanui_cloud_wallpaper", true},
    };
...
void CloudSyncPage::initSysConfig()
{
    ...
    item->setFont(itemFont);
    item->setData(QVariant::fromValue(itemMargin), Dtk::MarginsRole);
    item->setIcon(QIcon::fromTheme("oceanui_cfg_set"));
...
void CloudSyncPage::initUI()
{
    ...
    m_labelWarn->setPixmap(QIcon::fromTheme("oceanui_not_use").pixmap(24, 24));
    ...
    m_clearDlg->setIcon(QIcon::fromTheme("oceanui_union_id"));
