// Copyright (C) 2016 ~ 2021 Lingmo Technology Co., Ltd.
...
void LoginInfoPage::initUI()
{
    ...
    m_editNameBtn->setIcon(QIcon::fromTheme("oceanui_edit"));
    ...
    m_editInfoBtn->setIcon(QIcon::fromTheme("oceanui_sync_Setting"));
    m_editInfoBtn->setIconSize(QSize(16, 16));
    m_editInfoBtn->setFixedSize(36,36);
    m_logoutBtn->setToolTip(tr("Sign out"));
    m_logoutBtn->setIcon(QIcon::fromTheme("oceanui_sync_out"));
...
void LoginInfoPage::onUserInfoChanged(const QVariantMap &infos)
{
    ...
    QList<QPair<QString, QString>> infoTs {
        {"oceanui_sync_phone", phone},
        {"oceanui_sync_mail", mail},
        {"oceanui_sync_wechat", wechat},
        {"oceanui_sync_place", regionDate},
    };
