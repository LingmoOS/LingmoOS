...
#include "screensaver/screensavercheck.h"
    ...
    , ModuleInterface()
{
    ...
    translator->load(QString("/usr/share/oceanui-wallpapersetting-plugin/translations/oceanui-wallpapersetting-plugin_%1.qm").arg(QLocale::system().name()));
...
{
    return QString(":/translations/oceanui-wallpapersetting-plugin_%1.ts");
}
