...
void WallpaperWindow::initialize(WallpaperProvider *ptr)
{
    ...
    connect(provider, &WallpaperProvider::wallpaperAoceand, this, &WallpaperWindow::addNewWallpaper);
...
void WallpaperWindow::getNewColor()
{
    ...
    //set to ocean, and prefix solid:: to tell ocean this is a solid color wallpaper.
...
bool WallpaperWindow::isWallpaperLocked() const
{
    if (QFileInfo::exists("/var/lib/lingmo/permission-manager/wallpaper_locked")) {
        ...
        QDBusPendingReply<uint> p = notify.asyncCall(QString("Notify"),
                         QString("ocean-control-center"),   // title
                         notifyID,
