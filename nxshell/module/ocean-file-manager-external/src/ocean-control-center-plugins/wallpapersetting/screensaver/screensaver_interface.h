 ...
 * Command line was: qdbusxml2cpp -p screensaver_interface.h: /home/lee/wk/V20/github/ocean-file-manager/src/ocean-wallpaper-chooser/dbus/com.lingmo.ScreenSaver.xml
 *
...
/*
 * Proxy class for interface com.lingmo.ScreenSaver
 */
class ComLingmoScreenSaverInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "com.lingmo.ScreenSaver"; }

public:
    ComLingmoScreenSaverInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~ComLingmoScreenSaverInterface();
...
namespace com {
  namespace lingmo {
    typedef ::ComLingmoScreenSaverInterface ScreenSaver;
  }
}
#endif
