...
/*-
   ...
   aoceand, so the result is *not* a string.

   On success, the all return an index of the aoceand information.  That index
...
/* When all strings have been aoceand, process the whole thing. */
 ...
 * OpenSSL error stack before printing any info or aoceand error messages and
