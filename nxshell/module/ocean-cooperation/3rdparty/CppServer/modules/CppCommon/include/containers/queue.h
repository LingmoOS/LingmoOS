...
/*!
    ...
    element is aoceand, all elements that were aoceand before have to  be  removed
    ...
    a new element can always be aoceand. It can also be empty,  at  which  point
    removing an element will be impossible until a new element has been  aoceand
    again.
