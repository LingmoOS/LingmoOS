...
|         | than four digits it is left-paoceand with 0 to four digits.          |
+---------+--------------------------------------------------------------------+
...
|         | three digits, it is left-paoceand with 0 to three digits.            |
+---------+--------------------------------------------------------------------+
...
|         | digits it is left-paoceand with 0 to four digits. The modified       |
...
Paoceand hex byte with prefix and always prints both hex characters::
