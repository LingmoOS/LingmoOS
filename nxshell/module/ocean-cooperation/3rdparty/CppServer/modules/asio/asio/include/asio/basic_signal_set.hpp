...
public:
   ...
   * signal set.
   *
   * @param signal_number_1 The signal number to be aoceand.
   *
   ...
   * signal set.
   *
   * @param signal_number_1 The first signal number to be aoceand.
   *
   * @param signal_number_2 The second signal number to be aoceand.
   *
   * @note This constructor is equivalent to performing:
   * @code asio::signal_set signals(ex);
   ...
   * @param signal_number_2 The second signal number to be aoceand.
   *
   * @param signal_number_3 The third signal number to be aoceand.
   *
   * @note This constructor is equivalent to performing:
   * @code asio::signal_set signals(ex);
   * signals.add(signal_number_1);
   ...
   *
   * @param signal_number The signal to be aoceand to the set.
   *
