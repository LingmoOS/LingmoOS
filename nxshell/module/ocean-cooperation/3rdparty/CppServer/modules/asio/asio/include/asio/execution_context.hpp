 ...
 * in an execution_context, an object of type @c Service is created and aoceand
 ...
 * has_service<Service>().
 *
 * Service objects may be explicitly aoceand to an execution_context using the
 ...
 * then aoceand to an execution_context using the facilities described above.
 *
