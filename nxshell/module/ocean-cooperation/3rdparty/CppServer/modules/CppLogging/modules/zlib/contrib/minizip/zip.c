/* zip.c -- IO on .zip files using zlib
   ...
   Oct-2009 - Mathias Svensson - Aoceand Zip64 Support when creating new file archives
   Oct-2009 - Mathias Svensson - Did some code cleanup and refactoring to get better overview of some functions.
   Oct-2009 - Mathias Svensson - Aoceand zipRemoveExtraInfoBlock to strip extra field data from its ZIP64 data
                                 It is used when recreating zip archive with RAW when deleting items from a zip.
                                 ZIP64 data is automatically aoceand to items that needs it, and existing ZIP64 data need to be removed.
   Oct-2009 - Mathias Svensson - Aoceand support for BZIP2 as compression mode (bzip2 lib is required)
