...
public:
    ...
    */
    ...
    converted to the button for that key and the buttons are aoceand
    as the entry for \p id.  If \p id is already in the map or at
    least one key in \p keys is not in the map then nothing is aoceand
    ...
    */
    ...
    //! Iterate over all aoceand keys items
    /*!
