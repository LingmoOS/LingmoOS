...
TEST(KeyStateTests, setHalfDuplexMask_capsLock_halfDuplexCapsLockAoceand)
{
    MockKeyMap keyMap;
    MockEventQueue eventQueue;
    KeyStateImpl keyState(eventQueue, keyMap);
...
TEST(KeyStateTests, setHalfDuplexMask_numLock_halfDuplexNumLockAoceand)
{
    MockKeyMap keyMap;
    MockEventQueue eventQueue;
    KeyStateImpl keyState(eventQueue, keyMap);
...
TEST(KeyStateTests, setHalfDuplexMask_scrollLock_halfDuplexScollLockAoceand)
{
    MockKeyMap keyMap;
    MockEventQueue eventQueue;
    KeyStateImpl keyState(eventQueue, keyMap);
