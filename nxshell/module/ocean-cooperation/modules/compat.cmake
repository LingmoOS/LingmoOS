...
if (NOT DEFINED OCEAN_COOPERATION_PLUGIN_ROOT_DIR)
    set(OCEAN_COOPERATION_PLUGIN_ROOT_DIR ${LIB_INSTALL_DIR}/ocean-cooperation/plugins)
endif()

if (NOT DEFINED LINGMO_DAEMON_PLUGIN_DIR)
    set(LINGMO_DAEMON_PLUGIN_DIR ${OCEAN_COOPERATION_PLUGIN_ROOT_DIR}/daemon)
endif()

# build plugins dir
if(NOT DEFINED OCEAN_COOPERATION_PLUGIN_ROOT_DEBUG_DIR)
    set(OCEAN_COOPERATION_PLUGIN_ROOT_DEBUG_DIR ${CMAKE_CURRENT_BINARY_DIR}/plugins)
endif()
