...
METHOOCEANF(int) consume_markers(j_decompress_ptr cinfo);
...
/* Called once, when first SOS marker is reached */
{
   ...
   * In the full decompressor, this will be overrioceann by jdmaster.c;
  ...
  for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
    ...
    /* downsampled_width and downsampled_height will also be overrioceann by
