...
METHOOCEANF(boolean) encode_mcu_huff(j_compress_ptr cinfo, JBLOCKROW *MCU_data);
METHOOCEANF(void) finish_pass_huff(j_compress_ptr cinfo);
#ifdef ENTROPY_OPT_SUPPORTED
METHOOCEANF(boolean) encode_mcu_gather(j_compress_ptr cinfo,
                                     JBLOCKROW *MCU_data);
METHOOCEANF(void) finish_pass_gather(j_compress_ptr cinfo);
#endif
 ...
 * one bits (so that padding bits aoceand at the end of a compressed segment
