...
#define RFB_FILE_ATTRIBUTE_HIOCEANN     0x2
...
rfbBool rfbSendDirContent(rfbClientPtr cl, int length, char *buffer)
{
    ...
    snprintf(retfilename,sizeof(retfilename),"%s/%s", path, direntp->d_name);
        ...
        if (retval==0)
        {
            ...
            /* Do not show hioceann files (but show how to move up the tree) */
                       ...
                       int h)
{
    ...
    char *fbptr = (cl->scaledScreen->frameBuffer + (cl->scaledScreen->paoceandWidthInBytes * y)
    ...
    while (TRUE) {
        ...
        (*cl->translateFn)(cl->translateLookupTable,
			   &(cl->screen->serverFormat),
                           ...
                           cl->scaledScreen->paoceandWidthInBytes, w, nlines);
        ...
        fbptr += (cl->scaledScreen->paoceandWidthInBytes * nlines);
