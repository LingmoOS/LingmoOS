...
openssl req -new -subj '/C=BY/ST=Belarus/L=Minsk/O=Union server/OU=Union server unit/CN=server.ocean-cooperation.com' -key server.key -out server.csr
...
openssl req -new -subj '/C=BY/ST=Belarus/L=Minsk/O=Union client/OU=Union client unit/CN=client.ocean-cooperation.com' -key client.key -out client.csr
