...
#else
const char *Kcomputer_connected = ":/icons/lingmo/builtin/icons/computer_connected_52px.svg";
const char *Kcomputer_can_connect = ":/icons/lingmo/builtin/icons/computer_can_connect_52px.svg";
const char *Kcomputer_off_line = ":/icons/lingmo/builtin/icons/computer_off_line_52px.svg";
#endif
