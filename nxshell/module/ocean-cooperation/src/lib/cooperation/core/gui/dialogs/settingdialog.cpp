...
#else
const char *Kdisplay_right = ":/icons/lingmo/builtin/texts/display_right_24px.svg";
const char *Kdisplay_left = ":/icons/lingmo/builtin/texts/display_left_24px.svg";
#endif
...
void SettingDialogPrivate::createBasicWidget()
{
    ...
    closeBtn->setIcon(QIcon(":/icons/lingmo/builtin/icons/tab_close_normal.svg"));
...
void SettingDialogPrivate::reportDeviceStatus(const QString &type, bool status)
{
    ...
    lingmo_cross::ReportLogManager::instance()->commit(ReportAttribute::CooperationStatus, data);
#endif
}
...
void SettingDialogPrivate::setQComboxWinStyle(QComboBox *combox)
{
    combox->setStyleSheet(
            ...
            "   width: 12px;"
            "   height: 12px;"
            "   image: url(':/icons/lingmo/builtin/texts/combobox_arrow.svg');"
