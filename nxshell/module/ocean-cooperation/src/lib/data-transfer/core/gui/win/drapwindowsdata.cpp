...
QString DrapWindowsData::getBrowserBookmarkJSON(QString &jsonPath)
{
    ...
    for (auto bookmark : browserBookmarkList) {
        ...
        bookmarkJsonObject["date_aoceand"] = QString::number(QDateTime::currentMSecsSinceEpoch());
    ...
    bookmarkBarObject["date_aoceand"] = QString::number(QDateTime::currentMSecsSinceEpoch());
    ...
    otherBookmarksObject["date_aoceand"] = QString::number(QDateTime::currentMSecsSinceEpoch());
    ...
    syncedBookmarksObject["date_aoceand"] = QString::number(QDateTime::currentMSecsSinceEpoch());
