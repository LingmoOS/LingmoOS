...
bool SettingHelper::setWallpaper(const QString &filepath)
{
    ...
    QString service = "com.lingmo.daemon.Appearance";
    QString path = "/com/lingmo/daemon/Appearance";
    QString interfaceName = "com.lingmo.daemon.Appearance";
...
bool SettingHelper::installApps(const QString &app)
{
    ...
    QString service = "com.lingmo.lastore";
    QString path = "/com/lingmo/lastore";
    QString interfaceName = "com.lingmo.lastore.Manager";
...
void SettingHelper::onPropertiesChanged(const QDBusMessage &message)
{
    ...
    foreach (const QString &key, changedProps.keys()) {
        ...
        QDBusInterface interface("com.lingmo.lastore",
                                 message.path(),
