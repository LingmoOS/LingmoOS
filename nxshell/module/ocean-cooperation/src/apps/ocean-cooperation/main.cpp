...
const char *compatProc = "ocean-cooperation-daemon";
...
{
    // qputenv("QT_LOGGING_RULES", "ocean-cooperation.debug=true");
    ...
    app.setProductIcon(QIcon::fromTheme("ocean-cooperation"));
    app.setApplicationAcknowledgementPage("https://www.lingmo.org/acknowledgments/");
