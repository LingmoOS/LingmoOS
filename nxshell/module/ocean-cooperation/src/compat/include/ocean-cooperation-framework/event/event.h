...
#include <ocean-cooperation-framework/event/eventdispatcher.h>
#include <ocean-cooperation-framework/event/eventsequence.h>
#include <ocean-cooperation-framework/event/eventchannel.h>
