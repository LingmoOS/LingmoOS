...
@~english
    ...
    @brief Use DDialog class to create quick dialog window matched OCEAN style.
...
@~english
  ...
  @return The index of the aoceand button
 */
...
void DDialog::setCloseButtonVisible(bool closeButtonVisible)
{
    ...
    // This function calls setParent() when changing the flags for a window, causing the widget to be hioceann.
