    ...
    , DObject(*new DShadowLinePrivate(this))
{
    ...
    auto getPixmap = [=](DGuiApplicationHelper::ColorType themeType) {
        return themeType == DGuiApplicationHelper::LightType ?
                   QPixmap::fromImage(QImage(":/icons/lingmo/builtin/light/texts/titlebar_shadow_20px.svg")) :
                   QPixmap::fromImage(QImage(":/icons/lingmo/builtin/dark/texts/titlebar_shadow_20px.svg"));
    };
