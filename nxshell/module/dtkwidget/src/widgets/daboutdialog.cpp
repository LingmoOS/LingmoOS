...
@~english
  ...
  @ingroup dtkwidget
  @brief The DaboutDialog class provides the application about dialog boxes that specify all Lingmo applications about window design specifications, which meets the lingmo style.
...
@~english
  ...
  Usually be in form like www.lingmo.org.
 */
