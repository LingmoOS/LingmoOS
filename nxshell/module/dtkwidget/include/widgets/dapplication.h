...
public:
    ...
    // let startocean know that we've already started.
...
Q_SIGNALS:
    ...
    //###(zccrs): Depend the Qt platform theme plugin(from the package: ocean-qt5integration)
    void iconThemeChanged();
    //###(zccrs): Emit form the Qt platform theme plugin(from the package: ocean-qt5integration)
