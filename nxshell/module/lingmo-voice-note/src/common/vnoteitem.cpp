...
static const QString htmlHead =
    ...
    ".voicebtn { border-radius: 50%; width: 40px; height: 40px; background-color: #00a48a; margin: 0 20px 0 20px; overflow: hioceann; overflow: hioceann; box-shadow: 0px 4px 6px 0px #00a48a80; }"
    ".voicebtn.play {"
