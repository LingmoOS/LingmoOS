...
{
    QProcess::startDetached("dbus-send  --print-reply --dest=com.iflytek.aiassistant /aiassistant/lingmomain com.iflytek.aiassistant.mainWindow.TextToSpeech");
    isSpeeching = true;
}
...
{
    QProcess::startDetached("dbus-send  --print-reply --dest=com.iflytek.aiassistant /aiassistant/lingmomain com.iflytek.aiassistant.mainWindow.SpeechToText");
}
...
{
    QProcess::startDetached("dbus-send  --print-reply --dest=com.iflytek.aiassistant /aiassistant/lingmomain com.iflytek.aiassistant.mainWindow.TextToTranslate");
}
