...
#ifdef OS_BUILD_V23
/**
 * @brief AudioService 音频服务名 org.lingmo.ocean.Audio1
 */
const static QString AudioService = QStringLiteral("org.lingmo.ocean.Audio1");

/**
 * @brief AudioPath 服务地址 /org/lingmo/ocean/Audio1
 */
const static QString AudioPath = QStringLiteral("/org/lingmo/ocean/Audio1");

/**
 * @brief AudioInterface 接口名称 org.lingmo.ocean.Audio1
 */
const static QString AudioInterface = QStringLiteral("org.lingmo.ocean.Audio1");

/**
 * @brief SinkInterface 音频输出接口名称 org.lingmo.ocean.Audio1.Sink
 */
const static QString SinkInterface = QStringLiteral("org.lingmo.ocean.Audio1.Sink");

/**
 * @brief SourceInterface 音频输入接口名称 org.lingmo.ocean.Audio1.Source
 */
const static QString SourceInterface = QStringLiteral("org.lingmo.ocean.Audio1.Source");

#else
const static QString AudioService = QStringLiteral("com.lingmo.daemon.Audio");
const static QString AudioPath = QStringLiteral("/com/lingmo/daemon/Audio");
const static QString AudioInterface = QStringLiteral("com.lingmo.daemon.Audio");
const static QString SinkInterface = QStringLiteral("com.lingmo.daemon.Audio.Sink");
const static QString SourceInterface = QStringLiteral("com.lingmo.daemon.Audio.Source");
#endif
/**
...
private:
    /**
     * @brief 音频服务dbus接口
     * 对应为 (org.lingmo.ocean.Audio)
     */
    QDBusInterface *m_audioDBusInterface = nullptr;

    /**
     * @brief 音频源(默认音频输入源接口)
     * 对应为 (org.lingmo.ocean.Audio.Source)
     */
    QDBusInterface *m_defaultSourceDBusInterface = nullptr;

    /**
     * @brief 音频源(默认音频输入源接口)
     * 对应为 (org.lingmo.ocean.Audio.Sink)
     */
    QDBusInterface *m_defaultSinkDBusInterface = nullptr;
    /**
     * @brief 默认输入音频服务地址 org.lingmo.ocean.Audio1.SourceX  X---序号
     */
    QString m_defaultSourcePath;

    /**
     * @brief 默认输出音频服务地址 org.lingmo.ocean.Audio1.SinkX  X---序号
     */
