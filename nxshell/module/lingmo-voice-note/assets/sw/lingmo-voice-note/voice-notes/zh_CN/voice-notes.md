...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到语音记事本图标 ![lingmo_voice_note](../common/lingmo_voice_note.svg)，单击运行。
3. 右键单击 ![lingmo_voice_note](../common/lingmo_voice_note.svg)，您可以：
...
- 在任务栏右键单击 ![lingmo_voice_note](../common/lingmo_voice_note.svg)，选择 **关闭所有**，退出语音记事本。
