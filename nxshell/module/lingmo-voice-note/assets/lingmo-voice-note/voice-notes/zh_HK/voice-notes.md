...
2. 上下滾動鼠標滾輪瀏覽或通過搜索，找到語音記事本圖標 ![lingmo_voice_note](../common/lingmo_voice_note.svg)，單擊運行。
3. 右鍵單擊 ![lingmo_voice_note](../common/lingmo_voice_note.svg)，您可以：
...
- 在任務欄右鍵單擊 ![lingmo_voice_note](../common/lingmo_voice_note.svg)，選擇 **關閉所有**，退出語音記事本。
