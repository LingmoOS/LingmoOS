...
2. Locate Voice Notes![lingmo_voice_note](../common/lingmo_voice_note.svg) by scrolling the mouse wheel or searching "voice notes" in the Launcher interface, and click it to run.
3. Right-click ![lingmo_voice_note](../common/lingmo_voice_note.svg), and you can:
   - Click **Send to desktop** to create a desktop shortcut.
   - Click **Send to dock** to fix it in the Dock.
   - Click **Add to startup** to add the application to startup, and it will automatically run when the system starts up.

> ![notes](../common/notes.svg) Notes: If Voice Notes has been fixed in the Dock by default, you can click ![lingmo_voice_note](../common/lingmo_voice_note.svg) in the Dock to run it.

### Exit Voice Notes

- Click ![close](../common/close_icon.svg) on the Voice Notes interface to exit Voice Notes.
- Right-click ![lingmo_voice_note](../common/lingmo_voice_note.svg) in the Dock, and select **Close All** to exit.
