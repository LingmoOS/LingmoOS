    ...
    : QObject(parent)
{
    ...
    static const QString &Service = QStringLiteral("com.lingmo.daemon.FakeTimeDate1");
    static const QString &Path = QStringLiteral("/com/lingmo/daemon/FakeTimeDate1");
    static const QString &Interface = QStringLiteral("com.lingmo.daemon.FakeTimeDate1");
