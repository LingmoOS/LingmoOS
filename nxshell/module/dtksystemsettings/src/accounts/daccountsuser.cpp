    ...
    : q_ptr(parent)
{
    ...
    const auto &freeDesktopPath = "/com/lingmo/daemon/FakeAccounts/User" + QString::number(uid);
    const auto &daemonPath = "/com/lingmo/daemon/FakeAccounts/User" + QString::number(uid);
#else
    const auto &freeDesktopPath = "/org/freedesktop/Accounts/User" + QString::number(uid);
    const auto &daemonPath = "/org/lingmo/ocean/Accounts1/User" + QString::number(uid);
#endif
