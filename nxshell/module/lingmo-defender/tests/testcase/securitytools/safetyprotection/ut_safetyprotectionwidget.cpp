...
TEST_F(SafetyProtectionWidgetTest, Sample)
{
    ...
    factory.setInvokerInteface("com.lingmo.defender.datainterface", &dataInterface);
    factory.setInvokerInteface("com.lingmo.defender.MonitorNetFlow", &monitorInterface);
    factory.setInvokerInteface("com.lingmo.defender.hmiscreen", &hmiInterface);
    factory.setSettinsInteface("com.lingmo.ocean.lingmo-defender", &settingsInterface);
