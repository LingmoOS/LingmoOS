...
#include "ut_loginsafetywidget.h"
...
#include "../src/window/modules/securitytools/loginsafety/loginsafetymodel.h"
#include "../src/window/modules/securitytools/loginsafety/loginsafetywidget.h"
#include "../src/window/modules/securitytools/loginsafety/pwdlevelchangeddlg.h"

using namespace testing;

LoginSafetyWidgetTest::LoginSafetyWidgetTest()
{
}

void LoginSafetyWidgetTest::SetUp()
{
}

void LoginSafetyWidgetTest::TearDown()
{
}

TEST_F(LoginSafetyWidgetTest, Sample)
{
    ...
    factory.setInvokerInteface("com.lingmo.defender.datainterface", &defenderDataMockInter);
    factory.setInvokerInteface("com.lingmo.ocean.ControlCenter", &controlCenterMockInter);
    factory.setSettinsInteface(LINGMO_DEFENDER_GSETTING_PATH, &gSettingsMockInter);
    ...
    LoginSafetyModel model(&factory);
    LoginSafetyWidget widget(&model);
    PwdLevelChangedDlg dlg;
}
