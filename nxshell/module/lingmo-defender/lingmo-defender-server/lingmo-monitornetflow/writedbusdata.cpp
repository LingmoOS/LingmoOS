    ...
    , m_isInitSqlDatabase(false)
{
    ...
    // 扫描冗余文件并删除
    scanFile("/usr/share/lingmo-defender/config/");
...
void WriteDBusData::initLocalCache()
{
    ...
    m_localCacheDb.setDatabaseName("/usr/share/lingmo-defender/localcache.db");
    m_localCacheDb.setUserName("root");
    m_localCacheDb.setPassword("lingmo-defender");
