...
TARGET = lingmo-MonitorNetFlow
TEMPLATE = app
CONFIG += c++11 link_pkgconfig
PKGCONFIG += dtkwidget dframeworkdbus gsettings-qt

INCLUDEPATH += \
    ../lingmo-defender-datainterface/window/modules/common \
...
dbus.files += \
    com.lingmo.defender.MonitorNetFlow.xml
dbus.header_flags += \
...
DISTFILES += \
    com.lingmo.defender.MonitorNetFlow.xml \
    com.lingmo.defender.MonitorNetFlow.conf

message("current dir:" + $$PWD)
system_dbus_conf.files += \
    $$PWD/com.lingmo.defender.MonitorNetFlow.conf
system_dbus_conf.path = /usr/share/dbus-1/system.d

install_service.files += \
    $$PWD/com.lingmo.defender.MonitorNetFlow.service
