...
#include "com_lingmo_daemon_resourcemanager.h"
#include "com_lingmo_ocean_daemon_launcherd.h"
...
using ResourceManagerInter = com::lingmo::daemon::ResourceManager;
using LauncherInter = com::lingmo::ocean::daemon::Launcher;
using MonitorNetFlow = com::lingmo::defender::MonitorNetFlow;
using DataInterFace = com::lingmo::defender::datainterface;
