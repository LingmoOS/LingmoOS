...
SocketCreateManager::SocketCreateManager(QObject *parent)
    : QObject(parent)
    , m_gsNetControl(new QGSettings("com.lingmo.ocean.lingmo-defender", QByteArray(), this))
    , m_resourceManagerInter(new ResourceManagerInter("com.lingmo.daemon.ResourceManager", "/com/lingmo/daemon/ResourceManager", QDBusConnection::systemBus(), this))
    , m_launcherInter(new LauncherInter("com.lingmo.ocean.daemon.Launcher", "/com/lingmo/ocean/daemon/Launcher", QDBusConnection::sessionBus(), this))
    , m_monitornetflow(new MonitorNetFlow("com.lingmo.defender.MonitorNetFlow", "/com/lingmo/defender/MonitorNetFlow", QDBusConnection::systemBus(), this))
    , m_dataInterFace(new DataInterFace("com.lingmo.defender.datainterface", "/com/lingmo/defender/datainterface", QDBusConnection::sessionBus(), this))
...
void SocketCreateManager::setNetControlSwitchStatus(bool isNetStatus)
{
    ...
    if (isNetStatus && !m_isbRegisterStatus) {
        ...
        m_uuid = m_resourceManagerInter->SubscribeControl(nPid, sCmd, "lingmo-defender", interest);
