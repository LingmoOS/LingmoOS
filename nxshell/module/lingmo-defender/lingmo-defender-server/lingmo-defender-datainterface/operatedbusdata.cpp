...
#include "common.h"
#include "../../lingmo-defender/src/window/modules/common/common.h"
#include "../../lingmo-defender/src/window/modules/common/invokers/invokerfactory.h"
#include "../../lingmo-defender/src/window/modules/common/invokers/invokerinterface.h"
...
const QString WhitePathsFile = "/usr/share/lingmo-defender/cleanerwhite.json";
const QString appPathsFile = "/usr/share/lingmo-defender/appInfomation.json";
...
OperateDBusData::OperateDBusData(QObject *parent)
    : QObject(parent)
    , m_gsetting(new QGSettings(LINGMO_DEFENDER_GSETTING_PATH, QByteArray(), this))
    , m_adaptpr(nullptr)
    ...
    , m_launcherInter(new Launcherd("com.lingmo.ocean.daemon.Launcher", "/com/lingmo/ocean/daemon/Launcher", QDBusConnection::sessionBus(), this))
    , m_startManagerInterface(new DBusStartManager)
    , m_monitorNetFlowInter(nullptr)
    , m_managerInter(new LastoreManager("com.lingmo.lastore", "/com/lingmo/lastore", QDBusConnection::systemBus(), this))
    ...
    , m_resourceManagerInvokerInter(nullptr)
{
    ...
    m_monitorNetFlowInter = new NetFlowMonitorInter("com.lingmo.defender.MonitorNetFlow",
                                                    "/com/lingmo/defender/MonitorNetFlow",
    ...
    m_resourceManagerInvokerInter = factory->CreateInvoker("com.lingmo.daemon.ResourceManager",
                                                           "/com/lingmo/daemon/ResourceManager",
                                                           "com.lingmo.daemon.ResourceManager",
...
{
    QDBusMessage m = QDBusMessage::createMethodCall("com.lingmo.ocean.Notification", "/com/lingmo/ocean/Notification", "com.lingmo.ocean.Notification", "Notify");
    QStringList action;
    action << "_open1" << tr("Settings"); //添加按钮
    QVariantMap inform; //按钮的点击操作
    QString openSysSafetyPageCmd = QString("qdbus,com.lingmo.defender.hmiscreen,"
                                           "/com/lingmo/defender/hmiscreen,"
                                           "com.lingmo.defender.hmiscreen.ShowPage,"
                                           "%1,%2")
                                       .arg(MODULE_SECURITY_TOOLS_NAME)
                                       .arg(USB_CONN_NAME);

    inform.insert(QString("x-lingmo-action-_open1"), openSysSafetyPageCmd);
