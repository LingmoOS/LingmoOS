...
const QString service = "com.lingmo.defender.daemonservice";
const QString path = "/com/lingmo/defender/daemonservice";
...
ServiceDBus::ServiceDBus(QObject *parent)
    : QObject(parent)
    , m_adaptor(nullptr)
    , m_monitornetflow(new MonitorNetFlow("com.lingmo.defender.MonitorNetFlow", "/com/lingmo/defender/MonitorNetFlow",
                                          QDBusConnection::systemBus(), this))
    , m_hmiscreenServer(new HmiscreenServer("com.lingmo.defender.hmiscreen", "/com/lingmo/defender/hmiscreen",
                                            QDBusConnection::sessionBus(), this))
    , m_DataInterFaceServer(new DataInterFaceServer("com.lingmo.defender.datainterface", "/com/lingmo/defender/datainterface",
                                                    QDBusConnection::sessionBus(), this))
    , m_defenderSetting(new QGSettings(LINGMO_DEFENDER_GSETTING_PATH, QByteArray(), this))
