...
#include "../../lingmo-defender/src/window/modules/common/comdata.h"
...
using HmiscreenServer = com::lingmo::defender::hmiscreen;
using MonitorNetFlow = com::lingmo::defender::MonitorNetFlow;

// 病毒查杀服务接口
using DaemonService = com::lingmo::defender::daemonservice;

using DataInterFaceServer = com::lingmo::defender::datainterface;
