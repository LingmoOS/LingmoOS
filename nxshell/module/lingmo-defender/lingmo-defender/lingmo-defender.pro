...
INCLUDEPATH += src \
    ../lingmo-defender-server/lingmo-monitornetflow/usbconnection \
...
SOURCES += \
        ...
        src/widgets/oceanuislider.cpp \
        src/widgets/oceanuisliderannotated.cpp \
...
HEADERS += \
        ...
        src/widgets/oceanuislider.h \
        src/widgets/oceanuisliderannotated.h \
...
# 界面dbus接口相关文件
hmiscreendbus.files = com.lingmo.defender.hmiscreen.xml
# 心跳服务dbus接口相关文件
daemonservicedbus.files = ../lingmo-defender-server/lingmo-defender-daemonservice/com.lingmo.defender.daemonservice.xml
# 数据处理dbus接口相关文件
datainterfacedbus.files = ../lingmo-defender-server/lingmo-defender-datainterface/com.lingmo.defender.datainterface.xml
datainterfacedbus.header_flags += \
        -i ../lingmo-defender-server/lingmo-defender-datainterface/window/modules/common/defenderprocinfolist.h \
...
# 流量监控dbus接口相关文件
monitornetflowdbus.files = ../lingmo-defender-server/lingmo-monitornetflow/com.lingmo.defender.MonitorNetFlow.xml
...
install_desktop.files = ./lingmo-defender.desktop
install_desktop.path = $${PREFIX}/share/applications

install_qm.files = ./translations/*.qm
install_qm.path = $${PREFIX}/share/lingmo-defender/translations

install_service.files = ./com.lingmo.defender.hmiscreen.service
install_service.path = $${PREFIX}/share/dbus-1/services

install_docs.files = ./docs/*
install_docs.path = $${PREFIX}/share/dman/lingmo-denfender

icon.path = /usr/share/icons/hicolor/scalable/apps
icon.files = $$PWD/src/window/icons/icons/lingmo-defender.svg

polkit.path = /usr/share/polkit-1/actions
polkit.files = $$PWD/com.lingmo.lingmo-defender.policy

# 安装垃圾清理白名单配置文件
whitepaths.path = /usr/share/lingmo-defender
whitepaths.files = $$PWD/cleanerwhite.json

# 安装垃圾清理应用垃圾清单
appInfomation.path = /usr/share/lingmo-defender
appInfomation.files = $$PWD/appInfomation.json

# 帮助手册
manual_dir.files = $$PWD/assets/lingmo-defender
