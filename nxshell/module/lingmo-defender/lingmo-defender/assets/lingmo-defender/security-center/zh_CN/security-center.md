...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到安全中心图标![lingmo_defender](../common/lingmo_defender.svg) ，单击运行  。
3. 右键单击 ![lingmo_defender](../common/lingmo_defender.svg)，您可以：
   - 单击 **发送到桌面**，在桌面创建快捷方式。
...
- 右键单击任务栏上的 ![lingmo_defender](../common/lingmo_defender.svg)，选择 **关闭所有** 来退出安全中心。
