...
1. 單擊任務欄上的啟動器 ![lingmo-launcher](../common/lingmo_launcher.svg)，進入啟動器介面。
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到「安全中心」按鈕 ![lingmo_defender](../common/lingmo_defender.svg)，單擊開啟。彈出授權框，需要輸入系統登錄密碼進行認證。
...
- 右鍵單擊任務欄上的 ![lingmo_defender](../common/lingmo_defender.svg) 圖示，選擇 **全部關閉** 來關閉安全中心。
