...
2. Locate ![lingmo_defender](../common/lingmo_defender.svg) by scrolling mouse wheel or searching by "Security Center" in Launcher interface. Click ![lingmo_defender](../common/lingmo_defender.svg) to run. An authentication window pops up. Please input the password to go on.
...
- Right-click ![lingmo_defender](../common/lingmo_defender.svg) on Dock, select **Close All** to exit.
