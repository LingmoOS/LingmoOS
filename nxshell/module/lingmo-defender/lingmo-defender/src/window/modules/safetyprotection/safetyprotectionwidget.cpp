    ...
    , m_hmiScreen(nullptr)
{
    ...
    m_monitorInterFaceServer = factory->CreateInvoker("com.lingmo.defender.MonitorNetFlow", "/com/lingmo/defender/MonitorNetFlow", "com.lingmo.defender.MonitorNetFlow", ConnectType::SYSTEM, this);
    m_dataInterFaceServer = factory->CreateInvoker("com.lingmo.defender.datainterface", "/com/lingmo/defender/datainterface", "com.lingmo.defender.datainterface", ConnectType::SESSION, this);
    m_hmiScreen = factory->CreateInvoker("com.lingmo.defender.hmiscreen", "/com/lingmo/defender/hmiscreen", "com.lingmo.defender.hmiscreen", ConnectType::SESSION, this);
    // 初始化安全中心gsetting配置
    m_gsetting = factory->CreateSettings("com.lingmo.ocean.lingmo-defender", QByteArray(), this);
