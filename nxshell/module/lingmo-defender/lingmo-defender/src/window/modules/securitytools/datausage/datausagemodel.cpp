...
{
    m_monitorInterFaceServer = invokerFactory->CreateInvoker("com.lingmo.defender.MonitorNetFlow",
                                                             "/com/lingmo/defender/MonitorNetFlow",
                                                             "com.lingmo.defender.MonitorNetFlow",
                                                             ConnectType::SYSTEM, this);
    m_dataInterFaceServer = invokerFactory->CreateInvoker("com.lingmo.defender.datainterface",
                                                             "/com/lingmo/defender/datainterface",
                                                             "com.lingmo.defender.datainterface",
                                                             ConnectType::SESSION, this);
    m_gsNetControl = invokerFactory->CreateSettings("com.lingmo.ocean.lingmo-defender", QByteArray(), this);
