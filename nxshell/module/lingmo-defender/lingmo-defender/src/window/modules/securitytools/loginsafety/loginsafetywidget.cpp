...
#include "../src/widgets/oceanuislider.h"
...
void LoginSafetyWidget::initUI()
{
    ...
    m_highLevelItem->setIcon(QIcon::fromTheme("oceanui_security_level_high"));
    ...
    m_mediumLevelItem->setIcon(QIcon::fromTheme("oceanui_security_level_medium"));
    ...
    m_lowLevelItem->setIcon(QIcon::fromTheme("oceanui_security_level_low"));
