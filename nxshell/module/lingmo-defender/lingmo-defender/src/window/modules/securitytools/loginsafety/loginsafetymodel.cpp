...
{
    if (invokeFactory) {
        m_gSettingsInvokerInter = invokeFactory->CreateSettings(LINGMO_DEFENDER_GSETTING_PATH, "", this);
        m_defenderDataInvokerInter = invokeFactory->CreateInvoker("com.lingmo.defender.datainterface",
                                                                  "/com/lingmo/defender/datainterface",
                                                                  "com.lingmo.defender.datainterface",
                                                                  ConnectType::SESSION, this);
        m_controlCenterInvokerInter = invokeFactory->CreateInvoker("com.lingmo.ocean.ControlCenter",
