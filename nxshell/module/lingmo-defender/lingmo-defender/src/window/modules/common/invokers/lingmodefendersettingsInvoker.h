...
class LingmoDefenderSettingsInvoker : public QObject
    , public SettingsInvokerInterface
{
    Q_OBJECT
public:
    explicit LingmoDefenderSettingsInvoker(const QByteArray &schema_id, const QByteArray &path = QByteArray(), QObject *parent = nullptr);
