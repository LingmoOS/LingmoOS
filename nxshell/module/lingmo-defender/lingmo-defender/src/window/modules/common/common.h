...
// 流量监控配置文件路径
#define NET_MONITOR_CONFIG_PATH "/opt/lingmo-defender/file/config/net-monitor.ini" // 回收站路径
// 应用流量参数
struct NetFlowData {
    QString sPkgName;
    QString sExecPath;
...
// 缓存数据地址
#define DEFENDER_LOCAL_CACHE_DB_PATH "/usr/share/lingmo-defender/localcache.db"
// 数据库相关
...
// 配置目录
#define USB_CONTROL_CONFIG_DIR "/usr/share/lingmo-defender/config/"
// 配置文件名
