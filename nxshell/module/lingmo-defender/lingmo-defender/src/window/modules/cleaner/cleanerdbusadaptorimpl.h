...
class ComLingmoDefenderDatainterfaceInterface;
class ComLingmoDefenderMonitorNetFlowInterface;
class QGSettings;
...
public:
    ...
    // 后台服务：lingmo-defender-datainterface
...
private:
    // 后台服务接口
    ComLingmoDefenderDatainterfaceInterface *m_dataInterFaceServer;
    ComLingmoDefenderMonitorNetFlowInterface *m_monitorInterFaceServer;
