...
{
    m_dataInterFaceServer = new ComLingmoDefenderDatainterfaceInterface("com.lingmo.defender.datainterface",
                                                                        "/com/lingmo/defender/datainterface",
                                                                        QDBusConnection::sessionBus(), this);
    m_monitorInterFaceServer = new ComLingmoDefenderMonitorNetFlowInterface("com.lingmo.defender.MonitorNetFlow",
                                                                            "/com/lingmo/defender/MonitorNetFlow",
                                                                            QDBusConnection::systemBus(), this);

    m_gsettings = new QGSettings(LINGMO_DEFENDER_GSETTING_PATH, QByteArray(), this);
}
