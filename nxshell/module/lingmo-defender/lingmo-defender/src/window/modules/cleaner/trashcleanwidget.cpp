...
#include "../../lingmo-defender/src/window/modules/common/compixmap.h"
#include "../../lingmo-defender/src/window/modules/common/gsettingkey.h"
#include "../../lingmo-defender/src/widgets/scoreprogressbar.h"
#include "../../lingmo-defender/src/widgets/cleaneritem.h"
#include "../../lingmo-defender/src/widgets/titlelabel.h"
#include "../../lingmo-defender/src/widgets/titlebuttonitem.h"
#include "../../lingmo-defender/src/widgets/labels/tipslabel.h"
#include "../../lingmo-defender/src/widgets/labels/smalllabel.h"
...
void TrashCleanWidget::initHeaderFrame()
{
    ...
    DFontSizeManager::instance()->bind(m_headerTitle, DFontSizeManager::T5);
    ...
    DFontSizeManager::instance()->bind(m_tipTitle, DFontSizeManager::T8);
    // 字体样式
    QPalette pal;
    ...
    DFontSizeManager::instance()->bind(m_scanTime, DFontSizeManager::T8);
...
void TrashCleanWidget::addAppCheckItems()
{
    ...
    foreach (auto app, appArr) {
        ...
        addChildItem(APP_CHECK_INDEX, app[CLEANER_APP_TIP].toString(), QString(""), paths, isInstalled);
    }
}
...
void TrashCleanWidget::addBrowserCookies()
{
    ...
    foreach (auto app, appArr) {
        ...
        addChildItem(BROWSER_CACHE_CHECK_INDEX, app[CLEANER_APP_TIP].toString(), tr(""), paths);
    }
}
...
void TrashCleanWidget::addChildItem(int rootIndex, QString title, QString tip, QList<QStringList> paths, bool isInstalled)
{
...
void TrashCleanWidget::addChildItem(int rootIndex, QString title, QString tip, QStringList paths)
{
    if (rootIndex >= m_rootItems.size() || rootIndex < 0)
        return;
    TrashCleanItem *item = new TrashCleanItem(m_rootItems[rootIndex]);
