...
#define DBUS_SERVER "com.lingmo.defender.MonitorNetFlow"
#define DBUS_PATH "/com/lingmo/defender/MonitorNetFlow"
...
SecurityLogAdaptorImpl::SecurityLogAdaptorImpl(QObject *parent)
    : QObject(parent)
{
    m_monitorInterface = new ComLingmoDefenderMonitorNetFlowInterface(DBUS_SERVER,
                                                                      DBUS_PATH,
