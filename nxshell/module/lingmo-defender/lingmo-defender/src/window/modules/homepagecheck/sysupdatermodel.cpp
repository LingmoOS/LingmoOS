    ...
    , m_checkUpdateJobTimer(nullptr)
{
    if (m_Invokerfactory) {
        // 系统更新管理器dbus服务
        m_managerInvokerInter = m_Invokerfactory->CreateInvoker("com.lingmo.lastore",
                                                                "/com/lingmo/lastore",
                                                                "com.lingmo.lastore.Manager",
                                                                ConnectType::SYSTEM, this);
        // 系统更新dbus服务
        m_updaterInvokerInter = m_Invokerfactory->CreateInvoker("com.lingmo.lastore",
                                                                "/com/lingmo/lastore",
                                                                "com.lingmo.lastore.Updater",
                                                                ConnectType::SYSTEM, this);
    }
...
{
    m_checkUpdateJobInvokerInter = m_Invokerfactory->CreateInvoker("com.lingmo.lastore",
                                                                   jobPath,
