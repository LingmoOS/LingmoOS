...
#include "com_lingmo_lastore_updater.h"
#include "com_lingmo_lastore_job.h"
...
using ManagerInter = com::lingmo::lastore::Manager;
using UpdaterInter = com::lingmo::lastore::Updater;
using JobInter = com::lingmo::lastore::Job;
