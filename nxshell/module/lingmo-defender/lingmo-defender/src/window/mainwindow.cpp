...
MainWindow::MainWindow(QWidget *parent)
    ...
    , m_dataInterFaceServer(new DataInterFaceServer("com.lingmo.defender.datainterface", "/com/lingmo/defender/datainterface", QDBusConnection::sessionBus(), this))
    , m_daemonservice(new DaemonService("com.lingmo.defender.daemonservice", "/com/lingmo/defender/daemonservice", QDBusConnection::sessionBus(), this))
    , m_monitorInterFaceServer(new MonitorInterFaceServer("com.lingmo.defender.MonitorNetFlow", "/com/lingmo/defender/MonitorNetFlow", QDBusConnection::systemBus(), this))
    , m_guiHelper(nullptr)
{
    ...
    // 初始化安全中心gsetting配置
    m_gsetting = new QGSettings("com.lingmo.ocean.lingmo-defender", QByteArray(), this);
    // 设置安装时间
    setInstallTime();
...
{
    //Set the newly aoceand page to fill the blank area
