...
BOOT_WRAPPER_AARCH64_DTB = $(LINUX_DIR)/arch/arm64/boot/dts/$(basename $(call qstrip,$(LINGMO_TARGET_BOOT_WRAPPER_AARCH64_DTS))).dtb

BOOT_WRAPPER_AARCH64_CONF_OPTS = \
	--with-kernel-dir=$(LINUX_DIR) \
	--with-dtb=$(BOOT_WRAPPER_AARCH64_DTB) \
	--with-cmdline=$(LINGMO_TARGET_BOOT_WRAPPER_AARCH64_BOOTARGS)

ifeq ($(LINGMO_TARGET_BOOT_WRAPPER_AARCH64_PSCI),y)
BOOT_WRAPPER_AARCH64_CONF_OPTS += --enable-psci
else
BOOT_WRAPPER_AARCH64_CONF_OPTS += --disable-psci
endif

ifeq ($(LINGMO_TARGET_BOOT_WRAPPER_AARCH64_GICV3),y)
