...
ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_TARBALL),y)
MXS_BOOTLETS_TARBALL = $(call qstrip,$(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_TARBALL_URL))
...
else ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_GIT),y)
MXS_BOOTLETS_SITE = $(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_GIT_URL)
MXS_BOOTLETS_SITE_METHOD = git
MXS_BOOTLETS_VERSION = $(call qstrip,$(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_GIT_VERSION))
BR_NO_CHECK_HASH_FOR += $(MXS_BOOTLETS_SOURCE)
else
...
ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_STMP37xx),y)
MXS_BOOTLETS_BOARD = stmp37xx_dev
else ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_STMP378x),y)
MXS_BOOTLETS_BOARD = stmp378x_dev
else ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_IMX28EVK),y)
MXS_BOOTLETS_BOARD = iMX28_EVK
else ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_BOARD),y)
MXS_BOOTLETS_BOARD = $(call qstrip,$(LINGMO_TARGET_MXS_BOOTLETS_CUSTOM_BOARD_NAME))
endif

ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_HAS_IVT),y)
...
ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_BAREBOX),y)
...
else ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_LINUX),y)
...
else ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_UBOOT),y)
...
ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_LINUX),y)
...
ifeq ($(LINGMO_TARGET_MXS_BOOTLETS_UBOOT),y)
