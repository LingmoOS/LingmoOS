...
AT91BOOTSTRAP_BOARD = $(call qstrip,$(LINGMO_TARGET_AT91BOOTSTRAP_BOARD))
AT91BOOTSTRAP_MEMORY = $(call qstrip,$(LINGMO_TARGET_AT91BOOTSTRAP_MEMORY))
...
ifneq ($(call qstrip,$(LINGMO_TARGET_AT91BOOTSTRAP_CUSTOM_PATCH_DIR)),)
define AT91BOOTSTRAP_APPLY_CUSTOM_PATCHES
	$(APPLY_PATCHES) $(@D) $(LINGMO_TARGET_AT91BOOTSTRAP_CUSTOM_PATCH_DIR) \*.patch
endef
...
ifeq ($(LINGMO_TARGET_AT91BOOTSTRAP)$(BR_BUILDING),yy)
ifeq ($(AT91BOOTSTRAP_BOARD),)
$(error No AT91Bootstrap board name set. Check your LINGMO_TARGET_AT91BOOTSTRAP_BOARD setting)
endif
endif
