...
ifeq ($(LINGMO_TARGET_EDK2_OVMF_DEBUG_ON_SERIAL),y)
...
ifeq ($(LINGMO_TARGET_EDK2_PLATFORM_OVMF_I386),y)
EDK2_ARCH = IA32
...
else ifeq ($(LINGMO_TARGET_EDK2_PLATFORM_OVMF_X64),y)
EDK2_ARCH = X64
EDK2_DEPENDENCIES += host-nasm
EDK2_PACKAGE_NAME = OvmfPkg
...
else ifeq ($(LINGMO_TARGET_EDK2_PLATFORM_SOLIDRUN_ARMADA80X0MCBIN),y)
EDK2_ARCH = AARCH64
...
else ifeq ($(LINGMO_TARGET_EDK2_PLATFORM_QEMU_SBSA),y)
EDK2_ARCH = AARCH64
...
else ifeq ($(LINGMO_TARGET_EDK2_PLATFORM_OVMF_RISCV),y)
EDK2_ARCH = RISCV64
