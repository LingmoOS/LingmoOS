...
ifeq ($(LINGMO_TARGET_GRUB2_INSTALL_TOOLS),y)
...
GRUB2_BUILTIN_MODULES_PC = $(call qstrip,$(LINGMO_TARGET_GRUB2_BUILTIN_MODULES_PC))
GRUB2_BUILTIN_MODULES_EFI = $(call qstrip,$(LINGMO_TARGET_GRUB2_BUILTIN_MODULES_EFI))
GRUB2_BUILTIN_CONFIG_PC = $(call qstrip,$(LINGMO_TARGET_GRUB2_BUILTIN_CONFIG_PC))
GRUB2_BUILTIN_CONFIG_EFI = $(call qstrip,$(LINGMO_TARGET_GRUB2_BUILTIN_CONFIG_EFI))
GRUB2_BOOT_PARTITION = $(call qstrip,$(LINGMO_TARGET_GRUB2_BOOT_PARTITION))
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_I386_PC) += i386-pc
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_I386_EFI) += i386-efi
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_X86_64_EFI) += x86_64-efi
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_ARM_UBOOT) += arm-uboot
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_ARM_EFI) += arm-efi
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_ARM64_EFI) += arm64-efi
...
GRUB2_TUPLES-$(LINGMO_TARGET_GRUB2_RISCV64_EFI) += riscv64-efi
...
#
# NOTE: TARGET_STRIP is overridden by !LINGMO_STRIP_strip, so always
