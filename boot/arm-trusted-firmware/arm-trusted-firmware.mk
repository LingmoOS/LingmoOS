...
ARM_TRUSTED_FIRMWARE_VERSION = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_VERSION))

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_TARBALL),y)
# Handle custom ATF tarballs as specified by the configuration
ARM_TRUSTED_FIRMWARE_TARBALL = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_TARBALL_LOCATION))
...
else ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_GIT),y)
ARM_TRUSTED_FIRMWARE_SITE = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_REPO_URL))
...
ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_LATEST_VERSION),y)
ARM_TRUSTED_FIRMWARE_LICENSE = BSD-3-Clause
ARM_TRUSTED_FIRMWARE_LICENSE_FILES = docs/license.rst
endif
endif

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE):$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_VERSION)$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_TARBALL)$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_GIT),y:y)
BR_NO_CHECK_HASH_FOR += $(ARM_TRUSTED_FIRMWARE_SOURCE)
endif

ARM_TRUSTED_FIRMWARE_INSTALL_IMAGES = YES

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_NEEDS_DTC),y)
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += host-dtc
endif

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_NEEDS_ARM32_TOOLCHAIN),y)
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += host-arm-gnu-toolchain
endif

ARM_TRUSTED_FIRMWARE_PLATFORM = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_PLATFORM))

ARM_TRUSTED_FIRMWARE_TARGET_BOARD = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_TARGET_BOARD))

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_DEBUG),y)
...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += \
	...
	$(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_ADDITIONAL_VARIABLES)) \
	PLAT=$(ARM_TRUSTED_FIRMWARE_PLATFORM) \
	TARGET_BOARD=$(ARM_TRUSTED_FIRMWARE_TARGET_BOARD) \
	HOSTCC="$(HOSTCC) $(HOST_CFLAGS) $(HOST_LDFLAGS)"

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_SSP),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += \
	ENABLE_STACK_PROTECTOR=$(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_SSP_LEVEL))
else
...
ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_BL32_OPTEE),y)
...
endif # LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_BL32_OPTEE

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_BAREBOX_AS_BL33),y)
ARM_TRUSTED_FIRMWARE_BAREBOX_BIN = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_BAREBOX_BL33_IMAGE))
...
ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_EDK2_AS_BL33),y)
...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += \
	BL33=$(BINARIES_DIR)/$(call qstrip,$(LINGMO_TARGET_EDK2_FD_NAME).fd)
endif

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_UBOOT_AS_BL33),y)
ARM_TRUSTED_FIRMWARE_UBOOT_BIN = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_UBOOT_BL33_IMAGE))
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += BL33=$(BINARIES_DIR)/$(ARM_TRUSTED_FIRMWARE_UBOOT_BIN)
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += uboot
endif

ifeq ($(LINGMO_TARGET_VEXPRESS_FIRMWARE),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += SCP_BL2=$(BINARIES_DIR)/scp-fw.bin
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += vexpress-firmware
endif

ifeq ($(LINGMO_TARGET_BINARIES_MARVELL),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += SCP_BL2=$(BINARIES_DIR)/scp-fw.bin
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += binaries-marvell
endif

ifeq ($(LINGMO_TARGET_MV_DDR_MARVELL),y)
...
ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_FIP),y)
ARM_TRUSTED_FIRMWARE_MAKE_TARGETS += fip
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += host-openssl
endif

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_RCW),y)
...
ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_BL31),y)
ARM_TRUSTED_FIRMWARE_MAKE_TARGETS += bl31
endif

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_BL31_UBOOT),y)
...
ARM_TRUSTED_FIRMWARE_MAKE_TARGETS += \
	$(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_ADDITIONAL_TARGETS))

ARM_TRUSTED_FIRMWARE_CUSTOM_DTS_PATH = $(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DTS_PATH))
...
define ARM_TRUSTED_FIRMWARE_INSTALL_IMAGES_CMDS
	$(foreach f,$(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_IMAGES)), \
...
# Configuration check
ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE)$(BR_BUILDING),yy)

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_TARBALL),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_TARBALL_LOCATION)),)
$(error No tarball location specified. Please check LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_TARBALL_LOCATION)
endif
endif

ifeq ($(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_GIT),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_REPO_URL)),)
$(error No repository specified. Please check LINGMO_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_REPO_URL)
endif
endif
