...
UBOOT_VERSION = $(call qstrip,$(LINGMO_TARGET_UBOOT_VERSION))
UBOOT_BOARD_NAME = $(call qstrip,$(LINGMO_TARGET_UBOOT_BOARDNAME))

UBOOT_LICENSE = GPL-2.0+
ifeq ($(LINGMO_TARGET_UBOOT_LATEST_VERSION),y)
...
UBOOT_DEPENDENCIES = host-pkgconf $(LINGMO_MAKE_HOST_DEPENDENCY)
UBOOT_MAKE = $(LINGMO_MAKE)

ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_TARBALL),y)
# Handle custom U-Boot tarballs as specified by the configuration
UBOOT_TARBALL = $(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_TARBALL_LOCATION))
UBOOT_SITE = $(patsubst %/,%,$(dir $(UBOOT_TARBALL)))
UBOOT_SOURCE = $(notdir $(UBOOT_TARBALL))
else ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_GIT),y)
UBOOT_SITE = $(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_REPO_URL))
UBOOT_SITE_METHOD = git
else ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_HG),y)
UBOOT_SITE = $(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_REPO_URL))
UBOOT_SITE_METHOD = hg
else ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_SVN),y)
UBOOT_SITE = $(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_REPO_URL))
...
ifeq ($(LINGMO_TARGET_UBOOT)$(LINGMO_TARGET_UBOOT_LATEST_VERSION),y)
BR_NO_CHECK_HASH_FOR += $(UBOOT_SOURCE)
endif

ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_BIN),y)
UBOOT_BINS += u-boot.bin
endif

ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_DTB),y)
UBOOT_BINS += u-boot.dtb
endif

ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_ELF),y)
UBOOT_BINS += u-boot
...
ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_REMAKE_ELF),y)
...
ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_SD),y)
...
ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_NAND),y)
UBOOT_BINS += u-boot.nand
UBOOT_MAKE_TARGET += u-boot.sb
UBOOT_DEPENDENCIES += host-elftosb host-openssl
endif

ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_STM32),y)
UBOOT_BINS += u-boot.stm32
ifeq ($(LINGMO_TARGET_UBOOT_BUILD_FORMAT_STM32_LEGACY),y)
UBOOT_MAKE_TARGET += u-boot.stm32
endif
endif

ifeq ($(LINGMO_TARGET_UBOOT_FORMAT_CUSTOM),y)
UBOOT_BINS += $(call qstrip,$(LINGMO_TARGET_UBOOT_FORMAT_CUSTOM_NAME))
endif

ifeq ($(LINGMO_TARGET_UBOOT_OMAP_IFT),y)
UBOOT_BINS += u-boot.bin
...
UBOOT_MAKE_OPTS += \
	...
	$(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_MAKEOPTS))

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_ATF_BL31),y)
UBOOT_DEPENDENCIES += arm-trusted-firmware
ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_ATF_BL31_ELF),y)
...
ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_OPTEE_TEE),y)
UBOOT_DEPENDENCIES += optee-os
UBOOT_MAKE_OPTS += TEE=$(BINARIES_DIR)/tee.elf
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_TI_K3_DM),y)
UBOOT_TI_K3_DM_SOCNAME = $(call qstrip,$(LINGMO_TARGET_UBOOT_TI_K3_DM_SOCNAME))
...
ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_OPENSBI),y)
...
ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_IMX_FIRMWARE),y)
UBOOT_DEPENDENCIES += firmware-imx
UBOOT_IMX_FW_FILES = \
	$(if $(LINGMO_PACKAGE_FIRMWARE_IMX_NEEDS_HDMI_FW),signed_hdmi_imx8m.bin) \
	$(if $(LINGMO_PACKAGE_FIRMWARE_IMX_LPDDR4),lpddr4*.bin) \
	$(if $(LINGMO_PACKAGE_FIRMWARE_IMX_DDR4),ddr4*.bin) \
	$(if $(LINGMO_PACKAGE_FIRMWARE_IMX_DDR3),ddr3*.bin)
...
ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_ROCKCHIP_RKBIN),y)
...
ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_DTC),y)
UBOOT_DEPENDENCIES += host-dtc
UBOOT_MAKE_OPTS += DTC=$(HOST_DIR)/bin/dtc
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_PYTHON3),y)
UBOOT_DEPENDENCIES += host-python3 host-python-setuptools
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_PYLIBFDT),y)
UBOOT_DEPENDENCIES += host-python-pylibfdt
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_PYELFTOOLS),y)
UBOOT_DEPENDENCIES += host-python-pyelftools
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_OPENSSL),y)
UBOOT_DEPENDENCIES += host-openssl
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_LZOP),y)
UBOOT_DEPENDENCIES += host-lzop
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_GNUTLS),y)
UBOOT_DEPENDENCIES += host-gnutls
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_UTIL_LINUX),y)
UBOOT_DEPENDENCIES += host-util-linux
endif

ifeq ($(LINGMO_TARGET_UBOOT_NEEDS_XXD),y)
...
UBOOT_PATCHES = $(call qstrip,$(LINGMO_TARGET_UBOOT_PATCH))
...
ifeq ($(LINGMO_TARGET_UBOOT_BUILD_SYSTEM_LEGACY),y)
define UBOOT_CONFIGURE_CMDS
	$(TARGET_CONFIGURE_OPTS) \
		$(UBOOT_MAKE) -C $(@D) $(UBOOT_MAKE_OPTS) \
		$(UBOOT_BOARD_NAME)_config
endef
else ifeq ($(LINGMO_TARGET_UBOOT_BUILD_SYSTEM_KCONFIG),y)
ifeq ($(LINGMO_TARGET_UBOOT_USE_DEFCONFIG),y)
UBOOT_KCONFIG_DEFCONFIG = $(call qstrip,$(LINGMO_TARGET_UBOOT_BOARD_DEFCONFIG))_defconfig
else ifeq ($(LINGMO_TARGET_UBOOT_USE_CUSTOM_CONFIG),y)
UBOOT_KCONFIG_FILE = $(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_CONFIG_FILE))
endif # LINGMO_TARGET_UBOOT_USE_DEFCONFIG

UBOOT_KCONFIG_FRAGMENT_FILES = $(call qstrip,$(LINGMO_TARGET_UBOOT_CONFIG_FRAGMENT_FILES))
...
endif # LINGMO_TARGET_UBOOT_BUILD_SYSTEM_LEGACY

UBOOT_CUSTOM_DTS_PATH = $(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_DTS_PATH))
...
define UBOOT_BUILD_CMDS
	...
	$(TARGET_CONFIGURE_OPTS) \
		...
		$(UBOOT_MAKE) -C $(@D) $(UBOOT_MAKE_OPTS) \
		$(UBOOT_MAKE_TARGET)
	$(if $(LINGMO_TARGET_UBOOT_FORMAT_SD),
		$(@D)/tools/mxsboot sd $(@D)/u-boot.sb $(@D)/u-boot.sd)
	$(if $(LINGMO_TARGET_UBOOT_FORMAT_NAND),
		$(@D)/tools/mxsboot \
			-w $(LINGMO_TARGET_UBOOT_FORMAT_NAND_PAGE_SIZE) \
			-o $(LINGMO_TARGET_UBOOT_FORMAT_NAND_OOB_SIZE) \
			-e $(LINGMO_TARGET_UBOOT_FORMAT_NAND_ERASE_SIZE) \
			nand $(@D)/u-boot.sb $(@D)/u-boot.nand)
endef

define UBOOT_BUILD_OMAP_IFT
	$(HOST_DIR)/bin/gpsign -f $(@D)/u-boot.bin \
		-c $(call qstrip,$(LINGMO_TARGET_UBOOT_OMAP_IFT_CONFIG))
endef
...
define UBOOT_INSTALL_IMAGES_CMDS
	...
	$(if $(LINGMO_TARGET_UBOOT_SPL),
		$(foreach f,$(call qstrip,$(LINGMO_TARGET_UBOOT_SPL_NAME)), \
			cp -dpf $(@D)/$(f) $(BINARIES_DIR)/
		)
	)
endef

ifeq ($(LINGMO_TARGET_UBOOT_ZYNQMP),y)

UBOOT_ZYNQMP_PMUFW = $(call qstrip,$(LINGMO_TARGET_UBOOT_ZYNQMP_PMUFW))
...
UBOOT_ZYNQMP_PM_CFG = $(call qstrip,$(LINGMO_TARGET_UBOOT_ZYNQMP_PM_CFG))
...
UBOOT_ZYNQMP_PSU_INIT = $(call qstrip,$(LINGMO_TARGET_UBOOT_ZYNQMP_PSU_INIT_FILE))
...
endif # LINGMO_TARGET_UBOOT_ZYNQMP
...
ifeq ($(LINGMO_TARGET_UBOOT_OMAP_IFT),y)
ifeq ($(BR_BUILDING),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_OMAP_IFT_CONFIG)),)
$(error No gpsign config file. Check your LINGMO_TARGET_UBOOT_OMAP_IFT_CONFIG setting)
endif
ifeq ($(wildcard $(call qstrip,$(LINGMO_TARGET_UBOOT_OMAP_IFT_CONFIG))),)
$(error gpsign config file $(LINGMO_TARGET_UBOOT_OMAP_IFT_CONFIG) not found. Check your LINGMO_TARGET_UBOOT_OMAP_IFT_CONFIG setting)
endif
endif
...
ifeq ($(LINGMO_TARGET_UBOOT_ALTERA_SOCFPGA_IMAGE_CRC),y)
ifeq ($(LINGMO_TARGET_UBOOT_SPL),y)
UBOOT_CRC_ALTERA_SOCFPGA_INPUT_IMAGES = $(call qstrip,$(LINGMO_TARGET_UBOOT_SPL_NAME))
...
ifeq ($(LINGMO_TARGET_UBOOT)$(BR_BUILDING),yy)
...
$(error No U-Boot board name set. Check your LINGMO_TARGET_UBOOT_BOARDNAME setting)
endif # UBOOT_BOARD_NAME
else ifeq ($(LINGMO_TARGET_UBOOT_BUILD_SYSTEM_KCONFIG),y)
ifeq ($(LINGMO_TARGET_UBOOT_USE_DEFCONFIG),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_BOARD_DEFCONFIG)),)
$(error No board defconfig name specified, check your LINGMO_TARGET_UBOOT_BOARD_DEFCONFIG setting)
endif # qstrip LINGMO_TARGET_UBOOT_BOARD_DEFCONFIG
endif # LINGMO_TARGET_UBOOT_USE_DEFCONFIG
ifeq ($(LINGMO_TARGET_UBOOT_USE_CUSTOM_CONFIG),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_CONFIG_FILE)),)
$(error No board configuration file specified, check your LINGMO_TARGET_UBOOT_CUSTOM_CONFIG_FILE setting)
endif # qstrip LINGMO_TARGET_UBOOT_CUSTOM_CONFIG_FILE
endif # LINGMO_TARGET_UBOOT_USE_CUSTOM_CONFIG
endif # LINGMO_TARGET_UBOOT_BUILD_SYSTEM_LEGACY

#
# Check custom version option
#
ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_VERSION),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_VERSION_VALUE)),)
$(error No custom U-Boot version specified. Check your LINGMO_TARGET_UBOOT_CUSTOM_VERSION_VALUE setting)
endif # qstrip LINGMO_TARGET_UBOOT_CUSTOM_VERSION_VALUE
endif # LINGMO_TARGET_UBOOT_CUSTOM_VERSION

#
# Check custom tarball option
#
ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_TARBALL),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_TARBALL_LOCATION)),)
$(error No custom U-Boot tarball specified. Check your LINGMO_TARGET_UBOOT_CUSTOM_TARBALL_LOCATION setting)
endif # qstrip LINGMO_TARGET_UBOOT_CUSTOM_TARBALL_LOCATION
endif # LINGMO_TARGET_UBOOT_CUSTOM_TARBALL

#
# Check Git/Mercurial repo options
#
ifeq ($(LINGMO_TARGET_UBOOT_CUSTOM_GIT)$(LINGMO_TARGET_UBOOT_CUSTOM_HG),y)
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_REPO_URL)),)
$(error No custom U-Boot repository URL specified. Check your LINGMO_TARGET_UBOOT_CUSTOM_REPO_URL setting)
endif # qstrip LINGMO_TARGET_UBOOT_CUSTOM_CUSTOM_REPO_URL
ifeq ($(call qstrip,$(LINGMO_TARGET_UBOOT_CUSTOM_REPO_VERSION)),)
$(error No custom U-Boot repository version specified. Check your LINGMO_TARGET_UBOOT_CUSTOM_REPO_VERSION setting)
endif # qstrip LINGMO_TARGET_UBOOT_CUSTOM_CUSTOM_REPO_VERSION
endif # LINGMO_TARGET_UBOOT_CUSTOM_GIT || LINGMO_TARGET_UBOOT_CUSTOM_HG

endif # LINGMO_TARGET_UBOOT && BR_BUILDING
