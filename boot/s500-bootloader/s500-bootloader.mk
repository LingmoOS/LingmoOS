...
S500_BOOTLOADER_BOARD = $(call qstrip,$(LINGMO_TARGET_S500_BOOTLOADER_BOARD))
...
ifeq ($(LINGMO_TARGET_S500_BOOTLOADER)$(BR_BUILDING),yy)
# we NEED a board name
ifeq ($(S500_BOOTLOADER_BOARD),)
$(error No s500-bootloader board specified. Check your LINGMO_TARGET_S500_BOOTLOADER settings)
endif
endif
